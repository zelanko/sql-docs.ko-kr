...
OGC(Open Geospatial Consortium) WKB(Well-Known Binary) 표현에서 **geometryMultiPoint** 인스턴스를 반환합니다.
 ...
 *SRID*  
 반환할 **geometryMultiPoint** 인스턴스의 SRID(Spatial Reference ID)를 나타내는 **int** 식입니다.  
