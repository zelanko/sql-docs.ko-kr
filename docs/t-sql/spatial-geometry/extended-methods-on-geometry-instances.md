---
description: geometry 인스턴스의 확장 메서드
title: geometry 인스턴스의 확장 메서드 | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88458997"
---
# <a name="extended-methods-on-geometry-instances"></a>geometry 인스턴스의 확장 메서드
[!INCLUDE [SQL Server Azure SQL Database ](../../includes/applies-to-version/sql-asdb.md)]

  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]는 OGC(Open Geospatial Consortium) geometry 인스턴스의 여러 확장 메서드를 지원합니다.  
...
-   [AsBinaryZM &#40;geometry 데이터 형식&#41;](../../t-sql/spatial-geometry/asbinaryzm-geometry-datatype.md)  
...
-   [CurveToLineWithTolerance &#40;geometry 데이터 형식&#41;](../../t-sql/spatial-geometry/curvetolinewithtolerance-geometry-data-type.md)  
  
-   [InstanceOf&#40;geometry 데이터 형식&#41;](../../t-sql/spatial-geometry/instanceof-geometry-data-type.md)  
  
-   [Filter &#40;geometry 데이터 형식&#41;](../../t-sql/spatial-geometry/filter-geometry-data-type.md)  
  
-   [HasM &#40;geometry 데이터 형식&#41;](../../t-sql/spatial-geometry/hasm-geometry-datatype.md)  
  
-   [HasZ &#40;geometry 데이터 형식&#41;](../../t-sql/spatial-geometry/hasz-geometry-datatype.md)  
  
-   [IsNull &#40;geometry 데이터 형식&#41;](../../t-sql/spatial-geometry/isnull-geometry-data-type.md)  
  
-   [IsValidDetailed &#40;geometry 데이터 형식&#41;](../../t-sql/spatial-geometry/isvaliddetailed-geometry-datatype.md)  
...
-   [MinDbCompatibilityLevel &#40;geometry 데이터 형식&#41;](../../t-sql/spatial-geometry/mindbcompatibilitylevel-geometry-data-type.md)  
