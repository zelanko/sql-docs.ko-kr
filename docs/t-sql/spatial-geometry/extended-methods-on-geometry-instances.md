---
title: "Geometry 인스턴스의 메서드를 확장 합니다. | Microsoft Docs"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[tsql-appliesto-ss2012-asdb-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-asdb-xxxx-xxx-md.md)]
  ...
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Open Geospatial Consortium (OGC) geometry 인스턴스의 여러 확장된 메서드를 지원합니다.  
...
-   [필터 &#40; geometry 데이터 형식 &#41;](../../t-sql/spatial-geometry/filter-geometry-data-type.md)  
