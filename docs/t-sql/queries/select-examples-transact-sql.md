...
## <a name="a-using-select-to-retrieve-rows-and-columns"></a>1. SELECT를 사용하여 행 및 열 검색  
 ...
 [!code-sql[#SelectExamples1 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_1.sql)]  
 ...
 [!code-sql[#SelectExamples2 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_2.sql)]  
  
 다음 예에서는 제품 라인이 `Product`이고 제조에 필요한 기간이 `R`일보다 작은 `4`에 대한 행만 반환합니다.  
  
 [!code-sql[#SelectExamples3 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_3.sql)]  
...
## <a name="b-using-select-with-column-headings-and-calculations"></a>2. SELECT에 열 머리글 및 계산 사용  
 ...
 [!code-sql[#SelectExamples4 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_4.sql)]  
  
 다음 쿼리에서는 각 판매 주문의 각 제품에 대한 총 수익을 계산합니다.  
  
 [!code-sql[#SelectExamples5 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_5.sql)]  
  
## <a name="c-using-distinct-with-select"></a>3. SELECT에 DISTINCT 사용  
 다음 예에서는 `DISTINCT`를 사용하여 중복된 제목을 검색하지 않도록 합니다.  
  
 [!code-sql[#SelectExamples6 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_6.sql)]  
  
## <a name="d-creating-tables-with-select-into"></a>4. SELECT INTO로 테이블 만들기  
 다음 첫 번째 예에서는 `#Bicycles`에 `tempdb`라는 임시 테이블을 만듭니다.  
  
 [!code-sql[#SelectExamples7 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_7.sql)]  
  
 다음 두 번째 예에서는 영구 테이블 `NewProducts`를 만듭니다.  
  
 [!code-sql[#SelectExamples8 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_8.sql)]  
...
## <a name="e-using-correlated-subqueries"></a>5. 상관 하위 쿼리 사용  
 ...
 [!code-sql[#SelectExamples9 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_9.sql)]  
 ...
 [!code-sql[#SelectExamples10 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_10.sql)]  
 ...
 [!code-sql[#SelectExamples11 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_11.sql)]  
  
 다음 예에서는 두 개의 상관 하위 쿼리를 사용하여 특정 제품을 판매한 직원의 이름을 찾습니다.  
  
 [!code-sql[#SelectExamples12 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_12.sql)]  
  
## <a name="f-using-group-by"></a>6. GROUP BY 사용  
 다음 예에서는 데이터베이스에서 각 판매 주문의 합계를 구합니다.  
  
 [!code-sql[#SelectExamples13 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_13.sql)]  
...
## <a name="g-using-group-by-with-multiple-groups"></a>7. GROUP BY에 여러 그룹 사용  
 ...
 [!code-sql[#SelectExamples14 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_14.sql)]  
  
## <a name="h-using-group-by-and-where"></a>8. GROUP BY 및 WHERE 사용  
 다음 예에서는 가격이 `$1000`보다 큰 행만 검색한 후 그 결과를 그룹화합니다.  
  
 [!code-sql[#SelectExamples15 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_15.sql)]  
  
## <a name="i-using-group-by-with-an-expression"></a>9. GROUP BY에 식 사용  
 다음 예에서는 식으로 그룹화를 수행합니다. 식에 집계 함수가 없는 경우 식으로 그룹화를 수행할 수 있습니다.  
  
 [!code-sql[#SelectExamples16 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_16.sql)]  
  
## <a name="j-using-group-by-with-order-by"></a>10. GROUP BY 및 ORDER BY 사용  
 다음 예에서는 각 제품 유형의 평균 가격을 찾아 그 결과를 평균 가격에 따라 정렬합니다.  
  
 [!code-sql[#SelectExamples18 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_17.sql)]  
...
## <a name="k-using-the-having-clause"></a>11. HAVING 절 사용  
 ...
 [!code-sql[#SelectExamples19 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_18.sql)]  
...
## <a name="l-using-having-and-group-by"></a>12. HAVING 및 GROUP BY 사용  
 ...
 [!code-sql[#SelectExamples21 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_19.sql)]  
...
## <a name="m-using-having-with-sum-and-avg"></a>13. SUM 및 AVG와 함께 HAVING 사용  
 ...
 [!code-sql[#SelectExamples22 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_20.sql)]  
  
 총 판매액이 `$2000000.00` 이상인 제품을 보려면 다음 쿼리를 사용합니다.  
  
 [!code-sql[#SelectExamples23 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_21.sql)]  
 ...
 [!code-sql[#SelectExamples24 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_22.sql)]  
...
## <a name="n-using-the-index-optimizer-hint"></a>14. INDEX 최적화 프로그램 힌트 사용  
 ...
 [!code-sql[#SelectExamples45 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_23.sql)]  
...
## <a name="m-using-option-and-the-group-hints"></a>13. OPTION 및 GROUP 힌트 사용  
 ...
 [!code-sql[#SelectExamples46 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_24.sql)]  
  
## <a name="o-using-the-union-query-hint"></a>15. UNION 쿼리 힌트 사용  
 다음 예에서는 `MERGE UNION` 쿼리 힌트를 사용합니다.  
  
 [!code-sql[#SelectExamples47 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_25.sql)]  
...
## <a name="p-using-a-simple-union"></a>16. 단순 UNION 사용  
 ...
 [!code-sql[#SelectExamples48 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_26.sql)]  
...
## <a name="q-using-select-into-with-union"></a>17. UNION과 함께 SELECT INTO 사용  
 ...
 [!code-sql[#SelectExamples49 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_27.sql)]  
...
## <a name="r-using-union-of-two-select-statements-with-order-by"></a>18. 두 SELECT 문에서 ORDER BY와 함께 UNION 사용  
 ...
 [!code-sql[#SelectExamples50 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_28.sql)]  
...
## <a name="s-using-union-of-three-select-statements-to-show-the-effects-of-all-and-parentheses"></a>S.는 세 개의 SELECT 문에서 UNION을 사용하여 ALL 및 괄호의 효과 확인  
 ...
 [!code-sql[#SelectExamples51 선택](../../t-sql/queries/codesnippet/tsql/select-examples-transact_29.sql)]  
