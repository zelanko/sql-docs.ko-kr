...
> MAXDOP가 0으로 설정되면 서버는 최대 병렬 처리 수준을 선택합니다.  
 ...
 MAXRECURSION *숫자*  
 해당 쿼리에 대해 허용되는 최대 재귀 횟수를 지정합니다. *숫자*는 0에서 32767 사이의 음수가 아닌 정수입니다. 0을 지정하면 제한이 적용되지 않습니다. 이 옵션을 지정하지 않은 경우 서버에 대한 기본 한도는 100입니다.  
