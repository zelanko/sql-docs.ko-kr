...
<a name="use_hint"></a>사용 하 여 힌트 ( **'***hint_name***'** )  
 **적용 대상**:에 적용 됩니다 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (부터는 [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]) 및 [!INCLUDE[ssSDS](../../includes/sssds-md.md)]합니다.
