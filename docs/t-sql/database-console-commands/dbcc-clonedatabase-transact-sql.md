...
명령 실행이 종료되는 즉시 내부 스냅샷이 삭제됩니다. 복제된 데이터베이스에서 TRUSTWORTHY 및 DB_CHAINING 옵션이 해제됩니다. 
...
### <a name="c-creating-a-schema-only-clone-of-a-database-without-statistics-and-query-store"></a>C. 통계 및 쿼리 저장소가 없는 데이터베이스의 스키마 전용 클론 만들기 
...
[SQL Server에서 필요한 데이터베이스 메타데이터의 스크립트를 생성하여 통계 전용 데이터베이스를 만드는 방법](https://support.microsoft.com/help/914288)   
