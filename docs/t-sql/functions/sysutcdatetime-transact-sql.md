...
[!INCLUDE[tsql-appliesto-ss2008-all_md](../../includes/tsql-appliesto-ss2008-all-md.md)]
  ...
  반환 된 **datetime2** 되는 컴퓨터의 시간과 날짜를 포함 하는 값의 인스턴스 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 실행 되 고 합니다. 날짜 및 시간이 UTC (협정 세계시) 시간으로 반환 됩니다. 소수 자릿수 초의 전체 자릿수는 1-7자리입니다. 기본 전체 자릿수는 7자리입니다.  
...
## <a name="remarks"></a>주의  
 [!INCLUDE[tsql](../../includes/tsql-md.md)]문은 참조할 수 있습니다 SYSUTCDATETIME을 참조할 수 있는 모든 위치는 **datetime2** 식입니다.  
...
### <a name="f-converting-date-and-time-values-to-time"></a>6. 날짜 및 시간을 시간으로 변환  
 다음 예에서는 날짜 및 시간 값을 `time`으로 변환하는 방법을 보여 줍니다.  
