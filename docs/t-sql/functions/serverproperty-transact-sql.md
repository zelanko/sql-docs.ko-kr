...
> [!IMPORTANT]
> [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 및 [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]의 [!INCLUDE[ssde_md](../../includes/ssde_md.md)] 버전 번호는 서로 비교할 수 없으며, 이러한 개별 제품의 내부 빌드 번호를 나타냅니다. [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]의 [!INCLUDE[ssde_md](../../includes/ssde_md.md)]은 [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]와 동일한 코드 베이스를 기반으로 합니다. 가장 중요한 점은 [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]의 [!INCLUDE[ssde_md](../../includes/ssde_md.md)]에는 항상 최신 SQL [!INCLUDE[ssde_md](../../includes/ssde_md.md)] 비트가 있다는 점입니다. [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)] 버전 12는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 버전 15보다 최신 버전입니다.
