...
호환성 수준 110 이상에서 **time** 및 **datetime2** 데이터 형식에 대한 CAST 및 CONVERT 연산의 기본 스타일은 항상 121입니다. 쿼리에 이전 동작이 적용되는 경우 110보다 낮은 호환성 수준을 사용하거나, 해당 쿼리에서 스타일 0을 명시적으로 지정해야 합니다.
