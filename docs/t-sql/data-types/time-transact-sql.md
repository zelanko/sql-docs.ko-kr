...
|*초 소수 부분 자릿수*|초의 소수 부분 자릿수를 지정합니다.<br /><br /> 0에서 7 사이의 정수를 지정할 수 있습니다. Informatica에 대 한이 0에서 3 사이의 정수를 수 있습니다.<br /><br /> 기본 소수 자릿수는 7(100ns)입니다.|  
...
|요소 범위|hh는 0에서 23 사이에 속하는 두 자리 숫자로, 시를 나타냅니다.<br /><br /> mm은 0에서 59 사이에 속하는 두 자리 숫자로, 분을 나타냅니다.<br /><br /> ss는 0에서 59 사이에 속하는 두 자리 숫자로, 초를 나타냅니다.<br /><br /> n*은 0에서 9999999 사이에 속하는 0부터 7 자리의 숫자로, 소수 자릿수 초를 나타냅니다. Informatica에 대 한 n\* 세 자리 숫자로, 0에서 999 사이의 0이 됩니다.|  
