---
description: geography 인스턴스의 확장 메서드
title: Geography 인스턴스의 확장 메서드 | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88467510"
---
# <a name="extended-methods-on-geography-instances"></a>geography 인스턴스의 확장 메서드
[!INCLUDE [SQL Server Azure SQL Database ](../../includes/applies-to-version/sql-asdb.md)]

  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]는 OGC(Open Geospatial Consortium) geography 인스턴스의 여러 확장 메서드를 지원합니다.  
...
-   [AsBinaryZM&#40;geography 데이터 형식&#41;](../../t-sql/spatial-geography/asbinaryzm-geography-data-type.md)  
...
-   [BufferWithCurves&#40;geography 데이터 형식&#41;](../../t-sql/spatial-geography/bufferwithcurves-geography-data-type.md)  
...
-   [HasZ&#40;geography 데이터 형식&#41;](../../t-sql/spatial-geography/hasz-geography-data-type.md)  
...
-   [IsValidDetailed&#40;geography 데이터 형식&#41;](../../t-sql/spatial-geography/isvaliddetailed-geography-data-type.md)  
...
-   [MinDbCompatibilityLevel&#40;geography 데이터 형식&#41;](../../t-sql/spatial-geography/mindbcompatibilitylevel-geography-data-type.md)  
  
-   [NumRing](../../t-sql/spatial-geography/numrings-geography-data-type.md)  
  
-   [감소](../../t-sql/spatial-geography/reduce-geography-data-type.md)  
...
## <a name="see-also"></a>관련 항목  
 ...
 [OGC 정적 Geography 메서드](../../t-sql/spatial-geography/ogc-static-geography-methods.md)   
