 ...
 *geometrycollection_tagged_text*  
 WKT 표현에서 **geography** 반환할 인스턴스. *geometrycollection_tagged_text* 는 **nvarchar (max)** 식입니다.  
  
 *SRID*  
 이 **int** spatial 나타내는 식 참조의 ID (SRID)는 **geography** 반환할 인스턴스.  
...
## <a name="remarks"></a>주의  
 OGC 형식은 **geography** 인스턴스 STGeomCollFromText()에서 반환 된 해당 WKT 입력로 설정 됩니다.  
  
 이 메서드에서 throw 된 **ArgumentException** 입력 유효 하지 않을 경우.  
