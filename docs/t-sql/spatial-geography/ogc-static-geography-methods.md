---
title: OGC 정적 지리 메서드 | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "47819261"
---
# <a name="ogc-static-geography-methods"></a>OGC 정적 지리 메서드
[!INCLUDE[tsql-appliesto-ss2012-asdb-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-asdb-xxxx-xxx-md.md)]

  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]는 OGC(Open Geospatial Consortium)의 정적 지리 메서드를 지원합니다.  
