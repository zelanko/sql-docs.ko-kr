...
반환 된 **geographyPolygon** Open Geospatial Consortium (OGC) wkb (WELL-KNOWN Binary) 표현의 인스턴스.
 ...
 *WKB_polygon*  
 WKB 표현에서 **geographyPolygon** 반환할 인스턴스. *WKB_polygon* 는 **varbinary (max)** 식입니다.  
