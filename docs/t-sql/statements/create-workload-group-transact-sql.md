...
> |||||
> |---|---|---|---|
> |**_\* SQL Server \*_** &nbsp;|[SQL Database<br />관리되는 인스턴스](create-workload-group-transact-sql.md?view=azuresqldb-mi-current)|[Azure Synapse<br />분석](create-workload-group-transact-sql.md?view=azure-sqldw-latest)|
