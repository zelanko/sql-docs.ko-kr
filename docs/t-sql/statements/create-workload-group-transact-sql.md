...
REQUEST_MAX_MEMORY_GRANT_PERCENT = *value*  
단일 요청이 풀에서 사용할 수 있는 최대 메모리 양을 지정합니다. *값*은 MAX_MEMORY_PERCENT에서 지정한 리소스 풀 크기와 관련된 백분율입니다. *값*은 [!INCLUDE[ssSQL17](../../includes/sssql17-md.md)]까지의 정수이고 [!INCLUDE[sql-server-2019](../../includes/sssqlv15-md.md)]로 시작하며 기본 설정은 25입니다. 허용되는 *value*의 범위는 1에서 100까지입니다.  
...
-   *값*을 0으로 설정하면 사용자 정의 작업 그룹에 SORT 및 HASH MATCH 작업이 있는 쿼리가 실행되지 않습니다.  
...
## <a name="examples"></a>예  
### <a name="1-shows-how-to-create-a-workload-group-named-newreports"></a>1. newReports라는 작업 그룹을 만드는 방법을 보여줍니다.    
