...
-   주 복제본이 활성 상태여야 합니다. 비활성 주 복제본 문제를 해결하는 방법은 [AlwaysOn 가용성 그룹 구성 문제 해결(SQL Server)](http://go.microsoft.com/fwlink/?LinkId=225834)을 참조하십시오.  
