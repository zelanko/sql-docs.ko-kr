...
ms.locfileid: "66826868"
---
# <a name="set-result-set-caching-transact-sql-applies-to-azure-sql-data-warehouse-gen2-only-preview"></a>SET RESULT SET CACHING(Transact-SQL) Azure SQL Data Warehouse Gen2에만 적용(미리 보기)
