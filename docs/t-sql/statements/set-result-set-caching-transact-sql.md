...
---
# <a name="set-result-set-caching-transact-sql-preview-for-azure-sql-data-warehouse-gen2"></a>SET RESULT SET CACHING (Transact-SQL)(Azure SQL Data Warehouse Gen2용 미리 보기)
