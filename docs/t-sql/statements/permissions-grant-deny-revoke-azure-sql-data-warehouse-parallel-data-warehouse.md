---
description: '사용 권한: GRANT, DENY, REVOKE(Azure Synapse Analytics, 병렬 데이터 웨어하우스)'
...
-   REFERENCES  
 ...
 각 사용 권한 유형에 대한 정의는 [사용 권한(데이터베이스 엔진)](../../relational-databases/security/permissions-database-engine.md)을 참조하세요.  
