 ...
 *사용 권한*  
 ...
 사용자::*database_user*  
 사용 권한을 부여할 사용자의 클래스 및 이름을 지정합니다. 범위 한정자 (:)가 필요 합니다.  
  
 역할::*database_role*  
 사용 권한을 부여할 역할의 클래스 및 이름을 지정합니다. 범위 한정자 (:)가 필요 합니다.  
  
 응용 프로그램 역할::*application_role*  
   
 사용 권한을 부여할 응용 프로그램 역할의 클래스 및 이름을 지정합니다. 범위 한정자 (:)가 필요 합니다.  
 ...
 *Database_user_mapped_to_Windows_User*  
 Windows 사용자에 매핑된 데이터베이스 사용자를 지정 합니다.  
...
## <a name="remarks"></a>주의  
 데이터베이스 보안 주체에 대 한 정보에 표시 되는 [sys.database_principals](../../relational-databases/system-catalog-views/sys-database-principals-transact-sql.md) 카탈로그 뷰에 있습니다. 데이터베이스 수준 사용 권한에 대 한 정보는 [sys.database_permissions](../../relational-databases/system-catalog-views/sys-database-permissions-transact-sql.md) 카탈로그 뷰에 있습니다.  
...
|비대칭 키에 매핑된 데이터베이스 사용자|Db_securityadminfixed 데이터베이스 역할의 멤버 자격, db_owner의 멤버 자격이 고정 데이터베이스 역할 또는 멤버 자격 sysadmin 고정된 서버 역할의입니다.|  
...
|데이터베이스 역할|역할, db_securityadminfixed 데이터베이스 역할의 멤버 자격, db_owner 고정된 데이터베이스 역할의 멤버 자격 또는 sysadmin 고정된 서버 역할의 멤버 자격에 대 한 권한을 변경 합니다.|  
...
## <a name="see-also"></a>관련 항목:  
 ...
 [REVOKE 데이터베이스 보안 주체 사용 권한 &#40; Transact SQL &#41;](../../t-sql/statements/revoke-database-principal-permissions-transact-sql.md)   
