---
description: CREATE WORKLOAD 분류자(Transact-SQL)
...
[[!INCLUDE[ssSDW](../../includes/sssdwfull-md.md)] 분류](/azure/sql-data-warehouse/sql-data-warehouse-workload-classification)</br>
