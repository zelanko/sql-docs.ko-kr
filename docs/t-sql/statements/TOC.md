...
## [민감도 분류](add-sensitivity-classification-transact-sql.md)
...
## [DATABASE(병렬 데이터 웨어하우스)](alter-database-parallel-data-warehouse.md)  
## [DATABASE AUDIT SPECIFICATION](alter-database-audit-specification-transact-sql.md)
## [DATABASE 호환성 수준](alter-database-transact-sql-compatibility-level.md)  
## [DATABASE 데이터베이스 미러링](alter-database-transact-sql-database-mirroring.md)  
## [DATABASE ENCRYPTION KEY](alter-database-encryption-key-transact-sql.md)
## [DATABASE 파일 및 파일 그룹 옵션](alter-database-transact-sql-file-and-filegroup-options.md)  
...
## [DATABASE SET 옵션](alter-database-transact-sql-set-options.md)  
...
## [INDEX(선택적 XML 인덱스)](alter-index-selective-xml-indexes.md)  
...
## [BACKUP DATABASE(병렬 데이터 웨어하우스)](backup-database-parallel-data-warehouse.md)  
...
## [RESTORE 문](restore-statements-for-restoring-recovering-and-managing-backups-transact-sql.md)  
## [RESTORE DATABASE(병렬 데이터 웨어하우스)](restore-database-parallel-data-warehouse.md)

## [RESTORE 인수](restore-statements-arguments-transact-sql.md)  
...
## [DATABASE(병렬 데이터 웨어하우스)](create-database-parallel-data-warehouse.md)  
...
## [REMOTE TABLE AS SELECT(병렬 데이터 웨어하우스)](create-remote-table-as-select-parallel-data-warehouse.md)  
...
## [TABLE IDENTITY(속성)](create-table-transact-sql-identity-property.md)
...
## [XML INDEX(선택적 XML 인덱스)](create-xml-index-selective-xml-indexes.md)  
## [XML SCHEMA COLLECTION](create-xml-schema-collection-transact-sql.md)  

# 데이터 정렬
## [COLLATE 절](collations.md)  
## [SQL Server 데이터 정렬 이름](sql-server-collation-name-transact-sql.md)  
## [Windows 데이터 정렬 이름](windows-collation-name-transact-sql.md)  
## [데이터 정렬 선행 규칙](collation-precedence-transact-sql.md)  
...
## [INDEX(선택적 XML 인덱스)](drop-index-selective-xml-indexes.md)  
...
## [민감도 분류](drop-sensitivity-classification-transact-sql.md)
...
## [DENY 어셈블리 사용 권한](deny-assembly-permissions-transact-sql.md)  
## [DENY 비대칭 키 사용 권한](deny-asymmetric-key-permissions-transact-sql.md)  
## [DENY 가용성 그룹 사용 권한](deny-availability-group-permissions-transact-sql.md)  
## [DENY 인증서 사용 권한](deny-certificate-permissions-transact-sql.md)  
## [DENY 데이터베이스 사용 권한](deny-database-permissions-transact-sql.md)  
## [DENY 데이터베이스 보안 주체 사용 권한](deny-database-principal-permissions-transact-sql.md)  
## [DENY 데이터베이스 범위 자격 증명](deny-database-scoped-credential-transact-sql.md)  
## [DENY 끝점 사용 권한](deny-endpoint-permissions-transact-sql.md)  
## [DENY 전체 텍스트 사용 권한](deny-full-text-permissions-transact-sql.md)  
## [DENY 개체 사용 권한](deny-object-permissions-transact-sql.md)  
## [DENY 스키마 사용 권한](deny-schema-permissions-transact-sql.md)  
## [DENY 검색 속성 목록 사용 권한](deny-search-property-list-permissions-transact-sql.md)  
## [DENY 서버 사용 권한](deny-server-permissions-transact-sql.md)  
## [DENY 서버 보안 주체 사용 권한](deny-server-principal-permissions-transact-sql.md)  
## [DENY Service Broker 사용 권한](deny-service-broker-permissions-transact-sql.md)  
## [DENY 대칭 키 사용 권한](deny-symmetric-key-permissions-transact-sql.md)  
## [DENY 시스템 개체 사용 권한](deny-system-object-permissions-transact-sql.md)  
## [DENY 형식 사용 권한](deny-type-permissions-transact-sql.md)  
## [DENY XML 스키마 컬렉션 사용 권한](deny-xml-schema-collection-permissions-transact-sql.md)  
## [EXECUTE AS](execute-as-transact-sql.md)  
## [EXECUTE AS 절](execute-as-clause-transact-sql.md)  
## [GRANT](grant-transact-sql.md)  
## [GRANT 어셈블리 사용 권한](grant-assembly-permissions-transact-sql.md)  
## [GRANT 비대칭 키 사용 권한](grant-asymmetric-key-permissions-transact-sql.md)  
## [GRANT 가용성 그룹 사용 권한](grant-availability-group-permissions-transact-sql.md)  
## [GRANT 인증서 사용 권한](grant-certificate-permissions-transact-sql.md)  
## [GRANT 데이터베이스 사용 권한](grant-database-permissions-transact-sql.md)  
## [GRANT 데이터베이스 보안 주체 사용 권한](grant-database-principal-permissions-transact-sql.md)  
## [GRANT 데이터베이스 범위 자격 증명](grant-database-scoped-credential-transact-sql.md)  
## [GRANT 끝점 사용 권한](grant-endpoint-permissions-transact-sql.md)  
## [GRANT 전체 텍스트 사용 권한](grant-full-text-permissions-transact-sql.md)  
## [GRANT 개체 사용 권한](grant-object-permissions-transact-sql.md)  
## [GRANT 스키마 사용 권한](grant-schema-permissions-transact-sql.md)  
## [GRANT 검색 속성 목록 사용 권한](grant-search-property-list-permissions-transact-sql.md)  
## [GRANT 서버 사용 권한](grant-server-permissions-transact-sql.md)  
## [GRANT 서버 보안 주체 사용 권한](grant-server-principal-permissions-transact-sql.md)  
## [GRANT Service Broker 사용 권한](grant-service-broker-permissions-transact-sql.md)  
## [GRANT 대칭 키 사용 권한](grant-symmetric-key-permissions-transact-sql.md)  
## [GRANT 시스템 개체 사용 권한](grant-system-object-permissions-transact-sql.md)  
## [GRANT 형식 사용 권한](grant-type-permissions-transact-sql.md)  
## [GRANT XML 스키마 컬렉션 사용 권한](grant-xml-schema-collection-permissions-transact-sql.md)  
## [OPEN MASTER KEY](open-master-key-transact-sql.md)  
## [OPEN SYMMETRIC KEY](open-symmetric-key-transact-sql.md)  
## [사용 권한: GRANT, DENY, REVOKE(Azure SQL Data Warehouse, 병렬 데이터 웨어하우스)](permissions-grant-deny-revoke-azure-sql-data-warehouse-parallel-data-warehouse.md)  
## [REVERT](revert-transact-sql.md)  
## [REVOKE](revoke-transact-sql.md)  
## [REVOKE 어셈블리 사용 권한](revoke-assembly-permissions-transact-sql.md)  
## [REVOKE 비대칭 키 사용 권한](revoke-asymmetric-key-permissions-transact-sql.md)  
## [REVOKE 가용성 그룹 사용 권한](revoke-availability-group-permissions-transact-sql.md)  
## [REVOKE 인증서 사용 권한](revoke-certificate-permissions-transact-sql.md)  
## [REVOKE 데이터베이스 사용 권한](revoke-database-permissions-transact-sql.md)  
## [REVOKE 데이터베이스 보안 주체 사용 권한](revoke-database-principal-permissions-transact-sql.md)  
## [REVOKE 데이터베이스 범위 자격 증명](revoke-database-scoped-credential-transact-sql.md)  
## [REVOKE 끝점 사용 권한](revoke-endpoint-permissions-transact-sql.md)  
## [REVOKE 전체 텍스트 사용 권한](revoke-full-text-permissions-transact-sql.md)  
## [REVOKE 개체 사용 권한](revoke-object-permissions-transact-sql.md)  
## [REVOKE 스키마 사용 권한](revoke-schema-permissions-transact-sql.md)  
## [REVOKE 검색 속성 목록 사용 권한](revoke-search-property-list-permissions-transact-sql.md)  
## [REVOKE 서버 사용 권한](revoke-server-permissions-transact-sql.md)  
## [REVOKE 서버 보안 주체 사용 권한](revoke-server-principal-permissions-transact-sql.md)  
## [REVOKE Service Broker 사용 권한](revoke-service-broker-permissions-transact-sql.md)  
## [REVOKE 대칭 키 사용 권한](revoke-symmetric-key-permissions-transact-sql.md)  
## [REVOKE 시스템 개체 사용 권한](revoke-system-object-permissions-transact-sql.md)  
## [REVOKE 형식 사용 권한](revoke-type-permissions-transact-sql.md)  
## [REVOKE XML 스키마 컬렉션 사용 권한](revoke-xml-schema-collection-permissions-transact-sql.md)  
...
# SET
## [개요](set-statements-transact-sql.md)
