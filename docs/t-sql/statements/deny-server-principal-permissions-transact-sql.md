---
description: DENY 서버 보안 주체 사용 권한(Transact-SQL)
...
### <a name="b-denying-view-definition-permission-with-cascade"></a>B. CASCADE를 지정하여 VIEW DEFINITION 권한 거부  
