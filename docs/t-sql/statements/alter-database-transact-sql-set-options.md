...
> [!NOTE]
> ALTER DATABASE를 사용하여 일부 옵션을 설정하려면 배타적 데이터베이스 액세스가 필요할 수 있습니다. ALTER DATABASE 문이 적시에 완료되지 않으면 데이터베이스의 다른 세션에서 ALTER DATABASE 세션을 차단하고 있는지 확인합니다.
