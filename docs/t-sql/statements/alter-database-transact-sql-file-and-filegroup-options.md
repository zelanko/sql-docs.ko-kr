...
[Binary Large Object](../../relational-databases/blob/binary-large-object-blob-data-sql-server.md)   
...
FILEGROWTH *growth_increment*  
파일의 자동 증분을 지정합니다. 파일의 FILEGROWTH 설정은 MAXSIZE 설정을 초과할 수 없습니다. 
