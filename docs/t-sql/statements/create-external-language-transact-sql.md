...
> [!NOTE]
> 현재, **Java**만 외부 언어로 지원됩니다. **R** 및 **Python**은 예약된 이름이며 해당 특정 이름을 사용하여 외부 언어를 만들 수 없습니다. **R** 및 **Python** 사용 방법에 대한 자세한 내용은 [SQL Server Machine Learning Services](https://docs.microsoft.com/sql/machine-learning/)를 참조하세요.
