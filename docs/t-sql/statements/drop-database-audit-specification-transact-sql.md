...
## <a name="remarks"></a>주의  
 DROP DATABASE AUDIT SPECIFICATION은 DROP 명령이 실행되기 전에 수집된 감사 데이터를 제외한 감사 사양의 메타데이터를 제거합니다. 데이터베이스 감사 사양의 상태를 OFF로 설정 해야 사용 하 여 `ALTER DATABASE AUDIT SPECIFICATION` 삭제할 수 있습니다.  
  
## <a name="permissions"></a>Permissions  
 사용자에 게는 **ALTER ANY DATABASE AUDIT** 권한이 데이터베이스 감사 사양을 삭제할 수 있습니다.  
...
```  
 ...
 감사 만들기의 전체 예제를 보려면 [SQL Server Audit &#40; 데이터베이스 엔진 &#41;](../../relational-databases/security/auditing/sql-server-audit-database-engine.md)합니다.  
