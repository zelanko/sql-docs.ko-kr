...
|[% (모듈로)](../../t-sql/language-elements/modulo-transact-sql.md)|나누기의 정수 나머지를 반환합니다. 예를 들어 12를 5로 나누면 나머지가 2이므로 12 % 5 = 2를 반환합니다.|  
 ...
 더하기 (+) 빼기 (-) 연산자 데도 사용할 수 있습니다에 산술 연산을 수행 하 고 **datetime** 및 **smalldatetime** 값입니다.  
  
 전체 자릿수와 소수 산술 연산의 결과 대 한 자세한 내용은 참조 [전체 자릿수, 소수 자릿수 및 길이 &#40; Transact SQL &#41; ](../../t-sql/data-types/precision-scale-and-length-transact-sql.md).  
