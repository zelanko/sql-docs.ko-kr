---
description: 언어 요소(Transact-SQL)
...
ms.locfileid: "97466134"
---
# <a name="language-elements-transact-sql"></a>언어 요소(Transact-SQL)
...
[트랜잭션(Azure Synapse Analytics)](../../t-sql/language-elements/transactions-sql-data-warehouse.md)
