...
[!INCLUDE[tsql-appliesto-ss2008-all_md](../../includes/tsql-appliesto-ss2008-all-md.md)]
  ...
  두 식을 비교합니다(비교 연산자).   Null이 아닌 식을 비교하는 경우 왼쪽 피연산자의 값이 오른쪽 피연산자의 값보다 작으면 결과는 TRUE이고 그렇지 않으면 결과는 FALSE입니다.   항목을 참조 중 하나 또는 두 개의 피연산자가 NULL 이면 [SET ansi_nulls&#40; Transact SQL &#41; ](../../t-sql/statements/set-ansi-nulls-transact-sql.md).  
...
### <a name="b-using--to-compare-two-variables"></a>2. 사용 하 여 < 두 변수 비교에  
