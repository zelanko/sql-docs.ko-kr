...
# [슬래시 별(블록 주석)](slash-star-comment-transact-sql.md)  
...
# [백슬래시(줄 연속)](sql-server-utilities-statements-backslash.md)  
...
### [+=(더하기 대입)](add-equals-transact-sql.md)  
### [-(빼기)](subtract-transact-sql.md)  
### [-=(빼기 대입)](subtract-equals-transact-sql.md)  
### [*(곱하기)](multiply-transact-sql.md)  
### [*=(곱하기 대입)](multiply-equals-transact-sql.md)  
### [/(나누기)](divide-transact-sql.md)  
### [/=(나누기 대입)](divide-equals-transact-sql.md)  
### [% 모듈러스](modulo-transact-sql.md)  
### [%=모듈러스 대입](modulo-equals-transact-sql.md)  
## [=(대입)](assignment-operator-transact-sql.md)  
## [비트 단위](bitwise-operators-transact-sql.md)  
### [&(비트 단위 AND)](bitwise-and-transact-sql.md)  
### [&=(비트 AND 대입)](bitwise-and-equals-transact-sql.md)  
### [|(비트 OR)](bitwise-or-transact-sql.md)  
### [|=(비트 OR 대입)](bitwise-or-equals-transact-sql.md)  
### [^(배타적 비트 단위 OR)](bitwise-exclusive-or-transact-sql.md)  
### [^=(배타적 비트 OR 대입)](bitwise-exclusive-or-equals-transact-sql.md)  
...
### [+=(문자열 연결 대입)](string-concatenation-equal-transact-sql.md)  
### [%(와일드카드 - 일치하는 문자)](percent-character-wildcard-character-s-to-match-transact-sql.md)  
