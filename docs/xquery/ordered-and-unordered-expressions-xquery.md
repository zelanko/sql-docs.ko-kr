---
title: 정렬 및 식 (XQuery) 순서 없이 | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.prod_service: sql
...
ms.author: jroth
manager: craigg
ms.openlocfilehash: cfb3d8d0a9f18517af4129b0c32b95a8973dbaf2
...
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]
 ...
 추가 **정렬** 및 **순서가 지정 되지 않은** XQuery 사양에 설명 된 구문을 지원 하지 않습니다.  
