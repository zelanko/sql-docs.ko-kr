---
title: 업데이트 됨-SQL Server 문서에 대 한 XQuery | Microsoft Docs
description: 코드 조각에 대 한 Microsoft SQL Server에 대 한 XQuery에 최근에 변경된 된 설명서에 대 한 업데이트 된 콘텐츠를 표시 합니다.
manager: craigg
author: MightyPen
ms.author: genemi
ms.topic: article
...
ms.locfileid: "32739305"
---
# <a name="new-and-recently-updated-xquery-for-sql-server"></a>새로 추가 되거나 최근에 업데이트 된: SQL Server에 대 한 XQuery
...
- *주제 영역:* &nbsp; **SQL Server에 대 한 XQuery**합니다.
