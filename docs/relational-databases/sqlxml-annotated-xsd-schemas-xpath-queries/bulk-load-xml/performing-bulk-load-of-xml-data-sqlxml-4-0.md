---
title: XML 데이터 대량 로드 수행 (SQLXML)
description: SQLXML 4.0에서 XML 대량 로드를 사용 하 여 반 구조화 된 XML 데이터를 Microsoft SQL Server 테이블로 로드 하는 방법에 대해 알아봅니다.
ms.date: 03/17/2017
ms.prod: sql
...
## <a name="in-this-section"></a>섹션 내용  
 ...
 SQLXMLBulkLoad 개체와 해당 메서드 및 속성에 대해 설명 합니다.  
