---
title: XSL 변환 적용 (SQLXML)
description: SQLXML 관리 되는 클래스에 있는 SqlXmlCommand 개체의 XslPath 속성을 사용 하 여 XSL 변환을 적용 하는 SQL 쿼리의 예를 확인 합니다.
ms.date: 03/14/2017
ms.prod: sql
...
```  
 ...
 다음은 애플리케이션을 테스트하는 데 사용할 수 있는 XSL 스타일시트입니다.  
