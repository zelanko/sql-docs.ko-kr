...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]ExecuteToStream 메서드를 사용 하지 않고 명령을 실행 하는 SqlXmlCommand 개체의 ExecuteXmlReader 메서드를 사용할 수 있습니다. 이 메서드는 결과 (이 예제는 요소 또는 특성 이름과 값 인쇄)의 추가 처리를 위해 사용할 수 있는 XmlReader 개체를 반환 합니다.  
