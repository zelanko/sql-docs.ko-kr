...
-   에 특수 문자가 **ntext** 데이터 비교 BLOB 유형에 대 한 제한으로 인해 SQLXML 4.0을 사용 하 여 문제를 발생할 수 있습니다. 예를 들어, 사용 "[Serializable]"는  **\<diffgr: 전에 >** 동시성 검사는 열에에서 사용 하는 경우 DiffGram 블록 **ntext** 형식은 다음 SQLOLEDB 실패 하 게 됩니다 오류 설명:  
