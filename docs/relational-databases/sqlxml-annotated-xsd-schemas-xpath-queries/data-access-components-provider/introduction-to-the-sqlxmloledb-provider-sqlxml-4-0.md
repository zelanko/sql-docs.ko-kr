...
|명령<br /><br /> 속성|Default<br /><br /> (있는 경우)|설명|  
|--------------------------|----------------------------|-----------------|  
...
|namespaces||이 속성을 사용하면 네임스페이스를 사용하는 XPath 쿼리를 실행할 수 있습니다. 이 속성을 사용 하는 예제는 [SQLXMLOLEDB Provider&#41;&#40;네임 스페이스를 사용 하 여 XPath 쿼리 실행 ](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/data-access-components-provider/executing-xpath-queries-with-namespaces-sqlxmloledb-provider.md)을 참조 하세요.|  
