---
title: SQLXML 4.0 데이터 액세스 구성 요소
description: SQLXML 4.0-SQLXMLOLEDB Provider, SQLXML 관리 되는 클래스 및 SQL Server Native Client (SQLNCLI11)의 데이터 액세스 구성 요소에 대해 알아봅니다.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
