---
title: .NET 프레임워크의 SQL 서버 데이터 유형 | 마이크로 소프트 문서
description: SqlType 라이브러리는 Microsoft .NET 프레임워크의 일부입니다. SQL Server 데이터베이스와 동일한 의미 체계와 정밀도를 가진 데이터 형식을 제공합니다.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "81488485"
---
# <a name="sql-server-data-types-in-the-net-framework"></a>.NET Framework의 SQL Server 데이터 형식
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
  **SqlType** 라이브러리는 [!INCLUDE[msCoName](../../includes/msconame-md.md)] .NET Framework의 기본 클래스 라이브러리의 일부입니다. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 데이터베이스에 포함된 데이터 형식과 의미 체계 및 전체 자릿수가 동일한 데이터 형식을 제공하도록 디자인되었습니다. 이 항목에서는 .NET Framework 프로그래머에 대한 새 의미 체계에 대해 설명하고 **System.Data.SqlTypes** 네임스페이스에 구현된 형식을 **소개합니다.**  
 ...
 [CLR에서 큰 개체 &#40;LOB&#41; 매개 변수 처리](../../relational-databases/clr-integration-database-objects-types-net-framework/handling-large-object-lob-parameters-in-the-clr.md)  
