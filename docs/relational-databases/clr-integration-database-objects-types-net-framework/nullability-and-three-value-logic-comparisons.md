...
ms.locfileid: "85719924"
---
# <a name="nullability-and-three-value-logic-comparisons"></a>Null 허용 여부 및 3개의 값 논리 비교
 [!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]
  데이터 형식에 대해 잘 알고 있는 경우의 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **SqlTypes** 네임 스페이스에서 유사한 의미 체계 및 전체 자릿수를 찾을 수 있습니다 [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] . 그러나 약간의 차이가 있으며 이 항목에서는 이러한 차이 중 가장 중요한 점에 대해 설명합니다.  
...
## <a name="precision"></a>전체 자릿수  
 [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] CLR의 decimal 데이터 형식에는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]의 숫자 및 decimal 데이터 형식의 최대값과는 다른 최대값이 있습니다. 또한 [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] CLR decimal 데이터 형식에는 최대 전체 자릿수가 있는 것으로 간주됩니다. 그러나의 CLR에서 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **SqlDecimal** 는 동일한 최대 전체 자릿수 및 소수 자릿수와 동일한 의미 체계를의 decimal 데이터 형식과 동일 하 게 제공 합니다 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
