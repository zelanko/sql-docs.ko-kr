---
title: 데이터 정렬 및 CLR 통합 데이터 유형 | 마이크로 소프트 문서
description: SQL Server CLR 통합에서 .NET 프레임워크 문자열 API는 현재 스레드의 CompareInfo 속성을 사용하여 문자열 비교를 수행합니다.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
