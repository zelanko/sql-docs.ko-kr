...
### <a name="making-certificates-available-to-applications-and-users"></a>응용 프로그램 및 사용자가 인증서를 사용할 수 있도록 설정
...
### <a name="making-cng-keys-available-to-applications-and-users"></a>응용 프로그램 및 사용자가 CNG 키를 사용할 수 있도록 설정
