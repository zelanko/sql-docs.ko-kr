---
title: "SQL Server 및 데이터베이스 암호화 키(데이터베이스 엔진) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## SQL Server 응용 프로그램 및 데이터베이스 키  
 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 에서는 두 가지 주요한 용도로 키를 사용합니다. 이러한 키에는 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 인스턴스에서 해당 인스턴스를 위해 생성되는 SMK(*서비스 마스터 키*)와 데이터베이스에 사용되는 DMK(*데이터베이스 마스터 키*)가 있습니다.  
