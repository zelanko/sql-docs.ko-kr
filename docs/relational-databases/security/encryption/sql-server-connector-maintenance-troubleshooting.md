---
title: "SQL Server 커넥터 유지 관리 및 문제 해결 | Microsoft Docs"
ms.custom: ""
ms.date: "07/27/2016"
...
### [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 커넥터 업그레이드  
...
### [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 서비스 사용자 롤링  
...
### 구성에서 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]  
