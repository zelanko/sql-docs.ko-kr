---
title: "SQL Server 보안 설정 | Microsoft Docs"
ms.custom: ""
ms.date: "01/31/2017"
...
f1_keywords: 
  - "Security [SQL Server]"
helpviewer_keywords: 
  - "데이터베이스 개체 [SQL Server], 보안"
  - "SQL Server, 보안"
  - "운영 체제 [SQL Server], 보안"
  - "보안 [SQL Server], 계획"
  - "응용 프로그램 [SQL Server], 보안"
...
|사용할 방화벽 구성: [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]|[SSIS 서비스 액세스에 대한 Windows 방화벽 구성](../../integration-services/service/configure-a-windows-firewall-for-access-to-the-ssis-service.md)|  
...
|내용|참조 항목|  
|---------------------------|---------|  
|다음 연결, 구성 및 제어: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|[SQL Server Management Studio 사용](../../ssms/use-sql-server-management-studio.md)|  
