...
|DATABASE|ALTER ANY SENSITIVITY CLASSIFICATION|ALSP<br />적용 대상: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)](SQL Server 2019(15.x) ~ 현재 버전), SQL Database.|DATABASE|CONTROL SERVER|
