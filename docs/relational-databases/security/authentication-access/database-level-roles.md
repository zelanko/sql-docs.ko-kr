...
helpviewer_keywords: 
  - "db_denydatareader 역할"
  - "사용자 [SQL Server], 데이터베이스 역할"
  - "데이터베이스 수준 역할 [SQL Server]"
  - "db_denydatawriter 역할"
  - "역할 [SQL Server], 데이터베이스"
  - "보안 주체 [SQL Server], 데이터베이스 수준"
  - "db_backupoperator 역할"
  - "자격 증명 [SQL Server], 역할"
  - "db_accessadmin 역할"
  - "스키마 [SQL Server], 역할"
  - "사용 권한 [SQL Server], 역할"
  - "데이터베이스 역할 [SQL Server], 나열됨"
  - "db_datareader 역할"
  - "db_ddladmin 역할"
  - "db_datawriter 역할"
  - "db_securityadmin 역할"
  - "db_owner 역할"
  - "데이터베이스 역할 [SQL Server]"
  - "고정 데이터베이스 역할 [SQL Server]"
  - "인증 [SQL Server], 역할"
  - "그룹 [SQL Server], 역할"
...
데이터베이스 역할에 사용자를 추가하고 제거하려면 [ALTER ROLE](../../../t-sql/statements/alter-role-transact-sql.md) 문의 `ADD MEMBER` 및 `DROP MEMBER` 옵션을 사용합니다. [!INCLUDE[ssPDW_md](../../../includes/sspdw-md.md)]에서는 이 `ALTER ROLE` 사용을 지원하지 않습니다. 대신 기존의 [sp_addrolemember](../../../relational-databases/system-stored-procedures/sp-addrolemember-transact-sql.md) 및 [sp_droprolemember](../../../relational-databases/system-stored-procedures/sp-droprolemember-transact-sql.md) 프로시저를 사용합니다.
...
## <a name="special-roles-for-includesssdsmdtokensssdsmdmd-and-includesssdwmdtokensssdwmdmd"></a>[!INCLUDE[ssSDS_md](../../../includes/sssds-md.md)] 및 [!INCLUDE[ssSDW_md](../../../includes/sssdw-md.md)]의 특수 역할
