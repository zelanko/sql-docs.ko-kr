---
title: "사용 권한 계층(데이터베이스 엔진) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2016"
...
helpviewer_keywords: 
  - "보안 [SQL Server], 액세스 거부"
  - "계층 [SQL Server], 사용 권한"
  - "보안 개체 [SQL Server]"
  - "보안 [SQL Server], 사용 권한"
  - "사용 권한 [SQL Server], 계층"
  - "보안 [SQL Server], 액세스 부여"
...
[!INCLUDE[tsql-appliesto-ss2008-all_md](../../includes/tsql-appliesto-ss2008-all-md.md)]
 ...
 ![데이터베이스 엔진 권한 계층 다이어그램](../../relational-databases/security/media/wj-security-layers.gif "데이터베이스 엔진 권한 계층 다이어그램")  
