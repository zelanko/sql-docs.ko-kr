...
## <a name="example"></a>예제  
 ...
 이 섹션에서 설명한 다른 예제의 전체 코드 목록은 CLR 예제를 설치하면 확인할 수 있습니다. 에 대 한 지침은이 예제를 설치 합니다 [SQL Server 데이터베이스 엔진 예제](https://msftengprodsamples.codeplex.com/)합니다.  
