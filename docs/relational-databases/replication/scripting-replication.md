...
ms.topic: "article"
helpviewer_keywords: 
  - "스크립트 [SQL Server 복제], 복제 개체"
  - "병합 복제 스크립팅 [SQL Server 복제]"
  - "복제 [SQL Server], 스크립팅"
  - "스냅숏 복제 [SQL Server], 스크립팅"
  - "스크립트 [SQL Server 복제]"
  - "트랜잭션 복제, 스크립팅"
...
## 복제 개체 스크립팅  
 복제 개체 또는 복제 마법사에서 스크립트는 **복제** 폴더에 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]합니다. 마법사에서 스크립팅하는 경우 개체를 만들고 스크립팅하거나 스크립팅만 하도록 선택할 수 있습니다.  
...
#### Management Studio에서 개체를 스크립팅하려면  
...
3.  게시 또는 구독을 마우스 오른쪽 단추로 누른 **스크립트 생성**합니다.  
  
4.  옵션을 지정 된 **SQL 스크립트 생성-\< ReplicationObject>** 대화 상자입니다.  
...
#### Management Studio에서 여러 개체를 스크립팅하려면  
  
1.  [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]에서 배포자, 게시자 또는 구독자에 연결한 다음 해당 서버 노드를 확장합니다.  
  
2.  마우스 오른쪽 단추로 클릭는 **복제** 폴더를 마우스 클릭 한 다음 **스크립트 생성**합니다.  
