...
## <a name="user-action"></a>사용자 동작  
 구독이 생성된 후 게시의 스냅숏 에이전트가 시작되지 않은 경우 또는 구독을 다시 초기화하도록 마지막으로 선택한 후 스냅숏 에이전트가 시작되지 않은 경우 배포 에이전트를 시작하기 전에 스냅숏 에이전트를 시작한 다음 완료해야 합니다. 자세한 내용은 [스냅숏 만들기 및 적용](../../relational-databases/replication/create-and-apply-the-initial-snapshot.md)을 참조하세요.  
