 ...
 **오류 메시지**  
 세션이 오류로 인해 종료된 경우 이 필드는 스냅샷 에이전트가 기록한 마지막 오류 메시지를 표시합니다. 세션이 오류 없이 종료된 경우에는 필드가 비어 있습니다.  
  
 **동작 메시지**  
 선택한 세션 중에 스냅샷 에이전트가 기록한 모든 정보 메시지 및 오류 메시지입니다.  
