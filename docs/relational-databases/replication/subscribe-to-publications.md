...
helpviewer_keywords: 
  ...
  - "끌어오기 구독 [SQL Server 복제]"
  - "구독 [SQL Server 복제]"
  - "밀어넣기 구독 [SQL Server 복제], 밀어넣기 구독 정보"
  - "병합 복제 구독 [SQL Server 복제]"
  - "병합 복제 구독 [SQL Server 복제], 구독 정보"
  - "게시 [SQL Server 복제], 구독"
  - "밀어넣기 구독 [SQL Server 복제]"
  - "끌어오기 구독 [SQL Server 복제], 끌어오기 구독 정보"
...
## SQL Server 이외 구독자  
 Oracle 및 IBM DB2는 밀어넣기 구독을 사용하여 스냅숏 및 트랜잭션 게시를 구독할 수 있습니다. 자세한 내용은 참조 [비-SQL Server 구독자](../../relational-databases/replication/non-sql/non-sql-server-subscribers.md)합니다.  
