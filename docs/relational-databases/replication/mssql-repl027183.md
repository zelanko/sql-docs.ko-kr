...
-   고유 열을 기반으로 하는 조인 필터에 대해 **join_unique_key** 속성을 설정합니다. 자세한 내용은 [Join Filters](../../relational-databases/replication/merge/join-filters.md)을(를) 참조하세요.  
