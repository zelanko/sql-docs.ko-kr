---
title: "구독 다시 초기화 - 모든 구독 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# 구독 다시 초기화 - 모든 구독
   **구독 다시 초기화** 대화 상자에서는 모든 게시에 구독을 다시 초기화 하도록 표시할 수 있습니다. 다시 초기화를 수행하려면 각 구독자에 스냅숏을 적용해야 하며 이 작업은 트랜잭션 게시에 대한 구독을 위한 배포 에이전트 및 병합 게시에 대한 구독을 위한 병합 에이전트에서 수행합니다.  
