...
-   [스냅숏 폴더](../../relational-databases/replication/snapshot-folder.md)  
  
-   [배포 데이터베이스](../../relational-databases/replication/distribution-database.md)  
  
-   [게시자](../../relational-databases/replication/publishers.md)  
  
-   [배포자 암호](../../relational-databases/replication/distributor-password.md)  
