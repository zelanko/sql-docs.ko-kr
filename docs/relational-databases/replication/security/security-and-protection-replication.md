...
# <a name="security-and-protection-replication"></a>보안 및 보호(복제)
  [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 에서 배포하는 복제 시나리오를 악의적인 공격으로부터 보호하고 데이터의 보안을 향상시키는 방법을 살펴봅니다.  
  
 ![작은 파일 폴더 아이콘](../../../analysis-services/media/filefolder-small.png "Small File Folder Icon") **보안 개요**  
 ...
 ![작은 파일 폴더 아이콘](../../../analysis-services/media/filefolder-small.png "Small File Folder Icon") **안전한 개발**  
 ...
 ![작은 파일 폴더 아이콘](../../../analysis-services/media/filefolder-small.png "Small File Folder Icon") **안전한 배포**  
 ...
 ![작은 파일 폴더 아이콘](../../../analysis-services/media/filefolder-small.png "Small File Folder Icon") **안전한 작업**  
