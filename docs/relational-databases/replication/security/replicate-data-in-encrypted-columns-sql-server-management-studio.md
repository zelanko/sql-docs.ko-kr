---
title: "암호화된 열의 데이터 복제(SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "암호화 [SQL Server], 데이터 복제"
  - "암호화 [SQL Server 복제]"
  - "게시 [SQL Server 복제], 암호화된 열"
...
---
# 암호화된 열의 데이터 복제(SQL Server Management Studio)
...
6.  게시를 구독합니다. 자세한 내용은 참조 [끌어오기 구독을 만들](../../../relational-databases/replication/create-a-pull-subscription.md) 또는 [밀어넣기 구독을 만들](../../../relational-databases/replication/create-a-push-subscription.md)합니다.  
...
8.  구독자에서 실행 [대칭 키 만들기](../../../t-sql/statements/create-symmetric-key-transact-sql.md) ALGORITHM, KEY_SOURCE 및 IDENTITY_VALUE에 대해 동일한 값을 사용 하 여 1 단계에서와 같이 합니다. ENCRYPTION BY에는 다른 값을 지정할 수 있습니다.  
