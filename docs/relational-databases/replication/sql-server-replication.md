---
title: "SQL  Server  복제 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
 ...
 **영역별 내용 찾아보기**  
 ![작은 파일 폴더 아이콘](../../analysis-services/media/filefolder-small.png "작은 파일 폴더 아이콘") [새로운 기능](../../relational-databases/replication/what-s-new-replication.md)  
  
 ![작은 파일 폴더 아이콘](../../analysis-services/media/filefolder-small.png "작은 파일 폴더 아이콘") [이전 버전과의 호환성](../../relational-databases/replication/replication-backward-compatibility.md)  
  
 ![작은 파일 폴더 아이콘](../../analysis-services/media/filefolder-small.png "작은 파일 폴더 아이콘") [복제 기능 및 태스크](../../relational-databases/replication/replication-features-and-tasks.md)  
  
 ![작은 파일 폴더 아이콘](../../analysis-services/media/filefolder-small.png "작은 파일 폴더 아이콘") [기술 참조](../../relational-databases/replication/technical-reference-replication.md)  
