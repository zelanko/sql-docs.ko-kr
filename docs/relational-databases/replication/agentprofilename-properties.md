---
description: '&lt;AgentProfileName&gt; 속성'
 ...
 **매개 변수**  
 프로필에 포함된 에이전트 매개 변수입니다. 프로필에서 각 매개 변수의 값을 반드시 지정할 필요는 없습니다. 지정한 에이전트에 유효한 모든 매개 변수를 보려면 **이 프로필에서 사용되는 매개 변수만 표시** 확인란의 선택을 취소합니다. 각 매개 변수에 대한 설명은 다음을 참조하십시오.  
 ...
 **값**  
 프로필의 매개 변수에 대해 지정된 값입니다. 사용자 정의 프로필에서는 이 필드를 편집할 수 있습니다.  
