---
title: "복제된 데이터베이스 백업 및 복원 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "복제 관리, 복원"
  - "복제된 데이터베이스 백업"
  - "백업 [SQL Server 복제], 백업 정보"
  - "복원 복제된 데이터베이스 [SQL Server 복제]"
  - "복구 [SQL Server 복제], 백구 정보"
  - "데이터베이스 복원 [SQL Server], 복제된 데이터베이스"
  - "데이터베이스 백업 [SQL Server], 복제된 데이터베이스"
  - "복원 [SQL Server 복제], 복원 정보"
  - "복구 [SQL Server 복제]"
  - "복제 [SQL Server], 관리"
  - "배포 데이터베이스 [SQL Server 복제], 백업"
  - "복원 [SQL Server 복제]"
  - "복제 관리, 백업"
...
> [!NOTE]  
>  로그 전달을 사용하는 경우 복제된 데이터베이스를 대기 서버로 복원할 수 있습니다. 자세한 내용은 참조 [로그 전달 및 복제 & #40; SQL Server 및 #41;](../../../database-engine/log-shipping/log-shipping-and-replication-sql-server.md)합니다.  
