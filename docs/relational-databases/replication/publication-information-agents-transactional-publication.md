---
title: "게시 정보, 에이전트(트랜잭션 게시) | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
 ...
 **에이전트**  
 게시와 연결된 각 복제 에이전트의 이름입니다. 배포 에이전트는 이 게시에 대한 구독과 연결됩니다. 자세한 내용은 참조 [정보 보기 및는 에이전트 구독 관련 & #40;에 대 한 작업 수행 복제 모니터 & #41;](../../relational-databases/replication/monitor/view information and perform tasks for subscription agents.md)합니다.  
