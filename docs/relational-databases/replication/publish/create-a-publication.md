...
description: SQL Server Management Studio, Transact-SQL 또는 복제 관리 개체를 사용하여 SQL Server에서 게시를 만드는 방법을 알아봅니다.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
-   게시 및 아티클 이름에는 %, \*, [, ], |, :, ", ? 등의 문자를 포함할 수 없습니다. , ' , \ , / , < , >. 이러한 문자를 포함하는 데이터베이스 개체를 복제하려면 **아티클 속성 - \<Article>** 대화 상자(마법사의 **아티클** 페이지에서 사용 가능)에서 개체 이름과 다른 아티클 이름을 지정해야 합니다.  
