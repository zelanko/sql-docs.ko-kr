---
title: "Oracle 게시자에 대한 데이터 형식 매핑 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
### FLOAT 및 NUMBER 형식  
 ...
 Oracle에서는 NUMBER(4,5)처럼 전체 자릿수보다 큰 소수 자릿수로 숫자를 정의할 수 있지만 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]에서는 전체 자릿수가 소수 자릿수보다 크거나 같아야 합니다. 보장 하기 위해 데이터가 잘리지 Oracle 게시자의 전체 자릿수 보다 클 경우, 전체 자릿수도 설정 되었습니다 눈금 데이터 형식을 매핑할 때: NUMBER(4,5) NUMERIC(5,5)로 매핑됩니다.  
...
### 큰 개체 유형  
 ...
 큰 개체 형식에 대 한 자세한 내용은 "큰 개체에 대 한 고려 사항" 섹션을 참조 [디자인 고려 사항 및 Oracle 게시자에 대 한 제한](../../../relational-databases/replication/non-sql/design-considerations-and-limitations-for-oracle-publishers.md)합니다.  
