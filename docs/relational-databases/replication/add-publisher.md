...
## 옵션  
 **추가**  
 시작 하는 추가할 게시자 유형을 선택 하려면 클릭은 **서버에 연결** 대화 상자입니다. 다음 옵션을 사용할 수 있습니다.  
...
-   **Oracle 게시자 추가...**  
     ...
     에 연결 된 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 사용 하 여 Oracle 게시자와 연결 된 배포자는 **서버에 연결** 대화 상자입니다.  
 ...
 **제거**  
 대화 상자 맨 위에 있는 표에서 게시자를 선택 하 고 클릭 **제거** 추가할 게시자 목록에서 게시자를 제거 하려면.  
  
> [!NOTE]  
>  이 단추를 사용하여 이미 복제 모니터에 표시된 게시자를 제거할 수는 없습니다. 제거 하려면 이미 표시 되어 있는 게시자 마우스 오른쪽 단추로 클릭 하 고 복제 모니터의 왼쪽된 창에서 게시자 **제거**합니다.  
