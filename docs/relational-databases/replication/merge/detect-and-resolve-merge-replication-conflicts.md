---
title: "병합 복제 충돌 감지 및 해결 | Microsoft Docs"
ms.custom: ""
ms.date: "12/09/2016"
...
-   클라이언트 구독(가져오기 구독의 기본 유형)을 사용하는 두 구독자 사이에 충돌이 발생하면 게시자와 동기화하는 첫 번째 구독자의 변경 내용이 유지되고 두 번째 구독자의 변경 내용은 삭제됩니다. 클라이언트 구독과 서버 구독을 지정 하는 방법에 대 한 정보를 참조 하십시오. [#40;는 병합 구독 유형 및 충돌 해결 우선 순위를 지정 합니다. SQL Server Management Studio & #41;](../../../relational-databases/replication/specify a merge subscription type and conflict resolution priority.md)합니다.  
