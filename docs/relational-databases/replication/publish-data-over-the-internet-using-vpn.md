---
title: "VPN을 사용하여 인터넷을 통해 데이터 게시 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "VPN [SQL Server 복제]"
  - "웹 게시 [SQL Server 복제], VPN"
  - "인터넷 [SQL Server 복제], VPN"
