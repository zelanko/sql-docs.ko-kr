---
title: "구독 관련 에이전트에 대한 정보 보기 및 태스크 수행(복제 모니터) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "에이전트 [SQL Server 복제], 정보 보기"
  - "복제 에이전트 정보 보기"
  - "에이전트 [SQL Server 복제], 복제 모니터 태스크"
...
manager: "jhubbard"
---
# 구독 관련 에이전트에 대한 정보 보기 및 태스크 수행(복제 모니터)
...
### 구독과 연결된 에이전트에 대한 정보를 보고 태스크를 수행하려면(모든 구독 탭)  
...
2.  **모든 구독** 탭을 클릭하여 구독에 대한 정보를 봅니다. 이 탭에서 다음과 같이 보다 자세한 정보에 액세스하고 태스크를 수행할 수도 있습니다.  
    ...
    -   구독에 연결 된 에이전트에 대 한 자세한 정보를 보려면 해당 구독을 마우스 오른쪽 단추로 클릭 **세부 정보 보기**합니다. 자세한 정보에는 에이전트 기록과 오류 메시지, 트랜잭션 복제에 대한 성능 통계 및 병합 복제에 대한 아티클 수준의 동기화 통계가 포함됩니다.  
    ...
    -   단일 병합 구독의 유효성을 검사 하려면 해당 구독을 마우스 오른쪽 단추로 클릭 **구독 유효성 검사**합니다. 병합 게시에 대 한 모든 구독 유효성을 검사 하려면 해당 게시를 마우스 오른쪽 단추로 클릭 **모든 구독 유효성 검사**트랜잭션 게시에 대 한 모든 구독의 유효성을 검사할 게시를 마우스 오른쪽 단추로 클릭 하 고 클릭 하 고, **구독 유효성 검사**합니다.  
...
### 구독과 관련된 에이전트에 대한 정보를 보고 태스크를 수행하려면(구독 조사 목록 탭)  
