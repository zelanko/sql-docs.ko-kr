---
title: "Microsoft 복제 충돌 뷰어(트랜잭션 복제) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Microsoft 복제 충돌 뷰어(트랜잭션 복제)
  복제 충돌 뷰어에서는 지연 업데이트 구독을 사용하는 트랜잭션 복제 및 피어 투 피어 트랜잭션 복제에서 동기화 중 발생한 충돌을 볼 수 있습니다. 자세한 내용은 참조 [#40; 및 트랜잭션 게시에 대 한 데이터 충돌 보기 SQL Server Management Studio & #41;](../../relational-databases/replication/view-data-conflicts-for-transactional-publications-sql-server-management-studio.md)합니다.  
...
## 옵션  
 ...
 아래쪽 섹션에서 충돌 데이터는 해당 하는 열에 표시 됩니다 (**충돌 시 적용 되** 및 **충돌 시 무시 되**). 업데이트된 데이터와 삭제된 데이터 간에 충돌이 있다면 충돌 시 삭제된 쪽을 표시하는 데이터는 없습니다. 이 경우 복제 충돌 뷰어에서는 행이 한 위치에서 삭제되었고 다른 위치에서는 업데이트되었음을 나타내는 메시지를 열 중 하나에 표시합니다. 권장 해결 방법도 표시됩니다.  
...
## 참고 항목  
 [피어 투 피어 복제에서 충돌 검색](../../relational-databases/replication/transactional/conflict-detection-in-peer-to-peer-replication.md)   
