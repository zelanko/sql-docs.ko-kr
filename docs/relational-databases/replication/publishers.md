 ...
 **추가**  
 허용 하려는 서버가 목록, 클릭 **추가** 추가 하는 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 게시자 또는 Oracle 게시자를 사용할 수 있는 게시자 목록입니다.  
