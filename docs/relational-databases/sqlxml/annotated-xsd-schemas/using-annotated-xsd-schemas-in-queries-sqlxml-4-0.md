---
title: 쿼리에 주석이 추가 된 XSD 스키마 사용 (SQLXML)
description: SQLXML 4.0의 주석이 추가 된 XSD 스키마에 대해 XPath 쿼리를 지정 하 여 데이터베이스에서 데이터를 검색 하는 방법에 대해 알아봅니다.
ms.date: 01/11/2019
ms.prod: sql
...
```  
 ...
 그러면 SQLXML 4.0 테스트 스크립트(Sqlxml4test.vbs)를 만들어서 사용하여 템플릿 파일의 일부로 쿼리를 실행할 수 있습니다. 자세한 내용은 [SQLXML 4.0&#41;에서 사용 되지 &#40;주석이 추가 된 XDR 스키마 ](../../../relational-databases/sqlxml/annotated-xsd-schemas/annotated-xdr-schemas-deprecated-in-sqlxml-4-0.md)를 참조 하세요.  
