...
```  
 ...
 매핑 스키마에는  **\<연락처 >** 요소는 사용 하 여 샘플 AdventureWorks 데이터베이스의 Person.Contact 테이블에 매핑됩니다는 **sql: relation** 주석입니다. ConID, FName 및 LName 특성은 사용 하 여 Person.Contact 테이블의 ContactID, FirstName 및 LastName 열에 매핑됩니다는 **sql: field** 주석입니다.  
