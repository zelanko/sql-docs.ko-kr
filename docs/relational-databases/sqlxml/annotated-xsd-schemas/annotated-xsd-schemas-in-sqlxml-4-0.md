...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]이 섹션에서는 SQLXML 4.0에서 주석이 추가 된 XSD 스키마를 사용 하는 방법에 대 한 정보를 제공 합니다. 이전 버전의 SQLXML에서는 XDR(XML-Data Reduced) 스키마를 통해 비슷한 기능이 제공되었습니다. 이 섹션에서는 레거시 응용 프로그램을 위한 XDR 정보도 제공합니다.  
...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [XSD 스키마 &#40;에서 주석 사용 SQLXML 4.0 &#41;](../../../relational-databases/sqlxml-annotated-xsd-schemas-using/using-annotations-in-xsd-schemas-sqlxml-4-0.md)  
 ...
 주석이 추가된 XSD 스키마를 쿼리에 사용하는 방법을 설명합니다.  
  
 [주석이 추가 된 XDR 스키마를 해당 XSD 스키마 &#40; 변환 SQLXML 4.0 &#41;](../../../relational-databases/sqlxml/annotated-xsd-schemas/converting-annotated-xdr-schemas-to-equivalent-xsd-schemas-sqlxml-4-0.md)  
 XDR 스키마를 SQLXML 4.0에서 사용할 수 있는 해당 XSD 스키마로 변환하는 방법을 설명합니다.  
