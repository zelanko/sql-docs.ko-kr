...
> [!NOTE]  
>  이 항목에서는 이미 FOR XML 절에 익숙한 사용자를 대상으로 클라이언트 쪽의 FOR XML 절 사용에 대한 추가 정보를 제공합니다. FOR XML에 대 한 자세한 내용은 [구성 XML을 사용 하 여 FOR XML](../../../relational-databases/xml/for-xml-sql-server.md).  
...
> [!NOTE]  
>  SQLXMLOLEDB 공급자 또는 SQLXML 관리 되는 클래스를 사용 하는 경우 사용할 수 있습니다는 **ClientSideXml** 속성을 클라이언트 쪽 XML 서식을 요청 합니다.  
...
## <a name="see-also"></a>관련 항목  
 ...
 [xml에서 SQLXML 4.0 데이터 형식 지원](../../../relational-databases/sqlxml/xml-data-type-support-in-sqlxml-4-0.md)   
