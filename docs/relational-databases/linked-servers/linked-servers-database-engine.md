---
title: "연결된 서버(데이터베이스 엔진) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "OLE DB, 연결된 서버"
  - "OLE DB 공급자, 연결된 서버"
  - "서버 관리 [SQL Server], 연결된 서버"
  - "연결된 서버 [SQL Server]"
  - "분산 쿼리 [SQL Server], 연결된 서버"
  - "서버 [SQL Server], 연결됨"
  - "원격 서버 [SQL Server], 연결된 서버"
  - "연결된 서버 [SQL Server], 연결된 서버 정보"
