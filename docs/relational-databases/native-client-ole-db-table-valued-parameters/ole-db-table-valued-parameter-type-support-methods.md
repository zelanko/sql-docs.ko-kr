---
description: SQL Server Native Client에서 OLE DB Table-Valued 매개 변수 형식 지원 (메서드)
title: OLE DB Table-Valued 매개 변수 형식 (메서드)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97484945"
---
# <a name="ole-db-table-valued-parameter-type-support-in-sql-server-native-client-methods"></a>SQL Server Native Client에서 OLE DB Table-Valued 매개 변수 형식 지원 (메서드)
