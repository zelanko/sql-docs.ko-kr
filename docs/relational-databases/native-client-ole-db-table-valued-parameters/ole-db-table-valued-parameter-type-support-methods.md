...
|ISSCommandWithParameters::SetParameterInfo|테이블 반환 매개 변수의 명령 매개 변수를 지정하려면 소비자가 DBPARAMBINDINFO 구조체의 *pwszName* 멤버에서 매개 변수 형식을 "table" 또는 "DBTYPE_TABLE"로 지정합니다. 합니다 *ulParamSize* 로 ~ 0입니다. 자세한 내용은 "테이블 반환 매개 변수 사양"를 참조 하세요 [Executing Commands Containing Table-Valued 매개 변수](../../relational-databases/native-client-ole-db-table-valued-parameters/executing-commands-containing-table-valued-parameters.md)합니다.|  
