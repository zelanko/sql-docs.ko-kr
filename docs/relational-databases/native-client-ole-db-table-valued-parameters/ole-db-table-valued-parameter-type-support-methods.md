---
title: OLE DB 테이블 값 매개 변수 유형(메서드)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
## <a name="see-also"></a>참고 항목  
 ...
 [테이블 값 매개 변수 행 집합 생성](../../relational-databases/native-client-ole-db-table-valued-parameters/table-valued-parameter-rowset-creation.md)   
