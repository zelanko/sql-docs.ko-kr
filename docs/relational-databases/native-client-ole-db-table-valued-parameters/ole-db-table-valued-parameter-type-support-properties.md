---
description: SQL Server Native Client에서 OLE DB Table-Valued 매개 변수 형식 지원 (속성)
title: OLE DB Table-Valued 매개 변수 형식 (속성)
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.locfileid: "97469284"
---
# <a name="ole-db-table-valued-parameter-type-support-in-sql-server-native-client-properties"></a>SQL Server Native Client에서 OLE DB Table-Valued 매개 변수 형식 지원 (속성)
