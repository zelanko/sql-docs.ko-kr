---
description: SQL Server Native Client의 테이블 반환 매개 변수 (OLE DB)
...
ms.locfileid: "88499048"
---
# <a name="table-valued-parameters--in-sql-server-native-client-ole-db"></a>SQL Server Native Client의 테이블 반환 매개 변수 (OLE DB)
