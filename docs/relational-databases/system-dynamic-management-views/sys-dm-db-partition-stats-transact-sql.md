...
## <a name="permissions"></a>Permissions  
 쿼리하려면 VIEW DATABASE STATE 권한이 필요는 **sys.dm_db_partition_stats** 동적 관리 뷰. 동적 관리 뷰 사용 권한에 대 한 자세한 내용은 참조 [동적 관리 뷰 및 함수 &#40; Transact SQL &#41; ](~/relational-databases/system-dynamic-management-views/system-dynamic-management-views.md).  
