...
## <a name="remarks"></a>주의  
 동적 관리 뷰에 대 한 자세한 내용은 참조 하세요. [동적 관리 뷰 및 함수 &#40; Transact SQL &#41; ](~/relational-databases/system-dynamic-management-views/system-dynamic-management-views.md) 에 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 온라인 설명서.  
