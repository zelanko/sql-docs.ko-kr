...
|**transport_stream_id**|**uniqueidentifier**|식별자는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] TCP/IP 통신에 대 한이 연결에서 사용 하는 네트워크 인터페이스 (SNI) 연결 합니다.|  
|**state**|**smallint**|연결의 현재 상태입니다. 가능한 값:<br /><br /> 1 = NEW<br /><br /> 2 = CONNECTING<br /><br /> 3 = CONNECTED<br /><br /> 4 = LOGGED_IN<br /><br /> 5 = 종료|  
|**state_desc**|**nvarchar(60)**|연결의 현재 상태입니다. 가능한 값:<br /><br /> NEW<br /><br /> CONNECTING<br /><br /> CONNECTED<br /><br /> LOGGED_IN<br /><br /> CLOSED|  
