...
-   [sys.databases](~/relational-databases/system-catalog-views/sys-databases-transact-sql.md)**Log_reuse_wait_desc** 열 값이 "AVAILABILITY_REPLICA" 인 경우 가용성 그룹의 보조 복제본이 지정 된 주 데이터베이스에서 로그 잘림을 보류 하 고 있습니까?     
