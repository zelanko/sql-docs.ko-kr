...
---
# <a name="sysdm_pdw_nodes_exec_query_profiles-transact-sql"></a>_pdw_nodes_exec_query_profiles (Transact-sql)
...
[_Exec_query_profiles](https://docs.microsoft.com/sql/relational-databases/system-dynamic-management-views/sys-dm-exec-query-profiles-transact-sql?view=sql-server-ver15) 에 동일한 설명이 적용 됩니다.  
