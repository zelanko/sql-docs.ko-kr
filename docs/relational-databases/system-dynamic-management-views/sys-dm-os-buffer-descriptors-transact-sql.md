...
> **참고:** 또는에서이를 호출 하려면 [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] [!INCLUDE[ssPDW](../../includes/sspdw-md.md)] **sys.dm_pdw_nodes_os_buffer_descriptors** 이름을 사용 합니다.  
...
## <a name="remarks"></a>설명  
 sys.dm_os_buffer_descriptors는 리소스 데이터베이스에서 사용 중인 페이지를 반환 합니다. sys.dm_os_buffer_descriptors은 사용 가능한 페이지나 도난당 한 페이지 또는 읽을 때 오류가 발생 한 페이지에 대 한 정보를 반환 하지 않습니다.  
