...
> [!NOTE]  
>  또는에서이 DMV를 호출 하려면 [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] [!INCLUDE[ssPDW](../../includes/sspdw-md.md)] **sys.dm_pdw_nodes_tran_database_transactions** 이름을 사용 합니다.  
...
## <a name="see-also"></a>참고 항목  
 [Transact-sql&#41;sys.dm_tran_active_transactions &#40;](../../relational-databases/system-dynamic-management-views/sys-dm-tran-active-transactions-transact-sql.md)   
