...
|**artcmdtype**|**tinyint**|현재 복제 중인 명령의 유형이며 다음 값 중 하나가 될 수 있습니다.<br /><br /> **1** = INSERT<br /><br /> **2** = DELETE<br /><br /> **3** = UPDATE<br /><br /> **4** = UPDATETEXT<br /><br /> **5** = 없음<br /><br /> **6** = 내부 전용<br /><br /> **7** = 내부 전용<br /><br /> **8** = 부분 UPDATE|  
