---
title: sys. dm _db_sststststststststststststststststststststststg Microsoft Docs
ms.custom: ''
ms.date: 08/23/2017
ms.prod: sql
ms.reviewer: ''
...
## <a name="remarks"></a>설명  
 ...
 sys. dm _db_sstststststststststststststststststststl_l는 특정 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 버전으로 제한 되는 다음과 같은 데이터베이스 변경 기능  
