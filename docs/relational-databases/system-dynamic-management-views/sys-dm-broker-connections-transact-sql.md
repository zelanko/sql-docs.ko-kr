...
## <a name="physical-joins"></a>물리적 조인  
 ![sys.dm_broker_connections에 대한 조인](../../relational-databases/system-dynamic-management-views/media/join-dm-broker-connections-1.gif "sys.dm_broker_connections에 대한 조인")  
