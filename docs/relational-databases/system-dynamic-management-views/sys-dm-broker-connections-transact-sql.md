...
|**state**|**smallint**|연결의 현재 상태입니다. NULL을 허용합니다. 가능한 값:<br /><br /> 1 = NEW<br /><br /> 2 = CONNECTING<br /><br /> 3 = CONNECTED<br /><br /> 4 = LOGGED_IN<br /><br /> 5 = 종료|  
