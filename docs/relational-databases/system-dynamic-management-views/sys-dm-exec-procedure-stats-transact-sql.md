...
> 또는 [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] [!INCLUDE[ssPDW](../../includes/sspdw-md.md)]에서이를 호출 하려면 이름 **sys. dm_pdw_nodes_exec_procedure_stats**을 사용 합니다. 
...
|**total_spills**|**bigint**|이 저장 프로시저가 컴파일된 이후 실행 될 때 발생 한 총 페이지 수입니다.<br /><br /> **적용 대상**: [!INCLUDE[ssSQL17](../../includes/sssql17-md.md)] CU3부터 시작|  
|**last_spills**|**bigint**|저장 프로시저가 마지막으로 실행 되었을 때에 분산 된 페이지의 수입니다.<br /><br /> **적용 대상**: [!INCLUDE[ssSQL17](../../includes/sssql17-md.md)] CU3부터 시작|  
|**min_spills**|**bigint**|단일 실행 중이 저장 프로시저가 연결한 최소 페이지 수입니다.<br /><br /> **적용 대상**: [!INCLUDE[ssSQL17](../../includes/sssql17-md.md)] CU3부터 시작|  
|**max_spills**|**bigint**|단일 실행 중이 저장 프로시저가 연결한 최대 페이지 수입니다.<br /><br /> **적용 대상**: [!INCLUDE[ssSQL17](../../includes/sssql17-md.md)] CU3부터 시작|  
