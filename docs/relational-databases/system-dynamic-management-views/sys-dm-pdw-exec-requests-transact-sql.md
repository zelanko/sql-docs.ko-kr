...
|label|**nvarchar(255)**|일부 선택 쿼리 문과 연결 된 선택적 레이블 문자열입니다.|문자열을 포함 하는 ' a ~ z', ' A-z ','0-9', '_'.|  
...
|result_set_cache|**bit**|완료 된 쿼리 결과가 캐시 적중 (1) 인지 여부를 세부 정보 (0).|0, 1|
||||
