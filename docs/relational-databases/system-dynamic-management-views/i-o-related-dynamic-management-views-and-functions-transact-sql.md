---
description: I/O 관련 동적 관리 뷰 및 함수(Transact-SQL)
title: I/o 관련 동적 관리 뷰 및 함수 (Transact-sql) | Microsoft Docs
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "89519134"
---
# <a name="io-related-dynamic-management-views-and-functions-transact-sql"></a>I/O 관련 동적 관리 뷰 및 함수(Transact-SQL)
