...
2015-07-13 일부 터 'sys.dm_xe_objects' 이름에 ' _database 포함 하지 않는 이러한 Xevent Dmv 중 하나입니다. 오타 또는 다음 테이블의 오른쪽 열에는 오류가 아닙니다. 이름은 Microsoft SQL Server 및 Azure SQL Database에서 동일 합니다.  
