...
|memory_consumer_desc|**nvarchar (64)**|메모리 소비자 인스턴스에 대한 설명입니다.<br /><br /> VARHEAP <br />시스템 힙입니다. 범용입니다. 현재, 가비지 수집 작업 항목을 할당하는 데만 사용됩니다.<br />또는<br />할당 준비 힙입니다. 할당 준비 목록에 포함된 항목 수가 미리 결정된 캡(일반적으로 약 5,000개 항목)에 도달할 경우 할당 준비에 사용됩니다.<br /><br /> PGPOOL: IO 시스템 풀의 경우 세 가지 크기 (시스템 4K 페이지 풀, 시스템 64 K 페이지 풀 및 시스템 256 K 페이지 풀)가 있습니다.|  
