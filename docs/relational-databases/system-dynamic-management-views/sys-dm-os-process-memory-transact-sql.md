...
> [!NOTE]  
>  또는 [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] [!INCLUDE[ssPDW](../../includes/sspdw-md.md)]에서이를 호출 하려면 이름 **sys. dm_pdw_nodes_os_process_memory**을 사용 합니다.  
...
|**page_fault_count**|**bigint**|
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 프로세스에서 발생한 페이지 폴트 수를 나타냅니다. Null을 허용하지 않습니다.|  
