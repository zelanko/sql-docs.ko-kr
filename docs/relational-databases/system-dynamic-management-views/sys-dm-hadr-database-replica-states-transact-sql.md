 ...
 **end_of_log_lsn**하십시오 **last_hardened_lsn**, 및 **recovery_lsn** 은 플러시 Lsn입니다. 예를 들어 **last_hardened_lsn** 은 디스크에 이미 있는 블록의 다음 블록의 시작을 나타냅니다.  따라서 모든 LSN < 값 **last_hardened_lsn** 디스크에 있습니다.  LSN > =이 값은 플러시되지 않습니다.  
