...
# [지역에서 복제(Azure SQL Database)](geo-replication-dynamic-management-views-and-functions-azure-sql-database.md)  
...
# [메모리 최적화 테이블](memory-optimized-table-dynamic-management-views-transact-sql.md)  
...
# [SQL Data Warehouse 및 병렬 데이터 웨어하우스](sql-and-parallel-data-warehouse-dynamic-management-views.md)  
