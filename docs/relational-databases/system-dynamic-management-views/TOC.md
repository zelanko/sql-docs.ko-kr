# [개요](system-dynamic-management-views.md)  

# [Always On 가용성 그룹](always-on-availability-groups-dynamic-management-views-functions.md)  
...
# [공용 언어 런타임](common-language-runtime-related-dynamic-management-views-transact-sql.md)  
...
# [데이터베이스](database-related-dynamic-management-views-transact-sql.md)  
...
## [sys.dm_db_objects_impacted_on_version_change (Azure SQL 데이터베이스)](sys-dm-db-objects-impacted-on-version-change-azure-sql-database.md)  
...
## [sys.dm_db_wait_stats (Azure SQL 데이터베이스)](sys-dm-db-wait-stats-azure-sql-database.md)  
## [sys.dm_operation_status (Azure SQL 데이터베이스)](sys-dm-operation-status-azure-sql-database.md)  
## [sys.dm_database_copies (Azure SQL 데이터베이스)](sys-dm-database-copies-azure-sql-database.md)  
## [sys.dm_db_resource_stats (Azure SQL 데이터베이스)](sys-dm-db-resource-stats-azure-sql-database.md)  
...
# [실행](execution-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [확장 이벤트](extended-events-dynamic-management-views.md)  
## [sys.dm_xe_database_sessions (Azure SQL 데이터베이스)](sys-dm-xe-database-sessions-azure-sql-database.md)  
## [sys.dm_xe_database_session_targets (Azure SQL 데이터베이스)](sys-dm-xe-database-session-targets-azure-sql-database.md)  
## [sys.dm_xe_database_session_object_columns (Azure SQL 데이터베이스)](sys-dm-xe-database-session-object-columns-azure-sql-database.md)  
## [sys.dm_xe_database_session_events (Azure SQL 데이터베이스)](sys-dm-xe-database-session-events-azure-sql-database.md)  
## [sys.dm_xe_database_session_event_actions (Azure SQL 데이터베이스)](sys-dm-xe-database-session-event-actions-azure-sql-database.md)  
...
# [Filestream 및 FileTable](filestream-and-filetable-dynamic-management-views-transact-sql.md)  
...
# [전체 텍스트 검색 및 의미 체계 검색](full-text-and-semantic-search-dynamic-management-views-functions.md)  
...
# [지리적 복제 (Azure SQL 데이터베이스)](geo-replication-dynamic-management-views-and-functions-azure-sql-database.md)  
## [sys.geo_replication_links (Azure SQL 데이터베이스)](sys-geo-replication-links-azure-sql-database.md)  
## [sys.dm_geo_replication_link_status (Azure SQL 데이터베이스)](sys-dm-geo-replication-link-status-azure-sql-database.md)  
## [sys.dm_continuous_copy_status (Azure SQL 데이터베이스)](sys-dm-continuous-copy-status-azure-sql-database.md)  
...
# [O I](i-o-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [메모리 액세스에 최적화 된 테이블](memory-optimized-table-dynamic-management-views-transact-sql.md)  
...
# [개체](object-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [복제](replication-related-dynamic-management-views-transact-sql.md)  
...
# [리소스 관리자](resource-governor-related-dynamic-management-views-transact-sql.md)  
...
# [보안 관련](security-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [서버 관련](server-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [SQL 데이터 웨어하우스 및 병렬 데이터 웨어하우스](sql-and-parallel-data-warehouse-dynamic-management-views.md)  
...
# [SQL Server 운영 체제](sql-server-operating-system-related-dynamic-management-views-transact-sql.md)  
...
# [의](transaction-related-dynamic-management-views-and-functions-transact-sql.md)  
