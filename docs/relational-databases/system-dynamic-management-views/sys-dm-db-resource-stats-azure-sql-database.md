...
> [!TIP]  
> 이러한 제한 및 서비스 계층에 대 한 자세한 내용은 [서비스 계층](https://azure.microsoft.com/documentation/articles/sql-database-service-tiers/)항목을 참조 하 고, [Azure SQL Database에서 쿼리 성능을 수동으로 조정](https://azure.microsoft.com/documentation/articles/sql-database-performance-guidance/)하 고, [리소스 제한과 리소스 관리를 SQL Database](https://docs.microsoft.com/azure/sql-database/sql-database-resource-limits-database-server).
...
## <a name="see-also"></a>참고 항목  
 [resource_stats &#40;Azure SQL Database&#41;](../../relational-databases/system-catalog-views/sys-resource-stats-azure-sql-database.md) [서비스 계층](https://azure.microsoft.com/documentation/articles/sql-database-service-tiers/)
