...
|**lob_fetch_in_pages**|**bigint**|LOB_DATA 할당 단위에서 검색된 LOB(Large Object) 페이지의 누적 개수입니다. 이러한 페이지는 데이터 형식의 열에 저장 된 포함 **텍스트**를 **ntext**를 **이미지**를 **varchar (max)**, **nvarchar ( max)** 하십시오 **varbinary (max)**, 및 **xml**합니다. 자세한 내용은 [데이터 형식&#40;Transact-SQL&#41;](../../t-sql/data-types/data-types-transact-sql.md)을 참조하세요.|    
