...
|**sqlserver_start_time_ms_ticks**|**bigint**|마지막으로 시작 된 ms_tick 번호를 나타냅니다. **ms_tick** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 현재 ms_ticks 열과 비교됩니다. Null을 허용하지 않습니다.|  
