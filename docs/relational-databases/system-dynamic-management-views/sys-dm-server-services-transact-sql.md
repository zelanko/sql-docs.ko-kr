...
|status|**int**|서비스의 현재 상태를 나타냅니다. 다음은 가능한 값과 해당 설명입니다.<br /><br /> 1: 중지 됨<br />2: 기타 (시작 보류 중)<br />3: 기타 (중지 보류 중)<br />4: 실행 중<br />5: 기타 (계속 보류 중)<br />6: 기타 (일시 중지 보류 중)<br />7: 일시 중지 됨<br /><br /> Null을 허용합니다.|  
