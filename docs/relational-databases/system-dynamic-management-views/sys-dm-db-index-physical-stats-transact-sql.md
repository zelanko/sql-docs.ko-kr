...
|version_ghost_record_count|**bigint**|할당 단위에서 처리 중인 스냅샷 격리 트랜잭션이 보유하고 있는 삭제할 레코드 수입니다.<br /><br /> IN_ROW_DATA 할당 단위에서 리프가 아닌 인덱스 수준에 대해 0입니다.<br /><br /> 인 경우 NULL *모드* = LIMITED입니다.|  
