...
|hobt_id|bigint|Columnstore 인덱스의 경우에는 파티션에 대 한 내부 columnstore 데이터를 추적 하는 행 집합의 ID입니다. 행 집합은 데이터 힙 또는 이진 트리로 저장 됩니다. 부모 columnstore 인덱스와 동일한 인덱스 ID를 가집니다. 자세한 내용은 [sys.internal_partitions &#40;transact-sql&#41;](../../relational-databases/system-catalog-views/sys-internal-partitions-transact-sql.md)를 참조 하세요.<br /><br /> If 인 경우 NULL <br /><br /> **적용 대상**: SQL Server 2016 이상, Azure SQL Database, Azure SQL Managed Instance|  
