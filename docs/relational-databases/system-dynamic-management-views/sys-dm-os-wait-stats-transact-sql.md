...
|ASYNC_OP_COMPLETION |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|ASYNC_OP_CONTEXT_READ |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|ASYNC_OP_CONTEXT_WRITE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|ASYNC_SOCKETDUP_IO |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|BLOB_METADATA |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|BROKER_DISPATCHER |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|BROKER_FORWARDER |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|BROKER_START |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|BROKER_TASK_SHUTDOWN |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|BROKER_TASK_STOP |Service Broker queue 작업 처리기가 작업을 종료 하려고 할 때 발생 합니다. 상태 검사가 직렬화되고 먼저 실행 상태에 있어야 합니다.| 
|BROKER_TASK_SUBMIT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
...
|CHECK_TABLES_THREAD_BARRIER |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|CMEMPARTITIONED |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|CMEMTHREAD |태스크가 스레드로부터 안전한 메모리 개체를 기다리는 경우에 발생합니다. 여러 태스크가 같은 메모리 개체의 메모리를 할당하려고 하여 경합이 발생할 때 대기 시간이 증가할 수 있습니다.| 
|COLUMNSTORE_BUILD_THROTTLE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|COLUMNSTORE_COLUMNDATASET_SESSION_LIST |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|COMMIT_TABLE |내부적으로만 사용됩니다.| 
|CONNECTION_ENDPOINT_LOCK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|COUNTRECOVERYMGR |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|CREATE_DATINISERVICE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|DBSEEDING_FLOWCONTROL |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|DBSEEDING_OPERATION |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
...
|DIRECTLOGCONSUMER_LIST |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|DIRTY_PAGE_POLL |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|DIRTY_PAGE_SYNC |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|DIRTY_PAGE_TABLE_LOCK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|DISPATCHER_PRIORITY_QUEUE_SEMAPHORE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|DPT_ENTRY_LOCK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|DROP_DATABASE_TIMER_TASK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
...
|DTCNEW_ENLIST |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|DTCNEW_PREPARE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|DTCNEW_RECOVERY |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|DTCNEW_TM |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|DTCNEW_TRANSACTION_ENLISTMENT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|EXTERNAL_RG_UPDATE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|EXTERNAL_SCRIPT_NETWORK_IO |내부적으로만 사용됩니다. <br /><br /> **적용**대상: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 부터 현재까지| 
|EXTERNAL_SCRIPT_PREPARE_SERVICE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|EXTERNAL_SCRIPT_SHUTDOWN |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|EXTERNAL_WAIT_ON_LAUNCHER, |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|FABRIC_HADR_TRANSPORT_CONNECTION |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|FABRIC_REPLICA_CONTROLLER_LIST |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|FABRIC_REPLICA_CONTROLLER_STATE_AND_CONFIG |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
...
|FFT_NSO_DB_KILL_FLAG |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FFT_NSO_DB_LIST |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FFT_NSO_FCB |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FFT_NSO_FCB_FIND |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FFT_NSO_FCB_PARENT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FFT_NSO_FCB_RELEASE_CACHED_ENTRIES |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FFT_NSO_FCB_STATE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|FFT_NSO_FILEOBJECT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FFT_NSO_TABLE_LIST |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FFT_NTFS_STORE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FFT_RECOVERY |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FFT_RSFX_COMM |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FFT_RSFX_WAIT_FOR_MEMORY |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FFT_STARTUP_SHUTDOWN |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FFT_STORE_DB |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FFT_STORE_ROWSET_LIST |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FFT_STORE_TABLE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FILE_VALIDATION_THREADS |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|FILESTREAM_CACHE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FILESTREAM_CHUNKER |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FILESTREAM_CHUNKER_INIT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FILESTREAM_FCB |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FILESTREAM_FILE_OBJECT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FILESTREAM_WORKITEM_QUEUE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FILETABLE_SHUTDOWN |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|FOREIGN_REDO |내부적으로만 사용됩니다. <br /><br /> **적용**대상: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 부터 현재까지| 
|FORWARDER_TRANSITION |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|GDMA_GET_RESOURCE_OWNER |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|GHOSTCLEANUP_UPDATE_STATS |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
|GHOSTCLEANUPSYNCMGR |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|GLOBAL_QUERY_CANCEL |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
|GLOBAL_QUERY_CLOSE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|GLOBAL_QUERY_CONSUMER |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
...
|HADR_AR_UNLOAD_COMPLETED |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|HADR_ARCONTROLLER_NOTIFICATIONS_SUBSCRIBER_LIST |상태 변경 또는 구성 변경 등의 가용성 복제본 이벤트에 대한 게시자가 이벤트 구독자 목록에 대한 단독 읽기/쓰기 액세스를 기다리고 있습니다. 내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|HADR_CONNECTIVITY_INFO |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|HADR_DATABASE_WAIT_FOR_RECOVERY |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|HADR_DBR_SUBSCRIBER |상태 변경 또는 구성 변경 등의 가용성 복제본 이벤트에 대한 게시자가 가용성 데이터베이스에 해당하는 이벤트 구독자의 런타임 상태에 대한 단독 읽기/쓰기 액세스를 기다리고 있습니다. 내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|HADR_DBR_SUBSCRIBER_FILTER_LIST |상태 변경 또는 구성 변경 등의 가용성 복제본 이벤트에 대한 게시자가 가용성 데이터베이스에 해당하는 이벤트 구독자 목록에 대한 단독 읽기/쓰기 액세스를 기다리고 있습니다. 내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|HADR_DBSEEDING |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|HADR_DBSEEDING_LIST |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|HADR_DBSTATECHANGE_SYNC |데이터베이스 복제본의 내부 상태를 업데이트하기 위한 동시성 제어 대기입니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|HADR_FABRIC_CALLBACK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
...
|HADR_FILESTREAM_PREPROC |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|HADR_NOTIFICATION_DEQUEUE |Windows Server 장애 조치(Failover) 클러스터링 알림을 처리하는 백그라운드 태스크가 다음 알림을 기다리고 있습니다. 내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|HADR_NOTIFICATION_WORKER_EXCLUSIVE_ACCESS |Always On 가용성 복제본 관리자가 Windows Server 장애 조치 (Failover) 클러스터링 알림을 처리 하는 백그라운드 작업의 런타임 상태에 대 한 직렬화 된 액세스를 기다리고 있습니다. 내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|HADR_SEEDING_CANCELLATION |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|HADR_SEEDING_FILE_LIST |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|HADR_SEEDING_LIMIT_BACKUPS |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|HADR_SEEDING_SYNC_COMPLETION |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|HADR_SEEDING_TIMEOUT_TASK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|HADR_SEEDING_WAIT_FOR_COMPLETION |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|HADR_TDS_LISTENER_SYNC |내부 Always On 시스템 또는 WSFC 클러스터에서 수신기가 시작 되거나 중지 되도록 요청 합니다. 이 요청의 처리는 항상 비동기이며 중복 요청을 제거하는 메커니즘이 있습니다. 또한 구성 변경으로 인해 이 프로세스가 일시 중단 되는 순간이 있습니다. 이 수신기 동기화 메커니즘과 관련된 모든 대기는 이 대기 유형을 사용합니다. 내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|HADR_THROTTLE_LOG_RATE_GOVERNOR |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|HADR_THROTTLE_LOG_RATE_LOG_SIZE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
|HADR_THROTTLE_LOG_RATE_SEEDING |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
|HADR_THROTTLE_LOG_RATE_SEND_RECV_QUEUE_SIZE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
...
|HCCO_CACHE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|HK_RESTORE_FILEMAP |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|HKCS_PARALLEL_MIGRATION |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|HKCS_PARALLEL_RECOVERY |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|LOG_POOL_SCAN |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|LOGPOOL_CACHESIZE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|LOGPOOL_CONSUMER |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|LOGPOOL_CONSUMERSET |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|LOGPOOL_FREEPOOLS |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|LOGPOOL_MGRSET |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|LOGPOOL_REPLACEMENTSET |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|LOGPOOLREFCOUNTEDOBJECT_REFDONE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|LOWFAIL_MEMMGR_QUEUE |메모리를 사용할 수 있을 때까지 대기하는 동안 발생합니다.| 
|MD_AGENT_YIELD |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|MD_LAZYCACHE_RWLOCK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|NETWORKSXMLMGRLOAD |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|PARALLEL_REDO_DRAIN_WORKER |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|PARALLEL_REDO_FLOW_CONTROL |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|PARALLEL_REDO_LOG_CACHE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|PARALLEL_REDO_TRAN_LIST |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|PARALLEL_REDO_TRAN_TURN |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|PARALLEL_REDO_WORKER_SYNC |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|PARALLEL_REDO_WORKER_WAIT_WORK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|PREEMPTIVE_HTTP_EVENT_WAIT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|PREEMPTIVE_HTTP_REQUEST |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|PREEMPTIVE_OS_GETFINALFILEPATHBYHANDLE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|PREEMPTIVE_OS_PDH_WMI_INIT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|PREEMPTIVE_OS_PIPEOPS |내부적으로만 사용됩니다.| 
|PREEMPTIVE_OS_PROCESSOPS |내부적으로만 사용됩니다.| 
|PREEMPTIVE_OS_QUERYCONTEXTATTRIBUTES |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|PREEMPTIVE_OS_SQMLAUNCH |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] 부터 [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)]까지 |  
|PREEMPTIVE_OS_VERIFYSIGNATURE |내부적으로만 사용됩니다.| 
|PREEMPTIVE_OS_VERIFYTRUST |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|PREEMPTIVE_XE_CX_FILE_OPEN |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|PREEMPTIVE_XE_CX_HTTP_CALL |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
...
|PWAIT_COOP_SCAN |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|PWAIT_DIRECTLOGCONSUMER_GETNEXT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|PWAIT_EVENT_SESSION_INIT_MUTEX |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|PWAIT_FABRIC_REPLICA_CONTROLLER_DATA_LOSS |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|PWAIT_HADR_ACTION_COMPLETED |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|PWAIT_HADR_FAILOVER_COMPLETED |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|PWAIT_HADR_JOIN |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
...
|PWAIT_HADR_SERVER_READY_CONNECTIONS |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|PWAIT_HADRSIM |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|PWAIT_LOG_CONSOLIDATION_IO |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|PWAIT_LOG_CONSOLIDATION_POLL |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
...
|PWAIT_PREEMPTIVE_APP_USAGE_TIMER |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
|PWAIT_PREEMPTIVE_AUDIT_ACCESS_WINDOWSLOG |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|PWAIT_QRY_BPMEMORY |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|PWAIT_REPLICA_ONLINE_INIT_MUTEX |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|PWAIT_RESOURCE_SEMAPHORE_FT_PARALLEL_QUERY_SYNC |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|PWAIT_SBS_FILE_OPERATION |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
|PWAIT_XTP_FSSTORAGE_MAINTENANCE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|PWAIT_XTP_HOST_STORAGE_WAIT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|QDS_ASYNC_CHECK_CONSISTENCY_TASK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|QDS_ASYNC_PERSIST_TASK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|QDS_ASYNC_PERSIST_TASK_START |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|QDS_ASYNC_QUEUE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|QDS_BCKG_TASK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|QDS_BLOOM_FILTER |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|QDS_CLEANUP_STALE_QUERIES_TASK_MAIN_LOOP_SLEEP |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|QDS_CTXS |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|QDS_DB_DISK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|QDS_DYN_VECTOR |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|QDS_EXCLUSIVE_ACCESS |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|QDS_HOST_INIT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
|QDS_LOADDB |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|QDS_PERSIST_TASK_MAIN_LOOP_SLEEP |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|QDS_QDS_CAPTURE_INIT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|QDS_SHUTDOWN_QUEUE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|QDS_STMT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|QDS_STMT_DISK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|QDS_TASK_SHUTDOWN |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|QDS_TASK_START |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|QE_WARN_LIST_SYNC |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
...
|RECOVERY_MGR_LOCK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|REDO_THREAD_PENDING_WORK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|REDO_THREAD_SYNC |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|REMOTE_BLOCK_IO |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
|REMOTE_DATA_ARCHIVE_MIGRATION_DMV |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|REMOTE_DATA_ARCHIVE_SCHEMA_DMV |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|REMOTE_DATA_ARCHIVE_SCHEMA_TASK_QUEUE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|REPL_TRANFSINFO_ACCESS |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|REPL_TRANHASHTABLE_ACCESS |내부적으로만 사용됩니다.| 
|REPL_TRANTEXTINFO_ACCESS |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|RESERVED_MEMORY_ALLOCATION_EXT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|RESMGR_THROTTLED |새 쿼리가 GROUP_MAX_REQUESTS 설정에 따라 들어오고 정체되는 경우 발생합니다.| 
|RESOURCE_GOVERNOR_IDLE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|RESTORE_FILEHANDLECACHE_ENTRYLOCK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|RESTORE_FILEHANDLECACHE_LOCK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|RG_RECONFIG |내부적으로만 사용됩니다.| 
|ROWGROUP_OP_STATS |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|ROWGROUP_VERSION |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|RTDATA_LIST |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|SATELLITE_CARGO |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|SATELLITE_SERVICE_SETUP |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|SATELLITE_TASK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|SBS_DISPATCH |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
|SBS_RECEIVE_TRANSPORT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
|SBS_TRANSPORT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
|SCAN_CHAR_HASH_ARRAY_INITIALIZATION |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|SEC_DROP_TEMP_KEY |임시 보안 키 삭제 시도가 실패한 후 다시 시도하기 전에 발생합니다.| 
|SECURITY_CNG_PROVIDER_MUTEX |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
|SECURITY_CRYPTO_CONTEXT_MUTEX |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|SECURITY_DBE_STATE_MUTEX |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|SECURITY_KEYRING_RWLOCK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|SECURITY_MUTEX |EKM(확장 가능 키 관리) 암호화 공급자의 전역 목록 및 EKM 세션의 세션 범위 목록에 대한 액세스를 제어하는 뮤텍스를 기다리는 경우에 발생합니다.| 
|SECURITY_RULETABLE_MUTEX |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|SEMPLAT_DSI_BUILD |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|SEQUENCE_GENERATION |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|SERVER_RECONFIGURE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|SESSION_WAIT_STATS_CHILDREN |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|SHARED_DELTASTORE_CREATION |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|SHUTDOWN |종료 문이 활성 연결이 종료될 때까지 대기하는 동안 발생합니다.| 
|SLEEP_BPOOL_FLUSH |검사점이 디스크 하위 시스템의 폭주를 방지하기 위해 새 I/O의 실행을 조절하는 경우에 발생합니다.| 
|SLEEP_BUFFERPOOL_HELPLW |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|SLEEP_MASTERDBREADY |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|SLEEP_MASTERMDREADY |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|SLEEP_MASTERUPGRADED |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|SLEEP_MEMORYPOOL_ALLOCATEPAGES |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|SLEEP_MSDBSTARTUP |SQL 추적이 msdb 데이터베이스 시작이 완료될 때까지 대기하는 경우에 발생합니다.| 
|SLEEP_RETRY_VIRTUALALLOC |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|SLEEP_WORKSPACE_ALLOCATEPAGE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|SLO_UPDATE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|SMSYNC |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|SNI_CONN_DUP |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
...
|SNI_WRITE_ASYNC |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
|SOAP_READ |HTTP 네트워크 읽기가 완료될 때까지 대기하는 동안 발생합니다.| 
|SOAP_WRITE |HTTP 네트워크 쓰기가 완료될 때까지 대기하는 동안 발생합니다.| 
|SOCKETDUPLICATEQUEUE_CLEANUP |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|SOS_MEMORY_TOPLEVELBLOCKALLOCATOR |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|SP_PREEMPTIVE_SERVER_DIAGNOSTICS_SLEEP |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|SP_SERVER_DIAGNOSTICS_BUFFER_ACCESS |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|SP_SERVER_DIAGNOSTICS_INIT_MUTEX |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|SP_SERVER_DIAGNOSTICS_SLEEP |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|SQLTRACE_FILE_READ_IO_COMPLETION |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|SQLTRACE_FILE_WRITE_IO_COMPLETION |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|SQLTRACE_INCREMENTAL_FLUSH_SLEEP |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|SQLTRACE_LOCK |내부적으로만 사용됩니다. <br /><br /> **적용**대상:에만 적용 됩니다 [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] . |  
|SQLTRACE_PENDING_BUFFER_WRITERS |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|STARTUP_DEPENDENCY_MANAGER |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|TDS_BANDWIDTH_STATE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|TDS_INIT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|TDS_PROXY_CONTAINER |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|TEMPOBJ |임시 개체 삭제가 동기화되는 경우에 발생합니다. 이 대기는 드물게 발생하며 태스크가 temp 테이블 삭제에 대한 액세스를 과도하게 요청한 경우에만 발생합니다.| 
|TEMPORAL_BACKGROUND_PROCEED_CLEANUP |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
|TERMINATE_LISTENER |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|UCS_ENDPOINT_CHANGE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|UCS_MANAGER |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|UCS_MEMORY_NOTIFICATION |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|UCS_SESSION_REGISTRATION |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|UCS_TRANSPORT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|UCS_TRANSPORT_STREAM_CHANGE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|UTIL_PAGE_ALLOC |트랜잭션 로그 검색이 메모리 부족 시 메모리를 사용할 수 있을 때까지 대기하는 경우에 발생합니다.| 
|VDI_CLIENT_COMPLETECOMMAND |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|VDI_CLIENT_GETCOMMAND |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|VDI_CLIENT_OPERATION |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|VDI_CLIENT_OTHER |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|VERSIONING_COMMITTING |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|WAIT_SCRIPTDEPLOYMENT_REQUEST |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|WAIT_SCRIPTDEPLOYMENT_WORKER |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|WAIT_XLOGREAD_SIGNAL |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
|WAIT_XTP_ASYNC_TX_COMPLETION |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|WAIT_XTP_CKPT_AGENT_WAKEUP |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
...
|WAIT_XTP_COMPILE_WAIT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
...
|WAIT_XTP_OFFLINE_CKPT_BEFORE_REDO |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
...
|WAIT_XTP_SERIAL_RECOVERY |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
|WAIT_XTP_SWITCH_TO_INACTIVE |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|WINFAB_REPORT_FAULT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
...
|XDB_CONN_DUP_HASH |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|XDES_HISTORY |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|XDES_OUT_OF_ORDER_LIST |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|XDES_SNAPSHOT |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|XDESTSVERMGR |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
...
|XE_CALLBACK_LIST |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] 이상| 
|XE_CX_FILE_READ |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
...
|XIO_CREDENTIAL_MGR_RWLOCK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|XIO_CREDENTIAL_RWLOCK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|XIO_EDS_MGR_RWLOCK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
|XIO_EDS_RWLOCK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
|XIO_IOSTATS_BLOBLIST_RWLOCK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
|XIO_IOSTATS_FCBLIST_RWLOCK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] 이상| 
|XIO_LEASE_RENEW_MGR_RWLOCK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|XTP_HOST_DB_COLLECTION |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|XTP_HOST_LOG_ACTIVITY |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상| 
|XTP_HOST_PARALLEL_RECOVERY |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|XTP_PREEMPTIVE_TASK |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
|XTP_TRUNCATION_LSN |내부적으로만 사용됩니다. <br /><br /> **적용 대상**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] 이상| 
