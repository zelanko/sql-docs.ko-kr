...
|상태|**int**|에 있는 노드의 상태는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 장애 조치 클러스터 인스턴스: 0, 1, 2, 3, -1. 자세한 내용은 [GetClusterNodeState 함수](https://go.microsoft.com/fwlink/?LinkId=204794)합니다.|  
