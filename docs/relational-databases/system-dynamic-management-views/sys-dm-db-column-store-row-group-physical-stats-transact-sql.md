...
### <a name="a-calculate-fragmentaton-to-decide-when-to-reorganize-or-rebuild-a-columnstore-index"></a>A. Reorganize는 columnstore 인덱스 다시 작성 하는 시기를 결정 fragmentaton를 계산 합니다.  
