---
title: "PowerShell을 사용하여 Microsoft Azure Blob 저장소 서비스에 여러 데이터베이스 백업 | Microsoft Docs"
ms.custom: ""
ms.date: "05/20/2016"
...
---
# PowerShell을 사용하여 Microsoft Azure Blob 저장소 서비스에 여러 데이터베이스 백업
...
### 다중 데이터베이스, 다중 인스턴스 백업 작업에 대한 PowerShell  
...
### 모든 SQL Server 인스턴스에서 SQL 자격 증명 만들기  
...
### 시스템 데이터베이스를 비롯한 모든 데이터베이스에 대한 전체 데이터베이스 백업  
...
### 모든 사용자 데이터베이스에 대한 전체 데이터베이스 백업  
...
### 모든 SQL Server 인스턴스의 MASTER 및 MSDB(시스템 데이터베이스)에 대한 전체 데이터베이스 백업  
...
### 한 SQL Server 인스턴스의 모든 사용자 데이터베이스에 대한 전체 데이터베이스 백업  
...
### 한 SQL Server 인스턴스의 시스템 데이터베이스(MASTER 및 MSDB)에 대한 전체 데이터베이스 백업  
