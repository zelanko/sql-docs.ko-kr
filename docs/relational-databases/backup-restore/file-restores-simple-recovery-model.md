---
title: "파일 복원(단순 복구 모델) | Microsoft Docs"
ms.custom: ""
ms.date: "03/24/2017"
...
### 파일 복원 시퀀스의 Transact-SQL 단계(단순 복구 모델)  
 이 섹션에서는 단순 파일 복원 시퀀스에 대한 필수 [!INCLUDE[tsql](../../includes/tsql-md.md)][RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md) 옵션을 보여 줍니다. 이 용도와 관련 없는 구문 및 세부 사항은 생략됩니다.  
...
-   [Restore.SqlRestore 메서드(서버)](../Topic/SqlRestore%20Method.md)(SMO)  
