...
# [PowerShell을 사용하여 Microsoft Azure Blob 저장소 서비스에 여러 데이터베이스 백업](back-up-multiple-databases-to-azure-blob-storage-powershell.md)
...
# [Microsoft Azure Blob 저장소 서비스로 SQL Server 백업 및 복원](sql-server-backup-and-restore-with-microsoft-azure-blob-storage-service.md)
...
# [자격 증명 만들기 - Azure 저장소 인증](create-credential-authenticate-to-azure-storage.md)
