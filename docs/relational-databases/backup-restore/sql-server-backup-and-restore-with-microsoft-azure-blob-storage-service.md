---
title: "Microsoft Azure Blob 저장소 서비스로 SQL Server 백업 및 복원 | Microsoft Docs"
ms.custom: ""
ms.date: "07/25/2016"
...
---
# Microsoft Azure Blob 저장소 서비스로 SQL Server 백업 및 복원
...
## <a name="benefits-of-using-the-microsoft-azure-blob-service-for-includessnoversiontokenssnoversionmdmd-backups"></a>[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 백업에 Microsoft Azure Blob 서비스를 사용할 경우의 이점  
...
##  <a name="a-namebillinga-microsoft-azure-billing-considerations"></a><a name="Billing"></a> Microsoft Azure 청구 고려 사항:  
 ...
 **저장소:** 요금은 사용 공간을 기준으로 하며 단계적 등급과 중복 수준에 따라 계산됩니다. 자세한 내용과 최선 정보는 [가격 정보](http://go.microsoft.com/fwlink/?LinkId=277059) 문서의 **데이터 관리** 섹션을 참조하세요.  
...
## <a name="see-also"></a>관련 항목:  
 ...
 [자습서: SQL Server 2016 데이터베이스와 함께 Microsoft Azure Blob Storage 서비스 사용](Tutorial:%20Using%20the%20Microsoft%20Azure%20Blob%20storage%20service%20with%20SQL%20Server%202016%20databases.md)  
