...
### <a name="d--restore-earlier-disk-backups-to-a-point-in-time"></a>4.  이전 디스크 백업을 특정 시점으로 복원
...
#### <a name="f-restore-local-backup-to-microsoft-azure-storage-url"></a>6. Microsoft Azure Storage(URL)에 로컬 백업 복원
