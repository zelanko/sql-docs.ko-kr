...
> [!NOTE]  
>  [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]를 사용하여 복원 태스크를 지정할 때는 [!INCLUDE[tsql](../../includes/tsql-md.md)]스크립트[를 클릭한 다음 스크립트의 대상을 선택하여 해당하는 ](../../t-sql/statements/restore-statements-transact-sql.md) **RESTORE** 스크립트를 생성할 수 있습니다.  
