---
title: "시스템 데이터베이스 백업 및 복원(SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "시스템 데이터베이스 [SQL Server], 백업 및 복원"
  - "시스템 데이터베이스 복원 [SQL Server]"
  - "백업 [SQL Server], 시스템 데이터베이스"
  - "데이터베이스 백업 [SQL Server], 시스템 데이터베이스"
  - "서버 [SQL Server], 백업"
