---
title: "전체 복구 모델에서 특정 오류 지점으로 데이터베이스 복원(Transact-SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
2.  다음의 기본 [RESTORE DATABASE](../Topic/RESTORE%20\(Transact-SQL\).md) 문을 실행하여 전체 데이터베이스 백업을 복원합니다.  
