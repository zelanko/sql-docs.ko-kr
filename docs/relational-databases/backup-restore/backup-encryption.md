...
description: 이 문서에서는 백업 중 암호화에 대한 사용법, 이점 및 권장 방법을 포함하여 SQL Server 백업의 암호화 옵션에 대해 설명합니다.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
1. [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)]으로 수행된 백업에 대한 암호화가 지원되며, 이를 통해 오프사이트 백업의 보안이 강화됩니다.  
  
1. 이 기능은 AES 256비트까지 여러 암호화 알고리즘을 지원하므로 사용자의 요구 사항에 적합한 알고리즘을 선택할 수 있습니다.  
