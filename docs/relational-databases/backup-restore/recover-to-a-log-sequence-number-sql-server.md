...
description: SQL Server에서 LSN(로그 시퀀스 번호)을 사용하여 특정 지점으로 복구할 수 있습니다. 이 기능은 도구 공급업체를 위한 기능입니다.
ms.custom: ''
ms.date: 10/23/2019
ms.prod: sql
...
-   WITH STOPBEFOREMARK **='** lsn: _<lsn_number>_ **'** 절을 사용합니다. 여기서 lsn: *\<lsnNumber>* 는 지정한 LSN이 포함된 로그 레코드가 복구 지점이 되도록 지정하는 문자열입니다.  
