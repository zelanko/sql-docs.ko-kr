---
title: "백업 세트의 데이터와 로그 파일 보기(SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/15/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "데이터베이스 백업 [SQL Server], 백업 세트 보기"
  - "백업 세트 정보 보기"
  - "백업 세트 [SQL Server], 파일 보기"
  - "백업 세트 정보 표시"
  - "트랜잭션 로그 백업 [SQL Server], 백업 세트 보기"
...
---
# 백업 세트의 데이터와 로그 파일 보기(SQL Server)
...
###  <a name="Security"></a> 보안  
 보안에 대한 자세한 내용은 [RESTORE FILELISTONLY&#40;Transact-SQL&#41;](../Topic/RESTORE%20FILELISTONLY%20\(Transact-SQL\).md)를 참조하세요.  
...
3.  [RESTORE FILELISTONLY](../Topic/RESTORE%20FILELISTONLY%20\(Transact-SQL\).md) 문을 사용합니다. 이 예에서는 `FILE=2` 백업 장치의 두 번째 백업 세트(`AdventureWorksBackups`)에 대한 정보를 반환합니다.  
