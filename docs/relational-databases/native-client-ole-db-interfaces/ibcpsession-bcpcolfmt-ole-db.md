...
## <a name="return-code-values"></a>반환 코드 값  
 ...
 E_FAIL  
 자세한 내용은 [ISQLServerErrorInfo](https://msdn.microsoft.com/library/a8323b5c-686a-4235-a8d2-bda43617b3a1) 인터페이스를 사용 하 여 공급자 특정 오류가 발생 했습니다.  
