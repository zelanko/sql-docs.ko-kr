...
**ISSAbort** 에서 공개 된 인터페이스는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB provider는 **issabort:: Abort** 메서드는 현재 행 집합 및 모든 명령을 취소 하는 데 사용 되는 일괄 처리 처음에 행 집합을 생성 하 고 실행을 아직 완료 되지 않은 명령입니다.  
