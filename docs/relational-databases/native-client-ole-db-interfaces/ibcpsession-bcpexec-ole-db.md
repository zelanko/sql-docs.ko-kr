 ...
 **BCPExec** 메서드는 값에 따라 데이터베이스 테이블 또는 그 반대의 경우는 사용자 파일 간에 데이터를 복사 합니다 *eDirection* 사용 하는 매개 변수는 [ibcpsession:: Bcpinit](../../relational-databases/native-client-ole-db-interfaces/ibcpsession-bcpinit-ole-db.md)메서드.  
