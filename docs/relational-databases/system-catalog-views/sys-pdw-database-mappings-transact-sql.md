...
|database_id|**int**|데이터베이스에 대 한 개체 ID입니다. 참조 [sys.databases&#40; Transact SQL &#41; ](../../relational-databases/system-catalog-views/sys-databases-transact-sql.md).<br /><br /> **physical_name** 및 **database_id** 이 보기에 대 한 키를 형성 합니다.||  
