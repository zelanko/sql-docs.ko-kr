...
|data_compression|**tinyint**|각 파티션의 압축 상태를 나타냅니다.<br /><br /> 0 = 없음 <br />1 = ROW <br />2 = PAGE <br />3 = COLUMNSTORE: [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 이상 **에 적용 됩니다**.<br />4 = COLUMNSTORE_ARCHIVE: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 이상 **에 적용 됩니다**.<br /><br /> **참고:** 전체 텍스트 인덱스는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]모든 버전에서 압축 됩니다.|  
