...
|열 이름|데이터 형식|설명|  
|-----------------|---------------|-----------------|  
|**이름의**|**sysname 이며**|데이터베이스 내에서 고유한 보안 주체의 이름입니다.|  
...
|**default_schema_name**|**sysname 이며**|SQL 이름이 스키마를 지정하지 않을 때 사용되는 이름입니다. S, U 또는 A 유형의 보안 주체의 경우 Null입니다.|  
|**create_date**|**날짜**|보안 주체가 생성된 시간입니다.|  
|**modify_date**|**날짜**|보안 주체가 마지막으로 수정된 시간입니다.|  
...
|**default_language_name**|**sysname 이며**|**적용**대상: [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 이상.<br /><br /> 이 보안 주체의 기본 언어를 나타냅니다.|  
...
## <a name="see-also"></a>참고 항목  
 ...
 [Azure Active Directory 인증을 사용 하 여 SQL Database에 연결](https://azure.microsoft.com/documentation/articles/sql-database-aad-authentication)  
