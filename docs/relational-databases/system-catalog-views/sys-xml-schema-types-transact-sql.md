...
|**is_extension_blocked**|**bit**|1 = **complexType** 정의의 block 특성 또는 ancestor 스키마> 요소 정보 항목의 **blockdefault** 특성이 \< "extension" 또는 "#all"로 설정 된 경우 인스턴스에서 형식 확장으로의 대체가 차단 됩니다.<br /><br /> 0 = 확장으로의 대체가 차단되지 않습니다.|  
|**is_restriction_blocked**|**bit**|1 = **complexType** 정의의 block 특성 또는 ancestor 스키마> 요소 정보 항목의 **blockdefault** 특성이 \< "restriction" 또는 "#all"로 설정 된 경우 인스턴스에서 형식 제한으로의 대체가 차단 됩니다.<br /><br /> 0 = 제한으로의 대체가 차단되지 (기본값)|  
|**is_final_extension**|**bit**|1 = **complexType** 정의의 최종 특성이 나 상위 **finalDefault** \< 스키마> 요소 정보 항목의 나머지 기본 특성이 "extension" 또는 "#all"로 설정 된 경우 형식의 확장에의 한 파생이 차단 됩니다.<br /><br /> 0 = 확장이 (기본값)|  
|**is_final_restriction**|**bit**|1 = 단순 또는 **complexType** 정의의 최종 특성이 나 상위 **finalDefault** \< 스키마> 요소 정보 항목의 나머지 기본 특성이 "restriction" 또는 "#all"로 설정 된 경우 유형의 제한에의 한 파생이 차단 됩니다.<br /><br /> 0 = 제한이 (기본값)|  
