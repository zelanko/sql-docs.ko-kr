...
|**is_final_extension**|**bit**|1 = **complexType** 정의의 최종 특성이 나 상위 \<스키마> 요소 정보 항목의 나머지 **기본** 특성이 "extension" 또는 "#all"로 설정 된 경우 형식의 확장에의 한 파생이 차단 됩니다.<br /><br /> 0 = 확장이 (기본값)|  
|**is_final_restriction**|**bit**|1 = 단순 또는 **complexType** 정의의 최종 특성이 나 상위 \<스키마> 요소 정보 항목의 나머지 **기본** 특성이 "restriction" 또는 "#all"로 설정 된 경우 유형의 제한에의 한 파생이 차단 됩니다.<br /><br /> 0 = 제한이 (기본값)|  
