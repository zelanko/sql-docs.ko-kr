...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
 ...
 SOAP 유형 페이로드를 전달하는 서버의 각 엔드포인트에 대해 한 행을 포함합니다. 이 뷰의 모든 행에 대해 해당 행이 동일한 **endpoint_id** 에 **sys.http_endpoints** 카탈로그 HTTP 구성 메타 데이터를 전달 하는 뷰.  
  
 
|열 이름|데이터 형식|설명|  
|-----------------|---------------|-----------------|  
|**< 상속 된 열 >**||이 뷰가 상속 하는 열 목록은 참조 하세요 [sys.endpoints &#40;TRANSACT-SQL&#41;](../../relational-databases/system-catalog-views/sys-endpoints-transact-sql.md)합니다.|  
...
|**default_namespace**|**nvarchar(384)**|네임 스페이스에 지정 된 기본 네임 스페이스 = 옵션 또는 `https://tempuri.org` 기본값 대신 지정 된 경우.|  
