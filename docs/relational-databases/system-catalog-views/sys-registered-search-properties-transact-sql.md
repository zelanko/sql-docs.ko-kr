---
title: sys.registered_search_properties (TRANSACT-SQL) | Microsoft 문서
ms.custom: ''
ms.date: 06/10/2016
ms.prod: sql
...
|**property_name**|**nvarchar(64)**|검색 속성 목록에서 이 검색 속성을 고유하게 식별하는 이름입니다.<br /><br /> 참고: 속성을 검색 하려면이 속성에 이름을 지정 합니다 [CONTAINS](../../t-sql/queries/contains-transact-sql.md) 조건자입니다.|  
