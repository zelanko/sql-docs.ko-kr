...
## <a name="remarks"></a>설명  
 카탈로그 뷰는 저장된 메타데이터를 표시합니다. 메모리 내 구성을 확인 하려면 해당 동적 관리 뷰 [sys. dm_resource_governor_resource_pools &#40;&#41;transact-sql](../../relational-databases/system-dynamic-management-views/sys-dm-resource-governor-resource-pools-transact-sql.md)을 사용 합니다.  
