...
테이블에 대한 `VIEW DEFINITION` 권한이 필요합니다. 다음 열은 사용자에 게 last_id, entry_count, data_ptr와 같은 @no__t 없는 경우 null을 반환 합니다.  
...
## <a name="see-also"></a>관련 항목  
 ...
 [SQL Server System Catalog @no__t FAQ](../../relational-databases/system-catalog-views/querying-the-sql-server-system-catalog-faq.md)-1  
 [sys.columns&#40;Transact-SQL&#41;](../../relational-databases/system-catalog-views/sys-columns-transact-sql.md)   
 [sys. 모든 열 &#40;transact-sql&#41;](../../relational-databases/system-catalog-views/sys-all-columns-transact-sql.md)   
