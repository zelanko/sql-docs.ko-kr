...
|**type**|**int**|사전 종류입니다.<br /><br /> 1-포함 하는 해시 사전 **int** 값<br /><br /> 2 – 사용되지 않음<br /><br /> 3 – 문자열 값을 포함하는 해시 사전<br /><br /> 4-포함 하는 해시 사전 **float** 값<br /><br /> 사전에 대 한 자세한 내용은 참조 [Columnstore 인덱스 가이드](~/relational-databases/indexes/columnstore-indexes-overview.md)합니다.|  
