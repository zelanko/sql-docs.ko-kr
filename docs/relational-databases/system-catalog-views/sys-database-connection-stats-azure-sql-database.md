...
[!INCLUDE[tsql-appliesto-xxxxxx-asdb-xxxx-xxx-md](../../includes/tsql-appliesto-xxxxxx-asdb-xxxx-xxx-md.md)]
  ...
  **데이터베이스 연결 이벤트에** 대 한 통계를 포함 하 여 데이터베이스 연결 성공 및 실패에 대 [!INCLUDE[ssSDS](../../includes/sssds-md.md)] 한 개요를 제공 합니다. 연결 이벤트에 대 한 자세한 내용은 [event_log &#40;Azure SQL Database&#41;](../../relational-databases/system-catalog-views/sys-event-log-azure-sql-database.md)에서 이벤트 유형을 참조 하세요.  
...
|**terminated_connection_count**|**int**|**_[!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)] v11에만 적용 됩니다._**<br /><br /> 종료된 연결 수:|  
|**throttled_connection_count**|**int**|**_[!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)] v11에만 적용 됩니다._**<br /><br /> 정체된 연결 수입니다.|  
...
- 이 뷰에는 발생할 수 있는 일부 [!INCLUDE[ssSDS](../../includes/sssds-md.md)] 데이터베이스 오류가 포함 되어 있지 않습니다 .이 오류는 [event_log &#40;Azure SQL Database&#41;](../../relational-databases/system-catalog-views/sys-event-log-azure-sql-database.md)의 이벤트 유형에 지정 된 오류만 포함 합니다.  
  
- [!INCLUDE[ssSDS](../../includes/sssds-md.md)] 데이터 센터 내에 컴퓨터 오류가 있으면 이벤트 테이블에서 소량의 데이터가 누락 될 수 있습니다.  
...
## <a name="see-also"></a>관련 항목:
 ...
 [Azure SQL Database 연결 문제 해결](/azure/sql-database/sql-database-troubleshoot-common-connection-issues)  
