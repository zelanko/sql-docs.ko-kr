...
|열 이름|데이터 형식|설명|  
|-----------------|---------------|-----------------|  
|**class**|**tinyint**|사용 권한이 있는 클래스를 식별합니다.<br /><br /> 0 = 데이터베이스<br />1 = 개체 또는 열<br />3 = 스키마<br />4 = 데이터베이스 보안 주체<br />5 = 어셈블리 **적용 대상**: [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 이상<br />6 = 형식<br />10 = XML 스키마 컬렉션- <br />                      **적용 대상**: [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 이상<br />15 = 메시지 유형- **적용**대상: [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 이상<br />16 = 서비스 계약- **적용**대상: [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 이상<br />17 = 서비스 **적용 대상**: [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 이상.<br />18 = 원격 서비스 바인딩-[!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 이상 **에 적용**됩니다.<br />19 = 경로: [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 이상 **에 적용**됩니다.<br />23 = 전체 텍스트 카탈로그-[!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 이상 **에 적용**됩니다.<br />24 = 대칭 키-[!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 이상 **에 적용 됩니다**.<br />25 = 인증서 **적용**대상: [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 이상.<br />26 = 비대칭 키- **적용**대상: [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 이상|  
