...
-   [지정된 된 데이터 형식에 종속 되는 열을 찾으려면 어떻게 해야 합니까?](#_FAQ22)  
  
-   [지정한 CLR 사용자 정의 형식 또는 별칭 데이터 형식에 종속 되는 계산된 열을 찾으려면 어떻게 해야 합니까?](#_FAQ23)  
...
-   [뷰, TRANSACT-SQL 함수 및 지정한 CLR 사용자 정의 형식 또는 별칭 형식에 종속 된 TRANSACT-SQL 저장 프로시저 찾으려면 어떻게](#_FAQ26)  
  
### <a name="tables-indexes-views-and-constraints"></a>테이블, 인덱스, 뷰 및 제약 조건  
  
-   [지정된 된 데이터베이스의 모든 사용자 정의 테이블 찾기](#_FAQ31)  
  
-   [지정된 된 데이터베이스에 클러스터형된 인덱스가 없는 모든 테이블 찾기](#_FAQ1)  
  
-   [인덱스를 갖지 않는 모든 테이블 찾기](#_FAQ4)  
...
-   [최근 N 일 동안에서 수정 된 엔터티를 모두 찾으려면 어떻게 해야 합니까?](#_FAQ6)  
  
-   [지정된 된 테이블에 대 한 기본 키 열을 찾으려면 어떻게 해야 합니까?](#_FAQ16)  
  
-   [지정된 된 테이블에 대 한 외래 키 열을 찾으려면 어떻게 해야 합니까?](#_FAQ17)  
  
-   [열이 계산된 열 식에 사용 되 면 어떻게 확인 합니까?](#_FAQ20)  
  
-   [계산된 열 식에 사용 되는 모든 열 찾기](#_FAQ21)  
  
-   [지정된 된 테이블에 대 한 모든 제약 조건을 찾기](#_FAQ27)  
  
-   [지정된 된 테이블에 대 한 모든 인덱스 찾으려면 어떻게 해야 합니까?](#_FAQ28)  
  
-   [지정 된 열 이름이 있는 모든 테이블 찾기](#_FAQ30)  
  
-   [지정된 된 개체에서 모든 통계 찾으려면 어떻게 해야 합니까?](#_FAQ33)  
  
-   [찾으려면 어떻게 해야 합니까 모든 통계 및 통계 열에 지정된 된 개체?](#_FAQ34)  
  
### <a name="modules-stored-procedures-user-defined-functions-and-triggers"></a>모듈(저장 프로시저, 사용자 정의 함수 및 트리거)  
  
-   [데이터베이스의 모든 저장된 프로시저 찾으려면 어떻게 해야 합니까?](#_FAQ9)  
  
-   [데이터베이스의 모든 사용자 정의 함수 찾기](#_FAQ12)  
  
-   [지정 된 저장된 프로시저 또는 함수에 대 한 매개 변수 찾기](#_FAQ10)  
  
-   [지정된 된 함수에서 종속성 찾으려면 어떻게 해야 합니까?](#_FAQ8)  
  
-   [모듈의 정의 보려면 어떻게 해야 합니까?](#_FAQ15)  
  
-   [서버 수준 트리거의 정의 보려면 어떻게 해야 합니까?](#_FAQ19)  
  
### <a name="schemas-users-roles-and-permissions"></a>스키마, 사용자, 역할 및 사용 권한  
  
-   [지정된 된 스키마에 포함 된 엔터티 소유자를 모두 찾으려면 어떻게 해야 합니까?](#_FAQ2)  
  
-   [지정 된 보안 주체에 부여 하거나 거부 한 사용 권한을 찾으려면 어떻게 해야 합니까?](#_FAQ18)  
...
```  
 ...
 다음 쿼리는 제한적 이며 좁은 뷰의 열을 CLR 사용자 정의 형식 또는 별칭에 종속 반환 되지만 결과 집합은 볼 수는 **공용** 역할입니다. 사용자 정의 형식에 대한 REFERENCE 권한을 다른 사용자에게 부여했고, 다른 사용자가 만들었으며 해당 형식을 사용하는 개체에 대한 메타데이터를 볼 수 있는 권한이 없는 경우 이 쿼리를 사용할 수 있습니다.  
