...
|size|**int**|8KB 페이지 단위로 나타낸 파일의 현재 크기입니다. 데이터베이스 스냅샷의 경우 size는 스냅샷이 파일에 대해 사용할 수 있는 최대 공간을 나타냅니다.<br /><br /> 참고:이 필드는 FILESTREAM 컨테이너에 대해 0으로 채워집니다. FILESTREAM 컨테이너의 실제 크기에 대 한 *database_files* 카탈로그 뷰를 쿼리 합니다.|  
...
|drop_lsn|**숫자 (25, 0)**|파일이 삭제된 시점의 LSN입니다.|  
