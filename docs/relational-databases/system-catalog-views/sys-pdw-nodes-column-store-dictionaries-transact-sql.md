...
|**유형**|**int**|사전 종류입니다.<br /><br /> 1- **int** 값을 포함 하는 해시 사전<br /><br /> 2-사용 되지 않음<br /><br /> 3-문자열 값을 포함 하는 해시 사전<br /><br /> 4- **float** 값을 포함 하는 해시 사전|  
...
## <a name="see-also"></a>참고 항목  
 ...
 [COLUMNSTORE 인덱스 &#40;transact-sql&#41;  만들기](../../t-sql/statements/create-columnstore-index-transact-sql.md)  
