---
title: _nodes_column_store_dictionaries (Transact-sql) | Microsoft Docs
ms.date: 03/03/2017
ms.prod: sql
...
ms.locfileid: "72305187"
---
# <a name="syspdw_nodes_column_store_dictionaries-transact-sql"></a>_nodes_column_store_dictionaries (Transact-sql)
...
## <a name="see-also"></a>관련 항목  
 ...
 [COLUMNSTORE 인덱스 &#40;transact-sql&#41;@no__t 만들기](../../t-sql/statements/create-columnstore-index-transact-sql.md)-3  
 [ &#40;_nodes_column_store_segments&#41;](../../relational-databases/system-catalog-views/sys-pdw-nodes-column-store-segments-transact-sql.md)   
