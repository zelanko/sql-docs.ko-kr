---
title: sys.stats_columns (Transact SQL) | Microsoft 문서
ms.custom: ''
ms.date: 12/18/2017
ms.prod: sql
...
|**stats_id**|**int**|이 열이 속한 통계의 ID입니다.<br /><br />통계는 인덱스에 해당 하는 경우는 *stats_id* 값은 동일는 *이뤄지고* 값은 [sys.indexes](../../relational-databases/system-catalog-views/sys-indexes-transact-sql.md) 카탈로그 뷰.|  
