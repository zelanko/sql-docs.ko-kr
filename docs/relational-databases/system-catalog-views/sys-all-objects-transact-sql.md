...
|modify_date|**datetime**|ALTER 문을 사용하여 개체를 마지막으로 수정한 날짜입니다. 개체가 테이블이 나 뷰가 면 테이블이 나 뷰의 인덱스를 만들거나 수정할 때에도 modify_date 변경 됩니다.|  
