...
|**is_fixed_role**|**bit**|보안 주체가 고정 권한이 있는 기본 제공 서버 역할 중 하나 이면 1을 반환 합니다. 자세한 내용은 [서버 수준 역할](../../relational-databases/security/authentication-access/server-level-roles.md)을 참조하세요.|  
