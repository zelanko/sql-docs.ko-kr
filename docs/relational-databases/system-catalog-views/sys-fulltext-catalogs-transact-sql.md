...
> [!NOTE]  
>  이후 릴리스에서 다음 열이 제거 됩니다 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]: **data_space_id**, **file_id**, 및 **경로**합니다. 새 개발 작업에서는 이러한 열을 사용하지 말고 이러한 열을 사용 중인 응용 프로그램을 가능한 한 빨리 수정하십시오.  
