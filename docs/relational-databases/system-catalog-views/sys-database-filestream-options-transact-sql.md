...
|**non_transacted_access**|**tinyint**|사용하도록 설정된 FILESTREAM 데이터에 대한 비트랜잭션 액세스 수준입니다. 액세스 수준은 NON_TRANSACTED_ACCESS 옵션으로 설정 됩니다는 **CREATE DATABASE** 하거나 **ALTER DATABASE** 문.<br /><br /> 이 설정에는 다음 값 중 하나를 사용할 수 있습니다.<br /><br /> 0 - 사용 안 함. 이것은 기본값입니다. 이 수준은 값을 제공 하 여 설정 됩니다 **OFF** 에 대 한 합니다 **NON_TRANSACTED_ACCESS** 옵션입니다.<br /><br /> 1 - 읽기 전용 액세스. 이 수준은 값을 제공 하 여 설정 됩니다 **READ_ONLY** 에 대 한 합니다 **NON_TRANSACTED_ACCESS** 옵션입니다.<br /><br /> 3 - 모든 액세스. 이 수준은 값을 제공 하 여 설정 됩니다 **전체** 에 대 한 합니다 **NON_TRANSACTED_ACCESS** 옵션입니다.<br /><br /> 5 - READONLY로 전환 중<br /><br /> 6 - OFF로 전환 중|  
|**non_transacted_access_desc**|**nvarchar(60)**|Non_transacted_access에서 식별 된 비트랜잭션 액세스 수준 설명입니다.<br /><br /> 이 설정에는 다음 값 중 하나를 사용할 수 있습니다.<br /><br /> NONE - 기본값입니다.<br /><br /> READ_ONLY<br /><br /> FULL<br /><br /> IN_TRANSITION_TO_READ_ONLY<br /><br /> IN_TRANSITION_TO_OFF|  
