...
|component_id|**int**|이 경고가 적용 되는 구성 요소의 ID입니다. 구성 요소는 "전원 공급 장치"와 같은 일반적인 구성 요소 식별자 이며 설치에 한정 되지 않습니다. [Sys.pdw_health_components &#40;transact-sql&#41;](../../relational-databases/system-catalog-views/sys-pdw-health-components-transact-sql.md)를 참조 하세요.|NOT NULL|  
