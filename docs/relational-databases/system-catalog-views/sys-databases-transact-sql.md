...
|**default_fulltext_language_name**|**nvarchar(128)**|포함된 데이터베이스의 기본 전체 텍스트 언어를 나타냅니다.<br /> 포함 되지 않은 데이터베이스의 경우이 값은 **null** 입니다.<br /> **적용 대상**: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (부터 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] ) 및[!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]|  
...
|**제한**|**tinyint not null**|데이터베이스의 포함 상태를 나타냅니다.<br />  0 = 데이터베이스가 포함되지 않습니다. **적용 대상**: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (부터 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] ) 및[!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]<br /> 1 = 데이터베이스가 부분 포함에 **적용**됩니다. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (부터 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] )|  
...
|**target_recovery_time_in_seconds**|**int**|데이터베이스 복구 예상 시간(초)입니다. Null을 허용합니다.<br /> **적용 대상**: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (부터 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] ) 및[!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]|  
...
|**is_temporal_retention_enabled**|**bit**|임시 보존 정책 정리 태스크를 사용할 수 있는지 여부를 나타냅니다.<br /><br />1 = 임시 보존이 사용 됩니다.<br />0 = 임시 보존이 사용 하지 않도록 설정 됨<br />**적용 대상**: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (부터 [!INCLUDE[ssSQL17](../../includes/sssql17-md.md)] ) 및[!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]|
...
|**is_accelerated_database_recovery_on**|**bit**|ADR (가속화 된 데이터베이스 복구)를 사용할 수 있는지 여부를 나타냅니다.<br />1 = ADR가 사용 됩니다.<br />0 = ADR가 사용 되지 않습니다.<br />**적용 대상**: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (부터 [!INCLUDE[sql-server-2019](../../includes/sssqlv15-md.md)] ) 및[!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]|
