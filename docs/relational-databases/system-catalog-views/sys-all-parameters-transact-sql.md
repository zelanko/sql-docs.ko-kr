...
|**xml_collection_id**|**int**|매개 변수 유효성 검사에 사용되는 XML 스키마 컬렉션의 ID입니다.<br /><br /> 매개 변수 데이터 형식의 경우 0이 아닌 **xml** XML이 입력 되 고 있습니다.<br /><br /> 0 = XML 스키마 컬렉션이 없거나 매개 변수가 XML이 아닙니다.|  
