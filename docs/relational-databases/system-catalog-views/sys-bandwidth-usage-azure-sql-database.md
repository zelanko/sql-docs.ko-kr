...
|**방향도**|사용된 대역폭의 유형은 다음 중 하나입니다.<br /><br /> 수신:로 이동 하는 데이터 [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]입니다.<br /><br /> 송신:에서 [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]이동 하는 데이터입니다.|  
