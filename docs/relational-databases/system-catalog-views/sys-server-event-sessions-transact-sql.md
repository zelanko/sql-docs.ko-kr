...
|max_dispatch_latency|**int**|이벤트가 세션 대상에 전달되기 전에 메모리에 버퍼링될 시간(밀리초)을 나타냅니다. 유효한 값은 0에서 2147483648, 0입니다. 값 0은 디스패치 대기 시간이 무한대 임을 나타냅니다. Null을 허용합니다.|  
...
|memory_partition_mode|**nchar(1)**|이벤트 버퍼가 만들어지는 메모리 내의 위치입니다. 기본 파티션 모드는 G이며 Null을 허용하지 않습니다. memory_partition_mode은 다음 중 하나입니다.<br /><br /> G - NONE<br /><br /> C - PER_CPU<br /><br /> N - PER_NODE|  
