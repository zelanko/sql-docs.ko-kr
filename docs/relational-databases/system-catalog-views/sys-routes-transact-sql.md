...
|**address**|**nvarchar(256)**|Service Broker에서 원격 서비스를 위한 메시지를 보내는 네트워크 주소입니다. NULL을 허용합니다. SQL Database Managed Instance에 대 한 주소는 로컬 이어야 합니다.|  
