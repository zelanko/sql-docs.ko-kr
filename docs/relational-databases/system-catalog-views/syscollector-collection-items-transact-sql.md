...
|**빈도**|**int**|컬렉션 항목이 데이터를 수집하는 빈도입니다. Null을 허용하지 않습니다.|  
|**매개 변수**|**xml**|컬렉션 항목과 연결된 수집기 유형에 대한 매개 변수화를 설명합니다. 이 컬렉션 항목에 대 한 XML 스키마와는 XSD (XML 스키마)에 저장 된 유효성이 검사 되는 **parameter_schema** 특정 수집기 형식에 대 한 합니다. Null을 허용합니다. 자세한 내용은 참조 [syscollector_collector_types &#40; Transact SQL &#41; ](../../relational-databases/system-catalog-views/syscollector-collector-types-transact-sql.md).|  
