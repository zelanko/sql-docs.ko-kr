...
# [데이터 수집기](data-collector-views-transact-sql.md)  
...
# [데이터 공간](data-spaces-transact-sql.md)  
...
# [끝점](endpoints-catalog-views-transact-sql.md)  
...
# [외부 작업](external-operations-catalog-views-transact-sql.md)  
...
# [Filestream 및 FileTable](filestream-and-filetable-catalog-views-transact-sql.md)  
...
# [전체 텍스트 검색 및 의미 체계 검색](full-text-search-and-semantic-search-catalog-views-transact-sql.md)  
...
# [개체](object-catalog-views-transact-sql.md)  
...
# [파티션 함수](partition-function-catalog-views-transact-sql.md)  
...
# [쿼리 저장소](query-store-catalog-views-transact-sql.md)  
...
# [서버 차원의 구성](server-wide-configuration-catalog-views-transact-sql.md)  
...
# [공간 데이터](spatial-data-catalog-views.md)  
