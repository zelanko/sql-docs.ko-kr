...
[!INCLUDE[tsql-appliesto-xxxxxx-xxxx-asdw-pdw-md](../../includes/tsql-appliesto-xxxxxx-xxxx-asdw-pdw-md.md)]
  ...
  에서 진행 중 [!INCLUDE[ssSDW](../../includes/sssdw-md.md)]이 고 완료 된 백업 및 복원 작업과의 지속적인 백업, 복원 및 로드 작업에 대 한 정보를 포함 [!INCLUDE[ssPDW](../../includes/sspdw-md.md)]합니다. 이 정보는 시스템을 다시 시작해도 유지됩니다.  
...
|모드|**nvarchar (16)**|실행 형식 내의 모드입니다.|Operation_type = **백업**<br />**큰**<br />**차지**<br /><br /> Operation_type = **로드**<br />**추가할**<br />**로딩**<br />**UPSERT**<br /><br /> Operation_type = **복원**<br />**DATABASE**<br />**HEADER_ONLY**|  
...
|진행률|**int**|완료 비율입니다.|0~100|  
|command|**nvarchar(4000)**|사용자가 제출한 명령의 전체 텍스트입니다.|는 4000 자 (공백 수) 보다 길면 잘립니다.|  
