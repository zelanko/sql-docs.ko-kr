...
|**wait_stats_capture_mode**|**smallint**|쿼리 저장소 대기 통계의 캡처를 수행 하는지 여부를 제어 합니다. <br /><br /> 0 = OFF <br /><br /> 1 = ON|
|**wait_stats_mode_capture_desc**|**nvarchar (60)**|실제 대기 통계 캡처 모드에 대 한 텍스트 설명을: <br /><br /> OFF <br /><br /> ON (기본값)| 
