...
|**default_object_id**|**int**|사용 하 여 형식에 바인딩된 독립 실행형 기본값의 ID입니다 [sp_bindefault](../../relational-databases/system-stored-procedures/sp-bindefault-transact-sql.md)합니다.<br /><br /> 0 = 기본값이 없습니다.|  
