...
|**is_distributed**|**bit**|분산 가용성 그룹 인지 여부를 지정 합니다. 자세한 내용은 [분산된 가용성 그룹&#40;Always On 가용성 그룹&#41;](../../database-engine/availability-groups/windows/distributed-availability-groups.md)을 참조하세요.|
