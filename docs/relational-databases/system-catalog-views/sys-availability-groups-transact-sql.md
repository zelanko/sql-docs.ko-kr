...
|2|다음과 같은 경우 자동 장애 조치(failover)를 시작하도록 지정합니다.<br /><br /> <br /><br /> -[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 인스턴스가 클러스터에 연결 되어 있지 않고 가용성 그룹의 사용자 지정 **health_check_timeout** 임계값이 초과 되었습니다.<br /><br /> -가용성 복제본이 실패 상태에 있습니다.|  
