...
|use_type_default|**bit**|Format_type = 구분 기호로 분리 된 텍스트, PolyBase가 HDFS 텍스트 파일에서 데이터를 가져올 때 누락 값을 처리 하는 방법을 지정 [!INCLUDE[ssSDW](../../includes/sssdw-md.md)]합니다.|0-문자열로 'NULL' 누락 된 값을 저장 합니다.<br /><br /> 1-열 기본 값으로 누락 된 값을 저장 합니다.|  
