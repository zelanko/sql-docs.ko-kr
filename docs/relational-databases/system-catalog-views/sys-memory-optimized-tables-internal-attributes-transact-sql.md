...
### <a name="b-returning-memory-consumption-of-all-columns-that-are-stored-off-row"></a>B. 행 외부에서 저장된 모든 열의 메모리 사용량 반환
...
### <a name="c-returning-memory-consumption-of-columnstore-indexes-on-memory-optimized-tables"></a>C. 메모리 최적화 테이블에서 columnstore 인덱스의 메모리 사용량 반환
...
다음 쿼리를 사용 하 여 메모리 최적화 테이블의 columnstore 인덱스에 사용 되는 내부 구조에서 메모리 사용을 중단 합니다.
