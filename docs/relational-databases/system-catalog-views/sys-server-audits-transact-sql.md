...
|**audit_guid**|**uniqueidentifier**|열거 하는 데 사용 되는 감사에 대 한 GUID를 감사 구성원 서버 &#124; 데이터베이스 감사 사양 중 서버 시작 및 데이터베이스 연결 작업.|  
|**create_date**|**datetime**|감사를 만든 UTC 날짜입니다.|  
|**modify_date**|**datetime**|감사를 마지막으로 수정한 UTC 날짜입니다.|  
|**principal_id**|**int**|서버에 등록된 감사 소유자의 ID입니다.|  
|**유형**|**char(2)**|감사 유형:<br /><br /> SL - NT 보안 이벤트 로그<br /><br /> AL - NT 응용 프로그램 이벤트 로그<br /><br /> FL - 파일 시스템의 파일|  
