...
[추가 민감도 CLASSIFICTION (Transact SQL)](../../t-sql/statements/add-sensitivity-classification-transact-sql.md)

[DROP 민감도 CLASSIFICTION (Transact SQL)](../../t-sql/statements/drop-sensitivity-classification-transact-sql.md)

[SQL Information Protection을 시작 하기](http://aka.ms/sqlip)
