...
|**safety_sequence_number**|**int**|변경 내용에 대 한 시퀀스 번호를 업데이트할 **safety_level**합니다.|  
...
|**is_suspended_sequence_number**|**int**|설정의 시퀀스 번호 **is_suspended**합니다.|  
|**partner_sync_state**|**tinyint**|미러링 세션의 동기화 상태<br /><br /> 5 = 파트너가 동기화 되었습니다. 장애 조치를 수행할 수 있습니다. 장애 조치 참조에 대 한 요구 사항에 대 한 자세한 [전환는 데이터베이스 미러링 세션 중 역할 &#40;SQL Server&#41;](../../database-engine/database-mirroring/role-switching-during-a-database-mirroring-session-sql-server.md)합니다.<br /><br /> 6 = 파트너가 동기화 되지 않습니다. 지금은 장애 조치를 수행할 수 없습니다.|  
