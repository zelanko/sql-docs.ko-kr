...
|**역할**|**tinyint**|미러링 역할. 다음 중 하나입니다.<br /><br /> **0** = 없음<br /><br /> **1** = 파트너<br /><br /> **2** = 미러링 모니터<br /><br /> **3** = 모두<br /><br /> 참고:이 값은 데이터베이스 미러링과만 관련이 있습니다.|  
|**role_desc**|**nvarchar (60)**|미러링 역할 설명. 다음 중 하나입니다.<br /><br /> **없음**<br /><br /> **당사자**<br /><br /> **감시**<br /><br /> **ALL**<br /><br /> 참고:이 값은 데이터베이스 미러링과만 관련이 있습니다.|  
