...
|**role_desc**|**nvarchar(60)**|미러링 역할 설명. 다음 중 하나입니다.<br /><br /> **NONE**<br /><br /> **파트너**<br /><br /> **WITNESS**<br /><br /> **ALL**<br /><br /> 참고:이 값은 데이터베이스 미러링과 관련이 있습니다.|  
...
## <a name="see-also"></a>관련 항목:  
 [추가 또는 가용성 복제본 &#40; 수정 시 끝점 URL 지정 SQL Server &#41;](../../database-engine/availability-groups/windows/specify-endpoint-url-adding-or-modifying-availability-replica.md)   
