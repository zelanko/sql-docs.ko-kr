...
|**key_store_provider_name**|**sysname**|CMK를 포함 하는 열 마스터 키 저장소에 대 한 공급자의 이름입니다. 허용되는 값은 다음과 같습니다.<br /><br /> MSSQL_CERTIFICATE_STORE-열 마스터 키 저장소가 인증서 저장소 인 경우<br /><br /> 열 마스터 키 저장소가 사용자 지정 형식인 경우 사용자 정의 값입니다.|  
...
|**서명과**|**varbinary(max)**|**Key_path**에서 참조 하는 열 마스터 키를 사용 하 여 생성 된 **key_path** 및 **allow_enclave_computations**의 디지털 서명입니다.|
