...
|**default_object_id**|**int**|독립 실행형 [sys.sp_bindefault](../../relational-databases/system-stored-procedures/sp-bindefault-transact-sql.md)인지 또는 인라인 열 수준 기본 제약 조건에 관계 없이 기본 개체의 ID입니다. 인라인 열 수준 기본 개체의 **parent_object_id** 열은 테이블 자체에 대 한 참조입니다. 또는 기본값이 없을 경우 0입니다.|  
|**rule_object_id**|**int**|**Sys.sp_bindrule** 를 사용 하 여 열에 바인딩된 독립 실행형 규칙의 ID입니다.<br /><br /> 0 = 독립 실행형 규칙이 없습니다.<br /><br /> 열 수준 CHECK 제약 조건에 대해서는 [sys.check_constraints &#40;transact-sql&#41;](../../relational-databases/system-catalog-views/sys-check-constraints-transact-sql.md)을 참조 하십시오.|  
