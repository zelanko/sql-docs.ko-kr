...
|**rule_object_id**|**int**|독립 실행형 규칙의 ID를 사용 하 여 열에 바인딩된 **sys.sp_bindrule**합니다.<br /><br /> 0 = 독립 실행형 규칙이 없습니다.<br /><br /> 열 수준 CHECK 제약 조건에 대 한 참조 [sys.check_constraints &#40;TRANSACT-SQL&#41;](../../relational-databases/system-catalog-views/sys-check-constraints-transact-sql.md)합니다.|  
