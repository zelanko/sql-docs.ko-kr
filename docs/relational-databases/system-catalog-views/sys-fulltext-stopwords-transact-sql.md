...
|**언어**|**sysname**|별칭 값 이거나 [sys.fulltext_languages](../../relational-databases/system-catalog-views/sys-fulltext-languages-transact-sql.md)에 해당 하는 로캘 id의 값 (**LCID**), 숫자로 된 LCID의 문자열 표현입니다.|  
