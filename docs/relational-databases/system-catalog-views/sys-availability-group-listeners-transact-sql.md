...
|**ip_configuration_string_from_cluster**|**nvarchar(max)**|이 수신기에 대한 클러스터 IP 구성 문자열(있는 경우)입니다. NULL = 수신기에 가상 IP 주소가 없음. 예를 들면 다음과 같습니다.<br /><br /> IPv4 주소: `65.55.39.10`<br /><br /> IPv6 주소:`2001::4898:23:1002:20f:1fff:feff:b3a3`|  
