---
title: "계산 열의 인덱스 | Microsoft Docs"
ms.custom: ""
ms.date: "02/17/2017"
...
> [!IMPORTANT]  
>  지정된 입력 집합에 대해 항상 같은 결과 집합을 반환하는 식은 결정적입니다. [COLUMNPROPERTY](../../t-sql/functions/columnproperty-transact-sql.md) 함수의 **IsDeterministic** 속성은 *computed_column_expression*이 결정적인지 여부를 보고합니다.  
