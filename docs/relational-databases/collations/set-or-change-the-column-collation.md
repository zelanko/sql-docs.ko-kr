---
title: "열 데이터 정렬 설정 또는 변경 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "tempdb 데이터베이스 [SQL Server], 데이터 정렬"
  - "데이터 정렬 [SQL Server], 열"
...
-   [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]. 자세한 내용은 [Collation and Unicode Support](../../relational-databases/collations/collation-and-unicode-support.md)을 참조하십시오.  
  
-   SMO([!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Management Objects)의 **Column.Collation** 속성 사용  
 ...
 **tempdb**를 사용할 때 [COLLATE](../Topic/COLLATE%20\(Transact-SQL\).md) 절은 *database_default* 옵션을 포함하여 임시 테이블에 있는 열이 **tempdb**의 데이터 정렬 대신 현재 사용자 데이터베이스의 데이터 정렬 기본값을 연결에 사용하도록 지정합니다.  
