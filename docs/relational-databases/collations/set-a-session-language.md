...
ms.topic: "article"
helpviewer_keywords: 
  - "오류 [SQL Server], 국가별 고려 사항"
  - "세계화 [SQL Server], 세션"
  - "시간 [SQL Server]"
  - "세션 [SQL Server], 언어"
  - "국가별 고려 사항 [SQL Server], 세션"
  - "날짜 [SQL Server], 세션 언어"
  - "전체 고려 사항 [SQL Server], 세션"
  - "클라이언트 쪽 세션 언어"
  - "시간 [SQL Server], 세션 언어"
  - "메시지 [SQL Server], 국가별 고려 사항"
  - "서버 쪽 세션 언어"
