---
title: "성능 모니터링 및 튜닝 도구 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "도구 [SQL Server], 성능 모니터링"
  - "서버 성능 모니터링 [SQL Server], 도구"
  - "성능 모니터링 [SQL Server], 도구"
  - "데이터베이스 성능 [SQL Server], 도구"
  - "데이터베이스 튜닝 [SQL Server], 도구"
  - "데이터베이스 모니터링 [SQL Server], 도구"
  - "성능 [SQL Server], 모니터링 도구"
  - "서버 성능 [SQL Server], 도구"
