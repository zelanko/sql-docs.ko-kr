---
title: "SQL Server Profiler를 사용하여 계획 지침 작성 및 테스트 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "계획 지침 확인"
  - "계획 지침 [SQL Server], 테스트"
  - "계획 지침 [SQL Server], SQL Server 프로파일러"
  - "쿼리 대 계획 지침 일치 [SQL Server]"
  - "계획 지침 테스트"
  - "SQL Server 프로파일러, 계획 지침"
  - "계획 지침 [SQL Server]. 만들기"
  - "쿼리 텍스트 캡처 [SQL Server]"
  - "계획 지침 확인"
  - "프로파일러 [SQL Server 프로파일러], 계획 지침"
  - "쿼리 대 계획 지침 일치 [SQL Server]"
