...
description: SQL Server 및 Azure SQL Database Managed Instance에 대한 신속한 인사이트를 제공하는 SQL Server Management Studio Performance 대시보드에 대해 알아봅니다.
ms.custom: ''
ms.date: 12/14/2019
ms.prod: sql
ms.reviewer: ''
