---
title: "성능 모니터링 및 튜닝 | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "07/18/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server 인스턴스, 성능 모니터링"
  - "서버 성능 모니터링 [SQL Server]"
  - "데이터베이스 엔진 [SQL Server], 성능"
  - "성능 모니터링 [SQL Server], 성능 정보"
  - "서버 성능 [SQL Server]"
  - "성능 모니터링 [SQL Server]"
  - "데이터베이스 성능 [SQL Server], 성능 정보"
  - "데이터베이스 튜닝 [SQL Server], 성능 정보"
  - "상태 정보 [SQL Server], 성능 모니터링"
  - "데이터베이스 모니터링 [SQL Server], 성능 정보"
  - "모니터링 [SQL Server], 쿼리 성능"
  - "서버 성능 [SQL Server], 성능 정보"
  - "데이터베이스 튜닝 [SQL Server]"
  - "데이터베이스 성능 [SQL Server]"
  - "모니터링 [SQL Server], 서버 성능"
  - "데이터베이스 모니터링 [SQL Server]"
  - "서버 성능 모니터링 [SQL Server], 서버 성능 모니터링 정보"
