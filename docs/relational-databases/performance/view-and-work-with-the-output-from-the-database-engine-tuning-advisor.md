---
title: "데이터베이스 엔진 튜닝 관리자의 출력 보기 및 작업 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "로그 보기"
  - "권장 사항 [데이터베이스 엔진 튜닝 관리자]"
  - "요약 튜닝 정보 [SQL Server]"
  - "데이터베이스 엔진 튜닝 관리자 [SQL Server], 권장 사항"
  - "데이터베이스 엔진 튜닝 관리자 [SQL Server], 로그"
  - "데이터베이스 엔진 튜닝 관리자 [SQL Server], 출력 보기"
  - "데이터베이스 엔진 튜닝 관리자 [SQL Server], 보고서"
  - "로그 [SQL Server], 튜닝"
  - "보고서 [SQL Server], 튜닝"
  - "튜닝 출력 보기"
...
> [!NOTE]  
>  **dta** 명령줄 유틸리티를 사용하며 **-ox** 인수를 사용하여 XML 파일에 출력 내용이 기록되도록 지정하는 경우 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]의 **파일** 메뉴에서 **파일 열기**를 클릭하여 XML 출력 파일을 열어 볼 수 있습니다. 자세한 내용은 [Use SQL Server Management Studio](../../ssms/use-sql-server-management-studio.md)을 참조하세요. **dta** 명령줄 유틸리티에 대한 자세한 내용은 [dta 유틸리티](../../tools/dta/dta-utility.md)를 참조하세요.  
  
#### 데이터베이스 엔진 튜닝 관리자 GUI로 튜닝 권장 구성을 보려면  
...
#### 데이터베이스 엔진 튜닝 관리자 GUI로 튜닝 요약 및 보고서를 보려면  
...
#### 데이터베이스 엔진 튜닝 관리자 GUI로 튜닝 로그를 보려면  
