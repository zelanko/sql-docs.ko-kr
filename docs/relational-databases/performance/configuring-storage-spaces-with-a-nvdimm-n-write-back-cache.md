...
description: SQL Server 트랜잭션 로그를 저장할 가상 드라이브로 미러된 NVDIMM-N 나중 쓰기 캐시를 사용하여 미러된 스토리지 공간을 설정하는 방법을 알아봅니다.
...
## <a name="see-also"></a>참고 항목  
 ...
 [Windows 2012 R2에서 Windows 스토리지 공간](/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/hh831739(v=ws.11))   
