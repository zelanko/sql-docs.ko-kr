...
description: SQL Server Profiler를 사용하여, 추적에 캡처된 Showplan XML Statistics Profile 이벤트를 파일에 저장하는 방법을 알아봅니다. 파일을 SQL Server Management Studio에서 엽니다.
