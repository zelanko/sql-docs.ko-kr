 ...
 *nColumns*  
 사용자 파일에 포함된 총 열 수입니다. 사용자 파일의 데이터를 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 테이블로 대량 복사 하 고 사용자 파일의 모든 열을 복사 하지 않으려는 경우에도 *Ncolumns* 를 총 사용자 파일 열 수로 설정 해야 합니다.  
