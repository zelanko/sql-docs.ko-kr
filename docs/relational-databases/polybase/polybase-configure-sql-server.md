...
1.  [CREATE EXTERNAL TABLE](../../t-sql/statements/create-external-table-transact-sql.md)을 사용하여 외부 SQL Server 인스턴스에 저장된 데이터를 나타내는 외부 테이블을 만듭니다.
