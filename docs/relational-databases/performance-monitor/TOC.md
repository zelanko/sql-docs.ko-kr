...
# [SQL Server, Broker 활성화 개체](sql-server-broker-activation-object.md)
...
# [SQL Server, 쿼리 저장소 개체](sql-server-query-store-object.md)
...
# [SQL Server, 일괄 처리 응답 통계 개체](sql-server-batch-resp-statistics-object.md)
...
# [SQL Server, 외부 스크립트 개체](sql-server-external-scripts-object.md)
...
# [SQL Server, 카탈로그 메타데이터 개체](sql-server-catalog-metadata-object.md)
...
# [SQL Server, Memory Broker Clerk 개체](sql-server-memory-broker-clerks-object.md)
