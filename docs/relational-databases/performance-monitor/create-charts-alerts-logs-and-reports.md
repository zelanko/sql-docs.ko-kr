---
title: "차트, 경고, 로그 및 보고서 만들기 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "시스템 모니터 [SQL Server], 차트 및 보고서"
  - "차트 [SQL Server]"
  - "보고서 [SQL Server]"
  - "보고서 [SQL Server], 만들기"
  - "Windows 시스템 모니터 [SQL Server], 차트 및 보고서"
  - "로그 [SQL Server], 시스템 모니터"
  - "시스템 모니터 [SQL Server], 로그"
  - "Windows 시스템 모니터 [SQL Server], 로그"
