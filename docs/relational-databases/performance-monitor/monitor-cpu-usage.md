---
title: "CPU 사용량 모니터링 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "성능 모니터링 [SQL Server], CPU 사용량"
  - "데이터베이스 튜닝 [SQL Server], CPU 사용량"
  - "프로세서 [SQL Server], 사용량 모니터링"
  - "데이터베이스 성능 [SQL Server], CPU 사용량"
  - "CPU 사용량 모니터링 [SQL Server]"
  - "서버 성능 [SQL Server], CPU 사용량"
  - "데이터베이스 모니터링 [SQL Server], CPU 사용량"
  - "모니터링 [SQL Server], CPU 사용량"
  - "프로세서 [SQL Server]"
  - "CPU [SQL Server], 모니터링"
  - "서버 성능 모니터링 [SQL Server], CPU 사용량"
