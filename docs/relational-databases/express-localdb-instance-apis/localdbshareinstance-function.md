...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]지정한 공유 이름을 사용 하는 컴퓨터의 다른 사용자와 지정된 된 SQL Server Express LocalDB 인스턴스를 공유 합니다.  
