...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]존재 여부, 전체 LocalDB 버전 번호 (빌드 및 릴리스 번호) 등 지정된 된 SQL Server Express LocalDB 버전에 대 한 정보를 반환 합니다.  
