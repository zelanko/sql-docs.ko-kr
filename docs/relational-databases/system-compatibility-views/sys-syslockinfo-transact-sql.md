...
|**rsc_type**|**tinyint**|리소스 유형:<br /><br /> 1 = NULL 리소스(사용되지 않음)<br /><br /> 2 = Database<br /><br /> 3 = 파일<br /><br /> 4 = 인덱스<br /><br /> 5 = 테이블<br /><br /> 6 = 페이지<br /><br /> 7 = 키<br /><br /> 8 = 익스텐트<br /><br /> 9 = RID (행 ID)<br /><br /> 10 = 응용 프로그램|  
