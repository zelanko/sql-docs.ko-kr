...
|**a-id**|**tinyint**|문자 집합 또는 정렬 순서의 고유 ID입니다. 정렬 순서 및 문자 집합은 같은 ID 번호를 공유할 수 없습니다. 1에서 240까지의 ID는 [!INCLUDE[ssDE](../../includes/ssde-md.md)]에서 사용하도록 예약되어 있습니다.|  
...
|**업무**|**smallint**|내부 시스템 상태 정보 비트입니다.|  
