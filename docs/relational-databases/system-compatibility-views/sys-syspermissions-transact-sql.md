---
title: sys.debug 사용 권한 (Transact-sql) | Microsoft Docs
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
...
|-----------------|---------------|-----------------|  
|**a-id**|**int**|개체 사용 권한에 대한 개체의 ID입니다.<br /><br /> 0 = 문 사용 권한|  
|**피부 여자**|**smallint**|권한에 의해 영향을 받는 사용자, 그룹 또는 역할의 ID입니다.|  
