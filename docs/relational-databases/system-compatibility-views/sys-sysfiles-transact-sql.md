...
|**크기가**|**int**|8KB 페이지 단위로 나타낸 파일의 크기입니다.|  
...
|**업무**|**int**|메가바이트 (MB) 또는 킬로바이트 (KB)의 **증가** 값에 대 한 상태 비트입니다.<br /><br /> 0x2 = 디스크 파일<br /><br /> 0x40 = 로그 파일<br /><br /> 0x100000 = 증가율 이 값은 백분율이며 페이지 수가 아닙니다.|  
|**성능**|**int**|예약되어 있습니다.|  
