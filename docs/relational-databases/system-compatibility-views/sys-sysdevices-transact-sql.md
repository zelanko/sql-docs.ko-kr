...
|**크기가**|**int**|2KB 페이지 단위로 표시한 파일 크기입니다.|  
|**거의**|**int**|이전 버전과의 호환성을 위해서만 유지됩니다.|  
|**최고**|**int**|이전 버전과의 호환성을 위해서만 유지됩니다.|  
|**업무**|**smallint**|디바이스 유형을 표시하는 비트맵입니다.<br /><br /> 1 = 기본 디스크<br /><br /> 2 = 물리적 디스크<br /><br /> 4 = 논리적 디스크<br /><br /> 8 = 머리글 건너뛰기<br /><br /> 16 = 백업 파일<br /><br /> 32 = 순차 쓰기<br /><br /> 4096 = 읽기 전용|  
