...
|sql_handle|**binary (20)**|현재 실행 중인 일괄 처리 또는 개체를 나타냅니다.<br /><br /> **참고** 이 값은 개체의 일괄 처리 또는 메모리 주소에서 파생 됩니다. 
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 해시 기반 알고리즘을 사용하여 계산되지 않습니다.|  
