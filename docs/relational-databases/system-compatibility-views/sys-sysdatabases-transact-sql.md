...
|**모드**|**smallint**|데이터베이스를 만드는 동안 잠그기 위해 내부적으로 사용됩니다.|  
...
|**예약**|**datetime**|나중에 사용하도록 예약되어 있습니다.|  
|**범주**|**int**|복제에 사용되는 정보의 비트맵을 포함합니다.<br /><br /> 1 = 스냅숏 또는 트랜잭션 복제용으로 게시됩니다.<br /><br /> 2 = 스냅숏 또는 트랜잭션 게시를 구독합니다.<br /><br /> 4 = 병합 복제용으로 게시됩니다.<br /><br /> 8 = 병합 게시를 구독합니다.<br /><br /> 16 = 배포 데이터베이스입니다.|  
