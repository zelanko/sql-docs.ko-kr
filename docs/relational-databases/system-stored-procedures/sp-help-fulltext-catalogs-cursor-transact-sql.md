...
## <a name="arguments"></a>인수  
 ...
 [ **@fulltext_catalog_name=**] **'***fulltext_catalog_name***'**  
 전체 텍스트 카탈로그의 이름입니다. *fulltext_catalog_name* 됩니다 **sysname**합니다. 매개 변수를 생략하거나 그 값이 NULL인 경우에는 현재 데이터베이스와 연결된 모든 전체 텍스트 카탈로그에 대한 정보가 반환됩니다.  
