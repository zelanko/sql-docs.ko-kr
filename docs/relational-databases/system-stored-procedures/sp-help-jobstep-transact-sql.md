...
|**on_success_step_id**|**int**|하는 경우 **on_success_action** 4를 실행 하 고 다음 단계로 나타냅니다.|  
|**on_fail_action**|**tinyint**|단계가 실패할 경우 수행되는 작업입니다. 값은 동일 **on_success_action**합니다.|  
|**on_fail_step_id**|**int**|하는 경우 **on_fail_action** 4를 실행 하 고 다음 단계로 나타냅니다.|  
...
-   **SQLAgentOperatorRole**  
 ...
 멤버인 **SQLAgentUserRole** 자신이 소유한 작업에 대 한 작업 단계를 보기만 할 수 있습니다.  
