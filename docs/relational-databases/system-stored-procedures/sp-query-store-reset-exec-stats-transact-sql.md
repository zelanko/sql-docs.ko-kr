...
## <a name="arguments"></a>인수  
 [  **@plan_id =** ] *plan_id*  
 선택이 취소 되는 쿼리 계획의 id가입니다. *plan_id* 는 **bigint**, 기본값은 없습니다.  
...
```  
 ...
 통계의 선택을 취소 하려는 plan_id를 식별 한 후 특정 쿼리 계획에 대 한 실행 통계를 삭제 하려면 다음 예제를 사용 합니다. 이 예에서는 계획 번호 3에 대 한 실행 통계를 삭제 합니다.  
