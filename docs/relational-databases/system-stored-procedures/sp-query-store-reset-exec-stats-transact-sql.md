---
title: sp_query_store_reset_exec_stats (TRANSACT-SQL) | Microsoft 문서
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
```  
 ...
 통계의 선택을 취소 하려는 plan_id를 확인 한 후 특정 쿼리 계획에 대 한 실행 통계를 삭제 하려면 다음 예제를 사용 합니다. 계획 번호 3에 대 한 실행 통계를 삭제 하는이 예제입니다.  
