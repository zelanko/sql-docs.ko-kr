...
|**유형**|**int**|작업의 유형입니다.<br /><br /> 1 = 로컬 작업<br /><br /> **2** = 다중 서버 작업입니다.<br /><br /> **0** = 작업에 대상 서버가 없습니다.|  
...
|**플래그**|**nvarchar(4000)**|**비트 마스크** 단계 동작을 제어 하는 값입니다.|  
...
|**사용 하도록 설정**|**int**|일정이 활성 상태 인지 여부 (**1**) 아닌지 (**0**).|  
