...
|**SQL_DATA_TYPE**|**smallint**|설명자의 **type** 필드에 표시 되는 SQL 데이터 형식의 값입니다. 이 열은 **datetime** 및 ISO **interval** 데이터 형식을 제외하고는 **DATA_TYPE** 열과 동일합니다. 이 열은 항상 값을 반환합니다.|  
