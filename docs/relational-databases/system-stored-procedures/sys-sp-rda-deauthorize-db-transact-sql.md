...
ms.locfileid: "32996960"
---
# <a name="syssprdadeauthorizedb-transact-sql"></a>sys.sp_rda_deauthorize_db (Transact SQL)
[!INCLUDE[tsql-appliesto-ss2016-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2016-xxxx-xxxx-xxx-md.md)]

  로컬 스트레치 사용 데이터베이스와 원격 Azure 데이터베이스 간의 인증된 된 연결을 제거합니다. 실행 **sp_rda_deauthorize_db** 원격 데이터베이스를 연결할 수 없습니다. 또는 일관성이 없는 상태는 데이터베이스의 모든 스트레치 사용 테이블에 대 한 쿼리 동작을 변경 하려는 시점과 합니다.  
