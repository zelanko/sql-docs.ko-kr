...
`[ @query_id = ] query_id` 쿼리 저장소에서 제거할 쿼리의 id가입니다. *query_id* 되는 **bigint**, 기본값은 없습니다.  
...
```  
 ...
 삭제 하려는 query_id를 확인 한 후 쿼리를 삭제 하려면 다음 예제를 사용 합니다.  
