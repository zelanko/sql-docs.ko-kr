...
|**thirdparty_flag**|**bit**|게시를 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 또는 타사 응용 프로그램에 사용할 수 있는지 여부를 지정합니다.<br /><br /> **0** = [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], oracle 또는 Oracle Gateway 게시자입니다.<br /><br /> **1** = 게시자는 통합 되어 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 타사 응용 프로그램을 사용 합니다.|  
 ...
 **sp_helpdistpublisher** 게시자 로그인을 표시 하지 것입니다 또는 결과에서 암호 설정 되어 비-**sysadmin** 로그인 합니다.  
  
## <a name="permissions"></a>Permissions  
 멤버는 **sysadmin** 고정된 서버 역할 실행 될 수 있습니다 **sp_helpdistpublisher** 로컬 서버를 배포자로 사용 하 여 게시자에 대해 합니다. 멤버는 **db_owner** 고정된 데이터베이스 역할 또는 **replmonitor** 배포 데이터베이스의 역할에에서 실행 될 수 있습니다 **sp_helpdistpublisher** 하를 사용 하 여 게시자에 대해 배포 데이터베이스입니다. 지정 된 게시에 대 한 사용자가 게시 액세스에서 목록 *게시자* 실행 될 수 있습니다 **sp_helpdistpublisher**합니다. 경우 *게시자* 를 지정 하지 않으면 사용자가 액세스 권한을 갖는 모든 게시자에 대해 정보를 반환 합니다.  
