...
|**암호**|**nvarchar (524)**|간단히 암호화된 형식으로 반환되는 암호입니다. **Sysadmin**이외의 사용자에 대 한 암호는 NULL입니다.|  
|**directory**|**bit**|원격 게시자가 배포자로 로컬 서버를 사용하는지 여부를 지정합니다.<br /><br /> **0** = 아니요<br /><br /> **1** = 예|  
...
|**thirdparty_flag**|**bit**|게시를 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 또는 타사 애플리케이션에 사용할 수 있는지 여부를 지정합니다.<br /><br /> **** = 0[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], oracle 또는 oracle Gateway 게시자입니다.<br /><br /> **1** = 게시자가 타사 응용 프로그램 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 을 사용 하 여 통합 되었습니다.|  
