...
## <a name="remarks"></a>주의  
 ...
 이 절차는 컬렉션 시작 되며 지정된 된 컬렉션 집합 및 컬렉션 집합에 있는 경우 컬렉션 에이전트 작업을 즉시 시작에 대 한 업로드 작업의  **@collection_mode**  캐시 되지 않은 (1)로 설정 합니다. 자세한 내용은 참조 하십시오 [sp_syscollector_create_collection_set &#40; Transact SQL &#41; ](../../relational-databases/system-stored-procedures/sp-syscollector-create-collection-set-transact-sql.md).  
