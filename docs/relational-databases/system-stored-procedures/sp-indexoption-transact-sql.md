...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
 ...
 [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]은 자동으로 페이지, 행 또는 테이블 수준의 잠금을 선택합니다. 이러한 옵션을 수동으로 설정할 필요는 없습니다. **sp_indexoption** 적절 한지 확실히 잠금의 특정 형식을 알고 있는 전문가 대 한 제공 됩니다.  
  
> [!IMPORTANT]  
>  [!INCLUDE[ssNoteDepNextAvoid](../../includes/ssnotedepnextavoid-md.md)] 대신 [ALTER INDEX &#40;TRANSACT-SQL&#41;](../../t-sql/statements/alter-index-transact-sql.md)합니다.  
...
-   때 **AllowRowLocks** 하거나 **DisAllowRowLocks** 는 TRUE 또는 FALSE로 설정은 힙에 적용 되 고 연결 된 비클러스터형 인덱스입니다.  
