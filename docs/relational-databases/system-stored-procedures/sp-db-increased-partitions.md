...
||  
|-|  
|**적용 대상**: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ([!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] s p 2부터 [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] SP1 이상 버전). 자세한 내용은 참조 [SQL Server 2008 SP2 및 SQL Server 2008 R2 SP1 15,000 파티션 지원](http://go.microsoft.com/fwlink/p/?LinkId=299658),|  
