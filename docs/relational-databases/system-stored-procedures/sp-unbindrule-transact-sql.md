...
## <a name="remarks"></a>Remarks  
 ...
 규칙이 별칭 데이터 형식에서 바인딩 해제되면 해당 규칙은 이 별칭 데이터 형식을 가진 열에서도 바인딩 해제됩니다. 규칙 데이터 형식이 나중에 ALTER TABLE 문의 ALTER COLUMN 절에 의해 변경 된 열에도 여전히 바인딩할 수 있습니다를 사용 하 여는 이러한 열에서 규칙 특히 바인딩을 해제 해야 합니다 **sp_unbindrule** 지정 하는 열 이름입니다.  
