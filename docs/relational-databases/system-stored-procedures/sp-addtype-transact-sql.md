...
### <a name="b-creating-an-alias-data-type-that-allows-for-null-values"></a>B. NULL 값을 허용하는 별칭 데이터 형식 만들기  
...
### <a name="c-creating-additional-alias-data-types"></a>C. 추가 별칭 데이터 형식 만들기  
