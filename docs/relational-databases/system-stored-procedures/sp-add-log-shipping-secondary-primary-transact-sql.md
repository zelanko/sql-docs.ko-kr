...
## <a name="arguments"></a>인수  
 ...
 [ **@copy_job_name** =] '*copy_job_name*'  
 트랜잭션 로그 백업을 보조 서버에 복사하기 위해 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 에이전트 작업을 생성하는 데 사용할 이름입니다. *copy_job_name* 됩니다 **sysname** NULL 일 수 없습니다.  
  
 [ **@restore_job_name** =] '*restore_job_name*'  
 이름인는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 백업을 보조 데이터베이스로 복원 하는 보조 서버의 에이전트 작업입니다. *restore_job_name* 됩니다 **sysname** NULL 일 수 없습니다.  
  
 [ **@file_retention_period** =] '*file_retention_period*'  
 시간 (분)에서 지정한 경로에서 보조 서버에서 유지 되는 백업 파일의 길이 @backup_destination_directory 삭제 되기 전에 매개 변수입니다. *history_retention_period* 됩니다 **int**, 기본값은 NULL입니다. 값이 지정되지 않으면 14420이 사용됩니다.  
 ...
 *monitor_server_security_mode* 됩니다 **비트** NULL 일 수 없습니다.  
 ...
 보조 서버의 복사 작업과 연관된 ID입니다. *copy_job_id* 됩니다 **uniqueidentifier** NULL 일 수 없습니다.  
  
 [ **@restore_job_id** =] '*restore_job_id*' 출력  
 보조 서버의 복원 작업과 연관된 ID입니다. *restore_job_id* 됩니다 **uniqueidentifier** NULL 일 수 없습니다.  
