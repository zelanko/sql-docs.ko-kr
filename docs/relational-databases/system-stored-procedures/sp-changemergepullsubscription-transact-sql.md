...
|**우선 순위**||이전 버전과 호환성을 위해서만;에 대 한 사용 가능 실행 [sp_changemergesubscription](../../relational-databases/system-stored-procedures/sp-changemergesubscription-transact-sql.md) 게시자에서 대신 구독의 우선 순위를 수정 합니다.|  
