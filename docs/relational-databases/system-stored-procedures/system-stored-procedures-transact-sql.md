...
|[Transact-sql&#41;Filestream 및 FileTable 저장 프로시저 &#40;](./filestream-and-filetable-sp-filestream-force-garbage-collection.md)|FILESTREAM 및 FileTable 기능을 구성하고 관리합니다.|  
...
|[PolyBase 저장 프로시저](./polybase-stored-procedures-sp-polybase-join-group.md)|PolyBase 스케일 아웃 그룹에서 컴퓨터를 추가 하거나 제거 합니다.|  
...
|[스냅숏 백업 저장 프로시저](./snapshot-backup-sp-delete-backup.md)|FILE_SNAPSHOT 백업을 모든 스냅숏과 함께 삭제 하거나 개별 백업 파일 스냅숏을 삭제 하는 데 사용 됩니다.|  
|[공간 인덱스 저장 프로시저](./spatial-index-stored-procedures-arguments-and-properties.md)|공간 인덱스의 인덱싱 성능을 분석하고 개선하는 데 사용됩니다.|  
...
|[Temporal 테이블 저장 프로시저](./spatial-index-stored-procedures-arguments-and-properties.md)|Temporal 테이블에 사용|  
