 ...
 *monitor_server_security_mode* 됩니다 **비트** NULL 일 수 없습니다.  
 ...
 [  **@threshold_alert =** ] '*threshold_alert*'  
 백업 임계값이 초과될 때 발생하는 경고입니다. *threshold_alert* 됩니다 **int** NULL 일 수 없습니다.  
  
 [  **@threshold_alert_enabled =** ] '*threshold_alert_enabled*'  
 경고가 발생 하는지 여부를 지정 하면 *backup_threshold* 를 초과 합니다.  
 ...
 *threshold_alert_enabled* 됩니다 **비트** NULL 일 수 없습니다.  
 ...
 [  **@history_retention_period =** ] '*history_retention_period*'  
 기록이 보존되는 기간(분)입니다. *history_retention_period* 됩니다 **int**합니다. 지정된 값이 없으면 14420을 사용합니다.  
