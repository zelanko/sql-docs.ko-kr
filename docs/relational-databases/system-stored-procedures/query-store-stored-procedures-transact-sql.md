---
description: 쿼리 저장소 저장 프로시저 (Transact-sql)
title: 쿼리 저장소 저장 프로시저 (Transact-sql) | Microsoft Docs
ms.custom: ''
ms.date: 03/29/2016
ms.prod: sql
