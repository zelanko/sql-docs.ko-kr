...
## <a name="remarks"></a>주의  
 **sp_grantdbaccess** 추가 옵션을 지 원하는 CREATE USER를 호출 합니다. 데이터베이스 사용자를 만드는 방법은 참조 [CREATE USER &#40;TRANSACT-SQL&#41;](../../t-sql/statements/create-user-transact-sql.md)합니다. 사용 하 여 데이터베이스에서 데이터베이스 사용자를 제거 하려면 [DROP USER](../../t-sql/statements/drop-user-transact-sql.md)합니다.  
