...
|**Default domain**|트러스트된 연결의 네트워크 사용자에 대한 기본 Windows 도메인 이름입니다. 기본 도메인은 Windows 및 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]를 실행하고 있는 컴퓨터의 도메인입니다. 이 값은 이전 버전과의 호환성을 위해 제공됩니다.|  
