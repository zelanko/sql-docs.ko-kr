...
## <a name="result-sets"></a>결과 집합  
 이 저장 프로시저는 로그 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 전달 경고 작업의 에이전트 작업 ID를 반환 합니다. 로그 전달 경고 작업이 없으면 빈 결과 집합을 반환합니다.  
