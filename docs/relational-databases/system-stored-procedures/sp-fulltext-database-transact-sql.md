...
> [!IMPORTANT]  
>  [!INCLUDE[ssNoteDepFutureDontUse](../../includes/ssnotedepfuturedontuse-md.md)]사용 하 여 [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] 대신 합니다.  
