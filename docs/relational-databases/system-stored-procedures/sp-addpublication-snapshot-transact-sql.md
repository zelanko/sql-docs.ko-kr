...
|**32**|*frequency_interval* 다음 중 하나입니다.<br /><br /> **1** = 일요일 &#124;<br /><br /> **2** = 월요일 &#124;<br /><br /> **3** = 화요일 &#124;<br /><br /> **4** = 수요일 &#124;<br /><br /> **5** = 목요일 &#124;<br /><br /> **6** = 금요일 &#124;<br /><br /> **7** = 토요일 &#124;<br /><br /> **8** = 하루 &#124;<br /><br /> **9** = 평일 &#124;<br /><br /> **10** = 주말|  
...
> [!NOTE]  
>  에 대 한 비-[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 게시자의 경우에 지정 된 동일한 로그인 이어야 합니다. [sp_adddistpublisher &#40; Transact SQL &#41; ](../../relational-databases/system-stored-procedures/sp-adddistpublisher-transact-sql.md).  
