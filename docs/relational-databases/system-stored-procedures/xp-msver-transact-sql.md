...
ms.locfileid: "39103651"
---
# <a name="xpmsver-transact-sql"></a>xp_msver(Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]

  [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]에 대한 버전 정보를 반환합니다. **xp_msver** 도 서버의 실제 빌드 번호 및 서버 환경에 대 한 정보를 반환 합니다. 정보는 **xp_msver** 반환 내에서 사용할 수 있습니다 [!INCLUDE[tsql](../../includes/tsql-md.md)] 문, 일괄 처리, 저장된 프로시저 및 등과 플랫폼 독립적인 코드 논리를 강화 합니다.  
...
|**ProcessorType**|프로세서 유형입니다. 비슷합니다 **플랫폼**합니다.|  
 ...
 **xp_msver**, 매개 변수를 없이 모든 옵션 값을 나열 하는 4 개의 열으로 된 결과 집합을 반환 합니다. **xp_msver**, 모든 매개 변수에 대 한 네 개의 열 결과 옵션에 대 한 값을 사용 하 여 집합을 반환 합니다.  
