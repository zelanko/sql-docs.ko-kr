...
## <a name="remarks"></a>주의  
 ...
 세션 컨텍스트의 총 크기는 256kb로 제한 합니다. 이 제한을 초과할 발생 하는 값 집합에는 문이 실패 합니다. 전체 메모리 사용량을 모니터링할 수 있습니다 [sys.dm_os_memory_objects &#40;TRANSACT-SQL&#41;](../../relational-databases/system-dynamic-management-views/sys-dm-os-memory-objects-transact-sql.md)합니다.  
