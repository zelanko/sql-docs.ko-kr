...
ms.locfileid: "33252279"
---
# <a name="xml-stored-procedures-transact-sql"></a>XML 저장 프로시저(Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]

  [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 에서는 다음과 같은 시스템 XML 텍스트 관리에 사용 되는 프로시저를 저장 합니다.  
