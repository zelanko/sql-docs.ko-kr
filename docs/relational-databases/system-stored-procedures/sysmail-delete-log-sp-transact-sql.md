...
`[ @logged_before = ] 'logged_before'` 날짜 및 지정 된 시간 까지의 항목을 삭제 합니다 *logged_before* 인수입니다. *logged_before* 됩니다 **datetime** 기본적으로 null입니다. NULL은 모든 날짜를 나타냅니다.  
  
`[ @event_type = ] 'event_type'` 로그로 지정 된 형식의 항목을 삭제 합니다 *event_type*합니다. *event_type* 됩니다 **varchar(15)** 기본값은 없습니다. 유효한 항목은 **성공**, **경고**합니다 **오류**, 및 **정보**합니다. NULL은 모든 이벤트 유형을 나타냅니다.  
