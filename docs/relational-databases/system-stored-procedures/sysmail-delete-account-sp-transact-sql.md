...
## <a name="arguments"></a>인수  
 ...
 삭제할 계정의 ID 번호입니다. *account_id* 됩니다 **int**, 기본값은 없습니다. 어느 *account_id* 하거나 *account_name* 지정 해야 합니다.  
  
 [ **@account_name** =] **'***account_name***'**  
 삭제할 계정의 이름입니다. *account_name* 됩니다 **sysname**, 기본값은 없습니다. 어느 *account_id* 하거나 *account_name* 지정 해야 합니다.  
