...
## <a name="remarks"></a>설명  
 **sp_copysnapshot** 은 모든 유형의 복제에 사용 됩니다. 버전 7.0 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 및 이전 버전을 실행 하는 구독자는 대체 스냅숏 위치를 사용할 수 없습니다.  
