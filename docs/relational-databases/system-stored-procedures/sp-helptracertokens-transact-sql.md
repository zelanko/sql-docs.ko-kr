 ...
 **sp_helptracertokens** 를 실행할 때 추적 프로그램 토큰 Id를 가져오는 데 [sp_helptracertokenhistory &#40; Transact SQL &#41; ](../../relational-databases/system-stored-procedures/sp-helptracertokenhistory-transact-sql.md).  
