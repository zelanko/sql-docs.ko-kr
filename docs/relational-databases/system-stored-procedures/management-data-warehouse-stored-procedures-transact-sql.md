---
description: 관리 데이터 웨어하우스 저장 프로시저(Transact-SQL)
title: 관리 데이터 웨어하우스 저장 프로시저 (Transact-sql) | Microsoft Docs
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
...
ms.locfileid: "97440574"
---
# <a name="management-data-warehouse-stored-procedures-transact-sql"></a>관리 데이터 웨어하우스 저장 프로시저(Transact-SQL)
[!INCLUDE [sql-asdb-asdbmi-asa-pdw](../../includes/applies-to-version/sql-asdb-asdbmi-asa-pdw.md)]

  데이터 수집기는 관리 데이터 웨어하우스에 데이터 및 데이터 수집기 형식 정보를 저장합니다. 다음 저장 프로시저는 관리 데이터 웨어하우스에 있는 데이터를 업데이트하고 테이블을 변경하는 데 사용됩니다.  
