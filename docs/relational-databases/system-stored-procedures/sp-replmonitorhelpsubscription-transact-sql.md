...
`[ @exclude_anonymous = ] exclude_anonymous`결과 집합에서 익명 끌어오기 구독을 제외할지 여부입니다. *exclude_anonymous* 는 **bit**이며 기본값은 **0**입니다. 값 **1** 은 익명 구독을 제외 하 고 값이 **0** 이면 포함 됨을 의미 합니다.  
...
|**subtype**|**int**|구독 유형이며 다음 값 중 하나일 수 있습니다.<br /><br /> **0** = 푸시<br /><br /> **1** = 끌어오기<br /><br /> **2** = 익명|  
