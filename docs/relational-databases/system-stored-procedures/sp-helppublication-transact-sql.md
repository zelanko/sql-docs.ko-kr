...
[!INCLUDE[appliesto-ss-asdbmi-xxxx-xxx-md](../../includes/appliesto-ss-asdbmi-xxxx-xxx-md.md)]
  ...
  게시에 관한 정보를 반환합니다. @No__t_0 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 게시의 경우이 저장 프로시저는 게시 데이터베이스의 게시자에서 실행 됩니다. Oracle 게시의 경우 이 저장 프로시저는 배포자에서 모든 데이터베이스에 대해 실행됩니다.  
...
## <a name="permissions"></a>Permissions  
 ...
 @No__t_0 이외 게시자의 경우 배포자에서 sysadmin 고정 서버 역할의 멤버 또는 배포 데이터베이스에 대 한 db_owner 고정 데이터베이스 역할의 멤버 또는 PAL에 있는 사용자만 sp_helppublication을 실행할 수 있습니다.  
