...
[!INCLUDE[tsql-appliesto-ss2014-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2014-xxxx-xxxx-xxx-md.md)]
 ...
 고유 하 게 컴파일된 모든 저장된 프로시저에 대 한 프로시저 수준 통계 컬렉션을 사용 하려면 참조 [sys.sp_xtp_control_proc_exec_stats &#40;TRANSACT-SQL&#41;](../../relational-databases/system-stored-procedures/sys-sp-xtp-control-proc-exec-stats-transact-sql.md)합니다.  
...
## <a name="arguments"></a>인수  
 ...
 @new_collection_value 때 0으로 설정 되어 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 시작 합니다.  
