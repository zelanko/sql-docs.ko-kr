...
[!INCLUDE[sqlserver](../../includes/applies-to-version/sqlserver.md)]
 ...
 고유 하 게 컴파일된 모든 저장 프로시저에 대 한 프로시저 수준에서 통계 컬렉션을 사용 하도록 설정 하려면 [sp_xtp_control_proc_exec_stats &#40;transact-sql&#41;](../../relational-databases/system-stored-procedures/sys-sp-xtp-control-proc-exec-stats-transact-sql.md)을 참조 하십시오.  
