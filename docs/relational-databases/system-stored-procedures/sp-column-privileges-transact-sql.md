...
## <a name="arguments"></a>인수  
 ...
 카탈로그 정보를 반환하는 데 사용되는 테이블입니다. *table_name* 됩니다 **sysname**, 기본값은 없습니다. 와일드카드 패턴 일치는 지원되지 않습니다.  
  
 [ @table_owner=] '*table_owner*'  
 카탈로그 정보를 반환하는 데 사용하는 테이블의 소유자입니다. *table_owner* 됩니다 **sysname**, 기본값은 NULL입니다. 와일드카드 패턴 일치는 지원되지 않습니다. 하는 경우 *table_owner* 지정 하지 않으면 기본 데이터베이스 관리 시스템 (DBMS)의 기본 테이블 표시 규칙이 적용 됩니다.  
