...
## <a name="examples"></a>예  
 다음 예제에 정의 된 예에서 만들어진 컬렉션 항목 기반 [sp_syscollector_create_collection_item &#40; Transact SQL &#41; ](../../relational-databases/system-stored-procedures/sp-syscollector-create-collection-item-transact-sql.md).  
