...
##  <a name="arguments"></a><a name="Arguments"></a> 인수  
 ...
 [@begin_time  
 이벤트가 표시되어야 하는 기간의 시작 시간입니다. @begin_time매개 변수는 DATETIME 이며 기본값은 NULL입니다. 지정되지 않은 경우 이전 30분의 이벤트가 표시됩니다.  
  
 @end_time  
 이벤트가 표시되어야 하는 기간의 종료 시간입니다. @end_time매개 변수는 DATATIME 이며 기본값은 NULL입니다.  지정하지 않은 경우 현재 시간까지의 이벤트가 표시됩니다.  
