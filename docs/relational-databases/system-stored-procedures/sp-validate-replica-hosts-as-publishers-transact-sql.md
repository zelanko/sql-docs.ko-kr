...
원래 게시자/게시 된 데이터베이스 쌍에 대해 **sp_redirect_publisher** 를 호출할 때 리디렉션의 대상을 `[ @redirected_publisher = ] 'redirected_publisher'` 합니다. *redirected_publisher* 는 **sysname**이며 기본값은 없습니다.  
