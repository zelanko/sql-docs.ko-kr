...
## <a name="arguments"></a>인수  
 [ **@publisher** = ] **'***publisher***'**  
 유형이 다른 게시자의 이름입니다. *publisher* 는 **sysname**이며 기본값은 없습니다.  
  
 [ **@propertyname** =] **'***propertyname***'**  
 설정할 속성 이름입니다. *propertyname* 은 **sysname**이며 다음 값 중 하나일 수 있습니다.  
...
## <a name="remarks"></a>설명  
 **sp_publisherproperty** 는 이외 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 게시자에 대 한 트랜잭션 복제에 사용 됩니다.  
...
## <a name="permissions"></a>사용 권한  
 배포자에서 **sysadmin** 고정 서버 역할의 멤버만 **sp_publisherproperty**을 실행할 수 있습니다.  
