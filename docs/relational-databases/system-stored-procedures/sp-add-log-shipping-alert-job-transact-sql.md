...
`[ @alert_job_id = ] alert_job_id OUTPUT`[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 로그 전달 경고 작업의 에이전트 작업 ID입니다.  
...
## <a name="remarks"></a>설명  
 **sp_add_log_shipping_alert_job** 는 모니터 서버에 있는 **master** 데이터베이스에서 실행 해야 합니다.  
