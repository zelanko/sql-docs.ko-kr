# [개요](system-stored-procedures-transact-sql.md)  
...
# 임시 테이블
## [임시 테이블-sys.sp_cleanup_temporal_history](temporal-table-sys-sp-cleanup-temporal-history.md)  
## [임시 테이블-sp_xtp_flush_temporal_history](temporal-table-sp-xtp-flush-temporal-history.md)  
# 스냅숏 백업
## [스냅숏 백업-sp_delete_backup_file_snapshot](snapshot-backup-sp-delete-backup-file-snapshot.md)  
## [스냅숏 백업-sp_delete_backup](snapshot-backup-sp-delete-backup.md)  
# PolyBase
## [PolyBase 저장 프로시저-sp_polybase_join_group](polybase-stored-procedures-sp-polybase-join-group.md)  
## [PolyBase 저장 프로시저-sp_polybase_leave_group](polybase-stored-procedures-sp-polybase-leave-group.md)  
# Filestream 및 Filetable
## [Filestream 및 FileTable-sp_filestream_force_garbage_collection](filestream-and-filetable-sp-filestream-force-garbage-collection.md)  
## [Filestream 및 FileTable-sp_kill_filestream_non_transacted_handles](filestream-and-filetable-sp-kill-filestream-non-transacted-handles.md)  
# 활성 지리적 복제
...
# [변경 데이터 캡처](change-data-capture-stored-procedures-transact-sql.md)  
...
# [커서](cursor-stored-procedures-transact-sql.md)  
...
## [sp_syscollector_delete_collection_set은](sp-syscollector-delete-collection-set-transact-sql.md)  
...
## [sp_execute_remote (Azure SQL 데이터베이스)](sp-execute-remote-azure-sql-database.md)  
...
## [s p _ h](sp-helpsort-transact-sql.md)  
...
# [분산된 쿼리](distributed-queries-stored-procedures-transact-sql.md)  
...
# [방화벽 규칙 (Azure SQL 데이터베이스)](firewall-rules-stored-procedures-azure-sql-database.md)  
## [sp_set_firewall_rule (Azure SQL 데이터베이스)](sp-set-firewall-rule-azure-sql-database.md)  
## [sp_set_database_firewall_rule (Azure SQL 데이터베이스)](sp-set-database-firewall-rule-azure-sql-database.md)  
## [sp_delete_firewall_rule (Azure SQL 데이터베이스)](sp-delete-firewall-rule-azure-sql-database.md)  
## [sp_delete_database_firewall_rule (Azure SQL 데이터베이스)](sp-delete-database-firewall-rule-azure-sql-database.md)  
...
## [managed_backup.sp_](managed-backup-sp-backup-master-switch-transact-sql.md)  
...
# [관리 데이터 웨어하우스](management-data-warehouse-stored-procedures-transact-sql.md)  
...
## [개체 계층 구조 구문](object-hierarchy-syntax-transact-sql.md)  
...
# [보안](security-stored-procedures-transact-sql.md)  
...
# [SQL 데이터 웨어하우스](sql-data-warehouse-stored-procedures.md)  
...
## [가 sp_pdw_database_encryption](sp-pdw-database-encryption-sql-data-warehouse.md)  
...
# [스트레치 데이터베이스 확장](stretch-database-extended-stored-procedures-transact-sql.md)  
