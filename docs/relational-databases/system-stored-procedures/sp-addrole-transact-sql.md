...
> [!IMPORTANT]
>  **sp_addrole** 는 이전 버전의와의 호환성을 위해 포함 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 되었으며 이후 릴리스에서는 지원 되지 않을 수 있습니다. 대신 [CREATE ROLE](../../t-sql/statements/create-role-transact-sql.md) 을 사용 해야 합니다.  
