...
|**run_value**|**int**|현재 실행 중인 구성 옵션 값입니다 ( **value_in_use**의 값).<br /><br /> 자세한 내용은 [sys. 구성 &#40;&#41;transact-sql](../../relational-databases/system-catalog-views/sys-configurations-transact-sql.md)을 참조 하세요.|  
...
> [!NOTE]  
>  옵션에 대해 지정 된 *값* 이 너무 높으면 **run_value** 열은 [!INCLUDE[ssDE](../../includes/ssde-md.md)]가 유효 하지 않은 설정을 사용 하는 대신 동적 메모리를 기본값으로 사용 한다는 사실을 반영 합니다.  
