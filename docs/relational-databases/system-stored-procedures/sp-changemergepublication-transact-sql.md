...
|**conflict_retention**||**int** 충돌은 보존할 일의 보존 기간을 지정 하는 합니다. 설정 *conflict_retention* 하 **0** 충돌 정리가 필요한 것을 의미 합니다.|  
 ...
 **1** 게시도 인해 기존 구독이 다시 초기화 되도록 변경 하 고 구독을 다시 초기화할 수 있는 권한이 부여를 지정 합니다.  
 ...
 **sp_changemergepublication** 병합 복제에 사용 됩니다.  
 ...
 다음 속성을 변경하려면 새 스냅숏을 생성해야 하며 값을 지정 해야 하면 **1** 에 대 한 합니다 *force_invalidate_snapshot* 매개 변수입니다.  
...
-   **publication_compatibility_level** (하 **80SP3** 만)  
...
-   **use_partition_groups**  
 ...
 다음 속성을 변경하려면 기존 구독을 다시 초기화해야 하며 값을 지정 해야 합니다 **1** 에 대 한 합니다 *force_reinit_subscription* 매개 변수입니다.  
  
-   **dynamic_filters**  
  
-   **validate_subscriber_info**  
  
 사용 하 여 Active Directory에 게시 개체 목록에는 *publish_to_active_directory*, [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 개체는 Active Directory에서 이미 만들어져 있어야 합니다.  
...
## <a name="permissions"></a>사용 권한  
 멤버는 **sysadmin** 고정된 서버 역할 또는 **db_owner** 고정된 데이터베이스 역할을 실행할 수 있습니다 **sp_changemergepublication**합니다.  
