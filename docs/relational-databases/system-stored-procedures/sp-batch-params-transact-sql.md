...
|**PARAMETER_NAME**|**sysname**|
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]가 일괄 처리에서 찾은 매개 변수의 이름입니다.|  
...
|**길이**|**int**|데이터의 전송 크기입니다. 이 값은 NULL입니다.|  
...
|**SQL_DATETIME_SUB**|**smallint**|**SQL_DATA_TYPE** 값이 SQL_DATETIME 또는 SQL_INTERVAL 경우 **datetime** 또는 ISO **interval** 하위 코드입니다. **Datetime** 및 ISO **간격이**아닌 데이터 형식의 경우이 열은 NULL입니다. 이 값은 NULL입니다.|  
