...
|**type**|**tinyint**|구독자의 유형입니다.<br /><br /> **0**  = 데이터베이스1 = ODBC 데이터 원본[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|  
...
|**frequency_relative_interval**|**int**|*Frequency_type* 가 **32** (매월 상대적)로 설정 된 경우 사용 되는 배포 에이전트 날짜입니다.<br /><br /> **1** = 첫 번째<br /><br /> **2** = 초<br /><br /> **4** = 세 번째<br /><br /> **8** = 네 번째<br /><br /> **16** = 마지막|  
|**frequency_recurrence_factor**|**int**|*Frequency_type*에서 사용 되는 되풀이 비율입니다.|  
...
|**security_mode**|**int**|구현된 보안 모드입니다.<br /><br /> **0**  =  인증[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]<br /><br /> 1 =  Windows[!INCLUDE[msCoName](../../includes/msconame-md.md)] 인증|  
...
|**frequency_relative_interval2**|**int**|*Frequency_type* 가 32 (매월 상대적)로 설정 된 경우 사용 되는 병합 에이전트 날짜입니다.<br /><br /> **1** = 첫 번째<br /><br /> **2** = 초<br /><br /> **4** = 세 번째<br /><br /> **8** = 네 번째<br /><br /> **16** = 마지막|  
 ...
 **Sysadmin** 고정 서버 역할, **db_owner** 고정 데이터베이스 역할 또는 게시에 대 한 게시 액세스 목록의 멤버만 **sp_helpsubscriberinfo**을 실행할 수 있습니다.  
