...
> [!IMPORTANT]  
>  [!INCLUDE[ssNoteDepNextAvoid](../../includes/ssnotedepnextavoid-md.md)] 통계에 대 한 정보를 얻으려면 [sys.debug](../../relational-databases/system-catalog-views/sys-stats-transact-sql.md) 및 [sys.stats_columns](../../relational-databases/system-catalog-views/sys-stats-columns-transact-sql.md) 카탈로그 뷰를 쿼리 합니다.  
