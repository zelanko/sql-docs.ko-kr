...
`[ @tracer_id = ] tracer_id`기록 정보가 반환 되는 [MStracer_tokens &#40;&#41; ](../../relational-databases/system-tables/mstracer-tokens-transact-sql.md) 테이블의 추적 프로그램 토큰 ID입니다. *tracer_id* 는 **int**이며 기본값은 없습니다.  
 ...
 **sp_helptracertokenhistory** 은 트랜잭션 복제에 사용 됩니다.  
 ...
 [Sp_helptracertokens &#40;transact-sql&#41; ](../../relational-databases/system-stored-procedures/sp-helptracertokens-transact-sql.md) 을 실행 하 여 게시에 대 한 추적 프로그램 토큰 목록을 가져옵니다.  
