---
title: "Off By Default 정책을 실행하도록 서버 구성 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
5.  [!INCLUDE[ssDE](../../includes/ssde-md.md)]이 정책을 준수하는 경우 **결과** 영역에 확인 표시가 있는 녹색 원이 나타납니다. [!INCLUDE[ssDE](../../includes/ssde-md.md)]이 정책을 준수하지 않는 경우 X 표시가 있는 빨간색 원이 나타납니다.  
