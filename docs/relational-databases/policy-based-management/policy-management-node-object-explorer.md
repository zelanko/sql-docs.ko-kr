...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] 이 섹션에서는 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]에 있는 개체 탐색기의 **PolicyManagement** 노드에 대한 다음 F1 도움말 항목을 제공합니다.  
