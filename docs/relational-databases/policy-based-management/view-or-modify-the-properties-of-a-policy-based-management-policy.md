---
title: 정책 기반 관리 정책의 속성 보기 또는 수정
description: SSMS(SQL Server Management Studio) 또는 T-SQL(Transact-SQL)을 사용하여 SQL Server 정책 기반 관리 정책의 속성을 보거나 수정하는 방법을 알아봅니다.
