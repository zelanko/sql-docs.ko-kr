...
---
# 1단원: Off By Default 정책 만들기 및 적용
...
-   [Off By Default 정책 만들기](../../relational-databases/policy-based-management/create-the-off-by-default-policy.md)  
  
-   [Off By Default 정책을 실행하도록 서버 구성](../../relational-databases/policy-based-management/configure-a-server-to-run-the-off-by-default-policy.md)  
