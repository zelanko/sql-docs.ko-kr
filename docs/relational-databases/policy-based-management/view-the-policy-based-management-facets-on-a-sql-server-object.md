...
2.  **패싯 보기 –***object_name* 대화 상자의 **패싯** 목록에서 해당 속성을 보려면 패싯을 선택합니다. 이 대화 상자에서 사용할 수 있는 옵션에 대한 자세한 내용은 [View Facets Dialog Box](../../relational-databases/policy-based-management/view-facets-dialog-box.md)를 참조하세요.  
