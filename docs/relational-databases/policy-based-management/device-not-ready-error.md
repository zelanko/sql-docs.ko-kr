...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] 이 규칙은 시스템 이벤트 로그에서 EventId 15를 검사합니다. 이 오류는 SCSI 호스트 어댑터 구성 문제 또는 이와 관련된 문제로 인해 발생할 수 있습니다.  
