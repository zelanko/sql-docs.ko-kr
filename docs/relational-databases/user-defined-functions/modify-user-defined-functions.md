...
6.  **파일** 메뉴에서 *function_name* **저장**을 클릭합니다.  
...
3.  다음 예를 복사하여 쿼리 창에 붙여 넣고 **실행**을 클릭합니다.  
 ...
 자세한 내용은 [ALTER FUNCTION&#40;Transact-SQL&#41;](../../t-sql/statements/alter-function-transact-sql.md)을 참조하세요.  
