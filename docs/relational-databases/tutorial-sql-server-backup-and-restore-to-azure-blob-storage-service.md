...
이 자습서는 Azure Blob Storage 서비스에서 백업을 작성하고 복원하는 방법을 이해하도록 도와줍니다.  이 자습서에서는 Azure Blob 컨테이너, 스토리지 계정에 액세스하기 위한 자격 증명을 만들고, Blob Service에 백업을 작성한 후 간단한 복원을 수행하는 방법을 설명합니다.
