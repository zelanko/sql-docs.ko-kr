...
1. **제목** 입력란에 테스트 이메일의 제목 줄을 입력합니다. 문제 해결을 위해 사용자의 이메일을 보다 잘 식별할 수 있도록 기본 제목을 변경합니다.
1. **본문** 입력란에 테스트 이메일의 본문을 입력합니다. 문제 해결을 위해 사용자의 이메일을 보다 잘 식별할 수 있도록 기본 제목을 변경합니다.
