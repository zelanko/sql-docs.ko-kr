---
title: "데이터베이스 메일을 통해 보낸 전자 메일 메시지의 상태 확인 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "전자 메일 [SQL Server], 상태 정보"
  - "메일 [SQL Server], 상태 정보"
  - "데이터베이스 메일 [SQL Server], 메시지 상태"
  - "상태 정보 [데이터베이스 메일]"
...
-   **데이터베이스 메일을 사용하여 보낸 전자 메일의 상태를 보려면:** [Transact-SQL](#TsqlProcedure) 사용  
