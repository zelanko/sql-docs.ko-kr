---
title: "데이터베이스 메일을 사용하도록 SQL Server 에이전트 메일 구성 | Microsoft Docs"
ms.custom: ""
ms.date: "08/05/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "데이터베이스 메일 [SQL Server], SQL Server 에이전트 메일"
  - "SQL Server 에이전트 메일"
...
---
# 데이터베이스 메일을 사용하도록 SQL Server 에이전트 메일 구성
...
-    [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 에이전트 서비스 계정이 사용할 [데이터베이스 메일 계정을 만듭니다](../../relational-databases/database-mail/create-a-database-mail-account.md).  
