---
description: 데이터베이스 메일 메시지 및 이벤트 로그 보관을 처리하는 SQL Server 에이전트 작업 만들기
...
###  <a name="overview-of-the-process"></a><a name="Process_Overview"></a> 프로세스 개요  
