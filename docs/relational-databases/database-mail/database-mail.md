---
title: "데이터베이스 메일 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "아키텍처 [SQL Server], 데이터베이스 메일"
  - "데이터베이스 메일 [SQL Server], 아키텍처"
  - "데이터베이스 메일 [SQL Server], 구성 요소"
...
-   [데이터베이스 메일 사용의 이점](#Benefits)  
  
-   [데이터베이스 메일 아키텍처](#VisualElement)  
  
-   [데이터베이스 메일 구성 요소 소개](#ComponentsAndConcepts)  
