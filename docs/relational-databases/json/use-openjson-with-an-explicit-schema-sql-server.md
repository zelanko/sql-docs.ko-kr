---
title: "명시적 스키마와 함께 JSON 사용(SQL Server) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "06/02/2016"
...
---
# 명시적 스키마와 함께 JSON 사용(SQL Server)
...
## 예 - [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 테이블에 JSON 로드  
