...
### <a name="use-openjson-instead-of-jsonvalue-to-return-long-text-values"></a>JSON_VALUE 대신 OPENJSON을 사용하여 긴 텍스트 값 반환  
...
### <a name="use-openjson-instead-of-jsonvalue-to-handle-duplicate-keys"></a>JSON_VALUE 대신 OPENJSON을 사용하여 중복 키 처리  
