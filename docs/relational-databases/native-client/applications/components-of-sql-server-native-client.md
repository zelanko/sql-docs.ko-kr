...
|sqlncli11.lib|라이브러리 파일 하는 데 필요한 직접 호출 합니다 **bcp** 포함 된 유틸리티 함수를 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client ODBC 드라이버.<br /><br /> 참고: Sqlncli11.dll 파일이 시스템 경로는 사용자의 시스템 경로에 있는지 확인 해야 하는 프로그래밍 코드에서 sqlncli11.lib 파일 참조를 하는 경우 응용 프로그램의 사용 합니다.|  
