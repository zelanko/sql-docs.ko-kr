---
title: SQL 서버 네이티브 클라이언트에 대한 지원 정책 | 마이크로 소프트 문서
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
ms.custom: ''
...
|--------------------------------------|---------------------------------|  
|SQL Server Native Client(SQL Server 2005)|Microsoft Windows 2000 서비스 팩 4 이상<br /><br /> Microsoft Windows Server 2003 이상<br /><br /> 마이크로 소프트 윈도우 XP 서비스 팩 1 이상<br /><br /> Microsoft Windows Vista([!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 서비스 팩 2 이상 필요)<br /><br /> 마이크로 소프트 윈도우 서버 2008 R2 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] (서비스 팩 2 필요, 이상)|  
|SQL 서버 네이티브 클라이언트 10.0 ([!INCLUDE[ssKatmai](../../../includes/sskatmai-md.md)])|Microsoft Windows Server 2003 서비스 팩 2 이상<br /><br /> Microsoft Windows XP 서비스 팩 2 이상<br /><br /> Microsoft Windows Vista<br /><br /> 마이크로 소프트 윈도우 서버 2008 R2|  
|SQL 서버 네이티브 클라이언트 10.5 ([!INCLUDE[ssKilimanjaro](../../../includes/sskilimanjaro-md.md)])|Microsoft Windows Server 2003 서비스 팩 2 이상<br /><br /> Microsoft Windows XP 서비스 팩 2 이상<br /><br /> Microsoft Windows Vista<br /><br /> 마이크로 소프트 윈도우 서버 2008 R2<br /><br /> Microsoft Windows 7|  
|SQL Server Native Client 11.0([!INCLUDE[ssSQL11](../../../includes/sssql11-md.md)] 및 [!INCLUDE[ssSQL14](../../../includes/sssql14-md.md)])|Microsoft Windows Vista<br /><br /> 마이크로 소프트 윈도우 서버 2008 R2<br /><br /> Microsoft Windows 7<br /><br /> Microsoft Windows 8<br /><br /> Microsoft Windows Server 2012|  
...
## <a name="ole-db-support-policies"></a>OLE DB 지원 정책  
 ...
 OLE DB Service Component를 사용하는 OLE DB 애플리케이션은 연결 문자열에 `DataTypeCompatibility=80`을 지정하는 경우에만 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client를 사용할 수 있습니다. 그러나 이 경우에는 [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] 이후에 추가된 기능을 사용할 수 없습니다.  
