...
## <a name="ole-db-support-policies"></a>OLE DB 지원 정책  
 ...
 OLE DB Service Component를 사용하는 OLE DB 애플리케이션은 연결 문자열에 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]을 지정하는 경우에만 `DataTypeCompatibility=80` Native Client를 사용할 수 있습니다. 그러나이 경우 [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] 후에 추가 된 기능은 제공 되지 않습니다.  
