---
title: 헤더 및 라이브러리 파일
description: SQL Server Native Client 헤더 및 라이브러리 파일을 사용 하 여 응용 프로그램을 개발 하는 방법을 알아봅니다. 필요한 파일을 개발 환경에 복사 합니다.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
