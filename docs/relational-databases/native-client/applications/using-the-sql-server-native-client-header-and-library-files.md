---
title: Native Client, 헤더 및 라이브러리 파일
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
## <a name="static-linking-and-bcp-functions"></a>정적 연결 및 BCP 함수  
 ...
 자세한 내용은 [대량 복사 작업](../../../relational-databases/native-client/features/performing-bulk-copy-operations.md)수행을 참조 하세요.  
