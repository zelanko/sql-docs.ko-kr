---
description: 저장 프로시저-SQL Server Native Client에서 호출
...
ms.locfileid: "97463314"
---
# <a name="stored-procedures---calling-in-sql-server-native-client"></a>저장 프로시저-SQL Server Native Client에서 호출
