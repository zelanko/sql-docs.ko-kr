...
**참고:** 새로운 개발에이 드라이버를 사용 하지는 것입니다. 새 OLE DB 공급자가 호출 됩니다는 [Microsoft OLE DB Driver for SQL Server](../../connect/oledb/oledb-driver-for-sql-server.md) (MSOLEDBSQL) 앞으로 가장 최근의 서버 기능으로 업데이트 됩니다.
