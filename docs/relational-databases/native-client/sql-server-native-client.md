...
> [!NOTE]
> SNAC 또는 ODBC 드라이버를 다운로드 하 고 다운로드 하는 방법에 대 한 자세한 내용은 [SNAC 수명 주기 설명 블로그 게시물](/archive/blogs/sqlreleaseservices/snac-lifecycle-explained)을 참조 하세요.
...
-   연결 관련 작업에 대한 비동기 실행. 자세한 내용은 [비동기 실행](../../odbc/reference/develop-app/asynchronous-execution-polling-method.md)을 참조 하세요.  
