...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
 ...
 날짜/시간 기능 향상에 대 한 자세한 내용은 날짜 [및 시간 기능 &#40;향상&#41; ](../../../relational-databases/native-client-ole-db-date-time/date-and-time-improvements-ole-db.md) 및 [ODBC &#40;&#41;의 날짜 및 시간 향상](../../../relational-databases/native-client-odbc-date-time/date-and-time-improvements-odbc.md)OLE DB을 참조 하세요.  
