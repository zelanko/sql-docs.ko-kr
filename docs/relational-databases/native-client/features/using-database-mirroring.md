---
description: SQL Server Native Client에서 데이터베이스 미러링 사용
...
ms.locfileid: "88448306"
---
# <a name="using-database-mirroring-in-sql-server-native-client"></a>SQL Server Native Client에서 데이터베이스 미러링 사용
