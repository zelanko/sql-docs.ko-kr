...
### <a name="using-memory-based-bulk-copy-operations"></a>메모리 기반 대량 복사 작업 사용  
 Native [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Client OLE DB 공급자는 **IRowsetFastLoad** 인터페이스를 구현 하 여 메모리 기반 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 대량 복사 작업에 대 한 지원을 노출 합니다. **IRowsetFastLoad** 인터페이스는 [IRowsetFastLoad::Commit](../../../relational-databases/native-client-ole-db-interfaces/irowsetfastload-commit-ole-db.md) 및 [IRowsetFastLoad::InsertRow](../../../relational-databases/native-client-ole-db-interfaces/irowsetfastload-insertrow-ole-db.md) 메서드를 구현합니다.  
