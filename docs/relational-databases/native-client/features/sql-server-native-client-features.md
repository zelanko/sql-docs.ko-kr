---
title: SQL 서버 네이티브 클라이언트 기능 | 마이크로 소프트 문서
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
ms.reviewer: ''
...
## <a name="in-this-section"></a>섹션 내용  
 ...
 Native Client가 대기 서버에 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 데이터베이스의 복사본 또는 미러를 유지하는 기능인 미러된 데이터베이스사용을 지원하는 방법에 대해 설명합니다.  
 ...
 네이티브 클라이언트가 데이터베이스에 개체 및 사용자 정의 데이터 구조를 저장할 수 있도록 하여 SQL 형식 시스템을 확장하는 UDT(사용자 정의 형식)를 지원하는 방법에 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 대해 설명합니다. [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]  
 ...
 Native Client가 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 테이블이나 뷰로 많은 양의 데이터를 전송하거나 뷰밖으로 전송할 수 있는 대량 복사 작업을 지원하는 방법에 대해 설명합니다.  
 ...
 향상된 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] FILESTREAM 기능에 대한 네이티브 클라이언트 지원에 대해 설명합니다.  
 ...
 [!INCLUDE[ssSQL11](../../../includes/sssql11-md.md)]에서 도입된 동작 변경 사항에 대해 설명합니다. 열 결과 또는 출력 매개 변수를 바인딩할 때 고정 길이 버퍼를 제공하고 종료 문자 앞에 버퍼에 작성된 **wchar** 문자가 서로게이트 쌍의 높은 서로게이트 코드 지점인 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 경우 다음 **wchar** 문자가 낮은 서로게이트 코드 포인트인 경우 Native Client는 버퍼에 상위 서로게이트 코드 포인트를 추가하지 않습니다.  
...
## <a name="see-also"></a>참고 항목  
 ...
 [OLE DB 사용 방법 주제](../../../relational-databases/native-client-ole-db-how-to/ole-db-how-to-topics.md)   
