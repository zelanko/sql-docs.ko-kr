...
## <a name="remarks"></a>설명  
 ...
 Native Client에서 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] ODBC를 사용 하 고 연결에 성공 하는 경우 [SQLGetConnectAttr](../../../relational-databases/native-client-odbc-api/sqlgetconnectattr.md)와 함께 **SQL_COPT_SS_CLIENT_CONNECTION_ID** 특성을 사용 하 여 클라이언트 연결 ID를 가져올 수 있습니다.  
