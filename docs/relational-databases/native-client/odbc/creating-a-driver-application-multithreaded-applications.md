---
title: 다중 스레드 응용 프로그램 | Microsoft 문서
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "43096169"
---
# <a name="creating-a-driver-application---multithreaded-applications"></a>드라이버 응용 프로그램 만들기 - 다중 스레드 응용 프로그램
