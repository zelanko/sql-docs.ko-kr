---
title: "msdb 데이터베이스 | Microsoft Docs"
ms.custom: ""
ms.date: "11/10/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server 에이전트, msdb 데이터베이스"
  - "경고 [SQL Server], msdb 데이터베이스"
  - "작업 [SQL Server], msdb 데이터베이스"
...
|데이터베이스 가용성 옵션|ONLINE<br /><br /> MULTI_USER<br /><br /> READ_WRITE|아니요<br /><br /> 사용자 계정 컨트롤<br /><br /> 예|  
