...
ms.topic: "article"
helpviewer_keywords: 
  - "데이터베이스 [SQL Server], 만들기"
  - "데이터베이스 만들기 [SQL Server], SQL Server Management Studio"
  - "데이터베이스 만들기"
...
5.  소유자 이름을 변경하려면 (**…**)을 클릭하여 다른 소유자를 선택합니다.  
    ...
    > [!NOTE]  
    >  [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)]부터 모든 사용자 데이터베이스에서 전체 텍스트를 사용할 수 있기 때문에 **전체 텍스트 인덱싱 사용** 옵션이 항상 선택되어 있고 흐리게 표시됩니다.  
...
9. 데이터베이스 옵션을 변경하려면 **옵션** 페이지를 선택한 다음 데이터베이스 옵션을 수정합니다. 각 옵션에 대한 자세한 내용은 [ALTER DATABASE SET 옵션&#40;Transact-SQL&#41;](../Topic/ALTER%20DATABASE%20SET%20Options%20\(Transact-SQL\).md)을 참조하세요.  
