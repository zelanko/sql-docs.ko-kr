 ...
 **슬라이딩 윈도우 시나리오에서 분할된 데이터 관리**  
 ...
 ![맨 위로 이동 링크에 사용되는 화살표 아이콘](https://docs.microsoft.com/analysis-services/analysis-services/instances/media/uparrow16x16.gif "맨 위로 이동 링크에 사용되는 화살표 아이콘") [섹션 내용](#Top)  
