...
## <a name="example"></a>예제  
 ...
 첫 번째 ( [!INCLUDE[tsql](../../includes/tsql-md.md)]) 코드 목록은 예제에서 사용 되는 테이블을 만듭니다.  
 ...
 세 번째 ( [!INCLUDE[tsql](../../includes/tsql-md.md)]) 코드 목록은 예제에서 사용 하는 테이블을 삭제 합니다.  
