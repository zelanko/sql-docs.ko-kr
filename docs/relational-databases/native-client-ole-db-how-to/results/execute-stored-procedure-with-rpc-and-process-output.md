...
## <a name="example"></a>예제  
 ...
 첫 번째 실행 ( [!INCLUDE[tsql](../../../includes/tsql-md.md)]) 코드 목록을 응용 프로그램에서 사용 하는 저장된 프로시저를 만듭니다.  
 ...
 세 번째 실행 ( [!INCLUDE[tsql](../../../includes/tsql-md.md)]) 코드 목록을 응용 프로그램에서 사용 하는 저장된 프로시저를 삭제 합니다.  
