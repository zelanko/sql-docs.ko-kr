---
title: 결과 집합에서 행 인출 (Native Client OLE DB 공급자) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "87247008"
---
# <a name="fetch-rows-from-a-result-set-native-client-ole-db-provider"></a>결과 집합에서 행 인출 (Native Client OLE DB 공급자)
