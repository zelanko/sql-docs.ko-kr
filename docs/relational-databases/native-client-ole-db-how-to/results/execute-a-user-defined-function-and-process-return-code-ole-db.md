---
description: SQL Server Native Client User-Defined 함수를 실행 하 고 반환 코드를 처리 합니다 (OLE DB).
title: User-Defined 함수, 반환 코드 (OLE DB)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "91866646"
---
# <a name="execute-a-sql-server-native-client-user-defined-function-and-process-return-code-ole-db"></a>SQL Server Native Client User-Defined 함수를 실행 하 고 반환 코드를 처리 합니다 (OLE DB).
