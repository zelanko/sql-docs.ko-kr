...
## <a name="in-this-section"></a>섹션 내용  
 ...
 날짜 및 시간 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 데이터 형식을 지원하는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] OLE DB(네이티브 클라이언트) 형식에 대한 정보를 제공합니다.  
 ...
 [OLE DB&#41;&#40;이전 SQL 서버 버전의 새 날짜 및 시간 기능](../../relational-databases/native-client-ole-db-date-time/new-date-and-time-features-with-previous-sql-server-versions-ole-db.md)  
