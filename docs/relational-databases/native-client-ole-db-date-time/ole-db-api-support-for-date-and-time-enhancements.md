...
|IBCPSession::BCPColFmt|자세한 내용은 [향상 된 날짜 및 시간 &#40;형식 OLE DB 및 ODBC&#41;에 대 한 대량 복사 변경 내용](../../relational-databases/native-client-odbc-date-time/bulk-copy-changes-for-enhanced-date-and-time-types-ole-db-and-odbc.md)을 참조 하세요.|  
