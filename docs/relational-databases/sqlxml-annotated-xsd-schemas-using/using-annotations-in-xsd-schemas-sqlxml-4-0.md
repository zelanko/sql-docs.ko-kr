...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)][!INCLUDE[msCoName](../../includes/msconame-md.md)] SQLXML 4.0의 XSD 스키마 언어 주석을 Xml-data Reduced (XDR) 스키마 언어에 도입 된 주석과 비슷한 방식으로 지원 합니다. XSD에는 XDR에서는 지원되지 않은 추가 주석도 도입되었습니다.  
...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [테이블 및 열 &#40; 데 XSD 요소 및 특성의 명시적 매핑 SQLXML 4.0 &#41;](../../relational-databases/sqlxml-annotated-xsd-schemas-using/explicit-mapping-xsd-elements-and-attributes-to-tables-and-columns.md)  
 ...
 [Sql: inverse Attribute on sql: relationship &#40;를 지정합니다. SQLXML 4.0 &#41;](../../relational-databases/sqlxml-annotated-xsd-schemas-using/specifying-the-sql-inverse-attribute-on-sql-relationship-sqlxml-4-0.md)  
 ...
 [Sql 사용 하 여 BLOB 데이터에 대 한 URL 참조 요청: 인코딩 &#40; SQLXML 4.0 &#41;](../../relational-databases/sqlxml-annotated-xsd-schemas-using/requesting-url-references-to-blob-data-using-sql-encode-sqlxml-4-0.md)  
