...
|--------------------|-----------------|----------------|--------------------|  
|**sql:encode**|XML 요소나 특성이 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] BLOB 열에 매핑된 경우 참조 URI를 요청할 수 있습니다. 이 URI는 나중에 BLOB 데이터를 반환하는 데 사용할 수 있습니다.|[Sql 사용 하 여 BLOB 데이터에 대 한 URL 참조 요청: 인코딩할 &#40;SQLXML 4.0&#41;](../../relational-databases/sqlxml-annotated-xsd-schemas-using/requesting-url-references-to-blob-data-using-sql-encode-sqlxml-4-0.md)|**url-encode**|  
...
|**sql:inverse**|사용 하 여 지정 된 부모-자식 관계의 해석 역 하도록 updategram 논리에 지시  **\<sql: relationship >** 합니다.|[Sql: inverse Attribute on sql: relationship 지정 &#40;SQLXML 4.0&#41;](../../relational-databases/sqlxml-annotated-xsd-schemas-using/specifying-the-sql-inverse-attribute-on-sql-relationship-sqlxml-4-0.md)|지원되지 않음|  
|**sql:is-constant**|어느 테이블에도 매핑되지 않는 XML 요소를 만듭니다. 이 요소는 쿼리 출력에 나타납니다.|[Sql 사용 하 여 상수 요소 만들기:은 상수 &#40;SQLXML 4.0&#41;](../../relational-databases/sqlxml-annotated-xsd-schemas-using/creating-constant-elements-using-sql-is-constant-sqlxml-4-0.md)|같은 데이터 집합|  
...
|**sql:limit-field**<br /><br /> **sql:limit-value**|제한 값을 기준으로 반환되는 값을 제한할 수 있습니다.|[사용 하 여 값 필터링-필드 및 sql:-값 &#40;SQLXML 4.0&#41;](../../relational-databases/sqlxml-annotated-xsd-schemas-using/filtering-values-using-sql-limit-field-and-sql-limit-value-sqlxml-4-0.md)|같은 데이터 집합|  
...
|**sql:prefix**|유효한 XML ID, IDREF 및 IDREFS를 만들고 ID, IDREF 및 IDREFS 값 앞에 문자열을 추가합니다.|[유효한 ID, IDREF 및 IDREFS 유형 특성을 사용 하 여 sql: prefix 만드는 &#40;SQLXML 4.0&#41;](../../relational-databases/sqlxml-annotated-xsd-schemas-using/creating-valid-id-idref-and-idrefs-type-attributes-using-sql-prefix-sqlxml-4-0.md)|같은 데이터 집합|  
|**sql:relationship**|XML 요소 사이의 관계를 지정합니다. **부모**, **자식**, **부모 키**, 및 **자식 키** 특성 관계를 설정 하는 데 사용 됩니다.|[Sql: relationship을 사용 하 여 관계 지정 &#40;SQLXML 4.0&#41;](../../relational-databases/sqlxml-annotated-xsd-schemas-using/specifying-relationships-using-sql-relationship-sqlxml-4-0.md)|다음과 같이 특성 이름이 다름<br /><br /> **key-relation**<br /><br /> **foreign-relation**<br /><br /> **key**<br /><br /> **foreign-key**|  
