...
|--------------------|-----------------|----------------|--------------------|  
|**sql:encode**|XML 요소나 특성이 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] BLOB 열에 매핑된 경우 참조 URI를 요청할 수 있습니다. 이 URI는 나중에 BLOB 데이터를 반환하는 데 사용할 수 있습니다.|[Sql 사용 하 여 BLOB 데이터에 대 한 URL 참조 요청: 인코딩 &#40; SQLXML 4.0 &#41;](../../relational-databases/sqlxml-annotated-xsd-schemas-using/requesting-url-references-to-blob-data-using-sql-encode-sqlxml-4-0.md)|**url-encode**|  
...
|**sql:relationship**|XML 요소 사이의 관계를 지정합니다. **부모**, **자식**, **부모 키**, 및 **자식 키** 특성 관계를 설정 하는 데 사용 됩니다.|[Sql: relationship을 사용 하 여 관계 &#40;를 지정합니다. SQLXML 4.0 &#41;](../../relational-databases/sqlxml-annotated-xsd-schemas-using/specifying-relationships-using-sql-relationship-sqlxml-4-0.md)|다음과 같이 특성 이름이 다름<br /><br /> **key-relation**<br /><br /> **foreign-relation**<br /><br /> **key**<br /><br /> **foreign-key**|  
