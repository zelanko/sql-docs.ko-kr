...
|-------------------|-------------------|------------------------------------|--------------------------------------------|  
|**Base64Binary**<br /><br /> **HexBinary**|**없음을**<br /><br /> **base64bin**|**해당 없음**|없음<br /><br /> EmployeeID|  
|**Boolean**|**부울**|**부울**|CONVERT(bit, EmployeeID)|  
|**Decimal, integer, float, byte, short, int, long, float, double, unsignedByte**|**number, int, float,i1, i2, i4, i8,r4, r8ui1, ui2, ui4, ui8**|**수많은**|CONVERT(float(53), EmployeeID)|  
...
|**날**|**날**|**문자열**|LEFT(CONVERT(nvarchar(4000), EmployeeID, 126), 10)|  
|**런타임**|**런타임**<br /><br /> **time.tz**|**문자열**|SUBSTRING(CONVERT(nvarchar(4000), EmployeeID, 126), 1 + CHARINDEX(N'T', CONVERT(nvarchar(4000), EmployeeID, 126)), 24)|  
