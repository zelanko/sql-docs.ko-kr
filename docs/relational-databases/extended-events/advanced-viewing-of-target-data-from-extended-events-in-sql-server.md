...
![그룹화가 선택된 도구 모음 및 그룹화 대화 상자 스크린샷](../../relational-databases/extended-events/media/xevents-ssms-ui53-grouping.png)
...
![집계가 선택된 도구 모음 및 집계 대화 상자 스크린샷](../../relational-databases/extended-events/media/xevents-ssms-ui51-aggregdialogcount.png)

집계를 완료한 후 다음과 같이 새로운 모양으로 표시가 바뀌었습니다.

![개수 값이 추가되었음을 보여 주는 표시 스크린샷](../../relational-databases/extended-events/media/xevents-ssms-ui52-aggregnewdisplay.png)
