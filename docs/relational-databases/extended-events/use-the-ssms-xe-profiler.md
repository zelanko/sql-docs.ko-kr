...
이 기능은 SSMS(SQL Server Management Studio) v17.3 이상에서만 사용할 수 있습니다. 최신 버전을 사용하고 있는지 확인하세요. 최신 버전은 [여기](../../ssms/download-sql-server-management-studio-ssms.md)에서 찾을 수 있습니다.
