---
title: "확장 이벤트 도구 | Microsoft Docs"
ms.custom: ""
ms.date: "03/17/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "확장 이벤트 [SQL Server], 사용"
  - "확장 이벤트 [SQL Server], 사용할 옵션"
...
|이름|설명|  
|----------|-----------------|  
|[trace_xe_event_map&#40;Transact-SQL&#41;](../Topic/trace_xe_event_map%20\(Transact-SQL\).md)|SQL 추적 이벤트 클래스에 매핑된 Extended Events 이벤트마다 하나의 행을 포함합니다.|  
|[trace_xe_action_map&#40;Transact-SQL&#41;](../Topic/trace_xe_action_map%20\(Transact-SQL\).md)|SQL 추적 열 ID에 매핑된 Extended Events 동작마다 하나의 행을 포함합니다.|  
  
## 참고 항목  
 [동적 관리 뷰 및 함수&#40;Transact-SQL&#41;](../Topic/Dynamic%20Management%20Views%20and%20Functions%20\(Transact-SQL\).md)   
 [카탈로그 뷰&#40;Transact-SQL&#41;](../../relational-databases/system-catalog-views/catalog-views-transact-sql.md)   
 [SQL Server 확장 이벤트 테이블&#40;Transact-SQL&#41;](../Topic/SQL%20Server%20Extended%20Events%20Tables%20\(Transact-SQL\).md)   
