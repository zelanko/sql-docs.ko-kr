---
title: 확장 이벤트를 사용하여 시스템 작업 모니터링
description: Windows용 이벤트 추적과 함께 확장 이벤트를 사용하여 시스템 활동을 모니터링할 수 있습니다. CREATE EVENT SESSION, ALTER EVENT SESSION 및 DROP EVENT SESSION에 대해 알아봅니다.
ms.date: 03/06/2017
ms.prod: sql
