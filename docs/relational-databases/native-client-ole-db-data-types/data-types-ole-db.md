---
description: SQL Server Native Client 데이터 형식 (OLE DB)
title: 데이터 형식 (Native Client OLE DB 공급자) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88475786"
---
# <a name="sql-server-native-client-data-types-ole-db"></a>SQL Server Native Client 데이터 형식 (OLE DB)
