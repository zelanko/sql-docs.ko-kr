---
title: "데이터 변경 내용 추적(SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "08/08/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "변경 데이터 캡처 [SQL Server], 변경 내용 추적과 비교"
  - "변경 데이터 캡처와 변경 내용 추적 비교"
  - "변경 데이터 캡처 [SQL Server], 데이터 형식 동작"
  - "Sync Services for ADO.NET"
  - "변경 내용 추적 [SQL Server], Sync Services for ADO.NET"
  - "변경 내용 추적 [SQL Server]"
  - "변경 데이터 캡처 [SQL Server], 보안"
  - "변경 데이터 캡처 [SQL Server], 기타 SQL Server 기능 및"
...
##  <a name="Capture"></a> 변경 데이터 캡처  
 ...
 ![변경 데이터 캡처에 대한 개념 설명](../../relational-databases/track-changes/media/cdcart1.gif "변경 데이터 캡처에 대한 개념 설명")  
...
-   데이터베이스가 다른 서버로 복원되는 경우에는 기본적으로 변경 데이터 캡처가 해제되고 관련된 모든 메타데이터가 삭제됩니다.  
     ...
     변경 데이터 캡처를 유지하려면 데이터베이스를 복원할 때 **KEEP_CDC** 옵션을 사용합니다. 이 옵션에 대한 자세한 내용은 [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md)를 참조하세요.  
...
##  <a name="Tracking"></a> 변경 내용 추적  
 ...
 ![변경 내용 추적에 대한 개념 설명](../../relational-databases/track-changes/media/cdcart2.gif "변경 내용 추적에 대한 개념 설명")  
...
## 참고 항목  
 ...
 [변경 데이터 캡처 관련 동적 관리 뷰&#40;Transact-SQL&#41;](../Topic/Change%20Data%20Capture%20Related%20Dynamic%20Management%20Views%20\(Transact-SQL\).md)  
