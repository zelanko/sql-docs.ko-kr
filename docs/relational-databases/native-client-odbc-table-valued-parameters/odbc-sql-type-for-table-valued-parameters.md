...
## <a name="remarks"></a>주의  
 ...
 SQLBindParameter의 *ValueType* 매개 변수에서 SQL_SS_TABLE를 C 데이터 형식으로 사용 하거나 apd (응용 프로그램 매개 변수 설명자) 레코드의 SQL_DESC_TYPE를 SQL_SS_TABLE로 설정 하려고 하면 SQL_ERROR 반환 되 고 진단 레코드가 SQLSTATE = HY003, "잘못 된 응용 프로그램 버퍼 유형"을 사용 하 여 생성 됩니다.  
