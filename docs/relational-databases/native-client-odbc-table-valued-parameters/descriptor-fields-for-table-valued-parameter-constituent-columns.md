...
|SQL_CA_SS_COLUMN_SORT_ORDER|SQLSMALLINT|테이블 반환 매개 변수 열의 정렬 순서를 나타냅니다. 이 경우 쿼리 성능이 향상될 수 있습니다. 테이블 반환 매개 변수 열이 아닌 바인딩에 대해서는 이 특성이 무시됩니다. 가능한 값은 다음과 같습니다. <br />**SQL_SS_ASCENDING_ORDER**<br />**SQL_SS_DESCENDING_ORDER**<br />**SQL_SS_ORDER_UNSPECIFIED**<br /><br /> 이외의 값 **SQL_SS_ASCENDING_ORDER** 하 고 **SQL_SS_DESCENDING_ORDER** 사용 하 여 오류를 생성 **SQLSTATE HY024** '잘못 된 특성 값' 메시지 및 취급 **SQL_SS_ORDER_UNSPECIFIED**,이 특성의 기본값은입니다.|  
