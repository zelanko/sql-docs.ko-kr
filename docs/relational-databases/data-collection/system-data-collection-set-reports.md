---
title: "시스템 데이터 컬렉션 집합 보고서 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "데이터 수집기 [SQL Server], 서버 작업"
  - "서버 작업 [SQL Server]"
  - "보고서 [SQL Server], 데이터 컬렉션"
  - "보고서 [SQL Server], 디스크 사용"
  - "컬렉션 집합 [SQL Server], 보고서"
  - "데이터 수집기 [SQL Server], 보고서"
  - "보고서 [SQL Server], 쿼리 통계"
  - "쿼리 통계 보고서 [SQL Server]"
  - "디스크 사용 보고서 [SQL Server]"
...
##  <a name="Disk"></a> 디스크 사용 요약 보고서  
 ...
 개체 탐색기에서 디스크 사용 요약 보고서에 액세스할 수 있습니다. 이 보고서를 보려면 **관리** 폴더를 확장하고 **데이터 컬렉션**을 마우스 오른쪽 단추로 클릭한 다음 **보고서**, **관리 데이터 웨어하우스**를 차례로 가리키고 **디스크 사용 요약**을 클릭합니다. 자세한 내용은 [컬렉션 집합 보고서 보기&#40;SQL Server Management Studio&#41;](../../relational-databases/data-collection/view-a-collection-set-report-sql-server-management-studio.md)를 참조하세요.  
...
#### 디스크 사용 컬렉션 집합 - 데이터베이스: <database_name> 하위 보고서  
...
#### 데이터베이스에 대한 디스크 사용: <database_name> 하위 보고서  
...
##  <a name="Query"></a> 쿼리 통계 기록 보고서  
 ...
 개체 탐색기에서 쿼리 통계 기록 보고서에 액세스할 수 있습니다. 이 보고서를 보려면 **관리** 폴더를 확장하고 **데이터 컬렉션**을 마우스 오른쪽 단추로 클릭한 다음 **보고서**, **관리 데이터 웨어하우스**를 차례로 가리키고 **쿼리 통계 기록**을 클릭합니다. 자세한 내용은 [컬렉션 집합 보고서 보기&#40;SQL Server Management Studio&#41;](../../relational-databases/data-collection/view-a-collection-set-report-sql-server-management-studio.md)를 참조하세요.  
...
## 서버 작업 기록 보고서  
 ...
 개체 탐색기에서 서버 작업 기록 보고서에 액세스할 수 있습니다. 이 보고서를 보려면 **관리** 폴더를 확장하고 **데이터 컬렉션**을 마우스 오른쪽 단추로 클릭한 다음 **보고서**, **관리 데이터 웨어하우스**를 차례로 가리키고 **서버 작업 기록**을 클릭합니다. 자세한 내용은 [컬렉션 집합 보고서 보기&#40;SQL Server Management Studio&#41;](../../relational-databases/data-collection/view-a-collection-set-report-sql-server-management-studio.md)를 참조하세요.  
