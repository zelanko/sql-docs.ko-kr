---
title: "일반 T-SQL 쿼리 수집기 유형을 사용하는 사용자 지정 컬렉션 집합 만들기(Transact-SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
manager: "jhubbard"
---
# 일반 T-SQL 쿼리 수집기 유형을 사용하는 사용자 지정 컬렉션 집합 만들기(Transact-SQL)
