---
title: "데이터 컬렉션 관리 | Microsoft Docs"
ms.custom: ""
ms.date: "07/18/2016"
...
helpviewer_keywords: 
  - "데이터 컬렉션 [SQL Server]"
  - "데이터 수집기 [SQL Server], Transact-SQL"
  - "데이터 수집기 [SQL Server], SQL Server Management Studio"
