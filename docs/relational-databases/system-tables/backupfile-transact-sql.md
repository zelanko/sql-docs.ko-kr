...
|**differential_base_lsn**|**numeric(25,0)**|차등 백업에 대한 기본 LSN입니다. 데이터 익스텐트가 로그 시퀀스 번호 보다 크거나 같은 차등 백업에 포함 됩니다 **differential_base_lsn**합니다.<br /><br /> 다른 백업 유형의 경우 값은 NULL입니다.|  
...
|**filegroup_guid**|**uniqueidentifier**|파일 그룹의 ID입니다. 사용 하 여 backupfilegroup 테이블에서 파일 그룹 정보를 찾으려면 **filegroup_guid** 사용 하 여 **backup_set_id**합니다.|  
