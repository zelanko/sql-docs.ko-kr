...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  **IHconstrainttypes** 시스템 테이블에 대 한 SQL Server 이외 게시자를 지원 합니다. SQL Server 이외 제약 조건의 각 유형당 한 개의 행을 포함 합니다. 이 테이블은 배포 데이터베이스에 저장됩니다.  
  
|열 이름|데이터 형식|Description|  
|-----------------|---------------|-----------------|  
|**유형**|**nvarchar(255)**|지원되는 SQL Server 이외 제약 조건 유형의 이름입니다.|  
