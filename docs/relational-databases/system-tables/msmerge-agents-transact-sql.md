...
|**offload_enabled**|**bit**|에이전트를 원격으로 활성화할 수 있음을 나타냅니다.<br /><br /> **0** 지정는 에이전트를 원격으로 활성화할 수 없습니다.<br /><br /> **1** 에이전트 offload_server 속성에 지정 된 원격 컴퓨터를 원격으로 활성화할 수를 지정 합니다.|  
