...
|**subscriber_security_mode**|**smallint**|에이전트가 구독자에 연결할 때 사용하는 보안 모드로 다음 중 하나일 수 있습니다.<br /><br /> **** =  0[!INCLUDE[msCoName](../../includes/msconame-md.md)] 인증 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .<br /><br /> **** =  1[!INCLUDE[msCoName](../../includes/msconame-md.md)] Windows 인증입니다.|  
|**subscriber_login**|**sysname**|구독자에 연결할 때 사용하는 로그인입니다.|  
|**subscriber_password**|**nvarchar (524)**|구독자에 연결할 때 사용하는 암호의 암호화된 값입니다.|  
|**publisher_security_mode**|**smallint**|에이전트가 게시자에 연결할 때 사용하는 보안 모드로 다음 중 하나일 수 있습니다.<br /><br /> **** =  0[!INCLUDE[msCoName](../../includes/msconame-md.md)] 인증 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .<br /><br /> **** =  1[!INCLUDE[msCoName](../../includes/msconame-md.md)] Windows 인증입니다.|  
