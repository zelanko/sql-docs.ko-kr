...
|**retention_period_unit**|**tinyint**|보존 기간을 정의할 때 사용할 단위를 지정합니다. 다음 값 중 하나일 수 있습니다.<br /><br /> **1** = 주<br /><br /> **2** = 월<br /><br /> **3** = 년|  
