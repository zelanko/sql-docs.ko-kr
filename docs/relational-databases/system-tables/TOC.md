# [개요](system-tables-transact-sql.md)  
# [확장 이벤트 테이블-trace_xe_action_map](extended-events-tables-trace-xe-action-map.md)  
# [확장 이벤트 테이블-trace_xe_event_map](extended-events-tables-trace-xe-event-map.md)  
# [데이터 계층 응용 프로그램 테이블 sysdac_history_internal](data-tier-application-tables-sysdac-history-internal.md)  
# [데이터 계층 응용 프로그램 테이블 sysdac_instances_internal](data-tier-application-tables-sysdac-instances-internal.md)  
# [시스템 테이블을 시스템 뷰로 매핑](mapping-system-tables-to-system-views-transact-sql.md)  
# [시스템 기본 테이블](system-base-tables.md)  
# [백업 및 복원 테이블](backup-and-restore-tables-transact-sql.md)  
...
# [변경 데이터 캡처 테이블](change-data-capture-tables-transact-sql.md)  
## [cdc입니다. < capture_instance > _CT](cdc-capture-instance-ct-transact-sql.md)  
...
# [SQL Server 에이전트 테이블](sql-server-agent-tables-transact-sql.md)  
...
# [복제 테이블](replication-tables-transact-sql.md)  
