...
|**snapshot_in_defaultfolder**|**bit**|스냅숏 파일을 기본 폴더에 저장할지 여부를 지정합니다.<br /><br /> **0** = 스냅숏 파일에서 지정한 대체 위치에 저장 된 *alternate_snapshot_folder*합니다.<br /><br /> **1** = 스냅숏 파일이 기본 폴더에 있습니다.|  
