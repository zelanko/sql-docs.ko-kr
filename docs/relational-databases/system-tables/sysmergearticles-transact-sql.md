...
|**유형**|**tinyint**|아티클 유형을 나타내며 다음 중 하나일 수 있습니다.<br /><br /> **10** = 테이블입니다.<br /><br /> **32** = 저장 프로시저 (스키마 전용).<br /><br /> **64** = 뷰 또는 인덱싱된 뷰 (스키마 전용).<br /><br /> **128** = 사용자 정의 함수 (스키마 전용).<br /><br /> **160** = 동의어 (스키마 전용).|  
|**objid**|**int**|개체 식별자입니다.|  
