...
|**pre_creation_cmd**|**tinyint**|같은 이름을 가진 개체가 이미 구독자에 존재하는 경우 초기 스냅샷을 적용하기 전에 실행하는 명령입니다.<br /><br /> **0** = none-명령을 실행 되지 않습니다.<br /><br /> **1** = DROP-대상 테이블을 삭제 합니다.<br /><br /> **2** = DELETE-대상 테이블에서 데이터를 삭제 합니다.<br /><br /> **3** = TRUNCATE-대상 테이블을 자릅니다.|  
