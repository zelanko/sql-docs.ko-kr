...
|__$conflict_type|**int**|충돌의 유형이며 다음 값 중 하나일 수 있습니다.<br /><br /> 1: 로컬 행이 업데이트에 의해 다른 변경 되었으므로 실패 한 업데이트는 삭제 되었고 후 다시 삽입 합니다.<br /><br /> 2: 로컬 행이 이미 삭제를 업데이트 하지 못했습니다.<br /><br /> 3: 로컬 행이 업데이트에 의해 다른 변경 되었으므로 실패 한 삭제 삭제 되었고 후 다시 삽입 합니다.<br /><br /> 4: 로컬 행이 이미 삭제를 삭제 하지 못했습니다.<br /><br /> 5: 로컬 행이 이미 삽입 되었거나 삽입 되어 업데이트 한 다음 삽입 하지 못했습니다.|  
