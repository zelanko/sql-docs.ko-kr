...
|__$reason_code|**int**|충돌 상태를 나타내는 코드이며 다음 값 중 하나입니다.<br /><br /> 0<br /><br /> 1<br /><br /> 2<br /><br /> <br /><br /> 자세한 내용은 **__ $ reason_text**를 참조 하세요.|  
...
|__$row_id|**없으면**|충돌을 일으키는 행과 연관된 행 버전입니다.|  
