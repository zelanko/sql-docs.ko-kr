...
|**이벤트 유형**|**tinyint**|기록될 이벤트 유형을 지정하며 값은 다음 중 하나일 수 있습니다.<br /><br /> **1** -초기 게시 수준 속성 설정 합니다.<br /><br /> **2** -게시 속성을 변경 합니다.<br /><br /> **101** -초기 아티클 속성 설정 합니다.<br /><br /> **102** -아티클 속성에서 변경 합니다.|  
