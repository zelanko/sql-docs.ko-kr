...
|-----------------|---------------|-----------------|  
|**proxy_id**|**int**|
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 에이전트 프록시 계정의 ID입니다. 이 값은 **sysproxies** 테이블의 **proxy_id** 열에 해당 합니다.|  
|**s**|**varbinary (85)**|SQL Server 로그인에 대 한 Microsoft Windows *security_identifier* 입니다.|  
