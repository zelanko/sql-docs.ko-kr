...
|peer_node|**sysname 이며**|응답을 생성한 서버 인스턴스의 이름입니다.|  
|peer_db|**sysname 이며**|응답을 생성한 피어에 있는 구독 데이터베이스입니다.|  
|peer_version|**sysname 이며**|게시자의 버전 번호를 식별합니다.|  
|peer_db_version|**sysname 이며**|피어 데이터베이스의 버전 번호를 식별합니다.|  
