...
|**physical_device_name**|**nvarchar(260)**|백업 디바이스의 물리적 이름입니다. NULL일 수 있습니다. 이 필드는 백업 및 복원 프로세스 간에 공유 됩니다. 원래 백업 대상 경로 또는 복원 원본 경로 포함할 수 있습니다. 에 따라 발생 했는지 여부 백업 또는 복원 먼저 데이터베이스에 대 한 서버에 있습니다. 참고 동일한 백업 파일에서 연속 복원 복원 시의 위치에 관계 없이 경로 업데이트 되지 것입니다. 이 인해 **physical_device_name** 사용 된 복원 경로 확인 하려면 필드를 사용할 수 없습니다.|  
|**device_type**|**tinyint**|백업 디바이스의 유형입니다.<br /><br /> 2 = 디스크<br /><br /> 5 = 테이프<br /><br /> 7 = 가상 디바이스<br /><br /> 9 = azure 저장소<br /><br /> 105 = 영구 백업 디바이스<br /><br /> NULL일 수 있습니다.<br /><br /> 모든 영구 장치 이름과 장치 번호를 확인할 수 있습니다 **sys.backup_devices**합니다.|  
