...
|**freq_relative_interval**|**int**|매월 **freq_interval** 발생 하는 경우 **freq_interval** 는 **32** (매월 상대적)입니다. 다음 값 중 하나입니다.<br /><br /> **0** = **freq_relative_interval** 사용 되지 않습니다.<br /><br /> **1** = 첫 번째<br /><br /> **2** = 초<br /><br /> **4** = 세 번째<br /><br /> **8** = 네 번째<br /><br /> **16** = 마지막|  
