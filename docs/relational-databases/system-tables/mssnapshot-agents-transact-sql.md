...
|**dynamic_filter_login**|**sysname**|평가에 사용 된 값을 [SUSER_SNAME &#40;TRANSACT-SQL&#41; ](../../t-sql/functions/suser-sname-transact-sql.md) 파티션을 정의 하는 매개 변수가 있는 필터의 함수입니다. 이 열은 분할된 스냅숏에 사용됩니다.|  
|**dynamic_filter_hostname**|**sysname**|평가에 사용 된 값을 [HOST_NAME &#40;TRANSACT-SQL&#41; ](../../t-sql/functions/host-name-transact-sql.md) 파티션을 정의 하는 매개 변수가 있는 필터의 함수입니다. 이 열은 분할된 스냅숏에 사용됩니다.|  
