...
|**description**|**nvarchar(255)**|미디어 세트의 문자 설명입니다. NULL일 수 있습니다.<br /><br /> 자세한 내용은 MEDIANAME and MEDIADESCRIPTION in [BACKUP &#40;transact-sql&#41;](../../t-sql/statements/backup-transact-sql.md)을 참조 하세요.|  
