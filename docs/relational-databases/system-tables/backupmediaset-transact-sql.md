...
|**software_vendor_id**|**int**|백업 미디어 레이블을 기록한 소프트웨어 공급업체의 ID 번호입니다. NULL일 수 있습니다.<br /><br /> 의 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 값은 16 진수 0x1200입니다.|  
