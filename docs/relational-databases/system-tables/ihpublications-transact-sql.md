...
ms.locfileid: "33003410"
---
# <a name="ihpublications-transact-sql"></a>IHpublications(Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]

  **IHpublications** 시스템 테이블은 현재 배포자를 사용 하 여 각 SQL Server 이외 게시에 대해 하나의 행을 포함 합니다. 이 테이블은 배포 데이터베이스에 저장됩니다.  
...
|**상태**|**tinyint**|게시의 상태를 나타내며 다음 중 하나일 수 있습니다.<br /><br /> **0** = 비활성입니다.<br /><br /> **1** = 활성 합니다.|  
...
|**enabled_for_internet**|**bit**|게시에 대 한 동기화 파일이 FTP 및 기타 서비스를 통해 인터넷에 노출 됩니다 있는지 여부를 나타냅니다. 여기서 **1** 인터넷에서 액세스할 수 있습니다.|  
|**immediate_sync_ready**|**bit**|동기화 파일은 위치를 사용할 수 있는지 나타냅니다 **1** 사용할 수 있다는 것을 의미 합니다. *SQL 이외 게시자에 대해 지원 되지 않습니다.*|  
|**allow_queued_tran**|**bit**|구독자의 변경 내용이 게시자에 적용될 수 있을 때까지 변경 지연이 설정되었는지 여부를 지정합니다. 경우 **1**, 구독자의 변경 내용을 큐에 대기 됩니다. *SQL 이외 게시자에 대해 지원 되지 않습니다.*|  
|**allow_sync_tran**|**bit**|게시에서 즉시 업데이트 구독이 허용되는지 여부를 지정합니다. **1** 즉시 업데이트 구독을 허용 합니다. *SQL 이외 게시자에 대해 지원 되지 않습니다.*|  
|**autogen_sync_procs**|**bit**|게시자에서 즉시 업데이트 구독에 대한 동기화 저장 프로시저가 생성되는지 여부를 지정합니다. **1** 게시자에서 생성 된 것을 의미 합니다. *SQL 이외 게시자에 대해 지원 되지 않습니다.*|  
...
|**allow_dts**|**bit**|게시에서 데이터 변환을 허용하도록 지정합니다. **1** 은 DTS 변환이 허용을 지정 합니다. *SQL 이외 게시자에 대해 지원 되지 않습니다.*|  
|**allow_anonymous**|**bit**|게시에서 익명 구독이 허용 되는지 여부를 나타냅니다. 여기서 **1** 는 사용할 수 있다는 것을 의미 합니다.|  
|**centralized_conflicts**|**bit**|게시자에 충돌 레코드를 저장하는지 여부를 지정합니다.<br /><br /> **0** = 충돌 레코드가 충돌을 일으킨 구독자 및 게시자 양쪽 모두에서 저장 됩니다.<br /><br /> **1** = 충돌 레코드가 게시자에 저장 됩니다.<br /><br /> *SQL 이외 게시자에 대해 지원 되지 않습니다.*|  
|**conflict_retention**|**int**|충돌 보존 기간(일)을 지정합니다. *SQL 이외 게시자에 대해 지원 되지 않습니다.*|  
|**conflict_policy**|**int**|지연 업데이트 구독자 옵션을 사용할 때 수행하는 충돌 해결 정책을 지정합니다. 다음 값 중 하나를 사용할 수 있습니다.<br /><br /> **1** = 게시자 내용 적용 충돌 합니다.<br /><br /> **2** = 구독자 내용 적용 충돌 합니다.<br /><br /> **3** = 구독이 다시 초기화 됩니다.<br /><br /> *SQL 이외 게시자에 대해 지원 되지 않습니다.*|  
|**queue_type**|**int**|사용할 큐의 유형을 지정합니다. 다음 값 중 하나를 사용할 수 있습니다.<br /><br /> **1** 사용 하 여 msmq = [!INCLUDE[msCoName](../../includes/msconame-md.md)] 메시지 큐에 트랜잭션을 저장 합니다.<br /><br /> **2** =를 사용 하는 sql [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 에 트랜잭션을 저장 합니다.<br /><br /> 이 열에서 비-사용 되지 않는[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 게시자입니다.<br /><br /> 참고:를 사용 하 여 [!INCLUDE[msCoName](../../includes/msconame-md.md)] 메시지 큐 사용 되지 않으며 더 이상 지원 합니다.<br /><br /> *이 열에는 SQL 이외 게시자에 대해 지원 되지 않습니다.*|  
