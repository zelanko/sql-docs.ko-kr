...
|**pubid**|**int**|게시의 ID입니다.|  
|**pre_creation_cmd**|**tinyint**|해당 아티클에 대한 스냅샷을 적용할 때 구독자에서 같은 이름의 기존 개체가 검색될 경우 시스템이 할 일을 지정합니다.<br /><br /> **0** = nothing입니다.<br /><br /> **1** = 대상 테이블을 삭제 합니다.<br /><br /> **2** = 대상 테이블을 삭제 합니다.<br /><br /> **3** = 대상 테이블을 잘라냅니다.|  
