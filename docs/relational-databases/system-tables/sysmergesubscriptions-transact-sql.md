...
|상태|**tinyint**|구독 상태입니다.<br /><br /> **0** = 비활성입니다.<br /><br /> **1** = 활성입니다.<br /><br /> **2** = 삭제 합니다.|  
|subscriber_type|**int**|구독자의 유형입니다.<br /><br /> **1** = 전역입니다.<br /><br /> **2** = 로컬입니다.<br /><br /> **3** = 익명입니다.|  
...
|priority|**real**|구독 우선순위를 지정하고 우선순위를 기반으로 한 충돌 해결 구현을 허용합니다. 같음 **0.00** 모든 로컬 또는 익명 구독에 대 한 합니다.|  
