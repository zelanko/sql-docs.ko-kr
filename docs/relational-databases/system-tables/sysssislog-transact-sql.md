...
ms.locfileid: "68029612"
---
# <a name="sysssislog-transact-sql"></a>sysssislog(Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]

  런타임에 패키지나 패키지의 태스크 및 컨테이너에 의해 생성되는 각 로깅 항목에 대해 한 행을 포함합니다. 이 테이블은를 설치할 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]때 msdb 데이터베이스에 만들어집니다. 다른 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 데이터베이스에 기록하도록 로깅을 구성하면 이러한 형식의 sysssislog 테이블이 지정한 데이터베이스에 만들어집니다.  
  
> [!NOTE]  
>  [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]는 패키지에서 로그 공급자를 **only** 사용 하는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 경우에만이 테이블의 로깅 항목을 작성 합니다.  
