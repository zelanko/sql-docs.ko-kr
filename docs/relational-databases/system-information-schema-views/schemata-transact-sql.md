...
[!INCLUDE[tsql-appliesto-ss2008-all-md](../../includes/tsql-appliesto-ss2008-all-md.md)]
  ...
  현재 데이터베이스 내의 각 스키마당 한 개의 행을 반환합니다. 이러한 뷰에서 정보를 검색 하려면의 정규화 된 이름을 지정 **INFORMATION_SCHEMA.** *view_name*합니다. 인스턴스의 모든 데이터베이스에 대 한 정보를 검색할 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], 쿼리는 [sys.databases&#40; Transact SQL &#41; ](../../relational-databases/system-catalog-views/sys-databases-transact-sql.md) 카탈로그 뷰에 있습니다.  
