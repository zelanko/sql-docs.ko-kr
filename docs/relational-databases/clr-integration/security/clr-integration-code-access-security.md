...
description: SQL Server CLR 통합의 경우 CLR은 코드 id를 기반으로 어셈블리에 대 한 권한이 부여 되는 관리 코드에 대 한 코드 액세스 보안을 지원 합니다.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
ms.reviewer: ''
...
|**EnvironmentPermission**|**제한 없음:** 시스템 및 사용자 환경 변수에 대 한 모든 액세스 권한이 허용 됩니다.|  
...
|**SqlClientPermission**|**제한 없음:** 데이터 원본에 대 한 모든 액세스 권한이 허용 됩니다.|  
|**StorePermission**|**제한 없음:** X.509 인증서 저장소에 대 한 모든 액세스 권한이 허용 됩니다.|  
