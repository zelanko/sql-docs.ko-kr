---
title: 공통 언어 런타임(CLR) 개요
description: SQL Server와의 CLR 통합을 사용하면 모든 .NET Framework 언어를 SQL Server 서버 측 모듈로 사용하여 일부 기능을 구현할 수 있습니다.
...
또한 Azure SQL Database 관리 인스턴스에서 CLR을 사용하는 방법을 보여 주는 이 6분 짜리 비디오를 볼 수도 있습니다.
...
## <a name="when-to-use-clr-modules"></a>CLR 모듈을 언제 사용해야 합니까?

CLR 통합을 사용하면 정규식, 외부 리소스(서버, 웹 서비스, 데이터베이스), 사용자 지정 암호화 등에 액세스하기 위한 코드 등 .Net Framework에서 사용할 수 있는 복잡한 기능을 구현할 수 있습니다. 서버 측 CLR 통합의 이점 중 일부는 다음과 같습니다.
...
## <a name="see-also"></a>참고 항목  
 [.NET 프레임워크](https://technet.microsoft.com/library/ms166014\(v=SQL.105\).aspx) 설치(전용)[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]   
