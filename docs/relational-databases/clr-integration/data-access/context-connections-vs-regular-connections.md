...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
 ...
 또한 성능이 향상되고 리소스 사용량이 줄어드는 이점도 있습니다. 컨텍스트 연결은 in-process 전용 연결이므로 네트워크 프로토콜 및 전송 계층을 무시하고 "직접" 서버에 연결하여 Transact-SQL 문을 보내고 결과를 받을 수 있습니다. 인증 프로세스도 무시됩니다. 다음 그림의 주요 구성 요소를 **SqlClient** 일반 연결을 사용 하는 경우 및 컨텍스트 연결을 사용 하는 경우 여러 구성 요소가 서로 상호 작용 하는 방법 뿐만 아니라 공급자를 관리 합니다.  
