---
title: CLR (공용 언어 런타임) 프로그래밍
description: CLR (공용 언어 런타임) 프로그래밍 문서에 대 한 링크
...
>  CLR 기능 (예: CLR 사용자 함수)은 Azure SQL Database에 대해 지원 *되지 않습니다* .  
 ...
 [공용 언어 런타임 &#40;CLR&#41; 통합에 대 한 사용 시나리오 및 예제](https://msdn.microsoft.com/library/33aac25f-abb4-4f29-af88-4a0dacd80ae7)  
