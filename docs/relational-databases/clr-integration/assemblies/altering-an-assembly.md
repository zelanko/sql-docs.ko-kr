...
```  
 ...
 어셈블리의 권한 집합에서 변경 되 면 **안전한** 하 **EXTERNAL_ACCESS** 또는 **UNSAFE**, 비대칭 키 및 해당 로그인을  **EXTERNAL ACCESS ASSEMBLY** 권한 또는 **UNSAFE ASSEMBLY** 어셈블리에 대 한 권한을 먼저 만들어야 합니다. 자세한 내용은 [Creating an Assembly](../../../relational-databases/clr-integration/assemblies/creating-an-assembly.md)을 참조하세요.  
