...
description: 관리 되는 데이터베이스 개체에 대 한 코드 검사는 CREATE ASSEMBLY를 사용 하 여 처음으로 등록 하 고 런타임에 수행할 때 SQL Server.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
ms.reviewer: ''
...
-   **에서 CREATE ASSEMBLY**_를 사용 하 고 모든 \<location> _ 참조 된 어셈블리와 해당 종속성을에서 사용할 수 있습니다 *\<location>* .  
  
-   **에서 CREATE ASSEMBLY**_를 사용 하 고 있으며 \<bytes ...> _ 모든 참조는 공백으로 구분 된 바이트를 통해 지정 됩니다.  
