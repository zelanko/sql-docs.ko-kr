---
title: 어셈블리(데이터베이스 엔진) | 마이크로 소프트 문서
description: SQL Server 인스턴스는 CLR 언어로 작성된 함수, 프로시저, 트리거 및 사용자 정의 집계 및 형식을 배포하는 어셈블리를 호스트할 수 있습니다.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
 ...
 어셈블리는 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] [!INCLUDE[tsql](../../includes/tsql-md.md)]에서 가 아니라 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] CLR(공통 언어 런타임)에서 호스팅되는 관리 코드 언어 중 하나로 작성된 함수, 저장 프로시저, 트리거, 사용자 정의 집계 및 사용자 정의 형식을 배포하는 데 사용되는 DLL 파일입니다.  
...
-   CLR 함수. 자세한 내용은 [CLR 함수 만들기를](../../relational-databases/user-defined-functions/create-clr-functions.md)참조하십시오.  
  
-   CLR 저장 프로시저. 자세한 내용은 [CLR 저장 프로시저를](https://msdn.microsoft.com/library/bbdd51b2-a9b4-4916-ba6f-7957ac6c3f33)참조하십시오.  
  
-   CLR 트리거. 자세한 내용은 [CLR 트리거 만들기](../../relational-databases/triggers/create-clr-triggers.md)를 참조하십시오.  
  
-   사용자 정의 집계 함수. 자세한 내용은 [사용자 정의 집계 만들기](../../relational-databases/user-defined-functions/create-user-defined-aggregates.md)를 참조하십시오.  
