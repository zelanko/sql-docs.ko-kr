...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] SQL:BatchStarting 이벤트 클래스는 [!INCLUDE[tsql](../../includes/tsql-md.md)] 일괄 처리가 시작 중임을 나타냅니다.  
...
|TextData|**ntext**|Transact-SQL 일괄 처리의 텍스트입니다.|1|예|  
