...
|**EventClass**|**ssNoversion**|이벤트 유형 = 115|27|아니오|  
|**EventSequence**|**ssNoversion**|요청 내에 지정된 이벤트 시퀀스입니다.|51|아니오|  
|**EventSubClass**|**ssNoversion**|이벤트 하위 클래스의 유형입니다.<br /><br /> 1=Backup<br /><br /> 2=Restore<br /><br /> 3=BackupLog|21|예|  
...
|**TextData**|**ntext**|백업 또는 복원 문의 SQL 텍스트입니다.|1|예|  
