...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] **Audit Backup/Restore** 이벤트 클래스는 백업 또는 복원 명령이 실행될 때마다 발생합니다.  
...
|**EventClass**|**int**|이벤트 유형 = 115|27|아니오|  
|**EventSequence**|**int**|요청 내에 지정된 이벤트 시퀀스입니다.|51|아니오|  
|**EventSubClass**|**int**|이벤트 하위 클래스의 유형입니다.<br /><br /> 1=Backup<br /><br /> 2=Restore<br /><br /> 3=BackupLog|21|예|  
