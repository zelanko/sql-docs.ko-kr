...
|**EventClass**|**int**|이벤트 유형 = 115|27|예|  
|**EventSequence**|**int**|요청 내에 지정된 이벤트 시퀀스입니다.|51|예|  
|**EventSubClass**|**int**|이벤트 하위 클래스의 유형입니다.<br /><br /> 1=Backup<br /><br /> 2=Restore<br /><br /> 3=BackupLog|21|yes|  
...
|**TextData**|**ntext**|백업 또는 복원 문의 SQL 텍스트입니다.|1|yes|  
