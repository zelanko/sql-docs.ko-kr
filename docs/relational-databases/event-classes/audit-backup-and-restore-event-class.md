...
|**EventSubClass**|**int**|이벤트 하위 클래스의 유형입니다.<br /><br /> 1=Backup<br /><br /> 2=Restore<br /><br /> 3=BackupLog|21|사용자 계정 컨트롤|  
...
|**TextData**|**ntext**|백업 또는 복원 문의 SQL 텍스트입니다.|1|사용자 계정 컨트롤|  
