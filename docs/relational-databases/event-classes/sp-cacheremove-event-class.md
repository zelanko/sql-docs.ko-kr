...
|EventClass|**ssNoversion**|이벤트 유형 = 36|27|아니오|  
|EventSequence|**ssNoversion**|요청 내에 지정된 이벤트 시퀀스입니다.|51|아니오|  
|EventSubClass|**ssNoversion**|이벤트 하위 클래스의 유형입니다.<br /><br /> 1=Compplan Remove: 캐시에서 컴파일된 쿼리 계획이 제거되었습니다.<br /><br /> 2=Proc Cache Flush: 프로시저 캐시에서 모든 항목이 제거되었습니다.|21|예|  
...
|TextData|**ntext**|캐시에서 제거되는 SQL 텍스트입니다.|1|예|  
