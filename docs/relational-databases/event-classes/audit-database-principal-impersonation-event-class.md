...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] **Audit Database Principal Impersonation** 이벤트 클래스는 데이터베이스 범위 내에 EXECUTE AS \<*user*> 또는 SETUSER 등의 가장이 있는 경우에 발생합니다.  
