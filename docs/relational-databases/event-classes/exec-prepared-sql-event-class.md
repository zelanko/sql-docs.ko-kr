---
title: "Exec Prepared SQL 이벤트 클래스 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## Exec Prepared SQL 이벤트 클래스 데이터 열  
...
|EventClass|**int**|이벤트 유형 = 72|27||  
|EventSequence|**int**|요청 내에 지정된 이벤트 시퀀스입니다.|51||  
|GroupID|**int**|SQL 추적 이벤트가 발생한 작업 그룹의 ID입니다.|66|예|  
|Handle|**int**|준비된 SQL 문의 핸들입니다.|33|예|  
