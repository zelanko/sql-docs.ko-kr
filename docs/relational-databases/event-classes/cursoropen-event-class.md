...
|**EventClass**|**ssNoversion**|기록된 이벤트 유형 = 53|27|아니오|  
|**EventSequence**|**ssNoversion**|일괄 처리에서 **CursorOpen** 이벤트 클래스의 순서입니다.|51|아니오|  
...
|**IntegerData**|**ssNoversion**|커서 유형입니다. 값은 다음과 같습니다.<br /><br /> 1 = 키 집합<br /><br /> 2 = 동적<br /><br /> 4 = 정방향 전용<br /><br /> 8 = 정적<br /><br /> 16 = 빠른 정방향|25|예|  
...
|**RequestID**|**ssNoversion**|커서를 연 요청 식별자입니다.|49|예|  
