...
|EventClass|**ssNoversion**|이벤트 유형 = 120|27|아니오|  
|EventSequence|**ssNoversion**|일괄 처리에서 OLE DB 이벤트 클래스의 순서입니다.|51|아니오|  
|EventSubClass|**ssNoversion**|0=시작<br /><br /> 1=완료|21|아니오|  
