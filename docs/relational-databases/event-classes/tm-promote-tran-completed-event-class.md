...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] TM: Promote Tran Completed 이벤트 클래스는 PROMOTE TRANSACTION 요청이 완료되었음을 나타냅니다. 이 요청은 트랜잭션 관리 인터페이스를 통해 클라이언트에서 보냅니다.  
...
|BinaryData|**image**|DTC Xact 토큰입니다.|2|예|  
...
|EventClass|**int**|이벤트 유형 = 184|27|아니요|  
