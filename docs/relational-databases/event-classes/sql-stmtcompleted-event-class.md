...
|CPU|**int**|이벤트에 의해 사용된 CPU 시간(밀리초)입니다.|18|사용자 계정 컨트롤|  
...
|EventClass|**int**|이벤트 유형 = 41|27|아니오|  
...
|IntegerData|**int**|문이 반환한 행의 수입니다.|25|사용자 계정 컨트롤|  
...
|NestLevel|**int**|문이 저장 프로시저 내에서 실행된 경우 저장 프로시저의 중첩 수준입니다.|29|사용자 계정 컨트롤|  
...
|Reads|**bigint**|SQL 문에 의해 실행된 페이지 읽기 수입니다.|16|사용자 계정 컨트롤|  
|RequestID|**int**|문을 포함하는 요청의 ID입니다.|49|사용자 계정 컨트롤|  
|RowCounts|**bigint**|이벤트의 영향을 받은 행 수 입니다.|48|사용자 계정 컨트롤|  
...
|TextData|**ntext**|실행된 문의 텍스트입니다.|@shouldalert|사용자 계정 컨트롤|  
|TransactionID|**bigint**|문이 트랜잭션 내에서 실행된 경우 트랜잭션의 ID입니다.|4|사용자 계정 컨트롤|  
|Writes|**bigint**|SQL 문에 의해 실행된 페이지 쓰기 수입니다.|17|사용자 계정 컨트롤|  
