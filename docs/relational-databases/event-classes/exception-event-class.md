...
---
# <a name="exception-event-class"></a>Exception 이벤트 클래스
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Exception 이벤트 클래스는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]에서 예외가 발생했음을 나타냅니다.  
  
## <a name="exception-event-class-data-columns"></a>Exception 이벤트 클래스 데이터 열  
...
|오류|**int**|이벤트의 오류 번호입니다.|31|예|  
|EventClass|**int**|이벤트 유형 = 33|27|아니요|  
...
|Severity|**int**|예외적인 심각도입니다.|20|예|  
|SPID|**int**|이벤트가 발생한 세션의 ID입니다.|12|예|  
|StartTime|**datetime**|이벤트가 시작된 시간입니다(사용 가능한 경우).|14|예|  
|State|**int**|서버의 상태입니다.|30|예|  
