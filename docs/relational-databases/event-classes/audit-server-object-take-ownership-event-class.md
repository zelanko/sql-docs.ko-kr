...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] **Audit Server Object Take Ownership** 이벤트 클래스는 서버 범위에 있는 개체 소유자가 변경될 때 발생합니다.  
