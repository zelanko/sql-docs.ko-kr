---
title: "Execution Warnings 이벤트 클래스 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## Execution Warnings 이벤트 클래스 데이터 열  
...
|기간|**bigint**|쿼리가 필요한 메모리를 가져오기 위해 기다려야 했던 밀리초 단위의 시간입니다. EventSubClass = 1(쿼리 대기)일 경우에만 유효합니다.|13|예|  
|오류|**int**|사용되지 않습니다.|31|예|  
