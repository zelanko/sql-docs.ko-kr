...
|Duration|**bigint**|쿼리가 필요한 메모리를 가져오기 위해 기다려야 했던 밀리초 단위의 시간입니다. EventSubClass = 1(쿼리 대기)일 경우에만 유효합니다.|13|사용자 계정 컨트롤|  
|Error|**int**|사용되지 않습니다.|31|사용자 계정 컨트롤|  
|EventClass|**int**|이벤트 유형 = 67|27|아니오|  
|EventSequence|**int**|추적 내의 지정된 이벤트 시퀀스입니다.|51|아니오|  
