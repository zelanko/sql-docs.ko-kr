---
title: "OLEDB Call 이벤트 클래스 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
|기간|**Bigint**|OLE DB Call 이벤트를 완료하는 데 소요되는 시간입니다.|13|아니요|  
|EndTime|**날짜/시간**|이벤트가 종료된 시간입니다.|15|예|  
|오류|**int**|지정된 이벤트의 오류 번호입니다. 종종 sys.messages 카탈로그 뷰에 저장된 오류 번호를 나타냅니다.|31|예|  
|EventClass|**정수**|이벤트 유형 = 119|27|아니요|  
|EventSequence|**정수**|일괄 처리 내의 OLE DB 이벤트 클래스 시퀀스입니다.|51|아니요|  
|EventSubClass|**정수**|0=시작<br /><br /> 1=완료|21|아니요|  
