...
|**EventSubClass**|**int**|이벤트 하위 클래스의 유형입니다.<br /><br /> 1=감사 시작<br /><br /> 2=감사 중지<br /><br /> 3=C2 모드 설정<br /><br /> 4=C2 모드 해제|21|예|  
