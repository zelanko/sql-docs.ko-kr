---
title: "Audit Change Audit 이벤트 클래스 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## Audit Change Audit 이벤트 클래스 데이터 열  
...
|**EventClass**|**int**|이벤트 유형 = 117|27|아니요|  
...
|**ServerName**|**nvarchar**|추적 중인 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 인스턴스의 이름입니다.|26|아니요|  
