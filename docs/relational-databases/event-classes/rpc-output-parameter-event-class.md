---
title: "RPC Output Parameter 이벤트 클래스 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## RPC Output Parameter 이벤트 클래스 데이터 열  
...
|ObjectName|**nvarchar**|참조되는 매개 변수의 이름입니다.|34|예|  
...
|TextData|**ntext**|RPC의 출력 매개 변수 값입니다.|1|예|  
