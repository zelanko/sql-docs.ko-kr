...
|EventClass|**int**|이벤트 유형 = 100|27|아니오|  
...
|ObjectName|**nvarchar**|참조되는 매개 변수의 이름입니다.|34|사용자 계정 컨트롤|  
...
|TextData|**ntext**|RPC의 출력 매개 변수 값입니다.|@shouldalert|사용자 계정 컨트롤|  
