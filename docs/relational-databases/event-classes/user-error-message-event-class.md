...
|EventClass|**int**|이벤트 유형 = 162|27|아니오|  
...
|Severity|**int**|오류 또는 예외의 심각도 수준입니다.|20|사용자 계정 컨트롤|  
|SPID|**int**|이벤트가 발생한 세션의 ID입니다.|12|사용자 계정 컨트롤|  
|StartTime|**datetime**|이벤트가 시작된 시간입니다(사용 가능한 경우).|14|사용자 계정 컨트롤|  
|State|**int**|오류 상태 코드입니다.|30|사용자 계정 컨트롤|  
|TextData|**ntext**|오류 메시지 또는 예외의 텍스트입니다.|@shouldalert|사용자 계정 컨트롤|  
