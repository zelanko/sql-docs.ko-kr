...
---
# <a name="prepare-sql-event-class"></a>Prepare SQL 이벤트 클래스
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Prepare SQL 이벤트 클래스는 SqlClient, ODBC, OLE DB 또는 DB-Library가 사용할 [!INCLUDE[tsql](../../includes/tsql-md.md)] 문을 준비했음을 나타냅니다.  
  
## <a name="prepare-sql-event-class-data-columns"></a>Prepare SQL 이벤트 클래스 데이터 열  
...
|EventClass|**int**|이벤트 유형 = 71|27|아니요|  
|EventSequence|**int**|요청 내에 지정된 이벤트 시퀀스입니다.|51|아니요|  
|GroupID|**int**|SQL 추적 이벤트가 발생한 작업 그룹의 ID입니다.|66|예|  
|Handle|**int**|준비된 [!INCLUDE[tsql](../../includes/tsql-md.md)] 문의 핸들입니다.|33|예|  
