...
|EventClass|**ssNoversion**|이벤트 유형 = 51|27|아니오|  
...
|IndexID|**ssNoversion**|검색 중인 인덱스입니다(인덱스인 경우).|24|예|  
...
|ObjectID|**ssNoversion**|검색 중인 개체의 시스템 할당 ID입니다.|22|예|  
