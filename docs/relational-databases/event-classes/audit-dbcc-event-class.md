...
|**ColumnPermissions**|**int**|열 사용 권한이 설정되어 있는지 나타냅니다. 문 텍스트를 구문 분석하여 어떤 권한이 어떤 열에 적용되었는지 정확히 알 수 있습니다.|44|사용자 계정 컨트롤|  
...
||||||  
|**EventClass**|**int**|이벤트 유형 = 116|27|아니오|  
...
||||||  
||||||  
|**TextData**|**ntext**|DBCC 명령의 SQL 텍스트입니다.|@shouldalert|사용자 계정 컨트롤|  
