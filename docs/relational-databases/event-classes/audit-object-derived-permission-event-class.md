---
description: Audit Object Derived Permission 이벤트 클래스
...
## <a name="audit-object-derived-permission-event-class-data-columns"></a>Audit Object Derived Permission 이벤트 클래스 데이터 열  
...
|**DBUserName**|**nvarchar**|데이터베이스의 발급자 사용자 이름입니다.|40|예|  
|**EventClass**|**int**|이벤트 유형 = 118|27|예|  
...
|**ObjectName**|**nvarchar**|생성, 변경 또는 삭제할 개체의 이름입니다.|34|예|  
...
|**OwnerName**|**nvarchar**|생성, 변경 또는 삭제할 개체의 소유자에 대한 데이터베이스 사용자 이름입니다.|37|예|  
