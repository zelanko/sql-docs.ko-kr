...
|ObjectType|**int**|호출된 저장 프로시저 유형입니다. 이 값은 sys.objects 카탈로그 뷰의 유형 열과 일치합니다. 값은 [ObjectType 추적 이벤트 열](../../relational-databases/event-classes/objecttype-trace-event-column.md)을 참조하세요.|28|yes|  
|RequestID|**int**|문을 포함하는 요청의 ID입니다.|49|yes|  
|RowCounts|**bigint**|이 저장 프로시저에 속한 모든 문의 행 수입니다.|48|yes|  
...
|TextData|**ntext**|저장 프로시저 호출의 텍스트입니다.|1|yes|  
