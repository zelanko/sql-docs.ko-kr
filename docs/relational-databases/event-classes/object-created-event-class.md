...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Object:Created 이벤트 클래스는 CREATE INDEX, CREATE TABLE, CREATE DATABASE 문 등을 사용하여 개체가 생성되었음을 나타냅니다.  
