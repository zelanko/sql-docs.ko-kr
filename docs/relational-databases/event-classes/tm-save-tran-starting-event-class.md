...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] TM: Save Tran Starting 이벤트 클래스는 SAVE TRANSACTION 요청이 시작 중임을 나타냅니다. 이 요청은 트랜잭션 관리 인터페이스를 통해 클라이언트에서 보냅니다.  
...
|EventClass|**int**|이벤트 유형 = 191|27|아니요|  
