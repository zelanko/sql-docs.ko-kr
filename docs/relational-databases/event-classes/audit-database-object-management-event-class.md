...
|**EventSubClass**|**int**|이벤트 하위 클래스의 유형입니다.<br /><br /> 1=만들기<br /><br /> 2=변경<br /><br /> 3=삭제<br /><br /> 4=덤프<br /><br /> 10=열기<br /><br /> 11=로드<br /><br /> 12=액세스|21|사용자 계정 컨트롤|  
