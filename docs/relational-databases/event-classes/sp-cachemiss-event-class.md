...
|EventClass|**int**|이벤트 유형 = 34|27|아니오|  
...
|ObjectName|**nvarchar**|저장 프로시저의 이름입니다. ObjectName을 채우면 TextData가 채워지지 않습니다.|34|사용자 계정 컨트롤|  
...
|TextData|**ntext**|캐시된 SQL 코드 텍스트입니다. TextData를 채우면 ObjectName이 채워지지 않습니다.|@shouldalert|사용자 계정 컨트롤|  
