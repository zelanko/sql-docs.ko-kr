---
title: "Audit Server Principal Impersonation 이벤트 클래스 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Server Principal Impersonation 이벤트 클래스"
...
---
# Audit Server Principal Impersonation 이벤트 클래스
  **Audit Server Principal Impersonation** 이벤트 클래스는 \<*로그인*>으로 실행과 같이 서버 범위 내에 가장이 있는 경우에 발생합니다.  
  
## Audit Server Principal Impersonation 이벤트 클래스 데이터 열  
