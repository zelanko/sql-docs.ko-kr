...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] **Audit Server Principal Impersonation** 이벤트 클래스는 EXECUTE AS \<*login*>과 같이 서버 범위 안에 가장이 있는 경우에 발생합니다.  
