---
title: "SQL:StmtRecompile 이벤트 클래스 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## SQL:StmtRecompile 이벤트 클래스 데이터 열  
...
|ServerName|**nvarchar**|추적할 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 이름입니다.|26|아니요|  
