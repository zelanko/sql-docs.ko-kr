---
title: "Audit Login GDR 이벤트 클래스 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
|**EventClass**|**int**|이벤트 유형 = 105|27|아니요|  
...
|**TargetLoginSid**|**image**|대상 로그인의 SID입니다.|43|예|  
