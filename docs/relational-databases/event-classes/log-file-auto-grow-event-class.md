---
title: "Log File Auto Grow 이벤트 클래스 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## Log File Auto Grow 이벤트 클래스 데이터 열  
...
|**EventSequence**|**정수**|일괄 처리 내의 **CursorClose** 이벤트 클래스 순서입니다.|51|아니요|  
