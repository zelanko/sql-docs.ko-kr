---
description: Log File Auto Grow 이벤트 클래스
...
## <a name="log-file-auto-grow-event-class-data-columns"></a>Log File Auto Grow 이벤트 클래스 데이터 열  
...
|**Duration**|**bigint**|파일을 확장하는 데 필요한 시간(밀리초)입니다.|13|예|  
|**EndTime**|**datetime**|로그 파일 **자동 증가** 가 끝난 시간입니다.|18|예|  
|**EventClass**|**int**|이벤트 유형 = 93|27|예|  
|**EventSequence**|**int**|일괄 처리 내의 **CursorClose** 이벤트 클래스 순서입니다.|51|예|  
...
|**IntegerData**|**정수**|파일이 증분되는 8KB 페이지 단위의 수입니다.|25|예|  
