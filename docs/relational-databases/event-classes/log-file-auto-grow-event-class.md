...
|**EndTime**|**datetime**|로그 파일 **자동 증가** 가 끝난 시간입니다.|18|사용자 계정 컨트롤|  
|**EventClass**|**int**|이벤트 유형 = 93|27|아니오|  
|**EventSequence**|**int**|일괄 처리 내의 **CursorClose** 이벤트 클래스 순서입니다.|51|아니오|  
...
|**IntegerData**|**정수**|파일이 증분되는 8KB 페이지 단위의 수입니다.|25|사용자 계정 컨트롤|  
