...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] **Audit Login Change Property** 이벤트 클래스는 **sp_defaultdb** 저장 프로시저, **sp_defaultlanguage** 저장 프로시저 또는 ALTER LOGIN 문을 사용하여 로그인 속성을 수정할 때 발생합니다.  
...
|**EventClass**|**int**|이벤트 유형 = 106|27|아니요|  
|**EventSequence**|**int**|요청 내에 지정된 이벤트 시퀀스입니다.|51|아니요|  
|**EventSubClass**|**int**|이벤트 하위 클래스의 유형입니다.<br /><br /> 1=기본 데이터베이스가 변경됨<br /><br /> 2=기본 언어가 변경됨<br /><br /> 3=이름이 변경됨<br /><br /> 4=자격 증명이 변경됨<br /><br /> 5=정책이 변경됨<br /><br /> 6=만료가 변경됨|21|예|  
