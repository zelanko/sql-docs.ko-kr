...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] XQuery Static Type 이벤트 클래스는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]가 XQuery 식을 실행할 때 발생합니다. 이 이벤트 클래스는 XQuery 식의 정적 유형을 제공합니다.  
...
|TextData|**ntext**|XQuery 식의 정적으로 유추된 유형입니다.|1|예|  
