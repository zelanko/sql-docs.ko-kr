...
|EventClass|**ssNoversion**|이벤트 유형 = 42|27|아니오|  
...
|LineNumber|**ssNoversion**|이 저장 프로시저를 호출한 EXECUTE 문의 줄 번호를 표시합니다.|5|예|  
...
|ObjectName|**nvarchar**|시작 중인 저장 프로시저의 이름입니다.|34|예|  
|ObjectType|**ssNoversion**|시작 중인 저장 프로시저의 유형입니다. 이 값은 sys.objects 카탈로그 뷰의 유형 열과 일치합니다. 값은 [ObjectType 추적 이벤트 열](../../relational-databases/event-classes/objecttype-trace-event-column.md)을 참조하세요.|28|예|  
...
|SourceDatabaseID|**ssNoversion**|개체가 있는 데이터베이스의 ID입니다.|62|예|  
|SPID|**ssNoversion**|이벤트가 발생한 세션의 ID입니다.|12|예|  
|StartTime|**datetime**|이벤트가 시작된 시간입니다(사용 가능한 경우).|14|예|  
|TextData|**ntext**|프로시저 호출의 텍스트입니다.|1|예|  
