...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] **Audit Add Member to DB Role** 이벤트 클래스는 데이터베이스 역할에서 로그인이 추가되거나 제거될 때마다 발생합니다. 이 이벤트 클래스는 **sp_addrolemember**, **sp_changegroup**, 및 **sp_droprolemember** 저장 프로시저와 함께 사용됩니다.  
...
|**DatabaseName**|**nvarchar**|역할 멤버 자격이 수정된 데이터베이스의 이름입니다.|35|예|  
|**DBUserName**|**nvarchar**|데이터베이스에서 발급자의 사용자 이름입니다.|40|예|  
|**EventClass**|**int**|이벤트 유형 = 110|27|아니요|  
|**EventSequence**|**int**|요청 내에 지정된 이벤트 시퀀스입니다.|51|아니요|  
|**EventSubClass**|**int**|이벤트 하위 클래스의 유형입니다.<br /><br /> 1=추가<br /><br /> 2=삭제<br /><br /> 3=그룹 변경|21|예|  
...
|**RoleName**|**nvarchar**|활성화된 응용 프로그램 역할의 이름입니다.|38|예|  
...
|**TargetUserName**|**nvarchar**|역할 멤버 자격이 수정되는 사용자의 이름입니다.|39|예|  
