...
|EventClass|**ssNoversion**|이벤트 유형 = 214|27|아니오|  
|EventSequence|**ssNoversion**|요청 내의 특정 이벤트 시퀀스입니다.|51|아니오|  
...
|ObjectID|**ssNoversion**|계획 지침을 적용할 때 실행 중이던 모듈의 개체 ID입니다. 계획 지침이 모듈에 적용되지 않은 경우 이 열은 NULL로 설정됩니다.|22|예|  
