...
|**EventClass**|**int**|기록된 이벤트 유형 = 74|27|아니오|  
|**EventSequence**|**int**|일괄 처리의 **CursorExecute** 이벤트 클래스 시퀀스입니다.|51|아니오|  
...
|**IntegerData**|**int**|커서 유형입니다. 값은 다음과 같습니다.<br /><br /> 1 = 키 집합<br /><br /> 2 = 동적<br /><br /> 4 = 정방향 전용<br /><br /> 8 = 정적<br /><br /> 16 = 빠른 정방향|25|아니오|  
