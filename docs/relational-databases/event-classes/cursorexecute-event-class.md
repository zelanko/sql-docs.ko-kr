---
description: CursorExecute 이벤트 클래스
...
|**IntegerData**|**int**|커서 유형입니다. 값:<br /><br /> 1 = 키 집합<br /><br /> 2 = 동적<br /><br /> 4 = 정방향 전용<br /><br /> 8 = 정적<br /><br /> 16 = 빠른 정방향|25|예|  
