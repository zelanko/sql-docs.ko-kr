...
|EventClass|**int**|이벤트 유형=52|27|아니오|  
...
|IndexID|**int**|검색 중인 인덱스입니다.|24|사용자 계정 컨트롤|  
...
|ObjectID|**int**|검색 중인 개체에 시스템이 할당한 개체 ID입니다.|22|사용자 계정 컨트롤|  
|Reads|**bigint**|읽은 페이지 수입니다(논리적).|16|사용자 계정 컨트롤|  
