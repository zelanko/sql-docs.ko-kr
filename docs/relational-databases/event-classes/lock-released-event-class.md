...
|DatabaseID|**int**|잠금이 해제된 데이터베이스의 ID입니다. [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] 에 ServerName 데이터 열이 추적에서 캡처되고 서버를 사용할 수 있으면 데이터베이스 이름이 표시됩니다. DB_ID 함수를 사용하여 데이터베이스의 값을 확인할 수 있습니다.|3|사용자 계정 컨트롤|  
|EventClass|**int**|이벤트 유형 = 23|27|아니오|  
...
|ObjectID|**int**|해제된 개체의 시스템 할당 ID입니다(사용 및 적용 가능한 경우).|22|사용자 계정 컨트롤|  
