...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] **Audit Database Operation** 이벤트 클래스는 데이터베이스에서 검사점 또는 쿼리 알림 구독과 같은 작업이 수행될 때 발생합니다.  
...
|**EventSubClass**|**int**|이벤트 하위 클래스의 유형입니다.<br /><br /> 1=검사점<br /><br /> 2=쿼리 알림 구독|21|예|  
