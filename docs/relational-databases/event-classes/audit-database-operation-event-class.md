...
## <a name="audit-database-operation-event-class-data-columns"></a>Audit Database Operation 이벤트 클래스 데이터 열  
...
|**EventSubClass**|**ssNoversion**|이벤트 하위 클래스의 유형입니다.<br /><br /> 1=검사점<br /><br /> 2=쿼리 알림 구독|21|예|  
