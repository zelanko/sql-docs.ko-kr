...
|**ClientProcessID**|**정수**|클라이언트 애플리케이션이 실행 중인 프로세스에 대해 호스트 컴퓨터가 할당한 ID입니다. 클라이언트가 클라이언트 프로세스 ID를 제공하면 이 데이터 열이 채워집니다.|9|예|  
...
|**EventClass**|**ssNoversion**|기록된 이벤트 유형 = 94|27|아니오|  
|**EventSequence**|**ssNoversion**|일괄 처리 내의 이벤트 클래스 순서입니다.|51|아니오|  
...
|**IntegerData**|**ssNoversion**|파일이 축소되는 8KB 페이지 단위의 수입니다.|25|예|  
