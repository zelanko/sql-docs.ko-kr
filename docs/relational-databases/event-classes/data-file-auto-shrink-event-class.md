...
|**기간**|**bigint**|파일이 축소되는 데 필요한 시간(밀리초)입니다.|13|사용자 계정 컨트롤|  
|**EndTime**|**datetime**|자동 축소가 종료된 시간입니다.|18|사용자 계정 컨트롤|  
|**EventClass**|**int**|기록된 이벤트 유형 = 94|27|아니오|  
|**EventSequence**|**int**|일괄 처리 내의 이벤트 클래스 순서입니다.|51|아니오|  
|**Filename**|**nvarchar**|축소할 파일의 논리적 이름입니다.|36|사용자 계정 컨트롤|  
...
|**IntegerData**|**int**|파일이 축소되는 8KB 페이지 단위의 수입니다.|25|사용자 계정 컨트롤|  
