...
|**EventClass**|**int**|이벤트 유형 = 104|27|아니오|  
|**EventSequence**|**int**|요청 내에 지정된 이벤트 시퀀스입니다.|51|아니오|  
|**EventSubClass**|**int**|이벤트 하위 클래스의 유형입니다.<br /><br /> 1=추가<br /><br /> 2=삭제|21|사용자 계정 컨트롤|  
...
|**TargetLoginName**|**nvarchar**|추가 또는 삭제될 로그인의 이름입니다.|42|사용자 계정 컨트롤|  
|**TargetLoginSid**|**image**|대상 로그인의 SID(보안 ID)입니다(매개 변수로 전달된 경우).|43|사용자 계정 컨트롤|  
