---
description: Audit Addlogin 이벤트 클래스
...
|**TargetLoginName**|**nvarchar**|추가 또는 삭제될 로그인의 이름입니다.|42|예|  
|**TargetLoginSid**|**image**|대상 로그인의 SID(보안 ID)입니다(매개 변수로 전달된 경우).|43|예|  
...
## <a name="see-also"></a>참고 항목  
 ...
 [Audit Login Change Property 이벤트 클래스](../../relational-databases/event-classes/audit-login-change-property-event-class.md)   
