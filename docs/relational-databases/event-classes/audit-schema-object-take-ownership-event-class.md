...
|**ObjectType**|**int**|이벤트와 관련된 개체 유형을 나타내는 값입니다. 이 열에 대해 반환되는 값은 **sys.objects** 카탈로그 뷰에 있는 **type** 열의 해당 값과 [ObjectType 추적 이벤트 열](../../relational-databases/event-classes/objecttype-trace-event-column.md)에 나열된 값의 조합입니다.|28|사용자 계정 컨트롤|  
|**OwnerName**|**nvarchar**|개체 소유자의 데이터베이스 사용자 이름입니다.|37|사용자 계정 컨트롤|  
|**ParentName**|**nvarchar**|개체가 포함된 스키마 이름입니다.|59|사용자 계정 컨트롤|  
