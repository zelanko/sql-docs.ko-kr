...
|**EventClass**|**ssNoversion**|기록된 이벤트 유형 = 75|27|아니오|  
|**EventSequence**|**ssNoversion**|일괄 처리 내의 **CursorRecompile** 이벤트 클래스 순서입니다.|51|아니오|  
...
|**RequestID**|**ssNoversion**|커서를 다시 컴파일한 요청 식별자입니다.|49|예|  
