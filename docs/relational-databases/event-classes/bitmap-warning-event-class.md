---
title: "Bitmap Warning 이벤트 클래스 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
|**LoginName**|**nvarchar**|사용자 로그인 이름이며 *DOMAIN\username* 형식의 Windows 로그인 자격 증명 또는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 보안 로그인입니다.|11|예|  
