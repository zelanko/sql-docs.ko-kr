...
|**EventClass**|**ssNoversion**|이벤트 유형 = 152|27|아니오|  
...
|**성공**|**ssNoversion**|1 = 성공, 0 = 실패. 예를 들어 값 1은 사용 권한 확인이 성공했음을 의미하고, 값 0은 확인이 실패했음을 의미합니다.|23|예|  
|**TargetLoginName**|**nvarchar**|로그인을 대상으로 하는 동작의 경우 대상 로그인의 이름입니다.|42|예|  
|**TargetLoginSid**|**image**|로그인을 대상으로 하는 동작의 경우 대상 로그인의 SID(보안 ID)입니다.|43|예|  
