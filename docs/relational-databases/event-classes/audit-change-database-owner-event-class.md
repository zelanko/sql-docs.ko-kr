---
title: "Audit Change Database Owner 이벤트 클래스 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Change Database Owner 이벤트 클래스"
...
## Audit Change Database Owner 이벤트 클래스 데이터 열  
...
|**성공**|**int**|1 = 성공, 0 = 실패. 예를 들어 값 1은 사용 권한 확인이 성공했음을 의미하고, 값 0은 확인이 실패했음을 의미합니다.|23|예|  
