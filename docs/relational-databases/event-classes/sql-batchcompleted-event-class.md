...
|CPU|**ssNoversion**|일괄 처리에 사용된 CPU 시간(밀리초)입니다.|18|예|  
...
|Error|**ssNoversion**|이벤트의 오류 번호입니다.<br /><br /> 0=확인<br /><br /> 1=오류<br /><br /> 2=중단|31|예|  
|EventClass|**ssNoversion**|이벤트 유형 = 12|27|아니오|  
...
|Writes|**bigint**|일괄 처리로 인한 페이지 쓰기 I/O 수입니다.|17|예|  
