...
|----------------------|---------------|-----------------|---------------|----------------|  
|EventClass|**ssNoversion**|216|27|아니오|  
|SPID|**ssNoversion**|이 이벤트를 발생시키는 서버 프로세스의 ID입니다.|12|예|  
|EventSubClass|**ssNoversion**|사용자 정의 분류자 함수의 경우 1입니다.|21|예|  
...
|ObjectID|**ssNoversion**|사용자 정의 분류자 개체의 ID입니다.|22|예|  
|CPU|**ssNoversion**|CPU 사용량(밀리초)입니다.|18|예|  
|Reads|**ssNoversion**|논리적 읽기 수입니다.|16|예|  
|Writes|**ssNoversion**|논리적 쓰기 수입니다.|17|예|  
|GroupID|**ssNoversion**|분류된 작업 그룹의 ID입니다.|66|예|  
|Error|**ssNoversion**|사용자 정의 분류자 함수를 실행하지 못할 경우 마지막 오류 번호입니다.|31|예|  
|State|**ssNoversion**|마지막 오류의 상태입니다.|30|예|  
