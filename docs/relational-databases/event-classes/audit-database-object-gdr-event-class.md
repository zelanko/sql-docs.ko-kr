...
## <a name="audit-database-object-gdr-event-class-data-columns"></a>Audit Database Object GDR 이벤트 클래스 데이터 열  
...
|**EventClass**|**ssNoversion**|이벤트 유형 = 172|27|아니오|  
