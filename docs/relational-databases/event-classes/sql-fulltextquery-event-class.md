---
title: "SQL:FullTextQuery 이벤트 클래스 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## SQL:FullTextQuery 이벤트 클래스 데이터 열  
...
|기간|**bigint**|전체 텍스트 쿼리를 완료하는 데 걸린 시간입니다.|13|아니요|  
|EndTime|**datetime**|이벤트 종료 시간입니다.|15|예|  
|오류|**int**|오류 메시지 수입니다.|31|예|  
