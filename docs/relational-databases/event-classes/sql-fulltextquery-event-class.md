...
|EndTime|**datetime**|이벤트 종료 시간입니다.|15|사용자 계정 컨트롤|  
|Error|**int**|오류 메시지 수입니다.|31|사용자 계정 컨트롤|  
|EventClass|**int**|기록된 이벤트 유형 = 123|27|아니오|  
...
|IntegerData|**int**|반환된 행 수입니다. 쿼리가 오류를 반환하면 이 값은 NULL입니다. 쿼리가 행을 반환하지 않으면 이 값은 0입니다.|25|사용자 계정 컨트롤|  
...
|TextData|**nvarchar**|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]로 전달된 쿼리의 전체 텍스트 부분입니다.|@shouldalert|아니오|  
