...
## <a name="sqlfulltextquery-event-class-data-columns"></a>SQL:FullTextQuery 이벤트 클래스 데이터 열  
...
|DatabaseID|**ssNoversion**|USE *database* 문으로 지정한 데이터베이스 ID이거나 지정한 인스턴스에 대해 USE *database*문이 발급되지 않은 경우에 사용되는 기본 데이터베이스 ID입니다. [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] 에 ServerName 데이터 열이 추적에서 캡처되고 서버를 사용할 수 있으면 데이터베이스 이름이 표시됩니다. DB_ID 함수를 사용하여 데이터베이스의 값을 확인할 수 있습니다.|3|예|  
|DatabaseName|**nvarchar**|사용자 문이 실행되는 데이터베이스의 이름입니다.|35|예|  
|Duration|**bigint**|전체 텍스트 쿼리를 완료하는 데 걸린 시간입니다.|13|아니오|  
|EndTime|**datetime**|이벤트 종료 시간입니다.|15|예|  
|Error|**ssNoversion**|오류 메시지 수입니다.|31|예|  
|EventClass|**ssNoversion**|기록된 이벤트 유형 = 123|27|아니오|  
...
|IntegerData|**ssNoversion**|반환된 행 수입니다. 쿼리가 오류를 반환하면 이 값은 NULL입니다. 쿼리가 행을 반환하지 않으면 이 값은 0입니다.|25|예|  
...
|ObjectID|**ssNoversion**|시스템이 할당한 대상의 ID입니다.|22|예|  
|RequestID|**ssNoversion**|전체 텍스트 쿼리를 시작한 요청 ID입니다.|49|예|  
...
|TextData|**nvarchar**|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]로 전달된 쿼리의 전체 텍스트 부분입니다.|1|아니오|  
