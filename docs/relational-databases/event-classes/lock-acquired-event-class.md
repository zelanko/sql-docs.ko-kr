...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Lock:Acquiredevent 클래스는 데이터 페이지와 같은 리소스에 대한 잠금 획득이 이루어졌음을 나타냅니다.  
...
|기간|**bigint**|잠금 요청을 실행한 시간과 잠금을 획득한 시간 사이의 경과 시간(밀리초)입니다.|13|예|  
