...
|EventClass|**int**|이벤트 유형 = 55|27|아니오|  
|EventSequence|**int**|요청 내에 지정된 이벤트 시퀀스입니다.|51|아니오|  
|EventSubClass|**int**|이벤트 하위 클래스의 유형입니다.<br /><br /> 0=재귀<br /><br /> 1=한도 초과|21|사용자 계정 컨트롤|  
...
|IntegerData|**int**|재귀 수준입니다(해시 재귀만 해당).|25|사용자 계정 컨트롤|  
...
|ObjectID|**int**|재분할에 관련된 해시 팀의 루트 노드 ID입니다. 실행 계획의 노드 ID와 일치합니다.|22|사용자 계정 컨트롤|  
