---
description: Hash Warning 이벤트 클래스
...
|LoginName|**nvarchar**|사용자 로그인 이름입니다( *\<DOMAIN>\\<username\>* 형식의 Windows 로그인 자격 증명 또는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 보안 로그인).|11|예|  
