...
|EventClass|**ssNoversion**|캡처된 이벤트 클래스 유형입니다. Broker:Forwarded Message Sent의 경우 항상 139입니다.|27|아니오|  
...
|ObjectId|**ssNoversion**|메시지가 전달될 때 전달되는 메시지에 대한 시간 제한 값입니다.|22|아니오|  
...
|성공|**ssNoversion**|전달 프로세스 동안 사용된 시간입니다.|23|아니오|  
