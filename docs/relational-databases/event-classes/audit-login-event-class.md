...
|**BinaryData**|**image**|ANSI Null, ANSI 패딩, 커밋 시 커서 닫기, Null 연결 및 따옴표 붙은 식별자를 포함한 세션 수준 설정입니다.|2|사용자 계정 컨트롤|  
...
|**EventClass**|**int**|이벤트 유형 = 14|27|아니오|  
...
|**IntegerData**|**int**|사용된 네트워크 패킷 크기입니다.|25|사용자 계정 컨트롤|  
