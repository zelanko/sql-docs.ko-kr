---
description: Audit Schema Object GDR 이벤트 클래스
...
|**권한**|**bigint**|확인한 사용 권한의 유형을 나타내는 정수 값입니다.<br /><br /> 1=SELECT ALL<br /><br /> 2=UPDATE ALL<br /><br /> 4=REFERENCES ALL<br /><br /> 8=INSERT<br /><br /> 16=DELETE<br /><br /> 32=EXECUTE(프로시저에만 해당)<br /><br /> 4096=SELECT ANY(하나 이상의 열)<br /><br /> 8192=UPDATE ANY<br /><br /> 16384=REFERENCES ANY|19|예|  
