...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Missing Column Statistics 이벤트 클래스는 최적화 프로그램에 유용한 열 통계가 사용할 수 없는 상태임을 나타냅니다.  
...
|EventClass|**int**|이벤트 유형=79|27|아니요|  
...
|TextData|**ntext**|누락된 통계가 있는 열의 목록입니다.|1|예|  
...
## <a name="see-also"></a>참고 항목  
 ...
 [이벤트 모니터링 및 응답](http://msdn.microsoft.com/library/f7fbe155-5b68-4777-bc71-a47637471f32)  
