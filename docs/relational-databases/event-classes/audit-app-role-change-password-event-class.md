...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] **Audit App Role Change Password** 이벤트 클래스는 응용 프로그램 역할에 대한 암호가 변경될 때마다 발생합니다.  
...
|**DatabaseName**|**nvarchar**|응용 프로그램의 역할이 수정되는 데이터베이스 이름입니다.|35|예|  
...
|**RoleName**|**nvarchar**|응용 프로그램 역할의 이름입니다.|38|예|  
