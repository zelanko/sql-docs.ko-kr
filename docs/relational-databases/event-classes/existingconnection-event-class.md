...
|EventClass|**int**|이벤트 유형 = 17|27|아니오|  
|EventSequence|**int**|해당 추적에서 해당 이벤트의 시퀀스입니다.|51|아니오|  
...
|TextData|**ntext**|해당 연결에 대한 집합 옵션입니다.|@shouldalert|사용자 계정 컨트롤|  
