...
|EventClass|**ssNoversion**|이벤트 유형 = 38|27|아니오|  
|EventSequence|**ssNoversion**|요청 내의 지정된 이벤트 시퀀스입니다.|51|아니오|  
|EventSubClass|**ssNoversion**|1=Execution Context Hit: 계획 캐시에 사용 가능한 실행 계획이 있습니다.<br /><br /> 2=Compplan Hit: 계획 캐시에 컴파일된 계획이 있습니다.|21|예|  
...
|ObjectID|**ssNoversion**|캐시에서 발견된 시스템이 할당한 저장 프로시저의 ID입니다.|22|예|  
