...
|**CPU**|**int**|연결하는 동안 사용자가 사용한 CPU 시간(밀리초)입니다.|18|사용자 계정 컨트롤|  
...
|**기간**|**bigint**|대략적으로 사용자가 로그인한 이후 경과 시간입니다.|13|사용자 계정 컨트롤|  
|**EndTime**|**datetime**|로그아웃 종료 시간입니다.|15|사용자 계정 컨트롤|  
...
|**Reads**|**bigint**|연결하는 동안 사용자가 실행한 논리적 읽기 I/O 수입니다.|16|사용자 계정 컨트롤|  
...
|**Writes**|**bigint**|연결하는 동안 사용자가 실행한 논리적 쓰기 I/O 수입니다.|17|사용자 계정 컨트롤|  
