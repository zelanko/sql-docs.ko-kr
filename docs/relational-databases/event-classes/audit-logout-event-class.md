...
description: Audit Logout 이벤트 클래스는 사용자가 SQL Server에서 로그아웃했음을 나타냅니다. 이 문서에서는 Audit Logout 이벤트 클래스 데이터 열에 대해 설명합니다.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
|**Duration**|**bigint**|대략적으로 사용자가 로그인한 이후 경과 시간입니다.|13|예|  
