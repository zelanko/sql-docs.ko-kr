...
|**CPU**|**ssNoversion**|연결하는 동안 사용자가 사용한 CPU 시간(밀리초)입니다.|18|예|  
...
|**EventClass**|**ssNoversion**|이벤트 유형 = 15|27|아니오|  
|**EventSequence**|**ssNoversion**|요청 내의 지정된 이벤트 시퀀스입니다.|51|아니오|  
|**EventSubClass**|**ssNoversion**|로그인에 사용된 연결의 유형입니다. 1 = 풀링 안 됨, 2 = 풀링됨|21|예|  
...
|**StartTime**|**datetime**|사용 가능한 경우 관련 Audit Login 이벤트의 StartTime입니다.|14|예|  
