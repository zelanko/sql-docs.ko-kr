...
|----------------------|---------------|-----------------|---------------|----------------|  
|**ApplicationName**|**nvarchar**|로드를 요청한 응용 프로그램의 이름입니다.|10|사용자 계정 컨트롤|  
...
|**TextData**|**ntext**|로드가 성공한 경우 "Assembly Load Succeeded" 그렇지 않으면 "Assembly Load Failed"입니다.|@shouldalert|사용자 계정 컨트롤|  
