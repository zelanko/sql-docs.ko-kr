---
title: "CLR 이벤트 범주 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "이벤트 클래스 [SQL Server], CLR 이벤트 범주"
  - "SQL Server 이벤트 클래스, CLR 이벤트 범주"
  - "CLR 이벤트 범주 [SQL Server]"
...
## Assembly Load 이벤트 클래스 데이터 열  
  
|데이터 열 이름|데이터 형식|설명|열 ID|필터 가능|  
|----------------------|---------------|-----------------|---------------|----------------|  
|**ApplicationName**|**nvarchar**|로드를 요청한 응용 프로그램의 이름입니다.|10|예|  
...
|**성공**|**int**|어셈블리 로드의 성공(1) 또는 실패(0) 여부를 나타냅니다.|23|예|  
