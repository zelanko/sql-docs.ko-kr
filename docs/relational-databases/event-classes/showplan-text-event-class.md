...
|Event Class|**ssNoversion**|이벤트 유형 = 96|27|아니오|  
...
|Login SID|**bitmap**|로그인한 사용자의 SID(보안 ID)입니다. 이 정보는 sys.server_principals 카탈로그 뷰에 있습니다. 각 SID는 서버의 각 로그인마다 고유합니다.|41|아니오|  
