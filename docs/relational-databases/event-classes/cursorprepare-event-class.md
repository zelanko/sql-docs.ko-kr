...
|**EventClass**|**ssNoversion**|기록된 이벤트 유형 = 70|27|아니오|  
|**EventSequence**|**ssNoversion**|일괄 처리 내에서 **CursorPrepare** 이벤트 클래스의 순서입니다.|51|아니오|  
|**GroupID**|**ssNoversion**|SQL 추적 이벤트가 발생한 작업 그룹의 ID입니다.|66|예|  
|**Handle**|**ssNoversion**|이벤트 클래스의 핸들입니다.|33|예|  
...
|**RequestID**|**ssNoversion**|커서를 준비한 요청 ID입니다.|49|예|  
