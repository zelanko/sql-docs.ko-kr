...
|**EventClass**|**ssNoversion**|캡처된 이벤트 클래스 유형입니다. **Broker:Corrupted Message** 의 경우 항상 **161**입니다.|27|아니오|  
...
|**IntegerData**|**ssNoversion**|이 메시지의 조각 번호입니다.|25|예|  
...
|**Severity**|**ssNoversion**|오류로 인해 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 가 메시지를 삭제한 경우 오류의 심각도입니다.|29|아니오|  
