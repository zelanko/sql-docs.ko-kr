...
|**FileName**|**nvarchar**|원격 끝점의 네트워크 주소입니다.|36|아니오|  
...
|**RoleName**|**nvarchar**|이 메시지를 수신하는 끝점의 역할입니다. 다음 값 중 하나일 수 있습니다.<br /><br /> **시작자**: 수신 끝점이 대화의 시작자입니다.<br /><br /> **대상**: 수신 끝점이 대화의 대상입니다.|38|아니오|  
...
|**TextData**|**ntext**|발견된 손상에 대한 설명입니다.|@shouldalert|사용자 계정 컨트롤|  
