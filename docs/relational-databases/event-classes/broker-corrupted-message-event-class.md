...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]는 Service Broker가 손상된 메시지를 수신할 때 **Broker:Corrupted Message** 이벤트를 발생시킵니다.  
...
|**EventClass**|**int**|캡처된 이벤트 클래스 유형입니다. **Broker:Corrupted Message** 의 경우 항상 **161**입니다.|27|아니요|  
|**EventSequence**|**int**|이 이벤트의 시퀀스 번호입니다.|51|아니요|  
|**FileName**|**nvarchar**|원격 끝점의 네트워크 주소입니다.|36|아니요|  
|**GUID**|**uniqueidentifier**|손상된 메시지가 속하는 대화의 대화 ID입니다. 이 식별자는 메시지의 일부로 전송되며 양쪽 대화 상대 간에 공유합니다.|54|아니요|  
...
|**RoleName**|**nvarchar**|이 메시지를 수신하는 끝점의 역할입니다. 다음 값 중 하나일 수 있습니다.<br /><br /> **시작자**: 수신 끝점이 대화의 시작자입니다.<br /><br /> **대상**: 수신 끝점이 대화의 대상입니다.|38|아니요|  
