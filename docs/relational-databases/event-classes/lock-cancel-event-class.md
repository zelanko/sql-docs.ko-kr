...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] **Lock:Cancel** 이벤트 클래스는 쿼리 취소 등의 원인으로 리소스에 대한 잠금 획득이 취소되었음을 나타냅니다.  
...
|**ObjectID**|**int**|잠금이 취소된 개체의 ID입니다(사용 및 적용 가능한 경우).|22|예|  
