...
|**EventSubClass**|**int**|잠금 에스컬레이션의 원인:<br /><br /> **0 - LOCK_THRESHOLD** 는 문이 잠금 임계값을 초과했음을 나타냅니다.<br /><br /> **1 - MEMORY_THRESHOLD** 는 문이 메모리 임계값을 초과했음을 나타냅니다.|21|yes|  
...
|**LineNumber**|**int**|[!INCLUDE[tsql](../../includes/tsql-md.md)] 문의 줄 수입니다.|5|yes|  
...
|**Exchange Spill**|**int**|잠금 에스컬레이션이 트리거된 테이블의 시스템 할당 ID입니다.|22|yes|  
