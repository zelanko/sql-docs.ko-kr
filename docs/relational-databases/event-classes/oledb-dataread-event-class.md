...
|EventClass|**ssNoversion**|이벤트 유형 = 121|27|아니오|  
|EventSequence|**ssNoversion**|일괄 처리 내의 OLE DB 이벤트 클래스 시퀀스입니다.|51|아니오|  
|EventSubClass|**ssNoversion**|이벤트 하위 클래스의 유형입니다.<br /><br /> 0=시작<br /><br /> 1=완료|21|아니오|  
