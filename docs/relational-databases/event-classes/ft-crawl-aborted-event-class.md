---
title: "FT:Crawl Aborted 이벤트 클래스 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## FT:Crawl Aborted 이벤트 클래스 데이터 열  
...
|**ObjectID**|**int**|오류가 발생했을 때 전체 텍스트 탐색이 실행되는 개체의 시스템 할당 ID입니다.|22|예|  
