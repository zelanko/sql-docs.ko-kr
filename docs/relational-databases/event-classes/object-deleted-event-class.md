...
|EventClass|**ssNoversion**|이벤트 유형 = 47|27|아니오|  
|EventSequence|**ssNoversion**|요청 내에 지정된 이벤트 시퀀스입니다.|51|아니오|  
|EventSubClass|**ssNoversion**|이벤트 하위 클래스의 유형입니다.<br /><br /> 0=시작<br /><br /> 1=커밋<br /><br /> 2=롤백|21|예|  
...
|IndexID|**ssNoversion**|이벤트에 의해 영향 받는 개체의 인덱스 ID입니다. 개체의 인덱스 ID를 확인하려면 sys.indexes 카탈로그 뷰의 index_id 열을 사용합니다.|24|예|  
