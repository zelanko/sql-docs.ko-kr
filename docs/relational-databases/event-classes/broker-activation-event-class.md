...
|**EventClass**|**int**|캡처된 이벤트 클래스 유형입니다. **Broker:Activation** 의 경우 항상 **163**입니다.|27|아니오|  
|**EventSequence**|**int**|이 이벤트의 시퀀스 번호입니다.|51|아니오|  
|**EventSubClass**|**nvarchar**|이 이벤트가 보고하는 특정 동작입니다. 다음 값 중 하나입니다.<br /><br /> **시작**:   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 가 활성화 저장 프로시저를 시작했습니다.<br /><br /> **종료**: 활성화 저장 프로시저가 정상적으로 종료되었습니다.<br /><br /> **중단**: 활성화 저장 프로시저가 오류로 인해 종료되었습니다.|21|아니오|  
...
|**IntegerData**|**int**|이 큐에 활성화된 태스크의 개수입니다.|25|아니오|  
...
|**Exchange Spill**|**int**|이 이벤트와 연결된 큐입니다.|22|아니오|  
