...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] **Audit Login Failed** 이벤트 클래스는 사용자가 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]에 로그인하려고 시도했으나 실패했음을 나타냅니다. 이 이벤트 클래스는 연결 풀에서 다시 사용된 연결 또는 새 연결에 의해 발생합니다.  
...
|**EventClass**|**int**|이벤트 유형 = 20|27|아니요|  
...
|**성공**|**int**|1 = 성공, 0 = 실패. 이 이벤트는 항상 실패를 표시합니다.|23|예|  
