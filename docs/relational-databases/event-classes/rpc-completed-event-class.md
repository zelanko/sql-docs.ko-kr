...
|CPU|**ssNoversion**|이벤트에서 사용한 CPU 시간입니다. [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]부터 마이크로초 단위입니다. 이전 버전에서는 밀리초 단위입니다.|18|예|  
...
|Error|**ssNoversion**|지정된 이벤트의 오류 번호입니다.<br /><br /> 0=확인<br /><br /> 1=오류<br /><br /> 2=중단<br /><br /> 3=건너뜀|31|예|  
|EventClass|**ssNoversion**|이벤트 유형 = 10|27|아니오|  
