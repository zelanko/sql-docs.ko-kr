...
|*plNativeError*|사용 가능한 경우 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]master.dbo.sysmessages**의**  오류 번호를 반환합니다. 네이티브 오류는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 공급자 데이터 원본을 성공적으로 초기화 한 후에 사용할 수 있습니다. 시도 전에 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 공급자는 항상 0을 반환 합니다.|  
