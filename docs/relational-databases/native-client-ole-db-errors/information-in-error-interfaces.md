...
|**GetCustomErrorObject**|인터페이스에 대 한 참조를 반환 **ISQLErrorInfo 합니다** 하 고 [ISQLServerErrorInfo](http://msdn.microsoft.com/library/a8323b5c-686a-4235-a8d2-bda43617b3a1)합니다.|  
|**GetErrorInfo**|에 대 한 참조를 반환 합니다는 **IErrorInfo** 인터페이스입니다.|  
...
|*과 같습니다*|반환 된 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 오류 번호가 **master.dbo.sysmessages** 사용 가능한 경우. 원시 오류를 성공적으로 초기화 한 후 사용할 수는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 공급자 데이터 원본입니다. 전에 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 공급자는 항상 0을 반환 합니다.|  
