---
title: 인출할 행 집합 및 업데이트 (ODBC) | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
2.  호출 [SQLFetch](http://go.microsoft.com/fwlink/?LinkId=58401) 하거나 [SQLFetchScroll](../../../relational-databases/native-client-odbc-api/sqlfetchscroll.md) 행 집합을 가져오려고 합니다.  
...
3.  바인딩된 열이 사용된 경우 행 집합의 바인딩된 열 버퍼에 있는 데이터 값과 데이터 길이를 사용합니다.  
    ...
    -   호출 [SQLGetData](../../../relational-databases/native-client-odbc-api/sqlgetdata.md) 마지막 행 집합의 열을 바인딩한 후 한 번 이상에 대 한 데이터를 가져올 바인딩되지 않은 열입니다. 에 대 한 호출 [SQLGetData](../../../relational-databases/native-client-odbc-api/sqlgetdata.md) 열 번호를 증가 하는 순서에 있어야 합니다.  
...
6.  커서 이름을 지정 하는 위치 지정된 UPDATE 또는 DELETE 문의 필요에 따라 실행 (에서 사용할 수 있습니다 [SQLGetCursorName](../../../relational-databases/native-client-odbc-api/sqlgetcursorname.md)) 및 동일한 연결에서 다른 문 핸들을 사용 합니다.  
