...
ms.locfileid: "32946018"
---
# <a name="managing-text-and-image-columns---use-data-at-execution-columns"></a>Text 및 image 열-사용 데이터 실행 시 열 관리
...
1.  각 실행 시 데이터 열에 대해 이전에 [SQLBindCol](../../relational-databases/native-client-odbc-api/sqlbindcol.md)에서 바인딩된 버퍼에 특수 값을 배치합니다.  
...
3.  각 실행 시 데이터 열에 대해 다음을 수행합니다.  
    ...
    -   [SQLPutData](../../relational-databases/native-client-odbc-api/sqlputdata.md) 를 한 번 이상 호출하여 길이가 전달될 때까지 열 데이터를 보냅니다.  
