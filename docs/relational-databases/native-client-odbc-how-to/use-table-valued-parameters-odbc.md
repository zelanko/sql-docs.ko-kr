---
description: 테이블 반환 매개 변수 사용(ODBC)
title: Table-Valued 매개 변수 사용 (ODBC) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
