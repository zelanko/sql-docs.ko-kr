---
title: 선택 결과 세트(ODBC) 대량 복사 | 마이크로 소프트 문서
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
5.  [bcp_control](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-control.md)호출하고 eOption을 BCPHINTS로 설정하고 select 문을 포함하는 SQLTCHAR 배열에 대한 포인터를 iValue에 배치합니다.  
  
6.  [bcp_exec](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-exec.md) 를 호출하여 대량 복사 작업을 실행합니다.  

 이러한 단계를 사용하면 기본 형식으로 파일이 만들어집니다. bcp_colfmt 을 [사용하여](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-colfmt.md)데이터 값을 다른 데이터 유형으로 변환할 수 있습니다. 자세한 내용은 ODBC&#41;&#40;[대량 복사 형식 파일 만들기를 ](../../../relational-databases/native-client-odbc-how-to/bulk-copy/create-a-bulk-copy-format-file-odbc.md)참조하십시오.  
