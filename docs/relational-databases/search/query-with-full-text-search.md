...
**추가 옵션** LIKE와 BETWEEN 등의 다른 [!INCLUDE[tsql](../../includes/tsql-md.md)] 조건자와 이 조건자를 결합할 수 있습니다.
...
검색 조건(이 경우 "학습 곡선")은 복잡할 수 있으며 하나 이상의 단어로 구성될 수 있습니다.
