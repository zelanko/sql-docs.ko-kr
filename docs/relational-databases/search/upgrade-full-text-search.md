...
-   전체 텍스트 카탈로그가 오프라인 상태이면 백업이 실패합니다.  
 ...
 [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] 전체 텍스트 카탈로그 백업 및 복원에 대한 자세한 내용은 [온라인 설명서에서](http://go.microsoft.com/fwlink/?LinkId=121052) 전체 텍스트 카탈로그 백업 및 복원 [및](http://go.microsoft.com/fwlink/?LinkId=121053)파일 백업과 복원 및 전체 텍스트 카탈로그 [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] 를 참조하세요.  
