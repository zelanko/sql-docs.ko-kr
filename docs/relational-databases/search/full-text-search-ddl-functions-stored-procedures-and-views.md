---
description: 전체 텍스트 검색 DDL, 함수, 저장 프로시저 및 뷰
...
[!INCLUDE [SQL Server Azure SQL Database](../../includes/applies-to-version/sql-asdb.md)]
 ...
 의미 체계 검색을 지원하는 데이터베이스 개체 목록은 [의미 체계 검색 DDL, 함수, 저장 프로시저 및 뷰](../../relational-databases/search/semantic-search-ddl-functions-stored-procedures-and-views.md)를 참조하세요.  
