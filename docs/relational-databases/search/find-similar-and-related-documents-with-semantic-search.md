---
title: "의미 체계 검색을 사용하여 유사하거나 관련된 문서 찾기 | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
##  <a name="BasicsQuerySimilar"></a> 유사하거나 관련된 문서 찾기  
  
###  <a name="HowToQuerySimilar"></a> 방법: SEMANTICSIMILARITYTABLE을 사용하여 유사하거나 관련된 문서 찾기  
...
##  <a name="BasicsQuerySimilarity"></a> 문서가 유사하거나 연관된 정도에 대한 정보 찾기  
  
###  <a name="HowToQuerySimilarity"></a> 방법: SEMANTICSIMILARITYDETAILSTABLE을 사용하여 문서가 유사하거나 연관된 정도에 대한 정보 찾기  
