---
title: "전체 텍스트 검색 | Microsoft Docs"
ms.custom: ""
ms.date: "07/29/2016"
...
> **참고** 전체 텍스트 검색은 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 데이터베이스 엔진의 선택적 구성 요소입니다. 자세한 내용은 [SQL Server 2016 설치](../../database-engine/install-windows/install-sql-server-2016.md)를 참조하세요.  
...
##  <a name="architecture"></a> 구성 요소 및 아키텍처  
...
-   **전체 텍스트 쿼리 쓰기**  
    ...
    -   [NEAR를 사용하여 근접 단어 검색](../../relational-databases/search/search-for-words-close-to-another-word-with-near.md)  
  
    -   [RANK를 사용하여 검색 결과 제한](../../relational-databases/search/limit-search-results-with-rank.md)  
...
-   **카탈로그 및 인덱스 관리**  
    ...
    -   [전체 텍스트 인덱스 관리](../Topic/Manage%20Full-Text%20Indexes.md)  
...
-   **언어 구성 요소 관리**  
    ...
    -   [등록된 필터와 단어 분리기 보기 및 변경](../../relational-databases/search/view-or-change-registered-filters-and-word-breakers.md)  
    ...
    -   [사용자 지정 사전을 사용하여 단어 분리기의 동작 사용자 지정](../../relational-databases/search/customize-the-behavior-of-word-breakers-with-a-custom-dictionary.md)  
...
-   [전체 텍스트 검색 업그레이드](../../relational-databases/search/upgrade-full-text-search.md)전체 텍스트 검색 업그레이드  
  
##  <a name="relcontent"></a> 관련 내용  
  
-   [전체 텍스트 검색 DDL, 함수, 저장 프로시저 및 뷰](../../relational-databases/search/full-text-search-ddl-functions-stored-procedures-and-views.md)  
