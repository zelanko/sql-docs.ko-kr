---
title: "전체 텍스트 필터 데몬 시작 관리자 서비스 계정 설정 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "전체 텍스트 검색 [SQL Server], FDHOST Launcher(MSSQLFDLauncher) 서비스 계정"
...
-   [SQL 전체 텍스트 필터 데몬 시작 관리자 서비스가 시작되지 않는 경우](#error)  
  
##  <a name="setting"></a> 서비스 계정 설정  
  
#### 전체 텍스트 검색용 SQL 전체 텍스트 필터 데몬 시작 관리자 서비스 계정을 설정하려면  
...
##  <a name="error"></a> SQL 전체 텍스트 필터 데몬 시작 관리자 서비스가 시작되지 않는 경우  
