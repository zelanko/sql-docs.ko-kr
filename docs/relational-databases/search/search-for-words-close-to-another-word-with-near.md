---
title: "NEAR를 사용하여 근접 단어 검색 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "구 검색 [전체 텍스트 검색]"
  - "근접 단어 검색 [전체 텍스트 검색]"
  - "전체 텍스트 검색 [SQL Server], 근접 검색"
  - "전체 텍스트 쿼리 [SQL Server], 근접"
  - "쿼리 [전체 텍스트 검색], 근접"
...
---
# NEAR를 사용하여 근접 단어 검색
  [CONTAINS](../../t-sql/queries/contains-transact-sql.md) 조건자 또는 [CONTAINSTABLE](../../relational-databases/system-functions/containstable-transact-sql.md) 함수에서 근접 단어(NEAR)를 사용하여 단어나 구를 검색할 수 있습니다. 첫 번째 검색 단어와 마지막 검색 단어를 분리하는 검색 대상이 아닌 단어의 최대 수를 지정할 수도 있습니다. 또한 단어나 구를 순서에 관계 없이 검색하거나 지정한 순서로 검색할 수 있습니다. [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 에서는 이제는 사용되지 않는 [일반 근접 단어](#Generic_NEAR)및 [에 새로 도입된](#Custom_NEAR)사용자 지정 근접 단어 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]를 모두 지원합니다.  
...
> [!NOTE]  
>  <custom_proximity_term> 구문에 대한 자세한 내용은 [CONTAINS&#40;Transact-SQL&#41;](../../t-sql/queries/contains-transact-sql.md)를 참조하세요.  
...
##  <a name="Additional_Considerations"></a> 근접 검색에 대한 추가 고려 사항  
...
##  <a name="Generic_NEAR"></a> 사용되지 않는 일반 근접 단어  
...
> [!NOTE]  
>  <generic_proximity_term> 구문에 대한 자세한 내용은 [CONTAINS&#40;Transact-SQL&#41;](../../t-sql/queries/contains-transact-sql.md)를 참조하세요.  
