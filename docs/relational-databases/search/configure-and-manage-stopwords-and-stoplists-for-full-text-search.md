---
title: "전체 텍스트 검색에 사용할 중지 단어와 중지 목록 구성 및 관리 | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
helpviewer_keywords: 
  - "중지 목록 [전체 텍스트 검색]"
  - "전체 텍스트 검색 [SQL Server], 중지 목록"
  - "전체 텍스트 검색 [SQL Server], 의미 없는 단어"
  - "의미 없는 단어 [전체 텍스트 검색]"
  - "전체 텍스트 검색 [SQL Server], 중지 단어"
  - "중지 단어 [전체 텍스트 검색]"
...
7.  다음 중지 목록 생성 옵션 중 하나를 선택합니다.  
    ...
    -   **기존 전체 텍스트 중지 목록에서 만들기**  
     ...
     자세한 내용은 [새 전체 텍스트 중지 목록&#40;일반 페이지&#41;](../Topic/New%20Full-Text%20Stoplist%20\(General%20Page\).md)을 참조하세요.  
...
##  <a name="viewing"></a> 중지 목록 및 중지 목록 메타데이터 보기  
...
5.  [전체 텍스트 중지 목록 속성](../Topic/Full-Text%20Stoplist%20Properties.md) 대화 상자에서 다음을 수행합니다.  
