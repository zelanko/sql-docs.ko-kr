...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
 ...
 다음 커서 트랜잭션 격리 수준은 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client ODBC 드라이버에서 지원 됩니다.  
...
-   스냅샷(SQL_TXN_SS_SNAPSHOT)  
 ...
 ODBC API는 추가 트랜잭션 격리 수준을 지정 하지만 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 또는 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client ODBC 드라이버에서는 지원 되지 않습니다.  
