...
ms.locfileid: "81305395"
---
# <a name="using-server-cursors"></a>서버 커서 사용
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

  ODBC 응용 프로그램이 ODBC 커서 특성을 기본값 이외의 다른 항목으로 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 설정하는 경우 네이티브 클라이언트 ODBC 드라이버는 동일한 형식의 API 서버 커서를 구현하도록 서버를 요청합니다. API 서버 커서가 사용되면 클라이언트의 메모리가 확보되고 클라이언트와 서버 간의 네트워크 트래픽이 줄어들 수 있습니다.  
