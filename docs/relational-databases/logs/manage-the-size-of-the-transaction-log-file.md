...
description: SQL Server 트랜잭션 로그 크기를 모니터링하고, 로그를 축소하고, 로그를 확장하고, tempdb 로그 증가 속도를 최적화하고, 트랜잭션 로그 증가를 제어하는 방법을 알아봅니다.
ms.custom: ''
ms.date: 01/05/2018
ms.prod: sql
...
##  <a name="shrink-log-file-size"></a><a name="ShrinkSize"></a> 로그 파일 크기 축소  
...
##  <a name="optimize-tempdb-transaction-log-size"></a><a name="tempdbOptimize"></a> tempdb 트랜잭션 로그 크기 최적화  
...
##  <a name="control-transaction-log-file-growth"></a><a name="ControlGrowth"></a> 트랜잭션 로그 파일 증가 제어  
