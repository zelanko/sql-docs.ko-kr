---
title: "꽉 찬 트랜잭션 로그 문제 해결(SQL Server 오류 9002) | Microsoft Docs"
ms.custom: ""
ms.date: "08/05/2016"
...
helpviewer_keywords: 
  - "로그 [SQL Server], 전체"
  - "문제 해결[SQL Server], 전체 트랜잭션 로그"
  - "9002(데이터베이스 엔진 오류)"
  - "트랜잭션 로그 [SQL Server], 잘림"
  - "트랜잭션 로그 백업 [SQL Server], 전체 로그"
  - "트랜잭션 로그 [SQL Server], 전체 로그"
  - "전체 트랜잭션 로그 [SQL Server]"
