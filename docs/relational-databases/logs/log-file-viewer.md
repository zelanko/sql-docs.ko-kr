...
description: SQL Server Management Studio의 로그 파일 뷰어를 사용하여 로그 파일에 캡처되는 오류 및 이벤트에 대한 자세한 내용을 확인할 수 있습니다.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
|태스크 설명|항목|  
|----------------------|-----------|  
|보려는 정보에 따라 로그 파일 뷰어를 여는 방법에 대해 설명합니다.|[로그 파일 뷰어 열기](../../relational-databases/logs/open-log-file-viewer.md)|  
|등록된 서버를 통해 오프라인 로그 파일을 보는 방법과 WMI 사용 권한을 확인하는 방법에 대해 설명합니다.|[오프라인 로그 파일 보기](../../relational-databases/logs/view-offline-log-files.md)|  
|로그 파일 뷰어 F1 도움말을 제공합니다.|[로그 파일 뷰어 F1 도움말](../../relational-databases/logs/log-file-viewer-f1-help.md)|  
