...
description: SQL Server CLR 프로그래밍은 HostProtectionResource 열거형에 대해 특정 값을 가진 형식 또는 멤버를 허용 하지 않습니다. 이 문서에서는 System.object의 허용 되지 않는 값을 나열 합니다.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
