...
ms.openlocfilehash: 2ac318f953f9d14d74d6c11a7c8b85ab12c6cd66
...
|이벤트 원본|MSSQLSERVER|  
|구성 요소|SQLEngine|  
|심볼 이름|HK_UNSUPPORTED_NULLABLE_COLUMNS|  
|메시지 텍스트|인덱스 키의 Null 허용 열은 '*construct*'에서 지원되지 않습니다.|  
  
## <a name="user-action"></a>사용자 동작  
인덱스 키에 Null 허용 열을 사용하지 마십시오.  
