...
[!INCLUDE[SNAC_Deprecated](../../includes/snac-deprecated.md)]
 ...
 ODBC 함수는 데이터를 프로그램 변수에 안팎으로 같은 이동 다루는 **SQLGetData**를 **SQLBindCol**, 및 [SQLBindParameter](../../relational-databases/native-client-odbc-api/sqlbindparameter.md), 암시적 데이터 형식 지원 변환 합니다. 예를 들어 애플리케이션이 정수 열을 문자열 프로그램 변수에 바인딩할 경우 드라이버는 해당 데이터를 자동으로 정수에서 문자로 변환한 후 이를 프로그램 변수에 전달합니다.  
