...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
 ...
 AutoTranslate를 "예"로 설정 하면 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client ODBC 드라이버는 유니코드를 사용 하 여 클라이언트의 SQL_C_CHAR 변수 및 **CHAR**, **varchar**또는 **text** 열, 변수 또는 매개 변수 간에 이동 되는 데이터를 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 데이터  
  
-   클라이언트의 SQL_C_CHAR 변수에서 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 데이터베이스의 **CHAR**, **varchar**또는 **text** 열, 변수 또는 매개 변수로 데이터가 전송 될 때 ODBC 드라이버는 먼저 클라이언트의 ACP를 사용 하 여 SQL_C_CHAR에서 유니코드로 변환 합니다. 그런 다음 서버의 ACP를 사용 하 여 유니코드에서 문자로 다시 이동 합니다.  
  
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 데이터베이스의 **char**, **varchar**또는 **text** 열, 변수 또는 매개 변수에서 클라이언트의 SQL_C_CHAR 변수로 데이터를 전송 하는 경우 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] NATIVE client ODBC 드라이버는 먼저 ACP를 사용 하 여 문자에서 유니코드로 변환 합니다. 그런 다음 유니코드에서 클라이언트의 ACP를 사용 하 여 SQL_C_CHAR으로 다시 이동 합니다.  
