...
-   RAISERROR  
 ...
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client ODBC 드라이버는 심각도가 11 이상인 RAISERROR에 SQL_ERROR을 반환 합니다. RAISERROR의 심각도가 19이면 연결도 삭제됩니다.  
...
-   [결과 집합 &#40;ODBC의 특성 확인&#41;](../../relational-databases/native-client-odbc-results/determining-the-characteristics-of-a-result-set-odbc.md)  
