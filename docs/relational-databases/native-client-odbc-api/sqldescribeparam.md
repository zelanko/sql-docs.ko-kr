...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
  ...
  SQL 문의 매개 변수를 설명 하기 위해 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client ODBC 드라이버는 준비 된 ODBC 문 핸들에 대해 SQLDescribeParam가 호출 될 때 [!INCLUDE[tsql](../../includes/tsql-md.md)] SELECT 문을 작성 하 고 실행 합니다. 결과 집합의 메타데이터에 따라 준비된 문의 매개 변수 특징이 결정됩니다. SQLDescribeParam는 SQLExecute 또는 SQLExecDirect에서 반환할 수 있는 오류 코드를 반환할 수 있습니다.  
...
-   SQLExecDirect 이후 FROM 절이 포함 된 [!INCLUDE[tsql](../../includes/tsql-md.md)] UPDATE 또는 DELETE 문에 대해  
...
-   [!INCLUDE[tsql](../../includes/tsql-md.md)] 명령에 주석 (/* \*/)이 있는 경우  
...
## <a name="sqldescribeparam-and-table-valued-parameters"></a>SQLDescribeParam와 테이블 반환 매개 변수  
 ...
 일반적으로 테이블 반환 매개 변수에 대 한 자세한 내용은 [테이블 반환 매개 &#40;변수 ODBC&#41;](../../relational-databases/native-client-odbc-table-valued-parameters/table-valued-parameters-odbc.md)를 참조 하세요.  
