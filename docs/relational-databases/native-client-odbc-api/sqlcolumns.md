 ...
 **Sqlcolumns** 는 크기가 높은 CLR udt (사용자 정의 형식)를 지원 합니다. 자세한 내용은 [ODBC &#40;&#41;의 Large CLR 사용자 정의 형식](../../relational-databases/native-client/odbc/large-clr-user-defined-types-odbc.md)을 참조 하세요.  
  
## <a name="sqlcolumns-support-for-sparse-columns"></a>스파스 열에 대한 SQLColumns 지원  
 SQLColumns의 결과 집합에 두 개의 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 특정 열이 추가 되었습니다.  
...
|SS_IS_COLUMN_SET|**Smallint**|열이 **column_set** 열인 경우 SQL_TRUE입니다. 그렇지 않으면 SQL_FALSE 합니다.|  
 ...
 ODBC 사양에 따라 SS_IS_SPARSE 및 SS_IS_COLUMN_SET는 [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)]이전 버전 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]에 추가 된 모든 드라이버 관련 열 앞에, 그리고 ODBC 자체에 의해 지정 된 모든 열 뒤에 표시 됩니다.  
 ...
 ODBC의 스파스 열에 대 한 자세한 내용은 [스파스 열에서 Odbc &#40;&#41;지원](../../relational-databases/native-client/odbc/sparse-columns-support-odbc.md)을 참조 하세요.  
