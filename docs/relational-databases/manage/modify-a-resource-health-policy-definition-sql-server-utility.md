---
title: "리소스 상태 정책 정의 수정(SQL Server 유틸리티) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# 리소스 상태 정책 정의 수정(SQL Server 유틸리티)
...
#### SQL Server 유틸리티에서 전역 리소스 사용률 정책 수정  
...
#### SQL Server 유틸리티에서 개별 데이터 계층 응용 프로그램 또는 개별 SQL Server 관리되는 인스턴스의 리소스 상태 정책 정의 수정  
