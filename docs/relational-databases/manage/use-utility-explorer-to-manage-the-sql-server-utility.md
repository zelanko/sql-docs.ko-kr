...
description: '유틸리티 탐색기를 사용하여 SQL Server 인스턴스를 관리하는 다양한 방법을 알아봅니다(예: 정책 정의 조정, CPU 및 스토리지 볼륨 사용률 확인).'
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
PowerShell에는 F1 도움말이 없지만 PowerShell 사용에 대한 정보를 제공하는 **Get-Help** cmdlet이 포함되어 있습니다. Get-Help를 사용하는 방법은 [SQL Server PowerShell 도움말 보기](../../powershell/sql-server-powershell.md)를 참조하세요.  
