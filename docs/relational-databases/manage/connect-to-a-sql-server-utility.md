---
title: "SQL Server 유틸리티에 연결 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
4.  유틸리티 탐색기 탐색 창에서 ![](../../relational-databases/manage/media/connect-to-utility.gif "Connect_to_Utility") **유틸리티**에 연결을 클릭합니다.  
