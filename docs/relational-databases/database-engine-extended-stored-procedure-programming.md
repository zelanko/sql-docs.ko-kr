...
>  [!INCLUDE[ssNoteDepFutureDontUse](../includes/ssnotedepfuturedontuse-md.md)] 대신 CLR 통합을 사용하십시오. 자세한 내용은 [CLR&#40;공용 언어 런타임&#41; 통합 프로그래밍 개요](../relational-databases/clr-integration/common-language-runtime-clr-integration-programming-concepts.md)를 참조하세요.  
 ...
 [!INCLUDE[msCoName](../includes/msconame-md.md)] 확장 저장 프로시저 API는 [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 기능을 확장하기 위한 서버 기반 API(응용 프로그래밍 인터페이스)를 제공합니다. 이 API는 확장 저장 프로시저와 게이트웨이 애플리케이션과 같은 애플리케이션을 빌드하는 데 사용되는 C 및 C++ 함수와 매크로로 구성됩니다.  
