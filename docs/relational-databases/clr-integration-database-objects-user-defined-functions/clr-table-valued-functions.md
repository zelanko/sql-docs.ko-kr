 ...
 **참고** 테이블 반환 함수는 [!INCLUDE[tsql](../../includes/tsql-md.md)] **fillrow** 메서드가 아닌 **initmethod** 메서드의 쿼리를 통해서만 데이터 액세스를 수행할 수 있습니다. 쿼리가 수행 되는 경우 **Initmethod** 는 **sqlfunction** 특성 속성으로 표시 되어야 합니다. [!INCLUDE[tsql](../../includes/tsql-md.md)]  
