...
description: 스칼라 반환 함수는 단일 값을 반환 합니다. SQL Server CLR 통합에서 관리 코드에 스칼라 반환 사용자 정의 함수를 작성할 수 있습니다.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
ms.reviewer: ''
...
> [!NOTE]  
>  **/Clr: pure** 로 컴파일된 Visual C++ 데이터베이스 개체는에서 실행할 수 없습니다 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] . 예를 들어 이러한 데이터베이스 개체에는 스칼라 반환 함수가 포함되어 있습니다.  
