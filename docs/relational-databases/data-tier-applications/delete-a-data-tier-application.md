...
### <a name="delete-the-dac-and-leave-the-database"></a>DAC 삭제 및 데이터베이스 유지
...
### <a name="delete-the-dac-and-drop-the-database"></a>DAC 삭제 및 데이터베이스 삭제
