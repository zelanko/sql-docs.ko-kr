...
---
# 뷰 삭제
  [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 또는 다음을 사용하여 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]에서 뷰를 삭제할 수 있습니다. [!INCLUDE[tsql](../../includes/tsql-md.md)]  
