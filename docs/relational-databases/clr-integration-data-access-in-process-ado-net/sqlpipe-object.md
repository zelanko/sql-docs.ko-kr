---
title: SqlPipe 개체 | 마이크로 소프트 문서
description: SQL Server에서 실행되는 CLR 데이터베이스 개체의 경우 SqlPipe 개체의 Send 메서드를 사용하여 연결된 파이프에 결과를 보낼 수 있습니다.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
 ...
 **보내기** 메서드는 클라이언트에서 PRINT에 [!INCLUDE[tsql](../../includes/tsql-md.md)]해당하는 정보 메시지로 나타나는 문자열 메시지를 보냅니다. **SqlDataRecord**를 사용하여 단일 행 결과 집합을 보내거나 **SqlDataReader**를 사용하여 다중 행 결과 집합을 보낼 수도 있습니다.  
