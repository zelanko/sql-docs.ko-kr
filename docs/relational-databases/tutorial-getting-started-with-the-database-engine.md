...
-   [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)]. [!INCLUDE[ssManStudio](../includes/ssmanstudio-md.md)] 는 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 설치 프로그램으로 설치할 수도 있고 [Microsoft 다운로드 센터](http://go.microsoft.com/fwlink/?LinkId=144346)에서 다운로드하여 설치할 수도 있습니다.  
