...
##  <a name="disabling-and-re-enabling-non-transactional-access-at-the-database-level"></a><a name="BasicsDisabling"></a> 데이터베이스 수준에서 비트랜잭션 액세스 사용 해제 및 다시 설정  
...
###  <a name="how-to-disable-and-re-enable-non-transactional-access-at-the-database-level"></a><a name="HowToDisable"></a> 방법: 데이터베이스 수준에서 비트랜잭션 액세스 사용 해제 및 다시 설정  
...
###  <a name="how-to-ensure-the-visibility-of-the-filetables-in-a-database"></a><a name="visible"></a> 방법: 데이터베이스에서 FileTable의 가시성 보장  
...
##  <a name="disabling-and-re-enabling-the-filetable-namespace-at-the-table-level"></a><a name="BasicsEnabling"></a> 테이블 수준에서 FileTable 네임스페이스 사용 해제 및 다시 설정  
...
###  <a name="how-to-disable-and-re-enable-the-filetable-namespace-at-the-table-level"></a><a name="HowToEnableNS"></a> 방법: 테이블 수준에서 FileTable 네임스페이스 사용 해제 및 다시 설정  
...
##  <a name="killing-open-file-handles-associated-with-a-filetable"></a><a name="BasicsKilling"></a> FileTable과 연결된 열려 있는 파일 핸들 중지  
...
###  <a name="how-to-get-a-list-of-open-file-handles-associated-with-a-filetable"></a><a name="HowToListOpen"></a> 방법: FileTable과 연결된 열려 있는 파일 핸들 목록 가져오기  
...
###  <a name="how-to-kill-open-file-handles-associated-with-a-filetable"></a><a name="HowToKill"></a> 방법: FileTable과 연결된 열려 있는 파일 핸들 중지  
...
###  <a name="how-to-identify-the-locks-held-by-filetables"></a><a name="HowToIdentifyLocks"></a> 방법: FileTable이 보유한 잠금 식별  
...
##  <a name="filetable-security"></a><a name="BasicsSecurity"></a> FileTable 보안  
...
##  <a name="backup-and-filetables"></a><a name="OtherBackup"></a> 백업과 FileTable  
...
##  <a name="sql-server-profiler-and-filetables"></a><a name="Monitor"></a> SQL Server Profiler와 FileTable  
...
##  <a name="auditing-and-filetables"></a><a name="OtherAuditing"></a> 감사와 FileTable  
...
##  <a name="dbcc-and-filetables"></a><a name="OtherDBCC"></a> DBCC와 FileTable  
