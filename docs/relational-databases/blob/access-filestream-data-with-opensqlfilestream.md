---
title: "OpenSqlFilestream을 사용하여 FILESTREAM 데이터 액세스 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
#### 매개 변수  
 *FilestreamPath*  
 [in] [PathName](../../relational-databases/system-functions/pathname-transact-sql.md) 함수에서 반환하는 **nvarchar(max)** 경로입니다. PathName은 FILESTREAM 테이블 및 열에 대한 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] SELECT 또는 UPDATE 권한이 있는 계정의 컨텍스트에서 호출해야 합니다.  
