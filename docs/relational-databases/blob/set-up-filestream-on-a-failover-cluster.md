---
title: "장애 조치(Failover) 클러스터에서 FILESTREAM 설정 | Microsoft Docs"
ms.custom: ""
ms.date: "08/26/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "FILESTREAM [SQL Server], 장애 조치(failover) 클러스터에서 설정"
...
---
# 장애 조치(Failover) 클러스터에서 FILESTREAM 설정
...
### 장애 조치 클러스터에서 FILESTREAM을 설정하려면  
