---
title: "FILESTREAM 액세스를 위한 방화벽 구성 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Windows 방화벽 [데이터베이스 엔진], FILESTREAM"
  - "FILESTREAM [SQL Server], Windows 방화벽"
...
### Windows 7을 실행하는 컴퓨터에서 Windows 파일 공유 포트를 열려면  
