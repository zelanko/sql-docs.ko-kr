...
ms.author: sstein
manager: craigg
ms.openlocfilehash: 9469852586ecf9b210a939777d64afe1c3fab366
...
|메시지 텍스트|로컬 데이터베이스 인스턴스 API 메서드 호출 내에서 예기치 않은 오류가 발생했습니다. 자세한 오류 정보는 Windows 응용 프로그램 로그를 참조하십시오.|  
