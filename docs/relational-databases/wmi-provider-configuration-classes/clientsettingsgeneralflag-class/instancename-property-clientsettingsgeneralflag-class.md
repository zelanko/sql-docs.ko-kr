...
ms.tgt_pltfrm: 
ms.topic: reference
apiname: InstanceName Property (ClientSettingsGeneralFlag Class)
...
ms.openlocfilehash: af38a0c5ad16cd57f069acb241c1f2492b5d05d8
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]인스턴스 이름을 가져옵니다 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 클라이언트입니다.  
