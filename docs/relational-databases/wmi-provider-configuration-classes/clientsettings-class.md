...
ms.locfileid: "73660682"
---
# <a name="clientsettings-class"></a>ClientSettings 클래스
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  [Clientsettings 클래스](../../relational-databases/wmi-provider-configuration-classes/clientsettings-class.md) 는 클라이언트의 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 설정을 나타냅니다.  
