...
---
# <a name="issuedto-property-securitycertificate-class"></a>IssuedTo 속성(SecurityCertificate 클래스)
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]보안 인증서가 발급 개체를 가져옵니다.  
