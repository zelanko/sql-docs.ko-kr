---
description: ServiceName 속성(SqlServiceAdvancedProperty 클래스)
title: ServiceName 속성 (SqlServiceAdvancedProperty)
...
## <a name="property-valuereturn-value"></a>속성 값/반환 값  
 고급 속성과 연결된 서비스의 이름을 지정하는 문자열 값입니다.  
