---
title: 구성 관리용 WMI 공급자 클래스
description: WMI(Windows Management Instrumentation)에서 제공 하는 기능을 검색 하 고 구현 합니다. Configuration Manager에 대해 이러한 클래스를 선택 합니다.
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
