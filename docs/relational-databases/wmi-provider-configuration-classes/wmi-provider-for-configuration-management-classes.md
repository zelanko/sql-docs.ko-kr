...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]구성 관리에 대 한 Windows Management Instrumentation (WMI) 공급자는 다음 클래스에 대 한 기능도를 제공합니다.  
