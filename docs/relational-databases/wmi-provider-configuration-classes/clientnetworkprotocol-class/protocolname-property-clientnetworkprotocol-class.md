---
description: ProtocolName 속성(ClientNetworkProtocol 클래스)
title: ProtocolName 속성 (ClientNetworkProtocol)
...
ms.locfileid: "88427335"
---
# <a name="protocolname-property-clientnetworkprotocol-class"></a>ProtocolName 속성(ClientNetworkProtocol 클래스)
[!INCLUDE [SQL Server](../../../includes/applies-to-version/sqlserver.md)]
  [클라이언트 프로토콜 구성](https://technet.microsoft.com/library/ms181035.aspx)에서 지정한 현재 네트워크 프로토콜의 이름을 가져옵니다.  
...
## <a name="property-valuereturn-value"></a>속성 값/반환 값  
 [Setordervalue 메서드 (ClientNetworkProtocol 클래스)](https://technet.microsoft.com/library/ms179295.aspx)에서 참조 하는 현재 클라이언트 네트워크 프로토콜의 이름을 지정 하는 문자열 값입니다.  
