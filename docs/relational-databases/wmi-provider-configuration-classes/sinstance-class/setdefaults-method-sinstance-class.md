...
|매개 변수|설명|  
|---------------|-----------------|  
|*OverwriteAll*|[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 클라이언트 인스턴스의 기존 값을 덮어쓸지 여부를 지정 하는 부울 값입니다. 기존 데이터를 덮어쓴 경우 **true** 이 고, 기존 데이터를 덮어쓰지 않는 경우 **false** 입니다.|  
