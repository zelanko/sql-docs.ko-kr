...
|속성 ID|Description|  
|-----------------|-----------------|  
|SSPROP_AUTH_OLD_PASSWORD|유형: VT_BSTR<br /><br /> R/W: 쓰기<br /><br /> 기본값: VT_EMPTY<br /><br /> 설명: 현재 또는 만료 된 암호입니다. 자세한 내용은 [프로그래밍 방식으로 암호 변경](../../relational-databases/native-client/features/changing-passwords-programmatically.md)을 참조 하세요.|  
...
|SSPROP_INIT_WSID|유형: VT_BSTR<br /><br /> R/W: 읽기/쓰기<br /><br /> 설명: 워크스테이션을 식별하는 문자열입니다.|  
 ...
 공급자별 속성 집합 DBPROPSET_SQLSERVERDATASOURCEINFO에서 Native Client OLE DB 공급자는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 추가 속성을 정의 합니다. 자세한 내용은 [데이터 원본 정보 속성](../../relational-databases/native-client-ole-db-data-source-objects/data-source-information-properties.md) 을 참조 하세요.  
...
```  
 ...
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 공급자에서 사용할 수 있는 키워드 목록은 [SQL Server Native Client에 연결 문자열 키워드 사용](../../relational-databases/native-client/applications/using-connection-string-keywords-with-sql-server-native-client.md)을 참조 하세요.  
