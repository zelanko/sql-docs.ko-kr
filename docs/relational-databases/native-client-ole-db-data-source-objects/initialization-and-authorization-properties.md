---
description: 초기화 및 권한 부여 속성 (Native Client OLE DB 공급자)
...
|SSPROP_INIT_PACKETSIZE|유형: VT_I4<br /><br /> R/W: 읽기/쓰기<br /><br /> 설명: 네트워크 패킷 크기 (바이트)입니다. 패킷 크기 속성 값은 512에서 32,767 사이여야 합니다. 기본 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 공급자 네트워크 패킷 크기는 4,096입니다.|  
