...
ms.locfileid: "81297023"
---
# <a name="sessions"></a>세션
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

  네이티브 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 클라이언트 OLE DB 공급자 세션은 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]의 인스턴스에 대한 단일 연결을 나타냅니다.  
  
 네이티브 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 클라이언트 OLE DB 공급자는 세션이 데이터 원본에 대한 트랜잭션 공간을 구분하도록 요구합니다. 특정 세션 개체에서 만들어진 모든 명령 개체는 해당 세션 개체의 로컬 또는 분산 트랜잭션에 참여합니다.  
 ...
 다음 예제에서는 네이티브 클라이언트 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] OLE DB 공급자를 사용하여 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 데이터베이스에 연결하는 방법을 보여 줍니다.  
...
```  
 ...
 네이티브 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 클라이언트 OLE DB 공급자 세션 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 개체를 인스턴스에 연결하면 세션 개체를 지속적으로 만들고 릴리스하는 응용 프로그램에 대해 상당한 오버헤드가 생성될 수 있습니다. 네이티브 클라이언트 OLE DB [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 공급자 세션 개체를 효율적으로 관리하여 오버헤드를 최소화할 수 있습니다. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]네이티브 클라이언트 OLE DB 공급자 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 응용 프로그램은 개체의 하나 이상의 인터페이스에 대한 참조를 유지하여 세션 개체의 연결을 활성 상태로 유지할 수 있습니다.  
