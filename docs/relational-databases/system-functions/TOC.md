# [개요](system-functions-for-transact-sql.md)  
# [Always On 가용성 그룹](always-on-availability-groups-functions-transact-sql.md)  
...
# [변경 데이터 캡처](change-data-capture-functions-transact-sql.md)  
...
# [변경 내용 추적](change-tracking-functions-transact-sql.md)  
...
# [데이터 수집기](data-collector-functions-transact-sql.md)  
...
# [Filestream 및 FileTable](filestream-and-filetable-functions-transact-sql.md)  
...
## [경로 이름](pathname-transact-sql.md)  
...
# [전체 텍스트 검색 및 의미 체계 검색](full-text-search-and-semantic-search-functions-transact-sql.md)  
...
# [시스템 메타 데이터](system-metadata-functions.md)  
...
# [시스템 보안](system-security-functions.md)  
...
# [시스템 추적](system-trace-functions.md)  
