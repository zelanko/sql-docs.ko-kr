 ...
 *database_id* | NULL  
 데이터베이스의 ID입니다. *database_id* 은 **int**, 기본값은 없습니다. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 인스턴스의 모든 데이터베이스에 대한 정보를 반환하려면 NULL을 지정합니다.  
...
|**타임 스탬프**|**bigint**|데이터를 사용한 시점의 데이터베이스 타임스탬프입니다. **int** 이전 버전의 [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)]합니다. |  
