---
title: Managed Backup 함수 (Transact-sql) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "68140617"
---
# <a name="managed-backup-functions-transact-sql"></a>Managed Backup 함수 (Transact-sql)
[!INCLUDE[tsql-appliesto-ss2016-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2016-xxxx-xxxx-xxx-md.md)]

  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]에서는에 대해 [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)]다음과 같은 함수를 제공 합니다.  
