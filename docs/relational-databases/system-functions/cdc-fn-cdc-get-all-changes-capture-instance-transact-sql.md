...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
 ...
 이 열거 함수는 원본 테이블에 변경 데이터 캡처가 활성화될 때 생성됩니다. 함수 이름은 파생 및 형식을 사용 **cdc.fn_cdc_get_all_changes_***capture_instance* 여기서 *capture_instance* 원본 테이블은 때 캡처 인스턴스에 대해 지정 된 값이 변경 데이터 캡처를 사용할 수 있습니다.  
