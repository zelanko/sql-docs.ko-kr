...
## <a name="remarks"></a>설명  
 ...
 Fn_trace_gettable 함수 롤오버 파일 로드 되지 것입니다 주의 (사용 하 여이 옵션을 지정 하는 경우는 *number_files* 인수)는 원래 추적 파일 이름이 밑줄과 숫자 값으로 끝나는 합니다. 이는 파일이 롤오버될 때 자동으로 추가된 밑줄과 숫자에는 적용되지 않습니다. 대 안으로, 원래 파일 이름에 밑줄을 제거 하는 추적 파일을 바꿀 수 있습니다. 예를 들어 원래 파일 이름이 **Trace_Oct_5.trc** 고 롤오버 파일 이름이 **Trace_Oct_5_1.trc**에서 파일 이름을 바꿀 수 있습니다 **TraceOct5.trc** 하고 **TraceOct5_1.trc**합니다.  
...
### <a name="a-using-fntracegettable-to-import-rows-from-a-trace-file"></a>A. fn_trace_gettable을 사용하여 추적 파일에서 행 가져오기  
