 ...
 *start_time*  
 ...
 연결 된 커밋 시간이 *start_time* 보다 큰 cdc. < capture_instance > _ct 변경 테이블의 행만 결과 집합에 포함 됩니다.  
...
-   @closed_high_end_point = 1  
     ...
     End_time 보다 작거나 같은 연결 된 커밋 시간이 포함 된 cdc. < capture_instance > _CT 변경 테이블의 행만 결과 집합에 포함 됩니다.  
