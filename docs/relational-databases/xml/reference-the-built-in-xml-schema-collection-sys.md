---
title: "기본 제공 XML 스키마 컬렉션 참조(sys) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "sys XML 스키마 컬렉션 [SQL Server]"
  - "스키마 컬렉션 [SQL Server], 미리 정의"
  - "미리 정의한 XML 스키마 컬렉션 [SQL Server]"
  - "XML 스키마 컬렉션 [SQL Server], 미리 정의"
  - "기본 제공 XML 스키마 컬렉션 [SQL Server]"
