---
title: "저장된 XML 스키마 컬렉션 보기 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "스키마 컬렉션 [SQL Server], 보기"
  - "XML 스키마 [SQL Server], 보기"
  - "CREATE XML SCHEMA COLLECTION 문"
  - "xml_schema_namespace 함수"
  - "XML 스키마 컬렉션 [SQL Server], 보기"
  - "XML 스키마 컬렉션 표시"
  - "XML 스키마 컬렉션 보기"
...
---
# 저장된 XML 스키마 컬렉션 보기
  [CREATE XML SCHEMA COLLECTION](../../t-sql/statements/create-xml-schema-collection-transact-sql.md)을 사용하여 XML 스키마 컬렉션을 가져오면 스키마 구성 요소가 메타데이터에 저장됩니다. [xml_schema_namespace](../Topic/xml_schema_namespace%20\(Transact-SQL\).md) 내장 함수를 사용하여 XML 스키마 컬렉션을 다시 만들 수 있습니다. 이 함수는 **xml** 데이터 형식을 반환합니다.  
  
 예를 들어 다음 쿼리는 [!INCLUDE[ssSampleDBobject](../../includes/sssampledbobject-md.md)] 데이터베이스의 프로덕션 관계형 스키마에서 XML 스키마 컬렉션(`ProductDescriptionSchemaCollection`)을 검색합니다.  
