...
description: FOR XML EXPLICIT가 있는 쿼리를 사용하여 데이터베이스에서 직원 정보를 XML로 검색하는 방법 예제를 확인합니다.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
...
태그 | Parent | Employee!1!EmpID | Name!2!FName | Name!2!LName
-|-|-|-|-
1 | NULL | 1 | NULL | NULL 
2 | 1 | 1 | Ken | Sánchez 
1 | NULL | 2 | NULL | NULL 
