...
description: EXPLICIT 모드를 사용하는 SELECT 문에 XMLTEXT 지시어를 지정하여 XML 문서의 사용하는 부분을 처리하는 방법을 알아봅니다.
ms.custom: ''
ms.date: 04/05/2017
ms.prod: sql
...
ms.locfileid: "85632322"
---
# <a name="example-specifying-the-xmltext-directive"></a>예제: XMLTEXT 지시어 지정
