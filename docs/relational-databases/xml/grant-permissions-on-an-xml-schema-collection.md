---
title: "XML 스키마 컬렉션에 대한 사용 권한 부여 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "사용 권한 부여 [SQL Server], XML 스키마 컬렉션"
  - "ALTER 권한"
...
### 4. XML 스키마 컬렉션에 대한 TAKE OWNERSHIP 권한 부여  
...
### 5. XML 스키마 컬렉션에 대한 VIEW DEFINITION 권한 부여  
