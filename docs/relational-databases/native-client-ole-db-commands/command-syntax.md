---
description: 명령 구문 (Native Client OLE DB 공급자)
title: 명령 구문 (Native Client OLE DB 공급자) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88455845"
---
# <a name="sql-server-native-client-command-syntax"></a>SQL Server Native Client 명령 구문
