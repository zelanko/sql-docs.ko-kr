...
ms.openlocfilehash: 63b010135db78edd56fac2ebe0725d4c672c7fbe
ms.sourcegitcommit: a78fa85609a82e905de9db8b75d2e83257831ad9
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 06/18/2018
ms.locfileid: "35702364"
---
# <a name="commands"></a>명령
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
[!INCLUDE[SNAC_Deprecated](../../includes/snac-deprecated.md)]

  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 공급자가 노출 된 **ICommand** 이 섹션에서 설명 하는 인터페이스 및 명령 개체:  
  
-   [명령 구문](../../relational-databases/native-client-ole-db-commands/command-syntax.md)  
  
-   [명령 매개 변수](../../relational-databases/native-client-ole-db-commands/command-parameters.md)  
