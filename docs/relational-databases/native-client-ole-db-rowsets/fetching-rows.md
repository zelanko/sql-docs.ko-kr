---
description: 행 페치 (Native Client OLE DB 공급자)
title: 행 페치 (Native Client OLE DB 공급자) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97419627"
---
# <a name="fetching-rows-native-client-ole-db-provider"></a>행 페치 (Native Client OLE DB 공급자)
