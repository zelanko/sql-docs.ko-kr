 ...
 **참고:** 컴퓨터 적절 하 게 구성 되어 있는지 확인 해야 하는 Windows 방화벽을 통해 연결 하는 경우. Windows Management Instrumentation 설명서에서 "Connecting Through Windows Firewall" 문서를 참조 하세요 [!INCLUDE[msCoName](../../includes/msconame-md.md)] MSDN [웹 사이트](https://go.microsoft.com/fwlink/?linkid=15426)합니다.  
