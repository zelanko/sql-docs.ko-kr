...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
 ...
 WMI 공급자는 인스턴스 공급자로서 인스턴스를 제공 합니다 [WMI 클래스](../../relational-databases/wmi-provider-configuration-classes/wmi-provider-for-configuration-management-classes.md) 다음 비동기 작업을 지원 합니다.  
 ...
 구성 관리용 WMI 공급자를 사용 하 여 관리 응용 프로그램의 예제를 참조 하세요 [WQL 및 스크립트 언어 구성 관리용 WMI 공급자를 사용 하 여](../../relational-databases/wmi-provider-configuration/using-wql-and-scripting-languages-with-the-wmi-provider.md)입니다.  
