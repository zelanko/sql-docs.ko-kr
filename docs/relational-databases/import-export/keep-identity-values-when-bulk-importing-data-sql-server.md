...
## <a name="keep-identity-values"></a>ID 값 유지 <a name="keep_identity"></a>  
...
### <a name="using-bcp-and-keeping-identity-values-without-a-format-file"></a>**서식 파일 없이 [bcp](../../tools/bcp-utility.md) 사용 및 ID 값 유지**<a name="bcp_identity"></a>
...
### <a name="using-bcp-and-generated-identity-values-without-a-format-file"></a>**서식 파일 없이 [bcp](../../tools/bcp-utility.md) 및 생성된 ID 값 사용**<a name="bcp_default"></a>
...
### <a name="using-bulk-insert-and-keeping-identity-values-without-a-format-file"></a>**서식 파일 없이 [BULK INSERT](../../t-sql/statements/bulk-insert-transact-sql.md) 사용 및 ID 값 유지**<a name="bulk_identity"></a>
...
### <a name="using-bulk-insert-and-generated-identity-values-without-a-format-file"></a>**서식 파일 없이 [BULK INSERT](../../t-sql/statements/bulk-insert-transact-sql.md) 및 생성된 ID 값 사용**<a name="bulk_default"></a>
