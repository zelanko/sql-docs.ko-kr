...
description: SQL Server 가져오기 또는 내보내기에서 원시 형식은 SQL Server 테이블 간에 데이터를 고속으로 전송하기 위해 데이터베이스의 원시 데이터 형식을 유지 관리합니다.
ms.date: 09/30/2016
ms.prod: sql
...
### <a name="sample-non-xml-format-file"></a>샘플 비 XML 서식 파일
...
### <a name="using-bcp-and-native-format-to-export-data"></a>bcp 및 원시 형식을 사용하여 데이터 내보내기
...
### <a name="using-bcp-and-native-format-to-import-data-without-a-format-file"></a>서식 파일 없이 bcp 및 원시 형식을 사용하여 데이터 가져오기
...
### <a name="using-bcp-and-native-format-to-import-data-with-a-non-xml-format-file"></a>bcp 및 원시 형식을 사용하여 비 XML 서식 파일과 함께 데이터 가져오기
...
### <a name="using-bulk-insert-and-native-format-without-a-format-file"></a>서식 파일 없이 BULK INSERT 및 원시 형식 사용
...
### <a name="using-bulk-insert-and-native-format-with-a-non-xml-format-file"></a>비 XML 서식 파일과 함께 BULK INSERT 및 원시 형식 사용
...
### <a name="using-openrowset-and-native-format-with-a-non-xml-format-file"></a>비 XML 서식 파일과 함께 OPENROWSET 및 원시 형식 사용
**FORMATFILE** 인수.  Microsoft SSMS( [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] )에서 다음 Transact-SQL을 실행합니다.
