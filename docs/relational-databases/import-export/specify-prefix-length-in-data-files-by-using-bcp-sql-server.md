---
title: "bcp를 사용하여 데이터 파일에 접두사 길이 지정(SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "07/28/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "bcp 유틸리티 [SQL Server], 접두사 길이"
  - "접두사 길이 [SQL Server]"
  - "길이 [SQL Server], 접두사 문자"
  - "데이터 형식 [SQL Server], 접두사 길이"
...
|**sql_variant**|8|8|8|8|  
 ...
 \***ntext**, **text** 및 **image** 데이터 형식은 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 이후 버전에서 제거됩니다. 향후 개발 작업에서는 이 데이터 형식을 사용하지 않도록 하고 현재 이 데이터 형식을 사용하는 응용 프로그램은 수정하세요. 대신 **nvarchar(max)**, **varchar(max)** 및 **varbinary(max)**를 사용합니다.  
