---
title: bcp를 사용하여 데이터 파일에 접두사 길이 지정
description: 이 문서에서는 원시 형식으로 데이터 파일에 대량으로 내보내기 위해 압축 파일 스토리지를 제공하도록 필드 길이를 인코드하는 접두사 필드에 대해 설명합니다.
ms.date: 07/28/2016
ms.prod: sql
