---
title: "bcp를 사용하여 데이터 형식을 호환 가능하도록 지정(SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "대량 내보내기 [SQL Server], 호환성"
  - "대량 가져오기 [SQL Server], 호환성"
  - "호환성 [SQL Server], 데이터 형식"
  - "데이터 형식 [SQL Server], 호환성"
  - "bcp 유틸리티 [SQL Server], 호환성"
...
-   [비 XML 서식 파일에 필드 단위 데이터 저장](#FieldByFieldNonXmlFF)  
