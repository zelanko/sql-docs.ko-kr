---
title: "대량 내보내기 또는 가져오기를 위한 데이터 준비(SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "대량 가져오기 [SQL Server], 계획"
  - "대량 가져오기 [SQL Server], CSV 파일에서"
  - "데이터 서식 [SQL Server], 작업 계획"
  - "CSV 파일 [SQL Server]"
  - "CSV 파일의 따옴표 붙은 필드 [SQL Server]"
