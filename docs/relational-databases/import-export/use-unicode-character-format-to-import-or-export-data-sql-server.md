...
## <a name="considerations-for-using-unicode-character-format"></a>유니코드 문자 형식 사용 시 고려 사항<a name="considerations"></a>
...
## <a name="special-considerations-for-using-unicode-character-format-bcp-and-a-format-file"></a>유니코드 문자 형식, bcp 및 서식 파일 사용 시 특별 고려 사항<a name="special_considerations"></a>
...
## <a name="command-options-for-unicode-character-format"></a>유니코드 문자 형식의 명령 옵션<a name="command_options"></a>  
...
### <a name="using-bcp-and-unicode-character-format-to-export-data"></a>**bcp 및 유니코드 문자 형식을 사용하여 데이터 내보내기**<a name="bcp_widechar_export"></a>
...
### <a name="using-bcp-and-unicode-character-format-to-import-data-without-a-format-file"></a>**bcp 및 유니코드 문자 형식을 사용하여 서식 파일 없이 데이터 가져오기**<a name="bcp_widechar_import"></a>
...
### <a name="using-bcp-and-unicode-character-format-to-import-data-with-a-non-xml-format-file"></a>**bcp 및 유니코드 문자 형식을 사용하여 XML 이외의 서식 파일과 함께 데이터 가져오기**<a name="bcp_widechar_import_fmt"></a>
...
### <a name="using-bulk-insert-and-unicode-character-format-without-a-format-file"></a>**서식 파일 없이 BULK INSERT 및 유니코드 문자 형식 사용**<a name="bulk_widechar"></a>
...
### <a name="using-bulk-insert-and-unicode-character-format-with-a-non-xml-format-file"></a>**XML 이외의 서식 파일과 함께 BULK INSERT 및 유니코드 문자 형식 사용하기**<a name="bulk_widechar_fmt"></a>
...
### <a name="using-openrowset-and-unicode-character-format-with-a-non-xml-format-file"></a>**XML 이외의 서식 파일과 함께 OPENROWSET 및 유니코드 문자 형식 사용하기**<a name="openrowset_widechar_fmt"></a>
**FORMATFILE** 인수.  Microsoft SSMS( [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] )에서 다음 Transact-SQL을 실행합니다.
```sql
TRUNCATE TABLE TestDatabase.dbo.myWidechar;  -- for testing
