---
title: "bcp 유틸리티를 사용하여 대량 데이터 가져오기 및 내보내기(SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "09/28/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "대량 내보내기 [SQL Server], bcp 유틸리티"
  - "대량 가져오기 [SQL Server], bcp 유틸리티"
