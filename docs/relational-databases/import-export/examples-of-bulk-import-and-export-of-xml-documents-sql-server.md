---
title: "XML 문서 대량 가져오기 및 내보내기 예(SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "10/24/2016"
...
helpviewer_keywords: 
  ...
  - "행 종결자 [SQL Server]"
  - "OPENROWSET 함수, XML 대량 로드"
  - "종결자 [SQL Server]"
  - "대량 내보내기 [SQL Server], 데이터 형식"
  - "XML 대량 로드 [SQL Server]"
...
-  [3. DTD가 포함된 파일에 있는 XML 데이터 대량 가져오기](#file_contains_dtd)  
  
- [4. 서식 파일을 사용하여 명시적으로 필드 종결자 지정](#field_terminator_in_format_file)  
