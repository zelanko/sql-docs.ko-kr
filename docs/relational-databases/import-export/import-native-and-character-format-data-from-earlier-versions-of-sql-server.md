---
title: "SQL Server 이전 버전으로부터 기본 및 문자 형식 데이터 가져오기 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "이전 버전 [SQL Server], 가져오기 및 내보내기 데이터 형식"
  - "-V 스위치"
  - "데이터 형식 [SQL Server], 이전 버전"
  - "이전 버전 [SQL Server], 가져오기 및 내보내기 데이터 형식"
 ...
 **bcp** 명령은 **datetime** 및 **smalldatetime** 값에 대해 ODBC 기본 형식을 사용하여 문자 형식 데이터 파일을 내보냅니다. 예를 들어 `12 Aug 1998`이라는 날짜가 포함된 **datetime** 열은 `1998-08-12 00:00:00.000` 문자열로 데이터 파일에 대량 복사됩니다.  
...
-   [데이터를 가져오거나 내보내기 위해 유니코드 네이티브 형식 사용&#40;SQL Server&#41;](../../relational-databases/import-export/use-unicode-native-format-to-import-or-export-data-sql-server.md)  
