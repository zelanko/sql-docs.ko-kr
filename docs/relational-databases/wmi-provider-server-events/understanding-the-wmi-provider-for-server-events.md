...
```  
 ...
 서버 이벤트용 WMI 공급자를 사용하는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 에이전트 관리 응용 프로그램에 대한 예는 [예제: 서버 이벤트용 WMI 공급자를 사용하여 SQL Server 에이전트 경고 만들기](https://technet.microsoft.com/library/ms186385.aspx)를 참조하십시오. 관리 코드에서 서버 이벤트용 WMI 공급자를 사용하는 관리 응용 프로그램에 대한 예는 [예제:   관리 코드에서 WMI 이벤트 공급자 사용](https://technet.microsoft.com/library/ms179315.aspx)을 참조하십시오. WMI에 대한 자세한 내용은 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] SDK에서도 참조할 수 있습니다.  
