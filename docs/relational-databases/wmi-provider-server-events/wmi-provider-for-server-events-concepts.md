---
title: 서버 이벤트용 WMI 공급자 개념
description: 서버 이벤트 용 WMI 공급자가 WMI(Windows Management Instrumentation)를 사용 하 여 SQL Server 인스턴스의 이벤트를 모니터링 하는 방법에 대해 알아보려면 다음 리소스를 사용 합니다.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
