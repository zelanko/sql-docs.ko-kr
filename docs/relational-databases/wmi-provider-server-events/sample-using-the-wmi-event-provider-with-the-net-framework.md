---
title: '예제: .NET Framework를 사용 하 여 WMI 이벤트 공급자를 사용 하 여 | Microsoft Docs'
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "68139225"
---
# <a name="sample-using-the-wmi-event-provider-with-the-net-framework"></a>예제: .NET Framework에서 WMI 이벤트 공급자 사용
