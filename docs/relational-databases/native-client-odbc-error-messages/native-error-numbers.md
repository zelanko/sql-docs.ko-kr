...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
  ...
  데이터 원본에서 발생 하는 오류 ([!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]에서 반환)의 경우 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client ODBC 드라이버는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]에 의해 반환 된 원시 오류 번호를 반환 합니다. 드라이버에서 검색 된 오류의 경우 Native Client ODBC 드라이버 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]는 원시 오류 번호 0을 반환 합니다. 네이티브 오류 번호 목록에 대 한 자세한 내용은 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]의 **master** 데이터베이스에서 **sysmessages** 시스템 테이블의 error 열을 참조 하십시오.  
