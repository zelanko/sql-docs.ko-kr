---
title: "편집기 및 보기 모드 관리 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "쿼리 편집기 [SQL Server Management Studio], 창 동작 관리"
  - "워크벤치 보기 모드 [SQL Server Management Studio]"
  - "전체 화면 모드 [SQL Server Management Studio]"
  - "글꼴 [SQL Server Management Studio]"
  - "자동 줄 바꿈 [SQL Server Management Studio]"
  - "가상 공간 모드 [SQL Server Management Studio]"
  - "문서 뷰 분할"
  - "줄 번호 표시"
  - "보기 모드 [SQL Server Management Studio]"
