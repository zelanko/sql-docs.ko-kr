---
title: "쿼리 편집기로 SQLCMD 스크립트 편집 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "스크립트 [SQL Server], SQLCMD 스크립트"
  - "SQLCMD 스크립트"
  - "스크립트 수정"
  - "쿼리 편집기 [데이터베이스 엔진], SQLCMD 스크립트"
