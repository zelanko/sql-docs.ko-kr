---
title: "IntelliSense 문제 해결(SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "사용할 수 없는 옵션 [IntelliSense]"
  - "IntelliSense [SQL Server], 문제 해결"
  - "IntelliSense [SQL Server], 사용 할 수 없는 옵션"
  - "문제 해결 [IntelliSense]"
