---
title: "대화형으로 문서 검색 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "대화형 검색 [SQL Server Management Studio]"
  - "검색 [SQL Server Management Studio], 대화형"
  - "쿼리 편집기 [SQL Server Management Studio], 대화형 검색"
