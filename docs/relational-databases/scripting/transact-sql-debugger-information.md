---
title: "Transact-SQL 디버거 정보 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Transact-SQL 디버거, 지역 창"
  - "Transact-SQL 디버거, 조사식 창"
  - "Transact-SQL 디버거, 스레드 창"
  - "Transact-SQL 디버거, 호출 스택 창"
  - "Transact-SQL 디버거, QuickWatch"
  - "Transact-SQL 디버거, 정보 보기"
...
-   @IntegerCounter 등의 변수 이름입니다.  
  
-   @IntegerCounter + 1 등의 변수에 대한 산술 연산입니다.  
  
-   @FirstName + @LastName 등의 두 문자 변수에 대한 문자열 연산입니다.  
...
## 참고 항목  
 ...
 [중단점 창](../../relational-databases/scripting/breakpoints-window.md)   
 [호출 스택 창](../../relational-databases/scripting/call-stack-window.md)   
 [스레드 창](../../relational-databases/scripting/threads-window.md)   
 [출력 창](../../relational-databases/scripting/output-window.md)   
