...
ms.topic: "article"
helpviewer_keywords: 
  - "쿼리 편집기 [SQL Server Management Studio], 코드 개요"
  - "쿼리 편집기 [SQL Server Management Studio], 코드 숨기기"
...
### Analysis Services XMLA 쿼리 편집기 영역  
 ...
 ![내부 노드가 숨겨진 XML 코드](../../relational-databases/scripting/media/editoutlinexmlinnercol.png "내부 노드가 숨겨진 XML 코드")  
 ...
 ![내부 및 가운데 태그가 숨겨진 XML 코드](../../relational-databases/scripting/media/editoutlinexmlmiddlecol.png "내부 및 가운데 태그가 숨겨진 XML 코드")  
  
 \<OuterTag> 줄의 빼기 기호를 클릭하면 다음 그림과 같이 3개의 줄이 모두 축소됩니다.  
  
 ![숨겨진 3개의 태그를 모두 보여 주는 XML 코드](../../relational-databases/scripting/media/editoutlinexmloutercol.png "숨겨진 3개의 태그를 모두 보여 주는 XML 코드")  
