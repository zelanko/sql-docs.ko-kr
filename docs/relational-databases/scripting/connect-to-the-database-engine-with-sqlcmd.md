---
title: "sqlcmd를 사용하여 데이터베이스 엔진에 연결 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "sqlcmd 유틸리티, 데이터베이스 엔진 연결"
  - "명명된 파이프 [SQL Server], sqlcmd 유틸리티"
  - "TCP/IP [SQL Server], 클라이언트 프로토콜"
  - "네트워크 프로토콜 [SQL Server], sqlcmd 유틸리티"
  - "프로토콜 [SQL Server], sqlcmd 유틸리티"
  - "VIA"
