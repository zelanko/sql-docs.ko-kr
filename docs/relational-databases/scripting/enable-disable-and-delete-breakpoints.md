---
title: "중단점 설정, 해제 및 삭제 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
## 중단점 창  
 **중단점** 창에는 중단점이 위치한 코드 줄과 같은 정보가 나열됩니다. **중단점** 창에서 중단점을 삭제, 해제 및 설정할 수 있습니다.  **중단점** 창에 대한 자세한 내용은 [중단점 Window](../../relational-databases/scripting/breakpoints-window.md)을 참조하십시오.  
