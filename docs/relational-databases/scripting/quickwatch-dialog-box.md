---
title: "간략한 조사식 대화 상자 | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
1.  **식** 목록 상자에서 원하는 식을 입력하거나 선택합니다. 다음의 [!INCLUDE[tsql](../../includes/tsql-md.md)] 식이 지원됩니다.  
    ...
    -   @IntegerCounter + 1 또는 FirstName + LastName과 같이 하나 이상의 변수, 매개 변수 또는 시스템 함수에 연산자를 적용하여 작성한 식  
...
## 참고 항목  
 ...
 [조사식 창](../../relational-databases/scripting/watch-window.md)   
 [지역 창](../../relational-databases/scripting/locals-window.md)   
 [호출 스택 창](../../relational-databases/scripting/call-stack-window.md)   
