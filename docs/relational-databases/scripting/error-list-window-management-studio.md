---
title: "오류 목록 창(Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
helpviewer_keywords: 
  - "오류 목록 창"
  - "SQL Server Management Studio [SQL Server], 오류 목록 창"
...
## Management Studio의 Transact-SQL 오류  
