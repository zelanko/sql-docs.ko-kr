---
title: "SQL Server PowerShell 도움말 보기 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "도움말 [PowerShell]"
  - "도움말 [SQL Server], PowerShell"
  - "PowerShell [SQL Server], 도움말"
...
## 시작하기 전 주의 사항  
 ...
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] cmdlet 및 공급자에 대한 개요는 [SQL Server PowerShell](../../relational-databases/scripting/sql-server-powershell.md)을 참조하세요.  
  
### Windows PowerShell 환경의 도움말  
...
### SQL Server PowerShell 공급자 도움말  
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] PowerShell 공급자는 SQLSERVER 가상 드라이브에서 여러 폴더(예: SQLSERVER:\SQL 및 SQLSERVER:\DAC 폴더)를 구현합니다. 각 폴더는 SQL Server 관리 효율성 개체 모델 중 하나에 연결됩니다. SQL Server 경로에 각 노드에 연결된 메서드 및 속성을 나열할 수 있지만 PowerShell 환경에서 해당 메서드와 속성에 대한 도움말을 볼 수 없습니다. 연결된 프로그래밍 참조에 대한 링크를 제공하는 폴더 테이블은 [SQL Server PowerShell Provider](../../relational-databases/scripting/sql-server-powershell-provider.md)를 참조하십시오.  
...
-   [!INCLUDE[tsql](../../includes/tsql-md.md)] 문을 통해 데이터를 대량으로 가져오는 데 서식 파일을 사용하는 방법을 보여 줍니다. [!INCLUDE[tsql](../../includes/tsql-md.md)] 언어에 대한 자세한 내용은 [Transact-SQL 참조&#40;데이터베이스 엔진&#41;](../../t-sql/transact-sql-reference-database-engine.md)를 참조하세요.  
  
-   XQuery 문. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]에서 지원하는 XQuery 언어에 대한 자세한 내용은 [XQuery 언어 참조&#40;SQL Server&#41;](../../xquery/xquery-language-reference-sql-server.md)를 참조하세요.  
  
## SQL Server cmdlet에 대한 도움말 보기  
 **cmdlet에 대한 도움말을 보려면**  
...
## SQL Server 공급자에 대한 도움말 가져오기  
 **공급자에 대한 도움말을 가져오려면**  
  
1.  이름을 SQLServer로 지정하여 Get-Help를 실행합니다.  
  
### 예: SQL Server 공급자 도움말 가져오기  
