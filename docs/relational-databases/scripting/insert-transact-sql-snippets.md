---
title: "Transact-SQL 코드 조각 삽입 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "IntelliSense [SQL Server], 코드 조각"
  - "Transact-SQL 코드 조각, 코드"
  - "코드 조각 [Transact-SQL], 삽입 방법"
