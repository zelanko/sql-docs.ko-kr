---
title: "기존 계층적 데이터로 테이블 채우기 | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
1.  재귀 쿼리는 집계가 있는 하위 쿼리를 금지합니다. 대신 [ROW_NUMBER()](../../t-sql/functions/row-number-transact-sql.md) 메서드를 통해 **Num** 열을 채우는 다음 코드를 사용하여 **#Children** 테이블을 채웁니다.  
