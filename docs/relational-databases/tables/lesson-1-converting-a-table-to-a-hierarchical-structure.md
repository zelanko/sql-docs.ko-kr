...
-   [Employee 테이블의 현재 구조 검사](../../relational-databases/tables/examining-the-current-structure-of-the-employee-table.md)  
  
-   [기존 계층적 데이터로 테이블 채우기](../../relational-databases/tables/populating-a-table-with-existing-hierarchical-data.md)  
  
-   [NewOrg 테이블 최적화](../../relational-databases/tables/optimizing-the-neworg-table.md)  
  
-   [요약: 테이블을 계층 구조로 변환](../../relational-databases/tables/summary-converting-a-table-to-a-hierarchical-structure.md)  
