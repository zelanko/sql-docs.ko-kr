...
## <a name="table-valued-parameters-vs-bulk-insert-operations"></a><a name="BulkInsert"></a> 테이블 반환 매개 변수와 BULK INSERT 작업 비교
...
다음 예제에서는 [!INCLUDE[tsql](../../includes/tsql-md.md)]을 사용하며 테이블 반환 매개 변수 형식을 만들고, 해당 형식을 참조하는 변수를 선언하고, 매개 변수 목록을 채운 다음 AdventureWorks 데이터베이스의 저장 프로시저에 값을 전달하는 방법을 보여 줍니다.
