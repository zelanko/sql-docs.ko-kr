---
title: "PRIMARY KEY 및 FOREIGN KEY 제약 조건 | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "06/02/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "외래 키 [SQL Server], 연계 참조 무결성"
  - "FOREIGN KEY 제약 조건"
  - "외래 키 [SQL Server]"
  - "외래 키 [SQL Server], 외래 키 제약 조건 정보"
...
[!INCLUDE[tsql-appliesto-ss2016-all_md](../../includes/tsql-appliesto-ss2016-all-md.md)]
 ...
 [외래 키 제약 조건](../../relational-databases/tables/primary-and-foreign-key-constraints.md#FKeys)  
...
|외래 키 관계를 만드는 방법에 대해 설명합니다.|[외래 키 관계 만들기](../../relational-databases/tables/외래-키-관계-만들기.md)|  
