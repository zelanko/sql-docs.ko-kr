---
title: "인덱스 다시 구성 태스크(유지 관리 계획) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# 인덱스 다시 구성 태스크(유지 관리 계획)
  **인덱스 다시 구성 태스크** 대화 상자를 사용하여 인덱스 페이지를 보다 효율적인 검색 순서로 이동할 수 있습니다. [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  데이터베이스의 경우 이 태스크를 수행하면 `ALTER INDEX REORGANIZE` 문이 사용됩니다.  
