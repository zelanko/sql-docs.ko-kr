---
title: "유지 관리 계획 만들기(유지 관리 계획 디자인 화면) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
4.  **새 유지 관리 계획** 대화 상자의 **이름** 상자에 계획의 이름을 입력하고 **확인**을 클릭합니다. 이렇게 하면 도구 상자가 열리고 주 표에서 만든 하위 계획 **Subplan_1**과 함께 *maintenance_plan_name* **[디자인]** 화면이 열립니다.  
