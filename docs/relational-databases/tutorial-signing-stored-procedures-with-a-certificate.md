---
description: '자습서: 인증서로 저장 프로시저 서명'
title: '자습서: 인증서로 저장 프로시저 서명'
...
> [!NOTE]  
> 이 자습서의 코드를 실행하려면 혼합 모드 보안을 구성하고 AdventureWorks2017 데이터베이스를 설치해야 합니다.   
