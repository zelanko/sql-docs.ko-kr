---
title: "추적 데이터에 대한 액세스 향상 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "프로파일러 [SQL Server 프로파일러], 공간"
  - "SQL Server Profiler, 공간"
  - "공간 [SQL Server], SQL Server Profiler"
...
### Windows 운영 체제에서 TEMP 환경 변수를 변경하려면  
