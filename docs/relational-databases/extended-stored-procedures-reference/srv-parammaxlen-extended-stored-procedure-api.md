...
|**N**|**NULL:** -1<br /><br /> **0:** -1<br /><br /> **>= 255:** -1<br /><br /> 255:-1 ** \<**|  
...
## <a name="remarks"></a>설명  
  ...
  **srv_parammaxlen** 함수는 원격 저장 프로시저의 최대 데이터 길이를 가져옵니다. 매개 변수의 실제 길이를 가져오려면 **srv_paramlen**을 사용합니다.  
