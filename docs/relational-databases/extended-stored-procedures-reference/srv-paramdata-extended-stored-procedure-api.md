...
## <a name="returns"></a>반환 값  
 매개 변수 값에 대한 포인터입니다. 경우는 *n*번째 매개 변수는 NULL, 즉 없는 *n*번째 매개 변수가 원격이 없습니다. 또는 저장된 프로시저는 NULL을 반환 합니다. 매개 변수 값이 문자열이면 Null로 종결되지 않을 수 있습니다. **srv_paramlen**을 사용하여 문자열 길이를 확인합니다.  
