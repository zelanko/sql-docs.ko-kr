...
## <a name="returns"></a>반환  
 매개 변수 값에 대한 포인터입니다. 
  *n*번째 매개 변수가 NULL이거나, *n*번째 매개 변수가 없거나, 원격 저장 프로시저가 없으면 NULL이 반환됩니다. 매개 변수 값이 문자열이면 Null로 종결되지 않을 수 있습니다. 
  **srv_paramlen**을 사용하여 문자열 길이를 확인합니다.  
...
|새 데이터 형식|입력 데이터 길이|  
|--------------------|-----------------------|  
|BITN|**NULL:** VP, NULL<br /><br /> **0:** VP, NULL<br /><br /> **>= 255:** 해당 없음<br /><br /> **<255:** 해당 없음|  
|BIGVARCHAR|**NULL:** NULL, 해당 없음<br /><br /> **0:** VP, NULL<br /><br /> **>= 255:** VP, 255 문자<br /><br /> **<255:** VP, 실제 데이터|  
|BIGCHAR|**NULL:** NULL, 해당 없음<br /><br /> **0:** VP, 255 공간<br /><br /> **>= 255:** VP, 255 문자<br /><br /> **<255:** VP, 실제 데이터 + 패딩 (최대 255)|  
|BIGBINARY|**NULL:** NULL, 해당 없음<br /><br /> **0:** VP, 255 0x00<br /><br /> **>= 255:** VP, 255 바이트<br /><br /> **<255:** VP, 실제 데이터 + 패딩 (최대 255)|  
|BIGVARBINARY|**NULL:** NULL, 해당 없음<br /><br /> **0:** VP, 0x00<br /><br /> **>= 255:** VP, 255 바이트<br /><br /> **<255:** VP, 실제 데이터|  
|NCHAR|**NULL:** NULL, 해당 없음<br /><br /> **0:** VP, 255 공간<br /><br /> **>= 255:** VP, 255 문자<br /><br /> **<255:** VP, 실제 데이터 + 패딩 (최대 255)|  
|NVARCHAR|**NULL:** NULL, 해당 없음<br /><br /> **0:** VP, NULL<br /><br /> **>= 255:** VP, 255 문자<br /><br /> **<255:** VP, 실제 데이터|  
|NTEXT|**NULL:** 해당 없음<br /><br /> **0:** 해당 없음<br /><br /> **>= 255:** 해당 없음<br /><br /> ** \<255:** 해당 없음|  
