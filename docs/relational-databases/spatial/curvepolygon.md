...
> [!IMPORTANT]  
>  **CurvePolygon** 하위 유형을 포함하여 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]에 도입된 공간 기능에 대한 자세한 설명 및 예를 보려면 [SQL Server 2012의 새로운 공간 기능](http://go.microsoft.com/fwlink/?LinkId=226407) 백서를 다운로드하세요.  
...
### 1. 빈 CurvePolygon을 사용하여 Geometry 인스턴스 인스턴스화  
...
### 2. 동일한 문에서 CurvePolygon을 사용하여 Geometry 인스턴스 선언 및 인스턴스화  
...
### 3. CurvePolygon을 사용하여 Geography 인스턴스 인스턴스화  
...
### 4. 외부 경계 링만 사용하여 CurvePolygon 저장  
...
```  
 ...
 @g1과 @g2 모두 동일한 외부 경계 링을 사용합니다. 이 원의 반지름은 5이고 @g1과 @g2 모두 내부 링에 대해 사각형을 사용합니다.  그러나 @g1 인스턴스는 유효하고 @g2 인스턴스는 유효하지 않습니다.  @g2가 유효하지 않는 이유는 내부 링이 외부 링에 의해 경계가 지정된 내부 공간을 4개의 개별 영역으로 분할하기 때문입니다.  다음 그림에서는 이를 실행한 결과를 보여 줍니다.  
  
## 참고 항목  
 [다각형](../../relational-databases/spatial/polygon.md)   
 [CircularString](../../relational-databases/spatial/circularstring.md)   
 [CompoundCurve](../../relational-databases/spatial/compoundcurve.md)   
 [geometry 데이터 형식 메서드 참조](../Topic/geometry%20Data%20Type%20Method%20Reference.md)   
 [geography 데이터 형식 메서드 참조](../Topic/geography%20Data%20Type%20Method%20Reference.md)   
