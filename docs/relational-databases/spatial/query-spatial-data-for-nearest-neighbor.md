---
description: 가장 인접한 항목의 공간 데이터 쿼리
...
## <a name="example"></a>예제  
 다음 코드 예에서는 공간 인덱스를 사용할 수 있는 가장 인접한 항목 쿼리를 보여 줍니다. 이 예에서는 `Person.Address` 데이터베이스의 `AdventureWorks2016` 테이블을 사용합니다.  
