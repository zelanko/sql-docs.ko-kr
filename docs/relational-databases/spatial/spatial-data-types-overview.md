---
title: "공간 데이터 형식 개요 | Microsoft Docs"
ms.custom: ""
ms.date: "11/01/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "geometry 데이터 형식 [SQL Server], 이해"
  - "geography 데이터 형식 [SQL Server], 공간 데이터"
  - "평면 공간 데이터 [SQL Server], 기하학 데이터 형식"
...
### geography 데이터 형식에서 중요하지 않은 외부 및 내부 링  
