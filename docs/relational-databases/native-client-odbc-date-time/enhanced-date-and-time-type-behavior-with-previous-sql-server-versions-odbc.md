...
## <a name="down-level-client-behavior"></a>하위 수준 클라이언트 동작  
 ...
 SQLDescribeCol, SQLDescribeParam, SQGetDescField, 및 SQLColAttribute에서 반환 된 문 메타 데이터 형식 이름을 포함 한 모든 측면에서 하위 수준 형식과 일치 하는 메타 데이터를 반환 합니다. 이러한 하위 수준 형식의 예로 **nvarchar**합니다.  
...
|기호|의미|  
|------------|-------------|  
|@shouldalert|[!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]에서 동작하는 경우 그보다 최신 버전의 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]에서도 계속 동작합니다.|  
