---
title: 형식 지원, ODBC 날짜 및 시간
description: 문자열, 리터럴 및 데이터 구조에 대 한 데이터 형식 매핑 및 형식을 포함 하 여 SQL Server 날짜 및 시간 데이터 형식을 지 원하는 ODBC 형식에 대해 알아봅니다.
ms.custom: ''
ms.date: 12/18/2019
ms.prod: sql
