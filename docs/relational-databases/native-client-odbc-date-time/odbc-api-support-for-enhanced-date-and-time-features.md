---
title: 향상 된 날짜 및 시간 기능에 대 한 ODBC API 지원 | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.openlocfilehash: e3fb2aca77741fde51fe2a58e417d4d32cc39aac
ms.sourcegitcommit: 2ddc0bfb3ce2f2b160e3638f1c2c237a898263f4
ms.translationtype: HT
ms.contentlocale: ko-KR
ms.lasthandoff: 05/03/2018
---
# <a name="odbc-api-support-for-enhanced-date-and-time-features"></a>향상 된 날짜 및 시간 기능에 대 한 ODBC API 지원
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
[!INCLUDE[SNAC_Deprecated](../../includes/snac-deprecated.md)]

  다음 ODBC API는 향상된 날짜 및 시간 기능을 지원합니다.  
...
-   [SQLSpecialColumns](../../relational-databases/native-client-odbc-api/sqlspecialcolumns.md)  
 ...
 다음 대량 복사 API는 향상된 날짜 및 시간 기능을 지원합니다.  
