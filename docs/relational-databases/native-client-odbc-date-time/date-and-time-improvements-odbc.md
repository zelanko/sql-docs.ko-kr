...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [향상 된 날짜 및 시간 형식을 이전 버전 SQL Server에 대 한 동작 &#40;ODBC&#41;](../../relational-databases/native-client-odbc-date-time/enhanced-date-and-time-type-behavior-with-previous-sql-server-versions-odbc.md)  
