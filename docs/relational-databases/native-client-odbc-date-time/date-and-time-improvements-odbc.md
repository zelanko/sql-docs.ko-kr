...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [datetime 데이터 형식 변환 &#40;ODBC&#41;](../../relational-databases/native-client-odbc-date-time/datetime-data-type-conversions-odbc.md)  
 ...
 [이전 SQL Server 버전 &#40;ODBC에서 향상 된 날짜 및 시간 형식 동작&#41;](../../relational-databases/native-client-odbc-date-time/enhanced-date-and-time-type-behavior-with-previous-sql-server-versions-odbc.md)  
