---
description: SQL Server Native Client에서 대량 데이터 설정
...
ms.locfileid: "97439944"
---
# <a name="setting-large-data-in-sql-server-native-client"></a>SQL Server Native Client에서 대량 데이터 설정
