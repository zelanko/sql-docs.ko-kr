...
#### <a name="data-storage-uses-columnstore-and-rowstore-compression"></a>데이터 스토리지는 columnstore 및 rowstore 압축을 사용함
columnstore 인덱스에 대해 살펴볼 때 데이터 스토리지에 대한 형식을 강조하기 위해 *rowstore* 및 *columnstore* 라는 용어가 사용됩니다. Columnstore 인덱스는 두 가지 유형의 스토리지를 사용합니다.

 ![클러스터형 Columnstore 인덱스](../relational-databases/indexes/media/sql-server-pdw-columnstore-physicalstorage.gif "클러스터형 Clustered 인덱스")
...
##  <a name="hash-index-design-guidelines"></a><a name="hash_index"></a> 해시 인덱스 디자인 지침 
...
### <a name="configuring-the-hash-index-bucket-count"></a><a name="configuring_bucket_count"></a> 해시 인덱스 버킷 수 구성
...
### <a name="declaration-considerations"></a><a name="h3-b2-declaration-limitations"></a> 선언 시 고려 사항  
...
##  <a name="memory-optimized-nonclustered-index-design-guidelines"></a><a name="inmem_nonclustered_index"></a> 메모리 최적화 비클러스터형 인덱스 디자인 지침 
...
[SQL Server 2008 인덱싱된 뷰를 통해 성능 향상](/previous-versions/sql/sql-server-2008/dd171921(v=sql.100))  
