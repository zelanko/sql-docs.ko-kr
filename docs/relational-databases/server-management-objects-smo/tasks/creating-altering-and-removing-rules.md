...
## <a name="creating-altering-and-removing-a-rule-in-visual-basic"></a>Visual Basic에서 규칙 생성, 변경 및 제거  
 ...
 System.object  의 개체에 대 한 <xref:Microsoft.SqlServer.Management.Smo.Rule> 모호성을 방지 하기 위해 개체에 대 한 Dim 문은 전체 어셈블리 경로로 지정 됩니다 <xref:Microsoft.SqlServer.Management.Smo.Rule> .  
