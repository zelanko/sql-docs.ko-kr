...
ms.locfileid: "38032627"
---
# <a name="smo-programming---getting-started-in-visual-c-net"></a>SMO 프로그래밍-Visual C#.NET 시작
[!INCLUDE[appliesto-ss-asdb-asdw-xxx-md](../../includes/appliesto-ss-asdb-asdw-xxx-md.md)]

  [!INCLUDE[csprcs](../../includes/csprcs-md.md)] .NET에는 CLR (공용 언어 런타임)에서 지원 되는 관리 되는 프로그래밍 언어 중 하나로 [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] .NET. C# 언어에 대 한 자세한 내용은 참조는 [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] .NET 설명서. [!INCLUDE[vsprvslong](../../includes/vsprvslong-md.md)] 및 [!INCLUDE[vsOrcas](../../includes/vsorcas-md.md)] 를 사용하여 SMO 응용 프로그램을 개발할 수 있습니다.  
...
## <a name="see-also"></a>관련 항목  
 [Visual C를 만들&#35; Visual Studio.NET에서에서 SMO 프로젝트](../../relational-databases/server-management-objects-smo/how-to-create-a-visual-csharp-smo-project-in-visual-studio-net.md)  
