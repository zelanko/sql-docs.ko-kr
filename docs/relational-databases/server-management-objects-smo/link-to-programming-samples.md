...
|CreateSPs|만드는 방법을 보여 줍니다는 **선택** 각 테이블에 대 한 프로시저는 선택한 데이터베이스에 저장 합니다.|  
...
|UtilityConversion|함께 사용할 **LoadRegAssembly**합니다. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]에서 사용하는 데모용 CLR(공용 언어 런타임) 함수를 포함합니다.|  
