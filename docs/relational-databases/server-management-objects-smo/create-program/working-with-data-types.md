...
-   <xref:Microsoft.SqlServer.Management.Smo.DataType> 클래스의 정적 멤버 중 하나를 사용 합니다 (예: **Int**). 이렇게 하면 실제로 <xref:Microsoft.SqlServer.Management.Smo.DataType> 개체의 인스턴스가 반환됩니다.  
 ...
 **참고** , 및 <xref:Microsoft.SqlServer.Management.Smo.UserDefinedDataType>XML 형식에는 모두 개체를 식별 하기 위한 이름 값이 필요 합니다. <xref:Microsoft.SqlServer.Management.Smo.UserDefinedType>  
