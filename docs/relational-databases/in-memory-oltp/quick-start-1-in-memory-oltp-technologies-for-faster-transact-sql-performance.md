...
manager: "jhubbard"
---
# 빠른 시작 1: 더 빠른 Transact-SQL 성능을 위한 메모리 내 OLTP 기술
...
- [Columnstore 인덱스 가이드](Columnstore%20Indexes%20Guide.xml)  
  
  
> [AZURE.NOTE] 메모리 내 기능에 대한 동영상(2분 소요)은 [Azure SQL Database - In-Memory Technologies](http://channel9.msdn.com/Blogs/Windows-Azure/Azure-SQL-Database-In-Memory-Technologies)(Azure SQL 데이터베이스 - 메모리 내 기술)에서 확인할 수 있습니다. 이 동영상은 2015년 12월에 발표되었습니다.  
...
컨테이너 간 트랜잭션에서 메모리 액세스에 최적화된 테이블에 대해 이 수준을 안정적으로 적용하려면 다음 T-SQL을 실행하여 [데이터베이스 설정을 변경](ALTER%20DATABASE%20SET%20Options%20%28Transact-SQL%29.xml)합니다.  
...
- [메모리 내 OLTP의 메모리 관리](Managing%20Memory%20for%20In-Memory%20OLTP.xml)  
...
- [메모리 액세스에 최적화된 테이블의 백업, 복원 및 복구](Backup,%20Restore,%20and%20Recovery%20of%20Memory-Optimized%20Tables.xml)  
