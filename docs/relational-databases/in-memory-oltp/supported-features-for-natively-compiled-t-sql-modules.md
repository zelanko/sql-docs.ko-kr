...
---
# 고유하게 컴파일된 T-SQL 모듈에 대해 지원되는 기능
...
##  <a name="a-nameqsancspa-query-surface-area-in-native-modules"></a><a name="qsancsp"></a> 네이티브 모듈의 쿼리 노출 영역  
...
[GROUP BY](../Topic/GROUP%20BY%20%28Transact-SQL%29.md) 절:

- AVG, COUNT, COUNT_BIG, MIN, MAX 및 SUM 집계 함수  

- MIN 및 MAX는 nvarchar, char, varchar, varchar, varbinary 및 binary 형식에 대해 지원되지 않습니다.  

[ORDER BY](../Topic/ORDER%20BY%20Clause%20%28Transact-SQL%29.md) 절:


- **ORDER BY** 절에서는 **DISTINCT** 가 지원되지 않습니다.


- ORDER BY 목록의 식이 GROUP BY 목록에 정확하게 나타나는 경우 [GROUP BY&#40;Transact-SQL&#41;](../Topic/GROUP%20BY%20\(Transact-SQL\).md)에서 지원됩니다.
...
##  <a name="a-namedmla-data-modification"></a><a name="dml"></a> 데이터 수정  
...
##  <a name="a-namecofa-control-of-flow-language"></a><a name="cof"></a> 흐름 제어 언어  
...
-   BEGIN ATOMIC(저장 프로시저의 외부 수준). 자세한 내용은 [Atomic Blocks](../../relational-databases/in-memory-oltp/기본-프로시저의-atomic-블록.md)을 참조하세요.  

##  <a name="a-namesoa-supported-operators"></a><a name="so"></a> 지원되는 연산자  
 지원되는 연산자는 다음과 같습니다.  
...
##  <a name="a-namebfncspa-built-in-functions-in-natively-compiled-modules"></a><a name="bfncsp"></a> 고유하게 컴파일된 모듈의 기본 제공 함수  
...
##  <a name="a-nameauditinga-auditing"></a><a name="auditing"></a> 감사  
...
##  <a name="a-nametqha-table-and-query-hints"></a><a name="tqh"></a> 테이블 및 쿼리 힌트  
 다음 항목이 지원됩니다.  

-   테이블 힌트 구문 또는 쿼리의 [OPTION 절&#40;Transact-SQL&#41;](../../t-sql/queries/option-clause-transact-sql.md)에 있는 INDEX, FORCESCAN 및 FORCESEEK 힌트. 자세한 내용은 [테이블 힌트&#40;Transact-SQL&#41;](../Topic/Table%20Hints%20\(Transact-SQL\).md)를 참조하세요.  
...
-   OPTIMIZE FOR  
 ...
 자세한 내용은 [쿼리 힌트&#40;Transact-SQL&#41;](../Topic/Query%20Hints%20\(Transact-SQL\).md)를 참조하세요.  

##  <a name="a-namelosa-limitations-on-sorting"></a><a name="los"></a> 정렬의 제한 사항  
 [TOP&#40;Transact-SQL&#41;](../../t-sql/queries/top-transact-sql.md) 및 [ORDER BY 절&#40;Transact-SQL&#41;](../Topic/ORDER%20BY%20Clause%20\(Transact-SQL\).md)을 사용하는 쿼리에서는 8,000개 이상의 행을 정렬할 수 있습니다. 하지만 [ORDER BY 절&#40;Transact-SQL&#41;](../Topic/ORDER%20BY%20Clause%20\(Transact-SQL\).md)이 없을 경우, [TOP&#40;Transact-SQL&#41;](../../t-sql/queries/top-transact-sql.md)은 최대 8,000개까지만 행을 정렬할 수 있습니다. 조인이 있으면 이러한 행 수가 더 줄어듭니다.  

 쿼리에서 [TOP&#40;Transact-SQL&#41;](../../t-sql/queries/top-transact-sql.md) 연산자와 [ORDER BY 절&#40;Transact-SQL&#41;](../Topic/ORDER%20BY%20Clause%20\(Transact-SQL\).md)을 모두 사용하는 경우 TOP 연산자에 대해 최대 8192행을 지정할 수 있습니다. 8192행보다 더 많이 지정하면 다음 오류 메시지가 나타납니다. **메시지 41398, 수준 16, 상태 1, 프로시저 *\<procedureName>*, 줄 *\<lineNumber>* TOP 연산자는 최대 8192개의 행을 반환할 수 있습니다. *\<숫자>*개가 요청되었습니다.**  
