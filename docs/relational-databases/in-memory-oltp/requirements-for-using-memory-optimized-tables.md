---
title: "메모리 액세스에 최적화된 테이블 사용을 위한 요구 사항 | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "11/16/2016"
...
[!INCLUDE[tsql-appliesto-ss2014-xxxx-xxxx-xxx_md](../../includes/tsql-appliesto-ss2014-xxxx-xxxx-xxx-md.md)]
 ...
 [SQL Server 2016 설치를 위한 하드웨어 및 소프트웨어 요구 사항](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md)외에 메모리 내 OLTP를 사용하기 위한 요구 사항은 다음과 같습니다.  
...
## <a name="important-notes-on-using-includehek2tokenhek2mdmd"></a>[!INCLUDE[hek_2](../../includes/hek-2-md.md)] 사용에 관한 중요 사항  
