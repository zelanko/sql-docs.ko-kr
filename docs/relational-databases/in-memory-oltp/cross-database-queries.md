---
title: "데이터베이스 간 쿼리 | Microsoft Docs"
ms.custom: ""
ms.date: "08/04/2016"
...
1. 테스트 개체를 만듭니다.  [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]에서 다음 [!INCLUDE[tsql](../../includes/tsql-md.md)] 명령을 실행합니다.  
...
2.  데이터베이스 간 쿼리를 시도합니다. [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]에서 다음 [!INCLUDE[tsql](../../includes/tsql-md.md)] 명령을 실행합니다.
...
3.  메모리 액세스에 최적화된 테이블 형식을 만듭니다.  [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]에서 다음 [!INCLUDE[tsql](../../includes/tsql-md.md)] 명령을 실행합니다.
