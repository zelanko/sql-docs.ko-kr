---
title: "ATOMIC 블록 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# 기본 프로시저의 Atomic 블록
  **BEGIN ATOMIC** 은 ANSI SQL 표준의 일부입니다. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 은(는) 고유하게 컴파일된 저장 프로시저와 고유하게 컴파일된 스칼라 사용자 정의 함수에 대해 최상위 수준에서 Atomic 블록을 지원합니다. 이러한 함수에 대한 자세한 내용은 [메모리 내 OLTP에 대한 사용자 정의 스칼라 함수](../../relational-databases/in-memory-oltp/scalar-user-defined-functions-for-in-memory-oltp.md)를 참조하세요.  
