...
## <a name="populating-data-and-delta-files"></a>데이터 및 델타 파일 채우기  
 ...
 ![메모리 액세스에 최적화된 테이블의 로그 레코드를 읽습니다.](../../relational-databases/in-memory-oltp/media/read-logs-hekaton.gif "Read log records for memory-optimized tables.")  
...
## <a name="merging-data-and-delta-files"></a>데이터 및 델타 파일 병합  
 ...
 ![다이어그램에서는 메모리 액세스에 최적화된 테이블 파일 그룹을 보여 줍니다.](../../relational-databases/in-memory-oltp/media/storagediagram-hekaton.png "Diagram shows memory optimized table file group")  
