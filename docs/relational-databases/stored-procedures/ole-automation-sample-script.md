---
title: "OLE 자동화 예제 스크립트 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# OLE 자동화 예제 스크립트
  이 항목에는 OLE 자동화 저장 프로시저를 사용하여 [!INCLUDE[ssDE](../../includes/ssde-md.md)]의 로컬 인스턴스에서 SQL-DMO SQLServer 개체를 만들고 사용하는 [!INCLUDE[tsql](../../includes/tsql-md.md)] 문 일괄 처리의 예가 포함되어 있습니다. 코드의 일부는 OLE 자동화 시스템 저장 프로시저에 대한 참조 항목에서 예로 사용됩니다.  
