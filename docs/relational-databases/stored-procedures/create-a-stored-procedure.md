...
-   **프로시저를 만들려면:** [SQL Server Management Studio](#SSMSProcedure), [Transact-SQL](#TsqlProcedure) 사용  
...
12. **프로시저 실행** 창에서 매개 변수 @LastName의 값으로 Margheim을 입력하고 매개 변수 @FirstName의 값으로 Diane을 입력합니다.  
