...
저장 프로시저나 함수가 실행되면 입력 매개 변수는 값을 상수로 설정하거나 변수의 값을 사용할 수 있습니다. 출력 매개 변수와 반환 코드는 값을 변수로 반환해야 합니다. 매개 변수와 반환 코드는 Transact-SQL 변수나 애플리케이션 변수와 데이터 값을 교환할 수 있습니다.
...
애플리케이션은 프로그램 변수에 바인딩된 매개 변수 표식을 사용하여 애플리케이션 변수, 매개 변수 및 반환 코드 간에 데이터를 교환할 수 있습니다.
