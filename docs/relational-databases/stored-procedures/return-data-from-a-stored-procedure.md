---
title: "저장 프로시저에서 데이터 반환 | Microsoft Docs"
ms.custom: ""
ms.date: "03/16/2017"
...
### Cursor Output 매개 변수의 예  
 다음 예에서는 **cursor** 데이터 형식을 사용하여 출력 매개 변수 `@currency`_`cursor`를 지정하는 프로시저가 생성됩니다. 그런 다음 일괄 처리로 프로시저가 호출됩니다.  
