---
title: Windows에 SQL Server Java 언어 확장 설치
titleSuffix: ''
description: SQL Server 설치 마법사를 실행하여 Windows 기반 SQL Server에 Java 언어 확장 기능을 설치하는 방법을 알아봅니다.
author: cawrites
ms.author: chadam
ms.date: 09/17/2020
ms.topic: conceptual
...
ms.locfileid: "92155558"
---
# <a name="install-sql-server-language-java-extensions-on-windows"></a>Windows에 SQL Server Java 언어 확장 설치
...
> [!NOTE]
> 이 문서는 Windows에서 SQL Server 언어 확장을 설치하는 데 사용합니다. Linux의 경우, [Linux에 SQL Server 2019 언어 확장(Java) 설치](../../linux/sql-server-linux-setup-language-extensions-java.md)를 참조하세요.
...
2. 제어판에서 **시스템 및 보안** , **시스템** 을 차례로 연 다음 **고급 시스템 속성** 을 선택합니다.
...
### <a name="optimize-the-server-for-language-extensions"></a>언어 확장을 위한 서버 최적화
