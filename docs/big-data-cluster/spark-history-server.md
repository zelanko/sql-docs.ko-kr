...
* [HDInsight에서 Spark 클러스터용 리소스 관리](https://docs.microsoft.com/en-us/azure/hdinsight/spark/apache-spark-resource-manager)
* [Spark 설정 구성](https://docs.microsoft.com/en-us/azure/hdinsight/spark/apache-spark-settings)
