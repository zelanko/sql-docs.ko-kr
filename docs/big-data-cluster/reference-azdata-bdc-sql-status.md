---
title: azdata bdc sql 상태 참조
titleSuffix: SQL Server big data clusters
description: Azdata bdc sql 상태 명령에 대 한 참조 문서입니다.
author: MikeRayMSFT
ms.author: mikeray
...
ms.locfileid: "70158258"
---
# <a name="azdata-bdc-sql-status"></a>azdata bdc sql 상태
...
|     |     |
| --- | --- |
[azdata bdc sql 상태 표시](#azdata-bdc-sql-status-show) | Sql server 서비스 상태입니다.
## <a name="azdata-bdc-sql-status-show"></a>azdata bdc sql 상태 표시
Sql server 서비스 상태입니다.
```bash
...
```
모든 인스턴스를 사용 하 여 sql 서비스의 상태를 가져옵니다.
```bash
