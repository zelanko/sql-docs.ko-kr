...
1. Kubernetes 클러스터에 연결하도록 kubectl을 구성하려면 [az aks get-credentials](/cli/azure/aks#az-aks-get-credentials) 명령을 실행합니다. 이 단계에서는 자격 증명을 다운로드하고 해당 자격 증명을 사용하도록 kubectl CLI를 구성합니다.
...
- [최신 Azure CLI](/cli/azure/install-azure-cli)를 설치했는지 확인합니다.
