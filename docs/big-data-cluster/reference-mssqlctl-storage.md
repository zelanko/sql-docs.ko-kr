...
ms.locfileid: "64775893"
---
# <a name="mssqlctl-storage"></a>mssqlctl 스토리지

[!INCLUDE[tsql-appliesto-ssver15-xxxx-xxxx-xxx](../includes/tsql-appliesto-ssver15-xxxx-xxxx-xxx.md)]

다음 문서에 대 한 참조를 제공 합니다 **저장소** 명령에 **mssqlctl** 도구입니다. 다른 방법에 대 한 자세한 내용은 **mssqlctl** 명령 참조 [mssqlctl 참조](reference-mssqlctl.md)합니다.

## <a name="commands"></a>명령
|     |     |
| --- | --- |
[mssqlctl 저장소 탑재](reference-mssqlctl-storage-mount.md) | HDFS의 원격 저장소의 탑재를 관리 합니다.
