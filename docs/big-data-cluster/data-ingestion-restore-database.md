...
description: 이 문서에서는 SQL Server 2019 빅 데이터 클러스터의 마스터 인스턴스에 데이터베이스를 복원하는 방법을 보여줍니다.
author: MikeRayMSFT
ms.author: mikeray
...
> [!TIP]
> [AdventureWorks 백업](../samples/adventureworks-install-configure.md)을 다운로드합니다.
