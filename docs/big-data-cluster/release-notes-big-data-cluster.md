...
2019 년 2 월 &nbsp; &nbsp;  /  &nbsp; &nbsp; SQL Server 2019 &nbsp; &nbsp;  /  &nbsp; &nbsp; CTP2.3
...
| _보안_ 끝점 이름이 변경 되었으며 통합 합니다. | _이전 끝점:_<br/> &nbsp; &nbsp; &nbsp; &bull; &nbsp; **service-security-lb**<br/> &nbsp; &nbsp; &nbsp; &bull; &nbsp; **service-security-nodeport**<br/><br/>_새 끝점:_<br/> &nbsp; &nbsp; &nbsp; &bull; &nbsp; **endpoint-security** |
| _프록시_ 끝점 이름이 변경 되었으며 통합 합니다. | _이전 끝점:_<br/> &nbsp; &nbsp; &nbsp; &bull; &nbsp; **service-proxy-lb**<br/> &nbsp; &nbsp; &nbsp; &bull; &nbsp; **service-proxy-nodeport**<br/><br/>_새 끝점:_<br/> &nbsp; &nbsp; &nbsp; &bull; &nbsp; **endpoint-service-proxy** |
| _컨트롤러_ 끝점 이름이 변경 되었으며 통합 합니다. | _이전 끝점:_<br/> &nbsp; &nbsp; &nbsp; &bull; &nbsp; **service-mssql-controller-lb**<br/> &nbsp; &nbsp; &nbsp; &bull; &nbsp; **service-mssql-controller-nodeport**<br/><br/>_새 끝점:_<br/> &nbsp; &nbsp; &nbsp; &bull; &nbsp; **endpoint-controller** |
| &nbsp; | &nbsp; |

### <a name="known-issues-deployment"></a>알려진 문제: 배포
...
### <a name="known-issues-kubeadm-deployments"></a>알려진 문제: kubeadm 배포
...
### <a id="mssqlctlctp23"></a> 알려진 문제: mssqlctl
...
### <a name="known-issues-external-tables"></a>알려진 문제: 외부 테이블
...
### <a name="known-issues-application-deployment"></a>알려진 문제: 응용 프로그램 배포

- R, Python 또는 MLeap 응용 프로그램에서 RESTful API를 호출할 때 호출에에서 시간 초과 5 분입니다.

### <a name="known-issues-spark-and-notebooks"></a>알려진 문제: Spark 및 notebook
...
### <a name="known-issues-hdfs"></a>알려진 문제: HDFS
...
### <a name="known-issues-security"></a>알려진 문제: 보안
