---
title: mssqlctl bdc 디버그 참조
titleSuffix: SQL Server big data clusters
description: Mssqlctl bdc 디버그 명령에 대 한 참조 문서입니다.
author: rothja
ms.author: jroth
manager: jroth
ms.date: 06/26/2019
...
ms.locfileid: "67394345"
---
# <a name="mssqlctl-bdc-debug"></a>mssqlctl bdc 디버그

[!INCLUDE[tsql-appliesto-ssver15-xxxx-xxxx-xxx](../includes/tsql-appliesto-ssver15-xxxx-xxxx-xxx.md)]

다음 문서에 대 한 참조를 제공 합니다 **bdc 디버그** 명령에 **mssqlctl** 도구입니다. 다른 방법에 대 한 자세한 내용은 **mssqlctl** 명령 참조 [mssqlctl 참조](reference-mssqlctl.md)합니다.
...
## <a name="mssqlctl-bdc-debug-dump"></a>mssqlctl bdc 디버그 덤프
