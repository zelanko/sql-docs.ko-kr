---
title: azdata bdc 상태 참조
titleSuffix: SQL Server big data clusters
description: Azdata bdc status 명령에 대 한 참조 문서입니다.
author: MikeRayMSFT
ms.author: mikeray
...
ms.locfileid: "68426053"
---
# <a name="azdata-bdc-status"></a>azdata bdc 상태

[!INCLUDE[tsql-appliesto-ssver15-xxxx-xxxx-xxx](../includes/tsql-appliesto-ssver15-xxxx-xxxx-xxx.md)]

다음 문서에서는 **azdata** 도구의 **bdc 상태** 명령에 대 한 참조를 제공 합니다. 다른 **azdata** 명령에 대 한 자세한 내용은 [azdata reference](reference-azdata.md)를 참조 하세요.

## <a name="commands"></a>명령
|     |     |
| --- | --- |
[azdata bdc 상태 표시](#azdata-bdc-status-show) | 빅 데이터 클러스터의 상태를 표시 합니다.
## <a name="azdata-bdc-status-show"></a>azdata bdc 상태 표시
빅 데이터 클러스터의 상태를 표시 합니다.
```bash
azdata bdc status show 
```
### <a name="examples"></a>예
사용자가 로그인 하는 BDC 상태입니다.
```bash
azdata bdc status show
```
