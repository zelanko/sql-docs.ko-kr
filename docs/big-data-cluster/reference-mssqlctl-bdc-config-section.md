---
title: mssqlctl bdc 구성 섹션 참조
titleSuffix: SQL Server big data clusters
description: Mssqlctl bdc 구성 섹션 명령에 대 한 참조 문서입니다.
author: rothja
ms.author: jroth
manager: jroth
ms.date: 06/26/2019
...
ms.locfileid: "67394405"
---
# <a name="mssqlctl-bdc-config-section"></a>mssqlctl bdc 구성 섹션

[!INCLUDE[tsql-appliesto-ssver15-xxxx-xxxx-xxx](../includes/tsql-appliesto-ssver15-xxxx-xxxx-xxx.md)]

다음 문서에 대 한 참조를 제공 합니다 **bdc 구성 섹션** 명령에 **mssqlctl** 도구입니다. 다른 방법에 대 한 자세한 내용은 **mssqlctl** 명령 참조 [mssqlctl 참조](reference-mssqlctl.md)합니다.
...
#### `--json-path -j`
구성 프로필의 cluster.json 파일, 즉 key1.key2.key3에서에서 섹션을 원하는 값을 발생 시키는 json 키 경로입니다. Jsonpath 쿼리 언어를 사용 하 여 https://github.com/h2non/jsonpath-ng 예:-j ' $. spec.pools [? ( @.spec.type "마스터" = =)]... 끝점 '
#### `--config-profile -c`
프로필 경로 구성 하는 BDC입니다.
...
## <a name="mssqlctl-bdc-config-section-set"></a>mssqlctl bdc 구성 섹션 집합
지정 된 json 경로 따라 선택한 구성 프로필에 지정된 된 섹션을 설정합니다.  모든 examplesbelow Bash에서 제공 됩니다.  다른 명령줄을 사용 하는 경우 주의 하십시오는 해야 할 수 있습니다 escapequotations 적절 하 게 합니다.  또는 패치 파일 기능을 사용할 수 있습니다.
```bash
