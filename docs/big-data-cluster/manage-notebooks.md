...
또한 사용자는 Notebook 외에, Jupyter Book이라는 Notebook 컬렉션을 볼 수 있습니다. Jupyter Book은 사용자가 SQL Server 문제를 해결하거나 클러스터 상태를 확인하기 위해 필요한 Notebook을 쉽게 찾을 수 있도록 Notebook 컬렉션을 탐색하기 위한 목차를 제공합니다.
