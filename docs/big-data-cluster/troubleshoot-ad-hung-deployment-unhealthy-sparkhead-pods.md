...
description: 비정상 `sparkhead` Pod가 있는 Active Directory 도메인에서 SQL Server 빅 데이터 클러스터 배포 중단 문제를 해결합니다.
author: macarv-ms
ms.author: macarv
ms.reviewer: mikeray
ms.date: 08/20/2020
...
## <a name="check-the-hdfs-and-sparkservices"></a>HDFS 및 Spark 서비스 확인 
...
:::image type="content" source="media/troubleshoot-ad-hung-deployment-unhealthy-sparkhead-pods/missing_reverse_lookup_zone_entry_for_domain_controller_add.png" alt-text="도메인 컨트롤러의 누락된 역방향 조회 영역 항목":::
