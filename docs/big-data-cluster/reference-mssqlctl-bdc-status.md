---
title: mssqlctl bdc 상태 참조
titleSuffix: SQL Server big data clusters
description: Mssqlctl bdc 상태 명령에 대 한 참조 문서입니다.
author: rothja
ms.author: jroth
manager: jroth
ms.date: 06/26/2019
...
ms.locfileid: "67394275"
---
# <a name="mssqlctl-bdc-status"></a>mssqlctl bdc 상태

[!INCLUDE[tsql-appliesto-ssver15-xxxx-xxxx-xxx](../includes/tsql-appliesto-ssver15-xxxx-xxxx-xxx.md)]

다음 문서에 대 한 참조를 제공 합니다 **bdc 상태** 명령에 **mssqlctl** 도구입니다. 다른 방법에 대 한 자세한 내용은 **mssqlctl** 명령 참조 [mssqlctl 참조](reference-mssqlctl.md)합니다.

## <a name="commands"></a>명령
|     |     |
| --- | --- |
[mssqlctl bdc 상태 표시](#mssqlctl-bdc-status-show) | 빅 데이터 클러스터의 상태를 보여 줍니다.
## <a name="mssqlctl-bdc-status-show"></a>mssqlctl bdc 상태 표시
빅 데이터 클러스터의 상태를 보여 줍니다.
```bash
mssqlctl bdc status show 
```
### <a name="examples"></a>예
여기서는 사용자가 로그인 하는 BDC 상태입니다.
```bash
mssqlctl bdc status show
```
