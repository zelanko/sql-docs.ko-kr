                                        ...
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="https://www.microsoft.com/download/details.aspx?id=55253">Power BI 보고서 서버 및 도구</a></li>
                                                </ul>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <ul>
                                                    <li><a href="/sql/linux/?toc=/sql/linux/toc.json">Linux의 SQL Server</a></li>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <ul>
                                                    <li><a href="/sql/connect/sql-server-driver-documentation">클라이언트 응용 프로그램을 사용하여 연결</a></li>
                                                ...
                                                <ul>
                                                    <li><a href="/sql/ssms/download-sql-server-management-studio-ssms">SSMS(SQL Server Management Studio)</a></li>
                                                    <li><a href="/sql/ssdt/download-sql-server-data-tools-ssdt">SSDT(SQL Server Data Tools)</a></li>
                                                    <li><a href="/sql/tools/command-prompt-utility-reference-database-engine">모든 SQL 도구 보기</a></li>
                                                </ul>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">마이그레이션 도구 다운로드</h4>
                                                <ul>
                                                ...
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">SQL Server 데이터베이스 마이그레이션</h4>
                                                <ul>
                                                    <li><a href="/azure/sql-database/sql-database-migrate-your-sql-server-database">Azure SQL Database로</a></li>
                                                    <li><a href="/azure/sql-data-warehouse/sql-data-warehouse-overview-migrate">Azure SQL Data Warehouse로</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
