...
layout: HubPage
hide_bc: true
title: "Microsoft SQL 문서 | Microsoft Docs"
                                        ...
                                        <div class="card">
                                            <div class="cardText">
                                                <div style="height:100px; border-bottom-color: #dbdbdb; border-bottom-width: 1px; border-bottom-style: solid; position: relative;">
                                                   <h3 style="bottom: 20px; color: rgb(110, 110, 110); font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif; font-size: 2rem; vertical-align: bottom; position: absolute;">데이터베이스</h3>
                                                </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">GitHub 샘플</h4>
                                                <ul>
                                                    <li><a href="https://github.com/Microsoft/sql-server-samples/tree/master/samples">코드 샘플</a></li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <div style="height:100px; border-bottom-color: #dbdbdb; border-bottom-width: 1px; border-bottom-style: solid; position: relative;">
                                                   <h3 style="bottom: 20px; color: rgb(110, 110, 110); font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif; font-size: 2rem; vertical-align: bottom; position: absolute;">데이터 분석</h3>
                                                </div>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">분석</h4>
                                                <ul>
                                                ...
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">보고</h4>
                                                <ul>
