                ...
                <ul id="main">
                        ...
                        <ul id="get-started" class="cardsW">
                            <li class="fullSpan">
                                <div class="container intro" style="color: #535353; font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif;">
                                    <p>Microsoft의 SQL 플랫폼에 대해 인기 있는 항목 및 다운로드 찾기</p>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <div style="height:100px; border-bottom-color: #dbdbdb; border-bottom-width: 1px; border-bottom-style: solid; position: relative;">
                                                   <h3 style="bottom: 20px; color: rgb(110, 110, 110); font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif; font-size: 2rem; vertical-align: bottom; position: absolute;">새로운 기능</h3>
                                                </div>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">SQL Server</h4>
                                                <ul>
                                                    <li><a href="/sql/sql-server/what-s-new-in-sql-server-2017">SQL Server 2017 미리 보기</a></li>
                                                    <li><a href="https://docs.microsoft.com/sql/reporting-services/what-s-new-in-sql-server-reporting-services-ssrs">SQL Server 2017 Reporting Services 미리 보기</a></li>
                                                    <li><a href="/sql/linux/sql-server-linux-whats-new">Linux의 SQL Server</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <div style="height:100px; border-bottom-color: #dbdbdb; border-bottom-width: 1px; border-bottom-style: solid; position: relative;">
                                                   <h3 style="bottom: 20px; color: rgb(110, 110, 110); font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif; font-size: 2rem; vertical-align: bottom; position: absolute;">탐색</h3>
                                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <div style="height:100px; border-bottom-color: #dbdbdb; border-bottom-width: 1px; border-bottom-style: solid; position: relative;">
                                                   <h3 style="bottom: 20px; color: rgb(110, 110, 110); font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif; font-size: 2rem; vertical-align: bottom; position: absolute;">다운로드 및 설치</h3>
                                                </div>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">SQL Server</h4>
                                                <ul>
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="https://www.microsoft.com/download/details.aspx?id=55329">Power BI 보고서 서버 및 도구</a></li>
                                                </ul>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">예제 데이터베이스</h4>
                                                <ul>
                                                    <li><a href="https://github.com/Microsoft/sql-server-samples/releases/tag/wide-world-importers-v1.0">Wide World Importers 예제 데이터베이스</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        ...
                        <ul id="databases" class="cardsW">
                            <li class="fullSpan">
                                <div class="container intro" style="color: #535353; font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif;">
                                    <p>데이터 센터 또는 Azure에서 SQL 데이터베이스를 사용하여 관계형 데이터 관리</p>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">최신 버전</h4>
                                                <ul>
                                                ...
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">Windows 또는 Linux에서 실행</h4>
                                                <ul>
                                                    <li><a href="/sql/linux/sql-server-linux-overview">Linux의 SQL Server</a></li>
                                                    <li><a href="/azure/virtual-machines/linux/">Linux 가상 컴퓨터</a></li>
                                                    <li><a href="/azure/virtual-machines/windows/">Windows 가상 컴퓨터</a></li>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <ul>
                                                    <li><a href="/azure/postgresql/">PostgreSQL용 Azure 데이터베이스</a></li>
                                                    <li><a href="/azure/mysql/">MySQL용 Azure 데이터베이스</a></li>
                                                </ul>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <div style="height:100px; border-bottom-color: #dbdbdb; border-bottom-width: 1px; border-bottom-style: solid; position: relative;">
                                                   <h3 style="bottom: 20px; color: rgb(110, 110, 110); font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif; font-size: 2rem; vertical-align: bottom; position: absolute;">개발</h3>
                                                </div>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">디자인</h4>
                                                <ul>
                                                    <li><a href="/sql/connect/sql-connection-libraries">클라이언트 응용 프로그램을 사용하여 연결</a></li>
                                                    <li><a href="/sql/relational-databases/database-features">관계형 데이터베이스 개념</a></li>
                                                </ul>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">Tools</h4>
                                                <ul>
                                                    <li><a href="/sql/ssms/download-sql-server-management-studio-ssms">SSMS(SQL Server Management Studio)</a></li>
                                                    <li><a href="/sql/ssdt/download-sql-server-data-tools-ssdt">SSDT(SQL Server Data Tools)</a></li>
                                                    <li><a href="/sql/tools/overview-sql-tools">모든 SQL 도구 보기</a></li>
                                                </ul>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">참조</h4>
                                                <ul>
                    ...
                    <li>
                        <a href="#movement">데이터 이동</a>
                        <ul id="movement" class="cardsW">
                            <li class="fullSpan">
                                <div class="container intro" style="color: #535353; font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif;">
                                    <p>데이터베이스 마이그레이션 또는 데이터베이스 간 데이터 이동</p>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <div style="height:135px; border-bottom-color: #dbdbdb; border-bottom-width: 1px; border-bottom-style: solid; position: relative;">
                                                   <h3 style="bottom: 20px; color: rgb(110, 110, 110); font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif; font-size: 2rem; vertical-align: bottom; position: absolute;">데이터베이스 마이그레이션</h3>
                                                </div>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">SQL Server 데이터베이스 업그레이드</h4>
                                                <ul>
                                                    <li><a href="https://www.microsoft.com/en-us/download/details.aspx?id=54090">데이터베이스 실험 도우미</a></li> 
                                                </ul>
                                                ...
                                                <ul>
                                                    <li><a href="/azure/sql-database/sql-database-migrate-your-sql-server-database">Azure SQL Database로 마이그레이션</a></li>
                                                    <li><a href="/azure/sql-data-warehouse/sql-data-warehouse-overview-migrate">Azure SQL Warehouse로 마이그레이션</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <div style="height:135px; border-bottom-color: #dbdbdb; border-bottom-width: 1px; border-bottom-style: solid; position: relative;">
                                                   <h3 style="bottom: 20px; color: rgb(110, 110, 110); font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif; font-size: 2rem; vertical-align: bottom; position: absolute;">데이터 준비를 위해 Azure Storage로 데이터 이동</h3>
                                                </div>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">네트워킹</h4>
                                                <ul>
                                                    <li><a href="/azure/networking/networking-overview">개요</a></li>
                                                    <li><a href="/azure/networking/networking-overview">ExpressRoute</a></li>
                                                </ul>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">Azure Blob Storage로 이동</h4>
                                                <ul>
                                                    <li><a href="/azure/vs-azure-tools-storage-manage-with-storage-explorer">Azure Storage 탐색기</a></li>
                                                    <li><a href="/azure/storage/storage-use-azcopy">AZCopy</a></li>
                                                    <li><a href="/azure/storage/storage-import-export-service">Import-Export 서비스</a></li>
                                                    <li>
                                                        <a href="/sql/integration-services/sql-server-integration-services"> SSIS(SQL Server Integration Services) </a>
                                                    </li>
                                                </ul>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">Azure Data Lake Store로 이동</h4>
                                                <ul>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <div style="height:135px; border-bottom-color: #dbdbdb; border-bottom-width: 1px; border-bottom-style: solid; position: relative;">
                                                   <h3 style="bottom: 20px; color: rgb(110, 110, 110); font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif; font-size: 2rem; vertical-align: bottom; position: absolute;">데이터베이스로 데이터 이동</h3>
                                                </div>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">SQL</h4>
                                                <ul>
                                                    <li><a href="/sql/integration-services/sql-server-integration-services">SQL Server Integration Services</a></li>
                                                    <li><a href="/sql/relational-databases/polybase/polybase-guide">PolyBase</a></li>
                                                    <li><a href="https://msdn.microsoft.com/en-us/library/system.data.sqlclient.sqlbulkcopy(v=vs.110).aspx">SqlBulkCopy 클래스</a></li>
                                                    <li><a href="/sql/tools/bcp-utility">BCP</a></li>
                                                </ul>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">NoSQL</h4>
                                                <ul>
                                                    <li><a href="/azure/documentdb/documentdb-import-data">Azure Cosmos DB로 데이터 가져오기</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        ...
                        <ul id="analytics" class="cardsW">
                            <li class="fullSpan">
                                <div class="container intro" style="color: #535353; font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif;">
                                    <p>기계 학습 및 분석을 사용하여 SQL 데이터에 대한 정보 얻기</p>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">기계 학습</h4>
                                                <ul>
                                                    <li><a href="https://docs.microsoft.com/sql/advanced-analytics/r/r-services">SQL Server 컴퓨터 학습 서비스</a></li>
                                                    <li><a href="https://docs.microsoft.com/sql/advanced-analytics/r/r-server-standalone">Machine Learning Server(독립 실행형)</a></li>
                                                </ul>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="https://azuremarketplace.microsoft.com/en-us/marketplace/apps/microsoft-ads.standard-data-science-vm">데이터 과학 가상 컴퓨터</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <ul>
                                                    <li><a href="https://powerbi.microsoft.com/en-us/documentation/powerbi-service-get-started/">Power BI 서비스</a></li>
                                                    <li><a href="https://powerbi.microsoft.com/en-us/documentation/powerbi-desktop-get-the-desktop/">Power BI Desktop</a></li>
                                                    <li><a href="https://powerbi.microsoft.com/en-us/documentation/powerbi-power-bi-apps-for-mobile-devices/">Power BI 모바일 앱</a></li>
                                                    <li><a href="https://powerbi.microsoft.com/en-us/documentation/powerbi-developer-overview-of-power-bi-rest-api/">Power BI 개발자</a></li>
                                                    <li><a href="https://powerbi.microsoft.com/en-us/documentation/reportserver-get-started/">Power BI 보고서 서버</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
