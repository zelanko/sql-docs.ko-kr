...
##  <a name="using-reference-data-directly-from-the-third-party-reference-data-providers"></a><a name="Direct"></a> 타사 참조 데이터 공급자를 통해 직접 참조 데이터 사용  
...
##  <a name="how-to-cleanse-data-by-using-the-reference-data"></a><a name="HowToCleanse"></a> 참조 데이터를 사용하여 데이터를 정리하는 방법  
