...
3.  **정리** 페이지에서 **시작**을 클릭하여 컴퓨터 기반 정리 프로세스를 실행합니다. 정리 프로세스가 끝난 후 **다음**을 클릭합니다.  
    ...
    >   
    >  -   **시작** 단추 아래에 “Domains \<Domain1>, \<Domain2>,… \<DomainN>이 참조 데이터 서비스 공급자를 사용하여 정리됩니다.”라는 메시지가 표시됩니다. 이 예에서는 다음 메시지가 표시됩니다. “Address Verification 도메인이 참조 데이터 서비스 공급자를 사용하여 정리됩니다.”  
