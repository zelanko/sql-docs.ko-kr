...
3.  작업 모니터링 화면의 작업 표에 각 작업에 대한 정보가 표시됩니다. 작업 표에는 각 DQS 작업에 대해 다음 정보가 표시됩니다.  
    ...
    -   **종료**: 작업을 종료 작업 모니터링 화면을 사용 하 여 DQS 관리자가 또는 활동의 각 기능 영역에서 실행 하는 동안 사용자가 취소 되었습니다 [!INCLUDE[ssDQSClient](../includes/ssdqsclient-md.md)]합니다.  
  
     **형식**: 작업의 유형을 나타냅니다. **하위 유형** 은 작업 유형에 대해 실행되는 특정 워크플로를 나타냅니다. 모니터링되는 작업의 유형은 다음과 같습니다.  
