...
# [열기, 잠금 해제, 이름 바꾸기 및 데이터 품질 프로젝트를 삭제 합니다.](열기-잠금-해제-이름-바꾸기-및-데이터-품질-프로젝트를-삭제-합니다.md)
...
# [데이터 품질 클라이언트에서 Integration Services 프로젝트 열기](open-integration-services-projects-in-data-quality-client.md)
...
# [Data Quality Services 기능 및 태스크](data-quality-services-features-and-tasks.md)
...
# [데이터 품질 클라이언트 홈 화면](data-quality-client-home-screen.md)
...
# [Data Quality 클라이언트 응용 프로그램](data-quality-client-application.md)
...
# [데이터 품질 클라이언트 응용 프로그램 실행](run-the-data-quality-client-application.md)
