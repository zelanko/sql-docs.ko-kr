...
## <a name="installing-the-data-quality-client-application"></a>데이터 품질 클라이언트 애플리케이션 설치  
  ...
  [!INCLUDE[ssDQSClient](../includes/ssdqsclient-md.md)] 애플리케이션 설치에 대한 자세한 내용은 [Data Quality Services 설치](../data-quality-services/install-windows/install-data-quality-services.md)를 참조하세요.  
