...
---
# 도메인 관리: 도메인 목록
  이 항목의 도메인 목록에 있는 컨트롤에 설명 된 **도메인 관리** 페이지에서 [!INCLUDE[ssDQSnoversion](../includes/ssdqsnoversion-md.md)] (DQS). 이 창에서 관리 작업을 수행할 도메인을 선택할 수 있습니다. **도메인 관리** 페이지의 모든 탭 페이지에도 동일한 창이 사용됩니다.  
 ...
 **선택한 도메인의 복사본 만들기**  
 선택한 도메인의 정확한 복사본을 만들고 기술 자료에 추가합니다. 복사본의 이름은 원본 도메인의 이름에 " – 복사"를 추가한 형태입니다. 이 명령은 사용할 수 있거나 도메인을 마우스 오른쪽 단추로 클릭 한 다음 클릭 하 여 **복사본을 만들고**, 하거나 도메인 목록 위의 아이콘을 클릭 하 여 합니다. 복합 도메인에 대해서는 사용할 수 없습니다.  
 ...
 **연결된 도메인 만들기**  
 선택한 도메인에 연결된 도메인을 만듭니다. 이 명령은 **도메인 만들기** 대화 상자를 표시합니다. 이 명령은 도메인을 마우스 오른쪽 단추로 클릭 한 다음 클릭 하 여 사용할 수는 **연결 된 도메인 만들기** 선택한 도메인에 연결 되어 있는 합니다. 연결을 설정할 도메인이 도메인 만들기 대화 상자에 표시됩니다. 이 명령은 복합 도메인에 대해 사용할 수 없습니다. 두 도메인의 연결을 해제하는 데 사용할 수 있는 명령은 없습니다. 그렇게 하려면 연결된 도메인을 삭제하십시오. 연결된 도메인은 연결된 도메인으로 만들 수 없습니다. 자세한 내용은 [Create a Linked Domain](../data-quality-services/create-a-linked-domain.md)을 참조하세요.  
 ...
 **도메인 내보내기**  
 도메인을.dqs 파일로 내보냅니다. 이 명령은 **데이터 파일로 내보내기** 대화 상자를 표시합니다. 이 명령은에서 사용할 수는 **내보내기** 도메인 목록 창에서 마우스 오른쪽 단추로 클릭 하거나 페이지의 맨 위에 있는 메뉴 모음에서 메뉴. 자세한 내용은 [Export a Domain to a .dqs File](../data-quality-services/export-a-domain-to-a-dqs-file.md)을 참조하세요.  
