...
-   **국가/지역(3자 선행)**: 각 위치에 대해 규칙에 따른 긴 이름(국가/지역으로 지정된 공식 이름)과 짧은 이름(지도의 목록 등에 사용되는 일반 이름), 2자 약어, 3자 약어 및 3자리 코드를 포함합니다.  선행 값은 국가의 3자 약어로 설정됩니다.  
...
-   **미국 - 주(2자 선행)**: 미국의 각 주에 대해 규칙에 따른 긴 이름(공식)과 2자 약어를 포함합니다. 선행 값은 주 이름의 2자 약어로 설정됩니다.  
