...
##  <a name="perform-knowledge-discovery"></a><a name="Discovery"></a> 기술 자료 검색 수행  
...
##  <a name="import-knowledge-from-an-excel-file"></a><a name="Excel"></a> Excel 파일에서 정보 가져오기  
...
##  <a name="import-knowledge-from-a-project-back-into-the-knowledge-base"></a><a name="Project"></a> 프로젝트에서 다시 기술 자료로 정보 가져오기  
...
##  <a name="use-the-default-dqs-knowledge-base"></a><a name="Default"></a> 기본 DQS 기술 자료 사용  
