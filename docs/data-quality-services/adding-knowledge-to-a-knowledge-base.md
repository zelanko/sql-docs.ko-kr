...
-   자세한 내용은 설명서를 참조 하십시오. [.dqs 파일에서에서 도메인 가져오기](../data-quality-services/import-a-domain-from-a-dqs-file.md) 또는 [.dqs 파일에서에서 기술 자료를 가져올](../data-quality-services/import-a-knowledge-base-from-a-dqs-file.md)합니다.  
...
-   자세한 내용은 설명서를 참조 하십시오. [도메인으로 Excel 파일에서 값 가져오기](../data-quality-services/import-values-from-an-excel-file-into-a-domain.md) 또는 [기술 자료 검색에서 Excel 파일에서 가져오기 도메인](../data-quality-services/import-domains-from-an-excel-file-in-knowledge-discovery.md)합니다.  
...
-   자세한 내용은 설명서를 참조 하십시오. [정리 프로젝트 값 가져오기 도메인으로](../data-quality-services/import-cleansing-project-values-into-a-domain.md)합니다.  
