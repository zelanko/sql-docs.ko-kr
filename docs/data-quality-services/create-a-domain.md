...
##  <a name="create-a-domain-in-the-knowledge-discovery-activity"></a><a name="Discovery"></a> 기술 자료 검색 작업에서 도메인 만들기  
...
10. **마침** 을 클릭하여 [도메인 관리 작업 종료](https://msdn.microsoft.com/library/ab6505ad-3090-453b-bb01-58435e7fa7c0)에 설명된 대로 도메인 관리 작업을 완료합니다.  
  
##  <a name="follow-up-after-creating-a-domain"></a><a name="FollowUp"></a> 후속 작업: 도메인을 만든 후  
