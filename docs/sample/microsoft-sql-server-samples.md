...
GitHub에 맞도록 https://github.com/microsoft/sql-server-samples 이동한 다음 리포지토리 분기 합니다. 자신의 분기에서 작업 하 고 변경 하거나 처음으로 샘플에 게시에 제출할 준비가 되 면 sql-서버-샘플의 마스터 분기에 끌어오기 요청을 제출 합니다. 요청을 검토 하 고 수락 또는 끌어오기 요청을 거부 됩니다 승인자 중 하나입니다.
