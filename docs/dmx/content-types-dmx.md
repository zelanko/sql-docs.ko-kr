...
[!INCLUDE[ssas-appliesto-sqlas](../includes/ssas-appliesto-sqlas.md)]
 ...
 에서 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 지 원하는 콘텐츠 형식에 대 한 자세한 설명은 [콘텐츠 &#40;형식 데이터 마이닝&#41;](https://docs.microsoft.com/analysis-services/data-mining/content-types-data-mining)을 참조 하세요.  
