...
-   [DROP 마이닝 model](../dmx/drop-mining-model-dmx.md) 문을 사용 하 여 데이터베이스에서 마이닝 모델을 완전히 제거 합니다. [DROP 마이닝 structure](../dmx/drop-mining-structure-dmx.md) 문을 사용 하 여 데이터베이스에서 마이닝 구조 및 연결 된 모든 마이닝 모델을 완전히 제거 합니다.  
 ...
 [DMX 문으로 돌아가기](#BKMK_DMXStatements)  
...
-   SELECT 문을 확장 하 여 원본 데이터의 통계와 같이 모델 학습 중에 계산 되 고 데이터 마이닝 모델에 저장 되는 정보를 검색 합니다. SELECT 문의 기능을 확장 하기 위해 포함할 수 있는 절은 다음과 같습니다.  
    ...
    -   [&#62; 모델 &#40;DMX에서 &#60;고유 선택&#41;](../dmx/select-distinct-from-model-dmx.md)  
  
    -   [모델&#62;에서 &#60;선택 합니다. 콘텐츠 &#40;DMX&#41;](../dmx/select-from-model-content-dmx.md)  
  
    -   [모델&#62;에서 &#60;선택 합니다. 사례 &#40;DMX&#41;](../dmx/select-from-model-cases-dmx.md)  
  
    -   [모델&#62;에서 &#60;선택 합니다. SAMPLE_CASES &#40;DMX&#41;](../dmx/select-from-model-sample-cases-dmx.md)  
  
    -   [모델&#62;에서 &#60;선택 합니다. DIMENSION_CONTENT &#40;DMX&#41;](../dmx/select-from-model-dimension-content-dmx.md)  
 ...
 **자세한 정보** **정보:**   [Dmx Select 문 이해](../dmx/understanding-the-dmx-select-statement.md), [일반 예측 함수 &#40;dmx&#41;](../dmx/general-prediction-functions-dmx.md), [dmx 예측 쿼리의 구조 및 사용](../dmx/structure-and-usage-of-dmx-prediction-queries.md), [데이터 마이닝 확장 &#40;dmx&#41; 함수 참조](../dmx/data-mining-extensions-dmx-function-reference.md)  
