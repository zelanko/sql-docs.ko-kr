...
ms.locfileid: "68008108"
---
# <a name="-positive-dmx"></a>+(양수)(DMX)
[!INCLUDE[ssas-appliesto-sqlas](../includes/ssas-appliesto-sqlas.md)]

  숫자 식의 양수 값을 반환하는 단항 연산을 수행합니다.  
