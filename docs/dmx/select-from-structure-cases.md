...
## <a name="examples"></a>예제  
 다음 예는 [!INCLUDE[ssAWDWsp](../includes/ssawdwsp-md.md)] 데이터베이스 및 연결 된 마이닝 모델을 기반으로 하는 대상 메일링 인 마이닝 구조를 기반으로 합니다. 자세한 내용은 [기본 데이터 마이닝 자습서](/previous-versions/sql/sql-server-2016/ms167167(v=sql.130))를 참조 하세요.  
