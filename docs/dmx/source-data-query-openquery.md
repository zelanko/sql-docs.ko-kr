 ...
 *명명 된 데이터 원본*  
 데이터베이스에 [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 있는 데이터 원본입니다.[!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)]  
