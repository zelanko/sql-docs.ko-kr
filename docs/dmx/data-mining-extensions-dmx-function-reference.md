---
title: DMX (데이터 마이닝 확장) 함수 참조 | Microsoft Docs
ms.date: 06/07/2018
ms.prod: sql
...
|[DMX &#40;DMX&#41;](../dmx/exists-dmx.md)|지정된 SELECT 문에서 반환한 결과 집합에 하나 이상의 행이 들어 있으면 true를 반환합니다.|  
...
|[DMX &#40;DMX&#41;](../dmx/lag-dmx.md)|현재 사례의 날짜와 데이터의 마지막 날짜 간의 시간 조각을 반환합니다.|  
|[&#40;DMX&#41;예측](../dmx/predict-dmx.md)|지정된 열에서 예측을 수행합니다.|  
