---
title: "SQL Server Profiler를 사용하여 교착 상태 분석 | Microsoft Docs"
ms.custom: ""
ms.date: "03/03/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "프로세스 노드 [SQL Server Profiler]"
  - "프로파일러 [SQL Server 프로파일러], 교착 상태"
  - "교착 상태 [SQL Server], 원인 식별"
  - "리소스 노드 [SQL Server Profiler]"
  - "그래프 [SQL Server Profiler]"
  - "SQL Server 프로파일러, 교착 상태"
  - "이벤트 [SQL Server], 교착 상태"
  - "가장자리 [SQL Server Profiler]"
