---
title: "추적과 Windows 성능 로그 데이터의 상관 관계 지정(SQL Server Profiler) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# 추적과 Windows 성능 로그 데이터의 상관 관계 지정(SQL Server Profiler)
