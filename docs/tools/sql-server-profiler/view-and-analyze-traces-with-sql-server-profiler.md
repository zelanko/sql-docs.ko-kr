...
ms.topic: "article"
helpviewer_keywords: 
  - "프로파일러 [SQL Server 프로파일러], 추적 보기"
  - "SQL Server 프로파일러, 추적 보기"
  - "추적 [SQL Server], 보기"
  - "SQL Server 프로파일러, 문제 해결"
  - "문제 해결 [SQL Server], 추적"
  - "이벤트 [SQL Server], 추적 내부에서 찾기"
  - "프로파일러 [SQL Server 프로파일러], 문제 해결"
  - "추적 [SQL Server], 이벤트"
...
2.  대상 이벤트를 찾습니다.  
    ...
    -   추적 파일이나 테이블을 열고 **Deadlock Chain**과 같은 원하는 이벤트 클래스의 노드를 확장하십시오. 자세한 내용은 [추적 파일 열기&#40;SQL Server Profiler&#41;](../../tools/sql-server-profiler/open-a-trace-file-sql-server-profiler.md) 또는 [추적 테이블 열기&#40;SQL Server Profiler&#41;](../../tools/sql-server-profiler/open-a-trace-table-sql-server-profiler.md)를 참조하세요.  
