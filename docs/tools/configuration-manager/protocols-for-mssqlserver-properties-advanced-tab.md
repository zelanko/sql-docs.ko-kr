...
- **필요한**:는 허용할 연결의 경우에 야 보호 된 응용 프로그램에서 보호 된 운영 체제를 의미 합니다. 이 설정은 세 가지 옵션 중 가장 안전 합니다. 그러나 **확장 된 보호** 를 지원 하지 않는 운영 체제에서 연결 하는 경우에는에 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]연결할 수 없습니다.
