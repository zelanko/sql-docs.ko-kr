...
# [<server>에 대한 프로토콜(SQL Server 구성 관리자)](protocols-for-server-sql-server-configuration-manager.md)
...
# [NS$<서비스 이름> 속성(고급 탭)](ns-service-name-properties-advanced-tab.md)
...
# [NS$<service name> 속성(탭의 로그)](ns-service-name-properties-log-on-tab.md)
