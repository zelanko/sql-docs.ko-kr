---
title: SQL 전체 텍스트 필터 데몬 시작 관리자(로그온 탭)
description: SQL Server 전체 텍스트 검색에서 사용하는 SQL 전체 텍스트 필터 데몬 시작 관리자에 대해 알아봅니다. 속성 대화 상자의 로그온 탭에 대해 알아봅니다.
