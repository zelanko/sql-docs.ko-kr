...
# TCP/IP Properties (IP Addresses Tab)
 ...
 변경 내용은 SQL Server를 다시 시작할 때 적용됩니다. SQL Server Browser 서비스를 시작 및 중지하는 방법은 [SQL Server Browser 서비스 시작 및 중지](https://msdn.microsoft.com/library/hh403394.aspx)를 참조하세요.  
