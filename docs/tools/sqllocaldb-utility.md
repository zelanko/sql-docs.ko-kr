...
description: 사용자와 개발자는 SqlLocalDB 유틸리티 명령줄 도구를 사용하여 SQL Server Express LocalDB 인스턴스를 만들고 관리할 수 있습니다.
