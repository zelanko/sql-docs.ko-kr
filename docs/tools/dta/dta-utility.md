...
ms.topic: "article"
helpviewer_keywords: 
  - "물리적 디자인 구조 [SQL Server]"
  - "명령 프롬프트 유틸리티 [SQL Server], dta"
  - "dta 유틸리티"
  - "데이터베이스 튜닝 [SQL Server], 데이터베이스 엔진 튜닝 관리자"
  - "작업 [SQL Server], 분석"
  - "dta 유틸리티, dta 유틸리티 정보"
  - "성능 [SQL Server], 데이터베이스 엔진 튜닝 관리자"
  - "데이터베이스 엔진 튜닝 관리자 [SQL Server], 명령 프롬프트"
  - "데이터베이스 최적화 [SQL Server]"
