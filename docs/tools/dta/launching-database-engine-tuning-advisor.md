...
applies_to: 
  - "SQL Server 2016"
helpviewer_keywords: 
  - "데이터베이스 튜닝 [SQL Server]"
  - "데이터베이스 엔진 튜닝 관리자 [SQL Server], 시작"
...
> [!NOTE]  
> [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 쿼리 편집기에서 [!INCLUDE[tsql](../../includes/tsql-md.md)] 스크립트를 가져올 때 데이터베이스 엔진 튜닝 관리자에서 XML 파일을 입력으로 사용할 수 있습니다. 자세한 내용은 [데이터베이스 엔진 튜닝 관리자 시작 및 사용](../../relational-databases/performance/start-and-use-the-database-engine-tuning-advisor.md)의 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 쿼리 편집기에서 데이터베이스 엔진 튜닝 관리자 시작에 대한 섹션을 참조하세요.  
  
## 단원의 다음 태스크  
[도구 옵션 및 레이아웃 설정](../../tools/dta/setting-tool-options-and-layout.md)  
