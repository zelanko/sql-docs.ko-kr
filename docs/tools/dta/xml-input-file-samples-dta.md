...
-   [단순 XML 입력된 파일 예제 &#40; DTA &#41;](../../tools/dta/simple-xml-input-file-sample-dta.md)  
  
-   [인라인 작업 &#40; DTA &#41; 포함 된 XML 입력된 파일 예제](../../tools/dta/xml-input-file-sample-with-inline-workload-dta.md)  
  
-   [사용자가 지정한 configuration&#40; DTA &#41; 포함 된 XML 입력된 파일 예제](../../tools/dta/xml-input-file-sample-with-user-specified-configuration-dta.md)  
