...
helpviewer_keywords: 
  ...
  - "테이블 [SQL Server 복제]"
  - "테이블 비교 [SQL Server]"
  - "명령 프롬프트 유틸리티 [SQL Server], tablediff"
  - "문제 해결 [SQL Server 복제], 불일치"
  - "불일치 [SQL Server]"
 ...
 **-sourceserver** *source_server_name*[**\\***instance_name*]  
 원본 서버의 이름입니다. [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]의 기본 인스턴스에 대해 *source_server_name*을 지정합니다. [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]의 명명된 인스턴스에 대해 *source_server_name***\\***instance_name*을 지정합니다.  
 ...
 **-destinationserver** *destination_server_name*[**\\***instance_name*]  
 대상 서버의 이름입니다. [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]의 기본 인스턴스에 대해 *destination_server_name*을 지정합니다. [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]의 명명된 인스턴스에 대해 *destination_server_name***\\***instance_name*을 지정합니다.  
 ...
 **-bf**  *number_of_statements*  
 **-f** 옵션을 사용할 경우 현재 [!INCLUDE[tsql](../includes/tsql-md.md)] 스크립트 파일에 쓸 [!INCLUDE[tsql](../includes/tsql-md.md)] 문의 수입니다. [!INCLUDE[tsql](../includes/tsql-md.md)] 문의 수가 *number_of_statements*를 초과하면 새 [!INCLUDE[tsql](../includes/tsql-md.md)] 스크립트 파일이 생성됩니다.  
