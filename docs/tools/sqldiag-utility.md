...
ms.topic: "article"
helpviewer_keywords: 
  - "명령 프롬프트 유틸리티 [SQL Server], SQLdiag"
  - "진단 정보 수집 중지"
  - "진단 정보 저장"
  - "성능 [SQL Server], 진단 정보 수집"
  - "진단 레코드 [SQL Server]"
  - "스크립트 [SQL Server], 진단 정보 수집"
  - "로그 [SQL Server], 진단 정보 수집"
  - "진단 정보 수집 시작"
  - "SQL Server의 클러스터형 인스턴스"
  - "성능 모니터링 [SQL Server], 진단 정보 수집"
  - "보안 [SQL Server], 진단 정보 수집"
  - "SQLDIAG 서비스"
  - "공간 [SQL Server], 진단 정보 수집"
  - "SQLdiag 유틸리티"
  - "디스크 공간 [SQL Server], 진단 정보 수집"
  - "구성 파일 [SQL Server]"
  - "자동 진단 정보 수집"
  - "클러스터 [SQL Server], 진단 정보 수집"
 ...
 **/A**  *SQLdiag_application_name*  
 동일한 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 인스턴스에 대해 여러 **SQLdiag** 유틸리티 인스턴스를 실행할 수 있도록 합니다.  
 ...
 **/G**를 지정하지 않으면 **SQLdiag**에서 사용자가 Windows **Administrators** 그룹의 멤버인지 확인하고 **Administrators** 그룹 멤버가 아닐 경우 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 진단 정보를 수집하지 않습니다.  
