---
title: "등록된 서버 또는 등록된 서버 그룹 이름 변경(SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "11/16/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "등록된 서버 또는 서버 그룹 이름 수정"
  - "서버 그룹 [SQL Server]"
  - "등록된 서버 [SQL Server], 이름"
  - "등록된 서버 또는 서버 그룹 이름 바꾸기"
  - "이름 [SQL Server], 등록된 서버 또는 서버 그룹"
...
manager: "jhubbard"
---
# 등록된 서버 또는 등록된 서버 그룹 이름 변경(SQL Server Management Studio)
