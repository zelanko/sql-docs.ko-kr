---
title: "중앙 관리 서버 및 서버 그룹 만들기(SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# 중앙 관리 서버 및 서버 그룹 만들기(SQL Server Management Studio)
...
5.  **연결 속성** 탭에서 네트워크 및 연결 속성을 검토하거나 수정합니다. 자세한 내용은 [서버에 연결&#40;연결 속성 페이지&#41; 데이터베이스 엔진](../../ssms/f1-help/connect-to-server-connection-properties-page-database-engine.md)을 참조하세요.  
  
6.  **테스트**를 클릭하여 연결을 테스트합니다.  
  
7.  **저장**을 클릭합니다. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 중앙 관리 서버 **폴더 아래에** 인스턴스가 표시됩니다.  
  
#### 새 서버 그룹을 만들고 그룹에 서버 추가  
