---
title: "등록된 서버 및 등록된 서버 그룹 이동(SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
helpviewer_keywords: 
  - "등록된 서버 또는 서버 그룹 이동"
  - "등록된 서버 [SQL Server], 서버 그룹"
  - "서버 그룹 [SQL Server]"
  - "등록된 서버 [SQL Server], 서버 또는 서버 그룹 이동"
  - "그룹 [SQL Server], 서버"
...
---
# 등록된 서버 및 등록된 서버 그룹 이동(SQL Server Management Studio)
