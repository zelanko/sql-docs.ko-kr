...
2.  **텍스트 편집기**, **모든 언어**를 차례로 확장하고 **탭** 을 클릭한 다음 들여쓰기 값을 적절히 설정합니다. 들여쓰기 크기뿐 아니라 탭 크기와 탭이 공백으로 변환되는지 여부도 변경할 수 있습니다.  
    ...
    ![탭 대화 상자의 모양](../../tools/sql-server-management-studio/media/tabsdialog.gif "탭 대화 상자의 모양")  
  
3.  **확인**을 클릭합니다.  
  
## 단원의 다음 태스크  
[쿼리 편집기 화면 크기](../../tools/sql-server-management-studio/maximizing-query-editor.md)  
