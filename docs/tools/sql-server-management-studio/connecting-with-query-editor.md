...
#### 오프라인으로 코드를 작성한 다음 다른 서버에 연결하려면  
...
3.  코드 창에 다음 [!INCLUDE[tsql](../../includes/tsql-md.md)] 문을 입력합니다.  
    ...
    이 시점에서 **연결**, **실행**, **구문 분석** 또는 **예상 실행 계획 표시**를 클릭하여 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 인스턴스에 연결할 수 있습니다. 이 모든 명령은 **쿼리** 메뉴, 쿼리 편집기 도구 모음 또는 쿼리 편집기 창에서 마우스 오른쪽 단추를 클릭할 때 나타나는 바로 가기 메뉴에서 사용할 수 있습니다. 이 연습에서는 도구 모음을 사용합니다.  
...
## 단원의 다음 태스크  
[들여쓰기 추가](../../tools/sql-server-management-studio/adding-indentation.md)  
