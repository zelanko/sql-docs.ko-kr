---
title: "SQL Server Management Studio 바로 가기 키 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server Management Studio [SQL Server], 바로 가기"
  - "바로 가기 키 [SQL Server Management Studio]"
  - "메뉴 바로 가기 [SQL Server Management Studio]"
  - "쿼리 편집기 [SQL Server Management Studio], 바로 가기 키"
  - "바로 가기 키 [SQL Server Management Studio]"
  - "바로 가기 [SQL Server Management Studio], 바로 가기 키"
  - "바로 가기 키 [SQL Server Management Studio], 바로 가기 목록"
  - "바로 가기 [SQL Server Management Studio]"
  - "액셀러레이터 키"
...
# SQL Server Management Studio 바로 가기 키
  [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 에는 두 개의 키보드 구성표가 있습니다. 기본적으로 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] 2010을 기반을 두는 바로 가기 키가 포함된 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 구성표가 사용됩니다. [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] 에서는 [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]의 표준 구성표와 유사한 키보드 구성표도 제공합니다. 키보드 구성표를 변경하거나 다른 바로 가기 키를 추가하려면 **도구** 메뉴에서 **옵션**을 클릭합니다. **환경**, **키보드** 페이지에서 원하는 키보드 구성표를 선택합니다.  
...
|다음의 다음 활성 창으로 이동 [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]|Alt+F6|Alt+F6|  
...
## Microsoft IntelliSense 바로 가기 키  
