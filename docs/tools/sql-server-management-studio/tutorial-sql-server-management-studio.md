---
title: "자습서: SQL Server Management Studio | Microsoft Docs"
ms.custom: ""
ms.date: "06/02/2016"
...
helpviewer_keywords: 
  - "프로젝트 [SQL Server Management Studio], 자습서"
  - "템플릿 [SQL Server], SQL Server Management Studio"
  - "원본 제어 [SQL Server Management Studio], 자습서"
  - "도움말 [SQL Server], SQL Server Management Studio"
  - "자습서 [SQL Server Management Studio]"
  - "Transact-SQL 자습서"
  - "솔루션 [SQL Server Management Studio], 자습서"
  - "SQL Server Management Studio [SQL Server], 자습서"
...
## 학습 내용  
이 자습서를 통해 [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]의 정보 표시 방식과 기능을 이용하는 방법을 이해할 수 있습니다. 이 자습서에서는 다운로드 센터에서 다운로드한 무료 [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]를 사용합니다.  
...
[1단원: SQL Server Management Studio의 기본 탐색](../../tools/sql-server-management-studio/lesson-1-basic-navigation-in-sql-server-management-studio.md)  
이 단원에서는 [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]의 구성 요소를 사용하는 방법, 환경 레이아웃을 다시 구성하는 방법 및 기본 레이아웃을 복원하는 방법을 배웁니다.  
  
[2단원: Transact-SQL 작성](../../tools/sql-server-management-studio/lesson-2-writing-transact-sql.md)  
이 단원에서는 쿼리 편집기를 여는 방법, 코드를 관리하는 방법 및 쿼리 편집기의 다른 새로운 기능을 사용하는 방법을 배웁니다.  
  
[3단원: 템플릿, 솔루션 및 스크립트 프로젝트 작업](../../tools/sql-server-management-studio/lesson-3-working-with-templates-solutions-and-script-projects.md)  
...
-   다운로드 센터에서 최신 버전의 [SQL Server Management Studio](https://msdn.microsoft.com/library/mt238290.aspx)를 설치합니다.  
