...
helpviewer_keywords: 
  - "등록된 서버 [SQL Server], 새 등록된 서버 만들기"
...
---
# 새 등록된 서버 만들기(SQL Server Management Studio)
...
-   로컬 서버 그룹  
     ...
     로컬 서버 그룹을 사용하여 자주 관리하는 서버에 쉽게 연결할 수 있습니다. 로컬 서버와 로컬이 아닌 서버가 모두 로컬 서버 그룹에 등록됩니다. 로컬 서버 그룹은 각 사용자에게 고유합니다. 등록된 서버 정보를 공유하는 방법은 [등록된 서버 정보 내보내기&#40;SQL Server Management Studio&#41;](../../tools/sql-server-management-studio/export-registered-server-information-sql-server-management-studio.md) 및 [등록된 서버 정보 가져오기&#40;SQL Server Management Studio&#41;](../../tools/sql-server-management-studio/import-registered-server-information-sql-server-management-studio.md)를 참조하세요.  
