...
|[구성 파일을 사용 하 여 Distributed Replay 설치](../../sql-server/install/install-distributed-replay-using-a-configuration-file.md)|구성 파일을 통해 Distributed Replay를 실행하는 데 사용하는 예제 구문 및 설치 매개 변수를 제공하는 절차 항목입니다.|  
