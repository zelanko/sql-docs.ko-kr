...
# <a name="sqllocaldb-utility"></a>SqlLocalDB 유틸리티
  유틸리티를 `SqlLocalDB` 사용 하 여 [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssExpCurrent](../includes/ssexpcurrent-md.md)] **LocalDB**의 인스턴스를 만듭니다. `SqlLocalDB` 유틸리티 (SqlLocalDB)는 사용자와 개발자가 [!INCLUDE[ssExpress](../includes/ssexpress-md.md)] **LocalDB**의 인스턴스를 만들고 관리할 수 있는 간단한 명령줄 도구입니다. **Localdb**를 사용 하는 방법에 대 한 자세한 내용은 [SQL Server 2014 Express LocalDB](../database-engine/configure-windows/sql-server-2016-express-localdb.md)를 참조 하세요.  
