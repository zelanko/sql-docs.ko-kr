 ...
 **-OutPutFormat** { **Text** | **XML** }  
 유틸리티 출력 형식이 텍스트 문자열 (**text**) 또는 직렬화 된 export-clixml 형식 (XML)이 되도록 지정 합니다.**XML** `sqlps`  
  
 **-InPutFormat** { **Text** | **XML** }  
 유틸리티에 대 한 입력 형식이 텍스트 문자열 (**text**) 또는 직렬화 된 export-clixml 형식 (XML)이 되도록 지정 합니다.**XML** `sqlps`  
