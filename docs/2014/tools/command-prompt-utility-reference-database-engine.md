...
|[sqlservr 응용 프로그램](sqlservr-application.md)|문제 해결을 위해 명령 프롬프트에서 [!INCLUDE[ssDE](../includes/ssde-md.md)] 인스턴스를 시작 및 중지하는 데 사용합니다.|\<드라이브 >: Files\Microsoft SQL Server\MSSQL12. MSSQLSERVER\MSSQL\Binn|  
