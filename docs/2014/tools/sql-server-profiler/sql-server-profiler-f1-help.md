---
title: SQL Server Profiler F1 도움말 | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
# <a name="sql-server-profiler-f1-help"></a>SQL Server 프로파일러 F1 도움말
 ...
 다음 섹션에서는 [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]에 대한 상황에 맞는 도움말 항목을 제공합니다. 이러한 항목은 F1 키를 누르거나 대화 상자에서 **도움말** 을 클릭하여 사용자 인터페이스를 통해 볼 수 있습니다.  
