...
# <a name="sqllogship-application"></a>sqllogship 애플리케이션
 ...
 ![항목 링크 아이콘](../../2014/database-engine/media/topic-link.gif "항목 링크 아이콘") 구문 표기 규칙에 대한 내용은 [명령 프롬프트 유틸리티 참조&#40;데이터베이스 엔진#41;](../tools/command-prompt-utility-reference-database-engine.md)를 참조하세요.  
 ...
 **Sqllogship** 응용 프로그램 SqlLogShip.exe는 X:\PROGRAM Files\Microsoft SQL Server\120\Tools\Binn 디렉터리에 설치 됩니다.  
