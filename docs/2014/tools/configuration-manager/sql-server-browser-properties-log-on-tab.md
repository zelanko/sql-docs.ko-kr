...
> [!IMPORTANT]  
>  낮은 권한의 계정을 사용하십시오. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Browser 서비스에 필요한 권한에 대한 자세한 내용은 [SQL Server Browser 서비스](../../../2014/tools/configuration-manager/sql-server-browser-service.md)의 보안 섹션을 참조하세요.  
