...
-   **파이프 이름**을 입력합니다. 둘 수 있습니다 **파이프 이름** 빈 및 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 구성 관리자에서 지정 하면 적절 한 파이프 이름을 완성 합니다 **프로토콜** 및 **서버**  
...
> [!NOTE]  
>  네트워크 프로토콜을 지정 하는 **sqlcmd** 매개 변수를 참조 "방법: 사용 하 여 데이터베이스 엔진 sqlcmd.exe에 연결"에서 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Books Onl 온라인 설명서.  
