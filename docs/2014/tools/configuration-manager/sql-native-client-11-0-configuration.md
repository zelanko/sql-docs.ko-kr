...
-   [SQL Server Native Client 구성 속성&#40;플래그 탭&#41;](../../../2014/tools/configuration-manager/sql-server-native-client-configuration-properties-flags-tab.md)  
...
-   [클라이언트 프로토콜&#40;SQL Server 구성 관리자&#41;](../../relational-databases/sql-server-configuration-manager.md)  
    ...
    -   [클라이언트 프로토콜 - 명명된 파이프 속성&#40;프로토콜 탭&#41;](../../../2014/tools/configuration-manager/client-protocols-named-pipes-properties-protocol-tab.md)  
