...
# <a name="sql-server-browser-sql-server-configuration-manager"></a>SQL Server Browser(SQL Server 구성 관리자)
 ...
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Browser 서비스 및 작동 방식에 대한 자세한 내용은 [SQL Server Browser 서비스](../../../2014/tools/configuration-manager/sql-server-browser-service.md)를 참조하세요.  
