...
> [!NOTE]  
>  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 서비스의 노드에 컴퓨터에서 사용 가능한 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 서비스가 채워져 있지 않으면 WMI(Windows Management Instrumentation)에 액세스할 수 있는 권한이 없는 것입니다. WMI에서 사용 권한을 구성 하려면 온라인 설명서 항목에 대 한 "방법: SQL Server 도구에 서버 상태를 표시 하기 위해 WMI를 구성 합니다. "  
