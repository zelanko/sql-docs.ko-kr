...
|**데이터 형식 및 길이**|없음|  
|**기본값**|없음|  
|**내용과**|선택 사항입니다. 각 `DTAInput` 요소에 한 번만 사용할 수 있습니다.|  
