...
## <a name="comments"></a>주석  
 `USE database_name`**Eventstring** 요소에 포함 된 인라인 작업에서 문을 지정할 수 있습니다.  
