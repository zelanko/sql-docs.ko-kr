...
|**기본값**|**NONE**|  
|**발생 빈도**|`TuningOptions` 요소를 사용하지 않을 경우 `DropOnlyMode` 요소에 한 번만 지정해야 합니다. 하는 경우 `DropOnlyMode` 는 사용할 수 없습니다 사용 `Partitioning`합니다. 이러한 요소는 함께 사용할 수 없습니다.|  
