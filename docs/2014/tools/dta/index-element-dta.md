...
|`ANSI_NULLS`|`boolean`|(선택 사항) 같음(=)과 같지 않음(<>) 비교 연산자를 Null 값과 함께 사용할 경우의 ISO 호환 동작을 지정합니다. 인덱스가 계산 열 또는 뷰에 있는 경우 이 특성을 설정해야 합니다. 예를 들어 다음 구문은 이 특성을 설정합니다.<br /><br /> `<Index ANSI_NULLS [...]>`<br /><br /> 기본적으로 이 특성은 해제되어 있습니다.<br /><br /> 자세한 내용은 [SET ANSI_NULLS&#40;Transact-SQL&#41;](/sql/t-sql/statements/set-ansi-nulls-transact-sql)를 참조하세요.|  
