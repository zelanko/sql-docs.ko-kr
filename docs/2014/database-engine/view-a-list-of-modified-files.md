---
title: 수정 된 파일의 목록을 보려면 | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
1.  에 **뷰** 메뉴에서 클릭 **보류 중인 체크 인**합니다.  
  
2.  선택한 파일을 확인 하려면 클릭 **체크 인**합니다. 고정할 수 있습니다 합니다 **보류 중인 체크 인** 의 오른쪽 창에서를 [!INCLUDE[ssManStudio](../includes/ssmanstudio-md.md)] 환경 끝났을 때 파일에서 확인할 수 있도록 작업 합니다.  
     ...
     **버전 비교**  
     Visual SourceSafe 열립니다 **차이점 옵션** 대화 상자를 선택한 다른 모든 파일 개발 환경 프로젝트에서 선택한 파일을 비교 하 고 있는 경우 차이 표시 합니다.  
  
     **체크 아웃 취소**  
     선택한 모든 항목의 체크 아웃을 취소 합니다 **보류 중인 체크 인** 창입니다.  
