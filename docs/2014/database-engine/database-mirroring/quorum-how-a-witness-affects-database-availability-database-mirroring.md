---
title: '쿼럼: 미러링 모니터 서버가 데이터베이스 가용성 (데이터베이스 미러링)에 미치는 영향 | Microsoft Docs'
ms.custom: ''
ms.date: 06/13/2017
...
-   *파트너 간 쿼럼* - 두 파트너로 구성됩니다.  
 ...
 ![쿼럼: 전체, 미러링 모니터 서버와 파트너; 두 파트너 모두](../media/dbm-failovautoquorum.gif "쿼럼: 전체, 미러링 모니터 서버와 파트너; 두 파트너 모두")  
