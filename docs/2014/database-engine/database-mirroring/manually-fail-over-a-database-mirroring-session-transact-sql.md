...
## <a name="see-also"></a>참고 항목  
 ...
 [데이터베이스 미러링 세션을 수동으로 장애 조치 (Failover) &#40;SQL Server Management Studio&#41;](manually-fail-over-a-database-mirroring-session-sql-server-management-studio.md)   
