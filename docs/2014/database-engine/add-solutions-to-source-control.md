...
# <a name="add-solutions-to-source-control"></a>원본 제어에 솔루션 추가
 ...
 [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] 프로젝트는 완전하게 로컬 디스크에 상주하므로 프로젝트를 로컬로 편집, 저장 및 작성할 수 있습니다. 소스 제어에 프로젝트를 추가한 후 사용할 수 있습니다 합니다 **체크 아웃** 소스 제어에서 프로젝트의 파일을 확인 하는 명령입니다.  
  
### <a name="to-add-a-solution-to-source-control"></a>원본 제어에 솔루션을 추가하려면  
  
1.  솔루션 탐색기에서 추가할 솔루션을 선택합니다.  
  
2.  에 **파일** 메뉴에서 **소스 제어**를 클릭 하 고 **소스 제어에 솔루션 추가**합니다.  
