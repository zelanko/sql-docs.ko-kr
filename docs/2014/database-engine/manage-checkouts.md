...
# <a name="manage-checkouts"></a>체크 아웃 관리
 ...
 사용할 수 있습니다 [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] 파일을 수동 또는 자동으로 체크 아웃 합니다. 파일을 포함 하는 솔루션을 열어 파일이 수동으로 확인 합니다 [!INCLUDE[ssManStudio](../includes/ssmanstudio-md.md)] 환경 및 클릭 한 다음를 **체크 아웃** 명령입니다. 자동으로 체크 아웃하도록 [!INCLUDE[ssManStudio](../includes/ssmanstudio-md.md)] 환경을 구성한 경우 파일을 자동으로 체크 아웃할 수 있습니다.  
