...
# <a name="open-solutions-and-projects-from-source-control"></a>원본 제어에서 솔루션 및 프로젝트 열기
  를 사용 [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] 하 여 소스 제어에서 솔루션 또는 프로젝트를 직접 열 수 있습니다. 소스 제어에서 솔루션을 열면 [!INCLUDE[ssManStudio](../includes/ssmanstudio-md.md)] 환경은 솔루션의 최신 버전을 자동으로 검색하여 지정된 위치에 복사합니다.  
