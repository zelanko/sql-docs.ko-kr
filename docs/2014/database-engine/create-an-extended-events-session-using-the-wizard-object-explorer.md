...
##  <a name="introduction"></a><a name="BKMK_Welcome"></a>간략하게  
 **소개** 페이지에서 다음을 수행합니다.  
...
##  <a name="set-session-properties"></a><a name="BKMK_SetSessionProperties"></a>세션 속성 설정  
...
##  <a name="choose-template"></a><a name="BKMK_ChooseTemplate"></a>템플릿 선택  
...
##  <a name="select-events-to-capture"></a><a name="BKMK_SelectEventsToCapture"></a>캡처할 이벤트 선택  
...
##  <a name="capture-global-fields"></a><a name="BKMK_CaptureGlobalFields"></a>전역 필드 캡처  
...
##  <a name="set-session-event-filters"></a><a name="BKMK_SetSessionEventFilters"></a>세션 이벤트 필터 설정  
...
##  <a name="specify-session-data-storage"></a><a name="BKMK_SpecifySessionDataOutput"></a>세션 데이터 저장소 지정  
...
##  <a name="summary"></a><a name="BKMK_Summary"></a>요약  
 **요약** 페이지에서 다음을 수행합니다.  
...
##  <a name="create-event-session"></a><a name="BKMK_CreateEventSession"></a>이벤트 세션 만들기  
