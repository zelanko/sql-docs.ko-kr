...
## <a name="breaking-changes-in-sssql14"></a>[!INCLUDE[ssSQL14](../includes/sssql14-md.md)]의 주요 변경 내용  
 향후 정보 제공 예정  
  
## <a name="breaking-changes-in-sssql11"></a>[!INCLUDE[ssSQL11](../includes/sssql11-md.md)]의 주요 변경 내용  
  
### <a name="you-cannot-use-sssql11-management-tools-to-create-a-utility-control-point-on-a-sskilimanjaro-instance-of-sql-server"></a>[!INCLUDE[ssSQL11](../includes/sssql11-md.md)] 관리 도구를 사용하여 SQL Server의 [!INCLUDE[ssKilimanjaro](../includes/sskilimanjaro-md.md)] 인스턴스에 유틸리티 제어 지점을 만들 수 없습니다.  
...
### <a name="smo-has-been-reversioned-in-sssql11"></a>[!INCLUDE[ssSQL11](../includes/sssql11-md.md)]에서 SMO의 버전 변경  
...
## <a name="breaking-changes-in-sql-server-2005"></a><a name="previous-versions"></a>SQL Server 2005의 주요 변경 내용  

[!INCLUDE[Archived documentation for very old versions of SQL Server](../includes/paragraph-content/previous-versions-archive-documentation-sql-server.md)]

## <a name="see-also"></a>참고 항목  
 [이전 버전과의 호환성](../../2014/getting-started/backward-compatibility.md)  
 [SQL Server 2014에서 관리 도구 기능의 주요 변경 내용에 대 한 자세한 정보](breaking-changes-to-database-engine-features-in-sql-server-2016.md?view=sql-server-2014)  
