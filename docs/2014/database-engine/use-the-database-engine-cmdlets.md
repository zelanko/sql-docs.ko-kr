...
|`Encode-Sqlname` 및 `Decode-Sqlname`을 사용하여 Windows PowerShell 경로에서 지원되지 않는 문자가 포함된 SQL Server 식별자를 처리하는 방법을 설명합니다.|[SQL Server 식별자 인코딩 및 디코딩](../powershell/encode-and-decode-sql-server-identifiers.md)|  
...
## <a name="see-also"></a>참고 항목  
 ...
 [AlwaysOn 가용성 그룹 &#40;에 대 한 PowerShell cmdlet 개요 SQL Server&#41;](availability-groups/windows/overview-of-powershell-cmdlets-for-always-on-availability-groups-sql-server.md)  
