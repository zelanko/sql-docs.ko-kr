 ...
 **영역별 내용 찾아보기**  
 ...
 ![작은 파일 폴더 아이콘](../../2014/integration-services/media/filefolder-small.gif "작은 파일 폴더 아이콘") [SQL Server 데이터베이스 엔진 이전 버전과 호환성](sql-server-database-engine-backward-compatibility.md)  
