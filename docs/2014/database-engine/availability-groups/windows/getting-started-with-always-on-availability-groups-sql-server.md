...
##  <a name="monitoring-availability-groups"></a><a name="MonitorAGsEtc"></a>가용성 그룹 모니터링  
...
-   **백서:**  [고가용성 및 재해 복구를 위한 Microsoft SQL Server AlwaysOn 솔루션 가이드](https://go.microsoft.com/fwlink/?LinkId=227600)  
