---
title: AlwaysOn 가용성 그룹 (SQL Server) 시작 | Microsoft Docs
ms.custom: ''
ms.date: 06/14/2017
...
-   **비디오 — AlwaysOn 소개:**  [Microsoft SQL Server 코드 이름 "Denali" AlwaysOn 시리즈, 파트 1: 차세대 고가용성 솔루션 소개](http://channel9.msdn.com/Events/TechEd/NorthAmerica/2011/DBI302)  
  
-   **비디오 - AlwaysOn 심층 탐구:**  [Microsoft SQL Server 코드 이름 "Denali" AlwaysOn 시리즈, 파트 2: AlwaysOn을 사용하여 중요 환경 고가용성 솔루션 빌드](http://channel9.msdn.com/Events/TechEd/NorthAmerica/2011/DBI404)  
  
-   **백서:**  [고가용성 및 재해 복구를 위한 Microsoft SQL Server AlwaysOn 솔루션 가이드](http://go.microsoft.com/fwlink/?LinkId=227600)  
  
-   **블로그:**  [SQL Server AlwaysOn 팀 블로그: 공식 SQL Server AlwaysOn 팀 블로그](http://blogs.msdn.com/b/sqlalwayson/)  
