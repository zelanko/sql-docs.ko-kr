...
-   **블로그:**  
     ...
     [AlwaysOn 상태 모델 파트 1--상태 모델 아키텍처](http://blogs.msdn.com/b/sqlalwayson/archive/2012/02/09/overview-of-the-alwayson-manageability-health-model.aspx)  
     ...
     [PowerShell-1 부를 사용 하 여 AlwaysOn 상태 모니터링: 기본 Cmdlet 개요](http://blogs.msdn.com/b/sqlalwayson/archive/2012/02/13/monitoring-alwayson-health-with-powershell-part-1.aspx)  
