...
##  <a name="alwayson-availability-groups-is-not-enabled"></a><a name="IsHadrEnabled"></a>AlwaysOn 가용성 그룹를 사용할 수 없습니다.
...
##  <a name="accounts"></a><a name="Accounts"></a>계좌
