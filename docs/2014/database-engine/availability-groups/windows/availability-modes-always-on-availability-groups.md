...
##  <a name="AsyncCommitAvMode"></a>비동기-커밋 가용성 모드
...
##  <a name="SyncCommitAvMode"></a>동기-커밋 가용성 모드
...
###  <a name="DisruptSync"></a>데이터 동기화를 방해 하는 요인
...
###  <a name="HowSyncWorks"></a>보조 복제본에서 동기화가 작동 하는 방식
...
###  <a name="SyncCommitWithAuto"></a>자동 장애 조치 (Failover)를 사용 하는 동기-커밋 모드
 ...
 **가용성 모드 및 장애 조치 (failover) 모드를 변경 하려면**
