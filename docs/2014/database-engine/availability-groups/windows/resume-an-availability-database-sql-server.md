...
### <a name="to-resume-a-secondary-database"></a>보조 데이터베이스를 재개하려면
  
1.  데이터베이스를 재개할 복제본을 호스팅하는 서버 인스턴스로 디렉터리를 변경(`cd`)합니다. 자세한 내용은 이 항목의 앞부분에 나오는 [필수 구성 요소](#Prerequisites)를 참조하십시오.  
