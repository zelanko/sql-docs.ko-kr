...
8.  **요약** 페이지에서, 선택한 보조 복제본으로 장애 조치할 경우 발생할 영향을 검토합니다.  
     ...
     선택에 만족 하는 경우 필요에 따라 **스크립트** 를 클릭 하 여 마법사에서 실행할 단계에 대 한 스크립트를 만듭니다. 그런 다음 가용성 그룹을 선택한 보조 복제본으로 장애 조치하려면 **마침**을 클릭합니다.  
...
|**해당 없음**|가용성 복제본을 호스팅하는 노드에 쿼럼이 없습니다.|  
...
###  <a name="confirm-potential-data-loss-page"></a><a name="ConfirmPotentialDataLoss"></a>잠재적인 데이터 손실 확인 페이지  
...
###  <a name="connect-to-replica-page"></a><a name="ConnectToReplica"></a>복제본에 연결 페이지  
