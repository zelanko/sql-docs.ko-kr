...
|------------|----------------------------|------------------------|------------------------|--------------------------------------------------------------------|-----------------------------------------------------------------------------------|  
|SQL Native Client 11.0 ODBC|예|yes|yes|yes|yes|  
|SQL Native Client 11.0 OLEDB|예|예|yes|아니요|예|  
|연결 패치를 사용 하는 .NET Framework 4.0 ADO.NET**<sup>*</sup>** |예|yes|yes|yes|yes|  
|.NET Framework 3.5 s p 1과 연결 패치가 있는 ADO.NET**<sup>**</sup>** |예|yes|yes|yes|yes|  
|SQL Server용 Microsoft JDBC Driver 4.0|예|yes|yes|yes|yes|  
  
 **<sup>*</sup>**.NET Framework 4.0:를 사용 하 여 ADO .NET 용 연결 패치를 다운로드 [https://support.microsoft.com/kb/2600211](https://support.microsoft.com/kb/2600211) 합니다.  
  
 **<sup>**</sup>* * .NET Framework 3.5 SP1:를 사용 하 여 ADO.NET에 대 한 연결 패치를 다운로드 [https://support.microsoft.com/kb/2654347](https://support.microsoft.com/kb/2654347) 합니다.  
...
## <a name="see-also"></a>참고 항목  
 ...
 [Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 또는 Windows Server 2008 r 2를 실행 하는 컴퓨터에서 IPSec 연결을 다시 연결할 때 긴 시간 지연이 발생 합니다.](https://support.microsoft.com/kb/980915)   
 [클러스터 서비스 Windows Server 2008 r 2에서 IPv6 IP 주소를 장애 조치 (failover) 하는 데 30 초 정도 걸립니다.](https://support.microsoft.com/kb/2578113)   
 [클러스터와 애플리케이션 서버 사이에 라우터가 없는 경우 장애 조치(Failover) 작업이 느려짐](https://support.microsoft.com/kb/2582281)  
