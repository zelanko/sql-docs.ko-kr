...
-   **로그인**  
     ...
     응용 프로그램에서 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 인증 또는 로컬 Windows 로그인을 사용하는 경우 이 항목의 뒷부분에 나오는 [SQL Server 인증 또는 로컬 Windows 로그인을 사용하는 응용 프로그램의 로그인](../../2014/database-engine/logins-and-jobs-for-availability-group-databases.md#SSauthentication)을 참조하십시오.  
