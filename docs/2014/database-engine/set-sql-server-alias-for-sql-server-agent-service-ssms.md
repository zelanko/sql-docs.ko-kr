...
-   [SQL Server Management Studio를 사용 하 여 SQL Server 에이전트 서비스의 SQL Server 별칭을 설정 하려면](#SSMSProcedure)  
...
4.  
  **로컬 호스트 서버 별칭** 상자에 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 에이전트에서 연결할 서버의 별칭을 입력합니다.  
