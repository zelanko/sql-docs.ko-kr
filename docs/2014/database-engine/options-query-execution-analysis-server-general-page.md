---
title: 옵션 (쿼리 실행 분석 서버-일반 페이지) | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
ms.locfileid: "36089985"
---
# <a name="options-query-execution-analysis-server-general-page"></a>옵션 (쿼리 실행 분석 서버-일반 페이지)
 ...
 **실행 제한 시간**  
 **새 연결** 대화 상자에서 기본값을 설정합니다. 이 상자의 값은 쿼리를 취소할 때까지 기다리는 시간(초)을 나타냅니다. 값 0은 무한 대기 또는 제한 시간 없음을 의미합니다. 새로 설치하는 경우 이 값은 0입니다.  
