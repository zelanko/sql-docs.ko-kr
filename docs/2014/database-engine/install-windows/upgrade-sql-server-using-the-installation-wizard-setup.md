...
-   [SQL Server의 여러 버전 및 인스턴스 작업](../../sql-server/install/work-with-multiple-versions-and-instances-of-sql-server.md)  
...
#### <a name="to-upgrade-to-sscurrent"></a>다음으로 업그레이드하려면 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
