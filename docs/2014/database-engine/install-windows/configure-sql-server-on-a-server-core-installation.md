...
-   [새로 설치 하는 동안 SQL Server 2014 용 업데이트 설치](#installing-updates-during-a-new-installation) 
  
-   [SQL Server 2014 설치한 후에 대 한 업데이트를 설치 합니다.](#installing-updates-after-installation) 
  
### <a name="installing-updates-during-a-new-installation"></a>새로 설치 하는 동안 업데이트를 설치합니다.  
...
### <a name="installing-updates-after-installation"></a>설치 후 업데이트를 설치합니다. 
...
##  <a name="startstop-sql-server-service"></a>시작/중지 SQL Server 서비스  
...
### <a name="using-sql-server-configuration-manager-remotely"></a>SQL Server 구성 관리자를 원격으로 사용  
...
## <a name="configuring-remote-access-of-sql-server-running-on-server-core"></a>Server Core에서 실행 중인 SQL Server의 원격 액세스 구성  
...
### <a name="enable-remote-connections-on-an-instance-of-sql-server"></a>SQL Server 인스턴스에서 원격 연결을 사용 하도록 설정 
...
### <a name="enable-tcpip-on-an-instance-of-sql-server"></a>SQL Server 인스턴스에서 TCP/IP 사용:
...
##  <a name="sql-servevr-command-prompt-utilities"></a>SQL Servevr 명령 프롬프트 유틸리티  
...
|[sqlservr 응용 프로그램](../../tools/sqlservr-application.md)|문제 해결을 위해 명령 프롬프트에서 [!INCLUDE[ssDE](../../includes/ssde-md.md)] 인스턴스를 시작 및 중지하는 데 사용합니다.|\<drive>:\Program Files\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]\MSSQL12.MSSQLSERVER\MSSQL\Binn|  
