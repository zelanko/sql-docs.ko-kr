...
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 64비트 버전에서 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 64비트 버전으로 업그레이드하는 경우 [!INCLUDE[ssDE](../../includes/ssde-md.md)]을 업그레이드하기 전에 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]를 업그레이드해야 합니다.  
...
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 구성 요소 및 사용자 데이터베이스 업그레이드에 필요한 디스크 공간을 예측합니다. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 구성 요소에 필요한 디스크 공간은 [SQL Server 2014 설치를 위한 하드웨어 및 소프트웨어 요구 사항](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server.md)을 참조하세요.  
