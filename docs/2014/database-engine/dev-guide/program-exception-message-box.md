...
4.  <xref:Microsoft.SqlServer.MessageBox.ExceptionMessageBox.Buttons%2A>에 다음 값 중 하나를 설정합니다.  
    ...
    -   <xref:Microsoft.SqlServer.MessageBox.ExceptionMessageBoxButtons.OKCancel>- **확인** 및 **취소** 단추를 표시 합니다.  
  
    -   <xref:Microsoft.SqlServer.MessageBox.ExceptionMessageBoxButtons.RetryCancel>- **다시 시도** 및 **취소** 단추를 표시 합니다.  
  
    -   <xref:Microsoft.SqlServer.MessageBox.ExceptionMessageBoxButtons.YesNo>- **예** 및 **아니요** 단추를 표시 합니다.  
  
    -   <xref:Microsoft.SqlServer.MessageBox.ExceptionMessageBoxButtons.YesNoCancel>- **예**, **아니요**및 **취소** 단추를 표시 합니다.  
