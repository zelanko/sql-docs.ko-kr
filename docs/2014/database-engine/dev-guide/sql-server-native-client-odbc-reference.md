---
title: SQL Server Native Client (ODBC) 참조 | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
ms.locfileid: "84933331"
---
# <a name="sql-server-native-client-odbc-reference"></a>SQL Server Native Client(ODBC) 참조
  ODBC(Open Database Connectivity)는 애플리케이션에서 ODBC 데이터 원본의 데이터에 액세스하는 데 사용하는 Microsoft Win32 응용 프로그래밍 인터페이스입니다.  
...
-   [SQL Server 드라이버 확장](../../../2014/database-engine/dev-guide/sql-server-driver-extensions.md)  
