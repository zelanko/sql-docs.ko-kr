---
title: 매개 변수 예제 배열 | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
6.  (줄 24 근처) 프로그램 파일에 적절 한 줄 찾기 및 바꾸기 `XXX` 인스턴스의의 이름으로 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
11. 명령 프롬프트에서 다음 줄을 실행하여 응용 프로그램을 테스트합니다.  
