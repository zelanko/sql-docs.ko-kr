...
-   사용 하 여 데이터 및 델타 파일에 사용 된 공간을 살펴보고 [sys.dm_db_xtp_checkpoint_files &#40;TRANSACT-SQL&#41; ](/sql/relational-databases/system-dynamic-management-views/sys-dm-db-xtp-checkpoint-files-transact-sql) 경우 병합이 트리거되지 말아야 할 때 볼 수 있습니다.  
...
```  
 ...
 블로그 [상태 전환에서에서 검사점 파일의 메모리 액세스에 최적화 테이블이 있는 데이터베이스](http://blogs.technet.com/b/dataplatforminsider/archive/2014/01/23/state-transition-of-checkpoint-files-in-databases-with-memory-optimized-tables.aspx) 데이터 및 델타 파일 쌍의 시작에서 가비지 수집 상태 전환에 설명 합니다.  
