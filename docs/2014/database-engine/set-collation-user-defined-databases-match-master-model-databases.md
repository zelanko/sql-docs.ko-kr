---
title: Model 데이터베이스 및 마스터와 일치 하도록 데이터 정렬의 사용자 정의 데이터베이스 설정 | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
-   사용자 데이터베이스 데이터 정렬과 일치하는 데이터 정렬을 사용하도록 시스템 데이터베이스를 다시 작성합니다. 시스템 데이터베이스 다시 작성 하는 방법에 대 한 자세한 내용은 참조 하세요. [시스템 데이터베이스 다시 작성](../relational-databases/databases/system-databases.md)합니다.  
