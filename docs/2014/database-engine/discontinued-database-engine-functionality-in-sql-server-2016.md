...
## <a name="SQL14"></a> 지원 되지 않는 기능 [!INCLUDE[ssSQL14](../includes/sssql14-md.md)]  
...
## <a name="Denali"></a> 지원 되지 않는 기능 [!INCLUDE[ssSQL11](../includes/sssql11-md.md)]  
...
## <a name="see-also"></a>관련 항목  
 [SQL Server 2014에서 사용되지 않는 데이터베이스 엔진 기능](deprecated-database-engine-features-in-sql-server-2016.md?view=sql-server-2014)  
