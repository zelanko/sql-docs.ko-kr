...
# <a name="compare-files"></a>파일 비교
 ...
 [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)]를 사용하여 프로젝트나 파일의 로컬 복사본을 원본 제어에 저장된 버전과 비교하거나 두 개의 로컬 파일을 비교할 수 있습니다. 또한를 사용 하는 **기록** 명령, 두 원본 제어 버전을 비교할 수 있습니다.  
