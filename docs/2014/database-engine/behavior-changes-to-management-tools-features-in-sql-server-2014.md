...
## <a name="behavior-changes-in-includesssql14includessssql14-mdmd"></a>
  [!INCLUDE[ssSQL14](../includes/sssql14-md.md)]의 동작 변경 내용  
 향후 정보 제공 예정  

## <a name="previous-versions"></a>SQL Server의 매우 이전 버전에 대 한 보관 된 설명서
