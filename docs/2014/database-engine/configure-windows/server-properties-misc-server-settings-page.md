 ...
 **두 자리 연도를 다음으로 해석 합니다.**  
 두 자리 연도 값 해석에 사용할 100년 간의 날짜 범위를 지정합니다. [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 는 지정 된 범위에 속하는 해당 자릿수로 끝나는 연도를 참조 하는 두 자리 날짜 값을 해석 합니다.  
