...
4.  **SQL Server \<**_instancename_**> 속성** 대화 상자의 **속성** 상자에서 **시작 모드** 의 값을 **수동**으로 설정 합니다.  
  
5.  **확인** 을 클릭 하 여 **SQL Server \<**_instancename_**> 속성** 대화 상자를 닫은 다음 Configuration Manager를 닫습니다 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
