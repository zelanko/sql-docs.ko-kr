...
###  <a name="to-provision-install-a-certificate-on-the-server"></a><a name="Provision"></a> 서버에 인증서를 구축(설치)하려면  
...
###  <a name="to-export-the-server-certificate"></a><a name="Export"></a> 서버 인증서를 내보내려면  
...
###  <a name="to-configure-the-client-to-request-encrypted-connections"></a><a name="ConfigureClientConnections"></a> 암호화된 연결을 요청하도록 클라이언트를 구성하려면  
...
###  <a name="to-encrypt-a-connection-from-sql-server-management-studio"></a><a name="EncryptConnection"></a> SQL Server Management Studio의 연결을 암호화하려면  
