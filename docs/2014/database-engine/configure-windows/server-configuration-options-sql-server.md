...
-   SC = 자체 구성 옵션입니다.  
    ...
    |[affinity64 I/O mask](affinity64-input-output-mask-server-configuration-option.md) (A, 64비트 버전에만 해당 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)])|-2147483648|2147483647|0|  
    ...
    |[OLE Automation 프로시저](ole-automation-procedures-server-configuration-option.md)(A)|0|1|0|  
    ...
    |[사용자 옵션](configure-the-user-options-server-configuration-option.md)|0|32767|0|  
