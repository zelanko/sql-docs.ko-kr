 ...
 **affinity I/O mask** 옵션은 고급 옵션입니다. 사용 하는 경우는 `sp_configure` 시스템 저장 프로시저 설정을 변경 하려면 변경할 수 있습니다, **선호도 I/O 마스크** 경우에만 **고급 옵션 표시** 1로 설정 됩니다. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]에서 **affinity I/O mask** 옵션을 다시 구성하려면 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 인스턴스를 다시 시작해야 합니다.  
