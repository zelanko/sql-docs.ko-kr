...
3.  다음 예를 복사하여 쿼리 창에 붙여 넣고 **실행**을 클릭합니다. 다음 예에서는 [sp_configure](/sql/relational-databases/system-stored-procedures/sp-configure-transact-sql) 를 사용하여 `nested triggers` 옵션의 값을 `0`(으)로 설정하는 방법을 보여 줍니다.  
...
##  <a name="follow-up-after-you-configure-the-nested-triggers-option"></a><a name="FollowUp"></a> 후속 작업: 중첩 트리거 옵션을 구성한 후  
