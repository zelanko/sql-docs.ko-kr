...
> [!NOTE]  
>  이러한 모니터에 대한 자세한 내용은 [복제 모니터링](../../relational-databases/replication/monitoring-replication.md) 및 [데이터베이스 미러링 모니터링&#40;SQL Server&#41;](../database-mirroring/database-mirroring-sql-server.md)을 참조하세요.  
