...
## <a name="using-startup-options-for-troubleshooting"></a>문제 해결을 위한 시작 옵션 사용  
 단일 사용자 모드 및 최소 구성 모드와 같은 일부 시작 옵션은 주로 문제 해결에서 사용됩니다. **-M** 또는 **-f** 옵션을 사용 하 여 문제를 해결 하기 위해 서버를 시작 하는 것은 명령줄에서 편리 하 게 사용할 수 있으며 sqlservr.exe를 수동으로 시작 합니다.  
