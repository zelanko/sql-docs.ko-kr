...
|도구|추적 재생용 SQL Server Profiler|[SQL Server Distributed Replay](../tools/distributed-replay/sql-server-distributed-replay.md)<br /><br /> 참고: Analysis Services 작업에 대 한 추적 재생에 SQL Server Profiler 계속 사용 합니다.|SQL Server Profiler|없음|  
