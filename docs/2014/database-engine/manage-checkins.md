...
# <a name="manage-checkins"></a>체크 인 관리
 ...
 사용 하 여 [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] 파일을 체크 인할에서 합니다. 소스 제어 저장소를 정기적으로 업데이트해야 하지만 또한 파일 집합에 대해 제어를 유지 관리해야 할 경우 체크 인한 파일이 체크 아웃된 상태로 유지되도록 지정할 수 있습니다.  
