...
#### <a name="enabling-ss_smartbackup-at-the-instance-level-with-default-settings"></a>기본 설정을 사용하여 인스턴스 수준에서 [!INCLUDE[ss_smartbackup](../includes/ss-smartbackup-md.md)] 설정  
...
#### <a name="to-pause-ss_smartbackup-using-powershell"></a>PowerShell을 사용하여 [!INCLUDE[ss_smartbackup](../includes/ss-smartbackup-md.md)] 을 일시 중지하려면  
...
#### <a name="to-resume-ss_smartbackup-using-powershell"></a>PowerShell을 사용하여 [!INCLUDE[ss_smartbackup](../includes/ss-smartbackup-md.md)] 을 다시 시작하려면  
