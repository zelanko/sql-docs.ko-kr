...
-   요청에서 반환 된 열 수를 확인 하기 위한 [Sqlnumresultcols](../native-client-odbc-api/sqlnumresultcols.md)  
  
-   결과 집합의 열을 설명 하는 [Sqlcolattribute](../native-client-odbc-api/sqlcolattribute.md) 또는 [SQLDescribeCol](../native-client-odbc-api/sqldescribecol.md)  
