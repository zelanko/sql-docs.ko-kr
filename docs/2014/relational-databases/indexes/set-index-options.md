...
8.  인덱스 열을 추가 또는 제거하거나 그 위치를 변경하려면 **인덱스 속성 -** _index_name_ 대화 상자의 **일반** 페이지를 선택합니다. 자세한 내용은 [Index Properties F1 Help](index-properties-f1-help.md)를 참조하세요.  
