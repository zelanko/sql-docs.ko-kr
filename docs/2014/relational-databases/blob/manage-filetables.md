...
###  <a name="HowToDisable"></a> 어떻게: 데이터베이스 수준에서 비트랜잭션 액세스를 다시 활성화 및 비활성화  
...
###  <a name="HowToEnableNS"></a> 어떻게: 사용 하지 않도록 설정 하 고 다시 테이블 수준에서 FileTable Namespace를 사용 하도록 설정  
...
###  <a name="HowToListOpen"></a> 어떻게: FileTable과 연결 된 열려 있는 파일 핸들 목록 가져오기  
...
###  <a name="HowToKill"></a> 어떻게: FileTable과 연결 된 열려 있는 파일 핸들 중지  
...
###  <a name="HowToIdentifyLocks"></a> 어떻게: 잠금 식별 Filetable이 보유  
