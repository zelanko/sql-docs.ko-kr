...
> [!NOTE]  
>  지정할 수도 있습니다 **varchar (max)** 하십시오 **nvarchar (max)**, 및 **varbinary (max)** 데이터 형식을 저장 프로시저, 함수 입력 및 출력 매개 변수 형식으로 반환 형식 또는 [CAST 및 CONVERT](/sql/t-sql/functions/cast-and-convert-transact-sql) 함수입니다.  
...
```  
 ...
 방법에 대 한 자세한 내용은 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 네이티브 클라이언트 OLE DB 공급자는 큰 값 데이터 형식, 참조 [Blob 및 OLE 개체](../../native-client-ole-db-blobs/blobs-and-ole-objects.md)합니다.  
