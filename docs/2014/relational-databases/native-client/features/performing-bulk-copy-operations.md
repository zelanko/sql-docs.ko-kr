...
# <a name="performing-bulk-copy-operations"></a>대량 복사 작업 수행
 ...
 이 기능을 보여 주는 샘플 애플리케이션은 [IRowsetFastLoad를 사용하여 데이터 대량 복사&#40;OLE DB&#41;](../../native-client-ole-db-interfaces/irowsetfastload-ole-db.md)를 참조하세요.  
...
-   데이터를 프로그램 변수로 로드한 다음 한 번에 한 행씩, 대량 복사하기 위한 대량 복사 함수를 사용하여 데이터를 테이블 또는 뷰로 가져옵니다.  
 ...
 대량 복사 함수를 사용할 애플리케이션을 코딩하는 프로그래머가 우수한 대량 복사 성능을 얻으려면 일반 규칙을 따라야 합니다. [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]에서 대량 복사 작업을 지원하는 방법에 대한 자세한 내용은 [데이터 대량 내보내기 및 가져오기&#40;SQL Server&#41;](../../import-export/bulk-import-and-export-of-data-sql-server.md)를 참조하세요.  
...
### <a name="using-memory-based-bulk-copy-operations"></a>메모리 기반 대량 복사 작업 사용  
 Native [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Client OLE DB 공급자는 **IRowsetFastLoad** 인터페이스를 구현 하 여 메모리 기반 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 대량 복사 작업에 대 한 지원을 노출 합니다. **IRowsetFastLoad** 인터페이스는 [IRowsetFastLoad::Commit](../../native-client-ole-db-interfaces/irowsetfastload-commit-ole-db.md) 및 [IRowsetFastLoad::InsertRow](../../native-client-ole-db-interfaces/irowsetfastload-insertrow-ole-db.md) 메서드를 구현합니다.  
