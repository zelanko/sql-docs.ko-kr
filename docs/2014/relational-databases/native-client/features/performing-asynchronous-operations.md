...
>   
>  또한 원격 프록시/스텁 dll (MDAC 2.8)은 Native Client에서 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] **ISSAsynchStatus** 인터페이스를 호출할 수 없습니다. **ISSAsynchStatus** 인터페이스는 원격을 통해 표시되지 않습니다.  
>   
