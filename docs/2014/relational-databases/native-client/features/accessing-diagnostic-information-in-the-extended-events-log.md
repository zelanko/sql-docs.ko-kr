...
## <a name="remarks"></a>Remarks  
 ...
 ODBC를 사용 하는 경우 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 고 연결이 성공, 클라이언트를 얻을 수 있습니다를 사용 하 여 연결 ID는 `SQL_COPT_SS_CLIENT_CONNECTION_ID` 특성이 [SQLGetConnectAttr](../../native-client-odbc-api/sqlgetconnectattr.md)합니다.  
