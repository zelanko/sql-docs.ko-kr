...
-   `DataTypeCompatibility=80`  
 ...
 Native Client에서 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 지원 되는 ADO 연결 문자열 키워드에 대 한 자세한 내용은 [SQL Server Native Client 연결 문자열 키워드 사용](using-connection-string-keywords-with-sql-server-native-client.md)을 참조 하세요.  
