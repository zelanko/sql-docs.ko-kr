...
-   `DataTypeCompatibility=80`  
 ...
 ADO에 대 한 자세한 정보에 대 한 연결 문자열에서 지원 되는 키워드 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native client를 [Connection String Keywords with SQL Server Native Client를 사용 하 여](using-connection-string-keywords-with-sql-server-native-client.md)합니다.  
