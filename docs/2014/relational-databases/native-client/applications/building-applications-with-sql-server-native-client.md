...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [SQL Server Native Client를 사용하여 Azure SQL Database에 연결](connecting-to-a-windows-azure-sql-database-using-sql-server-native-client.md)  
