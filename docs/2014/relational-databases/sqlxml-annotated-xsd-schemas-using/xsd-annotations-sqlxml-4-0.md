...
|`sql:inverse`|을 사용 하 여 지정 된 부모-자식 관계의 해석을 반전 하도록 updategram 논리에 지시 **\<sql:relationship>** 합니다.|[Sql: relationship에 sql: 역 특성 지정 &#40;SQLXML 4.0&#41;](specifying-the-sql-inverse-attribute-on-sql-relationship-sqlxml-4-0.md)|지원되지 않음|  
