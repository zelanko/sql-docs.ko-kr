...
-   이 오류가 발생된 모든 경우  
    ...
    -   스냅숏 에이전트, 로그 판독기 에이전트 및 큐 판독기 에이전트는 [복제 모니터를 사용 하 여 정보 보기 및 작업 수행](monitor/view-information-and-perform-tasks-replication-monitor.md)을 참조 하세요.  
  
    -   배포 에이전트 및 병합 에이전트는 [복제 모니터를 사용 하 여 정보 보기 및 작업 수행](monitor/view-information-and-perform-tasks-replication-monitor.md)을 참조 하세요.  
