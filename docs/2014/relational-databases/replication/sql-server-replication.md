...
-   [병합 게시에서 데이터를 테이블로 대량 로드](bulk-load-data-into-tables-in-a-merge-publication.md)    
...
-   [배포 데이터베이스에서 복제 된 명령 및 기타 정보 보기](monitor/view-replicated-commands-and-information-in-distribution-database.md)    
-   [트랜잭션 복제에 대해 통합 백업 사용](administration/enable-coordinated-backups-for-transactional-replication.md)   
...
-   [배포 데이터베이스에서 복제 된 명령 및 기타 정보 보기](monitor/view-replicated-commands-and-information-in-distribution-database.md)    
-   [병합 게시에 대한 충돌 정보 보기](view-conflict-information-for-merge-publications.md) 
