...
## <a name="explanation"></a>설명  
 구독자의 데이터를 게시자의 데이터와 비교하여 유효성을 검사했는데 데이터가 일치하지 않아 유효성 검사가 실패했습니다. 유효성 검사에 대한 자세한 내용은 [Validate Replicated Data](validate-replicated-data.md)를 참조하십시오.  
