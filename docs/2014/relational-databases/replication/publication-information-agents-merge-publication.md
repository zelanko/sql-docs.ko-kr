 ...
 **에이전트**  
 스냅샷 에이전트 이 에이전트는 병합 게시와 연결된 유일한 에이전트입니다. 병합 에이전트는 이 게시에 대한 구독과 연결되어 있습니다. 자세한 내용은 [복제 모니터를 사용 하 여 정보 보기 및 태스크 수행](monitor/view-information-and-perform-tasks-replication-monitor.md)을 참조 하세요.  
