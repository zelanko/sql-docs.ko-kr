...
2.  **일반** 페이지에서 \< **사용자 이름** 상자에 _Machine_Name>_ **\ repl_merge** 를 입력 하 고 줄임표 (**...**) 단추를 클릭 한 다음 **찾아보기**를 클릭 하 \< _Machine_Name>_ **\ repl_merge**을 선택 하 고 **확인**을 클릭 한 다음 **이름 확인**을 클릭 하 고 **확인**을 클릭 합니다.  
