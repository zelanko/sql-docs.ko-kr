...
### <a name="large-object-types"></a>큰 개체 유형  
 ...
 큰 개체 유형에 대한 자세한 내용은 [Oracle 게시자에 대한 디자인 고려 사항 및 제한 사항](design-considerations-and-limitations-for-oracle-publishers.md)에서 "큰 개체에 대한 고려 사항" 섹션을 참조하세요.  
...
-   저장 프로시저를 사용하여 이후의 모든 아티클에 대한 기본값을 전역으로 변경합니다. 기존 아티클에 대한 기본값은 변경되지 않습니다.  
 ...
 대체 데이터 형식 매핑을 지정하려면 [Oracle 게시자에 대한 데이터 형식 매핑 지정](../publish/specify-data-type-mappings-for-an-oracle-publisher.md)을 참조하십시오.  
