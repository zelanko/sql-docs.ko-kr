---
title: SQL Server 복제 게시자 속성 | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
 ...
 **기타**  
 **게시자 유형** 및 **배포 데이터베이스 이름** 속성은 읽기 전용입니다. **기본 스냅숏 폴더** 속성은 변경할 수 있습니다. 스냅샷 폴더에 대한 자세한 내용은 [스냅샷 폴더 보안 설정](security/secure-the-snapshot-folder.md)을 참조하세요.  
