...
-   구독자가 IIS에 연결한 다음 리소스 및 프로세스에 액세스하려면 먼저 IIS에서 해당 구독자를 인증해야 합니다. IIS는 세 가지 유형의 인증을 제공합니다. 익명, 기본 및 통합 합니다. 인증은 전체 웹 사이트나 사용자가 만든 가상 디렉터리에 적용할 수 있습니다.  
