...
ms.locfileid: "62630553"
---
# <a name="subscription-distributor-to-subscriber-history-transactional-subscription"></a>구독, 배포자에서 구독자로의 연결 기록(트랜잭션 구독)
  **배포자에서 구독자로의 작업 기록** 탭에는 상태, 기록, 정보 메시지 및 모든 오류 메시지를 포함 하 여 배포 에이전트에 대 한 자세한 정보가 표시 됩니다.  
  
## <a name="options"></a>옵션  
 
  **보기** 메뉴에서 보려는 배포 에이전트 세션을 선택한 다음 **배포 에이전트의 세션**표에서 특정 세션을 선택합니다. 
