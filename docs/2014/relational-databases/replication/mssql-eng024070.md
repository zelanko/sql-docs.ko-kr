...
## <a name="explanation"></a>설명  
 ...
 "사용자로 실행: \<UserAccount>. 복제-복제 스냅숏 하위 시스템: \<에이전트 agentname> 실패 했습니다. 사용자: \<UserAccount>로 실행 됩니다. 클라이언트에 필수 권한이 없습니다. 단계가 실패했습니다. `[SQLSTATE 42000] (Error 14151)`. 단계가 실패했습니다."  
