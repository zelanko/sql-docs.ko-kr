...
## <a name="explanation"></a>설명  
 ...
 "다음 사용자로 실행되었습니다: \<UserAccount >. 복제-복제 스냅숏 하위 시스템: agent \<AgentName > 실패 했습니다. 다음 사용자로 실행되었습니다: \<UserAccount >. 클라이언트에 필수 권한이 없습니다. 단계가 실패했습니다. `[SQLSTATE 42000] (Error 14151)`에서 분할된 테이블 또는 인덱스를 만들 수 있습니다. 단계가 실패했습니다."  
