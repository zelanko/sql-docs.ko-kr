...
-   **경고** (이상을 실행 [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] 하는 배포자의 경우)   
    -   이 탭에서는 에이전트에 대한 경고를 지정할 수 있습니다.  
  
-   **추적 프로그램 토큰** (이상을 실행 [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] 하는 배포자에 대 한 트랜잭션 복제에만 해당)  
