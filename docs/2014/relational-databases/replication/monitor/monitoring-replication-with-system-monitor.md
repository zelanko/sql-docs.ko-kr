...
|스냅숏 에이전트|[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]: 복제 스냅숏|Snapshot: Delivered Cmds/sec|배포자로 배달된 초당 명령 수입니다.|  
|스냅숏 에이전트|[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]: 복제 스냅숏|Snapshot: Delivered Trans/sec|배포자로 배달된 초당 트랜잭션 수입니다.|  
