...
-   이 배포자를 사용하는 모든 게시자에 대해 기본적으로 사용되는 스냅샷 폴더. 이 폴더가 이미 공유되어 있고 적절한 권한 집합이 설정되어 있는지 확인합니다. 자세한 내용은 [스냅샷 폴더 보안 설정](security/secure-the-snapshot-folder.md)을 참조하세요.  
