...
## <a name="non-sql-server-subscribers"></a>Non-SQL Server Subscribers  
 Oracle 및 IBM DB2는 밀어넣기 구독을 사용하여 스냅샷 및 트랜잭션 게시를 구독할 수 있습니다. 자세한 내용은 [Non-SQL Server Subscribers](non-sql/non-sql-server-subscribers.md)을(를) 참조하세요.  
