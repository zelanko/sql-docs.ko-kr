...
# <a name="subscribers"></a>게시자 속성
  [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 선택한 게시에 대 한[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 구독을 받을 또는 이외 구독자를 지정 합니다.  
