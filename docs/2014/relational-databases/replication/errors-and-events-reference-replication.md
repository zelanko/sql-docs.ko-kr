...
|[MSSQL_ENG021075](mssql-eng021075.md)|게시 '%s'의 초기 스냅숏을 사용할 수 없습니다.|  
|[MSSQL_ENG021076](mssql-eng021076.md)|아티클 '%s'의 초기 스냅숏을 아직 사용할 수 없습니다.|  
...
|[MSSQL_ENG021385](mssql-eng021385.md)|스냅숏이 게시 '%s'을(를) 처리하지 못했습니다. 활성 스키마 변경 작업 또는 추가 중인 새 아티클 때문인 것 같습니다.|  
