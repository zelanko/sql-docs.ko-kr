...
# <a name="replication-monitor"></a>복제 모니터
  설명서의 이 섹션에는 복제 모니터에 대한 정보가 포함되어 있습니다. 모니터에 표시 되는 페이지와 대화 상자는 모니터링 되는 버전 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 및 복제 유형에 따라 달라 집니다.  
...
-   [게시 정보, 트랜잭션 게시 &#40;경고 SQL Server 2005 이상&#41;](publication-information-warnings-transactional-publication.md)  
  
-   [게시 정보, 병합 게시 &#40;경고 SQL Server 2005 이상&#41;](publication-information-warnings-merge-publication-sql-server-2005-and-later.md)  
...
-   [구독, 배포 되지 않은 명령 &#40;트랜잭션 구독, SQL Server 2005 이상&#41;](subscription-undistributed-commands-transactional-subscription.md)  
  
-   [구독, 게시자에서 배포자로의 기록 &#40;트랜잭션 구독&#41;](subscription-publisher-to-distributor-history-transactional-subscription.md)  
  
-   [구독, 배포자에서 구독자로의 기록 &#40;트랜잭션 구독&#41;](subscription-distributor-to-subscriber-history-transactional-subscription.md)  
  
-   [구독, 동기화 기록 &#40;병합 구독, SQL Server 2005 이상&#41;](subscription-synchronization-history.md)  
  
-   [구독, 배포자에서 구독자로의 기록 &#40;스냅숏 구독&#41;](subscription-distributor-to-subscriber-history-snapshot-subscription.md)  
  
-   [로그 판독기 에이전트](log-reader-agent.md)  
  
-   [큐 판독기 에이전트](queue-reader-agent.md)  
  
-   [스냅샷 에이전트](snapshot-agent.md)  
