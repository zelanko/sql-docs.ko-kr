...
## <a name="options"></a>변수  
 **구독 속성**  
 초기 데이터 집합이 필요한 각 구독자의 **초기화** 열에서 확인란을 선택합니다. 확인란 선택을 취소하면 복제 메타데이터 및 프로시저만 초기화됩니다. 스냅숏 없이 구독 초기화에 대한 자세한 내용은 [스냅숏 없이 트랜잭션 구독 초기화](initialize-a-transactional-subscription-without-a-snapshot.md)를 참조하세요.  
