...
-   [!INCLUDE[msCoName](../../includes/msconame-md.md)] 의 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] **복제** 폴더 및 모든 하위 폴더에 대 한 상황에 맞는 메뉴에서 사용할 수 있는 **SQL 스크립트를 생성**합니다. 이 대화 상자에서는 인스턴스의 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]모든 복제 개체를 스크립팅할 수 있습니다.  
  
-   게시 및 구독에 대 한 상황에 맞는 메뉴에서 사용할 수 있는 **SQL 스크립트 \<ObjectName>를 생성 **합니다. 이 대화 상자를 사용하여 개별 개체를 스크립팅할 수 있습니다.  
 ...
 **다음 데이터 원본의 구독**  
 ...
 구성 **요소를 만들거나 사용 하도록 설정** 하 고 **구성 요소를 삭제 하거나 비활성화** 하려면  
 복제 개체를 생성 또는 삭제하는 명령을 스크립트에 포함할지 여부를 지정합니다. 
  [!INCLUDE[msCoName](../../includes/msconame-md.md)] 에서는 대화 상자를 사용하여 구성 요소를 설정 및 해제하는 스크립트 집합을 만들 것을 권장합니다.  
