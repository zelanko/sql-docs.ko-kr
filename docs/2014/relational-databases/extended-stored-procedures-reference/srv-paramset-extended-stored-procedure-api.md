...
|새 데이터 형식|반환 데이터 길이|  
|--------------------|------------------------|  
|`BITN`|**NULL:** *len* = 0, DATA = IG, RET = 0<br /><br /> **0:** 해당 없음<br /><br /> **>= 255:** 해당 없음<br /><br /> **<255:** 해당 없음|  
|`BIGVARCHAR`|**NULL:** *len* = 0, DATA = IG, RET = 1<br /><br /> **0:** *len* = IG, DATA = ig, RET = 0<br /><br /> **>= 255:** *len* = max8k, DATA = valid, RET = 0<br /><br /> **<255:** *len* = <8k, DATA = valid, RET = 1|  
|`BIGCHAR`|**NULL:** *len* = 0, DATA = IG, RET = 1<br /><br /> **0:** *len* = IG, DATA = ig, RET = 0<br /><br /> **>= 255:** *len* = max8k, DATA = valid, RET = 0<br /><br /> **<255:** *len* = <8k, DATA = valid, RET = 1|  
|`BIGBINARY`|**NULL:** *len* = 0, DATA = IG, RET = 1<br /><br /> **0:** *len* = IG, DATA = ig, RET = 0<br /><br /> **>= 255:** *len* = max8k, DATA = valid, RET = 0<br /><br /> **<255:** *len* = <8k, DATA = valid, RET = 1|  
|`BIGVARBINARY`|**NULL:** *len* = 0, DATA = IG, RET = 1<br /><br /> **0:** *len* = IG, DATA = ig, RET = 0<br /><br /> **>= 255:** *len* = max8k, DATA = valid, RET = 0<br /><br /> **<255:** *len* = <8k, DATA = valid, RET = 1|  
|NCHAR|**NULL:** *len* = 0, DATA = IG, RET = 1<br /><br /> **0:** *len* = IG, DATA = ig, RET = 0<br /><br /> **>= 255:** *len* = max8k, DATA = valid, RET = 0<br /><br /> **<255:** *len* = <8k, DATA = valid, RET = 1|  
|NVARCHAR|**NULL:** *len* = 0, DATA = IG, RET = 1<br /><br /> **0:** *len* = IG, DATA = ig, RET = 0<br /><br /> **>= 255:** *len* = max8k, DATA = valid, RET = 0<br /><br /> **<255:** *len* = <8k, DATA = valid, RET = 1|  
|`NTEXT`|**NULL:** *len* = IG, DATA = ig, RET = 0<br /><br /> **0:** *len* = IG, DATA = ig, RET = 0<br /><br /> **>= 255:** *len* = IG, DATA = ig, RET = 0<br /><br /> 255: *len* = ig, data = ig, RET = 0 ** \<**|  
