 ...
 **항목 내용**  
 ...
 [사용자 정의 함수의 이점](#Benefits)  
  
 [함수 유형](#FunctionTypes)  
  
 [지침](#Guidelines)  
  
 [함수의 유효한 문](#ValidStatements)  
  
 [스키마 바운드 함수](#SchemaBound)  
  
 [매개 변수 지정](#Parameters)  
  
 [관련 작업](#Tasks)  
  
##  <a name="Benefits"></a> 사용자 정의 함수의 이점  
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]에서 사용자 정의 함수를 사용하여 얻을 수 있는 이점은 다음과 같습니다.  
...
##  <a name="FunctionTypes"></a> 함수 유형  
 스칼라 함수  
 사용자 정의 스칼라 함수는 RETURNS 절에 정의된 유형의 단일 데이터 값을 반환합니다. 인라인 스칼라 함수에는 함수 본문이 없으며 스칼라 값이 단일 문의 결과입니다. 다중 문 스칼라 함수의 함수 본문은 BEGIN...END 블록으로 정의되며 여기에는 단일 값을 반환하는 일련의 [!INCLUDE[tsql](../../includes/tsql-md.md)] 문이 포함됩니다. 반환 형식을 제외한 모든 데이터 형식일 수 `text`, `ntext`, `image`, `cursor`, 및 `timestamp`합니다.  
  
 테이블 반환 함수  
 사용자 정의 테이블 반환 함수는 반환 된 `table` 데이터 형식입니다. 인라인 테이블 반환 함수에는 함수 본문이 없으며 테이블이 단일 SELECT 문의 결과 집합입니다.  
...
|NEWSEQUENTIALID|TEXTPTR|  
 ...
 결정적 및 비결정적 기본 제공 시스템 함수 목록은 [결정적 함수 및 비결정적 함수](../user-defined-functions/deterministic-and-nondeterministic-functions.md)를 참조하세요.  
...
|Transact-SQL 사용자 정의 함수를 수정하는 방법에 대해 설명합니다.|[사용자 정의 함수 수정](../user-defined-functions/user-defined-functions.md)|  
|사용자 정의 함수를 삭제하는 방법에 대해 설명합니다.|[사용자 정의 함수 삭제](../user-defined-functions/delete-user-defined-functions.md)|  
|사용자 정의 함수를 실행하는 방법에 대해 설명합니다.|[사용자 정의 함수 실행](../user-defined-functions/execute-user-defined-functions.md)|  
|사용자 정의 함수의 이름을 바꾸는 방법에 대해 설명합니다.|[사용자 정의 함수 이름 바꾸기](../user-defined-functions/rename-user-defined-functions.md)|  
|사용자 정의 함수의 정의를 보는 방법에 대해 설명합니다.|[사용자 정의 함수 보기](view-user-defined-functions.md)|  
