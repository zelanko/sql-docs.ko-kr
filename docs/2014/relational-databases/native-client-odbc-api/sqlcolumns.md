...
## <a name="sqlcolumns-support-for-enhanced-date-and-time-features"></a>향상된 날짜 및 시간 기능에 대한 SQLColumns 지원  
 날짜/시간 형식에 대해 반환 되는 값에 대 한 자세한 내용은 [카탈로그 메타 데이터](../native-client-odbc-date-time/metadata-catalog.md)를 참조 하세요.  
...
|SS_IS_COLUMN_SET|`Smallint`|열이 `column_set` 열이면 SQL_TRUE이며 그렇지 않으면 SQL_FALSE입니다.|  
 ...
 ODBC의 스파스 열에 대 한 자세한 내용은 [스파스 열 지원 &#40;odbc&#41;](../native-client/odbc/sparse-columns-support-odbc.md)를 참조 하세요.  
