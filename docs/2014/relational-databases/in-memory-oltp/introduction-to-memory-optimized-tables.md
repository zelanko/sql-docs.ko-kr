...
|[고유하게 컴파일된 저장 프로시저](https://msdn.microsoft.com/library/dn133184.aspx)|EXECUTE 문으로는 고유하게 컴파일된 저장 프로시저에서 저장 프로시저를 실행할 수 없습니다.|사용자 계정 컨트롤|아니요 <sup>1</sup>|  
