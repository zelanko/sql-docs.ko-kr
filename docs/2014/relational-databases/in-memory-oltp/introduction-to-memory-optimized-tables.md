...
|-------------|-------------------------------------------------------|-------------------------------------------|----------------|  
|메모리 액세스에 최적화된 테이블|예|예|아니요 <sup>1</sup>|  
...
## <a name="performance-and-scalability"></a>성능 및 확장성  
 ...
 통신  
 짧은 저장 프로시저에 대해 여러 번 호출을 하는 응용 프로그램은 적은 호출을 하고 각 저장 프로시저에 더 많은 기능이 구현된 응용 프로그램이 비해 성능 향상이 적을 수 있습니다.  
 ...
 동시성  
 성능이 래치 경합 또는 차단과 같은 엔진 수준 동시성의 영향을 받는 응용 프로그램은 응용 프로그램이 메모리 내 OLTP로 이동하면 성능이 크게 개선됩니다.  
