...
ms.locfileid: "58493505"
---
# <a name="errors-and-events-reference-database-engine"></a>오류 및 이벤트 참조(데이터베이스 엔진)

이 섹션에서는 추가 설명이 필요한 선택 된 데이터베이스 엔진 오류 메시지를 포함 합니다.
  
## <a name="in-this-section"></a>섹션 내용  
 [데이터베이스 엔진 이벤트 및 오류](database-engine-events-and-errors.md) 의 형식을 설명 [!INCLUDE[ssDE](../../includes/ssde-md.md)] 오류 메시지 및 오류 메시지를 보고 응용 프로그램에 오류 메시지를 반환 하는 방법에 설명 합니다.  
