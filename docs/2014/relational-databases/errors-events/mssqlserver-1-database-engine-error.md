...
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 구성 관리자 도구를 사용하여 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]에서 TCP 또는 명명된 파이프 프로토콜을 통한 원격 연결을 허용하도록 구성합니다.  
