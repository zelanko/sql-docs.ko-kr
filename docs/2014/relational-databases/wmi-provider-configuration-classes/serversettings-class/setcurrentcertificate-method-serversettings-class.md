...
## <a name="parts"></a>부분  
 *object*  
 인스턴스의 서버 설정을 나타내는 [ServerSettings Class] serversettings-class.md) 개체입니다 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] .  
