...
ms.locfileid: "63242655"
---
# <a name="instancename-property-clientsettings-class"></a>InstanceName 속성(ClientSettings 클래스)
 ...
 *개체가*  
  ...
  `ClientSettings` 클라이언트 인스턴스의 설정을 나타내는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 개체입니다.  
