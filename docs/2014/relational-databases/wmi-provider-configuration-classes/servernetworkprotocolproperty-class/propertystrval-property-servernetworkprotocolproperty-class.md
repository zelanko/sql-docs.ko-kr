...
## <a name="parts"></a>부분  
 *object*  
 [인스턴스의 네트워크 프로토콜 특성을 나타내는](servernetworkprotocolproperty-class.md) ServerNetworkProtocolProperty 클래스 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]개체입니다.  
