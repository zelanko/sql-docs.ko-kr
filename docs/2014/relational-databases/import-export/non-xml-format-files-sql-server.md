...
##  <a name="Structure"></a> 비 XML 서식 파일의 구조  
 ...
 ![비 XML 서식 파일 필드 식별](../../database-engine/media/mydepart-fmt-ident-c.gif "비 XML 서식 파일 필드 식별")  
...
|**호스트 파일 데이터 형식**|데이터 파일의 특정 필드에 저장되는 데이터 형식 표시. ASCII 데이터 파일에는 SQLCHAR을, 네이티브 형식의 데이터 파일에는 기본 데이터 형식을 사용합니다. 자세한 내용은 [bcp를 사용하여 파일 저장 유형 지정&#40;SQL Server&#41;](specify-file-storage-type-by-using-bcp-sql-server.md)을 참조하세요.|  
