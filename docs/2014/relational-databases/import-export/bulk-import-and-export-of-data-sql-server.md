...
##  <a name="bulk-import-and-bulk-export-overview"></a><a name="Intro"></a>대량 가져오기 및 대량 내보내기 개요  
...
3.  [bcp를 사용하여 파일 스토리지 유형 지정&#40;SQL Server&#41;](specify-file-storage-type-by-using-bcp-sql-server.md)  
