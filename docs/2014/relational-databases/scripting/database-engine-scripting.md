...
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 명령을 구현하는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] cmdlet 집합. **Invoke-Sqlcmd**는 이러한 cmdlet 중 하나로, 이 실행에 사용 됩니다 [!INCLUDE[ssDE](../../includes/ssde-md.md)] 쿼리 스크립트를 사용 하 여 실행할 수는 `sqlcmd` 유틸리티입니다.  
...
-   합니다 `sqlcmd` 명령 프롬프트 유틸리티를 사용 하면 대화형으로 실행 [!INCLUDE[ssDE](../../includes/ssde-md.md)] 쿼리 및 실행 기존 [!INCLUDE[ssDE](../../includes/ssde-md.md)] 스크립트 파일을 쿼리 합니다.  
