...
# <a name="parameter-info-intellisense"></a>매개 변수 정보(IntelliSense)
  IntelliSense [!INCLUDE[msCoName](../../includes/msconame-md.md)] **매개 변수 정보** 옵션은 함수 또는 저장 프로시저에 필요한 매개 변수의 개수, 이름 및 형식에 대 한 정보를 제공 하는 매개 변수 목록을 엽니다. 굵게 표시된 매개 변수는 함수나 시스템 저장 프로시저를 입력할 때 필요한 다음 매개 변수를 나타냅니다.  
...
1.  
  **편집** 메뉴에서 **IntelliSense** 를 선택한 다음 **매개 변수 정보**를 선택합니다.  
