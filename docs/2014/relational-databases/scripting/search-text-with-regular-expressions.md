...
1.  Regular expressions 사용 하도록 설정 하려면 합니다 **찾을 내용** 중 필드 **찾기**를 **바꾸기**를 **빠른 바꾸기**, 또는  **파일에서 바꾸기** 작업을 선택 합니다 **사용 하 여** 옵션 **찾기 옵션** 선택 **정규식**합니다.  
...
|n번 반복|^n|선행 식의 n번과 대응합니다. 예를 들어 [0-9] ^4 4 자리 시퀀스와 일치 합니다.|  
|그룹화|()|하위 식을 그룹화합니다.|  
