...
2.  **스크립트를 메뉴에 사용 하려면:**  [단일 개체 스크립팅](#ScriptSingleObject), [개체 탐색기를 사용 하 여 두 개체](#ScriptTwoObjectsOE)스크립팅 [개체 탐색기 정보를 사용 하 여 두 개체 스크립팅](#ScriptTwoObjectsOED)  
...
##  <a name="ScriptTwoObjectsOE"></a>개체 탐색기를 사용 하 여 두 개체의 스크립트를 생성 하려면  
 **개체 탐색기를 사용 하 여 두 개체를 스크립팅하려면**  
...
##  <a name="ScriptTwoObjectsOED"></a>개체 탐색기 정보를 사용 하 여 두 개체의 스크립트를 생성 하려면  
 **개체 탐색기 정보를 사용 하 여 두 개체를 스크립팅하려면**  
