...
ms.locfileid: "75243733"
---
# <a name="quick-info-intellisense"></a>요약 정보(IntelliSense)
  IntelliSense [!INCLUDE[msCoName](../../includes/msconame-md.md)] **요약 정보** 옵션은 코드의 모든 식별자에 대 한 전체 선언을 표시 합니다. 마우스 포인터를 식별자 위로 이동하면 노란색 팝업 창에 해당 선언이 표시됩니다. 
  [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]에서 **요약 정보** 는 데이터베이스 엔진 및 XML 쿼리 편집기에서 사용할 수 있습니다.  
  
## <a name="transact-sql-quick-info"></a>Transact-SQL 요약 정보  
 **요약 정보** 는 [!INCLUDE[ssDE](../../includes/ssde-md.md)] 쿼리 편집기에 두 가지 유형의 정보를 표시 합니다. 디버그 모드가 아닐 때는 **요약 정보** 에 식 선언이 표시됩니다. 디버그 모드일 때는 **요약 정보** 에 식 이름과 식의 현재 값이 표시됩니다.  
