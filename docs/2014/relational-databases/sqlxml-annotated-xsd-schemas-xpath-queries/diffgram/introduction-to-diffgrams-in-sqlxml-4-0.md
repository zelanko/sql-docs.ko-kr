 ...
 **hasChanges**  
 삽입 또는 업데이트 작업에 대 한 DiffGram이 특성을 지정 해야이 값을 가진 **삽입** 또는 **수정**합니다. 이 특성이 없으면의 해당 요소는  **\<DataInstance >** 처리를 통해 무시 논리 및 업데이트가 수행 됩니다. 작업 예제를 참조 하십시오. [DiffGram 예 &#40;SQLXML 4.0&#41;](diffgram-examples-sqlxml-4-0.md)합니다.  
