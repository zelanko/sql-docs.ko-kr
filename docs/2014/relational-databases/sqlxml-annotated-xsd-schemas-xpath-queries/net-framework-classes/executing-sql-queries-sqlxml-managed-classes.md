...
3.  명령 프롬프트에서 DocSample.exe를 실행합니다.  
 ...
 SQL 쿼리를 명령 텍스트로 지정하는 대신 다음 코드 조각에 표시된 것처럼 updategram 템플릿을 실행하는 템플릿을 지정하여 고객 레코드를 삽입할 수 있습니다. 파일에서 템플릿과 updategram을 지정한 후 파일을 실행합니다. 자세한 내용은 참조 [CommandText 속성을 사용 하 여 템플릿 파일 실행](executing-template-files-by-using-the-commandtext-property.md)합니다.  
...
> [!NOTE]  
>  XmlReader 개체를 반환 하는 ExecuteXMLReadermethod를 사용할 수 있습니다. 자세한 내용은 참조 [ExecuteXMLReader 메서드를 사용 하 여 SQL 쿼리 실행](executing-sql-queries-by-using-the-executexmlreader-method.md)합니다.  
