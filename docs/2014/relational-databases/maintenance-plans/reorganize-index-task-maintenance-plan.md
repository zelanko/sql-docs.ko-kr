...
ms.locfileid: "62807071"
---
# <a name="reorganize-index-task-maintenance-plan"></a>인덱스 다시 구성 태스크(유지 관리 계획)
  **다시 구성 작업** 대화 상자를 사용 하 여 인덱스 페이지를 보다 효율적인 검색 순서로 이동할 수 있습니다. 
  `ALTER INDEX REORGANIZE` 데이터베이스의 경우 이 태스크를 수행하면 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 문이 사용됩니다.  
