...
-   컬렉션 집합 업로드 빈도: 15 분 마다  
 ...
 UMDW 디렉터리는 구성할 수 있습니다. \<시스템 드라이브 >: \Program Files\Microsoft SQL Server\MSSQL10_50. < UCP_Name > \MSSQL\Data\\여기서 \<시스템 드라이브 >는 일반적으로 C:\ 드라이브입니다. 로그 파일 Sysutility_mdw_\<GUID>_LOG는 같은 디렉터리에 있습니다.  
