...
> [!IMPORTANT]  
>  [!INCLUDE[ssNoteDepFutureDontUse](../includes/ssnotedepfuturedontuse-md.md)]대신 CLR 통합을 사용 하세요. 자세한 내용은 [CLR&#40;공용 언어 런타임&#41; 통합 프로그래밍 개요](clr-integration/common-language-runtime-clr-integration-programming-concepts.md)를 참조하세요.  
