...
|DBTYPE_UDT|**UDT**|다음 정보를 사용 하는 `DBCOLUMNDESC` 하 여 구조 **itabledefinition:: Createtable** UDT 열이 필요한 경우:<br /><br /> -   *pwSzTypeName* 는 무시 됩니다.<br />-   *rgPropertySets* 포함 되어야 합니다는 `DBPROPSET_SQLSERVERCOLUMN` 속성 설정에 섹션에 설명 된 대로 `DBPROPSET_SQLSERVERCOLUMN`에 [사용자 형식](../native-client/features/using-user-defined-types.md)합니다.|  
|DBTYPE_UI1|**tinyint**||  
