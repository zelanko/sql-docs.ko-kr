---
title: '자습서: SQL Server 데이터 파일에서 Windows Azure 저장소 서비스 | Microsoft Docs'
ms.custom: ''
ms.date: 06/13/2017
...
# <a name="tutorial-sql-server-data-files-in-windows-azure-storage-service"></a>자습서: Windows Azure 저장소의 SQL Server 데이터 파일 서비스
 ...
 Windows Azure BLOB 저장소 서비스에 SQL Server를 통합할 수 있도록 지원하는 기능은 SQL Server 2014에서 새로 도입되었습니다. 참조 된 기능의 개요 및이 기능을 사용할 때의 이점에 대 한 [Windows Azure에서 SQL Server 데이터 파일](databases/sql-server-data-files-in-microsoft-azure.md)합니다.  
 ...
 **[2 단원입니다. 컨테이너에 정책 만들기 및 공유 액세스 서명 생성 &#40;SAS&#41; 키](lesson-1-create-stored-access-policy-and-shared-access-signature.md)**  
 ...
 **[4 단원: Windows Azure 저장소에서 데이터베이스 만들기](../relational-databases/lesson-3-database-backup-to-url.md)**  
 ...
 **[6 단원: 소스에서 데이터베이스를 마이그레이션 온-프레미스 Windows Azure에서 대상 컴퓨터와 컴퓨터](lesson-5-backup-database-using-file-snapshot-backup.md)**  
 이 단원에서는 CREATE DATABASE FOR ATTACH 옵션을 사용하여 온-프레미스에서 Microsoft Azure의 가상 머신으로 데이터베이스를 마이그레이션합니다.  
  
 **[7 단원: Windows Azure 저장소에 데이터 파일 이동](../relational-databases/lesson-6-generate-activity-and-backup-log-using-file-snapshot-backup.md)**  
 이 단원에서는 ALTER DATABASE 문을 사용하여 Windows Azure 저장소로 데이터 파일을 이동합니다.  
  
 **[8단원. Windows Azure 저장소에 데이터베이스를 복원 합니다.](../relational-databases/lesson-7-restore-a-database-to-a-point-in-time.md)**  
 이 단원에서는 RESTORE Database MOVE 옵션을 사용하여 Windows Azure 저장소로 데이터베이스를 복원합니다.  
  
 **[9 단원입니다. Windows Azure 저장소에서 데이터베이스를 복원 합니다.](lesson-8-restore-as-new-database-from-log-backup.md)**  
