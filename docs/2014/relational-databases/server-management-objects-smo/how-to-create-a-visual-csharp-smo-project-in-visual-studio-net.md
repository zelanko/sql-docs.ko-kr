...
5.  Visual C# 애플리케이션 형식을 선택합니다. 다음 예제에서는 **콘솔 응용 프로그램**을 선택 합니다.  
...
10. **보기** 메뉴에서 **코드**를 클릭 합니다. 또는 Program1.cs [Design] windows를 선택 하 고 windows form을 두 번 클릭 하 여 코드 창을 표시 합니다.  
