...
## <a name="examples"></a>예  
 ...
 데이터베이스 메일를 사용 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 하는 프로그램의 경우 메일 네임 `Imports` 스페이스를 한 정하는 문을 포함 해야 합니다. 다음과 같이 애플리케이션의 선언 앞에, 다른 `Imports` 문 끝에 구문을 삽입하십시오.  
