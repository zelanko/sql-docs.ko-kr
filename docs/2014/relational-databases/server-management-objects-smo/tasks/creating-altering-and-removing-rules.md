...
## <a name="creating-altering-and-removing-a-rule-in-visual-basic"></a>Visual Basic에서 규칙 생성, 변경 및 제거  
 ...
 System.Data 어셈블리의 `Dim` 개체와 혼동을 피하기 위해 이 <xref:Microsoft.SqlServer.Management.Smo.Rule> 개체의 <xref:Microsoft.SqlServer.Management.Smo.Rule> 문은 전체 어셈블리 경로로 지정됩니다.  
