...
-   XML 스키마 컬렉션, XML 인덱스 및 XML 데이터 형식으로 XML 데이터의 유효성 검사와 스토리지 기능 제공. 자세한 내용은 [XML 스키마 컬렉션 &#40;SQL Server&#41; ](../xml/xml-schema-collections-sql-server.md) 하 고 [Using XML Schemas](tasks/using-xml-schemas.md).  
