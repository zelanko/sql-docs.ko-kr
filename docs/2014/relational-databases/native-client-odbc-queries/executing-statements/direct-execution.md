...
-   SQL 문에 데이터 상수를 포함하지 않습니다. 대신 프로그램 변수에 바인딩된 매개 변수 표식을 사용합니다. 자세한 내용은 참조 [문 매개 변수를 사용 하 여](../using-statement-parameters.md)합니다.  
