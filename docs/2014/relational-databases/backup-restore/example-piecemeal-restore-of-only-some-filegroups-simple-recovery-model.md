---
title: '예: 일부 파일 (단순 복구 모델)의 증분 복원 | Microsoft Docs'
ms.custom: ''
ms.date: 06/13/2017
...
---
# <a name="example-piecemeal-restore-of-only-some-filegroups-simple-recovery-model"></a>예: 일부 파일 (단순 복구 모델)의 증분 복원
...
## <a name="see-also"></a>관련 항목  
 ...
 [복원&#40;Transact-SQL&#41;](/sql/t-sql/statements/restore-statements-transact-sql)   
