...
3.  [RESTORE LABELONLY](/sql/t-sql/statements/restore-statements-labelonly-transact-sql) 문을 사용합니다. 이 예에서는 `AdvWrks2008R2Backup` 논리적 백업 장치에 대한 정보를 반환합니다.  
