...
-   Windows 저장소 계정 및 컨테이너. 자세한 내용은 다음을 참조하십시오. [Lesson 1: Create Windows Azure Storage Objects](../../tutorials/lesson-1-create-windows-azure-storage-objects.md)입니다.  
