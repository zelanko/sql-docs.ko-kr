 ...
 **백업 유형**  
 ...
 [파일 백업(file backup)](full-file-backups-sql-server.md)  
 하나 이상의 데이터베이스 파일 또는 파일 그룹에 대한 백업입니다.  
  
 [부분 백업(partial backup)](partial-backups-sql-server.md)  
 ...
 **백업 미디어 용어 및 정의**  
 ...
 [미러링된 미디어 세트(mirrored media set)](mirrored-backup-media-sets-sql-server.md)  
...
##  <a name="restrictions-on-backup-operations-in-sql-server"></a><a name="Restrictions"></a>SQL Server의 백업 작업에 대 한 제한 사항  
