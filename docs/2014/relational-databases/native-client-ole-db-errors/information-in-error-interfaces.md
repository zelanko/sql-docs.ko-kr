...
|**GetCustomErrorObject**|인터페이스에 대 한 참조를 반환 **ISQLErrorInfo 합니다** 하 고 [ISQLServerErrorInfo](../../database-engine/dev-guide/isqlservererrorinfo-ole-db.md)합니다.|  
