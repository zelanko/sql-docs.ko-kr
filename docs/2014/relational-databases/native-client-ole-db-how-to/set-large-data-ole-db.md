...
1.  BLOB 열에 액세스하는 방법을 설명하는 DBOBJECT 구조를 만듭니다. DBOBJECT 구조의 **Dwflag** 요소를 STGM_READ 설정 하 고 iid 요소를 (노출할 인터페이스) `IID_ISequentialStream` 로 설정 합니다.  
