...
> [!NOTE]  
>  스냅숏 격리 수준은 [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]에서 도입되었습니다. 자세한 내용은 참조 [스냅숏 격리 작업](../native-client/features/working-with-snapshot-isolation.md)합니다.  
