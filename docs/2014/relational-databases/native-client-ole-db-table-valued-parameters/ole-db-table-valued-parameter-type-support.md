...
## <a name="methods"></a>메서드  
 테이블 반환 매개 변수를 지 원하는 OLE DB 방법에 대 한 정보를 참조 하십시오. [OLE DB Table-Valued 매개 변수 형식 지원 &#40;메서드&#41;](ole-db-table-valued-parameter-type-support-methods.md)합니다.  
  
## <a name="properties"></a>속성  
 테이블 반환 매개 변수를 지 원하는 OLE DB 속성에 대 한 방법에 대 한 자세한 내용은 참조 하십시오. [OLE DB Table-Valued 매개 변수 형식 지원 &#40;속성&#41;](ole-db-table-valued-parameter-type-support-properties.md)합니다.  
