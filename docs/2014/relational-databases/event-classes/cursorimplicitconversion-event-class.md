...
|**BinaryData**|**image**|결과로 나타나는 커서 유형입니다. 값은 다음과 같습니다.<br /><br /> 1 = 키 집합<br /><br /> 2 = 동적<br /><br /> 4 = 정방향 전용<br /><br /> 8 = 정적<br /><br /> 16 = 빠른 정방향|2|yes|  
...
|**RequestID**|**int**|암시적 변환의 요청 식별자입니다.|49|yes|  
