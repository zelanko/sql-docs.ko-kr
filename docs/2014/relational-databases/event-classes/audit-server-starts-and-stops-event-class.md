...
# <a name="audit-server-starts-and-stops-event-class"></a>Audit Server Starts and Stops 이벤트 클래스
  **Audit Server 시작 및 중지** 이벤트 클래스는 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 서비스 상태가 수정 될 때 발생 합니다.  
...
|**EventClass**|**int**|이벤트 유형 = 18|27|예|  
|**EventSequence**|**int**|요청 내에 지정된 이벤트 시퀀스입니다.|51|예|  
|**EventSubClass**|**int**|이벤트 하위 클래스의 유형입니다.<br /><br /> 1=종료<br /><br /> 2=시작<br /><br /> 3=일시 중지<br /><br /> 4=계속|21|yes|  
