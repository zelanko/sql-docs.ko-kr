...
|Duration|`bigint`|OLE DB QueryInterface 이벤트를 완료하는 데 소요되는 시간입니다.|13|아니요|  
...
|EventClass|`int`|이벤트 유형 = 120|27|아니요|  
|EventSequence|`int`|일괄 처리에서 OLE DB 이벤트 클래스의 순서입니다.|51|아니요|  
