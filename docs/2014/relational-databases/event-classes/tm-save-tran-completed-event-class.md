---
title: 'TM: Save Tran Completed 이벤트 클래스 | Microsoft Docs'
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "63061288"
---
# <a name="tm-save-tran-completed-event-class"></a>TM: Save Tran Completed 이벤트 클래스
  TM: Save Tran Completed 이벤트 클래스는 SAVE TRANSACTION 요청이 완료 되었음을 나타냅니다. 요청은 클라이언트에서 트랜잭션 관리 인터페이스를 통해 전송됩니다.  
  
## <a name="tm-save-tran-completed-event-class-data-columns"></a>TM: Save Tran Completed 이벤트 클래스 데이터 열  
...
|EventClass|`int`|이벤트 유형 = 192|27|아니요|  
