...
|**EventClass**|**int**|기록된 이벤트 유형 = 75|27|예|  
|**EventSequence**|**int**|일괄 처리 내의 **CursorRecompile** 이벤트 클래스 순서입니다.|51|예|  
...
|**RequestID**|**int**|커서를 다시 컴파일한 요청 식별자입니다.|49|yes|  
