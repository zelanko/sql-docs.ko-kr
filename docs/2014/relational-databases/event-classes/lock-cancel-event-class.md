...
|**DatabaseName**|`nvarchar`|잠금 획득이 시도된 데이터베이스의 이름입니다.|35|사용자 계정 컨트롤|  
|**기간**|`bigint`|잠금 요청 실행과 잠금 취소 사이의 시간(마이크로초)입니다.|13|사용자 계정 컨트롤|  
|**EndTime**|`datetime`|이벤트가 종료된 시간입니다.|15|사용자 계정 컨트롤|  
|**EventClass**|`int`|이벤트 유형 = 26|27|아니요|  
...
|**Exchange Spill**|`int`|잠금이 취소된 개체의 ID입니다(사용 및 적용 가능한 경우).|22|사용자 계정 컨트롤|  
