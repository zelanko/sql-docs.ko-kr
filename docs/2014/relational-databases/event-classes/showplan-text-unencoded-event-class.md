...
ms.locfileid: "62650378"
---
# <a name="showplan-text-unencoded-event-class"></a>Showplan Text (Unencoded) 이벤트 클래스
  실행 계획 텍스트 (인코딩되지 않음) 이벤트 클래스는 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 가 SQL 문을 실행할 때 발생 합니다. 이 이벤트 클래스는 Showplan Text 이벤트 클래스와 동일하지만 해당 이벤트 정보의 형식이 이진 데이터가 아닌 문자열입니다.  
...
## <a name="see-also"></a>참고 항목  
 ...
 [실행 계획 XML 이벤트 클래스](showplan-xml-event-class.md)   
