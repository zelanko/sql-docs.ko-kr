...
# <a name="audit-server-operation-event-class"></a>Audit Server Operation 이벤트 클래스
  **Audit Server Operation** 이벤트 클래스는 설정, 리소스, 외부 액세스 또는 권한 부여 변경 등의 보안 감사 작업이 사용 되는 경우에 발생 합니다.  
  
## <a name="audit-server-operation-event-class-data-columns"></a>Audit Server Operation 이벤트 클래스 데이터 열  
...
|**EventSubClass**|**int**|이벤트 하위 클래스의 유형입니다.<br /><br /> 1=관리자 대량 작업<br /><br /> 2=설정 변경<br /><br /> 3=리소스 변경<br /><br /> 4=인증<br /><br /> 5=외부 액세스<br /><br /> 6=서버 상태 변경<br /><br /> 7=안전하지 않은 어셈블리<br /><br /> 8=연결 변경<br /><br /> 9=리소스 관리자 변경<br /><br /> 10=작업 그룹 사용<br /><br /> 11=서버 상태 보기|21|yes|  
