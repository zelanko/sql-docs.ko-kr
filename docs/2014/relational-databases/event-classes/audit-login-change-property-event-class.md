...
|**EventSubClass**|**int**|이벤트 하위 클래스의 유형입니다.<br /><br /> 1=기본 데이터베이스가 변경됨<br /><br /> 2=기본 언어가 변경됨<br /><br /> 3=이름이 변경됨<br /><br /> 4=자격 증명이 변경됨<br /><br /> 5=정책이 변경됨<br /><br /> 6=만료가 변경됨|21|사용자 계정 컨트롤|  
