...
ms.locfileid: "62650406"
---
# <a name="showplan-xml-for-query-compile-event-class"></a>Showplan XML For Query Compile 이벤트 클래스
  실행 계획 XML For Query Compile 이벤트 클래스는가 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] SQL 문을 컴파일할 때 발생 합니다. 에서 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]실행 계획 연산자를 식별 하려면 thisevent 클래스를 포함 합니다.  
...
|Event Class|`int`|이벤트 유형 = 168|27|예|  
