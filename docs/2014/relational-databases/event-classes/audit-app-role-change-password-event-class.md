...
|**DatabaseName**|**nvarchar**|애플리케이션의 역할이 수정되는 데이터베이스 이름입니다.|35|yes|  
|**DBUserName**|**nvarchar**|데이터베이스에 있는 발급자의 사용자 이름입니다.|40|yes|  
|**EventClass**|**int**|이벤트 유형 = 112|27|예|  
...
|**RoleName**|**nvarchar**|애플리케이션 역할의 이름입니다.|38|yes|  
