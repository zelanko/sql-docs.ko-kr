...
|EventClass|`int`|이벤트 유형 = 55|27|예|  
|EventSequence|`int`|요청 내에 지정된 이벤트 시퀀스입니다.|51|예|  
|EventSubClass|`int`|이벤트 하위 클래스의 유형입니다.<br /><br /> 0=재귀<br /><br /> 1=한도 초과|21|yes|  
...
|LoginName|`nvarchar`|사용자 로그인 이름 ( * \<도메인>\\<사용자 이름\>*) 형식의 Windows 로그인 자격 증명 또는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 보안 로그인입니다.|11|yes|  
...
|ObjectID|`int`|재분할에 관련된 해시 팀의 루트 노드 ID입니다. 실행 계획의 노드 ID와 일치합니다.|22|yes|  
