...
|CPU|`int`|일괄 처리에 사용된 CPU 시간(밀리초)입니다.|18|yes|  
...
|읽기|`bigint`|일괄 처리로 인한 페이지 읽기 I/O 수입니다.|16|yes|  
...
|TextData|`ntext`|일괄 처리의 텍스트입니다.|1|yes|  
|TransactionID|`bigint`|시스템이 할당한 트랜잭션의 ID입니다.|4|yes|  
|쓰기|`bigint`|일괄 처리로 인한 페이지 쓰기 I/O 수입니다.|17|yes|  
