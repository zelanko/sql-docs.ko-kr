...
ms.locfileid: "63000635"
---
# <a name="audit-login-event-class"></a>Audit Login 이벤트 클래스
  **Audit Login** 이벤트 클래스는 사용자가에 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]성공적으로 로그인 했음을 나타냅니다. 이 이벤트 클래스는 연결 풀에서 다시 사용된 연결 또는 새 연결에 의해 발생합니다.  
