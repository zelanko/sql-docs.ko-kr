...
|Reads|`bigint`|이벤트 대신 서버에서 수행한 논리적 디스크 읽기 수입니다.|16|사용자 계정 컨트롤|  
|RequestID|`int`|문을 포함하는 요청의 ID입니다.|49|사용자 계정 컨트롤|  
|RowCounts|`bigint`|이벤트의 영향을 받은 행의 수입니다.|48|사용자 계정 컨트롤|  
...
|Writes|`bigint`|이벤트 대신 서버에서 수행한 물리적 디스크 쓰기 수입니다.|17|사용자 계정 컨트롤|  
