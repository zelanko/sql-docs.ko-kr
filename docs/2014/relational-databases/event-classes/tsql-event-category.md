...
|항목|Description|  
|-----------|-----------------|  
|[Exec Prepared SQL 이벤트 클래스](exec-prepared-sql-event-class.md)|SqlClient, ODBC, OLE DB 또는 DB-Library가 준비된 [!INCLUDE[tsql](../../includes/tsql-md.md)] 문을 실행했음을 나타냅니다.|  
|[Prepare SQL 이벤트 클래스](prepare-sql-event-class.md)|SqlClient, ODBC, OLE DB 또는 DB-Library가 사용할 [!INCLUDE[tsql](../../includes/tsql-md.md)] 문을 준비했음을 나타냅니다.|  
