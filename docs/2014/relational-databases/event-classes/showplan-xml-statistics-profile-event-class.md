...
# <a name="showplan-xml-statistics-profile-event-class"></a>Showplan XML Statistics Profile 이벤트 클래스
  실행 계획 XML Statistics Profile 이벤트 클래스는가 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] SQL 문을 실행할 때 발생 합니다. 실행 계획 연산자 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]를 식별 하려면 실행 계획 XML statistics Profile 이벤트 클래스를 포함 합니다.  
