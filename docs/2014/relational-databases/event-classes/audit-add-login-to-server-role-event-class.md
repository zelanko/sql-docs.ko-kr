...
# <a name="audit-add-login-to-server-role-event-class"></a>Audit Add Login to Server Role 이벤트 클래스
  **Audit Add login To Server role** 이벤트 클래스는 고정 서버 역할에서 로그인이 추가 되거나 제거 될 때마다 발생 합니다. 이 이벤트 클래스는 **sp_addsrvrolemember** 및 **sp_dropsrvrolemember** 저장 프로시저에 대해 사용됩니다.  
...
|**DBUserName**|**nvarchar**|로그인을 추가하거나 제거한 데이터베이스 사용자의 이름입니다.|40|yes|  
|**EventClass**|**int**|이벤트 유형 = 108|27|예|  
...
|**RoleName**|**nvarchar**|멤버 자격을 수정 중인 고정 서버 역할의 이름입니다.|38|yes|  
...
## <a name="see-also"></a>참고 항목  
 ...
 [Transact-sql&#41;sp_addsrvrolemember &#40;](/sql/relational-databases/system-stored-procedures/sp-addsrvrolemember-transact-sql)   
 [Transact-sql&#41;sp_dropsrvrolemember &#40;](/sql/relational-databases/system-stored-procedures/sp-dropsrvrolemember-transact-sql)  
