...
# <a name="audit-logout-event-class"></a>Audit Logout 이벤트 클래스
  **Audit Logout** 이벤트 클래스는 사용자가에서 로그 아웃 (로그 오프) [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]했음을 나타냅니다. 이 이벤트 클래스는 연결 풀에서 다시 사용된 연결 또는 새 연결에 의해 발생합니다.  
...
|**읽기**|**bigint**|연결하는 동안 사용자가 실행한 논리적 읽기 I/O 수입니다.|16|yes|  
...
|**쓰기**|**bigint**|연결하는 동안 사용자가 실행한 논리적 쓰기 I/O 수입니다.|17|yes|  
