...
ms.locfileid: "62938883"
---
# <a name="audit-login-change-password-event-class"></a>Audit Login Change Password 이벤트 클래스
  **Audit login Change password** 이벤트 클래스는 사용자가 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 로그인 암호를 변경할 때마다 발생 합니다.  
...
|**EventClass**|**int**|이벤트 유형 = 107|27|예|  
|**EventSequence**|**int**|요청 내에 지정된 이벤트 시퀀스입니다.|51|예|  
|**EventSubClass**|**int**|이벤트 하위 클래스의 유형입니다.<br /><br /> 1=암호 자체 변경됨<br /><br /> 2=암호 변경됨<br /><br /> 3=암호 자체 다시 설정<br /><br /> 4=암호 다시 설정<br /><br /> 5=암호 잠금 해제<br /><br /> 6=암호 변경해야 함|21|yes|  
