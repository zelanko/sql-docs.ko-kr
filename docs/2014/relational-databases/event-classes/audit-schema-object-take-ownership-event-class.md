...
ms.locfileid: "63012531"
---
# <a name="audit-schema-object-take-ownership-event-class"></a>Audit Schema Object Take Ownership 이벤트 클래스
  **Audit Schema Object Take** owner 이벤트 클래스는 스키마 개체 (예: 테이블, 프로시저 또는 함수)의 소유자를 변경할 수 있는 권한이 확인 될 때 발생 합니다. 이 이벤트 클래스는 ALTER AUTHORIZATION 문을 사용하여 개체에 소유자를 할당할 때 발생합니다.  
...
|**ParentName**|**nvarchar**|개체가 포함된 스키마 이름입니다.|59|yes|  
