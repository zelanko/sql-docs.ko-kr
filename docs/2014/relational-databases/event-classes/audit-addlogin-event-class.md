...
ms.locfileid: "62912167"
---
# <a name="audit-addlogin-event-class"></a>Audit Addlogin 이벤트 클래스
  **Audit addlogin** 이벤트 클래스는 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 로그인이 추가 되거나 제거 될 때 발생 합니다.  
 ...
 이 감사 이벤트는 **sp_addlogin** 및 **sp_droplogin** 저장 프로시저에 대한 것입니다.  
...
## <a name="audit-addlogin-event-class-data-columns"></a>Audit Addlogin 이벤트 클래스 데이터 열  
...
|**EventClass**|**int**|이벤트 유형 = 104|27|예|  
...
|**TargetLoginName**|**nvarchar**|추가 또는 삭제될 로그인의 이름입니다.|42|yes|  
|**TargetLoginSid**|**image**|대상 로그인의 SID(보안 ID)입니다(매개 변수로 전달된 경우).|43|yes|  
...
## <a name="see-also"></a>참고 항목  
 ...
 [Transact-sql&#41;sp_droplogin &#40;](/sql/relational-databases/system-stored-procedures/sp-droplogin-transact-sql)   
