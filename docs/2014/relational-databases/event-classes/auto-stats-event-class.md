...
|**작업**|**bigint**|이벤트에 의해 사용된 시간(마이크로초)입니다.|13|예|  
...
|**EventSubClass**|**int**|이벤트 하위 클래스의 유형입니다.<br /><br /> 1: 통계가 동기적으로 생성/업데이트 됩니다. **TextData** 열은 통계가 만들어지거나 업데이트 되었는지를 나타냅니다.<br /><br /> 2: 비동기 통계 업데이트입니다. 작업이 지연되었습니다.<br /><br /> 3: 비동기 통계 업데이트입니다. 작업이 시작되었습니다.<br /><br /> 4: 비동기 통계 업데이트입니다. 작업이 완료되었습니다.|21|예|  
