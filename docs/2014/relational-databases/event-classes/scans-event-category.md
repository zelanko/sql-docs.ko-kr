...
|항목|Description|  
|-----------|-----------------|  
|[Scan:Started 이벤트 클래스](scan-started-event-class.md)|테이블 또는 인덱스 검색이 시작되었음을 나타냅니다.|  
|[Scan:Stopped 이벤트 클래스](scan-stopped-event-class.md)|테이블 또는 인덱스 검색이 중지되었음을 나타냅니다.|  
