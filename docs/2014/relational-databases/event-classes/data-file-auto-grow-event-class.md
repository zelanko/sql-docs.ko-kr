...
|**EndTime**|**datetime**|데이터 파일이 자동으로 증가하는 시간이 종료되었습니다.|18|yes|  
|**EventClass**|**int**|이벤트 유형 = 92|27|예|  
...
|**IntegerData**|**int**|파일이 증분되는 8KB 페이지 단위의 수입니다.|25|yes|  
...
|**NTDomainName**|**nvarchar**|[!INCLUDE[msCoName](../../includes/msconame-md.md)] 사용자가 속한 Windows 도메인입니다.|7|yes|  
