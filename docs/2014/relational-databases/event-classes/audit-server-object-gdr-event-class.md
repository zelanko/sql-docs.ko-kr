...
# <a name="audit-server-object-gdr-event-class"></a>Audit Server Object GDR 이벤트 클래스
  **Audit Server OBJECT GDR** 이벤트 클래스는 Microsoft SQL Server 사용자가 서버 개체 사용 권한에 대해 GRANT, REVOKE 또는 DENY를 실행할 때마다 발생 합니다.  
...
|**권한**|**bigint**|확인한 사용 권한의 유형을 나타내는 정수 값입니다.<br /><br /> 1 = SELECT ALL<br /><br /> 2 = UPDATE ALL<br /><br /> 4 = REFERENCES ALL<br /><br /> 8 = INSERT<br /><br /> 16 = DELETE<br /><br /> 32 = EXECUTE(프로시저에만 해당)<br /><br /> 4096 = SELECT ANY(최소 하나의 열)<br /><br /> 8192 = UPDATE ANY|19|yes|  
