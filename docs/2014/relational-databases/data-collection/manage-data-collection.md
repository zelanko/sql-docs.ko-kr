...
|프로시저 이름|Description|  
|--------------------|-----------------|  
|[core.sp_create_snapshot&#40;Transact-SQL&#41;](/sql/relational-databases/system-stored-procedures/core-sp-create-snapshot-transact-sql)|관리 데이터 웨어하우스에 컬렉션 스냅샷을 만듭니다.|  
