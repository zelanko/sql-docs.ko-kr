...
-   명령 프롬프트에서 `sqlps`를 입력하고 Enter 키를 누릅니다. `cd xevent`를 입력한 다음 Enter 키를 누릅니다. 여기에서 **cd** 및 `dir` 명령 (또는 **Set Location** 및 **Get-childitem** cmdlet)을 사용 하 여 서버 이름 및 인스턴스 이름으로 이동할 수 있습니다.  
