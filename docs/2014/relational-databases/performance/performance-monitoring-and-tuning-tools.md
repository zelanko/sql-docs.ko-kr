...
|사용자 지정 애플리케이션에서 사용|예 <sup>1</sup>||||예||  
 ...
 <sup>1</sup> [!INCLUDE[ssSqlProfiler](../../../includes/sssqlprofiler-md.md)] 시스템 저장 프로시저를 사용 합니다.  
