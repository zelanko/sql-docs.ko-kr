...
|사용자 지정 응용 프로그램에서 사용|예 <sup>1</sup>||||예||  
 ...
 <sup>1</sup> Using [!INCLUDE[ssSqlProfiler](../../../includes/sssqlprofiler-md.md)] 시스템 저장 프로시저입니다.  
