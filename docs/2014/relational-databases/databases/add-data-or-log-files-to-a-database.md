...
11. 파일 경로를 지정합니다. 지정한 경로가 있어야 파일을 추가할 수 있습니다.  
    ...
    > [!NOTE]  
    >  기본적으로 데이터와 트랜잭션 로그는 단일 디스크 시스템에 맞게 동일한 드라이브와 경로에 배치되지만 프로덕션 환경에서는 적절하지 않을 수도 있습니다. 자세한 내용은 [Database Files and Filegroups](database-files-and-filegroups.md)을 참조하세요.  
