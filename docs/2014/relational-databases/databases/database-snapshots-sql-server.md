...
-   [데이터베이스 스냅숏에 대 한 사전 요구 사항 및 제한 사항](#LimitationsRequirements)  
...
##  <a name="LimitationsRequirements"></a>데이터베이스 스냅숏에 대 한 사전 요구 사항 및 제한 사항  
 **이 섹션의 설명:**  
  
-   [필수 구성 요소](#Prerequisites)  
  
-   [원본 데이터베이스에 대 한 제한 사항](#LimitsOnSourceDb)  
  
-   [데이터베이스 스냅숏에 대 한 제한 사항](#LimitsOnDbSS)  
  
-   [디스크 공간 요구 사항](#DiskSpace)  
  
-   [오프 라인 파일 그룹이 있는 데이터베이스 스냅숏](#OfflineFGs)  
...
###  <a name="LimitsOnSourceDb"></a>원본 데이터베이스에 대 한 제한 사항  
...
###  <a name="LimitsOnDbSS"></a>데이터베이스 스냅숏에 대 한 제한 사항  
...
###  <a name="OfflineFGs"></a>오프 라인 파일 그룹이 있는 데이터베이스 스냅숏  
...
-   [Transact-sql&#41;&#40;데이터베이스 스냅숏의 스파스 파일 크기를 확인 합니다.](view-the-size-of-the-sparse-file-of-a-database-snapshot-transact-sql.md)  
