...
##  <a name="cross-database-queries"></a><a name="cross_database_queries"></a>데이터베이스 간 쿼리  
...
##  <a name="database-ownership"></a><a name="database_ownership"></a>데이터베이스 소유권  
...
##  <a name="encrypted-data"></a><a name="encrypted_data"></a>암호화 된 데이터  
...
##  <a name="event-notifications-and-windows-management-instrumentation-wmi-events-at-server-level"></a><a name="event_notif_and_wmi_events"></a>이벤트 알림 및 WMI (WMI(Windows Management Instrumentation)) 이벤트 (서버 수준)  
...
##  <a name="extended-stored-procedures"></a><a name="extended_stored_procedures"></a>확장 저장 프로시저  
...
##  <a name="full-text-engine-for-sql-server-properties"></a><a name="ifts_service_properties"></a>SQL Server 속성에 대 한 전체 텍스트 엔진  
...
##  <a name="jobs"></a><a name="jobs"></a>직업  
...
-   [SQL Server 에이전트 구성](../../ssms/agent/sql-server-agent.md) ( [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]인스턴스를 설치하는 경우)  
...
-   [GRANT 서버 사용 권한&#40;Transact-SQL&#41;](/sql/t-sql/statements/grant-server-permissions-transact-sql)  
  
 인증서 및 비대칭 키에 대한 자세한 내용은 [Encryption Hierarchy](../security/encryption/encryption-hierarchy.md)을 참조하십시오.  
  
 [&#91;맨 위로 이동&#93;](#information_entities_and_objects)  
  
##  <a name="replication-settings"></a><a name="replication_settings"></a>복제 설정  
...
##  <a name="service-broker-applications"></a><a name="sb_applications"></a>응용 프로그램 Service Broker  
...
##  <a name="triggers-at-server-level"></a><a name="triggers"></a>트리거 (서버 수준)  
