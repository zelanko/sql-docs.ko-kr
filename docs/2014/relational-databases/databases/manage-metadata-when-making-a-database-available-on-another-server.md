---
title: 다른 서버 인스턴스 (SQL Server)에서 데이터베이스를 사용할 수 있도록 할 때 메타 데이터 관리 | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
> [!NOTE]  
>  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 에이전트 프록시 계정은 자격 증명을 사용 합니다. 프록시 계정의 자격 증명 ID를 확인하려면 [sysproxies](/sql/relational-databases/system-tables/dbo-sysproxies-transact-sql) 시스템 테이블을 사용하십시오.  
