...
`ALTER DATABASE`분리 및 연결을 사용 하는 대신 계획 된 재배치 절차를 사용 하 여 데이터베이스를 이동 하는 것이 좋습니다. 자세한 내용은 [Move User Databases](move-user-databases.md)을 참조하세요.  
