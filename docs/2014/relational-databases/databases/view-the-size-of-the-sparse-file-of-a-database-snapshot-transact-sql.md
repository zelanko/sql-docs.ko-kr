...
>  스파스 파일은 64KB씩 증분되므로 디스크상의 스파스 파일 크기는 항상 64KB의 배수입니다.  
 ...
 스냅숏의 각 스파스 파일이 현재 디스크에서 사용 중인 바이트 수를 확인하려면 **sys.dm_io_virtual_file_stats** 동적 관리 뷰의 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)][size_on_disk_bytes](/sql/relational-databases/system-dynamic-management-views/sys-dm-io-virtual-file-stats-transact-sql) 열을 쿼리합니다.  
