...
ms.locfileid: "72798059"
---
# <a name="extensible-key-management-using-azure-key-vault-sql-server"></a>Azure 키 자격 증명 모음(SQL Server)을 사용한 확장 가능 키 관리
  [!INCLUDE[msCoName](../../../includes/msconame-md.md)] Azure Key Vault에 대 한 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 커넥터를 사용 하 여 암호화 키를 보호 하기 위해 Azure Key Vault 서비스를 [확장 가능 키 &#40;관리 EKM&#41; ](extensible-key-management-ekm.md) 공급자로 활용할 수 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 있습니다.  
...
2.  [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 암호화 시나리오를 설정 및 관리하려면 키 자격 증명 모음을 사용하도록 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 관리자 로그인용 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 자격 증명을 설정합니다.  
    ...
    ```  
     ...
     `CREATE CREDENTIAL` 인수에 변수를 사용 하 고 클라이언트 ID에서 하이픈을 프로그래밍 방식으로 제거 하는 예는 [CREATE CREDENTIAL &#40;transact-sql&#41;](/sql/t-sql/statements/create-credential-transact-sql)을 참조 하세요.  
...
## <a name="see-also"></a>관련 항목:  
 ...
 [EKM 를 사용 하 여 TDE 사용](enable-tde-on-sql-server-using-ekm.md)  
