...
ms.locfileid: "70978375"
---
# <a name="create-a-database-master-key"></a>데이터베이스 마스터 키 만들기

이 항목에서는를 사용 `master` [!INCLUDE[tsql](../../../includes/tsql-md.md)]하 여에서 [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)] 데이터베이스에 데이터베이스 마스터 키를 만드는 방법에 대해 설명 합니다.
...
3. **시스템 데이터베이스**를 확장 하 고 마우스 `master` 오른쪽 단추를 클릭 한 다음 **새 쿼리**를 클릭 합니다.
