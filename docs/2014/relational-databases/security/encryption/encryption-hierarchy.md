...
# <a name="encryption-hierarchy"></a>암호화 계층
 ...
 ![일부 암호화 조합을 스택으로 표시합니다.](../../../database-engine/media/encryption-hierarchy-stack.gif "일부 암호화 조합을 스택으로 표시합니다.")  
...
-   서비스 마스터 키 및 모든 데이터베이스 마스터 키는 대칭 키입니다.  
 ...
 ![일부 암호화 조합을 휠로 표시합니다.](../../../database-engine/media/encryption-hierarchy-wheel.gif "일부 암호화 조합을 휠로 표시합니다.")  
