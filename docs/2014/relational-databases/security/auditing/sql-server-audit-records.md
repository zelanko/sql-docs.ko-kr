...
|**열었습니다**|이벤트를 발생시킨 동작의 성공 여부를 나타냅니다.|`bit`-1 = 성공, 0 = 실패|yes|  
|**permission_bitmask**|해당되는 경우 부여, 거부 또는 취소된 사용 권한을 표시합니다.|`bigint`|예|  
|**is_column_permission**|열 수준 사용 권한을 나타내는 플래그입니다.|`bit`-1 = True, 0 = False|예|  
...
|**object_ id**|감사가 수행된 엔터티의 주 ID이며 다음 내용이 포함됩니다.<br /><br /> 서버 개체<br /><br /> 데이터베이스<br /><br /> 데이터베이스 개체<br /><br /> 스키마 개체|`int`|예|  
...
|**object_name**|감사가 수행된 대상 엔터티의 이름입니다. 다음 내용이 포함됩니다.<br /><br /> 서버 개체<br /><br /> 데이터베이스<br /><br /> 데이터베이스 개체<br /><br /> 스키마 개체<br /><br /> TSQL 문(있는 경우)|`sysname`|예|  
