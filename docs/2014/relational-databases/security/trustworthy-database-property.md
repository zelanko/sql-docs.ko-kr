...
-   EXTERNAL_ACCESS 또는 UNSAFE 권한 설정이 포함된 악의적인 어셈블리. 자세한 내용은 [CLR Integration Security](../clr-integration/security/clr-integration-security.md)을 참조하세요.  
