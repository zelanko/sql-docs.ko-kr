...
4.  **데이터베이스 사용자 – 신규** 대화 상자의 **일반** 페이지에 있는 **사용자 유형** 목록에서 다음 사용자 유형 중 하나를 선택합니다. **로그인을 사용 하는 SQL 사용자**, **로그인 하지 않는 SQL 사용자**를 **인증서에 매핑된 사용자**를 **비대칭 키에 매핑된 사용자**, 또는 **Windows 사용자** .  
