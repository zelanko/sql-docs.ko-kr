...
3.  **로그인 - 신규** 대화 상자의 **일반** 페이지에서 **로그인 이름** 상자에 사용자 이름을 입력합니다. 또는 **검색...** 을 클릭하여 **사용자 또는 그룹 선택** 대화 상자를 엽니다.  
    ...
    1.  아래 **개체 유형 선택**, 클릭 **개체 유형...**  열려면 합니다 **개체 유형** 대화 상자 하 고 다음 중 일부 또는 모두 선택: **기본 제공 보안 주체**하십시오 **그룹**, 및 **사용자**합니다. **기본 제공 보안 주체** 및 **사용자** 는 기본적으로 선택됩니다. 완료되었으면 **확인**을 클릭합니다.  
...
### <a name="additional-options"></a>추가 옵션  
 합니다 **로그인-신규** 대화 상자는 또한 추가 페이지에서 옵션을 제공 합니다. **서버 역할**, **사용자 매핑**합니다 **보안 개체**, 및 **상태**합니다.  
...
3.  **특정 개체...** 를 선택한 경우:  
    ...
    2.  에 **개체 유형 선택** 대화 상자에서 다음 개체 유형 중 일부 또는 모두를 선택 합니다. **끝점**, **로그인**, **서버**를 **가용성**, 및 **서버 역할**합니다. [!INCLUDE[clickOK](../../../includes/clickok-md.md)]  
...
4.  선택 하는 경우 **유형의 모든 개체...** 를 **개체 유형 선택** 대화 상자에서 다음 개체 유형 중 일부 또는 모두를 선택 합니다. **끝점**, **로그인**, **서버**를 **가용성**, 및 **서버 역할**합니다. [!INCLUDE[clickOK](../../../includes/clickok-md.md)]  
...
##  <a name="FollowUp"></a> 후속편: 로그인을 만든 후 수행할 단계  
