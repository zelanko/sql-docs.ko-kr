...
# <a name="permissions-or-securables-page"></a>사용 권한 또는 보안 개체 페이지
 ...
 가능한 보안 개체와 보안 주체의 조합에 대한 자세한 내용은 [GRANT&#40;Transact-SQL&#41;](/sql/t-sql/statements/grant-transact-sql) 항목에서 보안 개체별 구문 링크를 참조하세요. 자세한 내용은 [Securables](securables.md)을 참조하세요.  
