...
## <a name="remarks"></a>설명  
  ...
  **BCPExec** 메서드는 *IBCPSession::BCPInit* 메서드에 사용된 [eDirection](ibcpsession-bcpinit-ole-db.md) 매개 변수 값에 따라 데이터를 사용자 파일에서 데이터베이스 테이블로 복사하거나 그 반대로 복사합니다.  
 ...
 *pRowsCopied*[out]  
 DWORD에 대한 포인터입니다. 
  **BCPExec** 메서드는 성공적으로 복사된 행 수로 DWORD를 채웁니다. 
  *pRowsCopied* 인수를 NULL로 설정하면 **BCPExec** 메서드에서 이 인수를 무시합니다.  
