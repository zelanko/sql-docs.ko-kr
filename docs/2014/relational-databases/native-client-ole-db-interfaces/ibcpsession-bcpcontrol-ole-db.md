...
|BCP_OPTION_FILECP|*iValue* 인수는 데이터 파일의 코드 페이지 번호를 포함합니다. 1252나 850과 같은 코드 페이지 번호를 지정하거나 다음 값 중 하나를 지정할 수 있습니다.<br /><br /> -BCP_FILECP_ACP: 파일의 데이터는 클라이언트의 Microsoft Windows® 코드 페이지입니다.<br />-BCP_FILECP_OEMCP: 파일의 데이터는 (기본값) 클라이언트의 OEM 코드 페이지입니다.<br />-의 코드 페이지 BCP_FILECP_RAW: 파일의 데이터는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]합니다.|  
