...
|[ISSCommandWithParameters:: SetParameterProperties &#40;OLE DB&#41;](isscommandwithparameters-setparameterproperties-ole-db.md)|**SSPARAMPROPS** 구조체의 배열을 지정 하 여 매개 변수 별로 매개 변수 속성을 설정 하거나 대량 매개 변수 속성을 설정 합니다.|  
