...
|사용되지 않는 기능|대체 기능|기능 이름|기능 ID|  
|------------------------|-----------------|------------------|----------------|  
|CONTAINS 및 CONTAINSTABLE 일반 NEAR 연산자:<br /><br /> {<simple_term> &#124; <prefix_term>}<br /><br /> {<br /><br /> { { NEAR &#124; ~ }    {<simple_term> &#124; <prefix_term>} } [...*n*]<br /><br /> }|사용자 지정 NEAR 연산자:<br /><br /> NEAR(<br /><br /> {{<simple_term> &#124; <prefix_term>} [,... *n* ]<br /><br /> &#124; ({<simple_term> &#124; <prefix_term>} [,... *n*])<br /><br /> [,\<distance> [,\<order>]]<br /><br /> }<br /><br /> )<br /><br /> \<거리>:: = {*integer* &#124; **MAX**}<br /><br /> \<순서>:: = {TRUE &#124; **FALSE**}|FULLTEXT_OLD_NEAR_SYNTAX|247|  
|CREATE FULLTEXT CATALOG 옵션:<br /><br /> '*Rootpath*' 경로<br /><br /> ON FILEGROUP *filegroup*|없음|CREATE FULLTEXT CATLOG IN PATH<br /><br /> 없음*|237<br /><br /> 없음을.<sup>*</sup>|  
...
## <a name="see-also"></a>참고 항목  
 [SQL Server, 사용 되지 않는 기능 개체](../performance-monitor/sql-server-deprecated-features-object.md)   
