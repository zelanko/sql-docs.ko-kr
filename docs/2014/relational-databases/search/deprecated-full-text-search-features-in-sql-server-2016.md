...
|사용되지 않는 기능|대체 기능|기능 이름|기능 ID|  
|------------------------|-----------------|------------------|----------------|  
|CONTAINS 및 CONTAINSTABLE 일반 NEAR 연산자:<br /><br /> {<simple_term> &#124; <prefix_term>}<br /><br /> {<br /><br /> { { NEAR &#124; ~ }    {<simple_term> &#124; <prefix_term>} } [...*n*]<br /><br /> }|사용자 지정 NEAR 연산자:<br /><br /> NEAR(<br /><br /> {   {<simple_term> &#124; <prefix_term>} [ ,…*n* ]<br /><br /> &#124; ( {<simple_term> &#124; <prefix_term>} [,…*n*] )<br /><br /> [,\<거리 > [,\<순서 >]]<br /><br /> }<br /><br /> )<br /><br /> \<거리 >:: = {*정수* &#124; **최대**}<br /><br /> \<순서 >:: = {TRUE &#124; **FALSE**}|FULLTEXT_OLD_NEAR_SYNTAX|247|  
