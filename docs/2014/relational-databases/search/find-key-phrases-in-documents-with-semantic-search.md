...
##  <a name="finding-key-phrases-in-documents"></a><a name="BasicsQueryKey"></a>문서에서 키 구 찾기  
  
###  <a name="how-to-find-the-key-phrases-in-documents-with-semantickeyphrasetable"></a><a name="howtofind"></a>방법: SEMANTICKEYPHRASETABLE를 사용 하 여 문서에서 키 구 찾기  
