...
##  <a name="creating-a-full-text-catalog"></a><a name="creating"></a>전체 텍스트 카탈로그 만들기  
...
##  <a name="viewing-the-properties-of-a-full-text-catalog"></a><a name="props"></a>전체 텍스트 카탈로그의 속성 보기  
...
##  <a name="rebuilding-a-full-text-catalog"></a><a name="rebuildone"></a>전체 텍스트 카탈로그 다시 작성  
...
##  <a name="rebuilding-all-full-text-catalogs-for-a-database"></a><a name="rebuildall"></a>데이터베이스의 모든 전체 텍스트 카탈로그 다시 작성  
...
##  <a name="removing-a-full-text-catalog-from-a-database"></a><a name="removing"></a>데이터베이스에서 전체 텍스트 카탈로그 제거  
