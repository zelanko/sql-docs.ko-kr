...
##  <a name="common-causes-of-performance-issues"></a><a name="causes"></a>성능 문제의 일반적인 원인  
...
##  <a name="troubleshooting-the-performance-of-full-populations"></a><a name="full"></a>전체 채우기 성능 문제 해결  
...
##  <a name="troubleshooting-slow-indexing-performance-due-to-filters"></a><a name="filters"></a>필터로 인 한 인덱싱 성능 저하 문제 해결  
