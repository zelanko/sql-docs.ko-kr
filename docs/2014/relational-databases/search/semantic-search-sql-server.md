...
##  <a name="what-can-i-do-with-semantic-search"></a><a name="whatcanido"></a>의미 체계 검색을 사용 하 여 무엇을 할 수 있나요?  
...
###  <a name="find-the-key-phrases-in-a-document"></a><a name="find1"></a>문서에서 키 구 찾기  
...
###  <a name="find-similar-or-related-documents"></a><a name="find2"></a>유사 하거나 관련 된 문서 찾기  
...
###  <a name="find-the-key-phrases-that-make-documents-similar-or-related"></a><a name="find3"></a>문서를 비슷하거나 관련 된 것으로 만드는 키 구 찾기  
...
##  <a name="storing-documents-in-sql-server"></a><a name="store"></a>SQL Server에 문서 저장  
