...
###  <a name="HowToQuerySimilar"></a>방법: SEMANTICSIMILARITYTABLE를 사용 하 여 유사 하거나 관련 된 문서 찾기  
...
##  <a name="BasicsQuerySimilarity"></a>문서 비슷하거나 관련 된 방법에 대 한 정보 찾기  
  
###  <a name="HowToQuerySimilarity"></a>방법: SEMANTICSIMILARITYDETAILSTABLE와 문서 비슷하거나 관련 된 방법에 대 한 정보 찾기  
