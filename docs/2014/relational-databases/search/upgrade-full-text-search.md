...
> [!NOTE]  
>  전체 텍스트 카탈로그를 지정하는 [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] [!INCLUDE[tsql](../../includes/tsql-md.md)] DDL 문은 계속 올바르게 작동합니다.  
...
##  <a name="Attaching_2005_ft_catalogs"></a> SQL Server 2005 데이터베이스를 연결합니다. [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
