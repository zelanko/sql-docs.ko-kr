...
|[분할 된 테이블 및 인덱스](partitions/partitioned-tables-and-indexes.md)|[동의어&#40;데이터베이스 엔진&#41;](synonyms/synonyms-database-engine.md)|[이벤트 알림](service-broker/event-notifications.md)|  
|[보기](views/views.md)|[XML 데이터&#40;SQL Server&#41;](xml/xml-data-sql-server.md)|[성능 모니터링 및 튜닝](performance/monitor-and-tune-for-performance.md)|  
