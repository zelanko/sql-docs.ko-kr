...
# <a name="create-clr-triggers"></a>CLR 트리거 만들기
  에서 CLR ( [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] 공용 언어 런타임) [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 에 만들어진 어셈블리에 프로그래밍 된 데이터베이스 개체를 만들 수 있습니다. CLR에서 제공하는 다양한 기능의 프로그래밍 모델을 활용할 수 있는 데이터베이스 개체에는 DML 트리거, DDL 트리거, 저장 프로시저, 함수, 집계 함수 및 유형이 있습니다.  
...
> [!NOTE]  
>  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 의 CLR 코드 실행 기능은 기본적으로 해제되어 있습니다. 관리 코드 모듈을 참조 하는 데이터베이스 개체를 생성, 변경 및 삭제할 수 있지만 [sp_configure (transact-sql)](/sql/relational-databases/system-stored-procedures/sp-configure-transact-sql)을 사용 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 하 여 [clr enabled 옵션](../../database-engine/configure-windows/clr-enabled-server-configuration-option.md) 을 설정 하지 않으면 이러한 참조가 실행 되지 않습니다.  
...
## <a name="see-also"></a>참고 항목  
 ...
 [CLR&#41; 통합 프로그래밍 개념 &#40;공용 언어 런타임](../clr-integration/common-language-runtime-clr-integration-programming-concepts.md)   
