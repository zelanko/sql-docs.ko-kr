...
-   행 단위 바인딩  
 ...
 [SQLGetData](../../native-client-odbc-api/sqlgetdata.md) 블록 커서에서 열 데이터 검색을 사용할 수도 있습니다. 때문에 **SQLGetData** 한 번에 하나의 행을 작동 **SQLSetPos** 호출을 호출 하기 전에 현재 행으로 행 집합의 특정 행을 설정 해야 **SQLGetData**합니다.  
