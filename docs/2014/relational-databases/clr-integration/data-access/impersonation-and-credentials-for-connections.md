...
> [!NOTE]  
>  가장의 동작 변경에 대 한 정보를 참조 하십시오. [SQL Server 2014 데이터베이스 엔진 기능의 주요 변경 내용](../../../database-engine/breaking-changes-to-database-engine-features-in-sql-server-2016.md)합니다.  
