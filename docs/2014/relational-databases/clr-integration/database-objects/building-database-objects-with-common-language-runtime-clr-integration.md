...
ms.locfileid: "84953610"
---
# <a name="building-database-objects-with-common-language-runtime-clr-integration"></a>CLR(공용 언어 런타임) 통합을 사용하여 데이터베이스 개체 작성
  을 사용 하 여 데이터베이스 개체를 빌드할 수 있습니다 [!INCLUDE[ssNoVersion](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] . "CLR 루틴" 이라고 합니다. 이러한 루틴에는 다음과 같은 항목이 포함됩니다.  
...
-   사용자 정의 트리거  
 ...
 .NET Framework 루틴의 각 형식에는 해당 하 [!INCLUDE[tsql](../../../includes/ssnoversion-md.md)] 는를 사용할 수 있는가 있습니다 [!INCLUDE[tsql](../../../includes/tsql-md.md)] . 예를 들어 스칼라 UDF는 모든 스칼라 식에 사용할 수 있고, TVF는 모든 FROM 절에 사용할 수 있습니다. 프로시저는 EXEC 문에서 호출되거나 클라이언트 애플리케이션에서 호출될 수 있습니다.  
