...
```  
 ...
 계층의 섹션을 다시 구성하는 저장 프로시저는 [Moving Subtrees](../hierarchical-data-sql-server.md#BKMK_MovingSubtrees)의 "하위 트리 이동" 섹션을 참조하세요.  
  
## <a name="next-task-in-lesson"></a>단원의 다음 태스크  
 [요약: 계층적 테이블의 데이터 관리](lesson-2-5-summary-managing-data-in-a-hierarchical-table.md)  
