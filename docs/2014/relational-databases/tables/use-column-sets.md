...
-   열 집합은 변경할 수 없습니다. 열 집합을 변경하려면 열 집합을 삭제한 다음 다시 만들어야 합니다.  
...
-   COLUMNS_UPDATED 함수에서 반환되는 데이터에 대한 자세한 내용은 [스파스 열 사용](use-sparse-columns.md)을 참조하세요.  
