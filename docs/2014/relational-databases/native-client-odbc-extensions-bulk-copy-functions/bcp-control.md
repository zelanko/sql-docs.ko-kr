 ...
 *eOption*  
 ...
 BCPDELAYREADFMT  
 경우에는 부울을 true로 설정 하면 [bcp_readfmt](bcp-readfmt.md) 실행 시 읽습니다. False (기본값) 이면 bcp_readfmt 즉시는 경우 서식 파일을 읽습니다. BCPDELAYREADFMT가 true이 고 bcp_columns 또는 bcp_setcolfmt를 호출 하는 경우 시퀀스 오류가 발생 합니다.  
...
## <a name="remarks"></a>Remarks  
 ...
 이러한 제어 매개 변수는 사용자 파일과 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 테이블 간에 복사하는 경우에만 의미가 있습니다. 컨트롤 매개 변수 설정을 복사 하는 행에 영향을 주지 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 사용 하 여 [bcp_sendrow](bcp-sendrow.md)합니다.  
