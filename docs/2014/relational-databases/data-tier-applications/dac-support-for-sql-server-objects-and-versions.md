...
##  <a name="supported-sql-server-objects"></a><a name="SupportedObjects"></a>지원 되는 SQL Server 개체  
...
##  <a name="data-tier-application-support-by-the-versions-of-sql-server"></a><a name="SupportByVersion"></a>SQL Server 버전의 데이터 계층 응용 프로그램 지원  
...
##  <a name="additional-considerations-for-deployment-actions"></a><a name="Considerations"></a>배포 작업에 대 한 추가 고려 사항  
