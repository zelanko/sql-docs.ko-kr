...
##  <a name="delete-data-tier-application-page"></a><a name="Delete_datatier_application"></a>데이터 계층 응용 프로그램 삭제 페이지  
...
##  <a name="delete-a-dac-using-powershell"></a><a name="DeleteDACPowerShell"></a>PowerShell을 사용 하 여 DAC 삭제  
...
3.  `add_DacActionStarted` 및 `add_DacActionFinished`를 사용하여 DAC 업그레이드 이벤트에 등록합니다.  
