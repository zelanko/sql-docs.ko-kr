...
1.  
  **단계** 페이지에서 **새로 만들기**를 클릭합니다.  
  
2.  
  **단계 이름** 입력란에 **Copy Database Mail Items**를 입력합니다.  
  
3.  
  **유형** 드롭다운 목록에서 **Transact-SQL 스크립트(T-SQL)** 를 선택합니다.  
  
4.  
  **데이터베이스** 드롭다운 목록에서 **msdb**를 선택합니다.  
  
5.  
  **명령** 입력란에 다음 문을 입력하여 이전 달의 이름을 딴 테이블을 만들고 현재 달의 시작일보다 이전인 행을 포함하도록 합니다.  
...
2.  
  **단계 이름** 입력란에 **Copy Database Mail Attachments**를 입력합니다.  
...
5.  
  **명령** 입력란에 다음 문을 입력하여 이전 달의 이름을 딴 테이블을 만들고 이전 단계에서 복사한 메시지에 해당하는 첨부 파일이 포함되도록 합니다.  
...
2.  
  **단계 이름** 입력란에 **Copy Database Mail Log**를 입력합니다.  
...
5.  
  **명령** 입력란에 다음 문을 입력하여 이전 달의 이름을 딴 테이블을 만들고 이전 단계에서 복사한 메시지에 해당하는 로그 항목이 포함되도록 합니다.  
...
2.  
  **단계 이름** 입력란에 **Remove rows from Database Mail**을 입력합니다.  
...
5.  
  **명령** 입력란에 다음 문을 입력하여 현재 달보다 이전인 행을 데이터베이스 테이블에서 제거합니다.  
...
2.  
  **단계 이름** 입력란에 **Remove rows from Database Mail event log**를 입력합니다.  
  
3.  
  **유형** 드롭다운 목록에서 **Transact-SQL 스크립트(T-SQL)** 를 선택합니다.  
  
4.  
  **명령** 입력란에 다음 문을 입력하여 현재 달보다 이전인 행을 데이터베이스 메일 이벤트 로그에서 제거합니다.  
...
1.  
  **새 작업** 대화 상자에서 **일정**을 클릭합니다.  
  
2.  
  **일정** 페이지에서 **새로 만들기**를 클릭합니다.  
  
3.  
  **이름** 입력란에 **Archive Database Mail**을 입력합니다.  
  
4.  
  **일정 유형** 드롭다운 목록에서 **되풀이**를 선택합니다.  
  
5.  
  **빈도** 영역에서 정기적으로 작업을 실행할 옵션을 선택합니다(예: 매월 한 번).  
  
6.  
  **일별 빈도** 영역에서 **한 번 수행 - \<시간>** 을(를) 선택합니다.  
