...
-   UDT 식을 인덱싱합니다. UDT 식을 통해 지속형 계산 열에 대한 인덱스를 만들 수 있습니다. UDT 식은 UDT의 속성, 메서드 또는 필드일 수 있습니다. 식은 결정적이어야 하고 데이터 액세스를 수행하지 않아야 합니다.  
 ...
 자세한 내용은 [clr user-defined Types](clr-user-defined-types.md) 하 고 [CREATE INDEX &#40;TRANSACT-SQL&#41;](/sql/t-sql/statements/create-index-transact-sql).  
