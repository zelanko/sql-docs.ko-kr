---
title: '자습서: Microsoft Azure Blob Storage 서비스로 SQL Server 백업 및 복원 | Microsoft 문서'
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="what-you-will-learn"></a>학습 내용  
 ...
 이 단원에서는 Azure storage 계정 및 blob 컨테이너를 만듭니다.  
 ...
 [3단원: Azure Blob Storage 서비스에 전체 데이터베이스 백업 작성](../tutorials/lesson-3-write-a-full-database-backup-to-the-windows-azure-blob-storage-service.md)  
...
1.  [Azure Blob Storage 서비스를 사용 하 여 백업 및 복원 SQL Server](backup-restore/sql-server-backup-and-restore-with-microsoft-azure-blob-storage-service.md)  
