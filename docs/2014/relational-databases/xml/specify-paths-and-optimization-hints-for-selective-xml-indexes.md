...
-   **CREATE** 문의 **FOR** 절 자세한 내용은 [CREATE SELECTIVE XML INDEX&#40;Transact-SQL&#41;](/sql/t-sql/statements/create-selective-xml-index-transact-sql)를 참조하세요.  
  
-   **ALTER** 문의 **ADD** 절 자세한 내용은 [ALTER INDEX&#40;선택적 XML 인덱스&#41;](../indexes/indexes.md)를 참조하세요.  
...
|**DATA TYPE**|사용자 계정 컨트롤|아니요|  
|**MAXLENGTH**|사용자 계정 컨트롤|아니요|  
...
## <a name="see-also"></a>관련 항목  
 [SXI&#40;선택적 XML 인덱스&#41;](../xml/selective-xml-indexes-sxi.md)   
 [선택적 XML 인덱스 만들기, 변경 및 삭제](../xml/create-alter-and-drop-selective-xml-indexes.md)  
