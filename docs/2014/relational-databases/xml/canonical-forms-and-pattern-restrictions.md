...
# <a name="canonical-forms-and-pattern-restrictions"></a>정규 형식 및 패턴 제한 사항
 ...
 따라서 주의 해야 기본 형식에서 파생 된 형식에 패턴 패싯을 적용할 때: `boolean`, `decimal`, `float`, `double`, `dateTime`, `time`, `date`, `hexBinary` 및 `base64Binary`합니다. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 에서 경고가 발생됩니다.  
