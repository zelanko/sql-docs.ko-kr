...
-   SQL 테이블에서 [XML 데이터&#40;SQL Server&#41;](xml-data-sql-server.md) 값 인스턴스를 쿼리합니다.  
  
-   [TYPE Directive in FOR XML Queries](type-directive-in-for-xml-queries.md) 을 적용하여 XML 유형의 텍스트 또는 이미지 형식의 데이터를 포함하는 쿼리 결과를 반환합니다.  
