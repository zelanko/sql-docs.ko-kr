...
# <a name="database-engine-tutorials"></a>데이터베이스 엔진 자습서
 ...
 [자습서: 인증서를 사용 하 여 저장된 프로시저에 서명](tutorial-signing-stored-procedures-with-a-certificate.md)  
 ...
 [자습서: 정책 기반 관리를 사용 하 여 서버 관리](policy-based-management/tutorial-administering-servers-by-using-policy-based-management.md)  
