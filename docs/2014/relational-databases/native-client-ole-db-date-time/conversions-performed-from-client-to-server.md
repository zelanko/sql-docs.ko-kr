...
|14|
  [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)]에 대한 `smalldatetime` 이전의 변환 의미가 유지됩니다. 초는 0으로 설정됩니다.|  
|15|
  [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)]에 대한 `datetime` 이전의 변환 의미가 유지됩니다. 초는 가장 근사한 300초로 반올림됩니다.|  
