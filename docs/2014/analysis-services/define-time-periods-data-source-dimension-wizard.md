...
## <a name="options"></a>변수  
 **시간 속성 이름**  
 시간 차원의 기간을 표시하는 데 사용되는 특성 유형을 표시합니다. 특성 유형에 대한 자세한 내용은 [Type 요소&#40;DimensionAttribute&#41;&#40;ASSL&#41;](scripting/properties/type-element-dimensionattribute-assl.md)를 참조하세요.  
