...
# <a name="table-binding-detail-partition-source-dialog-box-analysis-services---multidimensional-data"></a>테이블 바인딩 세부 정보(파티션 원본 대화 상자)(Analysis Services - 다차원 데이터)
  ...
  **파티션 원본** 대화 상자의 **테이블 바인딩** 옵션을 사용하여 파티션에 대한 데이터를 제공하는 팩트 테이블을 지정할 수 있습니다. 
  **파티션 원본** 대화 상자의 **바인딩 유형** 옵션에서 **테이블 바인딩** 을 선택하여 이 창을 표시할 수 있습니다.  
 ...
 **사용 가능한 테이블**  
  ...
  **테이블 필터**에서 필터를 지정한 경우 앞의 조건을 만족하는 테이블 이름과 해당 필터를 비교하여 목록을 더 제한합니다. 
