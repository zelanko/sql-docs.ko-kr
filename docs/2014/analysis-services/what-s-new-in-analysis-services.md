...
# <a name="what39s-new-in-sql-server-2014-analysis-services"></a>SQL Server&#39;2014의 새로운 기능 Analysis Services
  다차원 모델에 대 한 파워 뷰 보고서를 지 원하는 추가 된 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] 기능을 제외 하 고 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 는 이전 릴리스에서 변경 되지 않았습니다.  
...
-   [Visual Studio 2013 다운로드 SSDT](https://go.microsoft.com/fwlink/p/?LinkId=396526)  
  
-   [SSDT 다운로드-Visual Studio 2012 용 BI](https://go.microsoft.com/fwlink/p/?LinkID=273673)  
...
## <a name="features-recently-added-power-view-for-multidimensional-models"></a>최근에 추가 된 기능: 다차원 모델용 파워 뷰  
 ...
 **다차원 모델에 대 한 파워 뷰 보고서**  
  
 ![파워 뷰 보고서](media/powerviewreport-wn.gif "파워 뷰 보고서")  
