...
|관계|요소|  
|------------------|-------------|  
|부모 요소|[큐브 뷰](../objects/perspective-element-assl.md)|  
|자식 요소|[계산](../objects/calculation-element-assl.md) 형식의 [PerspectiveCalculation](../data-type/perspectivecalculation-data-type-assl.md)|  
