...
|관계|요소|  
|------------------|-------------|  
|부모 요소|[ProactiveCachingIncrementalProcessingBinding](../data-type/binding-data-type-assl.md)|  
|자식 요소|[IncrementalProcessingNotification](../objects/incrementalprocessingnotification-element-assl.md)|  
