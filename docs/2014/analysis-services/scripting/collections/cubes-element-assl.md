...
ms.locfileid: "48222063"
---
# <a name="cubes-element-assl"></a>Cubes 요소(ASSL)
  컬렉션을 포함 [큐브](../objects/cube-element-assl.md) 와 관련 된 요소를 [데이터베이스](../objects/database-element-assl.md) 요소입니다.  
...
|자식 요소|[Cube](../objects/cube-element-assl.md)|  
