...
|[AttributePermission 요소 &#40;ASSL&#41;](attributepermission-element-assl.md)|사용 권한을 해당 멤버의 정의 [역할](role-element-assl.md) 요소의 개별 차원 특성에는 [큐브](cube-element-assl.md) 요소입니다.|  
