...
|관계|요소|  
|------------------|-------------|  
|부모 요소|[AggregationDesign](../objects/aggregationdesign-element-assl.md), [큐브](../objects/cube-element-assl.md), [MeasureGroup](../objects/group-element-assl.md), [MeasureGroupBinding](../data-type/binding-data-type-assl.md), [파티션](../objects/partition-element-assl.md)|  
