...
ms.locfileid: "36081669"
---
# <a name="holdoutmaxpercent-element"></a>HoldoutMaxPercent 요소
  테스트 집합이 들어 있는 홀드 아웃 파티션에 사용할 수 있는 데이터 원본의 최대 사례 비율을 지정 된 [MiningStructure](../objects/miningstructure-element-assl.md) 요소입니다. 나머지 사례는 학습에 사용됩니다. 0 값은 테스트 집합으로 홀드아웃할 수 있는 사례 수에 대한 제한이 없음을 나타냅니다.  
...
## <a name="remarks"></a>Remarks  
 ...
 새 속성 `HoldoutMaxCases`, `HoldoutMaxPercent`, `HoldoutSeed`, 또는 `HoldoutActualSize` 에 사용할 수 있는 [!INCLUDE[ssKatmai](../../../includes/sskatmai-md.md)] 이상 버전입니다. 따라서 구문 설명에 표시된 대로 새 네임스페이스를 사용하여 이러한 속성에 접두사를 지정해야 합니다. 그렇지 않으면 [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)]에서 오류를 반환합니다.  
