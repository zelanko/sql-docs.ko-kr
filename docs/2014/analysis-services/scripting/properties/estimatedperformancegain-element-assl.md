...
## <a name="remarks"></a>Remarks  
 부모에 해당 요소가 `EstimatedPerformanceGain` Analysis Management Objects (AMO) 개체 모델은 <xref:Microsoft.AnalysisServices.AggregationDesign>합니다.  
