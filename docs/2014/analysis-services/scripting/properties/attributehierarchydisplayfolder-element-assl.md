...
## <a name="remarks"></a>Remarks  
 부모에 해당 하는 요소가 `AttributeHierarchyDisplayFolder` Analysis Management Objects (AMO) 개체 모델은 <xref:Microsoft.AnalysisServices.DimensionAttribute>합니다.  
