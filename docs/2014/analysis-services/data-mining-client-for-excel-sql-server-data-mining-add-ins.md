...
##  <a name="work-with-data"></a><a name="bkmk_Data"></a>데이터 작업  
...
##  <a name="build-models-and-analyze"></a><a name="bkmk_Model"></a>모델 작성 및 분석  
...
##  <a name="test-query-and-validate-models"></a><a name="bkmk_Validate"></a>모델 테스트, 쿼리 및 유효성 검사  
...
##  <a name="view-models"></a><a name="bkmk_ViewModels"></a>모델 보기  
...
##  <a name="manage-document-and-deploy"></a><a name="bkmk_UsageMgmt"></a>관리, 문서화 및 배포  
