...
|값|Description|  
|-----------|-----------------|  
|**일반 쿼리 작성기로 전환**|일반 쿼리 작성기 뷰에 사용할 수 있는 옵션만 표시하려면 선택합니다. 다음 옵션만 표시됩니다.<br /><br /> **SQL 창**<br /><br /> **결과 창**<br /><br /> **도구 모음**( **VDT 쿼리 작성기로 전환** 및 **실행**<br /><br /> <br /><br /> 참고: 이 옵션은 **VDT 쿼리 작성기로 전환** 을 선택할 경우에만 표시됩니다.|  
