...
4.  에 프로젝트 이름을 `Analysis Services Tutorial`도 변경 된 **솔루션 이름** 상자를 선택한 다음 클릭 **확인**합니다.  
  
 성공적으로 만들었습니다는 `Analysis Services Tutorial` 기반으로 프로젝트는 **Analysis Services 다차원 및 데이터 마이닝 프로젝트** 템플릿 이라는 새 솔루션 내 `Analysis Services Tutorial`합니다.  
