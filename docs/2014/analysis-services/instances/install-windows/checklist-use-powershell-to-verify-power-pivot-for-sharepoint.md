...
> 
>  상태가 **온라인**인지 확인 합니다. 사이트를 [!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)] 검색할 때 상태가 온라인이 아니거나 "http 오류"가 표시 되는 경우 IIS 응용 프로그램 풀의 id 자격 증명이 올바른지 확인 합니다. IIS 풀 이름은 Get-SPServiceApplicationPool 명령에서 반환되는 ID 속성 값입니다.
