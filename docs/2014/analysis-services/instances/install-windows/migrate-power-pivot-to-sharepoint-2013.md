...
##  <a name="bkmk_prepare_mount_databases"></a> 3) 웹 애플리케이션 준비 및 콘텐츠 데이터베이스 탑재  
...
-   **일정 옵션 1 마이그레이션: SharePoint 팜 관리자**  
    ...
    1.  SharePoint 2013 관리에서 `-StartMigratingRefreshSchedules` 스위치를 사용 하 여 `Set-PowerPivotServiceApplication` cmdlet을 실행 하 여 자동 주문형 일정 마이그레이션 ![PowerShell 관련 콘텐츠](../../../reporting-services/media/rs-powershellicon.jpg "PowerShell 관련 콘텐츠")를 사용 하도록 설정 합니다. 다음 Windows PowerShell 스크립트는 PowerPivot 서비스 애플리케이션이 한 개만 있다고 가정합니다.  
...
> [!NOTE]  
>  [!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)] 및 SharePoint 데이터베이스 연결 업그레이드에 대한 자세한 내용은 다음을 참조하세요.  
...
-   [SharePoint 2013 (https://go.microsoft.com/fwlink/p/?LinkId=256689) 로 업그레이드 하기 전에 준비를 정리](https://go.microsoft.com/fwlink/p/?LinkId=256689) 합니다.  
  
-   [Sharepoint 2010에서 sharepoint 2013 (https://go.microsoft.com/fwlink/p/?LinkId=256690) 로 데이터베이스를 업그레이드](https://go.microsoft.com/fwlink/p/?LinkId=256690) 합니다.
