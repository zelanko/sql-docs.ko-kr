...
# <a name="data-providers-used-for-analysis-services-connections"></a>Analysis Services 연결에 사용되는 데이터 공급자
 ...
 [Analysis Services 데이터 공급자의 버전을 확인 하는 방법](#bkmk_LibUpdate)  
  
 [최신 버전 데이터 공급자를 가져오는 위치](#bkmk_downloadsite)  
...
##  <a name="bkmk_ServVers"></a>서버 버전을 확인 하는 방법  
...
##  <a name="bkmk_LibUpdate"></a>Analysis Services 데이터 공급자의 버전을 확인 하는 방법  
...
2.  Microsoft.AnalysisServices.AdomdClient를 마우스 오른쪽 단추로 클릭하고 **속성**을 클릭합니다. 
  **버전**을 클릭합니다.  
...
##  <a name="bkmk_downloadsite"></a>최신 버전 데이터 공급자를 가져오는 위치  
