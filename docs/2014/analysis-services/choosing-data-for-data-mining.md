...
##  <a name="choosing-data"></a><a name="bkmk_ChoosingData"></a>데이터 선택  
...
##  <a name="common-data-problems"></a><a name="bkmk_CommonDataProblems"></a>일반적인 데이터 문제  
...
##  <a name="other-data-requirements"></a><a name="bkmk_OtherRequirements"></a>기타 데이터 요구 사항  
