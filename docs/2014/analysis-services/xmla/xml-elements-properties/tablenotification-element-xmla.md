...
|관계|요소|  
|------------------|-------------|  
|부모 요소|[TableNotifications](tablenotifications-element-xmla.md)|  
|자식 요소|[DbSchemaName](name-element-xmla.md), [DbTableName](dbtablename-element-xmla.md)|  
