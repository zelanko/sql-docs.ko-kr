...
# <a name="shopping-basket-analysis-table-analysistools-for-excel"></a>시장 바구니 분석(Excel용 테이블 분석 도구)
 ...
 시장 **바구니 분석** 도구를 사용 하 여 `associations` 데이터를 찾을 수 있습니다. 연결은 어떤 항목이 자주 함께 구매되는지 알려 줍니다. 데이터 마이닝에서이 기술은 매우 큰 데이터 집합에서 고객의 구매 동작을 분석 하는 데 사용 되는 *시장 바구니 분석*이라는 잘 알려진 방법입니다. 마케팅 담당자는 이 정보를 사용하여 고객에게 관련 제품을 추천하고 웹 페이지, 카탈로그 또는 매장에서 가까운 곳에 관련 제품을 배치하여 판매를 촉진할 수 있습니다.  
...
|고객 지원팀|이 조합이 들어 있는 사례의 개수입니다. 이 열을 정렬하여 가장 일반적인 항목 집합을 확인할 수 있습니다.|  
...
|고객 지원팀|기존 데이터에서 이 규칙에 대한 증거를 제공하는 사례의 개수를 나타냅니다.|  
