...
## <a name="reference-dimension-relationships"></a>참조 차원 관계  
 ...
 ![논리 다이어그램, 참조 차원 관계](../../analysis-services/dev-guide/media/as-refdimension1.gif "논리 다이어그램, 참조 차원 관계")  
 ...
 ![논리 스키마, 참조 차원 관계](../../analysis-services/dev-guide/media/as-refdim-schema1.gif "논리 스키마, 참조 차원 관계")  
 ...
 **Customer** 테이블을 차원 기본 테이블로 사용 하 고 **Geography** 테이블을 관련 테이블로 포함 하는 차원을 만들 수 있습니다. 그런 다음 차원과 InternetSales 측정값 그룹 간에 일반 관계가 정의됩니다.  
 ...
 ![논리 다이어그램, 참조 차원 관계](../../analysis-services/dev-guide/media/as-refdimension2.gif "논리 다이어그램, 참조 차원 관계")  
