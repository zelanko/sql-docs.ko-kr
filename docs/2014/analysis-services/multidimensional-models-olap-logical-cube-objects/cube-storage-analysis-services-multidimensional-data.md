...
-   빈 셀에는 저장소를 할당하지 않습니다.  
 ...
 저장소는 파티션 단위로 정의되며 큐브의 각 측정값 그룹에 대해 하나 이상의 파티션이 존재합니다. 자세한 내용은 참조 [파티션을 &#40;Analysis Services-다차원 데이터&#41;](partitions-analysis-services-multidimensional-data.md), [파티션 저장소 모드 및 처리](partitions-partition-storage-modes-and-processing.md), [측정값 및 측정값 그룹](../multidimensional-models/measures-and-measure-groups.md), 및 [다차원 모델의 측정값 및 측정값 그룹 만들기](../multidimensional-models/create-measures-and-measure-groups-in-multidimensional-models.md)합니다.  
