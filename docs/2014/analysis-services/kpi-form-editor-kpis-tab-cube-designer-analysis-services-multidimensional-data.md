 ...
 **상태 그래픽**  
 클라이언트 응용 프로그램에서 상태 값을 그래픽 형식으로 나타내기 위해 사용할 그래픽을 선택합니다.  
  
> [!NOTE]  
>  클라이언트 응용 프로그램에서 선택한 그래픽을 지원할 수도 있고 적절한 다른 항목으로 대체할 수도 있습니다.  
...
> [!NOTE]  
>  -1보다 작거나 1보다 큰 값도 가능하지만 타사 클라이언트 응용 프로그램에서 이러한 값을 잘못 해석할 수 있습니다.  
  
 **추세**  
 **추세 그래픽** 및 **추세 식** 옵션을 보려면 확장합니다.  
  
 **추세 그래픽**  
 클라이언트 응용 프로그램에서 추세 값을 그래픽 형식으로 나타내기 위해 사용할 그래픽을 선택합니다.  
 ...
 **표시 폴더**  
 클라이언트 응용 프로그램에서 표시를 위해 사용할 KPI 분류를 입력합니다.  
 ...
 **부모 KPI**  
 클라이언트 응용 프로그램에서 사용할 KPI를 분류할 기존 상위 KPI를 선택합니다.  
