...
|MAXIMUM_STATES|Microsoft Clustering Algorithm<br /><br /> Microsoft Neural Network Algorithm<br /><br /> Microsoft 시퀀스 클러스터링 알고리즘|알고리즘이 지원하는 최대 특성 상태 수를 지정합니다. 특성 상태 수가 최대 상태 수보다 크면 알고리즘은 특성의 가장 일반적인 상태를 사용하고 나머지 상태는 무시합니다.<br /><br /> 기본값은 100입니다.|  
