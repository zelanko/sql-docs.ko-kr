---
title: 계층 구조 (Dimension Structure Tab, Dimension Designer) (Analysis Services-다차원 데이터) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
-   수준 이름 옆의 화살표를 클릭하여 특성 관계를 표시하거나 숨깁니다.  
