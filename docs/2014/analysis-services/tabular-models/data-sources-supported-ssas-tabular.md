...
|Office 데이터베이스 연결 파일||.odc||  
 ...
 <sup>2</sup> SQL Azure에 대 한 자세한 내용은 웹 사이트 참조 [SQL Azure](http://go.microsoft.com/fwlink/?LinkID=157856)합니다.  
  
 <sup>3</sup> SQL Server PDW에 대 한 자세한 내용은 웹 사이트 참조 [SQL Server 2008 R2 병렬 데이터 웨어하우스](http://go.microsoft.com/fwlink/?LinkId=150895)합니다.  
