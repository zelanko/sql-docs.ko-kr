...
-   [지원 되는 데이터 원본](#bkmk_supported_ds)  
...
|Office 데이터베이스 연결 파일||.odc||  
 ...
 <sup>1</sup> ODBC 용 OLE DB 공급자를 사용할 수도 있습니다.  
  
 <sup>2</sup> SQL Azure에 대 한 자세한 내용은 웹 사이트 [SQL Azure](https://go.microsoft.com/fwlink/?LinkID=157856)를 참조 하십시오.  
  
 <sup>3</sup> SQL Server PDW에 대 한 자세한 내용은 [2008 R2 병렬 데이터 웨어하우스 SQL Server](https://go.microsoft.com/fwlink/?LinkId=150895)웹 사이트를 참조 하세요.  
