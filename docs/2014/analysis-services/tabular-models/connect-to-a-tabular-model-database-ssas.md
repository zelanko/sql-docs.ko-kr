...
##  <a name="user-permissions-on-the-database"></a><a name="bkmk_userpermissions"></a> 데이터베이스에 대한 사용자 권한  
...
##  <a name="administrative-permissions-on-the-server"></a><a name="bkmk_admin"></a> 서버에 대한 관리 권한  
...
##  <a name="connecting-from-excel-or-sharepoint"></a><a name="bkmk_excelconn"></a>Excel 또는 SharePoint에서 연결  
...
5.  데이터베이스를 선택합니다. 올바르게 선택하면 데이터베이스에 대해 단일 **모델** 큐브가 표시됩니다. **다음**을 클릭하고 **마침**을 클릭합니다.  
