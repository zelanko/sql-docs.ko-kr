...
2.  
  **기존 연결** 페이지에서 추가할 테이블이 있는 데이터 원본에 대한 연결을 선택한 다음 **열기**를 클릭합니다.  
  
3.  
  **테이블 및 뷰 선택** 페이지에서 모델에 추가할 데이터 원본의 테이블을 선택합니다.  
...
## <a name="see-also"></a>참고 항목  
 ...
 [SSAS 테이블 형식&#41;&#40;테이블 삭제](delete-a-table-ssas-tabular.md)  
