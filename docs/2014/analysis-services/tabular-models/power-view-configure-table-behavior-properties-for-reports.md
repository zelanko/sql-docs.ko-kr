...
> [!NOTE]
>   특정 표시 형식의 관점에서 레이아웃을 최적화하는 방법은 다음  [특정 레이아웃 최적화](#bkmk_optimizeforlayout)섹션을 참조하십시오.
...
##  <a name="optimizing-for-specific-layouts"></a><a name="bkmk_optimizeforlayout"></a> 특정 레이아웃 최적화
