...
##  <a name="defining-measures-by-using-the-measure-grid"></a><a name="bkmk_def_mg"></a>측정값 표를 사용 하 여 측정값 정의  
...
##  <a name="measure-properties"></a><a name="bkmk_properties"></a>측정값 속성  
