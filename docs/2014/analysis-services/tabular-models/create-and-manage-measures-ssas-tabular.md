...
-   [표준 집계 수식을 사용 하 여 측정값을 만들려면](#bkmk_create_stand)  
  
-   [사용자 지정 수식을 사용 하 여 측정값을 만들려면](#bkmk_create_custom)  
  
-   [측정값 속성을 편집 하려면](#bkmk_edit)  
  
-   [측정값 이름을 바꾸려면](#bkmk_rename)  
  
-   [측정값을 삭제 하려면](#bkmk_delete)  
