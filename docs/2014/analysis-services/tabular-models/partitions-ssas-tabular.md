...
|[작업 영역 데이터베이스에서 파티션을 처리 &#40;SSAS 테이블 형식&#41;](process-partitions-in-the-workspace-databse-ssas-tabular.md)|모델 작업 영역 데이터베이스에서 파티션을 처리(새로 고침)하는 방법을 설명 합니다.|  
