...
---
# <a name="configure-default-field-set-for-power-view-reports-ssas-tabular"></a>Power View 보고서의 기본 필드 집합 구성(SSAS 테이블 형식)
...
1.  
  [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]에서 기본 필드 목록을 구성 중인 테이블(탭)을 클릭합니다.  
  
2.  
  **속성** 창의 **기본 필드 집합** 속성에서 **편집하려면 클릭**을 클릭합니다.  
  
3.  기본 필드 집합 대화 상자에서 필드를 하나 이상 선택합니다. 측정값을 비롯하여 테이블의 모든 필드를 선택할 수 있습니다. Shift 키를 누른 채 범위를 선택하거나 Ctrl 키를 누른 채 개별 필드를 선택합니다.  
  
4.  
  **추가** 를 클릭하여 선택한 필드를 기본 필드 집합에 추가합니다.  
