...
##  <a name="workspace-database-overview"></a><a name="bkmk_overview"></a>작업 영역 데이터베이스 개요  
...
##  <a name="workspace-database-properties"></a><a name="bkmk_ws_prop"></a>작업 영역 데이터베이스 속성  
