...
##  <a name="thread-management-in-analysis-services"></a><a name="bkmk_threadarch"></a>Analysis Services의 스레드 관리
...
##  <a name="thread-pool-property-reference"></a><a name="bkmk_propref"></a> 스레드 풀 속성 참조
...
##  <a name="set-groupaffinity-to-affinitize-threads-to-processors-in-a-processor-group"></a><a name="bkmk_groupaffinity"></a> GroupAffinity를 설정하여 프로세서 그룹의 프로세서에 대한 스레드 선호도 설정
