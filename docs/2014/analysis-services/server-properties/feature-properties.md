...
# <a name="feature-properties"></a>기능 속성
 ...
 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]는 다음 표에 나열 된 서버 속성을 지원 합니다. 추가 서버 속성 및 해당 속성 설정 방법은 [Configure Server Properties in Analysis Services](server-properties-in-analysis-services.md)을 참조하세요.  
