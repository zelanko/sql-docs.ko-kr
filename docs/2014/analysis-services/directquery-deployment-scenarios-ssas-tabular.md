 ...
 **2 단계. 모델 디자이너에서 DirectQuery 모드를 사용 하도록 설정**  
...
-   계산 열을 제거합니다. 특정 측정값에 대해 계산 열이 필요한 경우에는 항상 테이블 가져오기 마법사에서 제공 하는 [SSAS&#41;&#40;관계형 쿼리 디자이너](relational-query-designer-ssas.md) 를 사용 하 여 열을 만들 수 있습니다.  
 ...
 **4 단계. 모델에 대 한 쿼리에 응답 하는 기본 방법 설정**  
