...
> [!IMPORTANT]  
>  SELECT 명령 구문을 사용하여 `DISCOVER_XML_METADATA` 행 집합을 쿼리할 수 없습니다. 그러나 <xref:Microsoft.AnalysisServices.AdomdClient.AdomdConnection.GetSchemaDataSet%2A>을 사용하여 `DISCOVER_XML_METADATA` 행 집합을 쿼리할 수 있습니다.  
