...
|EventSubclass|1|1|이벤트 하위 클래스는 각 이벤트 클래스에 대한 추가 정보를 제공합니다. 다음은 유효한 하위 클래스 Id/하위 클래스 이름 쌍입니다.<br /><br /> 0: 자동 관리 캐싱 시작<br />1: 자동 관리 캐싱 끝<br />2: 비행 레코더 시작<br />3: 비행 레코더 중지<br />4: 구성 속성 업데이트<br />5:SQL 추적<br />6: 개체 생성됨<br />7: 개체 삭제됨<br />8: 개체 변경됨<br />9: 자동 관리 캐싱 폴링 시작<br />10: 자동 관리 캐싱 폴링 끝<br />11: 비행 레코더 스냅숏 시작<br />12: 비행 레코더 스냅숏 끝<br />13: 자동 관리 캐싱: 알려야 할 개체 업데이트됨<br />14: 지연 처리: 처리 시작<br />15: 지연 처리: 처리 완료<br />16: SessionOpened 이벤트 시작<br />17: SessionOpened 이벤트 끝<br />18: SessionClosing 이벤트 시작<br />19: SessionClosing 이벤트 끝<br />20: CubeOpened 이벤트 시작<br />21: CubeOpened 이벤트 끝<br />22: CubeClosing 이벤트 시작<br />23: CubeClosing 이벤트 끝<br />24: 트랜잭션 중단 요청|  
...
|Duration|5|2|이벤트에 의해 사용된 시간(밀리초)을 포함합니다.|  
...
|데이터 열이 추적에서 캡처되고 서버를 사용할 수 있으면|43|8|알림 이벤트가 발생한 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 인스턴스의 이름을 포함합니다.|  
