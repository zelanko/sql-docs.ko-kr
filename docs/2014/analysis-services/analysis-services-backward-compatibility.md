...
|[SQL Server 2014의에서 기능을 서비스의 주요 변경 내용 분석](breaking-changes-to-analysis-services-features-in-sql-server-2014.md)|이 릴리스의 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 에 도입되어 잠재적으로 모델을 손상할 수 있는 코드 변경 내용 또는 이전 버전의 소프트웨어에서 만든 스크립트 또는 사용자 지정 애플리케이션에 대해 설명합니다.|  
