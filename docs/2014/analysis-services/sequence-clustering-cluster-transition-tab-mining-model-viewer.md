 ...
 **팁:** 클러스터를 사용 하 여 이름을 바꿀 수 있습니다 합니다 **클러스터 다이어그램** 탭 합니다. 클러스터를 선택하고 마우스 오른쪽 단추로 클릭한 다음 **이름 바꾸기**를 선택합니다. 클러스터의 이름을 설명이 더 많이 포함된 레이블로 바꾸면 **상태 전환** 탭에서 클러스터를 보다 쉽게 비교할 수 있습니다.  
