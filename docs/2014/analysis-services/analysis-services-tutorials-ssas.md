---
title: 분석 서비스 자습서(SSAS) | 마이크로 소프트 문서
ms.custom: ''
ms.date: 03/06/2017
...
# <a name="analysis-services-tutorials-ssas"></a>Analysis Services 자습서(SSAS)
 ...
 [GitHub의 어드벤처웍스 샘플 데이터베이스](https://github.com/Microsoft/sql-server-samples/releases/tag/adventureworks)  
 이 링크는 에 대한 AdventureWorks 샘플 데이터베이스가 있는 GitHub 다운로드 페이지로 [!INCLUDE[ssSQL14](../includes/sssql14-md.md)]이동합니다.  
...
## <a name="see-also"></a>참고 항목  
 [테크넷 위키: SQL Server 2012 샘플](https://go.microsoft.com/fwlink/?linkID=220734)   
