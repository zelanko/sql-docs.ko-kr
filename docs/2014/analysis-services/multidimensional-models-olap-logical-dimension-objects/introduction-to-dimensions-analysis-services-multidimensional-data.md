...
## <a name="dimension-based-on-a-star-schema-design"></a>별모양 스키마 디자인을 기반으로 하는 차원  
 ...
 ![팩트 차원 관계에 대 한 논리 스키마](../../../2014/analysis-services/dev-guide/media/dimfactrelationship.gif "팩트 차원 관계에 대 한 논리 스키마")  
...
## <a name="dimension-based-on-a-snowflake-schema-design"></a>눈송이 스키마 디자인을 기반으로 하는 차원  
 ...
 ![AdventureWorksAS Product 차원에 대 한 테이블](../../../2014/analysis-services/dev-guide/media/dimproduct.gif "AdventureWorksAS Product 차원에 대 한 테이블")  
