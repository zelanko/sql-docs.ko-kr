...
|옵션|정의|  
|------------|----------------|  
|**새 KPI**|**KPI 폼 편집기** 를 표시하고 새 KPI를 만들려면 선택합니다. 에 대 한 자세한 내용은 **KPI 폼 편집기**를 참조 하세요 [KPI 폼 편집기 &#40;KPIs Tab, Cube Designer&#41; &#40;Analysis Services-Multidimensional Data&#41;](kpi-form-editor-kpis-tab-cube-designer-analysis-services-multidimensional-data.md).|  
|**위로 이동**|**KPI 구성 도우미** 에서 선택한 KPI를 한 단계 위로 이동하고 **KPI 브라우저**에서 KPI가 표시되는 순서를 결정하려면 선택합니다.<br /><br /> 참고: 선택한 KPI를 더 이상 이동할 수 없는 경우에이 옵션은 사용할 수 없습니다.|  
|**아래로 이동**|**KPI 구성 도우미** 에서 선택한 KPI를 한 단계 아래로 이동하고 **KPI 브라우저**에서 KPI가 표시되는 순서를 결정하려면 선택합니다.<br /><br /> 참고: 선택한 KPI를 더 이상 이동할 수 없는 경우에이 옵션은 사용할 수 없습니다.|  
|**Delete**|선택한 KPI를 삭제하려면 선택합니다.|  
