...
##  <a name="requirements-for-using-the-configuration-tools"></a><a name="bkmk_requirements"></a>구성 도구 사용을 위한 요구 사항
...
##  <a name="two-versions-of-the-configuration-tool"></a><a name="bkmk_twoversions"></a>구성 도구의 두 가지 버전
...
|Name|지원되는 SharePoint 버전|세부적인 구성|
|----------|-------------------------------------|----------------------------|
...
###  <a name="how-the-two-configuration-tools-are-different"></a><a name="bkmk_sum_differences_betweentools"></a>두 구성 도구 다른 방법
...
##  <a name="overview-of-using-a-powerpivot-configuration-tool"></a><a name="bkmk_overview"></a>PowerPivot 구성 도구 사용에 대 한 개요
...
##  <a name="start-one-of-the-powerpivot-configuration-tools"></a><a name="bmkm_start_tool"></a>PowerPivot 구성 도구 중 하나를 시작 합니다.
