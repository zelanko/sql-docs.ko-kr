 ...
 **시나리오 3: 도메인 컨트롤러를 사용할 수 없습니다.**  
 ...
 오프라인 상태로 SharePoint용 PowerPivot을 사용하는 것이 목적인 경우 컴퓨터에 도메인 컨트롤러를 설치하면 유용합니다. 자세한 지침은 PowerPivot을 오프 라인으로 사용 하는 방법에 대 한 블로그 항목을 참조에서 "Taking your PowerPivot server off the network" [ http://www.powerpivotgeek.com ](https://go.microsoft.com/fwlink/?LinkId=184241)합니다.  
