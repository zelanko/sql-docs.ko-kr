 ...
 **시나리오 2a: 서버에서 이전 버전의 통합 문서 열기**  
 ...
 [SharePoint 서버에서 Analysis Services OLE DB 공급자 설치](../../sql-server/install/install-the-analysis-services-ole-db-provider-on-sharepoint-servers.md)  
