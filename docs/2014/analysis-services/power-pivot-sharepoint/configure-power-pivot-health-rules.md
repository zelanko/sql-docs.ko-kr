...
4.  서비스 속성 페이지의 상태 규칙 설정에서 다음 설정을 수정합니다.  
     ...
     이 구성 설정은 다음 규칙 정의에 해당 합니다 **문제 및 솔루션 검토** 페이지: **PowerPivot: Analysis Services에는 요청한 작업을 수행할 충분 한 CPU 리소스가 없습니다.**  
     ...
     이 구성 설정은 다음 규칙 정의에 해당 합니다 **문제 및 솔루션 검토** 페이지: **PowerPivot: 전체 CPU 사용량이 너무 높습니다.**  
     ...
     이 구성 설정은 다음 규칙 정의에 해당 합니다 **문제 및 솔루션 검토** 페이지: **PowerPivot: Analysis Services에는 요청한 작업을 수행 하는 데 충분 한 메모리가 없습니다.**  
     ...
     이 구성 설정은 다음 규칙 정의에 해당 합니다 **문제 및 솔루션 검토** 페이지: **PowerPivot: 연결 수가 현재 로드를 처리 하려면 더 많은 서버를 배포 해야 나타냅니다.**  
     ...
     이 구성 설정은 다음 규칙 정의에 해당 합니다 **문제 및 솔루션 검토** 페이지: **PowerPivot: PowerPivot 데이터가 캐시 된 드라이브에 디스크 공간이 부족 합니다.**  
...
4.  상태 규칙 설정에서 다음 설정을 수정합니다.  
     ...
     이 구성 설정은 다음 규칙 정의에 해당 합니다 **문제 및 솔루션 검토** 페이지: **PowerPivot: 연결에 대 한 로드 이벤트의 비율이 너무 높습니다.**  
     ...
     이 구성 설정은 다음 규칙 정의에 해당 합니다 **문제 및 솔루션 검토** 페이지: **PowerPivot: 사용 데이터가 예상 된 빈도로 업데이트 되지 않습니다.**  
