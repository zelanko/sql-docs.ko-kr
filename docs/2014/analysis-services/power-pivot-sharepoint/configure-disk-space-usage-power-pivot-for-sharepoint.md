...
2.  **기본 PowerPivot 서비스 애플리케이션** 을 클릭하여 관리 대시보드를 엽니다.  
  
3.  동작에서 **서비스 응용 프로그램 설정 구성**을 클릭 합니다.  
