---
title: '8단원: 작업 정의 | Microsoft Docs'
ms.custom: ''
ms.date: 06/13/2017
...
|URL|동적 웹 페이지를 인터넷 브라우저로 표시합니다.|  
 ...
 동작을 사용하여 애플리케이션을 시작하거나 선택한 항목의 컨텍스트 내에서 다른 작업을 수행할 수 있습니다. 자세한 내용은 [동작&#40;Analysis Services - 다차원 데이터&#41;](multidimensional-models/actions-analysis-services-multidimensional-data.md) 및 [다차원 모델의 동작](multidimensional-models/actions-in-multidimensional-models.md)을 참조하세요.  
