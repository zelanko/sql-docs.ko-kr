...
-   [새로 고칠 데이터 원본에 대 한 제한 사항](#bkmk_restrictions)  
  
-   [데이터 원본 변경에 대한 제한 사항](#bkmk_rest_changes)  
  
##  <a name="bkmk_how_df_works"></a>데이터 처리 방식  
...
##  <a name="bkmk_det_source"></a>데이터 원본 확인  
...
3.  
  **테이블 속성 편집** 대화 상자에서 **연결 이름**에 나열된 값을 기록해 둡니다.  
  
4.  
  [!INCLUDE[ssBIDevStudio](../includes/ssbidevstudio-md.md)]의 **모델** 메뉴에서 **기존 연결**을 클릭합니다.  
  
5.  
  **기존 연결** 대화 상자에서 3단계에서 확인한 이름의 데이터 원본을 선택한 다음 **편집**을 클릭합니다.  
  
6.  
  **연결 편집** 대화 상자에서 데이터베이스 이름, 파일 경로 또는 보고서 경로와 같은 연결 정보를 봅니다.  
...
3.  
  **테이블 속성 편집** 대화 상자의 **마지막 새로 고침** 에 테이블을 마지막으로 새로 고친 날짜가 표시됩니다.  
  
##  <a name="bkmk_restrictions"></a>새로 고칠 데이터 원본에 대 한 제한 사항  
...
##  <a name="bkmk_rest_changes"></a>데이터 원본 변경에 대 한 제한 사항  
...
## <a name="see-also"></a>참고 항목  
 ...
 [SSAS 테이블 형식&#41;&#40;기존 데이터 원본 연결 편집](edit-an-existing-data-source-connection-ssas-tabular.md)  
