 ...
 **자세한 내용:** [Microsoft Naive Bayes 알고리즘](data-mining/microsoft-naive-bayes-algorithm.md), [Microsoft Naive Bayes Viewer를 사용 하 여 모델 찾아보기](data-mining/browse-a-model-using-the-microsoft-naive-bayes-viewer.md)  
...
|**값**|
  **특성**에 나열된 특성의 상태입니다.|  
|**값 \<1에 우선>**|막대는 현재 특성과 값이 **값 1**에서 선택한 대상 결과와 유사한지 여부를 나타냅니다.|  
|**값 \<2>에 우선 합니다.**|막대는 현재 특성과 값이 **값 2**에서 선택한 대상 결과와 유사한지 여부를 나타냅니다.|  
