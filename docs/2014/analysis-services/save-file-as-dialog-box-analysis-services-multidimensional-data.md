---
title: 파일 저장 대화 상자 (Analysis Services-다차원 데이터) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
-   **데이터베이스 백업** 대화 상자에서 **찾아보기** 를 클릭합니다.  
  
-   **데이터베이스 백업**대화 상자의 **원격 파티션 백업 위치** 옵션에 대한 표의 **원격 백업 파일** 열에서 줄임표 단추( **...** )를 클릭합니다.  
