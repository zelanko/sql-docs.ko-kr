---
title: 차원 인텔리전스 옵션 (비즈니스 인텔리전스 마법사)를 설정 합니다. | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
