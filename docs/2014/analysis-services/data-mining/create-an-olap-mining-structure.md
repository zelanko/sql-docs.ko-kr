...
##  <a name="requirements-for-olap-mining-structure-and-models"></a><a name="bkmk_Reqs"></a>OLAP 마이닝 구조 및 모델에 대 한 요구 사항  
...
##  <a name="overview-of-olap-data-mining-process"></a><a name="bkmk_Overview"></a>OLAP 데이터 마이닝 프로세스 개요  
...
##  <a name="slicing-a-cube-vs-filtering-models"></a><a name="bkmk_Filters"></a>큐브 조각화 및 필터링 모델 비교  
...
##  <a name="using-nested-tables-in-an-olap-mining-model"></a><a name="bkmk_Nested"></a>OLAP 마이닝 모델에서 중첩 테이블 사용  
...
##  <a name="understanding-data-mining-dimensions-and-drillthrough"></a><a name="bkmk_DMDimension"></a>데이터 마이닝 차원 및 드릴스루 이해  
