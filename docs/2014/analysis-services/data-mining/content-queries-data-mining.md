...
-   [모델 패턴에 대 한 쿼리](#bkmk_Patterns)  
  
 [예](#bkmk_Examples)  
  
-   [연결 모델에 대 한 내용 쿼리](#bkmk_Assoc)  
  
-   [의사 결정 트리 모델에 대 한 내용 쿼리](#bkmk_DecTree)  
...
###  <a name="bkmk_Structure"></a>구조 및 사례 데이터에 대 한 쿼리  
 ...
 **모델 또는 구조를 테스트 하는 데 사용 되는 사례 찾기**  
...
###  <a name="bkmk_Patterns"></a>모델 패턴, 통계 및 특성에 대 한 쿼리  
...
###  <a name="bkmk_Assoc"></a>예 1: 연결 모델에 대 한 내용 쿼리  
...
###  <a name="bkmk_DecTree"></a>예 2: 의사 결정 트리 모델에 대 한 내용 쿼리  
