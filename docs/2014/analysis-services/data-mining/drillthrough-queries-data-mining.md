...
##  <a name="using-drillthrough-in-data-mining-designer"></a><a name="bkmk_Designer"></a>데이터 마이닝 디자이너에서 드릴스루 사용  
...
##  <a name="creating-drillthrough-queries-using-dmx"></a><a name="bkmk_DMX"></a>DMX를 사용 하 여 드릴스루 쿼리 만들기  
...
##  <a name="considerations-when-using-drillthrough"></a><a name="bkmk_Considerations"></a>드릴스루 사용 시 고려 사항  
...
###  <a name="limitations-on-drillthrough"></a><a name="bkmk_Limits"></a>드릴스루에 대 한 제한 사항  
