...
##  <a name="creating-data-definition-queries"></a><a name="bkmk_Create"></a>데이터 정의 쿼리 만들기  
...
###  <a name="data-definition-queries-in-sql-server-data-tools"></a><a name="bkmk_ssdt"></a>SQL Server Data Tools의 데이터 정의 쿼리  
...
###  <a name="data-definition-queries-in-sql-server-management-studio"></a><a name="bkmk_SSMS"></a>SQL Server Management Studio의 데이터 정의 쿼리  
...
###  <a name="scripting-data-definition-statements"></a><a name="bkmk_Scripts"></a>데이터 정의 문 스크립팅  
...
##  <a name="exporting-and-importing-models"></a><a name="bkmk_Export"></a>모델 내보내기 및 가져오기  
