...
###  <a name="example-1-typical-case-level-filtering"></a><a name="bkmk_Ex1"></a> 예 1: 일반적인 사례 수준 필터링  
...
###  <a name="example-2-case-level-filtering-using-nested-table-attributes"></a><a name="bkmk_Ex2"></a> 예 2: 중첩 테이블 특성을 사용한 사례 수준 필터링  
...
###  <a name="example-3-case-level-filtering-on-multiple-nested-table-attributes"></a><a name="bkmk_Ex3"></a> 예 3: 여러 중첩 테이블 특성을 사용한 사례 수준 필터링  
...
###  <a name="example-4-case-level-filtering-on-absence-of-nested-table-attributes"></a><a name="bkmk_Ex4"></a> 예 4: 중첩 테이블 특성의 부재를 사용한 사례 수준 필터링  
...
###  <a name="example-5-filtering-on-multiple-nested-table-values"></a><a name="bkmk_Ex5"></a> 예 5: 여러 중첩 테이블 값을 사용한 필터링  
...
###  <a name="example-6-filtering-on-nested-table-attributes-and-exists"></a><a name="bkmk_Ex6"></a> 예 6: 중첩 테이블 특성 및 EXISTS를 사용한 필터링  
...
###  <a name="example-8-filtering-on-dates"></a><a name="bkmk_Ex8"></a> 예 8: 날짜로 필터링  
...
> [!NOTE]  
>  모델에 추가하는 모든 추가 열은 결과에 영향을 줄 수 있습니다. 따라서 계열의 계산에 열을 사용하지 않으려면 열을 모델이 아니라 마이닝 구조에만 추가해야 합니다. 열에서 모델 플래그를 `PredictOnly` 또는 `Ignore`로 설정할 수도 있습니다. 자세한 내용은 [모델링 플래그&#40;데이터 마이닝&#41;](modeling-flags-data-mining.md)를 참조하세요.  
