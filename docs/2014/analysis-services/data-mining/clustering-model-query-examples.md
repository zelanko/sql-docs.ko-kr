...
##  <a name="finding-information-about-the-model"></a><a name="bkmk_top2"></a> 모델 정보 찾기  
...
###  <a name="sample-query-3-returning-a-cluster-or-list-of-clusters"></a><a name="bkmk_Query3"></a> 예제 쿼리 3: 클러스터 또는 클러스터 목록 반환  
...
###  <a name="sample-query-4-returning-attributes-for-a-cluster"></a><a name="bkmk_Query4"></a> 예제 쿼리 4: 클러스터에 대한 특성 반환  
...
###  <a name="sample-query-5-return-a-cluster-profile-using-system-stored-procedures"></a><a name="bkmk_Query5"></a> 예제 쿼리 5: 시스템 저장 프로시저를 사용하여 클러스터 프로필 반환  
...
###  <a name="sample-query-6-find-discriminating-factors-for-a-cluster"></a><a name="bkmk_Query6"></a> 예제 쿼리 6: 클러스터에 대한 판별 요소 찾기  
...
###  <a name="sample-query-7-returning-cases-that-belong-to-a-cluster"></a><a name="bkmk_Query7"></a> 예제 쿼리 7: 클러스터에 속한 사례 반환  
...
###  <a name="sample-query-8-predicting-outcomes-from-a-clustering-model"></a><a name="bkmk_Query8"></a> 예제 쿼리 8: 클러스터링 모델에서 결과 예측  
...
###  <a name="sample-query-9-determining-cluster-membership"></a><a name="bkmk_Query9"></a>예제 쿼리 9: 클러스터 멤버 자격 확인  
...
###  <a name="sample-query-10-returning-all-possible-clusters-with-probability-and-distance"></a><a name="bkmk_Query10"></a> 예제 쿼리 10: 확률과 거리가 포함된 가능한 모든 클러스터 반환  
