...
7.  계층 창 `Product Model Lines` 에서 계층을 **Hierarchies** 선택 하 고 속성 창 **AllMemberName** 속성을로 `All Products`변경 합니다.  
...
3.  계층 목록 `Product Model Lines` 에서가 선택 되어 **Hierarchy** 있는지 확인 한 다음를 확장 `All Products`합니다.  
