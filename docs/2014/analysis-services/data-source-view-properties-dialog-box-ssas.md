...
ms.locfileid: "66082499"
---
# <a name="data-source-view-properties-dialog-box-ssas"></a>데이터 원본 뷰 속성 대화 상자(SSAS)
  
  **의** 데이터 원본 뷰 속성 [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] 대화 상자를 사용하여 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 데이터베이스의 데이터 원본 뷰 속성을 설정할 수 있습니다. 
  **개체 탐색기** 에서 데이터 원본 뷰를 마우스 오른쪽 단추로 클릭하고 **속성** 을 선택하여 **데이터 원본 뷰 속성**대화 상자를 표시할 수 있습니다.  
...
|**타임 스탬프 만들기**|데이터 원본 뷰를 만든 날짜 및 시간을 표시합니다.|  
