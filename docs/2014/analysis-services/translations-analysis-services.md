...
> [!TIP]  
>  Excel, Management Studio 등과 같은 클라이언트 애플리케이션과 [!INCLUDE[ssSqlProfiler](../includes/sssqlprofiler-md.md)] 를 사용하여 번역된 문자열을 반환할 수 있습니다. 자세한 내용은 [세계화 팁과 모범 사례&#40;Analysis Services&#41;](globalization-tips-and-best-practices-analysis-services.md) 를 참조하세요.  
