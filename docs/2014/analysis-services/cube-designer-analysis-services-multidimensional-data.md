...
|**actions**|이 탭을 사용하여 드릴스루 작업 및 보고 작업을 비롯하여 큐브에 포함될 동작을 생성 및 수정할 수 있습니다. 이 탭에 대한 자세한 내용은 [작업&#40;큐브 디자이너&#41;&#40;Analysis Services - 다차원 데이터&#41;](actions-cube-designer-analysis-services-multidimensional-data.md)을 참조하세요.|  
