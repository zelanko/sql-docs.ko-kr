...
|**기존 파티션에서 집계 디자인을 복사 합니다.**|측정값 그룹의 기존 파티션에서 새 파티션으로 집계 디자인을 복사합니다. 이 옵션을 클릭하면 **원본** 옵션을 사용할 수 있습니다. **원본** 옵션을 사용하여 집계 디자인을 복사할 파티션을 선택할 수 있습니다.<br /><br /> 나중에 병합할 파티션은 테이블 구조와 집계 디자인이 동일 갖도록 참고 합니다. 새 파티션을 측정값 그룹의 기존 파티션과 병합할 경우 기존 파티션의 집계 디자인을 새 파티션에 복사해야 합니다.|  
