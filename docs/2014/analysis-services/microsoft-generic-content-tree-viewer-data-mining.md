...
# <a name="microsoft-generic-content-tree-viewer-data-mining"></a>Microsoft 일반 콘텐츠 트리 뷰어(데이터 마이닝)
 ...
 뷰어에 표시되는 정보는 마이닝 모델의 콘텐츠 스키마 행 집합을 기반으로 하는 공용 구조를 사용합니다. 콘텐츠 스키마 행 집합은 데이터 마이닝 모델의 기타 콘텐츠, 통계 및 패턴 저장에 대한 일반 프레임워크입니다. 마이닝 모델에 대한 데이터 마이닝 스키마 행 집합의 열 목록은 [DMSCHEMA_MINING_MODEL_CONTENT 행 집합](https://docs.microsoft.com/bi-reference/schema-rowsets/data-mining/dmschema-mining-model-content-rowset)을 참조하세요.  
