...
|**위로 이동**|선택한 계산을 한 단계 위로 이동하려면 선택합니다.<br /><br /> 참고: 선택한 계산을 더 이상 이동할 수 없는 경우에이 옵션은 사용할 수 없습니다.|  
|**아래로 이동**|선택한 계산을 한 단계 아래로 이동하려면 선택합니다.<br /><br /> 참고: 선택한 계산을 더 이상 이동할 수 없는 경우에이 옵션은 사용할 수 없습니다.|  
