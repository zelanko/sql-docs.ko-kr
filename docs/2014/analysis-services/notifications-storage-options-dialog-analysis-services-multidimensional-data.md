...
|**SQL Server**|에서 특수 추적 메커니즘을 사용 하 여 [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 개체의 기본 테이블에 대 한 변경 내용을 식별 합니다.|  
