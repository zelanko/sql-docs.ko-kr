...
-   0x0416 또는 1046 - **포르투갈어(브라질)**.  
 ...
 긴 목록을 보려면 [Microsoft에서 할당한 로캘 ID](https://msdn.microsoft.com/goglobal/bb964664.aspx)(영문)를 참조하세요. 자세한 배경을 알고 싶으면 [인코딩 및 코드 페이지](https://msdn.microsoft.com/goglobal/bb688114.aspx)를 참조하세요.  
