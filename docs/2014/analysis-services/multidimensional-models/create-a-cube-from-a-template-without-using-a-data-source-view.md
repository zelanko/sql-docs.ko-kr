...
|열|설명|  
|------------|-----------------|  
|**Type**|템플릿 차원의 차원 유형을 표시합니다. 이 셀을 클릭하면 차원의 차원 유형을 변경할 수 있습니다. 이 열은 차원 개체의 **유형** 속성을 설정합니다.|  
|`Name`|차원 이름을 표시합니다. 다른 이름을 입력하려면 이 셀을 클릭합니다. 이 값은 `Name` 차원 개체의 속성을 설정 합니다.|  
