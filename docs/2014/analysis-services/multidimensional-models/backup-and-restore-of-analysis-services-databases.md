...
##  <a name="preparing-for-backup"></a><a name="bkmk_prep"></a>백업 준비  
...
##  <a name="backing-up-a-multidimensional-or-a-tabular-database"></a><a name="bkmk_cube"></a> 다차원 데이터베이스 또는 테이블 형식 데이터베이스 백업  
...
##  <a name="restoring-an-analysis-services-database"></a><a name="bkmk_restore"></a>Analysis Services 데이터베이스 복원  
