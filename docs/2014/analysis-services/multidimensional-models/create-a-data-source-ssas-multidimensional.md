...
##  <a name="choose-a-data-provider"></a><a name="bkmk_provider"></a>Data Provider 선택  
...
##  <a name="set-credentials-and-impersonation-options"></a><a name="bkmk_impersonation"></a>자격 증명 및 가장 옵션 설정  
...
##  <a name="create-a-data-source-using-the-data-source-wizard"></a><a name="bkmk_steps"></a>데이터 원본 마법사를 사용 하 여 데이터 원본 만들기  
...
##  <a name="view-or-edit-connection-properties"></a><a name="bkmk_ConnectionString"></a>연결 속성 보기 또는 편집  
...
##  <a name="add-multiple-data-sources-to-a-model"></a><a name="bkmk_multipleDS"></a>모델에 여러 데이터 원본 추가  
