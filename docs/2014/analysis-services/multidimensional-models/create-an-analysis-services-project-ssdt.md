...
##  <a name="create-a-new-project-using-the-analysis-services-project-template"></a><a name="bkmk_NewUsingTemplate"></a>Analysis Services 프로젝트 템플릿을 사용 하 여 새 프로젝트 만들기  
...
##  <a name="create-a-new-project-using-an-existing-analysis-services-database"></a><a name="bkmk_NewUsingWizard"></a> 기존 Analysis Services 데이터베이스를 사용하여 새 프로젝트 만들기  
...
##  <a name="add-an-analysis-services-project-to-an-existing-solution"></a><a name="bkmk_AddtoExistingSolution"></a> 기존 솔루션에 Analysis Services 프로젝트 추가  
...
##  <a name="build-and-deploy-the-solution"></a><a name="bkmk_buildDeploy"></a> 솔루션 작성 및 배포  
...
##  <a name="analysis-services-project-folders"></a><a name="bkmk_ProjectFolders"></a>Analysis Services 프로젝트 폴더  
...
##  <a name="analysis-services-file-types"></a><a name="bkmk_FileTypes"></a> Analysis Services 파일 형식  
...
##  <a name="analysis-services-item-templates"></a><a name="bkmk_ItemTemplates"></a>Analysis Services 항목 템플릿  
