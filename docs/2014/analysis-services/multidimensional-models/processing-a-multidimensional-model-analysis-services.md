...
##  <a name="choosing-a-tool-or-approach"></a><a name="bkmk_tool"></a>도구 또는 방법 선택  
...
##  <a name="processing-objects"></a><a name="bkmk_proc"></a>개체 처리  
...
##  <a name="reprocessing-objects"></a><a name="bkmk_reproc"></a>개체 다시 처리  
