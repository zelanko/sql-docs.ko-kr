 ...
 **브라우저** 탭에는 메타 데이터 창, 필터 창 및 데이터 창과 같은 세 개의 창이 있습니다. 메타데이터 창에서는 트리 형식으로 큐브의 구조를 검토할 수 있습니다. **브라우저** 탭 상단의 필터 창에서는 찾아볼 하위 큐브를 정의할 수 있습니다. 데이터 창에서는 결과 집합을 보고 차원 계층을 통해 드릴다운할 수 있습니다.  
...
-   **필터** 창의 **차원** 열에서을 클릭 **\<Select dimension>** 하 고 목록에서 차원을 선택한 다음 **\<Select hierarchy>** **계층** 열을 클릭 하 고 목록에서 계층을 선택 합니다.  
...
|In(다음 안에)|하나 이상의 명명된 집합|값이 지정된 명명된 집합에 포함되어야 합니다.<br /><br /> (특성 계층에서만 지원됩니다.)|  
