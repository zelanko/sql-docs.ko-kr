...
##  <a name="processing-a-database"></a><a name="bkmk_procdb"></a>데이터베이스 처리  
...
##  <a name="processing-a-cube"></a><a name="bkmk_proccube"></a>큐브 처리  
...
##  <a name="processing-a-dimension"></a><a name="bkmk_procdim"></a>차원 처리  
...
##  <a name="processing-a-measure-group"></a><a name="bkmk_procmeasure"></a> 측정값 그룹 처리  
...
##  <a name="processing-a-partition"></a><a name="bkmk_procpartition"></a>파티션 처리  
...
##  <a name="processing-data-mining-structures-and-models"></a><a name="bkmk_procdm"></a>데이터 마이닝 구조 및 모델 처리  
