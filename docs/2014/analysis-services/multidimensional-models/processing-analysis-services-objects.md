...
# <a name="processing-analysis-services-objects"></a>Analysis Services 개체 처리
 ...
 [데이터 마이닝 구조 및 모델 처리](#bkmk_procdm)  
...
> [!NOTE]  
>  프로그래밍 방식으로 또는 [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]를 사용하여 개별 측정값 그룹을 처리할 수 있습니다. 
  [!INCLUDE[ssBIDevStudio](../../includes/ssbidevstudio-md.md)]에서 개별 측정값 그룹을 처리할 수 없지만 파티션을 사용하여 처리할 수 있습니다.  
