...
-   Power View 클라이언트 기능에는 Microsoft Silverlight 5가 필요합니다. 자세한 내용은 [Reporting Services 계획 및 파워 뷰 브라우저 지원 &#40;Reporting Services 2014&#41;](../../reporting-services/browser-support-for-reporting-services-and-power-view.md)을 참조 하세요.  
 ...
 **Variant로 측정**  
 ...
 ![파워 뷰의 집계할 때가 아닌 계층](../media/daxmd-nonaggrattrib.gif "파워 뷰의 집계할 수 없는 계층")  
 ...
 **SQL Server Data Tools (SSDT) 및 파워 뷰 필드 목록의 차원, 특성 및 계층**  
...
-   계산 멤버를 포함하는 특성은 부모-자식 특성일 수 없습니다.  
 ...
 아래 이미지에서는 Date 차원의 "회계 날짜 계산" 차원 특성에 대 한 시간 인텔리전스 계산 멤버를 포함 하는 큐브에 대 한 파워 뷰 보고서를 보여 줍니다.  
  
 **계산 멤버를 사용 하 여 보고서 파워 뷰**  
 ...
 **동작** -다차원 모델에 대 한 파워 뷰 보고서 또는 DAX 쿼리에서 지원 되지 않습니다.  
  
 **명명 된 집합** -다차원 모델에서는 다차원 모델에 대 한 파워 뷰 또는 DAX 쿼리에서 지원 되지 않습니다.  
...
## <a name="client-help-on-officecom"></a>Office.com의 클라이언트 도움말  
 ...
 [파워 뷰를 사용 하 여 놀이 Works 다차원 모델 살펴보기](https://office.microsoft.com/excel-help/explore-the-adventure-works-multidimensional-model-by-using-power-view-HA104046830.aspx)  
