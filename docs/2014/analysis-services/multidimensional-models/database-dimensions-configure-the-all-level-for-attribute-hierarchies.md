...
## <a name="all-member-and-all-level"></a>All 멤버 및 (All) 수준  
 (All) 수준의 단일 멤버를 All 멤버라고 합니다. `AttributeAllMemberName`차원의 속성은 차원의 특성에 대 한 All 멤버의 이름을 지정 합니다. 계층의 `AllMemberName` 속성은 계층에 대한 All 멤버의 이름을 지정합니다.  
