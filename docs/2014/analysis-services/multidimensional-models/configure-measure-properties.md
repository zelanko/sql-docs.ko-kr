...
|속성|정의|  
|--------------|----------------|  
|`AggregateFunction`|필수 사항입니다. 측정값이 집계되는 방법을 결정합니다. `Sum` 기본 집계가입니다. 자세한 내용은 각 함수 설명의 [Use Aggregate Functions](use-aggregate-functions.md) 을 참조하세요.|  
