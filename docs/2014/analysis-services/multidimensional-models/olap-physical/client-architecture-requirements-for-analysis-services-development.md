...
# <a name="client-architecture-requirements-for-analysis-services-development"></a>Analysis Services 배포의 클라이언트 아키텍처 요구 사항
 ...
 ![Analysis Services에 대 한 논리 클라이언트 아키텍처](../../../analysis-services/dev-guide/media/as-clientarch9.gif "Analysis Services에 대 한 논리 클라이언트 아키텍처")  
 ...
 **HTTP** SSAS 데이터 펌프 서비스 또는 SharePoint PowerPivot WS (웹 서비스) 구성 요소를 호출 하 여 HTTP 연결에 사용 합니다.  
  
 **INPROC** in-process 엔진에 연결할 때 사용 합니다.  
  
 **채널** SharePoint 팜에서 PowerPivot 시스템 서비스와 통신 하기 위해 예약 되어 있습니다.  
