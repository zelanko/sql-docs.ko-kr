---
title: 클라이언트 아키텍처 요구 사항에 대 한 Analysis Services 개발 | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
# <a name="client-architecture-requirements-for-analysis-services-development"></a>Analysis Services 배포의 클라이언트 아키텍처 요구 사항
 ...
 ![Analysis Services에 대 한 논리적 클라이언트 아키텍처](../../../analysis-services/dev-guide/media/as-clientarch9.gif "Analysis Services에 대 한 논리적 클라이언트 아키텍처")  
...
|모든 SOAP 지원 언어|XML for Analysis|  
 ...
 ![중간 계층 아키텍처에 대 한 논리 다이어그램](../../../analysis-services/dev-guide/media/as-midtierarch9.gif "중간 계층 아키텍처에 대 한 논리 다이어그램")  
 ...
 **HTTP** SSAS 데이터 펌프 서비스를 통해 또는 SharePoint PowerPivot WS (웹 서비스) 구성 요소를 호출 하 여 HTTP 연결에 사용 합니다.  
  
 **INPROC** in-process 엔진에 대 한 연결에 사용 합니다.  
  
 **채널** SharePoint 팜에서 PowerPivot 시스템 서비스와의 통신에 대 한 예약 합니다.  
