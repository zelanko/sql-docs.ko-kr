...
# <a name="understanding-microsoft-olap-architecture"></a>Microsoft OLAP 아키텍처 이해
 ...
 [자세히 ...](../olap-logical/understanding-microsoft-olap-logical-architecture.md)  
  
 ![작은 파일 폴더 아이콘](../../../integration-services/media/filefolder-small.gif "작은 파일 폴더 아이콘") **실제 아키텍처**  
...
## <a name="see-also"></a>참고 항목  
 [SSAS&#41;&#40;기술 참조](../../powershell/technical-reference-ssas.md)  
