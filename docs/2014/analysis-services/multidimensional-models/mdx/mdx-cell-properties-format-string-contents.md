...
|**d**|일을 앞에 오는 0 없이 숫자로 표시 합니다 (1-31).|  
...
|**MM**|월을 앞에 오는 0을 사용 하는 숫자로 표시 합니다 (01-12).<br /><br /> **h** 또는 **hh** 바로 뒤에 **m**이 나오면 월 대신 분이 표시됩니다.|  
...
|**h**|시간을 앞에 오는 0 없이 숫자로 표시 합니다 (0-23).|  
