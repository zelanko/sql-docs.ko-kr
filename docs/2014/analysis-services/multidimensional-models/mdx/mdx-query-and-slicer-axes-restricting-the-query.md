---
title: 쿼리 및 Slicer 축 (MDX)를 사용 하 여 쿼리를 제한 합니다. | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
-   **Query 축**-여러 멤버에 대해 검색 되는 데이터는 계층 집합입니다. 쿼리 축에 대한 자세한 내용은 [쿼리 축의 내용 지정&#40;MDX&#41;](mdx-query-and-slicer-axes-specify-the-contents-of-a-query-axis.md)을 참조하세요.  
  
-   **Slicer 축**-단일 멤버에 대 한 데이터가 검색 되는 계층 집합입니다. Slicer 축에 대한 자세한 내용은 [Slicer 축의 내용 지정&#40;MDX&#41;](mdx-query-and-slicer-axes-specify-the-contents-of-a-slicer-axis.md)을 참조하세요.  
...
## <a name="see-also"></a>관련 항목  
 [멤버, 튜플 및 집합 & #40; 사용 Mdx& #41;](working-with-members-tuples-and-sets-mdx.md)   
