...
>  0은 열 축을 지정하는 데 사용되었으며 열 축을 나타내는 axis(0)을 줄여 쓴 것입니다.  
 ...
 앞의 쿼리는 쿼리의 각 특성 계층에서 서로 함께 존재하는 멤버의 셀만 반환합니다. 이전 쿼리는 [ \* (Crossjoin) (MDX)](/sql/mdx/crossjoin-mdx) 함수의 새로운 * 변형을 사용 하 여 작성할 수도 있습니다.  
...
##  <a name="attribute-relationships-and-cube-space"></a><a name="AttribRelationships"></a>특성 관계 및 큐브 공간  
