...
-   쿼리될 큐브를 결정하는 FROM 절. FROM 절에 대 한 자세한 내용은 참조 [SELECT 문 &#40;MDX&#41;](/sql/mdx/mdx-data-manipulation-select)합니다.  
...
```  
 ...
 MDX SELECT 문은 WITH 키워드, 축 또는 slicer 축에 포함할 계산된 멤버를 만들기 위한 MDX 함수의 사용, 쿼리의 일부로 특정 셀 속성의 값을 반환하는 기능 등의 선택적 구문을 지원합니다. MDX SELECT 문에 대 한 자세한 내용은 참조 [SELECT 문 &#40;MDX&#41;](/sql/mdx/mdx-data-manipulation-select)합니다.  
