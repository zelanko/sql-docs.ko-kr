...
-   명령 언어 - `Create`, `Alter` 또는 `Process`와 같은 동작 명령을 Analysis Services 인스턴스로 보냅니다. 이 명령 언어에 대해서는 설명의 [XML for Analysis &#40;XMLA&#41; 참조](../../xmla/xml-for-analysis-xmla-reference.md)합니다.  
