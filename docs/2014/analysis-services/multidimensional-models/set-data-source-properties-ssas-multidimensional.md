...
|**쿼리 시간 제한**|연결 요청이 중단되기 전에 시도하는 시간을 지정합니다.<br /><br /> 다음 형식으로 쿼리 제한 시간을 입력합니다.<br /><br /> *\<Hours>*:*\<Minutes>*:*\<Seconds>*<br /><br /> 이 속성은 `DatabaseConnectionPoolTimeoutConnection` 서버 속성에서 수정할 수 있습니다. 서버 속성이 더 작으면 **쿼리 제한 시간**대신 사용됩니다.<br /><br /> **쿼리 제한 시간** 속성에 대 한 자세한 내용은을 참조 하십시오 <xref:Microsoft.AnalysisServices.DataSource.Timeout%2A> . 서버 속성에 대한 자세한 내용은 [OLAP Properties](../server-properties/olap-properties.md)을 참조하십시오.|  
