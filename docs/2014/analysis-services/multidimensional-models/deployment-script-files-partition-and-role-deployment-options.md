...
-   엽니다는 \< *프로젝트 이름*>.deploymentoptions 임의의 텍스트 편집기에서 이동 하 고 수동으로 옵션을 변경 합니다.  
