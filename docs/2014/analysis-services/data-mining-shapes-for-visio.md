...
-   **종속성 네트워크 다이어그램:** 이 마법사를 사용 하 여 의사 결정 트리와 신경망에 대 한 그래프를 만듭니다.  
  
-   **의사 결정 트리 다이어그램:** 이 마법사를 사용 하 여 의사 결정 지점 및 의사 결정 트리 모델을 사용 하 여 연결 하는 수식을 보여 주는 다이어그램을 만듭니다. 이 다이어그램은 회귀 모델에서도 사용할 수 있습니다.  
  
-   **클러스터 다이어그램:** 이 마법사를 사용 하 여 세그먼트화 모델에 대해 색상이 지정 된 그래프를 만듭니다. 특성 판별, 클러스터 프로필 및 종속성과 같은 뷰 사이를 전환하고 클러스터의 모양을 사용자 지정할 수 있습니다.  
