...
## <a name="programming-reference-sections"></a>프로그래밍 참조 섹션  
 ...
 ![작은 파일 폴더 아이콘](../integration-services/media/filefolder-small.gif "작은 파일 폴더 아이콘") [SQL Server Management Objects &#40;SMO&#41; 프로그래밍 가이드](../relational-databases/server-management-objects-smo/sql-server-management-objects-smo-programming-guide.md)  
 ...
 ![작은 파일 폴더 아이콘](../integration-services/media/filefolder-small.gif "작은 파일 폴더 아이콘") [ADOMD.NET을 사용 하 여 개발](../analysis-services/multidimensional-models/adomd-net/developing-with-adomd-net.md)  
