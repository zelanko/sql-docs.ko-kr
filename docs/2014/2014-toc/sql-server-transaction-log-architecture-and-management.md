...
##  <a name="physical_arch"></a> 트랜잭션 로그 물리 아키텍처  
 ...
 ![로그 파일 4 개의 가상 로그 파일을 나눌](media/tranlog3.gif "로그 파일로 나뉘어진 4 개의 가상 로그 파일")  
...
### <a name="log-truncation"></a>로그 잘림  
 ...
 ![4 개의 가상 로그가 있는 트랜잭션 로그](media/tranlog2.gif "4 개의 가상 로그가 있는 트랜잭션 로그")  
