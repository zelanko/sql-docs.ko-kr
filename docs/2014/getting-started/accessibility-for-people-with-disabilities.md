...
## <a name="ssnoversion-accessibility-features"></a>[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 내게 필요한 옵션  
...
## <a name="accessibility-in-msconame-windows"></a>[!INCLUDE[msCoName](../includes/msconame-md.md)] Windows의 내게 필요한 옵션 기능  
...
## <a name="adjusting-msconame-products-for-people-with-accessibility-needs"></a>장애가 있는 사용자의 요구에 맞게 [!INCLUDE[msCoName](../includes/msconame-md.md)] 제품 조정  
...
## <a name="msconame-documentation-in-alternative-formats"></a>다양한 형식의 [!INCLUDE[msCoName](../includes/msconame-md.md)] 설명서  
 장애가 있는 고객의 요구에 맞는 다양한 형식의 [!INCLUDE[msCoName](../includes/msconame-md.md)] 제품 설명서가 제공됩니다.  
  
### <a name="obtaining-documentation-for-ssnoversion"></a>[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 설명서 구하기  
