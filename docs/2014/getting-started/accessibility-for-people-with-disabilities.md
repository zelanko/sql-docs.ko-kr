...
## <a name="assistive-technology-products-for-windows"></a>Windows용 보조 기술 제품  
 ...
 [!INCLUDE[msCoName](../includes/msconame-md.md)] Windows 운영 체제에서 실행 되는 보조 기술 제품의 검색 가능 카탈로그를 제공 합니다 [Microsoft Accessibility 웹 사이트](http://go.microsoft.com/fwlink/?LinkID=67166)합니다.  
...
## <a name="obtaining-documentation-for-additional-includemsconameincludesmsconame-mdmd-products"></a>[!INCLUDE[msCoName](../includes/msconame-md.md)]의 추가 제품에 대한 설명서 구하기  
 에 대 한 설명서를 구할 수 있습니다 [!INCLUDE[msCoName](../includes/msconame-md.md)] 에서 제품을 [Microsoft Accessibility 웹 사이트](http://go.microsoft.com/fwlink/?LinkID=67164)합니다.  
...
### <a name="recording-for-the-blind--dyslexic-inc"></a>Recording for the Blind & Dyslexic, Inc.  
 ...
 미국 내에서 전화: (800) 221-4792  
  
 미국 및 캐나다에서 미국 전화: (609) 452-0606  
...
### <a name="customer-service"></a>고객 서비스  
 연결할 수는 [!INCLUDE[msCoName](../includes/msconame-md.md)] 전화 걸기 (800) 892-5234 오전 6 시 30 사이 Sales Information Center로 텍스트 전화를 걸어 및 오후 5 시 30 분 기술 지원 서비스에 문의할 수 있습니다.  
