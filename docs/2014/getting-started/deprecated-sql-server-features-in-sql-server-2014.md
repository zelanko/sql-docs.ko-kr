...
### <a name="slipstream-functionality"></a>통합 설치 기능  
 [제품 업데이트 기능은](/previous-versions/sql/sql-server-2012/hh231670(v=sql.110)?redirectedfrom=MSDN) PCU1에서 [!INCLUDE[ssKatmai](../includes/sskatmai-md.md)] 제공 되는 통합 설치 기능에 대 한 확장으로 SQL Server 2012에서 도입 되었습니다. SQL Server 2014에서 제품 업데이트 기능은 말합니다 SQL Server에 사용할 수 있는 권장 방법입니다. 따라서 원래 통합 설치 기능과 관련 된 명령줄 매개 변수,/*Pcusource* 및/*CUSource*는 더 이상 사용할 수 없습니다. 이러한 매개 변수는 계속 작동 하지만 향후 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 설치 프로그램 릴리스에서 제거 될 수 있습니다. 사용 하기에 권장 되는 매개 변수는/*UpdateSource* 입니다 .이 매개 변수는 원래 통합 설치 매개 변수,/*pcusource* 및/*CUSource*의 기능을 결합 합니다.  
  
 PCU1에서 [!INCLUDE[ssKatmai](../includes/sskatmai-md.md)] 제공 되는 통합 설치 기능에 대 한 자세한 내용은 [통합 설치 a SQL Server Update](https://go.microsoft.com/fwlink/?LinkId=219945) (https://go.microsoft.com/fwlink/?LinkId=219945)를 참조 하세요.  
