...
|리소스|사용자|  
|--------------|--------------|  
|[SQL Server Developer Center](https://msdn.microsoft.com/sqlserver/)|[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 데이터베이스, 보고 시스템 및 비즈니스 인텔리전스 솔루션을 구축하고 애플리케이션 및 웹 사이트에서 이 시스템을 사용하도록 하는 개발자|  
|[XML 개발자 센터](https://go.microsoft.com/fwlink/?LinkId=42458)|데이터 저장 및 조작에 XML을 사용하는 웹 사이트 및 애플리케이션의 웹 사이트 제작자 및 애플리케이션 개발자|  
