...
|기능 이름|Enterprise|비즈니스 인텔리전스|Standard|웹|Express with Advanced Services|Express with Tools|Express|  
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|Server Core 지원<sup>1</sup>|yes|yes|yes|yes|yes|yes|yes|  
|로그 전달|yes|yes|yes|yes||||  
|데이터베이스 미러링|yes|지원(Safety Full만)|지원(Safety Full만)|미러링 모니터만|미러링 모니터만|미러링 모니터만|미러링 모니터만|  
|백업 압축|yes|yes|yes|||||  
|데이터베이스 스냅샷|yes|||||||  
...
|빠른 복구|yes|||||||  
|미러된 백업|yes|||||||  
|Hot Add 메모리 및 CPU<sup>2</sup>|yes|||||||  
|데이터베이스 복구 관리자|yes|yes|yes|yes|yes|yes|yes|  
|암호화된 백업|yes|yes|yes|||||  
|스마트 백업|yes|yes|yes|예||||  
...
|관리|yes|||||||  
|파티션 테이블 병렬 처리|yes|||||||  
|여러 Filestream 컨테이너|yes|||||||  
|NUMA 인식 큰 페이지 메모리 및 버퍼 배열 할당|yes|||||||  
|버퍼 풀 확장 <sup>1</sup>|yes|yes|yes|||||  
|IO 리소스 관리|yes|||||||  
|메모리 내 OLTP <sup>1</sup>|yes|||||||  
|지연된 내구성|yes|yes|yes|yes|yes|yes|yes|  
...
|기능 이름|Enterprise|비즈니스 인텔리전스|Standard|웹|Express with Advanced Services|Express with Tools|Express|  
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|기본 감사|yes|yes|yes|yes|yes|yes|yes|  
|미세 감사|yes|||||||  
|투명한 데이터베이스 암호화|yes|||||||  
|확장 가능 키 관리|yes|||||||  
|사용자 정의 역할|yes|yes|yes|yes|yes|yes|yes|  
|포함된 데이터베이스|yes|yes|yes|yes|yes|yes|yes|  
|백업을 위한 암호화|yes|yes|yes|||||  
  
##  <a name="Replication"></a> 복제  
  
|기능 이름|Enterprise|비즈니스 인텔리전스|Standard|웹|Express with Advanced Services|Express with Tools|Express|  
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]변경 내용 추적|yes|yes|yes|yes|yes|yes|yes|  
|병합 복제|yes|yes|yes|예(구독자만)|예(구독자만)|예(구독자만)|예(구독자만)|  
|트랜잭션 복제|yes|yes|yes|예(구독자만)|예(구독자만)|예(구독자만)|예(구독자만)|  
|스냅샷 복제|yes|yes|yes|예(구독자만)|예(구독자만)|예(구독자만)|예(구독자만)|  
|다른 유형의 구독자|yes|yes|yes|||||  
|Oracle 게시|yes|||||||  
|피어 투 피어 트랜잭션 복제|yes|||||||  
...
|SQL 구성 관리자|yes|yes|yes|yes|yes|yes|yes|  
|SQL CMD(명령 프롬프트 도구)|yes|yes|yes|yes|yes|yes|yes|  
|[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]Management Studio|yes|yes|yes|yes|yes|yes||  
|Distributed Replay - 관리 도구|yes|yes|yes|yes|yes|yes||  
|Distributed Replay - 클라이언트|yes|예|yes|yes||||  
|Distributed Replay - 컨트롤러|예(Enterprise는 최대 16 클라이언트 지원, Developer는 1 클라이언트만 지원)|예|예(1 클라이언트만 지원)|예(1 클라이언트만 지원)||||  
|SQL 프로파일러|yes|yes|yes|아니요<sup>2</sup>|아니요<sup>2</sup>|아니요<sup>2</sup>|아니요<sup>2</sup>|  
|[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]에이전트|yes|yes|yes|yes||||  
|Microsoft System Center Operations Manager 관리 팩|yes|yes|yes|yes||||  
|DTA(데이터베이스 튜닝 관리자)|yes|yes|예<sup>3</sup>|예<sup>3</sup>||||  
|Azure VM [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 에 데이터베이스 배포 마법사|yes|yes|yes|yes|yes|yes|yes|  
|[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]Azure의 데이터 파일|yes|yes|yes|yes|yes|yes|yes|  
...
|기능 이름|Enterprise|비즈니스 인텔리전스|Standard|웹|Express with Advanced Services|Express with Tools|Express|  
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|사용자 인스턴스|||||yes|yes|yes|  
|LocalDB|||||yes|yes||  
|관리자 전용 연결|yes|yes|yes|yes|지원(추적 플래그 사용)|지원(추적 플래그 사용)|지원(추적 플래그 사용)|  
|PowerShell 스크립팅 지원|yes|yes|yes|yes|yes|yes|yes|  
|SysPrep 지원<sup>1</sup>|yes|yes|yes|yes|yes|yes|yes|  
|데이터 계층 응용 프로그램 구성 요소 작업 지원-추출, 배포, 업그레이드, 삭제|yes|yes|yes|yes|yes|yes|yes|  
|정책 자동화(일정 및 변경 내용 검사)|yes|yes|yes|yes||||  
|성능 데이터 수집기|yes|yes|yes|yes||||  
|다중 인스턴스 관리에서 관리되는 인스턴스로 등록 가능|yes|yes|yes|yes||||  
|표준 성능 보고서|yes|yes|yes|yes||||  
|계획 지침을 위한 계획 지침 및 계획 고정|yes|yes|yes|yes||||  
|인덱스 뷰의 직접 쿼리(NOEXPAND 힌트 사용)|yes|yes|yes|yes||||  
|인덱싱된 뷰의 자동 유지 관리|yes|yes|yes|yes||||  
...
|병렬 인덱스 작업|yes|||||||  
|쿼리 최적화 프로그램의 인덱싱된 뷰 자동 사용|yes|||||||  
|병렬 일관성 검사|yes|||||||  
|
  [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 유틸리티 제어 지점|yes|||||||  
|포함된 데이터베이스|yes|yes|yes|yes|yes|yes|yes|  
|버퍼 풀 확장<sup>2</sup>|yes|yes|yes|||||  
...
|기능 이름|Enterprise|비즈니스 인텔리전스|Standard|웹|Express with Advanced Services|Express with Tools|Express|  
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|[!INCLUDE[msCoName](../includes/msconame-md.md)]Visual Studio 통합|yes|yes|yes|yes|yes|yes|yes|  
|Intellisense([!INCLUDE[tsql](../includes/tsql-md.md)] 및 MDX)|yes|yes|yes|yes|yes|yes|yes|  
|[!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)]|yes|yes|yes|yes|yes|||  
|SQL 쿼리 편집 및 디자인 도구<sup>1</sup>|yes|yes|yes|||||  
|버전 제어 지원<sup>1</sup>|yes|yes|yes|||||  
|MDX 편집, 디버그 및 디자인 도구<sup>1</sup>|yes|yes|yes|||||  
...
|기능 이름|Enterprise|비즈니스 인텔리전스|Standard|웹|Express with Advanced Services|Express with Tools|Express|  
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|CLR(공용 언어 런타임) 통합|yes|yes|yes|yes|yes|yes|yes|  
|네이티브 XML 지원|yes|yes|yes|yes|yes|yes|yes|  
|XML 인덱싱|yes|yes|yes|yes|yes|yes|yes|  
|MERGE & UPSERT 기능|yes|yes|yes|yes|yes|yes|yes|  
|FILESTREAM 지원|yes|yes|yes|yes|yes|yes|yes|  
|FileTable|yes|yes|yes|yes|yes|yes|yes|  
|날짜 및 시간 데이터 형식|yes|yes|yes|yes|yes|yes|yes|  
|국제화 지원|yes|yes|yes|yes|yes|yes|yes|  
|전체 텍스트 및 의미 체계 검색|yes|yes|yes|yes|yes|||  
|쿼리에서 언어 지정|yes|yes|yes|yes|yes|||  
|Service Broker(메시징)|yes|yes|yes|아니요(클라이언트 전용)|아니요(클라이언트 전용)|아니요(클라이언트 전용)|아니요(클라이언트 전용)|  
|[!INCLUDE[tsql](../includes/tsql-md.md)]종점|yes|yes|yes|yes||||  
...
|-------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|
  [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 가져오기 및 내보내기 마법사|yes|yes|yes|yes|yes|yes|yes|  
|기본 제공 데이터 원본 커넥터|yes|yes|yes|yes|yes|yes|yes|  
|SSIS 디자이너 및 런타임|yes|yes|yes|||||  
|기본 변환|yes|yes|yes|||||  
|기본 데이터 프로파일링 도구|yes|yes|yes|||||  
|Attunity Oracle CDC Service|yes|||||||  
...
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|성능 우선 Oracle 대상|yes|||||||  
|성능 우선 Teradata 대상|yes|||||||  
|SAP BW 원본 및 대상|yes|||||||  
|데이터 마이닝 모델 학습 대상 어댑터|yes|||||||  
|차원 처리 대상 어댑터|yes|||||||  
|파티션 처리 대상 어댑터|yes|||||||  
|Attunity의 변경 데이터 캡처 구성 요소|yes|||||||  
|Attunity의 Connector for ODBC(Open Database Connectivity)|yes|||||||  
...
|기능|Enterprise|비즈니스 인텔리전스|Standard|웹|Express with Advanced Services|Express with Tools|Express|  
|-------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|[!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)]데이터|yes|yes||||||  
|[!INCLUDE[ssMDSmdm](../includes/ssmdsmdm-md.md)]웹 응용 프로그램|yes|yes||||||  
  
##  <a name="Data_warehouse"></a>데이터 웨어하우스  
  
|기능 이름|Enterprise|비즈니스 인텔리전스|Standard|웹|Express with Advanced Services|Express with Tools|Express|  
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|데이터베이스 없이 큐브 만들기|yes|yes|yes|||||  
|준비 및 데이터 웨어하우스 스키마 자동 생성|yes|yes|yes|||||  
|변경 데이터 캡처|yes|||||||  
|스타 조인 쿼리 최적화|yes|||||||  
|확장 가능한 읽기 전용 Analysis Services 구성|yes|||||||  
|분할된 테이블 및 인덱스의 병렬 쿼리 처리|yes|||||||  
|xVelocity 메모리 최적화 columnstore 인덱스|yes|||||||  
|글로벌 일괄 집계|yes|||||||  
...
|기능 이름|Enterprise|비즈니스 인텔리전스|Standard|웹|Express with Advanced Services|Express with Tools|Express|  
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|확장 가능한 공유 데이터베이스(연결/분리, 읽기 전용 데이터베이스)|yes|yes||||||  
|백업/복원, 데이터베이스 연결/분리|yes|yes|yes|||||  
|데이터베이스 동기화|yes|yes||||||  
|고가용성|yes|yes|yes|||||  
|프로그래밍 기능(AMO, ADOMD.Net, OLEDB, XML/A, ASSL)|yes|yes|yes|||||  
  
###  <a name="BISemModel_multi"></a>BI 의미 체계 모델 (다차원)  
  
|기능 이름|Enterprise|비즈니스 인텔리전스|Standard|웹|Express with Advanced Services|Express with Tools|Express|  
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|반가산적 측정값|yes|yes|아니요<sup>1</sup>|||||  
|계층 구조|yes|yes|yes|||||  
|KPI|yes|yes|yes|||||  
|큐브 뷰|yes|yes||||||  
|동작|yes|yes|yes|||||  
|계정 인텔리전스|yes|yes|yes|||||  
|시간 인텔리전스|yes|yes|yes|||||  
|사용자 지정 롤업|yes|yes|yes|||||  
|큐브 쓰기 저장(writeback)|yes|yes|yes|||||  
|차원 쓰기 저장(Writeback)|yes|yes||||||  
|셀 쓰기 저장(writeback)|yes|yes|yes|||||  
|드릴스루|yes|yes|yes|||||  
|고급 계층 유형(부모-자식, 비정형 계층 구조)|yes|yes|yes|||||  
|고급 차원(참조 차원, 다 대 다 차원|yes|yes|yes|||||  
|연결된 측정값 및 차원|yes|yes||||||  
|Translations|yes|yes|yes|||||  
|집계|yes|yes|yes|||||  
|여러 파티션|yes|yes|예, 최대 3|||||  
|자동 관리 캐싱|yes|yes||||||  
|사용자 지정 어셈블리(저장 프로시저)|yes|yes|yes|||||  
|MDX 쿼리 및 스크립트|yes|yes|yes|||||  
|DAX 쿼리|yes|yes||||||  
|역할 기반 보안 모델|yes|yes|yes|||||  
|차원 및 셀 수준 보안|yes|yes|yes|||||  
|확장 가능 문자열 스토리지|yes|yes|yes|||||  
|MOLAP, ROLAP, HOLAP 스토리지 모델|yes|yes|yes|||||  
|이진 및 압축 XML 전송|yes|yes|yes|||||  
|밀어넣기 모드 처리|yes|yes||||||  
|직접 쓰기 저장(writeback)|yes|yes||||||  
|측정값 식|yes|yes||||||  
...
|DAX 계산, DAX 쿼리, MDX 쿼리|yes|yes||||||  
|행 수준 보안|yes|yes||||||  
|파티션|yes|yes||||||  
|메모리 내 및 DirectQuery 스토리지 모드(테이블 형식만 해당)|yes|yes||||||  
  
###  <a name="PowerPivot"></a>SharePoint용 PowerPivot  
  
|기능 이름|Enterprise|비즈니스 인텔리전스|Standard|웹|Express with Advanced Services|Express with Tools|Express|  
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|공유 서비스 아키텍처를 기반으로 하는 SharePoint 팜 통합|yes|yes||||||  
|사용량 보고|yes|yes||||||  
|상태 모니터링 규칙|yes|yes||||||  
|PowerPivot 갤러리|yes|yes||||||  
|PowerPivot 데이터 새로 고침|yes|yes||||||  
|PowerPivot 데이터 피드|yes|yes||||||  
...
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|표준 알고리즘|yes|yes|yes|||||  
|데이터 마이닝 도구(마법사, 편집기, 쿼리 작성기)|yes|yes|yes|||||  
|교차 유효성 검사|yes|yes||||||  
|마이닝 구조 데이터의 필터링된 하위 집합에 대한 모델|yes|yes||||||  
|시계열: ARTXP 및 ARIMA 방식 간의 사용자 지정 혼합|yes|yes||||||  
|시계열: 새 데이터를 사용한 예측|yes|yes||||||  
|무제한 동시 DM 쿼리|yes|yes||||||  
|데이터 마이닝 알고리즘에 대 한 고급 구성 & 튜닝 옵션|yes|yes||||||  
|플러그 인 알고리즘 지원|yes|yes||||||  
|병렬 모델 처리|yes|yes||||||  
|시계열: 계열 간 예측|yes|yes||||||  
|연결 규칙에 대한 무제한 특성|yes|yes||||||  
|시퀀스 예측|yes|yes||||||  
|Naive Bayes, 신경망, 로지스틱 회귀를 위한 다중 예측 대상|yes|yes||||||  
...
|보고서 관리자|yes|yes|yes|yes|yes|||  
|역할 기반 보안|yes|yes|yes|yes|yes|||  
|Word 내보내기 및 서식 있는 텍스트 지원|yes|yes|yes|yes|yes|||  
|향상된 계기 및 차트|yes|yes|yes|yes|yes|||  
|Excel, PDF 및 이미지로 내보내기|yes|yes|yes|yes|yes|||  
|사용자 지정 인증|yes|yes|yes|yes|yes|||  
...
|SharePoint 통합|yes|yes|yes|||||  
|원격 및 비 SQL 데이터 원본 지원<sup>1</sup>|yes|yes|yes|||||  
|데이터 원본, 배달 및 렌더링, RDCE 확장성|yes|yes|yes|||||  
|데이터 기반 보고서 구독|yes|yes||||||  
|확장 배포(웹 팜)|yes|yes||||||  
|경고<sup>2</sup>|yes|yes||||||  
...
|Excel 및 Visio 2010용 데이터 마이닝 추가 기능|yes|yes|yes|||||  
...
|기능 이름|Enterprise|비즈니스 인텔리전스|Standard|웹|Express with Advanced Services|Express with Tools|Express|  
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|공간 인덱스|yes|yes|yes|yes|yes|yes|yes|  
|평면 및 측지 데이터 형식|yes|yes|yes|yes|yes|yes|yes|  
|고급 공간 라이브러리|yes|yes|yes|yes|yes|yes|yes|  
|산업 표준 공간 데이터 형식 가져오기/내보내기|yes|yes|yes|yes|yes|yes|yes|  
...
|데이터베이스 메일|yes|yes|yes|yes||||  
  
##  <a name="Other_Components"></a>기타 구성 요소  
  
|기능 이름|Enterprise|비즈니스 인텔리전스|Standard|웹|Express with Advanced Services|Express with Tools|Express|  
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|데이터베이스 엔진 서비스|yes|yes||||||  
