...
# <a name="features-supported-by-the-editions-of-sql-server-2014"></a>SQL Server 2014 버전에서 지원하는 기능
 ...
 > **참고:** [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]은 180 일 평가 기간에 대 한 평가 버전에서 사용할 수 있습니다. 자세한 내용은 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [평가판 소프트웨어 웹 사이트](https://go.microsoft.com/fwlink/?LinkId=190955)를 참조하세요.  
> 
...
|기능 이름|Enterprise|Business Intelligence|표준|Web|Express with Advanced Services|Express with Tools|Express|  
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
...
|스마트 백업|예|예|예|아니요||||  
 ...
 <sup>1</sup> Server Core에 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]를 설치 하는 방법에 대 한 자세한 내용은 [Server core에 SQL Server 2014 설치](../database-engine/install-windows/install-sql-server-on-server-core.md)를 참조 하세요.  
...
|Azure VM에 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 데이터베이스 배포 마법사|예|예|예|예|예|예|예|  
|Azure에서 데이터 파일 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]|예|예|예|예|예|예|예|  
  
 <sup>2</sup> [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 웹, [!INCLUDE[ssExpress](../includes/ssexpress-md.md)], [!INCLUDE[ssExpress](../includes/ssexpress-md.md)] with Tools 및 [!INCLUDE[ssExpress](../includes/ssexpress-md.md)] With Advanced Services는 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Standard 및 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Enterprise edition을 사용 하 여 프로 파일링 할 수 있습니다.  
...
|기능|Enterprise|Business Intelligence|표준|Web|Express with Advanced Services|Express with Tools|Express|  
|-------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
...
|[!INCLUDE[ssCrescent](../includes/sscrescent-md.md)] <sup>2</sup>|예|예||||||  
 ...
 <sup>1</sup> [!INCLUDE[ssRSCurrent](../includes/ssrscurrent-md.md)]에서 지원 되는 데이터 원본에 대 한 자세한 내용은 [SSRS &#40;&#41;Reporting Services에서 지 원하는 데이터 원본](../reporting-services/create-deploy-and-manage-mobile-and-paginated-reports.md)을 참조 하세요.  
  
 <sup>2</sup> SharePoint 모드의 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] 필요 합니다. 자세한 내용은 sharepoint [모드 설치 &#40;SharePoint 2010 및 sharepoint&#41;2013 Reporting Services](../reporting-services/install-windows/install-reporting-services-sharepoint-mode.md)를 참조 하세요.  
...
## <a name="see-also"></a>참고 항목  
 [SQL Server 2014 에 대 한 제품 사양](../../2014/getting-started/sql-server-2014-product-specifications.md)  
