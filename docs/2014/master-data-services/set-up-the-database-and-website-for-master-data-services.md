...
ms.locfileid: "48205033"
---
# <a name="set-up-the-database-and-website-for-master-data-services"></a>Master Data Services에 대한 데이터베이스 및 웹 사이트 설정
  사용 된 [!INCLUDE[ssMDScfgmgr](../includes/ssmdscfgmgr-md.md)] 데이터베이스 및 웹 사이트를 설정 하려면 [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] (MDS)  
...
3.  (선택 사항) Data Quality Services를 사용 하 여와 통합을 사용 하도록 설정 합니다 **웹 구성** 페이지에서 [!INCLUDE[ssMDScfgmgr](../includes/ssmdscfgmgr-md.md)]합니다.  
 ...
 사용할 수도 있습니다 [!INCLUDE[ssMDScfgmgr](../includes/ssmdscfgmgr-md.md)] 웹 응용 프로그램과 MDS 데이터베이스에 연결 된 서비스에 대 한 설정을 지정할 수 있습니다. 예를 들어 데이터를 로드하는 빈도나 유효성 검사 메일을 전송하는 빈도를 지정할 수 있습니다. 자세한 내용은 [시스템 설정&#40;Master Data Services&#41;](../../2014/master-data-services/system-settings-master-data-services.md)을 참조하세요.  
