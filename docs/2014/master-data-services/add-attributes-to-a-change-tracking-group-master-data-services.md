...
2.  
  **모델 탐색기** 페이지의 메뉴 모음에서 **관리** 를 가리키고 **엔터티**를 클릭합니다.  
...
6.  
  **엔터티 편집** 페이지에서  
    ...
    -   리프 멤버에 대 한 특성인 경우 **리프 특성** 창에서 특성을 선택 하 고 **리프 특성 편집**을 클릭 합니다.  
  
    -   통합 멤버에 대 한 특성인 경우 **통합 특성** 창에서 특성을 선택 하 고 **통합 특성 편집**을 클릭 합니다.  
  
    -   컬렉션에 대 한 특성인 경우 **컬렉션 특성** 창에서 특성을 선택 하 고 **컬렉션 특성 편집**을 클릭 합니다.  
  
7.  
  **변경 내용 추적 설정** 확인란을 선택합니다.  
  
8.  
  **변경 내용 추적 그룹** 상자에 그룹의 번호를 입력합니다.  
...
-   [특성 값 변경을 기반으로 하는 작업 시작 &#40;MDS(Master Data Services)&#41;](../../2014/master-data-services/initiate-actions-based-on-attribute-value-changes-master-data-services.md)  
