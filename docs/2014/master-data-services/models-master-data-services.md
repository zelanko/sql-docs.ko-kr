...
## <a name="how-models-relate-to-other-objects"></a>다른 개체와 모델의 관계  
 ...
 ![MDS(Master Data Services) 모델의 개체](../../2014/master-data-services/media/mds-conc-model-circles.gif "MDS(Master Data Services) 모델의 개체")  
...
## <a name="model-example"></a>모델 예  
 ...
 ![제품 모델 마스터 데이터 예제](../../2014/master-data-services/media/mds-conc-model.gif "제품 모델 마스터 데이터 예제")  
...
|태스크 설명|항목|  
|----------------------|-----------|  
|모델을 만들어 마스터 데이터를 구성합니다.|[모델을 만드는 &#40;Master Data Services&#41;](../../2014/master-data-services/create-a-model-master-data-services.md)|  
