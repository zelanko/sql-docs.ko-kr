...
## <a name="web-application"></a>웹 애플리케이션  
 웹 서버는 파일 시스템의 [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] **WebApplication** 폴더에서 이 웹 애플리케이션의 콘텐츠를 제공합니다. 이 위치는 설치 중에 지정 되며 기본적으로 *drive*: Files\Microsoft SQL Server\120\Master Data services\webapplication입니다 .입니다.  
