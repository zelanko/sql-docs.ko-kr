...
> [!NOTE]  
>  사용자가 모델 관리자인 경우 사용자 인터페이스의 모든 기능 영역에 모델이 표시됩니다. 그렇지 않은 경우에는 **탐색기** 기능 영역에만 모델이 표시됩니다. 자세한 내용은 [관리자&#40;Master Data Services&#41;](administrators-master-data-services.md)에 액세스하지 않고 그룹에서 사용자를 추가하고 제거할 수 있습니다.  
  
|사용 권한|Description|  
|----------------|-----------------|  
|**읽기 전용**|**탐색기**에서 모델이 표시 되지만 사용자가 멤버를 추가 하거나 제거할 수 없으며 특성 값, 계층 멤버 자격 또는 컬렉션 멤버 자격을 업데이트할 수 없습니다.|  
|**고침**|**탐색기**에 모델이 표시 되 고 사용자가 멤버를 추가 및 제거 하 고, 특성 값, 계층 멤버 자격 및 컬렉션 멤버 자격을 업데이트할 수 있습니다.|  
|**거부**|모델이 표시되지 않습니다.|  
...
## <a name="see-also"></a>참고 항목  
 ...
 [MDS(Master Data Services)&#41;&#40;컬렉션 권한](../../2014/master-data-services/collection-permissions-master-data-services.md)  
