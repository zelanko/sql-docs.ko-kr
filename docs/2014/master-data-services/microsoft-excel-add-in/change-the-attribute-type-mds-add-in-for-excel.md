...
1.  Excel에서 변경하려는 열(특성)이 포함된 엔터티를 로드합니다. 자세한 내용은 참조 [mds Excel로 데이터 로드](export-data-to-excel-from-master-data-services.md)합니다.  
...
-   "_old" 접미사를 사용해서 아무 값도 포함되지 않는 특성의 복사본을 생성합니다. 이 라고는 **사용 되지 않는** 특성입니다.  
...
-   해야 통합 관리 선택 항목에서 구독 뷰를 보기 행을 선택, 열어 연필 아이콘을 클릭 하 여 편집 열고 클릭는 **저장 디스크** 뷰 정의 새로 고치려면 아이콘입니다. 뷰 구문을 재생성하는 데 다른 변경 사항은 필요하지 않습니다.  
 ...
 **사용 되지 않는 특성 삭제**  
 ...
 특성을 삭제 하려면 참조 [특성 삭제 &#40;Master Data Services&#41;](../delete-an-attribute-master-data-services.md)  
