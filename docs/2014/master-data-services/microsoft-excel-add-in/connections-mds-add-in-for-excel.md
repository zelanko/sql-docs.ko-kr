...
# <a name="connections-mds-add-in-for-excel"></a>연결(Excel용 MDS 추가 기능)
 ...
 여러 사용자가 동시에 연결할 수 있습니다. 하지만 여러 사용자가 동일한 데이터를 게시하려고 시도하면 충돌이 발생할 수 있습니다. 자세한 내용은 참조 [데이터 게시 &#40;MDS 추가 기능 Excel 용&#41;](overview-importing-data-from-excel-mds-add-in-for-excel.md)합니다.  
...
## <a name="troubleshooting-connections"></a>연결 문제 해결  
 MDS에 연결할 때 모든 문제 참조 발생 하면 [ http://social.technet.microsoft.com/wiki/contents/articles/4520.aspx ](http://social.technet.microsoft.com/wiki/contents/articles/4520.aspx) 문제 해결 팁에 대 한 합니다.  
