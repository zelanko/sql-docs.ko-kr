...
## <a name="troubleshooting-connections"></a>연결 문제 해결  
 MDS에 연결 하는 경우 문제가 발생 하면 [https://social.technet.microsoft.com/wiki/contents/articles/4520.aspx](https://social.technet.microsoft.com/wiki/contents/articles/4520.aspx) 문제 해결 팁을 참조 하십시오.  
