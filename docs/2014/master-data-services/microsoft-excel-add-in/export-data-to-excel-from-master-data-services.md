---
title: MDS에서 Excel로 데이터를 로드 | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
ms.locfileid: "36091520"
---
# <a name="load-data-from-mds-into-excel"></a>MDS에서 Excel로 데이터 로드
  에 [!INCLUDE[ssMDSshort](../../includes/ssmdsshort-md.md)] [!INCLUDE[ssMDSXLS](../../includes/ssmdsxls-md.md)]를 사용 하려면 MDS 저장소에서 데이터를 로드 해야 합니다.  
  
 로드 하기 전에 데이터 집합을 필터링 하려는 경우 참조 [로드 하기 전에 데이터 필터링 &#40;MDS 추가 기능 Excel 용&#41; ](filter-data-before-exporting-mds-add-in-for-excel.md) 대신 합니다.  
