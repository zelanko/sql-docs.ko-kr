...
|Internet Explorer 보안 강화 구성|설치 하는 경우 [!INCLUDE[ssMDSshort](../../includes/ssmdsshort-md.md)] Windows Server 2008 또는 Windows Server 2008 R2 컴퓨터에서 Internet Explorer 보안 강화에 대 한 스크립팅을 허용 하도록 구성 해야 할 수 있습니다는 [!INCLUDE[ssMDSmdm](../../includes/ssmdsmdm-md.md)] 응용 프로그램 사이트입니다. 그렇게 하지 않으면 서버 컴퓨터에서 [!INCLUDE[ssMDSmdm](../../includes/ssmdsmdm-md.md)] 응용 프로그램 사이트로의 이동에 실패합니다.|[Internet Explorer: 보안 구성 강화](http://go.microsoft.com/fwlink/p/?LinkId=223869)|  
