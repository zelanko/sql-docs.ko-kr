...
||  
|-|  
|웹 서버<br /><br /> 일반 HTTP 기능<br /><br /> 정적 콘텐츠<br /><br /> 기본 문서<br /><br /> 디렉터리 검색<br /><br /> HTTP 오류<br /><br /> 응용 프로그램 개발<br /><br /> ASP.NET<br /><br /> .NET 확장성<br /><br /> ISAPI 확장<br /><br /> ISAPI 필터<br /><br /> 상태 및 진단<br /><br /> HTTP 로깅<br /><br /> 요청 모니터<br /><br /> 보안<br /><br /> Windows 인증<br /><br /> 요청 필터링<br /><br /> 성능<br /><br /> 정적 콘텐츠 압축<br /><br /> 관리 도구<br /><br /> IIS 관리 콘솔|  
