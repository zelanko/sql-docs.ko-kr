...
> [!NOTE]  
>  멤버에 대한 도메인 기반 특성 값이 없으면 멤버가 파생 계층에 포함되지 않습니다. 모든 멤버에 대한 도메인 기반 특성 값을 요구하려면 [특성 값 요구&#40;Master Data Services&#41;](require-attribute-values-master-data-services.md)를 참조하세요.  
...
5.  
  **파생 계층 추가** 페이지의 **파생 계층 이름** 상자에 계층의 이름을 입력합니다.  
...
7.  **파생 계층 편집** 페이지의 **사용 가능한 엔터티 및 계층** 창에서 엔터티나 계층을 클릭 하 고 **현재 수준** 창으로 끌어 놓습니다.  
