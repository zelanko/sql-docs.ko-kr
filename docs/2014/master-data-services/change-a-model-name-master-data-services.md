---
title: 모델 이름 (Master Data Services) 변경 | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
3.  에 **모델 유지 관리** 페이지의 표에서 변경할 이름 사용 하 여 모델에 대 한 행을 클릭 합니다.  
...
5.  에 **모델 이름** 상자 모델의 업데이트 된 이름을 입력 합니다.  
