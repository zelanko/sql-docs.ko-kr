...
7.  표 형태의 비즈니스 규칙 행에서 **알림** 필드를 두 번 클릭 합니다.  
...
-   다음과 같이 전자 메일 프로토콜을 구성합니다.  
    ...
    -   [전자 메일 알림 &#40;MDS(Master Data Services)&#41;구성](../../2014/master-data-services/configure-email-notifications-master-data-services.md)  
