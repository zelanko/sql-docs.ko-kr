...
|**SMTP 서버**|계정에서 전자 메일을 보내기 위해 사용하는 SMTP 서버의 이름 또는 IP 주소를 입력합니다. SMTP 서버 형식 예는 `smtp.` *>company_name<* 됩니다 `.com` . 이에 대한 도움을 얻으려면 메일 관리자에게 문의하십시오.|  
