...
ms.locfileid: "36090449"
---
# <a name="create-a-model-administrator-master-data-services"></a>모델 관리자 만들기(Master Data Services)
  [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)], 그룹 또는 사용자가을 하려는 경우 모델 관리자 만들기 **업데이트** 하나 이상의 모델에 있는 모든 개체에 대 한 사용 권한.  
...
## <a name="remarks"></a>Remarks  
 모델 개체 또는 계층 멤버에 다른 사용 권한을 할당하지 마십시오. 이렇게 하면 사용자가 더 이상 관리자 하 고 모든 기능 영역에서 모델 이외의 볼 수 없습니다 **탐색기**합니다.  
  
 한 가지 예외가: 사용자에 게 있으면 **업데이트** 계층에 할당 된 사용 권한을 **루트** 에 **계층 멤버** 탭에서 사용자는 여전히 모델로 간주 되는 관리자가입니다.  
