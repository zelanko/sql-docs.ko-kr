...
5.  업데이트 하려는 그룹의 유형에 따라 더하기 기호를 클릭 하 여 **리프 그룹**, **통합 그룹**또는 **컬렉션 그룹**을 확장 합니다.  
...
8.  **리프 그룹 이름** 상자, **통합 그룹 이름** 상자 또는 **컬렉션 그룹 이름** 상자에 특성 그룹의 업데이트 된 이름을 입력 합니다.  
...
## <a name="see-also"></a>참고 항목  
 ...
 [특성 그룹 &#40;MDS(Master Data Services)를 만듭니다&#41;](../../2014/master-data-services/create-an-attribute-group-master-data-services.md)   
