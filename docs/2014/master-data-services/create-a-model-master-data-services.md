...
3.  에 **모델 유지 관리** 페이지에서 클릭 **Add model**합니다.  
  
4.  에 **Model name** 상자 모델의 이름을 입력 합니다.  
  
5.  또는 **모델과 이름이 같은 엔터티 만들기** 를 선택하여 모델과 이름이 같은 엔터티를 만듭니다.  
  
6.  필요에 따라 선택 **모델과 이름이 같은 명시적 계층 만들기** 모델과 이름이 같은 명시적 계층을 만들려고 합니다. 이 옵션을 선택하면 컬렉션에 엔터티를 사용할 수 있습니다.  
  
7.  필요에 따라 선택할 **필수 계층 (모든 리프 멤버가 포함 되** 하 여 명시적 계층을 필수 계층으로 만듭니다.  
  
8.  **모델 저장**을 클릭합니다.  
  
## <a name="next-steps"></a>다음 단계  
  
-   [엔터티를 만듭니다. &#40;Master Data Services&#41;](create-an-entity-master-data-services.md)  
...
## <a name="see-also"></a>관련 항목  
 ...
 [모델 이름 변경 &#40;Master Data Services&#41;](../../2014/master-data-services/change-a-model-name-master-data-services.md)  
