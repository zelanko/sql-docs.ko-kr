...
8.  **이름** 상자에 특성의 업데이트된 이름을 입력합니다. 특성 이름으로 사용하지 않아야 하는 단어의 목록을 보려면 [예약어&#40;Master Data Services&#41;](reserved-words-master-data-services.md)를 참조하세요.  
  
9. **특성 저장**을 클릭합니다.  
  
## <a name="see-also"></a>관련 항목:  
 [텍스트 특성 만들기&#40;Master Data Services&#41;](create-a-text-attribute-master-data-services.md)   
 [특성 삭제&#40;Master Data Services&#41;](delete-an-attribute-master-data-services.md)   
