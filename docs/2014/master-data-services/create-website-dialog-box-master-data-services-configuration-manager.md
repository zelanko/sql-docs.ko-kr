...
## <a name="see-also"></a>관련 항목  
 [웹 구성 페이지 &#40;마스터 데이터 서비스 구성 관리자&#41;](../../2014/master-data-services/web-configuration-page-master-data-services-configuration-manager.md)   
 [마스터 데이터 서비스를 위한 데이터베이스 및 웹 사이트 설정](../../2014/master-data-services/set-up-the-database-and-website-for-master-data-services.md)   
 [마스터 데이터 서비스&#41;&#40;웹 응용 프로그램 요구 사항](install-windows/web-application-requirements-master-data-services.md)   
