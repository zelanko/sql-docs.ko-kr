...
# <a name="master-data-services"></a>Master  Data  Services
 ...
 적절한 교육을 통해 모든 비즈니스 사용자는 [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] 솔루션을 구현할 수 있어야 합니다. 또한 MDS를 사용하여 고객, 제품 또는 계정 목록 관리뿐 아니라 모든 도메인도 관리할 수 있습니다. MDS를 처음 설치하면 여기에는 도메인의 구조가 포함되지 않으므로, 도메인에 대한 모델을 만들어 필요한 도메인을 정의해야 합니다.  
