...
|사용 권한|Description|  
|----------------|-----------------|  
|**읽기 전용**|모든 컬렉션 및 컬렉션 멤버가 표시됩니다.<br /><br /> 사용자는 컬렉션을 추가하거나 제거할 수 없으며 컬렉션에 멤버를 추가하거나 컬렉션에서 멤버를 제거할 수도 없습니다.|  
|**Update**|모든 컬렉션이 표시되고 사용자는 컬렉션을 추가 및 제거할 수 있습니다.<br /><br /> 또한 사용자는 컬렉션에서 멤버를 추가하거나 제거할 수도 있습니다.|  
