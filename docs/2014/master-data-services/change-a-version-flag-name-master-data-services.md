...
### <a name="to-change-a-version-flag-name"></a>버전 플래그 이름을 변경하려면  
...
3.  
  **버전 플래그 관리** 페이지의 **모델** 필드에서 모델을 선택합니다.  
  
4.  표의 플래그 이름 행에서 **이름** 필드를 두 번 클릭합니다.  
...
## <a name="see-also"></a>참고 항목  
 ...
 [버전 &#40;MDS(Master Data Services)에 플래그를 할당&#41;](../../2014/master-data-services/assign-a-flag-to-a-version-master-data-services.md)  
