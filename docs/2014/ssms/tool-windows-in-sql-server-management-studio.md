...
|-|-|  
|**도구**|**용도**|  
|[개체 탐색기](object/object-explorer.md)|서버 탐색, 개체 작성 및 찾기, 데이터 원본 관리, 로그 보기 등을 수행합니다. 이 도구는 **보기** 메뉴에서 액세스합니다.|  
|[솔루션 탐색기](solution/solution-explorer.md)|스크립트와 관련 연결 정보를 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 스크립트라는 프로젝트에 저장 및 구성합니다. 여러 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 스크립트를 솔루션으로 저장하고 원본 제어를 사용하여 시간이 지남에 따라 증가하는 스크립트를 관리할 수 있습니다. 이 도구는 **보기** 메뉴에서 액세스합니다.|  
