...
11. 템플릿 스크립트 (7 단계의 스크립트)를 편집 하 고 네 곳에서 제품 이름 블레이드를, <strong> *<* </strong> `nvarchar(50)` <strong>이름 *>* </strong>product_name 매개 변수로 바꿉니다.  
...
4.  **템플릿 매개 변수 바꾸기** 대화 상자에서 값에 대해 `product_name` **freewheel** (기본 내용 덮어쓰기)을 입력 한 다음 **확인** 을 클릭 하 여 **템플릿 매개 변수 바꾸기** 대화 상자를 닫고 쿼리 편집기에서 스크립트를 수정 합니다.  
