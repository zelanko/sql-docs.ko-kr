...
## <a name="in-this-section"></a>섹션 내용  
 [지원되는 쿼리 형식&#40;Visual Database Tools&#41;](visual-database-tools.md)  
 ...
 [삭제 쿼리 만들기&#40;Visual Database Tools&#41;](delete-queries-visual-database-tools.md)  
 데이터를 삭제하는 쿼리를 만드는 방법에 대해 설명합니다.  
  
 [UNION 쿼리 만들기&#40;Visual Database Tools&#41;](create-union-queries-visual-database-tools.md)  
