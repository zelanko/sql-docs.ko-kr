 ...
 **파티션 열 목록**  
 분할 열 함수에 관련된 열의 목록을 쉼표로 구분하여 표시합니다. 
  **(데이터 공간 형식)** 필드에서 파일 그룹을 선택한 경우에는 사용할 수 없습니다.  
...
-   **예** [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 는 경고를 발생 하 고, 잘못 된 들어오는 행을 무시 하 고, 나머지 행을 삽입 하려고 합니다.  
  
-   **No** [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 는 오류 메시지를 발행 하 고 전체 대량 삽입 작업을 롤백합니다.  
