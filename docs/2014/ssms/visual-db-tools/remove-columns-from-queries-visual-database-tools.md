...
> [!NOTE]  
>  열을 쿼리에서 완전히 제거하지 않은 채 선택 쿼리의 출력에서만 제거할 수도 있습니다. 자세한 내용은 [쿼리 결과에서 열 제거&#40;Visual Database Tools&#41;](visual-database-tools.md)를 참조하세요.  
...
-   [SQL 창](sql-pane-visual-database-tools.md)에서 열에 대한 모든 참조를 제거합니다.  
