 ...
 **Path**  
 구성 요소의 전체 경로를 표시합니다. 제품과 함께 제공된 기본 구성 요소를 확인하려면 이 열을 정렬한 다음 [!INCLUDE[msCoName](../../includes/msconame-md.md)] Visual Studio 설치 경로에 저장되어 있는 구성 요소를 찾습니다.  
