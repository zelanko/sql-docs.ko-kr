 ...
 **다음을 사용 하 여 도움말 표시**  
 도움말 표시 방법을 지정합니다. 항목을 외부 부동 창에 표시하려면 드롭다운 목록에서 **외부 도움말 뷰어** 를 선택합니다. 도움말 항목을 **** 내에 도킹된 웹 브라우저 창에 표시하려면 통합 도움말 뷰어[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]를 선택합니다.  
