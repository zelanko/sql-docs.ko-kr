...
ms.locfileid: "68188508"
---
# <a name="options-environment-general-page"></a>옵션(환경-일반 페이지)
  
  **옵션** 대화 상자를 사용하여 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 시작 동작, 일반 창 관리 옵션 및 기타 일반 설정을 구성할 수 있습니다. 
  **도구** 메뉴에서 **옵션**을 클릭하고 **환경** 폴더를 확장한 다음 **일반**을 클릭합니다.  
  
## <a name="uielement-list"></a>UIElement 목록  
 **시작 시**  
 
  [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 를 시작할 때 수행할 동작을 선택합니다. 옵션은 다음과 같습니다.  
  
-   연결 개체 탐색기 메시지를 **열고** 개체 탐색기를 엽니다.  
  
-   연결에 대 한 **새 쿼리 창** 프롬프트를 연 다음 SQL 쿼리 편집기를 엽니다.  
  
-   연결에 대 한 **개체 탐색기 및 새 쿼리** 프롬프트를 연 다음 해당 연결을 사용 하 여 개체 탐색기와 SQL 쿼리 편집기를 모두 엽니다.  
  
-   **빈 환경 열기** 는 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] SQL 쿼리 편집기 창을 사용 하지 않고 서버에 개체 탐색기 연결 하지 않고 열립니다.  
