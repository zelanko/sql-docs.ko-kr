 ...
 **다음에 종속 된 개체**  _\<selected object>_  
 이 단추를 클릭하면 종속성이 추적되고 선택한 개체에 종속된 개체의 목록이 표시됩니다.  
  
 **개체** _\<selected object>_ **종속**      
 이 단추를 클릭하면 종속성이 추적되고 선택한 개체가 종속된 개체의 목록이 표시됩니다.  
  
 **종속성**  
 _\<selected object>_ **에 종속된 개체**를 클릭하면 선택한 개체에 종속된 개체의 계층 뷰가 표시됩니다. _\<selected object>_ **가 종속된** **개체**를 클릭하면 선택한 개체가 종속된 개체의 계층 뷰가 표시됩니다.  
