...
5.  **작업 속성-***job_name* 대화 상자의 **페이지 선택**에서 **단계**를 선택합니다. 이 페이지에서 사용할 수 있는 옵션에 대 한 자세한 내용은 참조 하십시오. [작업 속성: 새 작업 &#40;단계 페이지&#41;](../agent/job-properties-new-job-steps-page.md)합니다.  
