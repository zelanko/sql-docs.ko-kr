...
2.  
  **등록된 서버 내보내기** 대화 상자에서 다음과 같이 선택합니다.  
...
## <a name="see-also"></a>참고 항목  
 [등록 된 서버 정보 가져오기 &#40;SQL Server Management Studio&#41;](import-registered-server-information-sql-server-management-studio.md) [등록 된 새 서버 &#40;SQL Server Management Studio를 만듭니다&#41;](create-a-new-registered-server-sql-server-management-studio.md)  
