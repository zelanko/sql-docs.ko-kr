...
1.  등록된 서버에서 서버 또는 서버 그룹을 마우스 오른쪽 단추로 클릭하고 **편집**을 가리킨 다음 **서버 등록 속성**을 클릭합니다.  
  
2.  
  **등록된 서버 이름** 상자에서 서버 등록을 위해 새 이름을 입력한 다음 **저장**을 클릭합니다.  
  
#### <a name="to-change-the-name-of-a-server-group"></a>서버 그룹의 이름을 변경하려면  
  
1.  등록된 서버에서 서버 또는 서버 그룹을 마우스 오른쪽 단추로 클릭하고 **편집**을 가리킨 다음 **서버 그룹 속성**을 클릭합니다.  
  
2.  
  **서버 그룹 이름** 상자에서 서버 그룹의 새 이름을 입력한 다음 **저장**을 클릭합니다.  
  
## <a name="see-also"></a>참고 항목  
 [서버 등록 &#40;SQL Server Management Studio&#41;변경](change-a-server-s-registration-sql-server-management-studio.md)
