...
3.  
  **등록된 서버 가져오기** 대화 상자에서 가져오려는 등록된 서버 파일을 선택한 다음 **확인**을 클릭합니다.  
...
## <a name="see-also"></a>참고 항목  
 ...
 [SQL Server Management Studio &#40;등록 된 새 서버를 만듭니다&#41;](create-a-new-registered-server-sql-server-management-studio.md)  
