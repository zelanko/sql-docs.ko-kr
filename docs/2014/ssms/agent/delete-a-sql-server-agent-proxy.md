...
-   **다음을 사용 하 여 SQL Server 에이전트 프록시 계정을 삭제 합니다.**  
...
-   
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 에이전트 프록시 계정을 삭제할 때 프록시가 활성 작업 단계를 참조하지 않는지 확인합니다. 프록시를 참조 하는 작업 단계를 확인 하려면 프록시를 마우스 오른쪽 단추로 클릭 하 고 **속성**을 선택한 다음 _Proxy_name_**프록시 계정 속성** 대화 상자에서 **참조** 페이지를 선택 합니다. 프록시를 삭제한 경우 **개체 삭제** 대화 상자에서 해당 프록시를 사용하는 모든 작업 단계를 재할당할 수 있는 옵션이 제공됩니다.  
...
1.  
  **개체 탐색기**에서 더하기 기호를 클릭하여 삭제하려는 프록시 계정이 포함된 서버를 확장합니다.  
...
6.  
  **개체 삭제** 대화 상자에서 올바른 프록시 계정이 선택되었는지 확인합니다. 
  **재할당 대상** 확인란을 선택하여 이 프록시 계정을 참조하는 작업 단계를 다른 계정에 재할당합니다.  
...
3.  다음 예를 복사하여 쿼리 창에 붙여 넣고 **실행**을 클릭합니다.  
 ...
 자세한 내용은 [sp_delete_proxy &#40;transact-sql&#41;](/sql/relational-databases/system-stored-procedures/sp-delete-proxy-transact-sql)를 참조 하세요.  
