...
ms.locfileid: "85058748"
---
# <a name="sql-server-agent-fixed-database-roles"></a>SQL Server 에이전트 고정 데이터베이스 역할
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]에는 다음과 같은 **msdb** 데이터베이스 고정 데이터베이스 역할이 있으므로 관리자는 에이전트에 대 한 액세스를 보다 세밀 하 게 제어할 수 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 있습니다. 다음 역할은 액세스 권한이 적은 것부터 순서대로 나열되어 있습니다.  
...
|------------|---------------|----------------------------------------|------------------------------------------------|-------------|  
|생성/수정/삭제|예|예 <sup>1</sup>|예|예|  
|목록 보기(열거)|예 <sup>2</sup>|예|예|예 <sup>3</sup>|  
|설정/해제|예|예|예|적용할 수 없음|  
|속성 보기|예|예|예|예|  
|실행/중지/시작|적용할 수 없음|예|적용할 수 없음|해당 사항 없음|  
|작업 기록 보기|해당 없음|예|해당 없음|해당 없음|  
|작업 기록 삭제|해당 없음|아니요 <sup>4</sup>|해당 없음|해당 없음|  
|연결/분리|해당 없음|적용할 수 없음|예|적용할 수 없음|  
...
|목록 보기(열거)|예 <sup>2</sup>|예|예|예|예 <sup>3</sup>|  
|설정/해제|예|예(소유한 작업만 해당)|예|예(소유한 작업만 해당)|해당 없음|  
|속성 보기|예|예|예|예|예|  
|속성 편집|예|예(소유한 작업만 해당)|예|예(소유한 작업만 해당)|예|  
|실행/중지/시작|해당 없음|예(소유한 작업만 해당)|아니요|적용할 수 없음|해당 사항 없음|  
|작업 기록 보기|적용할 수 없음|예|예|해당 없음|해당 사항 없음|  
|작업 기록 삭제|해당 없음|아니요 <sup>4</sup>|아니요|해당 없음|해당 사항 없음|  
|연결/분리|해당 사항 없음|해당 사항 없음|해당 사항 없음|예(소유한 작업만 해당)|해당 없음|  
...
|목록 보기(열거)|예|예 <sup>1</sup>|예|예|예|예|  
|설정/해제|예|예|예 <sup>3</sup>|예|예 <sup>4</sup>|해당 없음|  
|속성 보기|예|예|예|예|예|예|  
|속성 편집|예|예|예(소유한 작업만 해당)|예|예(소유한 작업만 해당)|예|  
|실행/중지/시작|해당 사항 없음|적용할 수 없음|예|아니요|적용할 수 없음|해당 사항 없음|  
|작업 기록 보기|해당 사항 없음|해당 없음|예|예|해당 사항 없음|해당 없음|  
|작업 기록 삭제|해당 사항 없음|해당 없음|예|아니요|적용할 수 없음|해당 없음|  
|연결/분리|해당 사항 없음|해당 없음|해당 없음|해당 사항 없음|예(소유한 작업만 해당)|해당 없음|  
 ...
 <sup>4</sup> **SQLAgentOperatorRole** 멤버 **sp_update_schedule** 저장 프로시저를 사용 하 고 ** \@ 사용** 및 ** \@ schedule_id** (또는 ** \@ 이름**) 매개 변수의 값을 지정 하 여 자신이 소유 하지 않은 일정을 사용 하거나 사용 하지 않도록 설정할 수 있습니다. 이 역할의 멤버가 이 저장 프로시저에 다른 매개 변수를 지정하는 경우 프로시저 실행이 실패합니다.  
