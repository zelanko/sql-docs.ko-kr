...
|------------------|--------------------------------|---------------------------------|  
|ESCAPE 매크로가 사용됨|작업에 있는 모든 토큰이 성공적으로 바뀝니다.|경고로 활성화된 토큰이 바뀌지 않습니다. 이러한 토큰은 **-a-dbn**, **a**- **오류**, a- **심각도**, a- **MSG**및 **WMI ( *`property`* )** 입니다. 다른 정적 토큰은 성공적으로 바뀝니다.|  
