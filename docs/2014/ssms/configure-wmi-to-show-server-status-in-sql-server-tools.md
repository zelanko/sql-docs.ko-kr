...
2.  에 **열려** 상자에 입력 `wmimgmt.msc`, 클릭 하 고 **확인**합니다.  
...
7.  에 **에 대 한 권한을 * * *\<그룹 또는 사용자 >* 상자를 선택는 **허용** 열에 대 한는 **원격 으로부터 사용 가능** 하려는 원격으로 사용자에 대 한 사용 권한 서비스 상태를 검색 합니다.  
