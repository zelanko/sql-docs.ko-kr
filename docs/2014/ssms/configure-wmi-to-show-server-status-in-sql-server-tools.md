...
##  <a name="to-configure-wmi-permission"></a><a name="SSMSProcedure"></a>WMI 사용 권한을 구성 하려면  
  
1.  원격 서버의 **시작** 메뉴에서 **실행**을 클릭합니다.  
  
2.  **열기** 상자에를 입력 `wmimgmt.msc`한 다음 **확인**을 클릭 합니다.  
...
7.  _\<그룹 또는 사용자>_ **에 대 한 사용 권한**상자에서 서비스 상태를 원격으로 검색 하려는 사용자에 대해 **원격 사용** 권한에 대해 **허용** 열을 선택 합니다.  
