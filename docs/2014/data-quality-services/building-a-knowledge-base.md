...
|||  
|-|-|  
|새 기술 자료를 처음부터 만들거나, 기존 기술 자료나 .dqs 데이터 파일을 통해 만듭니다.|[기술 자료 만들기](../../2014/data-quality-services/create-a-knowledge-base.md)|  
|기존 기술 자료를 열어 기술 자료 검색, 도메인 관리를 수행하거나 일치 정책을 추가할 수 있습니다.|[기술 자료 열기](../../2014/data-quality-services/open-a-knowledge-base.md)|  
|기술 자료에 대해 열기, 잠금 해제, 관련 작업 취소, 이름 바꾸기, 삭제 또는 속성 보기 등의 관리 작업을 수행합니다.|[기술 자료 관리](../../2014/data-quality-services/manage-a-knowledge-base.md)|  
|기술 자료 검색, 도메인 값 관리, 일치 정책 추가, 정보/도메인/값 가져오기 또는 기본 기술 자료 DQS 데이터 사용을 통해 기술 자료에 정보를 추가합니다.|[기술 자료에 정보 추가](../../2014/data-quality-services/adding-knowledge-to-a-knowledge-base.md)|  
|데이터 샘플이 데이터 품질 기준에 맞는지 분석합니다.|[기술 자료 검색 수행](../../2014/data-quality-services/perform-knowledge-discovery.md)|  
