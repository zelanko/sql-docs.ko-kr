...
|정리 및 일치 활동을 위한 임계값 구성 방법을 설명합니다.|[Configure Threshold Values for Cleansing and Matching](../../2014/data-quality-services/configure-threshold-values-for-cleansing-and-matching.md)|  
