...
|Excel 파일에서 도메인으로 값 가져오기|[Import Values from an Excel File into a Domain](../../2014/data-quality-services/import-values-from-an-excel-file-into-a-domain.md)|  
