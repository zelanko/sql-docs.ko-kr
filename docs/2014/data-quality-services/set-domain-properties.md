...
##  <a name="set-domain-properties"></a><a name="Set"></a>도메인 속성 설정  
...
##  <a name="domain-properties"></a><a name="Properties"></a>도메인 속성  
  
###  <a name="domain-name-and-description"></a><a name="Name"></a>도메인 이름 및 설명  
 도메인이 생성된 후 도메인 이름 또는 설명을 변경할 수 있습니다. 도메인 이름은 기술 자료에 대해 고유해야 합니다. 설명은 최대 256자까지 지정할 수 있습니다.  
  
###  <a name="data-type"></a><a name="Type"></a> 데이터 형식  
...
###  <a name="use-leading-values"></a><a name="Leading"></a>선행 값 사용  
...
###  <a name="normalize-string"></a><a name="Normalize"></a>문자열 정규화  
...
###  <a name="format-output-to"></a><a name="Format"></a>출력 형식  
...
###  <a name="language"></a><a name="Language"></a>언어도  
 ...
 기본 언어는 영어입니다. **언어** 속성을 **기타** 로 설정하면 도메인에 대해 맞춤법 검사기가 해제됩니다.  
...
###  <a name="enable-speller"></a><a name="Speller"></a>맞춤법 검사기 사용  
