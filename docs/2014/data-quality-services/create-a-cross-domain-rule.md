...
# <a name="create-a-cross-domain-rule"></a>도메인 간 규칙 만들기
 ...
 도메인 간 규칙 *값이 다음 값과 같음* 에서 결정적 **Then**절은 도메인 간 규칙의 유효성에 대해 알려줄 뿐만 아니라 데이터 정리 작업 시 데이터를 수정합니다. 자세한 내용은 [선언적 도메인 간 규칙을 사용 하 여 데이터 수정](../../2014/data-quality-services/cleanse-data-in-a-composite-domain.md#CDCorrection) 에 [복합 도메인의 데이터 정리](../../2014/data-quality-services/cleanse-data-in-a-composite-domain.md)합니다.  
...
2.  도메인 간 규칙을 마치면 클릭 **완료** 에 설명 된 대로 도메인 관리 작업을 완료 하려면 [도메인 관리 작업 종료](../../2014/data-quality-services/end-the-domain-management-activity.md)합니다.  
