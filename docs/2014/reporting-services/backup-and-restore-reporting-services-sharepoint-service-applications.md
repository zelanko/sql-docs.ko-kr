...
-   확인 프로그램 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] 서비스 응용 프로그램 데이터베이스 액세스를 위해 UEA 또는 Windows 인증을 사용 하는 합니다. 둘 중 하나가 사용되고 있는 경우 복원 프로세스 후에 서비스 응용 프로그램을 올바르게 구성할 수 있도록 적절한 자격 증명이 무엇인지 확인합니다.  
