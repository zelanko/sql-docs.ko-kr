...
2.  속성 창을 엽니다.  
    ...
    > [!NOTE]  
    >  속성 창에 표시 되지 않으면, 클릭는 **보기** 탭을 선택한 다음는 **속성** 확인란을 선택 합니다.  
  
3.  에 **포인터** 속성 (...) 단추를 클릭 합니다. Pointer 컬렉션 편집기가 열립니다.  
  
4.  설정의 **SnappingEnabled** 속성을 `True`합니다.  
  
5.  설정의 **SnappingInterval** 을 맞춤 간격을 나타내는 값입니다. 포인터가 지정한 값의 가장 근사한 반올림 배수로 맞춰집니다.  
