...
-   로컬 보고서 서버를 탐색 하는 경우 다음과 유사한 오류가 표시 참조: [로컬 관리를 위한 기본 모드 보고서 서버 구성 &#40;SSRS&#41;](report-server/configure-a-native-mode-report-server-for-local-administration-ssrs.md)  
