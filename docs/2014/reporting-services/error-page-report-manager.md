...
-   찾아보기만 하려는 경우 로컬 보고서 서버에 다음과 유사한 오류를 참조 하세요.를 참조 하십시오. [로컬 관리에 대해 기본 모드 보고서 서버 구성&#40;SSRS&#41;](report-server/configure-a-native-mode-report-server-for-local-administration-ssrs.md)  
