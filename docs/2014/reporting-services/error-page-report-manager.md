...
-   로컬 보고서 서버로 이동하는 동안 다음과 유사한 오류가 나타나면 다음을 참조합니다. [로컬 관리에 대해 기본 모드 보고서 서버 구성&#40;SSRS&#41;](report-server/configure-a-native-mode-report-server-for-local-administration-ssrs.md)  
...
-   다음과 비슷한 오류 메시지가 나타나면 [Configure a Report Server for Remote Administration](report-server/configure-a-report-server-for-remote-administration.md)을 참조하십시오.  
     ...
     해당 컴퓨터를 찾을 수 없습니다. "RPC 서버를 사용할 수 없습니다. (HRESULT에서 예외가 발생했습니다: 0x800706BA)".  
