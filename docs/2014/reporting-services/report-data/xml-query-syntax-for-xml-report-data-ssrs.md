...
|XML 데이터 원본|쿼리 예|  
|---------------------|-------------------|  
|웹 서비스 XML 데이터( ListChildren 메서드 사용)|`<Query>`<br /><br /> `<Method Name="ListChildren" Namespace="https://schemas.microsoft.com/sqlserver/2005/06/30/reporting/reportingservices" />`<br /><br /> `</Query>`|  
