...
## <a name="controlling-access-data-source-properties"></a>데이터 원본 속성 액세스 제어  
 기본적으로 보고서 관리 권한을 가진 모든 사용자는 데이터 원본 유형, 연결 문자열, 자격 증명, 그리고 포함된 데이터 원본과 공유 데이터 원본 중 보고서가 연결 정보를 받을 대상을 결정하는 속성을 포함한 모든 속성을 설정할 수 있습니다. 태스크 및 사용 권한 제어 기본 모드 보고서 서버에서 데이터 원본 속성에 대 한 액세스에 대 한 자세한 내용은 참조 하십시오. [공유 데이터 원본 항목 보안](../security/secure-shared-data-source-items.md) 및 [보안 보고서 및 리소스](../security/secure-reports-and-resources.md)합니다.  
  
 SharePoint 라이브러리의 항목에 대한 속성을 보고 편집할 수 있는 권한은 사이트 관리자에 의해 결정됩니다. 사용 권한은 데이터 원본 연결 속성에 대 한 액세스 제어에 대 한 자세한 내용은 참조 하십시오. [SharePoint 사이트와 보고서 서버 항목에 대 한 목록 사용 권한 참조](../security/sharepoint-site-and-list-permission-reference-for-report-server-items.md)합니다.  
...
|보고서 프로젝트의 공유 데이터 원본(.rds) 파일을 추가하고 연결합니다.|보고서 디자이너|[만들기, 수정 및 공유 데이터 원본을 삭제 &#40;SSRS&#41;](create-modify-and-delete-shared-data-sources-ssrs.md)|  
...
|게시된 보고서의 데이터 원본 연결 속성을 편집합니다.|보고서 관리자|[보고서에 대 한 데이터 원본 속성 구성 &#40;보고서 관리자&#41;](configure-data-source-properties-for-a-report-report-manager.md)|  
...
|보고서에 기존 .odc 연결 정보를 사용합니다.|SharePoint 사이트|[Office 데이터 연결을 사용 하 여 &#40;.odc&#41; 보고서와 함께 &#40;Reporting Services sharepoint에서 통합 모드&#41;](use-an-office-data-connection-odc-with-reports.md)|  
...
## <a name="see-also"></a>관련 항목  
 [공유 데이터 원본에는 보고서 또는 모델 바인딩 &#40;SSRS&#41;](bind-a-report-or-model-to-a-shared-data-source-ssrs.md)   
