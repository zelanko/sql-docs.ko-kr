...
##  <a name="Models"></a>보고서 모델  
 Teradata 데이터 원본을 기반으로 하는 보고서 모델에서 데이터 집합을 만들려면 모델을의 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)] 모델 디자이너에서 디자인 하 고 보고서 서버에 게시 해야 합니다.  
...
##  <a name="Related"></a>관련 섹션  
 ...
 [Teradata에 대 한 .NET Framework Data Provider에서 SQL Server 2008 Reporting Services 사용](https://go.microsoft.com/fwlink/?LinkID=130848)  
