...
##  <a name="embedded-and-shared-data-sources"></a><a name="bkmk_data_sources"></a>포함 된 데이터 원본 및 공유 데이터 원본
...
##  <a name="built-in-data-extensions"></a><a name="bkmk_DataConnections"></a>기본 제공 데이터 확장 프로그램
...
##  <a name="create-a-data-source"></a><a name="bkmk_create_data_source"></a>데이터 원본 만들기
...
##  <a name="credentials-for-data-sources"></a><a name="bkmk_credentials"></a>데이터 원본에 대 한 자격 증명
