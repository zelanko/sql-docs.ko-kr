...
##  <a name="connection-string-examples"></a><a name="ConnectionString"></a>연결 문자열 예  
...
||||  
|보고서 모델|해당 없음|보고서 모델에 대한 연결 문자열은 필요하지 않습니다. 보고서 작성기에서 보고서 서버로 이동하고 보고서 모델인 .smdl 파일을 선택합니다.|  
...
##  <a name="creating-data-sources"></a><a name="Creating"></a>데이터 원본 만들기  
