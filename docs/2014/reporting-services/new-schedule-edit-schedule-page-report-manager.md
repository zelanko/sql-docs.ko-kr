...
5.  **보고서 실행 스냅샷에서 이 보고서 렌더링**옵션을 선택합니다. 그런 다음 **다음 일정을 사용하여 스냅샷을 보고서 기록에 추가**, **보고서별 일정**을 차례로 선택한 후 **구성**을 클릭합니다.  
...
5.  **다음 일정을 사용하여 스냅샷을 보고서 기록에 추가**, **보고서별 일정**을 차례로 선택한 후 **구성**을 클릭합니다.  
...
-   **일** 은 선택하는 요일의 특정 시간 및 분에 실행되는 일정을 정의합니다. \< *매일*>, 매일, \<모든 *숫자*> 일을 지정할 수 있습니다. 한 가지 방법을 선택하면 다른 날이 선택된 것처럼 보이더라도 다른 방법은 사용할 수 없게 됩니다.  
