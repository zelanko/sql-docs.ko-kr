...
|[웹 서비스 메서드 호출](calling-web-service-methods.md)|에서 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)]SOAP API를 사용 하 여 웹 서비스 메서드를 호출 하는 방법을 설명 합니다.|  
