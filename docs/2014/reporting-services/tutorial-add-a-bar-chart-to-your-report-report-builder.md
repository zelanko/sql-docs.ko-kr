...
##  <a name="3-modify-the-display-of-names-on-the-vertical-axis"></a><a name="AllValues"></a>3. 세로 축의 이름 표시 수정  
...
##  <a name="4-change-the-sort-order-for-names-on-the-vertical-axis"></a><a name="Sort"></a>4. 세로 축에서 이름에 대 한 정렬 순서 변경  
...
##  <a name="6-title-the-chart"></a><a name="ChartTitle"></a>6. 차트 제목  
...
##  <a name="8-add-a-filter-to-display-the-top-five-values"></a><a name="Filter"></a>8. 상위 5 개 값을 표시 하는 필터 추가  
...
2.  **보고서 작성기** 단추에서 다른 **이름으로 저장**을 클릭 합니다.  
