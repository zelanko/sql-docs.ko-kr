 ...
 **Getting Started** 대화 상자, 포함된 된 데이터 집합 만들기, 공유 데이터 원본을 선택 및 차트 마법사를 사용 하 여 가로 막대형 차트를 만듭니다.  
...
1.  **시작**을 클릭하고 **프로그램**, **Microsoft SQL Server 2012 보고서 작성기**를 차례로 가리킨 다음 **보고서 작성기**를 클릭합니다.  
    ...
    > [!NOTE]  
    >  경우는 **Getting Started** 대화 상자 않습니다 하지 표시, 보고서 작성기 단추를 클릭 하 고 클릭 **새로 만들기**합니다.  
...
5.  세로 마우스 오른쪽 단추로 클릭 **축 제목** 선택을 취소 합니다 **축 제목 표시** 확인란 합니다.  
...
8.  다시 합니다 **범주 그룹 속성** 페이지를 **순서** 드롭 다운 목록에서 **내림차순**합니다. 그러면 이름이 내림차순으로 나타나도록 역방향 사전순이 선택됩니다.  
  
9. [!INCLUDE[clickOK](../includes/clickok-md.md)]  
  
10. **실행** 을 클릭하여 보고서를 미리 봅니다.  
  
 사용 하 여 가로 축의 이름은 역순으로 정렬 됩니다 **Alerca** 맨 위에 있는 및 **Zeng** 맨 아래에 있습니다.  
...
2.  선택 단어 **차트 제목** 입력 한 후 다음 텍스트를 확인 하 고 차트의 맨 위에 있는: **Sales for 2008 and 2009**합니다.  
...
2.  차트 아래쪽의 가로 축을 클릭하여 선택합니다.  
     ...
     리본에서에 **홈** 탭의 **수** 그룹에서 클릭를 **통화** 단추. 가로 축 레이블이 통화로 변경됩니다.  
  
3.  (선택 사항) 십진수를 제거합니다. **통화** 단추 주위에 있는 **소수 자릿수 줄이기** 단추를 두 번 클릭합니다.  
  
4.  가로 축을 마우스 오른쪽 단추로 클릭한 다음 **가로 축 속성**을 클릭합니다.  
  
5.  에 **번호** 탭을 선택 **천 단위로 값 표시 합니다.**  
  
6.  [!INCLUDE[clickOK](../includes/clickok-md.md)]  
  
7.  마우스 오른쪽 단추로 클릭 **축 제목** 누릅니다 **축 제목 속성**합니다.  
  
8.  에 **제목 텍스트** 상자에 입력 **Sales in thousands** 클릭 **확인**합니다.  
...
2.  형식 **Sales Bar Chart**에 입력 한 다음 입력 **Top Five Sellers for 2009**이므로 다음과 같이 표시 됩니다.  
...
4.  선택 **Top Five Sellers for 2009**, 및는 **글꼴** 섹션에서 합니다 **홈** 탭, 글꼴 크기를 설정 합니다 **10**합니다.  
