...
# <a name="dataset-properties-dialog-box-query"></a>데이터 세트 속성 대화 상자, 쿼리
  데이터 **집합 속성** 대화 상자에서 **쿼리** 를 선택 하 여 데이터 원본을 선택 하 고 쿼리를 만들 수 있습니다.  
  
 **데이터 세트 속성** 대화 상자에는 다음과 같은 항목이 있습니다.  
  
-   [데이터 세트 속성 대화 상자, 매개 변수](report-data/dataset-properties-dialog-box-parameters.md)  
  
-   [데이터 세트 속성 대화 상자, 필드](../../2014/reporting-services/dataset-properties-dialog-box-fields.md)  
  
-   [데이터 세트 속성 대화 상자, 옵션](../../2014/reporting-services/dataset-properties-dialog-box-options.md)  
  
-   [데이터 세트 속성 대화 상자, 필터](report-data/dataset-properties-dialog-box-filters.md)  
