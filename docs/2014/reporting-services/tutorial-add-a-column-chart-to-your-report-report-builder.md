 ...
 **시작** 차트 마법사를 포함된 된 데이터 집합을 만드는 공유 데이터 원본을 선택 하 고 세로 막대형 차트 만들기 대화 상자를 사용 합니다.  
...
2.  가로 축 제목을 마우스 오른쪽 단추로 누른 **축 제목 표시** 제목을 제거 하려면. 가로 축에는 날짜가 표시되므로 제목이 필요하지 않습니다.  
  
3.  가로 축을 마우스 오른쪽 단추로 누른 **가로 축 속성**합니다.  
  
4.  에 **축 옵션** 페이지 **축 범위 및 간격**, 형식 **3** 에 대 한 **간격**합니다. 차트에 3일 단위로 날짜가 표시됩니다.  
  
5.  클릭 **레이블을**합니다.  
  
6.  **축 레이블 자동 맞춤 옵션 변경**선택, **자동 맞춤 사용 안 함**합니다.  
...
2.  차트에 범례를 마우스 오른쪽 단추로 누른 **범례 속성**합니다.  
  
3.  에 대 한 **레이아웃 및 위치**을 다른 위치를 선택 합니다. 예를 들어 아래쪽 가운데 옵션으로 위치를 설정합니다.  
  
     범례가 차트의 위쪽이나 아래쪽에 배치될 경우 범례 레이아웃은 세로에서 가로로 변경됩니다. **레이아웃** 드롭다운 목록에서 다른 레이아웃을 선택할 수 있습니다.  
  
4.  [!INCLUDE[clickOK](../includes/clickok-md.md)]  
  
5.  (옵션) 이 자습서에는 범주가 하나만 있기 때문에 범례가 필요하지 않습니다. 범례를 제거 하려면 범례를 마우스 오른쪽 단추로 클릭 하 고 클릭 **범례 삭제**합니다.  
...
2.  단어 **차트 제목을** 입력 한 후 다음 텍스트와 차트의 위쪽에: **Store Sales Order Totals**합니다.  
...
3.  리본 메뉴에 **홈** 탭에 **번호** 그룹을 클릭 합니다는 **통화** 단추입니다. 축 레이블이 변경되어 통화 형식이 표시됩니다.  
  
4.  리본 메뉴에 **홈** 탭에 **번호** 그룹을 클릭 합니다는 **소수 자릿수 줄이기** 근접 한 달러로 반올림 된 수를 표시 하려면 단추 두 번입니다.  
  
5.  세로 축을 마우스 오른쪽 단추로 클릭 하 고 클릭 **세로 축 속성**합니다.  
  
6.  클릭 **번호**합니다. **통화** 에서 이미 선택 되어는 **범주** 상자 및 **소수 자릿수** 이미 **0** (영)입니다.  
  
7.  에 **에 값 표시** 상자를 클릭 **수천**합니다.  
  
8.  [!INCLUDE[clickOK](../includes/clickok-md.md)]  
  
9. 차트의 왼쪽을 따라 세로 축 제목을 마우스 오른쪽 단추로 클릭 하 고 클릭 **축 제목 속성**합니다.  
  
10. 에 있는 텍스트 대체는 **제목 텍스트** 필드는 텍스트: **Sales Total (in Thousands)** 합니다. 제목의 형식을 지정하는 방법과 관련된 다양한 옵션을 지정할 수도 있습니다.  
...
3.  마우스 오른쪽 단추로 클릭는 **[sum (sales)]** 에 있는 필드는 **값** 영역과 클릭 **계산 된 계열 추가**합니다.  
...
3.  형식 **Sales Chart**를 enter 키를 입력 하 고 다음 **January to 2009년 12월**이므로 다음과 같습니다.  
  
     **Sales Chart**  
  
     **January to 2009년 12월**  
  
4.  선택 **Sales Chart**를 클릭 하 고는 **b o l d** 단추는 **글꼴** 섹션에서 **홈** 리본 메뉴의 탭 합니다.  
  
5.  선택 **January to 2009년 12월**, 및는 **글꼴** 섹션에서 **홈** 탭, 글꼴 크기를 설정 **10**합니다.  
  
6.  (선택 사항) 해야 할 수는 **제목** 입력란 아래쪽 가장자리의 가운데를 클릭할 때 양방향 화살표를 당겨 두 줄의 텍스트를 포함 하도록 크게 합니다.  
