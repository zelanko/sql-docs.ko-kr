...
##  <a name="to-set-data-refresh-options"></a><a name="bkmk_set_data_refresh"></a>데이터 새로 고침 옵션을 설정 하려면  
...
##  <a name="to-set-report-caching-options"></a><a name="bkmk_set_report_caching"></a>보고서 캐싱 옵션을 설정 하려면  
...
##  <a name="to-set-processing-time-out-values"></a><a name="bkmk_set_processing"></a>처리 제한 시간 값을 설정 하려면  
...
##  <a name="to-set-report-history-options-and-limits"></a><a name="bkmk_set_report_history"></a>보고서 기록 옵션 및 제한을 설정 하려면  
...
##  <a name="set-database-timeout"></a><a name="bkmk_set_database_timeout"></a>데이터베이스 제한 시간 설정  
