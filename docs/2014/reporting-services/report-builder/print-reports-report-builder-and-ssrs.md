...
> [!NOTE]  
>  브라우저의 인쇄 명령을 사용할 경우 HTML 보고서 인쇄물에는 첫 번째 페이지의 내용만 포함됩니다. [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 클라이언트 인쇄 기능을 사용하여 HTML 보고서를 인쇄하면 보다 나은 결과를 얻을 수 있습니다. 자세한 내용은 [인쇄 컨트롤을 사용하여 브라우저에서 보고서 인쇄&#40;보고서 작성기 및 SSRS&#41;](print-reports-from-a-browser-with-the-print-control-report-builder-and-ssrs.md)를 참조하세요.  
