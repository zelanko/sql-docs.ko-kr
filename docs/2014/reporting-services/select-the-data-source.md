 ...
 **Type**  
 사용 중인 데이터 원본의 유형을 선택 합니다. 예를 들어 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 데이터베이스를 사용 하는 경우를 선택 [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]합니다.  
