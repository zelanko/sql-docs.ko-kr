...
2.  보고서에 다른 그룹을 더 추가합니다.  
    ...
    1.  행 그룹 창에서 그룹을 마우스 오른쪽 단추로 클릭하고 **그룹 추가**를 클릭한 다음 추가할 그룹 유형을 선택합니다.  
        ...
        > [!NOTE]  
        >  데이터 영역에 그룹을 추가하는 데는 여러 가지 방법이 있습니다. 자세한 내용은 [데이터 영역에서 그룹 추가 또는 삭제&#40;보고서 작성기 및 SSRS&#41;](add-or-delete-a-group-in-a-data-region-report-builder-and-ssrs.md)를 참조하세요.  
