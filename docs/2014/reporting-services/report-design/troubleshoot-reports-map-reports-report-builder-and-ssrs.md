...
### <a name="i-renamed-a-data-source-or-dataset-to-a-friendly-name-and-now-no-data-appears-in-my-map"></a>데이터 원본이나 데이터 세트의 이름을 친숙한 이름으로 바꾼 후 지도에 데이터가 나타나지 않습니다.  
