...
##  <a name="DefiningMinMax"></a>눈금에 대 한 최소값, 최대값 및 간격 정의  
...
2.  Interval 값을 지정 하지 않으면 기본값은 Auto입니다. 즉, 응용 프로그램은 첫 번째 단계에서 지정한 최소값과 최대값을 기반으로 간격의 등거리 수를 계산 합니다. 간격에 대한 값을 지정하면 계기는 최대값과 최소값 사이의 차이를 계산한 다음 이 수를 간격 속성에 지정한 값으로 나눕니다.  
...
##  <a name="ReducingCollisions"></a>승수를 사용 하 여 레이블 충돌 감소  
...
## <a name="see-also"></a>참고 항목  
 [계기 &#40;보고서 작성기 및&#41;SSRS에서 범위 서식 지정](formatting-ranges-on-a-gauge-report-builder-and-ssrs.md)   
