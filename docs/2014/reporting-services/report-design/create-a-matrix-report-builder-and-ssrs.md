...
>  이 마법사는 [!INCLUDE[ssRBDenali](../../includes/ssrbdenali-md.md)]에서만 사용할 수 있습니다.
 ...
 ![확장 그룹이 있는 렌더링된 행렬의 미리 보기](../media/rs-basicmatrixpreview.gif "확장 그룹이 있는 렌더링된 행렬 미리 보기")
...
## <a name="see-also"></a>참고 항목
 집계 함수는 [보고서 작성기 및 ssrs &#40;](expression-examples-report-builder-and-ssrs.md) [&#40;보고서 작성기 및 Ssrs&#41;식 예제를 참조](report-builder-functions-aggregate-functions-reference.md)&#41;
