---
title: 지도 범례를 변경, 색 눈금 및 관련 규칙 (보고서 작성기 및 SSRS) | Microsoft Docs
ms.custom: ''
ms.date: 06/14/2017
...
1.  디자인 뷰에서 범례를 마우스 오른쪽 단추로 클릭 하 고 엽니다는  _\<보고서 항목->_**속성** 페이지입니다.  
...
2.  클릭 하는 데이터가 있는 계층을 마우스 오른쪽 단추로 클릭  _\<맵 요소 유형\>_**색 규칙**합니다.  
...
2.  하 고 클릭 하는 데이터가 있는 계층을 마우스 오른쪽 단추로 클릭  _\<맵 요소 유형\>_**색 규칙**합니다.  
...
3.  선택 합니다 **사용 하 여 데이터 시각화** \<규칙 유형을\> 옵션입니다. 배포 옵션을 사용하려면 계층과 연결된 분석 데이터에 따라 **분포** 페이지에서 범위를 만들어야 합니다.  
...
2.  하 고 클릭 하는 데이터가 있는 계층을 마우스 오른쪽 단추로 클릭  _\<맵 요소 유형\>_**규칙**합니다.  
