...
-   **지도 범례** 지도 계층의 지도 요소 표시를 변경 하는 분석 데이터를 해석 하는 데 도움이 되는 지침을 표시 합니다. 하나의 지도에 여러 개의 범례가 있을 수 있으므로 각 지도 계층에서 사용할 범례를 지정해야 합니다. 범례에는 둘 이상의 지도 계층에 대한 지침이 제공될 수 있습니다.  
