...
2.  **계열 데이터** 를 클릭하고 **도구 설명** 속성에서 문자열이나 식을 입력합니다. 차트 관련 키워드를 사용하여 차트의 다른 요소를 나타낼 수 있습니다. 자세한 내용은 참조 [차트의 데이터 요소에 서식 &#40;보고서 작성기 및 SSRS&#41;](formatting-data-points-on-a-chart-report-builder-and-ssrs.md)합니다.  
