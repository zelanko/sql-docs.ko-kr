...
-   **항목에 대한 전체 경로.**  
    ...
    -   **보고서 서버:** 경로에서 시작 **/**, 홈 폴더입니다. 예를 들면 /Reports/AllSubreports/Subreport1과 같은 형태입니다.  
  
    -   **SharePoint 사이트:** 항목의 전체 URL 및 파일 확장명 .rdl과 함께 보고서 이름을 식에 지정해야 합니다. `="http://server/site/library/folder/Report1.rdl"`) 을 입력합니다.  
