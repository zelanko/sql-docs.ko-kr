...
# <a name="embed-an-image-in-a-report-report-builder-and-ssrs"></a>보고서에 이미지 포함(보고서 작성기 및 SSRS)
 ...
 디자인 화면에 이미지를 추가하기 전에 보고서 정의에 이미지를 포함할 수 있습니다. 자세한 내용은 [배경 이미지 추가&#40;보고서 작성기 및 SSRS&#41;](add-a-background-image-report-builder-and-ssrs.md)를 참조하세요.  
