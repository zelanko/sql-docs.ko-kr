...
2.  **축 옵션**설정, `Interval` 를 **1**합니다. 모든 범주 그룹 레이블이 표시됩니다. x축에 다른 모든 범주 그룹 레이블을 표시하려면 **2**를 입력합니다.  
...
2.  **축 옵션**설정, `Interval` 를 **자동**합니다. 차트에 축을 따라 배치할 수 있는 최적의 범주 레이블 수가 표시됩니다.  
