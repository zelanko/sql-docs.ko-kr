...
2.  **축 옵션**에서 자동으로 `Interval` 설정 **Auto**합니다. 차트에 축을 따라 맞출 수 있는 최적의 범주 레이블 수가 표시 됩니다.  
...
## <a name="see-also"></a>참고 항목  
 ...
 [로그 눈금 &#40;보고서 작성기 및 SSRS를 지정&#41;](specify-a-logarithmic-scale-report-builder-and-ssrs.md)   
