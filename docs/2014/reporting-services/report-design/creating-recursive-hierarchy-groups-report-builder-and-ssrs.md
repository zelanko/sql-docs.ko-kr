...
### <a name="aggregate-functions-that-support-recursion"></a>재귀를 지원하는 집계 함수  
 매개 변수 *Recursive* 를 허용하는 Reporting Services 집계 함수를 사용하여 재귀 계층 구조의 요약 데이터를 계산할 수 있습니다. 다음 함수 `Recursive` 매개 변수로: [합계](report-builder-functions-sum-function.md), [Avg](report-builder-functions-avg-function.md), [개수](report-builder-functions-count-function.md)를 [CountDistinct](report-builder-functions-countdistinct-function.md)를 [CountRows](report-builder-functions-countrows-function.md)를 [최대](report-builder-functions-max-function.md), [Min](report-builder-functions-min-function.md), [StDev](report-builder-functions-stdev-function.md), [StDevP](report-builder-functions-stdevp-function.md)합니다 [합계](report-builder-functions-sum-function.md), [Var](report-builder-functions-var-function.md), 및 [VarP](report-builder-functions-varp-function.md) . 자세한 내용은 [집계 함수 참조&#40;보고서 작성기 및 SSRS&#41;](report-builder-functions-aggregate-functions-reference.md)를 참조하세요.  
