...
# <a name="creating-recursive-hierarchy-groups-report-builder-and-ssrs"></a>재귀 계층 구조 그룹 생성(보고서 작성기 및 SSRS)
  부모와 자식 간의 관계가 데이터 집합의 필드로 표현 되는 재귀 데이터를 표시 하려면 자식 필드를 기반으로 데이터 영역 그룹 식을 설정 하 고 부모 필드를 기반으로 부모 속성을 설정 하면 됩니다.  
