...
|[Count](report-builder-functions-count-function.md)|식으로 지정되어 정해진 범위의 컨텍스트에서 계산되는 Null이 아닌 값의 개수를 반환합니다.|  
...
##  <a name="restrictions-on-built-in-fields-collections-and-aggregate-functions"></a><a name="Restrictions"></a>기본 제공 필드, 컬렉션 및 집계 함수에 대 한 제한 사항  
 다음 표에는 전역 기본 제공 컬렉션에 대한 참조가 포함된 식을 추가할 수 있는 보고서 위치에서의 제한 사항이 요약되어 있습니다.  
  
|보고서의 위치|필드|매개 변수|ReportItems|PageNumber<br /><br /> TotalPages|DataSource<br /><br /> 데이터 세트|변수|RenderFormat|  
|------------------------|------------|----------------|-----------------|-------------------------------|----------------------------|---------------|------------------|  
|페이지 머리글<br /><br /> 페이지 바닥글|예|yes|최대 하나<br /><br /> 참고 1|예|yes|yes|yes|  
|본문|예<br /><br /> 참고 2|예|현재 범위 또는 포함하는 범위의 항목만<br /><br /> 참고 3|예|예|yes|yes|  
|보고서 매개 변수|아니요|목록 앞부분의 매개 변수만<br /><br /> 참고 4|아니요|예|예|예|예|  
|필드|예|yes|아니요|예|예|예|예|  
|쿼리 매개 변수|예|예|아니요|예|예|예|예|  
|그룹 식|예|yes|아니요|예|예|아니요|예|  
|정렬 식|예|yes|아니요|예|예|yes<br /><br /> 참고 5|아니요|  
|필터 식|예|yes|아니요|예|예|yes<br /><br /> 참고 6|아니요|  
|코드|예|예<br /><br /> 참고 7|아니요|예|예|예|예|  
|보고서 언어|예|예|아니요|예|예|예|예|  
|변수|예|yes|아니요|예|예|현재 범위 또는 포함하는 범위|아니요|  
|집계|예|yes|페이지 머리글/페이지 바닥글에서만|보고서 항목 집계에서만|예|아니요|예|  
|조회 함수|예|yes|yes|예|예|아니요|예|  
...
|-------------|------------------|---------------|--------------------|--------------|-------------------------------------|---------------------------|----------------------|------------------------|  
|Running Value|아니요|아니요|예|예|예|예|yes|예|  
|처음<br /><br /> 마지막|아니요|아니요|예|예|예|예|아니요|예|  
|Previous|예|예|yes|예|yes|예|yes|예|  
|Sum 및 기타 미리 정렬 함수|예|아니요|예|예|예|예|yes|예|  
|ReportItem 집계|예|아니요|예|예|예|예|예|예|  
|조회 함수|예|예<br /><br /> 참고 1|yes<br /><br /> 참고 1|yes<br /><br /> 참고 1|yes<br /><br /> 참고 1|yes<br /><br /> 참고 1|아니요|아니요|  
|Aggregate 함수|예|아니요|예|예|예|예|예|예|  
...
|**기능**|**설명**|  
|------------------|---------------------|  
|[RowNumber](report-builder-functions-rownumber-function.md)|지정한 범위에서 행 개수의 실행 개수를 반환합니다. `RowNumber`는 0이 아닌 1부터 계산을 다시 시작합니다.|  
...
##  <a name="looking-up-values-from-another-dataset"></a><a name="LookupFunctions"></a>다른 데이터 집합에서 값 조회  
...
## <a name="see-also"></a>참고 항목  
 [보고서 &#40;보고서 작성기 및 SSRS에서 사용 하는 식&#41;](expression-uses-in-reports-report-builder-and-ssrs.md)   
