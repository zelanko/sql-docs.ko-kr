...
# <a name="publish-and-republish-report-parts-report-builder-and-ssrs"></a>보고서 파트 게시 및 다시 게시(보고서 작성기 및 SSRS)
 ...
 보고서 파트가 사용하는 데이터 집합을 포함하여 보고서 파트만 게시하거나 데이터 집합을 별도로 게시할 수 있습니다. 데이터 집합을 별도로 게시하는 경우에는 공유 데이터 집합이 되며 보고서 파트가 이 데이터 집합에 연결됩니다. 자세한 내용은 [보고서 작성기의 보고서 파트 및 데이터 집합](../report-data/report-parts-and-datasets-in-report-builder.md)을 참조하세요.  
