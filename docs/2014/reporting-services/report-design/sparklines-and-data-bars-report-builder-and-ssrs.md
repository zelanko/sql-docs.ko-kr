...
##  <a name="KindsofSparklines"></a>스파크 라인 유형  
 일반 차트와 같이 다양한 유형의 스파크라인을 만들 수 있습니다. 그러나 보통 3D 스파크라인은 만들지 않습니다. 다음과 같은 전체 차트의 스파크라인 버전을 만들 수 있습니다.  
  
-   [세로 막대형 차트 &#40;보고서 작성기 및 SSRS&#41;](charts-report-builder-and-ssrs.md): 기본, 누적 및 100% 기준 누적 세로 막대형 차트입니다.  
  
-   [꺾은선형 차트 &#40;보고서 작성기 및 SSRS&#41;](line-charts-report-builder-and-ssrs.md): 3d 꺾은선형 차트를 제외한 모든 차트입니다.  
  
-   [영역형 차트 &#40;보고서 작성기 및 SSRS&#41;](area-charts-report-builder-and-ssrs.md): 3d 영역형 차트를 제외한 모든 차트  
  
-   [원형 차트에는 보고서 작성기 및 SSRS&#41;](pie-charts-report-builder-and-ssrs.md)와 도넛형 차트 (평면 및 3d)가 모두 &#40;하 고 깔때기형 및 피라미드형 차트와 같은 다른 셰이프는 그렇지 않습니다.  
  
-   범위 형 차트에는 주식형, 원통형, 오차 막대 및 상자 그림 차트 [&#40;보고서 작성기 및 SSRS&#41;](range-charts-report-builder-and-ssrs.md)있습니다.  
...
-   [가로 막대형 차트 &#40;보고서 작성기 및 SSRS&#41;](bar-charts-report-builder-and-ssrs.md): 기본, 누적 및 100% 기준 누적 가로 막대형 차트입니다.  
  
-   [세로 막대형 차트 &#40;보고서 작성기 및 SSRS&#41;](charts-report-builder-and-ssrs.md): 기본, 누적 및 100% 기준 누적 세로 막대형 차트입니다. 세로 막대형 차트는 스파크라인 또는 데이터 막대일 수 있습니다.  

##  <a name="AlignDatainTableMatrix"></a>테이블 또는 행렬에서 스파크 라인 데이터 정렬  
...
##  <a name="UnderstandScope"></a>스파크 라인 또는 데이터 막대에 제공 되는 데이터 이해  
...
##  <a name="ConvertSparklinetoChart"></a>스파크 라인 또는 데이터 막대를 전체 차트로 변환  
...
##  <a name="HowTo"></a>방법 도움말 항목  
 [보고서 작성기 및 SSRS &#40;스파크 라인과 데이터 막대를 추가&#41;](sparklines-and-data-bars-report-builder-and-ssrs.md)  
...
### <a name="other-how-to-topics-for-charts"></a>기타 차트 관련 방법 도움말 항목  
 ...
 [시리즈 &#40;보고서 작성기 및 SSRS에 대 한 도구 설명을 표시&#41;](show-tooltips-on-a-series-report-builder-and-ssrs.md)  
