...
## <a name="see-also"></a>관련 항목  
 ...
 [스파크 라인, 가로 막대형 차트 및 표시기 (비디오) 보고서 작성기에서](http://technet.microsoft.com/bi/video/ff877165)   
 [방법: (비디오) 테이블에 스파크 라인 만들기](http://go.microsoft.com/fwlink/?LinkId=197092)  
