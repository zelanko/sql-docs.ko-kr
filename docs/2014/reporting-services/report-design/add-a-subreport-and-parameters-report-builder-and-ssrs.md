...
5.  **이 보고서를 하위 보고서로 사용** 상자에서 **찾아보기**를 클릭하거나 보고서의 이름을 입력합니다. 하위 보고서의 경로는 자동으로 지정되므로 **찾아보기** 를 클릭하는 것이 좋습니다. 여러 가지 방법으로 보고서를 지정할 수 있습니다. 자세한 내용은 [외부 항목에 대한 경로 지정&#40;보고서 작성기 및 SSRS&#41;](specifying-paths-to-external-items-report-builder-and-ssrs.md)을 참조하세요.  
