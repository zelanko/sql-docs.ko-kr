...
### <a name="options"></a>옵션
 **실행 계정 지정** 계정을 지정 하려면 선택 합니다.

 **계정** Windows 도메인 사용자 계정을 입력 합니다. *도메인>\\<사용자 계정\>형식을 사용 \<* 합니다.
 ...
 **아웃 바운드 SMTP 서버** 사용할 SMTP 서버 또는 게이트웨이를 지정 합니다. 네트워크에서 로컬 서버나 SMTP 서버를 사용할 수 있습니다.
