...
## <a name="see-also"></a>참고 항목
 <xref:ReportExecution2005.ReportExecutionService.Render%2A>[REPORTING SERVICES SOAP 헤더를 사용 하 여](../report-server-web-service-net-framework-soap-headers/using-reporting-services-soap-headers.md) [SSRS&#41;&#40;기술 참조](../../../2014/reporting-services/technical-reference-ssrs.md)
