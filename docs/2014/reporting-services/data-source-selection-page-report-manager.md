...
###### <a name="to-open-the-data-source-selection-page"></a>데이터 원본 선택 페이지를 열려면  
  
1.  보고서 관리자를 열고 데이터 원본을 선택할 보고서나 모델을 찾습니다.  
 ...
 **확인**  
 데이터 원본 선택 항목을 데이터 원본 속성 페이지에 복사하려면 클릭합니다.  
