...
##  <a name="1-create-a-blank-report-data-source-and-dataset"></a><a name="BlankReport"></a>1. 빈 보고서, 데이터 원본 및 데이터 집합 만들기
...
3.  **데이터 세트 이름** 드롭다운 목록에서 **ListDataset**을 선택합니다.
...
##  <a name="3-add-graphics"></a><a name="Graphics"></a>3. 그래픽 추가
...
##  <a name="5-add-a-table-to-show-sales-details"></a><a name="Table"></a>5. 테이블을 추가 하 여 판매 세부 정보 표시
...
##  <a name="6-format-data"></a><a name="Format"></a>6. 데이터 서식 지정
...
##  <a name="8-optional-add-a-line-to-separate-areas-of-the-report"></a><a name="Line"></a>8. (선택 사항) 선을 추가 하 여 보고서 영역 구분
...
##  <a name="9-optional-add-summary-data-visualization"></a><a name="Visualization"></a>9. (선택 사항) 요약 데이터 시각화 추가
