...
# <a name="activate-the-report-server-file-sync-feature-in-sharepoint-central-administration"></a>SharePoint 중앙 관리에서 보고서 서버 파일 동기화 기능 활성화
 ...
 설치한 후 SharePoint 사이트 관리에서 파일 동기화 기능을 활성화할 수 있습니다는 [!INCLUDE[ssRSCurrent](../includes/ssrscurrent-md.md)] SharePoint 제품 용 추가 기능을 합니다.  
...
## <a name="prerequisites"></a>사전 요구 사항  
 ...
 설치를 확인 하려면 설치 된 응용 프로그램의 목록을 보려면 [!INCLUDE[msCoName](../includes/msconame-md.md)] Windows **제어판**합니다. 경우는 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] 설치 된 추가 기능, 보고서 서버 파일 동기화 기능을 활성화 하려면이 항목의 지침을 따릅니다.  
...
## <a name="see-also"></a>관련 항목  
 ...
 [보고서 서버 및 Power View Integration Features in SharePoint 활성화](activate-the-report-server-and-power-view-integration-features-in-sharepoint.md)   
