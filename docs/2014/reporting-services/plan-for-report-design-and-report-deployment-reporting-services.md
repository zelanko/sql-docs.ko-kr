...
-   **보고서 작성기:** 보고서 작성기에서 보고서 서버로 보고서를 저장 합니다.  
  
-   **보고서 관리자:** 보고서 관리자에서 기본 모드 보고서 서버로 보고서를 업로드 합니다.  
  
-   **SharePoint:** SharePoint 모드 보고서 서버를 사용 하 여 구성 된 SharePoint 사이트로 보고서를 업로드 합니다.  
  
-   **프로그래밍 방식으로:** 프로그래밍 방식으로 보고서 서버에 SOAP API 인터페이스를 사용 하 여 보고서를 게시 합니다. 자세한 내용은 [Report Server Web Service](report-server-web-service/report-server-web-service.md)을 참조하세요.  
