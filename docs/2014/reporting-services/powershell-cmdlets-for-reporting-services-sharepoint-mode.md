...
-   [자세한 샘플](#bkmk_detailedsamples)  
    ...
    -   [목록에서 reporting services 데이터 확장 프로그램 – SharePoint 모드](#bkmk_example_list_data_extensions)  
...
-   [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] SharePoint 모드 설치 되어 있지 않습니다 따라서 및는 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] cmdlet 설치 되어 있지 않습니다.  
...
```  
 ...
 시작 된 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] 서비스  
