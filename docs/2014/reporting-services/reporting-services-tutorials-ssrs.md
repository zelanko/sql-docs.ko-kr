...
# <a name="reporting-services-tutorials-ssrs"></a>Reporting Services 자습서(SSRS)
 ...
 이 자습서의 단계에 따라 [!INCLUDE[ssRSCurrent](../includes/ssrscurrent-md.md)] 또는 [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[csprcs](../includes/csprcs-md.md)]를 사용 하 여 만든 응용 프로그램에서 웹 서비스에 액세스 하는 방법을 알아봅니다.  
 ...
 이 자습서의 단계를 따라 XML 스키마 정의 도구 (Xsd.exe)를 사용 하 여 보고서 정의 파일 (.rdl 및 .rdlc)을로 [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)]serialize 및 deserialize 할 수 있는 클래스를 생성 하는 방법을 배울 수 있습니다.  
