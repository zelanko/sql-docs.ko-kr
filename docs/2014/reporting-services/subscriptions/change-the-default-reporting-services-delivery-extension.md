...
1.  
  **SharePoint 관리 셸**을 엽니다.  
  
2.  
  [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] 서비스 애플리케이션의 이름을 알고 있는 경우에 이 단계를 건너뛸 수 있습니다. SharePoint 팜에 [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] 서비스 애플리케이션을 나열하려면 다음 PowerShell을 사용합니다.  
...
3.  
  [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] 서비스 애플리케이션 “ssrsapp”의 현재 기본 배달 확장 프로그램을 확인하려면 다음 PowerShell을 실행합니다.  
...
## <a name="see-also"></a>참고 항목  
 ...
 [Rsreportserver.config 구성 파일](../report-server/rsreportserver-config-configuration-file.md)   
 [Reporting Services에서 파일 공유 배달](file-share-delivery-in-reporting-services.md)   
