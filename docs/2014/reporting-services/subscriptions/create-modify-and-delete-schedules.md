...
-   [공유 일정 만들기 및 관리 (SharePoint 모드)](#bkmk_sharepoint)  
  
-   [공유 일정 만들기 및 관리(기본 모드)](#bkmk_native)  
  
##  <a name="overview-of-managing-shared-schedules"></a><a name="bkmk_overview"></a>공유 일정 관리 개요  
...
##  <a name="create-and-manage-shared-schedules-native-mode"></a><a name="bkmk_native"></a>공유 일정 만들기 및 관리 (기본 모드)  
...
1.  보고서 관리자의 일반 도구 모음에서 **사이트 설정**을 클릭합니다.  
    ...
    > [!NOTE]  
    >  **사이트 설정** 을 사용할 수 없으면 사이트 설정에 액세스할 권한이 없는 것입니다.  
