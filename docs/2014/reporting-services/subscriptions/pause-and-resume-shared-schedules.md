...
##  <a name="bkmk_native"></a>공유 일정 일시 중지 및 다시 시작 (기본 모드)  
 공유 일정을 일시 중지하고 다시 시작하려면 보고서 관리자에서 일정 페이지를 사용합니다. 을 사용할 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]수 없습니다. 일정을 일시 중지 하 고 다시 시작 하는 옵션은 제공 하지 않습니다. 자세한 내용은 [Create, Modify, and Delete Schedules](create-modify-and-delete-schedules.md)을 참조하세요.  
