...
> [!NOTE]  
>  그래픽 사용자 인터페이스가 있는 도구를 사용 하는 것을 선호 하는 경우 대신 Reporting Services 구성 관리자를 사용할 수 있습니다 `rsconfig` 및 `rskeymgmt`합니다.  
