...
> [!IMPORTANT]  
>  [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] 가 RemoteApp로 실행되면 보고서는 **** 에서 미리 보기 [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]보기에 표시할 수 없습니다. RemoteApp 프로그램은 원격 데스크톱 서비스를 통해 원격으로 액세스되는 프로그램입니다. 자세한 내용은 [TS RemoteApp 단계별 가이드](https://technet.microsoft.com/library/cc730673\(WS.10\).aspx)를 참조 하세요.  
