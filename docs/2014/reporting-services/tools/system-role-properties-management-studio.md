...
# <a name="system-role-properties-management-studio"></a>시스템 역할 속성(Management Studio)
 ...
 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]에는 **시스템 관리자** 와 **시스템 사용자**의 두 가지 미리 정의 된 시스템 역할 정의가 있습니다. 태스크 목록을 변경하여 이러한 역할 정의를 수정하거나 다른 태스크 조합을 지원하는 새 시스템 역할을 만들 수 있습니다. 역할 정의를 편집하면 역할 정의를 포함하는 모든 역할 할당에 영향을 줍니다.  
