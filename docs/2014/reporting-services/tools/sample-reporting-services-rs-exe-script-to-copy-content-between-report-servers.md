...
-   SOURCE_URL 및 target_url은 원본 및 대상을 가리키는 올바른 보고서 서버 Url 이어야 합니다 [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] 보고서 서버. 기본 모드에서 보고서 서버 URL은 다음과 같이 표시됩니다.  
