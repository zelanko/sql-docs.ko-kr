...
##  <a name="to-download-the-ssrs_migrationrss-script"></a><a name="bkmk_download_script"></a>Ssrs_migration rss 스크립트를 다운로드 합니다.  
...
##  <a name="supported-scenarios"></a><a name="bkmk_supported_scenarios"></a>지원 되는 시나리오  
...
###  <a name="items-and-resources-the-script-migrates"></a><a name="bkmk_what_is_migrated"></a>스크립트가 마이그레이션하는 항목 및 리소스  
...
##  <a name="required-permissions"></a><a name="bkmk_required_permissions"></a>필요한 권한  
...
##  <a name="how-to-use-the-script"></a><a name="bkmk_how_to_use_the_script"></a>스크립트를 사용 하는 방법  
...
###  <a name="native-mode-to-native-mode---azure-virtual-machine"></a><a name="bkmk_native_to_native_Azure_vm"></a>기본 모드에서 기본 모드로-Azure 가상 컴퓨터  
 다음 예제는 다음과 같이 콘텐츠를 마이그레이션합니다.  
...
##  <a name="sharepoint-mode--bi-site-collection-to-a-native-mode-server-on-azure-virtual-machine"></a><a name="bkmk_sharepoint_site_to_native_Azure_vm"></a>SharePoint 모드-Azure 가상 컴퓨터의 기본 모드 서버에 대 한 ' bi ' 사이트 모음  
 다음 예제는 다음과 같이 콘텐츠를 마이그레이션합니다.  
...
##  <a name="verification"></a><a name="bkmk_verification"></a>확인할  
...
##  <a name="troubleshooting"></a><a name="bkmk_troubleshoot"></a>슈팅이  
