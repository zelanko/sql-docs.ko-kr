...
# <a name="where-to-find-the-reporting-services-add-in-for-sharepoint-products"></a>SharePoint 제품용 Reporting Services 추가 기능 검색 위치
  합니다 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] (SSRS) 용 추가 기능에서 SharePoint 제품 및 기술 기능 (rsSharePoint.msi)은 SharePoint 배포를 사용 하 여 보고서 서버를 통합 하는 기능을 제공 하는 웹 다운로드입니다.  
...
-   명령 프롬프트 설치에서 **RS_SHPWFE** 옵션을 사용하여 추가 기능을 설치합니다. 에 대 한 자세한 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 명령 프롬프트 설치를 참조 하세요 [명령 프롬프트 설치의 Reporting Services SharePoint 모드 및 기본 모드](install-reporting-services-at-the-command-prompt.md)합니다.  
...
##  <a name="bkmk_sql2008r2"></a> SQL Server 2008 R2 Reporting Services 추가 기능에 SharePoint 2010 제품용  
 Microsoft SharePoint 2010 제품용 Microsoft SQL Server 2008 R2 Reporting Services 추가 기능은 SharePoint 2010 제품 준비 도구(**PreRequisiteInstaller.exe**)로 설치됩니다. 다운로드 및 추가 기능에서 개별적으로 설치 하려는 경우이 파일의 최신 버전은 사용 가능한 온라인에 [!INCLUDE[msCoName](../../includes/msconame-md.md)] 다운로드 센터에서 [SQL Server 2008 R2 Reporting Services 추가 기능에 Microsoft SharePoint 기술 2010 용 ](http://go.microsoft.com/fwlink/?LinkID=164654).  
...
##  <a name="bkmk_sql2008sp2"></a> SQL Server 2008 SP2 Reporting Services 추가 기능에 SharePoint 2007 제품 및 기술  
 ...
 이 파일의 최신 버전은 사용 가능한 온라인 합니다 [!INCLUDE[msCoName](../../includes/msconame-md.md)] 다운로드 센터 [Microsoft SQL Server 2008 SP2 Reporting Services 추가 기능인 Microsoft SharePoint 기술용](http://go.microsoft.com/fwlink/?LinkID=204594)합니다.  
...
##  <a name="bkmk_sql2008"></a> SQL Server 2008 Reporting Services 추가 기능에 SharePoint 2007 제품 및 기술  
 ...
 이 파일의 최신 버전은 사용 가능한 온라인 합니다 [!INCLUDE[msCoName](../../includes/msconame-md.md)] 다운로드 센터 [Microsoft SQL Server 2008 Reporting Services 추가 기능인 Microsoft SharePoint 기술용](http://go.microsoft.com/fwlink/?LinkID=204813)합니다.  
