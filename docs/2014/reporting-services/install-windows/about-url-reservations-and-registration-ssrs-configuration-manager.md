...
##  <a name="urls-in-reporting-services"></a><a name="ReportingServicesURLs"></a>Reporting Services의 Url  
...
##  <a name="authentication-and-service-identity-for-reporting-services-urls"></a><a name="URLPermissionsAccounts"></a>Reporting Services Url에 대 한 인증 및 서비스 Id  
...
##  <a name="urls-for-report-server-in-sharepoint-integrated-mode"></a><a name="URLSharePoint"></a>SharePoint 통합 모드의 보고서 서버에 대 한 Url  
