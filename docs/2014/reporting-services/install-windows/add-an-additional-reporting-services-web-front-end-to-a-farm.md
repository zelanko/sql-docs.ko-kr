...
## <a name="see-also"></a>관련 항목  
 [추가 웹 또는 응용 프로그램 서버 팜 (SharePoint Server 2010)](https://technet.microsoft.com/library/bb218968.aspx?missingurl=%2fen-us%2flibrary%2fe1aeaddf-6ee4-43a9-82b7-db20b68c71db\(Office.14\))   
 [서비스 (SharePoint Server 2010)를 구성 합니다.](https://technet.microsoft.com/library/ee794878.aspx)  
