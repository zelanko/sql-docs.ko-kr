...
##  <a name="check-prerequisites"></a><a name="bkmk_prereq"></a> 필수 구성 요소 확인  
 ...
 **추가 정보:**[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 서비스에 연결해야 하는 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 기능을 사용하려고 하면 이 오류 메시지가 표시됩니다. 여기에는 다음이 포함됩니다.  
