 ...
 **현재 SMTP 배달 방법**  
 ...
 `SendUsing` 구성 설정을 통해 구성 파일에서 배달 방법을 설정합니다. 지정 하는 방법에 대 한 자세한 내용은 합니다 `SendUsing` 설정을 참조 하세요 [전자 메일 배달을 위한 보고서 서버 구성 &#40;&AMP;#40;SSRS 구성 관리자&#41;](../../sql-server/install/configure-a-report-server-for-e-mail-delivery-ssrs-configuration-manager.md).  
