...
##  <a name="what-is-the-default-configuration"></a><a name="bkmk_whatisdefaultconfiguration"></a>기본 구성 이란?
...
##  <a name="when-to-install-the-default-configuration-for-native-mode"></a><a name="bkmk_whentoinstalldefaultconfig"></a>기본 모드용 기본 구성을 설치 하는 경우
...
|가상 디렉터리|기본적으로 가상 디렉터리는 보고서 서버 웹 서비스에 대 한\<ReportServer_*instance_name*> 형식으로 만들어지며 instance_name> 보고서 관리자 Reports_\<*instance_name* . 보고서 서버 웹 서비스의 기본 가상 디렉터리는 **reportserver**이고 보고서 관리자의 기본 가상 디렉터리는 **reports**입니다.|
...
##  <a name="install-native-mode-with-the-sql-server-installation-wizard"></a><a name="bkmk_installwithwizard"></a>SQL Server 설치 마법사를 사용 하 여 기본 모드 설치
...
##  <a name="install-native-mode-with-the-command-line"></a><a name="bkmk_commandline"></a>명령줄을 사용 하 여 기본 모드 설치
