...
# <a name="integrating-reporting-services-into-applications"></a>애플리케이션에 Reporting Services 통합
 ...
 사용자 지정 응용 프로그램에 통합 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 하기 위한 세 가지 옵션이 있습니다. 보고서 서버 웹 서비스 ( [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] SOAP API 라고도 함), 용 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[vsOrcas](../../includes/vsorcas-md.md)]ReportViewer 컨트롤, URL 액세스 등이 있습니다. 각 옵션에서는 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]를 애플리케이션에 통합하기 위한 서로 다른 방법을 제공합니다.  
...
## <a name="in-this-section"></a>섹션 내용  
 [SOAP을 사용하여 Reporting Services 통합](../application-integration/integrating-reporting-services-using-soap.md)  
...
## <a name="see-also"></a>참고 항목  
 ...
 [SSRS&#41;&#40;기술 참조](../../../2014/reporting-services/technical-reference-ssrs.md)   
