...
ms.locfileid: "36184436"
---
# <a name="using-url-access-in-a-web-application"></a>웹 응용 프로그램에서 URL 액세스 사용
...
```  
 ...
 장치 정보 설정에 대한 자세한 내용은 [장치 정보 설정을 렌더링 확장 프로그램에 전달](../report-server-web-service/net-framework/passing-device-information-settings-to-rendering-extensions.md)을 참조하세요.  
