...
6.  
  **데이터 원본에 대한 연결 선택** 페이지에서 기존 데이터 원본을 선택하거나 보고서 서버를 찾아 데이터 원본을 선택합니다. 데이터 원본을 사용할 수 없거나 보고서 서버에 대한 액세스 권한이 없는 경우 포함된 데이터 원본을 대신 사용할 수 있습니다. 자세한 내용은 [자습서: 기본 테이블 보고서 만들기&#40;보고서 작성기&#41;](../reporting-services/tutorial-creating-a-basic-table-report-report-builder.md)를 참조하세요.  
...
7.  레이아웃 선택 페이지의 **옵션**에서 **부분합 및 총합계 표시** 가 선택 되어 있는지 확인 합니다.  
...
##  <a name="BackgroundColors"></a>3. 배경색을 사용 하 여 KPI 표시  
...
##  <a name="Gauge"></a>4. 계기를 사용 하 여 KPI 표시  
...
##  <a name="Indicator"></a>5. 표시기를 사용 하 여 KPI 표시  
...
4.  
  **이름**에서 기본 이름을 **Product Sales KPI**로 바꿉니다.  
