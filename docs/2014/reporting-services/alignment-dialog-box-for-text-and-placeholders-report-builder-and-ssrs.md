...
-   **일반적인** 에서 계산 된 대로 텍스트를 표시 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]합니다. 일반 텍스트 맞춤이 계산되는 방법에 대한 자세한 내용은 [텍스트 및 자리 표시자 서식 지정&#40;보고서 작성기 및 SSRS&#41;](report-design/formatting-text-and-placeholders-report-builder-and-ssrs.md)을 참조하세요.  
...
## <a name="see-also"></a>관련 항목  
 ...
 [텍스트 상자에 텍스트 서식을 &#40;보고서 작성기 및 SSRS&#41;](report-design/format-text-in-a-text-box-report-builder-and-ssrs.md)  
