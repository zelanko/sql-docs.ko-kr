...
##  <a name="BackToTop"></a> 학습할 내용  
 ...
 3. [테이블에 스파크 라인 추가](#Sparkline)  
  
 4. [세로 및 가로로 스파크 라인 맞추기](#AlignSparklines)  
  
### <a name="other-optional-steps"></a>기타 선택적 단계  
 5. [데이터 서식 통화로](#FormatCurrency)  
  
 6. [데이터 서식 날짜로](#FormatDates)  
...
4.  **데이터 집합 선택** 페이지에서 **데이터 집합 만들기**를 선택하고 **다음**을 클릭합니다. **데이터 원본에 대한 연결 선택** 페이지가 열립니다.  
