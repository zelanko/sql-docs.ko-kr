 ...
 **이 사용자 이름 및 암호 사용**  
 특정 사용자 이름 및 암호를 제공하려면 이 옵션을 선택합니다. 포함된 데이터 원본의 경우 보고서 서버 프로젝트를 대상 서버에 게시하면 사용자 이름과 암호가 데이터베이스에 대해 저장된 자격 증명으로 저장됩니다. 사용자 이름과 암호를 Windows 자격 증명으로 사용하려는 경우 대상 서버에서 게시된 공유 데이터 원본에 대한 속성을 변경할 수 있습니다. 자세한 내용은 [](../../2014/reporting-services/create-delete-or-modify-a-shared-data-source-report-manager.md)온라인 설명서[!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]의  설명서에서 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [공유 데이터 원본 만들기, 삭제 또는 수정&#40;보고서 관리자&#41;](https://go.microsoft.com/fwlink/?linkid=121312)을 참조하세요.  
 ...
 **자격 증명 사용 안 함**  
 ...
 자세한 내용은 [](report-data/add-data-from-external-data-sources-ssrs.md)온라인 설명서[의 ](install-windows/configure-the-unattended-execution-account-ssrs-configuration-manager.md) 설명서에서 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]외부 데이터 원본의 데이터 추가&#40;SSRS&#41; 및 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [무인 실행 계정 구성&#40;SSRS 구성 관리자&#41;](https://go.microsoft.com/fwlink/?linkid=121312)의 해당하는 데이터 원본 유형에 대한 항목을 참조하세요.  
