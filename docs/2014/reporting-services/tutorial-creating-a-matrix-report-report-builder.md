...
##  <a name="1-create-a-matrix-report-and-dataset-from-the-new-table-or-matrix-wizard"></a><a name="CreateMatrix"></a>1. 새 테이블 또는 행렬 마법사에서 행렬 보고서 및 데이터 집합 만들기  
...
##  <a name="2-organize-data-and-choose-layout-and-style-from-the-new-table-or-matrix-wizard"></a><a name="Groups"></a>2. 새 테이블 또는 행렬 마법사에서 데이터 구성 및 레이아웃 및 스타일 선택  
...
##  <a name="9-optional-rotate-text-box-270-degrees"></a><a name="RotateTextBox"></a>9. (선택 사항) 텍스트 상자 270도 회전  
