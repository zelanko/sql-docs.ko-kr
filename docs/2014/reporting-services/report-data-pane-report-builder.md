 ...
 **데이터 원본**  
 포함된 데이터 원본 또는 공유 데이터 원본에 대한 참조를 나타냅니다. 데이터 원본은 보고서의 데이터 원본을 나타냅니다. 데이터 원본은 이를 사용하는 데이터 집합 컬렉션의 부모 노드입니다. 자세한 내용은 참조 [보고서에 데이터 추가 &#40;보고서 작성기 및 SSRS&#41; ](report-data/report-datasets-ssrs.md) 및 [데이터 연결, 데이터 원본 및 보고서 작성기의 연결 문자열](../../2014/reporting-services/data-connections-data-sources-and-connection-strings-in-report-builder.md)합니다.  
