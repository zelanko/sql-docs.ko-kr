...
5.  (옵션) **TargetDataSourceFolder**에 SharePoint 라이브러리 또는 라이브러리 폴더에 대한 URL을 입력합니다. 예를 들어 *http://TestServer/TestSite/Documents/DataSources*합니다.  
