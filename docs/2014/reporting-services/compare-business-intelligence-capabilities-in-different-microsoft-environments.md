...
|-|----------------------------------------------|------------------------------|-----------------------------|  
|BI 사이트|[!INCLUDE[ssGemini](../includes/ssgemini-md.md)]갤러리|예|Power BI 사이트|  
|데이터 관리와 쿼리 공유 및 관리|예|예|예 ** <sup>1</sup>**|  
|MDS(Master Data Services) 및 DQS(Data Quality Services)와의 통합|yes|예|예|  
|데이터 새로 고침 예약|예. 하지만 파워 쿼리 데이터가 들어 있는 통합 문서는 지원하지 않습니다.|예|yes|  
|자연어 쿼리 (Q&A)|예|예|예 ** <sup>2</sup>**|  
|예측|예|예|예 ** <sup>3</sup>**|  
|[!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]통합할|yes|예|예|  
|
  [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 통합(다차원 및 테이블 형식)|yes|예|예|  
|대화형 Power View 대시보드를 PowerPoint 프레젠테이션으로 내보내기|yes|예|예|  
|브라우저 내 대시보드 제작|yes|예|예|  
|사용 현황 모니터링|yes|예|yes|  
|
  [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 큐브의 행 기반 보안 활용|yes|예|예|  
|||||
...
|HTML5에서 브라우저 내 데이터 탐색|예|예|yes|  
|보고서 및 대시보드에 원격으로 액세스하는 모바일 BI 앱|예|예|예 ** <sup>1</sup>**|  
|데이터 소스로 [!INCLUDE[ssGemini](../includes/ssgemini-md.md)] 를 사용하는 Excel 통합 문서 **<sup>2</sup>**|yes|예|예|  
 ...
 **<sup>2</sup>**  [PowerPivot 통합 문서를 데이터 원본으로](https://support.office.com/article/Power-Pivot-Powerful-data-analysis-and-data-modeling-in-Excel-A9C2C6E2-CC49-4976-A7D7-40896795D045)  
