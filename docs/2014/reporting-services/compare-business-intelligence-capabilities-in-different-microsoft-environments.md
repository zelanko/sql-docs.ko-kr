...
# <a name="compare-business-intelligence-capabilities-in-different-microsoft-environments"></a>다양한 Microsoft 환경에서 비즈니스 인텔리전스 기능 비교
  Microsoft [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 숫자로 포함 하 여 다양 한 환경에서 비즈니스 인텔리전스를 배포할 수 있습니다 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] SharePoint Server, SharePoint Online 및 Office 365 용 Power BI를 사용 하 여 합니다. 이 항목에서는 구성 요소 및 각 환경에서 지원되는 기능을 비교합니다.  
...
|행 기반 보안의 활용 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 큐브|사용자 계정 컨트롤|아니오|아니요|  
  
 **<sup>1</sup>**[데이터 관리에서 데이터 관리자의 역할 이해](https://support.office.com/Article/Understanding-the-Role-of-Data-Stewards-in-Data-Management-ae3352f3-4389-45e8-a682-7fd6edb92524?ui=en-US&rs=en-US&ad=US) 하 고 [비디오: Power BI 정보 관리 및 데이터 관리](https://www.youtube.com/watch?v=8dHOj68ts7c)합니다.    
 ...
 **<sup>3</sup>**[소개 새로운 Office 365 용 Power View에서 기능을 예측](http://blogs.msdn.com/b/powerbi/archive/2014/05/08/introducing-new-forecasting-capabilities-in-power-view-for-office-365.aspx)합니다.    
...
|Excel 통합 문서 [!INCLUDE[ssGemini](../includes/ssgemini-md.md)] 데이터 소스로  **<sup>2</sup>**|사용자 계정 컨트롤|아니오|아니요|  
|다른 브라우저 및 버전의 기능을 사용하는 기능|예, Power View가 아닌 시각화에 대 한  **<sup>3</sup>**|예, 통합 문서 파일 크기 10MB 미만의  **<sup>3</sup>**|예  **<sup>3</sup>**|  
 ...
 **<sup>3</sup>**[비즈니스 인텔리전스 (BI) 도구의 모바일 지원](http://msdn.microsoft.com/library/dn151146\(v=sql.110\).aspx) 하 고 [Reporting Services 및 파워 뷰 브라우저 지원 (Reporting Services 2014)에 대 한 계획](http://msdn.microsoft.com/library/ms156511.aspx)합니다.    
