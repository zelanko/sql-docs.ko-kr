...
|공유 데이터 집합|공유 데이터 집합은 해당 공유 데이터 집합의 정의 보기 또는 변경, 속성 변경 등 사용자가 수행할 수 있는 동작의 범위를 제어하여 보안을 설정할 수 있습니다.<br /><br /> 자세한 내용은 [공유 데이터 집합 항목 보안 설정](secure-shared-dataset-items.md)을 참조하세요.|  
