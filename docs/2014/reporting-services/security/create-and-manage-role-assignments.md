...
## <a name="creating-a-system-level-role-assignment"></a>시스템 수준 역할 할당 만들기  
 ...
 자세한 내용은 참조 [보고서 서버에 사용자 액세스 권한 부여 &#40;보고서 관리자&#41; ](grant-user-access-to-a-report-server.md) 및 [미리 정의 된 역할](role-definitions-predefined-roles.md)합니다.  
