...
#### [항목 수준의 태스크](tasks-and-permissions-item-level-tasks.md)
#### [시스템 수준 태스크](tasks-and-permissions-system-level-tasks.md)
...
#### [역할 만들기, 삭제 또는 수정](role-definitions-create-delete-or-modify.md)
