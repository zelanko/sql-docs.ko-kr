...
##  <a name="predefined-role-definitions"></a><a name="bkmk_rolelist"></a>미리 정의 된 역할 정의  
...
|[시스템 관리자 역할](#bkmk_systemadministrator)|System|이 역할에 할당된 사용자는 기능 활성화, 기본값 설정, 사이트 전체 보안 설정, Management Studio에서 역할 정의를 만들기 및 작업 관리 등을 수행할 수 있습니다.|  
|[시스템 사용자 역할](#bkmk_systemuser)|System|이 역할에 할당된 사용자는 보고서 서버에 대한 기본 정보(예: 공유 일정에 있는 일정 정보)를 볼 수 있습니다.|  
  
##  <a name="content-manager-role"></a><a name="bkmk_content"></a>내용 관리자 역할  
...
##  <a name="publisher-role"></a><a name="bkmk_publisher"></a>게시자 역할  
...
##  <a name="browser-role"></a><a name="bkmk_browser"></a>브라우저 역할  
...
##  <a name="report-builder-role"></a><a name="bkmk_reportbuilder"></a>보고서 작성기 역할  
...
##  <a name="my-reports-role"></a><a name="bkmk_myreports"></a>내 보고서 역할  
...
##  <a name="system-administrator-role"></a><a name="bkmk_systemadministrator"></a>시스템 관리자 역할  
...
|작업 관리|실행 중인 작업을 확인 및 취소합니다. 자세한 내용은 [실행 중인 프로세스 관리](../subscriptions/manage-a-running-process.md)를 참조하세요.|  
...
##  <a name="system-user-role"></a><a name="bkmk_systemuser"></a>시스템 사용자 역할  
