...
-   필요에 따라 구성 파일을 수정하여 애플리케이션 설정을 변경할 수 있습니다. 각 파일에 대한 자세한 내용과 해당 파일의 수정 지침은 [Reporting Services Configuration Files](reporting-services-configuration-files.md)을 참조하십시오.  
