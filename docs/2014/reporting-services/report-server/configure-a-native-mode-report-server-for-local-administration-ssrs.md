...
##  <a name="to-configure-local-report-server-and-report-manager-administration"></a><a name="bkmk_configure_local_server"></a>로컬 보고서 서버 및 보고서 관리자 관리를 구성 하려면  
...
###  <a name="trusted-site-settings-in-the-browser"></a><a name="bkmk_site_settings"></a>브라우저의 신뢰할 수 있는 사이트 설정  
...
###  <a name="report-manager-folder-settings"></a><a name="bkmk_configure_folder_settings"></a> 보고서 관리자 폴더 설정  
...
###  <a name="report-manager-site-settings"></a><a name="bkmk_configure_site_settings"></a> 보고서 관리자 사이트 설정  
...
##  <a name="to-configure-sql-server-management-studio-ssms-for-local-report-server-administration"></a><a name="bkmk_configure_ssms"></a>로컬 보고서 서버 관리를 위해 SSMS (SQL Server Management Studio)를 구성 하려면  
...
##  <a name="to-configure-sql-server-data-tools-bi-ssdt-to-publish-to-a-local-report-server"></a><a name="bkmk_configure_ssdt"></a>로컬 보고서 서버에 게시 하도록 SSDT (SQL Server Data Tools BI)를 구성 하려면  
...
1.  시작 화면에서를 입력 `sql server` 하 고 **Visual Studio SQL Server Data Tools를**마우스 오른쪽 단추로 클릭 합니다. **관리자 권한으로 실행**을 클릭합니다.  
...
##  <a name="additional-information"></a><a name="bkmk_addiitonal_informaiton"></a>추가 정보  
