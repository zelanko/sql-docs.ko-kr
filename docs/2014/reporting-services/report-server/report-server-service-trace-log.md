...
-   [덤프 파일 위치를 지정 하는 사용자 지정 구성 설정 추가](#bkmk_add_custom)
...
|**TraceListeners**|추적 로그 내용을 출력할 대상을 지정합니다. 대상이 여러 개일 경우 쉼표로 구분하여 지정할 수 있습니다. 유효한 값은 다음과 같습니다.<br /><br /> DebugWindow<br /><br /> File(기본값)<br /><br /> StdOut|
