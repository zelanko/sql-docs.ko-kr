...
-   [덤프 파일 위치를 지정 하려면 사용자 지정 구성 설정을 추가](#bkmk_add_custom)  
...
##  <a name="bkmk_view_log"></a> 보고서 서버 로그 파일은 어디에 있나요?  
 ...
 ![파워 쿼리 및 SSRS 로그에 대 한 비디오를 볼](../media/generic-video-thumbnail.png "파워 쿼리 및 SSRS 로그에 대 한 비디오 보기")  
