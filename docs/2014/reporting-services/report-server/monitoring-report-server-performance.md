...
-   **MSRS 2011 Web Service** 고 `MSRS 2011 SharePoint Mode Web Service` 보고서 서버 성능을 모니터링 합니다. 이러한 성능 개체에는 일반적으로 대화형 보고서 보기 작업을 통해 시작된 보고서 서버 처리를 추적하는 데 사용되는 카운터 모음이 들어 있습니다. 이러한 카운터는 [!INCLUDE[vstecasp](../../includes/vstecasp-md.md)] 이 보고서 서버 웹 서비스를 중지할 때마다 다시 설정됩니다.  
...
## <a name="in-this-section"></a>섹션 내용  
 [성능 카운터 MSRS 2014 웹 서비스 및 MSRS 2014 Windows 서비스 성능 개체에 대 한 &#40;기본 모드&#41;](performance-counters-msrs-2011-web-service-performance-objects.md)  
