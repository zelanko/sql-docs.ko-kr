...
# <a name="cache-a-shared-dataset"></a>공유 데이터 집합 캐시
 ...
 캐시할 수 있는 공유 데이터 집합 유형은 제한되어 있습니다. 예를 들어 사용자 ID에 따라 데이터가 달라지는 경우 또는 보고서를 요청하는 사용자의 보안 토큰을 사용하여 데이터가 검색되는 경우 쿼리 결과를 캐시할 수 없습니다. 자세한 내용은 [공유 데이터 집합 캐시&#40;SSRS&#41;](cache-shared-datasets-ssrs.md) 및 [보고서 캐시&#40;SSRS&#41;](caching-reports-ssrs.md)를 참조하세요.  
