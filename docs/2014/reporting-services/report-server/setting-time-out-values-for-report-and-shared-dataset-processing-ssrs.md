...
## <a name="setting-a-query-time-out-for-a-shared-dataset"></a>공유 데이터 세트의 쿼리 제한 시간 설정  
 쿼리 제한 시간 값은 보고서 서버에서 공유 데이터 세트를 만들거나 관리할 때 초 단위로 지정됩니다. 기본적으로 이 값은 0초로 설정되며 이것은 제한 시간 값이 없는 것과 같습니다. 자세한 내용은 [공유 데이터 세트 관리](../report-data/manage-shared-datasets.md)를 참조하세요.  
