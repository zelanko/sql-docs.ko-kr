...
> [!IMPORTANT]  
>  아래 표에 **(\*)** 와 함께 나열된 디바이스 정보 설정은 더 이상 사용되지 않으므로 새 애플리케이션에서 사용하지 않아야 합니다. 자세한 내용은 [SQL Server 2014에서 SQL Server Reporting Services에서 사용 되지 않는 기능](deprecated-features-in-sql-server-reporting-services-ssrs.md)합니다.  
