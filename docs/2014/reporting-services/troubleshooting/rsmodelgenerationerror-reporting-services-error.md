...
## <a name="explanation"></a>설명  
 보고서 모델을 생성할 수 없습니다. 2005 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]SP1 및 이전 버전에서이 오류는 예를 들어 두 개의 외래 키가 한 테이블 내에서 같은 열에 정의 되는 경우와 같이 데이터 집합 개체가 데이터베이스 스키마 내에서 테이블이 나 관계를 처리할 수 없는 경우에 주로 표시 됩니다.  
