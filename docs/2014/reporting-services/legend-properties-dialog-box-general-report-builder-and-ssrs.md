...
# <a name="legend-properties-dialog-box-general-report-builder-and-ssrs"></a>범례 속성 대화 상자, 일반(보고서 작성기 및 SSRS)
  ...
  **범례** 대화 상자를 사용하여 차트의 범례 모양과 레이아웃을 정의할 수 있습니다. 자세한 내용은 [차트의 범례 서식 지정 &#40;보고서 작성기 및 SSRS&#41;](report-design/chart-legend-formatting-report-builder.md)를 참조 하세요.  
...
-   **긴 테이블** 범례의 내용을 테이블에 표시 합니다. 범례 항목을 추가하면 범례가 세로로 확장됩니다.  
  
-   **열** 범례의 내용을 단일 열에 표시 합니다.  
  
-   **행** 범례의 내용을 단일 행에 표시 합니다.  
  
-   **넓은 테이블** 범례의 내용을 테이블에 표시 합니다. 범례 항목을 추가하면 범례가 가로로 확장됩니다.  
  
-   **자동 테이블** 범례의 내용을 테이블에 표시 합니다. 범례 항목을 추가하면 차트에서 사용할 수 있는 공간에 따라 범례가 가로 또는 세로로 확장됩니다.  
