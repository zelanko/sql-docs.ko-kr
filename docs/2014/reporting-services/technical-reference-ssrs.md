...
# <a name="technical-reference-ssrs"></a>기술 참조(SSRS)
  [!INCLUDE[msCoName](../includes/msconame-md.md)] 에서 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]를 사용 하거나 관리 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] 하기 위한 도구 및 PowerShell 참조 설명서를 찾습니다.  
