...
##  <a name="1-create-a-new-report-from-getting-started"></a><a name="CreateTable"></a>1. 시작에서 새 보고서 만들기  
...
##  <a name="1a-specify-a-data-connection-in-the-table-wizard"></a><a name="DataConnection"></a>a. 테이블 마법사에서 데이터 연결 지정  
...
6.  **자격 증명**을 클릭합니다. 외부 데이터 원본에 액세스하는 데 필요한 자격 증명을 입력합니다.  
...
1.  **쿼리 디자인** 페이지에 관계형 쿼리 디자이너가 열립니다. 이 자습서에서는 텍스트 기반 쿼리 디자이너를 사용합니다.  
     ...
     **텍스트로 편집을**클릭 합니다. 텍스트 기반 쿼리 디자이너에 쿼리 창과 결과 창이 표시됩니다.  
  
2.  [!INCLUDE[tsql](../includes/tsql-md.md)] 쿼리 **상자에 다음** 쿼리를 붙여 넣습니다.  
...
1.  **필드 정렬** 페이지에서 **값**에 Product를 끌어 옵니다.  
...
##  <a name="1d-add-subtotal-and-total-rows-in-the-table-wizard"></a><a name="Subtotals"></a>차원. 테이블 마법사에서 부분합 및 합계 행 추가  
...
##  <a name="1e-choose-a-style-in-the-table-wizard"></a><a name="Style"></a>e. 테이블 마법사에서 스타일 선택  
...
##  <a name="2-format-data-as-currency"></a><a name="FormatCurrency"></a>2. 데이터 서식을 통화로 지정  
