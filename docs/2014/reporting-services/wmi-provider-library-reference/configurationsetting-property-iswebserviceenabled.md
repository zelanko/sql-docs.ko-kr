...
ms.locfileid: "66097647"
---
# <a name="iswebserviceenabled-property-wmi-msreportserver_configurationsetting"></a>IsWebServiceEnabled 속성(WMI MSReportServer_ConfigurationSetting)
...
## <a name="property-values"></a>속성 값  
 읽기 전용 `Boolean` 값입니다. 
  `true` 값은 보고서 서버 웹 서비스를 사용할 수 있음을 나타냅니다.  
