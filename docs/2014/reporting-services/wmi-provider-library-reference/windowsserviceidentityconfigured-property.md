...
ms.locfileid: "66096966"
---
# <a name="windowsserviceidentityconfigured-property-wmi-msreportserver_configurationsetting"></a>WindowsServiceIdentityConfigured 속성(WMI MSReportServer_ConfigurationSetting)
...
## <a name="property-values"></a>속성 값  
 보고서 서버 Windows 서비스를 실행하도록 마지막으로 구성된 ID가 들어 있는 `String` 값입니다.  
