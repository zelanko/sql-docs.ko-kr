...
ms.locfileid: "66097642"
---
# <a name="isinitialized-property-wmi-msreportserver_configurationsetting"></a>IsInitialized 속성(WMI MSReportServer_ConfigurationSetting)
...
## <a name="property-values"></a>속성 값  
 보고서 서버 인스턴스가 초기화되었는지 여부를 나타내는 `Boolean` 개체입니다.  
