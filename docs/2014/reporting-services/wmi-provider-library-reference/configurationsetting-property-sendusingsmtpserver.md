...
ms.locfileid: "66097515"
---
# <a name="sendusingsmtpserver-property-wmi-msreportserver_configurationsetting"></a>SendUsingSMTPServer 속성(WMI MSReportServer_ConfigurationSetting)
