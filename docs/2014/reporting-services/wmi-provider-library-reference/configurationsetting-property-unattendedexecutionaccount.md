...
ms.locfileid: "59956009"
---
# <a name="unattendedexecutionaccount-property-wmi-msreportserverconfigurationsetting"></a>UnattendedExecutionAccount 속성(WMI MSReportServer_ConfigurationSetting)
