...
ms.locfileid: "66098067"
---
# <a name="setdatabasequerytimeout-method-wmi-msreportserver_configurationsetting"></a>SetDatabaseQueryTimeout 메서드(WMI MSReportServer_ConfigurationSetting)
