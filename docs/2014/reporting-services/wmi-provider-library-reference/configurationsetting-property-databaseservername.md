...
ms.locfileid: "66097723"
---
# <a name="databaseservername-property-wmi-msreportserver_configurationsetting"></a>DatabaseServerName 속성(WMI MSReportServer_ConfigurationSetting)
  보고서 서버 데이터베이스가 설치되어 있는 서버 이름을 지정합니다. 읽기/쓰기입니다.  
