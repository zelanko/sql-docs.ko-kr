...
ms.locfileid: "66097383"
---
# <a name="virtualdirectoryreportmanager-property-wmi-msreportserver_configurationsetting"></a>VirtualDirectoryReportManager 속성(WMI MSReportServer_ConfigurationSetting)
