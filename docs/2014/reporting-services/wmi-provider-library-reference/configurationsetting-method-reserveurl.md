...
ms.locfileid: "66098136"
---
# <a name="reserveurl-method-wmi-msreportserver_configurationsetting"></a>ReserveURL 메서드(WMI MSReportServer_ConfigurationSetting)
...
## <a name="remarks"></a>설명  
 *Urlstring* 에는 가상 디렉터리 이름이 포함 되지 않습니다. 
  [SetVirtualDirectory](configurationsetting-method-setvirtualdirectory.md) 메서드를 사용하면 가상 디렉터리 이름을 포함할 수 있습니다.  
