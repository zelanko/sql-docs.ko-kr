...
ms.locfileid: "66097366"
---
# <a name="virtualdirectoryreportserver-property-wmi-msreportserver_configurationsetting"></a>VirtualDirectoryReportServer 속성(WMI MSReportServer_ConfigurationSetting)
