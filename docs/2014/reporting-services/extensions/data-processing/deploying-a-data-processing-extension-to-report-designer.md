...
4.  `Name`, `Type`및 `Visible` 특성에 대 한 값이 포함 된 **extension** 요소를 포함 하는 데이터 처리 확장 프로그램에 대 한 항목을 추가 합니다. 항목은 다음과 같습니다.  
...
-   Rsreportdesigner.config 파일의 **Designer** 요소 아래에 다음 항목을 추가 하 여 `Name` 특성을 이전 항목에서 제공한 이름으로 바꿉니다.  
