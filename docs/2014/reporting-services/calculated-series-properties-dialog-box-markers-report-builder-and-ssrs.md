---
title: 계열 속성 대화 상자, 표식 (보고서 작성기 및 SSRS)를 계산 합니다. | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="options"></a>변수  
 **표식 유형**  
 차트에 표식을 사용할 경우 어떤 표식 유형을 사용할지 선택합니다. 기본적으로 이 옵션은 **원**으로 설정되어 있습니다.  
  
 **표식 크기**  
 데이터 요소에 대해 표시할 표식의 크기를 선택합니다.  
  
 **표식 색**  
 데이터 요소에 대해 표시할 표식의 색을 선택합니다.  
  
 **표식 테두리 두께입니다.**  
 데이터 요소에 대해 표시할 표식의 테두리 두께를 선택합니다.  
...
## <a name="see-also"></a>관련 항목  
 ...
 [차트에 데이터 요소에 서식 지정 &#40;보고서 작성기 및 SSRS&#41;](report-design/formatting-data-points-on-a-chart-report-builder-and-ssrs.md)   
