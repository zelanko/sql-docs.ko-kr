...
## <a name="see-also"></a>관련 항목  
 ...
 [스크립트 태스크와 스크립트 구성 요소에서 중단점을 설정 하 여 스크립트 디버깅](data-flow/transformations/script-component.md)   
 [코딩 및 스크립트 태스크 디버깅](control-flow/script-task.md)   
