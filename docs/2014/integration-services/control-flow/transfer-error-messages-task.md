...
## <a name="execution-value"></a>실행 값  
 전송된 오류 메시지의 개수는 태스크의 `ExecutionValue` 속성에 정의된 실행 값으로 반환됩니다. 오류 메시지 전송 태스크의 `ExecValueVariable` 속성에 사용자 정의 변수를 할당하면 패키지 내의 다른 개체에서 오류 메시지 전송에 대한 정보를 사용할 수 있습니다. 자세한 내용은 [Integration Services&#40;SSIS&#41; 변수](../integration-services-ssis-variables.md) 및 [패키지에서 변수 사용](../use-variables-in-packages.md)을 참조하세요.  
