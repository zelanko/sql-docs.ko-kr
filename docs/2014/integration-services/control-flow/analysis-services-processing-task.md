...
## <a name="object-processing"></a>개체 처리  
 ...
 분석 개체를 처리할 때 종속 개체를 함께 처리할 수도 있습니다. 
  [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 처리 태스크에는 선택한 개체 외에 모든 종속 개체를 처리하는 옵션이 있습니다.  
...
>  
 ...
 처리 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 태스크는 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 연결 관리자를 사용 하 여 인스턴스에 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]연결 합니다. 자세한 내용은 [Analysis Services Connection Manager](../connection-manager/analysis-services-connection-manager.md)을 참조하세요.  
