...
### <a name="scriptlanguage-property"></a>ScriptLanguage 속성  
 [!INCLUDE[msCoName](../../../includes/msconame-md.md)][!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] VSTA (Tools for Applications)는 Visual Basic [!INCLUDE[msCoName](../../../includes/msconame-md.md)] 또는 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] Visual c # 프로그래밍 언어를 지원 합니다. 스크립트 태스크에서 스크립트를 만든 후에는 **ScriptLanguage** 속성의 값을 변경할 수 없습니다.  
