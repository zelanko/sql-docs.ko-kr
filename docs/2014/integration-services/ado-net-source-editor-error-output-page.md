...
3.  
  **ADO NET 원본 편집기**에서 **오류 출력**을 클릭합니다.  
...
## <a name="see-also"></a>참고 항목  
 [ADO NET 원본 편집기 &#40;연결 관리자 페이지&#41;](../../2014/integration-services/ado-net-source-editor-connection-manager-page.md)   
