...
3.  에 **제어 흐름** 디자인 화면에서 새로 추가 된을 마우스 오른쪽 단추로 클릭 **데이터 흐름 태스크**, 클릭 **이름 바꾸기**, 하도록 이름을 변경 하 고 `Extract Sample Currency Data`합니다.  
...
4.  데이터 흐름 태스크를 마우스 오른쪽 단추로 클릭 합니다. **속성**, 속성 창에서 있는지를 확인 하 고는 `LocaleID` 속성이로 설정 되어 **영어 (미국)** 합니다.  
