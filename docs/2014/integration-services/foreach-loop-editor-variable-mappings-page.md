...
# <a name="foreach-loop-editor-variable-mappings-page"></a>Foreach 루프 편집기(변수 매핑 페이지)
 ...
 [!INCLUDE[msCoName](../includes/msconame-md.md)] 패키지 만들기 자습서에는 Foreach 루프를 추가 하 고 구성 하는 방법을 설명 하는 단원이 포함 되어 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] 있습니다.  
 ...
 **관련 항목**: [Foreach 루프 컨테이너를 사용 하 여 Excel 파일 및 테이블 반복](control-flow/loop-through-excel-files-and-tables-by-using-a-foreach-loop-container.md)  
