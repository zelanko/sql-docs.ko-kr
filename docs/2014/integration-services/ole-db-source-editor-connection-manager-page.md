...
> [!NOTE]  
>  OLE DB `CommandTimeout` 원본의 속성은 **OLE DB 원본 편집기**에서 사용할 수 없지만 **고급 편집기**를 사용 하 여 설정할 수 있습니다. 이 속성에 대한 자세한 내용은 [OLE DB Custom Properties](data-flow/ole-db-custom-properties.md)의 Excel 원본 섹션을 참조하십시오.  
...
1.  
  [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] 에서 OLE DB 원본을 [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)]에 추가합니다.  
 ...
 **미리 보기**  
  ...
  **데이터 보기** 대화 상자를 사용하여 결과를 미리 봅니다. **Preview** 는 최대 200 개의 행을 표시할 수 있습니다.  
