...
##  <a name="specifying-a-result-set-type"></a><a name="Result_set_type"></a>결과 집합 유형 지정  
...
##  <a name="populating-a-variable-with-a-result-set"></a><a name="Populate_variable_with_result_set"></a>결과 집합으로 변수 채우기  
...
##  <a name="configuring-result-sets-in-the-execute-sql-task"></a><a name="Configure_result_sets"></a>SQL 실행 태스크에서 결과 집합 구성  
