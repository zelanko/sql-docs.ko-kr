...
|`Always`|검사점 파일을 항상 사용하고 패키지가 이전의 실행 오류 지점부터 다시 시작하도록 지정합니다. 검사점 파일을 찾을 수 없는 경우 패키지는 실패합니다.|  
...
### <a name="to-configure-the-checkpoint-properties"></a>검사점 속성을 구성하려면  
