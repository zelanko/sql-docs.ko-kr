...
ms.locfileid: "85469308"
---
# <a name="integration-services-error-and-message-reference"></a>Integration Services 오류 및 메시지 참조
  다음 표에서는 각 범주별로 미리 정의된 [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] 오류, 경고 및 정보 메시지를 숫자 코드 및 심볼 이름과 함께 오름차순으로 나열합니다. 이러한 각 오류는 네임 스페이스의 [Microsoft. Runtime. Runtime](/dotnet/api/microsoft.sqlserver.dts.runtime.hresults) 클래스에서 필드로 정의 됩니다. <xref:Microsoft.SqlServer.Dts.Runtime>  
