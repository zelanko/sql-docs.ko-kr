...
|**TextQualified**|텍스트 데이터가 인용 문자 등의 텍스트 한정자 문자로 묶 였는 지 여부를 나타냅니다. 유효한 값은<br /><br /> **True**: 플랫 파일의 텍스트 데이터가 한정 됩니다.<br /><br /> **False**: 플랫 파일의 텍스트 데이터가 한정 되지 않습니다.|  
