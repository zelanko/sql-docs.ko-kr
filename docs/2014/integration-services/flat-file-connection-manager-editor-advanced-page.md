...
|**TextQualified**|텍스트 데이터가 따옴표 문자 등의 텍스트 한정자 문자로 둘러싸여 있는지 여부를 나타냅니다. 유효한 값은 다음과 같습니다.<br /><br /> **True**: 플랫 파일의 텍스트 데이터가 한정 됩니다.<br /><br /> **False**: 플랫 파일의 텍스트 데이터가 한정 되지 않습니다.|  
