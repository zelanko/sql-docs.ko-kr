...
##  <a name="configure-the-options-in-the-containers-pane"></a><a name="container"></a>컨테이너 창에서 옵션 구성  
...
##  <a name="configure-the-options-on-the-details-tab"></a><a name="detail"></a>세부 정보 탭에서 옵션 구성  
