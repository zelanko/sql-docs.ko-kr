...
10. 속성 창에서 확인 하는 `LocaleID` 속성이 **영어 (미국)** 및 **DefaultCodePage** 속성이로 설정 되어 **1252**합니다.  
...
12. 속성 창에서 확인 하는 `LocaleID` 속성이 **영어 (미국)** 및 **DefaultCodePage** 속성이로 설정 되어 **1252**합니다.  
