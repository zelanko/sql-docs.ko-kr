...
# <a name="smtp-connection-manager"></a>SMTP 연결 관리자
  SMTP 연결 관리자를 사용하면 패키지에서 SMTP(Simple Mail Transfer Protocol) 서버에 연결할 수 있습니다. 에 포함 된 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] 메일 보내기 태스크에서는 SMTP 연결 관리자가 사용 됩니다.  
