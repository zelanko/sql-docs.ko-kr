...
# <a name="ado-net-destination"></a>ADO.NET 대상
 ...
 ADO NET 대상을 사용 하 여에 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]연결할 수 있습니다. OLE DB를 사용하여 [!INCLUDE[ssSDS](../../includes/sssds-md.md)] 에 연결할 수는 없습니다. 
  [!INCLUDE[ssSDS](../../includes/sssds-md.md)]에 대한 자세한 내용은 [일반 지침 및 제한 사항(Azure SQL Database)](https://go.microsoft.com/fwlink/?LinkId=248228)을 참조하세요.  
...
> [!NOTE]  
>  
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]는 데이터 형식이 이미지로 설정된 열에 텍스트 삽입을 지원하지 않습니다. 데이터 형식에 대 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 한 자세한 내용은 [데이터 형식 &#40;transact-sql&#41;](/sql/t-sql/data-types/data-types-transact-sql)을 참조 하세요.  
  
> [!NOTE]  
>  ADO.NET 대상은 DT_DBTIME 유형으로 설정된 입력 열을 datetime 유형으로 설정된 데이터베이스 열에 매핑하는 작업을 지원하지 않습니다. 데이터 형식에 대 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] 한 자세한 내용은 [Integration Services 데이터 형식](integration-services-data-types.md)을 참조 하세요.  
