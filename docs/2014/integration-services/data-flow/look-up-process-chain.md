...
# <a name="look-up-process-chain"></a>프로세스 체인 조회
 ...
 [!INCLUDE[msCoName](../../includes/msconame-md.md)] Connector 1.1 for SAP BW의 SAP BW 원본은 **프로세스 체인 조회** 대화 상자를 사용합니다. SAP BW 원본에 대한 자세한 내용은 [SAP BW Source](sap-bw-source.md)을 참조하십시오.  
