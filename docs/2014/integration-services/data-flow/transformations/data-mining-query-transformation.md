...
# <a name="data-mining-query-transformation"></a>데이터 마이닝 쿼리 변환
 ...
 모델이 동일한 데이터 마이닝 구조를 기반으로 하는 경우 하나의 변환에서 여러 개의 예측 쿼리를 실행할 수 있습니다. 자세한 내용은 참조 [데이터 마이닝 쿼리 인터페이스](../../../analysis-services/data-mining/data-mining-query-tools.md)합니다.  
