...
# <a name="row-sampling-transformation"></a>행 샘플링 변환
 ...
 이 변환은 입력 행의 비율을 선택하여 샘플 데이터 세트를 만드는 비율 샘플링 변환과 유사합니다. [Percentage Sampling Transformation](percentage-sampling-transformation.md)을 참조하세요.  
