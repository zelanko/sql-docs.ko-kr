 ...
 **추가**  
 ...
 기존 InfoObject를 추가하려면 추가를 클릭한 다음 **InfoObject 조회** 대화 상자를 사용하여 InfoObject를 찾습니다. 이 대화 상자에 대한 자세한 내용은 [Look Up InfoObject](look-up-infoobject.md)을 참조하십시오.  
