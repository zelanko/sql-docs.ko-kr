...
|--------------|---------------|-----------------|  
|ASConnectionId|문자열|연결 관리자의 고유 식별자입니다.|  
...
|ObjectRef|String|변환에서 사용하는 데이터 마이닝 구조를 식별하는 XML 태그입니다.|  
 ...
 자세한 내용은 [Data Mining Model Training Destination](data-mining-model-training-destination.md)을 참조하세요.  
