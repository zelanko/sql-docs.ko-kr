...
## <a name="expression-examples"></a>식 예  
 현재 날짜가 2003년 7월 4일 이전이면 이 예는 TRUE가 됩니다. 자세한 내용은 [GETDATE&#40;SSIS 식&#41;](getdate-ssis-expression.md)를 참조하세요.  
...
```  
 ...
 이 예에서는 변수 **LPrice**를 사용합니다. **LPrice** 의 값이 500보다 크거나 같으면 이 예는 TRUE가 됩니다. 식을 구문 분석하려면 변수의 데이터 형식이 숫자여야 합니다.  
