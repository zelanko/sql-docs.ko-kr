...
|**ValidateExternalMetadata**|스크립트 변환이 디자인 타임에서 외부 데이터 원본에 대해 열 메타데이터의 유효성을 검사할 것인지 여부를 나타냅니다. 값이 `false` 실행 시간까지 유효성 검사를 지연 합니다.|  
...
## <a name="see-also"></a>관련 항목  
 ...
 [스크립트 변환 편집기 &#40;입 / 출력 페이지&#41;](../../2014/integration-services/script-transformation-editor-inputs-and-outputs-page.md)   
