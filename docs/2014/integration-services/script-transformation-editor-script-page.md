...
|**UserComponentTypeName**|
  <xref:Microsoft.SqlServer.Dts.Pipeline.ScriptComponentHost> 인프라를 지원하는 `Microsoft.SqlServer.TxScript` 어셈블리 및 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 클래스를 지정합니다.|  
