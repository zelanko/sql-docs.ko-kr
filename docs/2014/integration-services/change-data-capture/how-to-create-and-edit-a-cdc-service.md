...
3.  새 Oracle CDC Service 대화 상자에서 필요한 정보를 입력합니다. 새 Oracle CDC Service 대화 상자에서 정보를 입력하는 방법은 [Create and Edit an Oracle CDC Service](create-and-edit-an-oracle-cdc-service.md) 을 참조하십시오.  
...
3.  CDC Service 속성 대화 상자에서 필요한 정보를 입력합니다. CDC Service 속성 대화 상자에서 정보를 입력하는 방법은 [Create and Edit an Oracle CDC Service](create-and-edit-an-oracle-cdc-service.md) 을 참조하십시오.  
