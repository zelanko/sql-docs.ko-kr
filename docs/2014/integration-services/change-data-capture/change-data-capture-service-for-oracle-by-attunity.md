...
## <a name="installation"></a>설치  
 ...
 Oracle CDC Service를 설치하려면 SQL Server 설치 미디어에서 **AttunityOracleCdcService.msi** 를 수동으로 실행합니다. X86 및 x64 설치 패키지에 살고 있는 **.\Tools\AttunityCDCOracle\\**  SQL Server 설치 미디어에 있습니다.  
