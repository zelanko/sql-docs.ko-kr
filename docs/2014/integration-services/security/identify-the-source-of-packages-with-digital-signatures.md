...
-   개별 패키지의 디지털 서명을 확인 하려면 `/VerifyS[igned]` **dtexec** 유틸리티를 사용 하 여 패키지를 실행할 때 옵션을 지정 합니다. 자세한 내용은 [dtexec Utility](../packages/dtexec-utility.md)를 참조하세요.  
