 ...
 **StandardInputVariable**  
 프로세스에 입력을 제공할 변수를 선택 하거나를 클릭 하 여 \<**New variable...**> 새 변수를 만듭니다.  
  
 **관련 항목:**  [변수 추가](../../2014/integration-services/add-variable.md)  
  
 **StandardOutputVariable**  
 프로세스 출력을 캡처할 변수를 선택 하거나 \<**New variable...**> 를 클릭 하 여 새 변수를 만듭니다.  
  
 **StandardErrorVariable**  
 프로세서의 오류 출력을 캡처할 변수를 선택 하거나를 클릭 하 여 \<**New variable...**> 새 변수를 만듭니다.  
