---
title: 추가, 삭제 또는 패키지에서 연결 관리자를 공유 | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
-   [프로젝트 수준의 연결 관리자를 추가 하려면](#project)  
...
##  <a name="project"></a> 프로젝트 수준의 연결 관리자를 추가 하려면  
