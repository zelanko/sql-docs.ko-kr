...
ms.locfileid: "62766434"
---
# <a name="ssis-designer"></a>SSIS 디자이너
  [!INCLUDE[ssIS](../includes/ssis-md.md)]디자이너는 패키지를 만들고 유지 관리 [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] 하는 데 사용할 수 있는 그래픽 도구입니다. [!INCLUDE[ssIS](../includes/ssis-md.md)]디자이너는 [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] 프로젝트의 [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)] 일부로에서 사용할 수 있습니다.  
...
-   런타임에 패키지의 실행 진행률 보기  
 ...
 ![SSIS 디자이너 및 도구 상자의 스크린 샷](media/denali-designerandtoolbox.gif "SSIS 디자이너 및 도구 상자의 스크린 샷")  
  
 [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)]에는 패키지에 기능을 추가 하는 추가 대화 상자 및 [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)] 창이 포함 되어 있으며 개발 환경을 구성 하 고 패키지를 사용 하는 데 사용할 수 있는 창과 대화 상자가 제공 됩니다. 자세한 내용은 [Integration Services 사용자 인터페이스](integration-services-user-interface.md)를 참조하세요.  
  
 [!INCLUDE[ssIS](../includes/ssis-md.md)]디자이너는 패키지를 관리 하 [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] 고 모니터링 하는 서비스에 종속 되지 않으며 디자이너에서 [!INCLUDE[ssIS](../includes/ssis-md.md)] 패키지를 만들거나 수정 하기 위해 서비스를 실행 하지 않아도 됩니다. 하지만 [!INCLUDE[ssIS](../includes/ssis-md.md)] 디자이너가 열려 있는 상태에서 서비스를 중지하면 [!INCLUDE[ssIS](../includes/ssis-md.md)] 디자이너에서 제공하는 대화 상자를 열 수 없으며 "RPC 서버를 사용할 수 없습니다"와 같은 오류 메시지가 표시될 수 있습니다. 
  [!INCLUDE[ssIS](../includes/ssis-md.md)] 디자이너를 다시 설정하고 패키지로 계속 작업하려면 디자이너를 닫고 [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)]를 종료한 다음 [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)], [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] 프로젝트 및 패키지를 다시 열어야 합니다.  
...
## <a name="parts-of-the-ssis-designer"></a>SSIS 디자이너의 구성 요소  
 [!INCLUDE[ssIS](../includes/ssis-md.md)]디자이너에는 각각 패키지 제어 흐름, 데이터 흐름, 매개 변수 및 이벤트 처리기를 빌드하기 위한 5 개의 탭과 패키지의 내용을 보기 위한 탭 하나가 있습니다. 런타임에는 실행 중인 패키지의 실행 과정과 실행 후의 결과를 보여 주는 6번째 탭이 나타납니다.  
 ...
 **제어** 흐름 탭의 디자인 화면에서 패키지의 제어 흐름을 구성 합니다. **도구 상자** 에서 디자인 화면으로 항목을 끌어 놓고 항목 아이콘을 클릭 한 다음 한 항목에서 다른 항목으로 화살표를 끌어서 컨트롤 흐름에 연결 합니다.  
  
 자세한 내용은 [Control Flow](control-flow/control-flow.md)을 참조하세요.  
  
### <a name="data-flow-tab"></a>데이터 흐름 탭  
 패키지에 데이터 흐름 태스크가 포함된 경우 패키지에 데이터 흐름을 추가할 수 있습니다. **데이터 흐름** 탭의 디자인 화면에서 패키지의 데이터 흐름을 구성 합니다. **도구 상자** 에서 디자인 화면으로 항목을 끌어다 놓고 항목 아이콘을 클릭 한 다음 한 항목에서 다른 항목으로 화살표를 끌어서 데이터 흐름에 연결 합니다.  
