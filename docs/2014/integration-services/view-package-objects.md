...
## <a name="see-also"></a>참고 항목
 [Integration Services 태스크](control-flow/integration-services-tasks.md) [Integration Services 컨테이너](control-flow/integration-services-containers.md) [선행 제약 조건](control-flow/precedence-constraints.md) [Integration Services &#40;](integration-services-ssis-variables.md) ssis&#41; [이벤트 처리기](integration-services-ssis-event-handlers.md) Integration Services ssis &#40;[로깅](performance/integration-services-ssis-logging.md)&#41;
