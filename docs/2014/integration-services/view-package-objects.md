...
# <a name="view-package-objects"></a>패키지 개체 보기
 ...
 패키지의 컨테이너 및 태스크인 실행 개체에는 이벤트 처리기, 선행 제약 조건 및 변수가 포함될 수 있습니다. [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)]는 컨테이너의 중첩 된 계층 구조를 지원 하 고 For 루프, Foreach 루프 및 시퀀스 컨테이너에는 다른 실행 파일을 포함할 수 있습니다.  
 ...
 ![패키지 탐색기 탭의 스크린 샷](media/packageexplorer.gif "패키지 탐색기 탭의 스크린 샷")  
