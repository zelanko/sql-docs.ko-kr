...
## <a name="see-also"></a>참고 항목
 [Integration Services에 대 한 사용자 지정 개체 개발](developing-custom-objects-for-integration-services.md) [사용자 지정 개체 유지](persisting-custom-objects.md) [패키지 개발을 위한 문제 해결 도구](../troubleshooting/troubleshooting-tools-for-package-development.md)
