...
## <a name="see-also"></a>참고 항목  
 [Integration Services에 대 한 사용자 지정 개체 개발](developing-custom-objects-for-integration-services.md)   
 [사용자 지정 개체 빌드, 배포 및 디버깅](building-deploying-and-debugging-custom-objects.md)  
