...
-   **SQL Server에서 패키지 저장**. 다음 데이터베이스에 패키지를 저장할 수 있습니다.  
    ...
    |[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Integration Services|인스턴스의 msdb 데이터베이스 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]|  
     ...
     인스턴스에서 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]의 인스턴스에서 패키지를 가져올 수 [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 또는의 인스턴스에서 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)], 있지만의 인스턴스로 패키지를 내보낼 수 없습니다 [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 또는 인스턴스에 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]합니다.  
...
-   **패키지 실행**. 실행할 수 있습니다 [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] Integration Services 및 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 를 사용 하 여 Integration Services 패키지는 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 버전의는 **dtexec** 유틸리티 또는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 에이전트입니다. 때마다는 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 에서 개발 된 패키지를 로드 하는 Integration Services 도구 [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 또는 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)], 메모리에는 도구에서 일시적으로 변환, 패키지에 패키지 형식으로 [!INCLUDE[ssISCurrent](../../includes/ssiscurrent-md.md)] 사용 합니다. 경우는 [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 또는 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 패키지에 성공적인 변환을 방해 하는 문제는 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Integration Services 도구는 이러한 문제가 해결 될 때까지 패키지를 실행할 수 없습니다. 자세한 내용은 [Upgrade Integration Services Packages](upgrade-integration-services-packages.md)를 참조하세요.  
