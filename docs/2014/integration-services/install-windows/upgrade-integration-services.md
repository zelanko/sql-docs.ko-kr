...
-   [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 또는 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]인스턴스에 저장 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] 된 패키지를 관리 하는 데 사용 [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] 합니다. [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 인스턴스를 서비스에서 관리하는 위치 목록에 추가하려면 서비스 구성 파일을 수정해야 합니다.  
