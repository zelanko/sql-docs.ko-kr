...
5.  **변수** 창에서 **변수 추가** 아이콘을 클릭 합니다. 새 변수가 목록에 추가됩니다.  
  
6.  필요에 따라 **표 옵션** 아이콘을 클릭하고 **가변 눈금 옵션** 대화 상자에 표시할 추가 열을 선택한 다음 **확인**을 클릭합니다.  
  
7.  필요에 따라 변수 속성을 설정합니다. 자세한 내용은 [사용자 정의 변수의 속성 설정](../../2014/integration-services/set-the-properties-of-a-user-defined-variable.md)에 의해 정의됩니다.  
...
4.  삭제할 변수를 선택한 다음 **변수 삭제**를 클릭합니다.  
     ...
     변수 창에 변수가 표시 되지 않는 경우 **표 옵션** 을 클릭 하 고 **모든 범위의 변수 표시**를 선택 합니다.  
