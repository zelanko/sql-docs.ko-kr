...
##  <a name="ValidateXML"></a>XML 태스크에서 풍부한 XML 유효성 검사 출력  
 XML 태스크의 `ValidationDetails` 속성을 사용하도록 설정하여 XML 문서의 유효성을 검사하고 풍부한 오류 출력을 가져올 수 있습니다. 
  ...
  `ValidationDetails` 서비스 팩 2에는 [!INCLUDE[ssSQL11](../includes/sssql11-md.md)] 속성이 도입되었습니다. 이 새 속성은 당시에는 발표되거나 문서화되지 않았습니다. 
  `ValidationDetails` 속성 또한 [!INCLUDE[ssSQL14](../includes/sssql14-md.md)] 및 SQL Server 2016에서 사용할 수 있습니다.  
