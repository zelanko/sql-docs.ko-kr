 ...
 **환경 변수 사용**  
 프로젝트 또는 패키지에서 참조하는 환경에 저장된 변수 값을 사용하려면 이 옵션을 선택합니다. 프로젝트 또는 패키지에 대한 환경 참조를 추가하려면 **구성** 대화 상자를 사용합니다. 자세한 내용은 [Configure Dialog Box](configure-dialog-box.md)을 참조하세요.  
