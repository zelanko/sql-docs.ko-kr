...
|**Maximum**|그룹의 최대값을 반환합니다. 숫자 데이터 형식에서만 실행됩니다.|  
 ...
 **Count Distinct Scale**  
 필요에 따라 집계에서 쓸 수 있는 고유한 값의 수를 대략적으로 지정합니다. 이 옵션의 기본값은 **Unspecified**입니다. `CountDistinctScale`및 **CountDistinctKeys** 가 모두 지정 된 경우 **CountDistinctKeys** 가 우선적으로 적용 됩니다.  
 ...
 **Count Distinct Keys**  
 필요에 따라 집계에서 쓸 수 있는 고유한 값의 수를 정확하게 지정합니다. `CountDistinctScale`및 **CountDistinctKeys** 가 모두 지정 된 경우 **CountDistinctKeys** 가 우선적으로 적용 됩니다.  
