...
-   비디오 [(SQL Server 비디오) Excel로 SQL Server 데이터 내보내기](https://go.microsoft.com/fwlink/?LinkID=200975), technet.microsoft.com  
  
-   CodePlex 샘플 [ODBC에서 사용 하 여 플랫 파일 마법사 내보내기 자습서: 단원 패키지](https://go.microsoft.com/fwlink/?LinkId=217657), msftisprodsamples.codeplex.com  
