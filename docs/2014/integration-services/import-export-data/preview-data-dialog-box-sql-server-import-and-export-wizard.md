...
# <a name="preview-data-dialog-box-sql-server-import-and-export-wizard"></a>데이터 미리 보기 대화 상자(SQL Server 가져오기 및 내보내기 마법사)
 ...
 에 대해 자세히 알아보려면 합니다 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 가져오기 및 내보내기 마법사를 참조 하십시오 [SQL Server 가져오기 및 내보내기 마법사](import-and-export-data-with-the-sql-server-import-and-export-wizard.md)합니다. 마법사 시작 옵션에 대 한 마법사를 성공적으로 실행 하는 데 필요한 권한에 대 한 자세한 내용은 참조 하세요 [SQL Server 가져오기 및 내보내기 마법사를 실행](start-the-sql-server-import-and-export-wizard.md)합니다.  
 ...
 **데이터 미리 보기 대화 상자를 열려면**  
  
-   에 **원본 테이블 및 뷰 선택** 페이지의 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 가져오기 및 내보내기 마법사 **미리 보기**합니다.  
  
## <a name="options"></a>변수  
 **원본**  
 마법사가 데이터 원본에 보내는 쿼리를 표시합니다.  
  
 **샘플 데이터 표**  
 쿼리에서 반환되는 샘플 데이터 행을 최대 200개까지 표시합니다.  
