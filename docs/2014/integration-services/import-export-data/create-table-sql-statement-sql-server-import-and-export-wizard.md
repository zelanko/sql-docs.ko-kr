...
ms.locfileid: "36092883"
---
# <a name="create-table-sql-statement-sql-server-import-and-export-wizard"></a>테이블 생성 SQL 문(SQL Server 가져오기 및 내보내기 마법사)
  사용 하 여는 **테이블 생성 SQL 문** 대화 상자를 자동으로 생성 된 정보 보호 정책을 보려면 하거나 용도 맞게 수정할 수 있습니다. 이 문을 수정하면 관련 변경 내용을 열 매핑에 적용해야 할 수도 있고 그에 따라 편집된 SQL 문을 직접 유지 관리해야 합니다.  
