...
### <a name="examples-using-methods-and-properties"></a>예를 들면 다음과 같습니다. 메서드 및 속성 사용  
...
```  
 ...
 이 예에서는 SMO **스크립트** 포함 된 스크립트를 생성 하는 메서드는 `CREATE VIEW` 문을 다시 AdventureWorks2012에에서 뷰를 만드는 데 필요 합니다.  
