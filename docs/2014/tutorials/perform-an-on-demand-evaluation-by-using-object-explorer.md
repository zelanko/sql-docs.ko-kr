...
> [!NOTE]  
>  실행 중인 인스턴스에 대해 최선의 구현 방법 정책의 요청 시 평가를 수행 하려면 등록 된 [!INCLUDE[ssVersion2005](../includes/ssversion2005-md.md)] [서버를 사용 하 여 요청 시 평가 수행](../../2014/tutorials/perform-an-on-demand-evaluation-by-using-registered-servers.md)항목의 절차를 사용 해야 합니다.  
