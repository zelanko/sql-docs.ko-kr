...
# <a name="lesson-3-adding-and-processing-models"></a>3단원: 모델 추가 및 처리
 ...
 이 단원의 작업을 완료 하려면 사용 합니다 [Microsoft Clustering Algorithm](../../2014/analysis-services/data-mining/microsoft-clustering-algorithm.md) 하며 [Microsoft Naive Bayes 알고리즘](../../2014/analysis-services/data-mining/microsoft-naive-bayes-algorithm.md).  
