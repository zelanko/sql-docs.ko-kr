...
ms.locfileid: "62720024"
---
# <a name="summary-writing-transact-sql"></a>요약: Transact-SQL 작성
  쿼리 편집기는 개발에서 [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 보다 정교한 제작 환경을 위한 중요 한 단계입니다. 손쉽게 쿼리 편집기를 전체 화면 모드로 전환하여 코드를 보거나 빠르게 다른 서버로 연결을 전환할 수 있습니다. 추가 기능은 **도구** 메뉴에서 사용할 수 있는 **옵션** 대화 상자에서 찾는 것이 좋습니다.  
