---
title: '2 단원: 타겟된 메일링 구조 (기본 데이터 마이닝 자습서) 구축 | Microsoft Docs'
ms.custom: ''
ms.date: 03/06/2017
...
ms.locfileid: "48086475"
---
# <a name="lesson-2-building-a-targeted-mailing-structure-basic-data-mining-tutorial"></a>2 단원: 타겟된 메일링 구조 (기본 데이터 마이닝 자습서) 구축
