...
1.  이제 전환할는 **제어 흐름** 탭 합니다.  
  
2.  끌어서 놓기 **SQL 실행 태스크** 에서 **SSIS 도구 상자** 에 **제어 흐름** 탭 합니다.  
  
3.  마우스 오른쪽 단추로 클릭 **SQL 실행 태스크** 에 **제어 흐름** 탭을 클릭 **이름 바꾸기**합니다. 형식 **Trigger Stored Procedure to Load Data into MDS** 누릅니다 **ENTER**합니다.  
  
4.  연결 **Receive, Cleanse, 일치 및 Curate Supplier Data** 를 **Trigger Stored Procedure to Load Data** 의 녹색 연결선을 사용 하 여 합니다.  
  
     ![SQL 실행 태스크에 연결](../../2014/tutorials/media/et-addingesqltasktocftorunthespformds-01.jpg "SQL 실행 태스크에 연결")  
  
5.  사용 하는 **변수** 창에서 다음 설정을 갖는 두 개의 새 변수를 추가 합니다. 표시 되지 않으면는 **변수** 창 클릭 **SSIS** 클릭 메뉴 모음에서 **변수**합니다.  
...
6.  두 번 클릭 **MDS에 데이터를 로드 하는 저장된 프로시저를 트리거할**합니다.  
...
10. 에 **매개 변수 매핑을** 페이지 **추가** 매핑을 추가 하려면. 드롭 다운 목록의 값이 올바르게 표시되도록 창을 최대화하고 열 크기를 조정합니다.  
  
11. 선택 **user:: versionname** 에 대 한 드롭다운 목록에서는 **변수 이름**합니다.  
  
12. 선택 **NVARCHAR** 에 대 한 **데이터 형식을**합니다.  
  
13. 형식 **0** (영)을 **매개 변수 이름**합니다.  
...
14. 이전 4개 단계를 반복해서 변수를 두 개 더 추가합니다.  
    ...
    |User::BatchTag|NVARCHAR|2|  
     ...
     ![SQL 실행 태스크 편집기-매개 변수 매핑을](../../2014/tutorials/media/et-addingesqltasktocftorunthespformds-04.jpg "SQL 실행 태스크 편집기-매개 변수 매핑")  
  
15. 클릭 **확인** 를 닫으려면는 **SQL 편집기 실행** 대화 상자.  
