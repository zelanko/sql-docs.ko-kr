...
# <a name="creating-a-solution-and-data-source-intermediate-data-mining-tutorial"></a>솔루션 및 데이터 원본 만들기(중급 데이터 마이닝 자습서)
 ...
 프로젝트에 대 한 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 자세한 내용은 [Analysis Services 프로젝트 &#40;만들기 SSDT&#41;](https://docs.microsoft.com/analysis-services/multidimensional-models/create-an-analysis-services-project-ssdt)를 참조 하세요.  
...
|[4단원: 시퀀스 클러스터링 시나리오 &#40;빌드 중급 데이터 마이닝 자습서&#41;](../../2014/tutorials/lesson-4-build-sequence-clustering-scenario-intermediate-data-mining.md)|항목이 구매된 순서를 표시하는 식별자를 추가하여 시장 바구니 분석에 사용되는 동일한 데이터|  
