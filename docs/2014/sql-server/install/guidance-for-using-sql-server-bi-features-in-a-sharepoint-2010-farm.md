...
-   SharePoint 개발자 도구는 SharePoint 독립 실행형 구성만 지원합니다.  자세한 내용은 SharePoint 설명서를 참조 하십시오.: [SharePoint 솔루션 개발 요구 사항](http://msdn.microsoft.com/library/ee231582.aspx)합니다.  
