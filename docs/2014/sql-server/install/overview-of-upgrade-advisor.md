...
|[업그레이드 관리자 실행 &#40;사용자 인터페이스&#41;](../../../2014/sql-server/install/running-upgrade-advisor-user-interface.md)|업그레이드 관리자 분석 마법사와 업그레이드 관리자 보고서 뷰어를 시작하고 실행하는 방법에 대해 설명합니다.|  
...
## <a name="see-also"></a>관련 항목  
 ...
 [업그레이드 관리자 실행 &#40;명령 프롬프트&#41;](../../../2014/sql-server/install/running-upgrade-advisor-command-prompt.md)  
