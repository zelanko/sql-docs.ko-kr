...
-   데이터 경고를 비롯하여 SharePoint 모드의 Reporting Services.  
 ...
 자세한 내용은의 기능 테이블을 참조 하십시오. [SharePoint와 SQL Server BI 기능 설치 &#40;PowerPivot 및 Reporting Services&#41;](../../../2014/sql-server/install/install-sql-server-bi-features-sharepoint-powerpivot-reporting-services.md)합니다.  
...
-   [가상 환경에 대 한 라이선스](http://www.microsoft.com/licensing/about-licensing/virtualization.aspx) (http://www.microsoft.com/licensing/about-licensing/virtualization.aspx)합니다.  
...
-   [SharePoint 구입 방법](http://sharepoint.microsoft.com/en-in/Pages/buy.aspx) (http://sharepoint.microsoft.com/en-in/Pages/buy.aspx)합니다.  
  
##  <a name="bkmk_3tier_powerpivot"></a> 별도 있는 3 계층 토폴로지 [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] 서버  
...
-   팜 외부에서 실행 (2) PowerPivot 모드의 analysis Services 하지만 PowerPivot 실행 되 고 **동일한 물리적** 다른 응용 프로그램 역할의 서버입니다.  
  
-   데이터베이스 역할 (3) SQL Server Enterprise를 사용 하 여 있도록는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 기능, AlwaysOn Availability Groups를 사용할 수 있습니다.  
...
##  <a name="bkmk_reference"></a> 참조 서 및 커뮤니티 내용  
...
-   [라이선싱 정보: 클라이언트 액세스 라이선스 및 라이선스 관리](http://www.microsoft.com/licensing/about-licensing/client-access-license.aspx) (http://www.microsoft.com/licensing/about-licensing/client-access-license.aspx)합니다.  
  
-   [라이선싱 정보: 제품 라이선싱 검색](http://www.microsoftvolumelicensing.com/default.aspx) (http://www.microsoftvolumelicensing.com/default.aspx)합니다.  
  
-   [볼륨 라이선싱: 가격 및 구입 방법](http://www.microsoft.com/licensing/how-to-buy/how-to-buy.aspx) (http://www.microsoft.com/licensing/how-to-buy/how-to-buy.aspx)합니다.  
