...
##  <a name="install-reporting-services-report-server-in-sharepoint-mode"></a><a name="bkmk_install_SSRS"></a>SharePoint 모드에서 Reporting Services 보고서 서버 설치  
...
##  <a name="install-and-start-the-reporting-services-sharepoint-service"></a><a name="bkmk_install_SSRS_sharedservice"></a>Reporting Services SharePoint 서비스 설치 및 시작  
...
##  <a name="create-a-reporting-services-service-application"></a><a name="bkmk_create_serrviceapplication"></a>Reporting Services 서비스 응용 프로그램 만들기  
