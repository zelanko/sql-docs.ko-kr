...
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 설치 프로그램  
 ...
 설치가 완료 된 후에 CEIP 보고를 사용 하지 않도록 설정 하려면 구성 도구 메뉴의 ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 오류 및 사용 보고** 도구를 사용 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **Configuration Tools** 합니다.  
