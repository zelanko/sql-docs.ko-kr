...
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 인스턴스 이름 - [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 장애 조치(Failover) 클러스터에 대한 인스턴스 이름을 선택합니다.  
  
-   이 노드의 이름 - 이 필드는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 설치 프로그램을 실행하는 컴퓨터의 이름으로 미리 채워집니다.  
