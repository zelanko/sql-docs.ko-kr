...
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 인스턴스 이름-에 대 한 인스턴스 이름을 선택 하 여 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 장애 조치 클러스터입니다.  
  
-   이 노드의 이름-이 필드는 컴퓨터 이름으로 미리 채워져 있는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 설치 프로그램을 실행 합니다.  
  
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 장애 조치 클러스터 네트워크 이름-이 필드는 미리 채워지지 않습니다. 새 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 장애 조치(Failover) 클러스터 인스턴스에 대한 네트워크 이름을 지정하십시오. 이 이름은 네트워크에서 장애 조치(Failover) 클러스터 인스턴스를 식별하는 이름입니다.  
