---
title: SQL Server 장애 조치 (Failover) 클러스터 마법사-준비 | Microsoft Docs
ms.custom: ''
ms.date: 05/24/2017
...
ms.locfileid: "85065177"
---
# <a name="sql-server-failover-cluster-wizard---prepare"></a>SQL Server 장애 조치(Failover) 클러스터 마법사 - 준비
