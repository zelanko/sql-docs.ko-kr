---
title: Microsoft SQL Server Reporting Services SharePoint 공유 서비스는 설치 된 Side-by-side (업그레이드 관리자) | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="description"></a>Description  
 업그레이드 관리자 검색 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] SharePoint 공유 서비스가 이전 버전의와 함께 설치 되어 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] SharePoint 공유 서비스 아키텍처를 기반으로 하는 없습니다. 컴퓨터에 이전 및 최신 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] SharePoint 관련 기술이 함께 설치되어 있기 때문에 업그레이드가 차단됩니다.  
