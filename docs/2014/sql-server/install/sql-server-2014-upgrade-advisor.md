...
ms.locfileid: "36185541"
---
# <a name="sql-server-2014-upgrade-advisor"></a>SQL Server 2014 업그레이드 관리자
  [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 업그레이드 관리자의 구성을 분석 하 여 설치 된 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 구성 요소를 성공적으로 업그레이드 하기 위해 해결 해야 하는 문제에 대 한 보고서를 생성 합니다.  
