...
|**[!INCLUDE[applies](../../includes/applies-md.md)]**  SharePoint 2013 &#124; SharePoint 2010|  
 ...
 ![참고](../../../2014/reporting-services/media/rs-fyinote.png "참고") 현재 릴리스 정보를 참조 하세요. [SQL server 2014 릴리스 정보](https://go.microsoft.com/fwlink/?LinkID=296445)합니다.  
...
1.  SharePoint 모드의 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 설치는 이전 릴리스와 달라지지 않았습니다.  
    ...
    3.  [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] SharePoint 서비스와 하나 이상의 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 서비스 애플리케이션을 구성합니다. 자세한 내용은 "Reporting Services 서비스 응용 프로그램 만들기" 섹션을 참조 [Reporting Services SharePoint 모드 설치 SharePoint 2013 용](../../../2014/sql-server/install/install-reporting-services-sharepoint-mode-for-sharepoint-2013.md)합니다.  
