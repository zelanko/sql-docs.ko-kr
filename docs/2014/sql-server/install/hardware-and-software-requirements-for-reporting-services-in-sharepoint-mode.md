...
-   로컬 설치의 경우 SharePoint 및 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 설치 중 로그인된 계정은 로컬 운영 체제의 administrators 그룹의 구성원이어야 합니다. 설치 계정이 SharePoint 팜 관리자 그룹의 구성원이 될 필요는 없습니다.  
     ...
     자세한 내용은 [SharePoint 2013에서의 계정 권한 및 보안 설정](http://technet.microsoft.com/library/cc678863.aspx)을 참조하세요.  
...
-   SharePoint 모드로 실행 중인 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]에는 SharePoint Server가 필요합니다. SharePoint 요구 사항 및 구성에 대한 자세한 내용은 다음을 참조하세요.  
    ...
    -   [비즈니스 인텔리전스에 대한 소프트웨어 요구 사항(SharePoint 2013)](http://go.microsoft.com/fwlink/p/?LinkId=256367)  
  
    -   [하드웨어 및 소프트웨어 요구 사항(SharePoint Server 2010)](http://technet.microsoft.com/library/cc262485\(v=office.14\))  
  
    -   [SharePoint Server 2010의 용량 관리 및 크기 조정](http://technet.microsoft.com/library/cc261700.aspx\(v=office.14\))  
...
-   [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 와 SharePoint 제품 및 기술은 모두 SQL Server 관계형 데이터베이스를 사용하여 응용 프로그램 데이터를 저장합니다.  
...
-   SharePoint 제품에서는 기존 데이터베이스 인스턴스를 사용할 수 있습니다. [!INCLUDE[ssDE](../../includes/ssde-md.md)] 의 인스턴스가 설치되지 않은 경우 SharePoint 제품 설치 프로그램은 SharePoint 응용 프로그램 데이터베이스에 대해 SQL Server Express Edition을 설치합니다.  
