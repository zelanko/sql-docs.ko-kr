...
|구성 시작|Workflow|구성 종료|주석|  
|----------------------------|--------------|--------------------------|--------------|  
|[!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]로컬 모드|설치|연결된 모드 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].||  
...
|SQL Server [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] Reporting Services 및 데이터베이스 엔진을 설치합니다.|[SharePoint 2010에 대 한 Reporting Services SharePoint 모드 설치](../../../2014/sql-server/install/install-reporting-services-sharepoint-mode-for-sharepoint-2010.md)|  
...
|서비스 애플리케이션에 대한 전자 메일 설정을 구성합니다.|[Reporting Services 서비스 응용 프로그램에 대 한 전자 메일 구성 &#40;SharePoint 2010 및 SharePoint 2013&#41;](../../reporting-services/install-windows/configure-e-mail-for-a-reporting-services-service-application.md)|  
|c2WTS(Windows 토큰 서비스에 대한 클레임) 구성|[Windows 토큰 서비스에 대 한 클레임 &#40;C2WTS&#41; 및 Reporting Services](../../../2014/sql-server/install/claims-to-windows-token-service-c2wts-and-reporting-services.md)|  
