...
# <a name="deployment-checklist-install-reporting-services-into-an-existing-sharepoint-farm"></a>배포 검사 목록: 기존 SharePoint 팜에 Reporting Services 설치
  [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] SharePoint 보고서 서버를 새로운 SharePoint 팜 또는 기존 SharePoint 팜에 설치할 수 있습니다. 이 항목에서는 가능한 시나리오 및 설치를 위한 모범 사례를 설명 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 에 기존 SharePoint 팜에 합니다.  
...
|인스턴스를 결정 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 보고서 서버 데이터베이스를 호스팅해야 합니다. 로컬 또는 원격 인스턴스를 사용할 수 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]합니다. 보고서에 맞는 저장 용량을 가진 컴퓨터에 있는 인스턴스를 선택해야 합니다.||  
...
|참고: 이전 CTP 릴리스에서 컴퓨터를 업그레이드 하는 경우 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 가 구성 파일에 사용자 지정 변경 내용을 적용 하 고를 업그레이드를 구성 파일에 동일한 변경 내용을 확인 해야 합니다 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]합니다. 관련이 있는 파일은 **web.config** 및 **client.config**입니다.||  
  
## <a name="installation-scenarios"></a>설치 시나리오  
 다음 표에서 설치 하는 경우 가능한 시나리오에 설명 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 에 기존 SharePoint 팜에 합니다. 로컬 모드에서는 보고서를 로컬로와 통합 하지 않고도 SharePoint 문서 라이브러리에서 렌더링할 수는 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 보고서 서버. SharePoint 제품용 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 추가 기능은 필요하지만 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 보고서 서버는 아닙니다. 로컬 모드에 대한 자세한 내용은 [보고서 뷰어의 로컬 모드와 보고서 뷰어에서 연결 모드 &#40;Reporting Services SharePoint 모드에서&#41; ](../../../2014/reporting-services/local-vs-connected-mode-report-viewer-reporting-services-sharepoint-mode.md) 및 [SharePoint 제품용 Reporting Services 추가 기능 검색 위치](../../reporting-services/install-windows/where-to-find-the-reporting-services-add-in-for-sharepoint-products.md)합니다.  
...
|하나 이상의 SSRS 서비스 응용 프로그램을 만들고 서비스 응용 프로그램 연결을 구성합니다.|' 서비스 응용 프로그램 ' 섹션을 참조 [Reporting Services SharePoint 모드 설치에 대 한 SharePoint 2010](../../../2014/sql-server/install/install-reporting-services-sharepoint-mode-for-sharepoint-2010.md)|  
|**추가 구성**||  
...
|서비스 응용 프로그램에 대한 전자 메일 설정을 구성합니다.|[A Reporting Services 서비스 응용 프로그램에 대 한 전자 메일을 구성 &#40;SharePoint 2010 및 SharePoint 2013&#41;](../../reporting-services/install-windows/configure-e-mail-for-a-reporting-services-service-application.md)|  
|c2WTS(Windows 토큰 서비스에 대한 클레임) 구성|[클레임을 Windows 토큰 서비스 &#40;C2WTS&#41; 및 Reporting Services](../../../2014/sql-server/install/claims-to-windows-token-service-c2wts-and-reporting-services.md)|  
...
|모든 웹 응용 프로그램을 새로운 매핑할 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]서비스 응용 프로그램|새 설치 **가 이제 작동**|  
