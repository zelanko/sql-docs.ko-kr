---
title: SQL Server 장애 조치 클러스터 마법사-설치 | Microsoft Docs
ms.custom: ''
ms.date: 05/24/2017
...
ms.locfileid: "63156757"
---
# <a name="sql-server-failover-cluster-wizard---install"></a>SQL Server 장애 조치(Failover) 클러스터 마법사 - 설치
