...
-   Windows Installer 4.5. Windows Installer를 설치할 수는 [Windows Installer 웹 사이트](http://go.microsoft.com/fwlink/?LinkId=49112)합니다.  
  
-   [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)](.NET Framework 4부터 해당). [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] 에서 확인할 수 있습니다 합니다 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 제품 미디어에서 합니다 [SDK, 재배포 가능 패키지 및 서비스 팩 다운로드 웹 사이트](http://go.microsoft.com/fwlink/?LinkId=48882).  
