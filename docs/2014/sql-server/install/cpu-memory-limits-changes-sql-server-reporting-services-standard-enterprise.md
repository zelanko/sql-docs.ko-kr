...
### <a name="description"></a>Description  
 ...
 다른 버전의 CPU 및 메모리 제한에 대 한 자세한 내용은 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [SQL Server 버전별 계산 용량 제한](../compute-capacity-limits-by-edition-of-sql-server.md)및 [SQL Server 버전에서 지 원하는 메모리](https://go.microsoft.com/fwlink/?LinkId=212633)를 참조 하세요.  
