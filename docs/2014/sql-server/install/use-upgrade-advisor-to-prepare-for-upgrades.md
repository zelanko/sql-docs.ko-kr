...
-   Microsoft .NET Framework 4 .NET Framework 4는 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 제품 미디어와 [.NET Framework 4 다운로드 페이지](https://go.microsoft.com/fwlink/?LinkId=209895)에서 사용할 수 있습니다.  
...
-   **시작**을 클릭 하 고 **모든 프로그램**, [!INCLUDE[ssCurrentUI](../../includes/sscurrentui-md.md)]을 차례로 가리킨 다음 **[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 업그레이드 관리자**를 클릭 합니다.  
