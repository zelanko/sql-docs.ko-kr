---
title: 사용자 지정 보고서 항목이 보고서 서버 (업그레이드 관리자)에서 검색 됨 | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
