 ...
 **섹션 내용**  
 ...
 [전자 메일 배달 &#40;SSRS에 대 한 보고서 서버 구성 Configuration Manager&#41;](../../../2014/sql-server/install/configure-a-report-server-for-e-mail-delivery-ssrs-configuration-manager.md)  
