...
# <a name="deployment-checklist-reporting-services-power-view-and-powerpivot-for-sharepoint"></a>배포 검사 목록: Reporting Services, Power View 및 SharePoint용 PowerPivot
  다음 검사 목록을 사용 하 여 동일한 SharePoint 팜에 이러한 BI 기능을 설치 합니다. SharePoint용 PowerPivot, 보고서 작성기 및 @no__t 0입니다. 이 검사 목록에서는 특정 설치 순서를 권장하지만 실제로는 어떠한 순서로도 이 기능을 설치할 수 있습니다. 이 검사 목록에서는 다음 제품 또는 기능이 설치되어 있다고 가정합니다.  
...
|SharePoint Server 2010 SP1 설치|[@No__t-1](https://go.microsoft.com/fwlink/p/?linkID=219697)에서 s p 1을 다운로드 합니다.|  
...
|팜이 작동하는지 확인|먼저 중앙 관리를 시작하여 팜이 사용 가능한지 확인합니다. 그런 다음 http://localhost 을 입력 하 여 팀 사이트를 엽니다.  SharePoint 팀 사이트가 표시되어야 합니다.|  
