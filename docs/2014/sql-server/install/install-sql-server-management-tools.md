...
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 데이터베이스 튜닝 관리자  
  
-   sqlcmd.exe 및 osql.exe와 같은 명령 프롬프트 도구  
...
## <a name="see-also"></a>참고 항목  
 ...
 [SQL Server 2014의 버전 및 구성 요소](../editions-and-components-of-sql-server-2016.md)   
