---
title: 전체 텍스트 검색 단어 분리기와 필터가 크게 향상 되었습니다. SQL Server 2005 및 SQL Server 2008 | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="description"></a>Description  
 ...
 단어 분리기에 대 한 정보를 참조 하십시오. [관리 단어 분리기와 형태소 분석기 검색에 대 한 구성 및](../../relational-databases/search/configure-and-manage-word-breakers-and-stemmers-for-search.md)합니다.  
