...
|[SQL Server BI 기능 설치 문제 확인 또는 문제 해결](../../../2014/sql-server/install/verify-or-troubleshoot-sql-server-bi-feature-installation-problems.md)|이 섹션에는 설치 확인을 위한 단계가 포함됩니다. 또한 웹에 대한 문제 해결 정보 링크를 제공합니다.|  
