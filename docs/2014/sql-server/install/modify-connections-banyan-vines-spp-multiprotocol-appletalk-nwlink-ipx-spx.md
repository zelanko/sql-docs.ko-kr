...
## <a name="corrective-action"></a>수정 동작  
 ...
 응용 프로그램 연결 문자열에서 이러한 프로토콜 중 하나를 사용 하는 경우, RPC에 대해 NETWORK = DBMSRPCN을 지정 하 고, 네트워크 = DBMSRPCN을 지정 하 여 Appletalk를 사용 합니다. 또는 네트워크 = DBMSVINN for Banyan VINES 속성에 대해 또는 "spx: 서버 \ 인스턴스" (예: SPX의 경우 "spx:**"), "*bv: Server*" (banyan VINES), "adsp:*server*" (Appletalk의 경우) 또는 "*RPC: server"의*경우 지원 되는 프로토콜 중 하나를 사용 하도록 응용 프로그램을 수정 해야 합니다.  
