 ...
 **포트**  
 보고서 서버에서 요청을 모니터링하는 포트를 지정합니다. 기본 포트는 포트 80입니다. 포트 80을 사용할 경우 URL에 포트 번호를 포함시킬 필요가 없습니다. 다른 포트 번호를 사용 하는 경우 URL에 항상 포함 해야 http://localhost:8181/reports)합니다 (예:).  
