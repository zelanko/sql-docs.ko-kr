...
-   [SharePoint 2013 예제 배포 토폴로지](#bkmk_example_deployments_2013)  
    ...
    -   [SharePoint용 PowerPivot 2013 및 Reporting Services 세 가지 서버 배포](#bkmk_bi_Sharepoint2013_3tier)  
  
    -   [SharePoint용 PowerPivot 2013 단일 서버 배포](#bkmk_powerpivot_sharepoint2013_1server)  
  
    -   [SharePoint용 PowerPivot 2013 2 서버 배포](#bkmk_powerpivot_sharepoint2013_2server)  
  
    -   [SharePoint용 PowerPivot 2013 3 서버 배포](#bkmk_powerpivot_sharepoint2013_3server)  
  
    -   [SharePoint용 PowerPivot 2013 및 Reporting Services 단일 서버 배포](#bkmk_powerpivot_ssrs_sharepoint2013_1server)  
  
    -   [SharePoint용 PowerPivot 2013 및 Reporting Services 두 서버 배포](#bkmk_powerpivot_ssrs_sharepoint2013_2server)  
...
###  <a name="bkmk_bi_Sharepoint2013_3tier"></a>SharePoint용 PowerPivot 2013 및 Reporting Services 세 가지 서버 배포  
...
|**(7)**|SharePoint 콘텐츠, 구성 및 서비스 애플리케이션 데이터베이스입니다.|  
 ...
 ![Sharepoint 설정](https://docs.microsoft.com/analysis-services/analysis-services/media/as-sharepoint2013-settings-gear.gif "Sharepoint 설정") Microsoft SQL Server 연결 (https://connect.microsoft.com/SQLServer/Feedback) )을 [통해 사용자 의견 및 연락처 정보를 제출](https://connect.microsoft.com/SQLServer/Feedback) 합니다.  
  
###  <a name="bkmk_powerpivot_sharepoint2013_1server"></a>SharePoint용 PowerPivot 2013 단일 서버 배포  
 ...
 단일 서버 배포(../../../2014/sql-server/install/media/as-powerpivot-mode-1server-deployment.gif "SharePoint용 PowerPivot") 단일 서버 배포 ![SharePoint용 PowerPivot]  
...
###  <a name="bkmk_powerpivot_sharepoint2013_2server"></a>SharePoint용 PowerPivot 2013 2 서버 배포  
 ...
 [!INCLUDE[ssGeminiShortvnext](../../includes/ssgeminishortvnext-md.md)]은 서버 쪽 데이터 새로 고침 처리, 데이터 공급자, [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] 갤러리 및 고급 데이터 모델을 사용 하는 Excel 통합 문서에 대 @no__t 한 관리 지원을 추가 하기 위해 SharePoint Server 2013를 확장 합니다.  
  
 설치 관리자 패키지는 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 기능 팩의 일부로 사용할 수 있습니다. 기능 팩은 [microsoft® SQL Server® 2014 PowerPivot](https://go.microsoft.com/fwlink/?LinkID=296473) ® (HYPERLINK "®-2" \t "_blank"®-3)의 [!INCLUDE[msCoName](../../includes/msconame-md.md)] 다운로드 센터에서 다운로드할 수 있습니다.  
  
 ![SSAS PowerPivot 모드 2 서버 배포](https://docs.microsoft.com/analysis-services/analysis-services/media/as-powerpivot-mode-2server-deployment.gif "SSAS PowerPivot 모드 2 서버 배포")  
...
###  <a name="bkmk_powerpivot_sharepoint2013_3server"></a>SharePoint용 PowerPivot 2013 3 서버 배포  
 ...
 Powerpivot(../../../2014/sql-server/install/media/as-powerpivot-mode-3server-deployment.gif "Mode3 서버 배포") 로 서의 ![Powerpivot Mode3 서버 배포]  
...
###  <a name="bkmk_powerpivot_ssrs_sharepoint2013_1server"></a>SharePoint용 PowerPivot 2013 및 Reporting Services 단일 서버 배포  
 단일 서버 배포는 테스트용으로는 유용하지만 프로덕션 배포에는 권장되지 않습니다.  
...
###  <a name="bkmk_powerpivot_ssrs_sharepoint2013_2server"></a>SharePoint용 PowerPivot 2013 및 Reporting Services 두 서버 배포  
...
##  <a name="bkmk_example_deployments_2010"></a>SharePoint 2010 예제 배포 토폴로지  
 ...
 ![논리적 아키텍처 다이어그램](../../../2014/sql-server/install/media/sql11bisetup.gif "논리 아키텍처 다이어그램")  
...
##  <a name="bkmk_sharepoint2010_1server"></a>단일 서버 배포  
 ...
 단일 서버에 모든 기능을 설치하기 위해 동일한 물리적 서버에 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 및 [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)]를 순서대로 설치합니다. 독립 실행형 서버 구성에 대 한 자세한 내용은 [Deployment 검사 목록: Reporting Services, 파워 뷰 및 SharePoint용 PowerPivot @ no__t-0입니다.  
...
##  <a name="bkmk_sharepoint2010_scaleserver"></a>3 계층 스케일 아웃 배포  
 ...
 다중 서버 팜을 배포 하는 경우 다음 SharePoint 문서의 지침을 따라야 합니다. [3 계층 팜을 위한 다중 서버 (SharePoint Server 2010)](https://go.microsoft.com/fwlink/?linkID=219834).  
