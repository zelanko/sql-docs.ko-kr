...
### <a name="shared-features"></a>공유 기능  
 단일 컴퓨터에 있는 모든 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 인스턴스에서 공유하는 기능은 단일 디렉터리에 설치됩니다. 이러한 형식은 다음과 같습니다.  
