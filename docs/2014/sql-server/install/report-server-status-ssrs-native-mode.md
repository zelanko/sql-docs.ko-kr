...
-   MSRS12.MSSQLSERVER  
 ...
 를 이미 설치한 같은 하는 구성 요소의 두 번째 인스턴스를 설치 하는 경우는 [!INCLUDE[ssDE](../../includes/ssde-md.md)], Contoso, 인스턴스 이름을 **인스턴스 ID** MSSQL12 됩니다. Contoso입니다.  
