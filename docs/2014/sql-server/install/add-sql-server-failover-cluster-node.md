---
title: SQL Server 장애 조치 클러스터 노드 추가 | Microsoft Docs
ms.custom: ''
ms.date: 05/24/2017
...
# <a name="add-sql-server-failover-cluster-node"></a>SQL Server 장애 조치(Failover) 클러스터 노드 추가
 ...
 시스템 구성 검사에서는 각 실행 규칙에 대한 간단한 설명과 실행 상태를 포함하는 보고서를 생성합니다. 시스템 구성 검사 보고서는 %programfiles%\microsoft SQL Server\120\Setup Bootstrap\Log\\< YYYYMMDD_HHMM >\\합니다.  
