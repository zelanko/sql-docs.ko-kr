...
##  <a name="page-types-that-cannot-be-automatically-repaired"></a><a name="UnrepairablePageTypes"></a>자동으로 복구 될 수 없는 페이지 유형  
...
##  <a name="developer-best-practice"></a><a name="DevBP"></a>개발자 모범 사례  
