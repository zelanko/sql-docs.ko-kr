...
-   **다음을 사용 하 여 쿼럼 NodeWeight 설정을 보려면** [Powershell 사용](#PowerShellProcedure), [cluster.exe 사용](#CommandPromptProcedure)  
...
3.  
  `Get-ClusterNode` 개체를 사용하여 클러스터의 각 노드에 대한 `NodeWeight` 속성을 설정합니다.  
...
2.  
  **cluster.exe** 를 사용하여 `NodeWeight` 값을 설정합니다.  
