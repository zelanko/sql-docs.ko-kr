...
|Windows 장애 조치(failover) 클러스터링|[Windows 2008 R2 장애 조치 멀티 사이트 클러스터링](http://www.microsoft.com/windowsserver2008/en/us/failover-clustering-multisite.aspx)|  
