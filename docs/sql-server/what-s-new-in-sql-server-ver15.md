...
|새로운 기능 또는 업데이트 | 세부 정보 |
|:---|:---|
|외부 테이블 쿼리 |이제 외부 테이블 열 이름이 SQL Server, Oracle, Teradata, MongoDB 및 ODBC 데이터 원본을 쿼리하는 데 사용됩니다. [PolyBase란?](../relational-databases/polybase/polybase-guide.md)을 참조하세요.|
