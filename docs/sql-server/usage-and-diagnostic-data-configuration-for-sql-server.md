---
title: SQL Server 사용 현황 및 진단 데이터 수집 구성 | Microsoft Docs
description: ''
author: MikeRayMSFT
ms.author: mikeray
manager: craigg
...
ms.locfileid: "59243557"
---
# <a name="configure-usage-and-diagnostic-data-collection-for-sql-server"></a>SQL Server 사용 현황 및 진단 데이터 수집 구성
