...
|인스턴스당 최대 Columnstore 세그먼트 캐시 메모리 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]|무제한 메모리| 32GB<sup>2</sup>| 16GB<sup>2</sup>| 352MB<sup>2</sup>| 352MB<sup>2</sup>|  
|데이터베이스당 메모리 최적화 데이터의 최대 크기 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]|무제한 메모리| 32GB<sup>2</sup>| 16GB<sup>2</sup>| 352MB<sup>2</sup>| 352MB<sup>2</sup>|  
