...
description: 이 문서에서는 다양한 성능, 런타임 및 가격 요구 사항을 충족할 수 있도록 각 버전의 SQL Server 2016에서 지원하는 기능을 설명합니다.
ms.custom:
- seo-lt-2019
- sqlfreshmay19
ms.date: 07/22/2020
...
> 
> ![Azure Virtual Machine 소형](/analysis-services/analysis-services/media/azure-virtual-machine-small.png) **[이미 설치된 SQL Server 2016으로 가상 머신을 스핀업](https://azuremarketplace.microsoft.com/marketplace/apps/microsoftsqlserver.sql2017-ws2019?tab=Overview)**   
...
|백업 압축|예|예|아니요|아니요|예| 
|데이터베이스 스냅샷|예|예 <sup>3</sup>|예 <sup>3</sup>|예 <sup>3</sup>|예 <sup>3</sup>|
|Always On 장애 조치(failover) 클러스터 인스턴스|예<br /><br /> 16|예<br /><br /> 노드 2개 지원|아니요|아니요|아니요|  
|Always On 가용성 그룹|예<br /><br /> 2개의 동기 보조 복제본을 포함하여 최대 8개까지 보조 복제본 지원|아니요|아니요|아니요|아니요|
|기본 가용성 그룹 <sup>2</sup>|아니요|예<br /><br /> 노드 2개 지원|아니요|아니요|예|
|온라인 페이지 및 파일 복원|예|아니요|아니요|아니요|예|
|온라인 인덱싱|예|아니요|아니요|아니요|예|
...
|NUMA 인식 큰 페이지 메모리 및 버퍼 배열 할당|예|아니요 <sup>4</sup>|아니요|아니요|아니요|
...
<sup>2</sup> 적용 대상: [!INCLUDE[ssSQL15](../includes/sssql15-md.md)] SP1, 버전 간 CPSA(공통 프로그래밍 노출 영역) 만들기의 일환. 집계 푸시다운, 문자열 조건자 푸시다운 및 SIMD 최적화는 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Enterprise 버전의 확장성 고급 기능입니다. 자세한 내용은 [Columnstore 인덱스 - 새로운 기능](../relational-databases/indexes/columnstore-indexes-what-s-new.md)을 참조하세요. 
...
|서버 감사|예|예|예|예|예| 
|데이터베이스 감사|예|예 <sup>1</sup>|예 <sup>1</sup>|예 <sup>1</sup>|예 <sup>1</sup>| 
...
|-------------|----------------|--------------|---------|------------------------------------|------------------------|  
|기본 R 통합|예|예|예|예|아니요|   
|고급 R 통합|예|아니요|아니요|아니요|아니요| 
|R Server (Standalone)|예|아니요|아니요|아니요|아니요|   
...
|Transact-SQL 엔드포인트|예|예|예|아니요|아니요| 
...
##  <a name="business-intelligence-clients"></a><a name="BIC"></a> Business Intelligence 클라이언트  
