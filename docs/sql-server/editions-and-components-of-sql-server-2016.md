---
title: "SQL Server 2016 버전 및 구성 요소 | Microsoft 문서"
ms.custom:
- SQL2016_New_Updated
ms.date: 12/01/2016
...
---
# <a name="editions-and-components-of-sql-server-2016"></a>SQL Server 2016 버전 및 구성 요소
> SQL Server 2016의 서로 다른 버전에서 지원하는 기능에 대한 세부 정보는 [SQL Server 2016의 버전과 지원하는 기능](../sql-server/editions-and-supported-features-for-sql-server-2016.md)을 참조하세요.
...
## <a name="includesscurrentincludessscurrent-mdmd-editions"></a>[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] 버전  
