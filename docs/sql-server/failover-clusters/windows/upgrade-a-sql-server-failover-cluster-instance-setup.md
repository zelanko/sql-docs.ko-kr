---
title: "SQL Server 장애 조치(Failover) 클러스터 인스턴스 업그레이드(설치) | Microsoft Docs"
ms.custom: ""
ms.date: "01/22/2016"
...
helpviewer_keywords: 
  ...
  - "장애 조치(failover) 클러스터링 [SQL Server], 클러스터 만들기"
  - "클러스터 [SQL Server], 만들기"
...
---
# SQL Server 장애 조치(Failover) 클러스터 인스턴스 업그레이드(설치)
...
11. 전체 텍스트 검색 업그레이드 페이지에서 업그레이드하려는 데이터베이스의 업그레이드 옵션을 지정합니다. 자세한 내용은 [전체 텍스트 검색 업그레이드 옵션](../Topic/Full-Text%20Search%20Upgrade%20Options.md)을 참조하세요.  
...
-   [새 SQL Server 2016 기능 활용](../Topic/Take%20Advantage%20of%20New%20SQL%20Server%202016%20Features.md)  
