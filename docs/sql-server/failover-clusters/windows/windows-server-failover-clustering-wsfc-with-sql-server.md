---
title: "SQL Server의 WSFC(Windows Server 장애 조치(Failover) 클러스터링) | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
helpviewer_keywords: 
  ...
  - "WSFC(Windows Server 장애 조치(Failover) 클러스터링), SQL Server"
  - "WSFC, SQL Server"
  - "쿼럼 [SQL Server]"
...
### Always On 장애 조치(Failover) 클러스터 인스턴스가 있는 인스턴스 수준 고가용성  
...
### 다음이 있는 데이터베이스 수준 고가용성 [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)]  
