---
title: "HealthCheckTimeout 속성 설정 구성 | Microsoft Docs"
ms.custom: ""
ms.date: "03/09/2017"
...
-   **HeathCheckTimeout 설정을 구성하려면:** [PowerShell](#PowerShellProcedure), [장애 조치(failover) 클러스터 관리자](#WSFC), [Transact-SQL](#TsqlProcedure) 사용  
