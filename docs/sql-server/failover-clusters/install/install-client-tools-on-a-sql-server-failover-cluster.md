---
title: "SQL Server 장애 조치 클러스터에 클라이언트 도구 설치 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# SQL Server 장애 조치 클러스터에 클라이언트 도구 설치
...
#### 설치 사용자 인터페이스를 사용하여 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 클라이언트 도구 설치  
...
#### 명령 프롬프트를 사용하여 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 클라이언트 도구 설치  
