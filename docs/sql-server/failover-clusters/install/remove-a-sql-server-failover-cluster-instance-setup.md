---
title: "SQL Server 장애 조치(Failover) 클러스터 인스턴스 제거(설치) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "클러스터 [SQL Server], 장애 조치(Failover) 클러스터형 인스턴스 제거"
  - "장애 조치(Failover) 클러스터링 [SQL Server], 장애 조치(Failover) 클러스터형 인스턴스 제거"
  - "장애 조치(Failover) 클러스터형 인스턴스 제거"
  - "장애 조치(Failover) 클러스터형 인스턴스 제거"
...
---
# SQL Server 장애 조치(Failover) 클러스터 인스턴스 제거(설치)
