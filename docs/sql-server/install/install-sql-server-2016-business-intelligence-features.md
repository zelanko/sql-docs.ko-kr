---
title: "SQL Server 2016 비즈니스 인텔리전스 기능 설치 | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/14/2017"
...
manager: "erikre"
---
# SQL Server 2016 비즈니스 인텔리전스 기능 설치
...
> [!NOTE] SSDT(SQL Server Data Tools)는 SQL Server 2016에 포함되지 않습니다. [SQL Server Data Tools 다운로드](http://go.microsoft.com/fwlink/?LinkID=616714).
  
## 관련 항목:  
 [Reporting Services&#40;SSRS&#41;의 새로운 기능](http://msdn.microsoft.com/ko-kr/bc909063-6b84-4b3a-80d2-e93fc04b4b9d)   
 [Analysis Services의 새로운 기능](../../analysis-services/what-s-new-in-analysis-services.md)   
 [Integration Services의 새로운 기능](../Topic/What's%20New%20in%20Integration%20Services.md)   
