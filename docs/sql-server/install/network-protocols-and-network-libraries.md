---
title: "네트워크 프로토콜 및 네트워크 라이브러리 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "프로토콜 [SQL Server]"
  - "구성 옵션 [SQL Server], 프로토콜"
  - "네트워크 라이브러리 [SQL Server]"
  - "프로토콜 [SQL Server Express], 네트워크 프로토콜 정보"
  - "파이프 [SQL Server]"
  - "네트워크 프로토콜 [SQL Server]"
  - "기본 SQL Server 구성"
  - "라이브러리 [SQL Server]"
  - "네트워크 프로토콜 [SQL Server Express], 네트워크 프로토콜 정보"
  - "구성 옵션 [SQL Server], 라이브러리"
