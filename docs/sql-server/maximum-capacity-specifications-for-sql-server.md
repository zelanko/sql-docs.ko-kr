---
title: "SQL Server의 최대 용량 사양 | Microsoft Docs"
ms.date: "03/09/2017"
...
|테이블당 외래 키 테이블 참조 수||발신 = 253, 수신 = 10,000|제한 사항에 대해서는 [Create Foreign Key Relationships](../relational-databases/tables/외래-키-관계-만들기.md)를 참조하세요.|  
|식별자 길이(문자 수)||128||  
