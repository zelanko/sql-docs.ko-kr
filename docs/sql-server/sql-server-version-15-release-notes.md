...
SQL Server Machine Learning Services의 문제는 [SQL Server Machine Learning Services의 알려진 문제](../machine-learning/known-issues-for-sql-server-machine-learning-services.md)를 참조하세요.
