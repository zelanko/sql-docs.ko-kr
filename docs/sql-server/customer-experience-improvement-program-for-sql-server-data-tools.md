...
---
# SQL Server Data Tools에 대한 사용자 환경 개선 프로그램
...
## SQL Server Data Tools에 대한 CEIP 참여 및 참여 거부  
...
### Visual Studio 2015용 SQL Server Data Tools와 CEIP에 대한 선택과 제어  
...
### SQL Server Data Tools - BI(SSDT-BI) 및 CEIP에 대한 선택과 제어  
