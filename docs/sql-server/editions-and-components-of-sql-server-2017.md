---
title: SQL Server 2017의 버전  지원하는 기능 | Microsoft Docs
ms.custom: ''
ms.date: 11/11/2017
ms.prod: sql
ms.reviewer: ''
...
|PolyBase 계산 노드|예|예 <sup>3</sup>|예 <sup>3</sup>|예 <sup>3</sup>|예 <sup>3</sup> | 
