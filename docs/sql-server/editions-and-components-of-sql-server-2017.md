...
|데이터베이스 스냅숏|사용자 계정 컨트롤|예|예|예|사용자 계정 컨트롤|
|Always On 장애 조치(failover) 클러스터 인스턴스<sup>2</sup>|사용자 계정 컨트롤|예|아니오|아니오|아니오|  
|Always On 가용성 그룹<sup>3</sup>|사용자 계정 컨트롤|아니오|아니오|아니오|아니오|
|기본 가용성 그룹<sup>4</sup>|아니오|사용자 계정 컨트롤|아니오|아니오|아니오|
|온라인 페이지 및 파일 복원|사용자 계정 컨트롤|아니오|아니오|아니오|아니오|
|온라인 인덱싱|사용자 계정 컨트롤|아니오|아니오|아니오|아니오|
|다시 시작 가능한 온라인 인덱스 다시 작성|사용자 계정 컨트롤|아니오|아니오|아니오|아니오|
...
|PowerShell 스크립팅 지원<sup>2</sup>|사용자 계정 컨트롤|예|예|예|사용자 계정 컨트롤| 
