...
[!INCLUDE[tsql-appliesto-ss2016-xxxx-xxxx-xxx_md](../../includes/tsql-appliesto-ss2016-xxxx-xxxx-xxx-md.md)]
  ...
  Stretch Database에 테이블을 구성하려면 SQL Server Management Studio에서 테이블에 대해 **늘이기 | 활성화**를 선택하여 **스트레치에 테이블 사용** 마법사를 엽니다. 또한, Transact-SQL을 사용하여 기존 테이블에서 Stretch Database를 사용하거나 활성화된 Stretch Database로 새 테이블을 만들 수 있습니다.  
 ...
 **사용 권한**. 데이터베이스 또는 테이블에 대해 Stretch Database를 사용하도록 설정하려면 db_owner 권한이 필요합니다. 또한, 테이블에서 Stretch Database를 사용하려면 테이블에 대한 ALTER 권한이 필요합니다.  
...
##  <a name="EnableWizardTable"></a> 마법사를 사용하여 테이블에서 Stretch Database 활성화  
 **마법사 시작**  
...
##  <a name="EnableTSQLTable"></a> Transact-SQL을 사용하여 테이블에서 Stretch Database 활성화  
 또한, Transact-SQL을 사용하여 기존 테이블에서 Stretch Database를 사용하거나 활성화된 Stretch Database로 새 테이블을 만들 수 있습니다.  
...
### <a name="enable-stretch-database-for-an-existing-table"></a>기존 테이블에서 Stretch Database 활성화  
 Stretch Database용으로 기존 데이터베이스를 구성하려면 ALTER TABLE 명령을 실행합니다.  
...
### <a name="create-a-new-table-with-stretch-database-enabled"></a>활성화된 Stretch Database에서 새 테이블 만들기  
 활성화된 Stretch Database에서 새 테이블을 만들려면 CREATE TABLE 명령을 실행합니다.  
