---
title: "스트레치 사용 데이터베이스 백업(스트레치 데이터베이스) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "06/14/2016"
...
Microsoft Azure는 스트레치 데이터베이스가 SQL Server에서 Azure로 마이그레이션한 원격 데이터를 자동으로 백업합니다.    
### Azure에서 자동 백업을 사용하여 데이터 손실 위험을 줄임  
...
### Azure에서 지리적 중복을 사용하여 데이터 손실 위험을 줄임  
...
> [!NOTE] 스트레치 데이터베이스가 준비 테이블에 일시적으로 유지하는 데이터 양을 늘리면 SQL Server에서 필요한 공간 크기가 증가합니다.
