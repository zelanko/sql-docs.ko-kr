...
[!INCLUDE[tsql-appliesto-ss2016-xxxx-xxxx-xxx_md](../../includes/tsql-appliesto-ss2016-xxxx-xxxx-xxx-md.md)]
  ...
  Stretch Database에 사용 가능한 데이터베이스와 테이블을 식별하려면 SQL Server 2016 업그레이드 관리자를 다운로드한 다음 Stretch Database 관리자를 실행합니다. 스트레치 데이터베이스 관리자는 차단 문제도 식별합니다.  
...
## <a name="run-the-stretch-database-advisor"></a>스트레치 데이터베이스 관리자 실행  
