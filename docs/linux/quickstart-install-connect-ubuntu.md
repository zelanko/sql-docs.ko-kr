...
1. Microsoft SQL Server Ubuntu 리포지토리를 등록합니다.
   ...
   > [!NOTE]
   > CU(누적 업데이트) 리포지토리입니다. 리포지토리 옵션 및 그 차이점에 대한 자세한 내용은 [소스 리포지토리 변경](sql-server-linux-change-repo.md)을 참조하십시오.
...
1. 소스 목록을 업데이트하고, unixODBC 개발자 패키지와 함께 설치 명령을 실행합니다.
