...
1. [Linux에서 SQL Server Integration Services ssis conf 구성](sql-server-linux-configure-ssis.md)
2. [버전 및 SQL Server 2017 linux의 지원 되는 기능](sql-server-linux-editions-and-components-2017.md)
3. [일정 SQL Server Integration Services 패키지 cron 사용 하 여 Linux에서 실행](sql-server-linux-schedule-ssis-packages.md)
