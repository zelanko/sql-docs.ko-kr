---
title: 가용성 그룹 장애 조치-Linux의 SQL Server 관리
description: ''
author: MikeRayMSFT
ms.author: mikeray
ms.reviewer: vanto
...
- [Pacemaker-수동으로 리소스 이동](https://clusterlabs.org/pacemaker/doc/en-US/Pacemaker/1.1/html/Clusters_from_Scratch/_manually_moving_resources_around_the_cluster.html)
