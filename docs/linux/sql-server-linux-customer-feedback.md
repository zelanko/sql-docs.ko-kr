---
title: Linux의 SQL Server에 대 한 고객 의견 | Microsoft Docs
description: SQL Server 고객 피드백 수집 되 고 Linux에 구성 하는 방법을 설명 합니다.
author: rothja
ms.author: jroth
manager: craigg
ms.date: 06/22/2018
...
## <a name="disable-customer-feedback"></a>고객 피드백을 사용 하지 않도록 설정

이 옵션을 통해 SQL Server 또는 Microsoft에 피드백을 전송 하는 경우 변경할 수 있습니다. 기본적으로이 값은 설정을 true로 합니다. 값을 변경 하려면 다음 명령을 실행 합니다.
...
Linux의 SQL Server에서 로컬 감사는 SQL Server 데이터베이스 엔진에 대 한 인스턴스 수준에서 구성할 수 있습니다. 다른 SQL Server 구성 요소 및 SQL Server Tools 사용 현황 피드백 수집에 대 한 로컬 감사 기능을 갖지 않습니다.
