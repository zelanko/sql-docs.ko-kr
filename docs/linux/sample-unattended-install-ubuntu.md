---
title: Ubuntu의 SQL Server의 무인된 설치 | Microsoft Docs
...
ms.locfileid: "47626551"
---
# <a name="sample-unattended-sql-server-installation-script-for-ubuntu"></a>Ubuntu에 대 한 샘플: SQL Server를 무인된 설치 스크립트
