...
+ [Python 자습서: SQL Server Machine Learning Services에서 선형 회귀를 사용하여 스키 대여 예측](..\advanced-analytics\tutorials\python-ski-rental-linear-regression-deploy-model.md)
