---
title: 버전 및 SQL Server 2017의 지원 되는 기능 ~ Linux
ms.date: 09/14/2017
ms.prod: sql
ms.technology: linux
ms.topic: conceptual
...
|표준|[!INCLUDE[ssNoVersion](../includes/ssNoVersion-md.md)] 표준 버전 부서와 소규모 조직이 응용 프로그램을 실행 하기 위한 기본 데이터 관리를 제공 하 고 온-프레미스 및 클라우드-최소한의 IT 리소스를 사용 하 여 효과적인 데이터베이스 관리를 사용 하도록 설정 용 공용 개발 도구를 지원 합니다.|  
...
|기능|Enterprise|Standard|Web|Express|   
|-------------|----------------|--------------|---------|------------------------|  
|관리자 전용 연결|사용자 계정 컨트롤|예|예|예, 추적 플래그 있음|예, 추적 플래그 있음|   
|PowerShell 스크립팅 지원|사용자 계정 컨트롤|예|예|예| 
|데이터 계층 애플리케이션 구성 요소 작업 지원 - 추출, 배포, 업그레이드, 삭제|예|예|예|사용자 계정 컨트롤| 
...
|인덱스 뷰의 직접 쿼리(NOEXPAND 힌트 사용)|사용자 계정 컨트롤|예|예|예| 
...
|JSON|예|예|예|예|   
|쿼리 저장소|예|예|예|예|   
|임시 테이블|예|예|예|사용자 계정 컨트롤|   
|네이티브 XML 지원|사용자 계정 컨트롤|예|예|사용자 계정 컨트롤| 
|XML 인덱싱|사용자 계정 컨트롤|예|예|예| 
|MERGE 및 UPSERT 기능|예|예|예|사용자 계정 컨트롤|   
...
|------------------|----------------|--------------|---------|------------------------------------|------------------------|
|공간 인덱스|사용자 계정 컨트롤|예|예|예|   
|평면 및 측지 데이터 형식|예|예|예|사용자 계정 컨트롤| 
|고급 공간 라이브러리|사용자 계정 컨트롤|예|예|사용자 계정 컨트롤|   
|산업 표준 공간 데이터 형식 가져오기/내보내기|사용자 계정 컨트롤|예|예|예|   
