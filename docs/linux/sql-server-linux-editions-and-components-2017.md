...
|기능|Enterprise|Standard|Web|Express|  
|-------------|----------------|--------------|---------|------------------------|  
|로그 전달|예|사용자 계정 컨트롤|사용자 계정 컨트롤|아니요|  
|백업 압축|예|사용자 계정 컨트롤|아니요|아니요| 
|데이터베이스 스냅숏|예|아니요|아니오|아니요|
|Always On 장애 조치 클러스터 인스턴스의<sup>1</sup>|예|사용자 계정 컨트롤|아니요|아니요| 
|Always On 가용성 그룹<sup>2</sup>|예|아니요|아니오|아니요|
|기본 가용성 그룹 <sup>3</sup>|아니요|예|아니요|아니요|
|최소 복제본 커밋 가용성 그룹|예|사용자 계정 컨트롤|아니요|아니요|
|클러스터가 없는 가용성 그룹|예|사용자 계정 컨트롤|아니요|아니요|
|온라인 페이지 및 파일 복원|예|아니요|아니오|아니요|
|온라인 인덱싱|예|아니요|아니오|아니요|
|다시 시작 가능한 온라인 인덱스 다시 작성|예|아니요|아니오|아니요|
|온라인 스키마 변경|예|아니요|아니오|아니요|
|빠른 복구|예|아니요|아니오|아니요|
|미러된 백업|예|아니요|아니오|아니요|
|Hot Add 메모리 및 CPU|예|아니요|아니오|아니요|
|암호화된 백업|예|사용자 계정 컨트롤|아니요|아니요|
|Microsoft Azure에 하이브리드 백업(URL에 백업)|예|사용자 계정 컨트롤|아니요|아니요|
...
|기능|Enterprise|Standard|Web|Express|  
|-------------|----------------|--------------|---------|------------------------| 
|Columnstore <sup>1</sup>|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예|  
|클러스터형 columnstore 인덱스의 큰 개체 이진 파일|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예|  
|온라인 비클러스터형 columnstore 인덱스 다시 작성|예|아니요|아니오|아니요|
|메모리 내 OLTP <sup>1</sup>|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예|
|영구 주 메모리|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예|
|테이블 및 인덱스 분할|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예|  
|데이터 압축|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예|
|리소스 관리자|예|아니요|아니오|아니요|  
|분할된 테이블 병렬 처리|예|아니요|아니오|아니요|
|NUMA 인식 및 큰 페이지 메모리 및 버퍼 배열 할당|예|아니요|아니오|아니요|
|IO 리소스 관리|예|아니요|아니오|아니요|  
|지연된 내구성|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예|
|자동 튜닝|예|아니요|아니오|아니요|
|일괄 처리 모드 적응 조인|예|아니요|아니오|아니요|
|일괄 처리 모드 메모리 부여 피드백|예|아니요|아니오|아니요|
|다중 문 테이블 반환 함수에 대한 인터리브 실행|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예|
|대량 삽입 기능 개선|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예|
...
|기능|Enterprise|Standard|Web|Express|
|-------------|----------------|--------------|---------|------------------------------------| 
|행 수준 보안|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예|  
|항상 암호화|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예| 
|동적 데이터 마스킹|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예|   
|기본 감사|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예| 
|미세 감사|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예| 
|투명한 데이터베이스 암호화|예|아니요|아니오|아니요|   
|사용자 정의 역할|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예| 
|포함된 데이터베이스|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예| 
|백업을 위한 암호화|예|사용자 계정 컨트롤|아니요|아니요|  
...
|PowerShell 스크립팅 지원|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예| 
|데이터 계층 응용 프로그램 구성 요소 작업 지원 - 추출, 배포, 업그레이드, 삭제|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예| 
...
|인덱스 뷰의 직접 쿼리(NOEXPAND 힌트 사용)|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예| 
|인덱싱된 뷰의 자동 유지 관리|예|사용자 계정 컨트롤|사용자 계정 컨트롤|아니요|아니요| 
|분산형 분할 뷰|예|아니요|아니오|아니요| 
|병렬 인덱스 작업|예|아니요|아니오|아니요|  
|쿼리 최적화 프로그램의 인덱싱된 뷰 자동 사용|예|아니요|아니오|아니요| 
|병렬 일관성 검사|예|아니요|아니오|아니요| 
|SQL Server 유틸리티 제어 지점|예|아니요|아니오|아니요|    

##  <a name="Programmability"></a> Programmability  
  
|기능|Enterprise|Standard|Web|Express 
|-------------|----------------|--------------|---------|------------------------|  
|JSON|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예|   
|쿼리 저장소|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예|   
|임시 테이블|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예|   
|네이티브 XML 지원|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예| 
|XML 인덱싱|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예| 
|MERGE 및 UPSERT 기능|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예|   
|날짜 및 시간 데이터 형식|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예|  
|국제화 지원|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예| 
...
|------------------|----------------|--------------|---------|------------------------------------|------------------------|
|공간 인덱스|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예|   
|평면 및 측지 데이터 형식|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예| 
|고급 공간 라이브러리|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예|   
|산업 표준 공간 데이터 형식 가져오기/내보내기|예|사용자 계정 컨트롤|사용자 계정 컨트롤|예|   
