...
## <a name="examples"></a>예  
 다음 예제에서는 합니다 **LinkMember** Adventure Works 큐브의 Calendar 계층에서 Date.Date 특성 계층에 있는 2002년 7월 1일 멤버의 상위 항목에 대 한 기본 측정값을 반환 하는 함수입니다.  
