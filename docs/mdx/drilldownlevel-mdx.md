...
# <a name="drilldownlevel-mdx"></a>DrilldownLevel(MDX)
 ...
 수준을 지정 드릴 다운은 옵션 이지만 수준으로 설정한 경우 사용할 수 있습니다는 **식 수준** 또는 **인덱스 수준**합니다. 이러한 인수는 상호 배타적입니다. 마지막으로, 계산 멤버가 쿼리에 있는 경우 행 집합에 이러한 계산 멤버가 포함되도록 인수를 지정할 수 있습니다.  
 ...
 **예제 1-최소 구문을 보여 줍니다.**  
 ...
 첫 번째 예제에 대 한 최소 구문을 보여 줍니다 **DrilldownLevel**합니다. 필요한 인수는 집합 식뿐입니다. 이 쿼리를 실행 해 서 상위 [All Categories] 및 다음 수준의 멤버를: [Accessories], [Bikes] 등입니다. 기본 목적은이 예는 간단 하지만 보여 줍니다 합니다 **DrilldownLevel** 아래의 다음 수준으로 드릴 다운 하는 함수입니다.  
 ...
 **예제 3-수준 식 설명**  
 ...
 이 예에서 드릴 다운 수준에서 시작 [City]의 두 번째 인수로 합니다 **DrilldownLevel** 함수입니다. 이 쿼리를 실행할 때 Washington 및 Oregon 주에 대해 [City] 수준에서 드릴다운이 시작합니다. 당 합니다 **DrilldownLevel** 함수의 경우, 결과 집합 [Postal codes] 아래쪽 다음 수준의 멤버를 포함 합니다.  
 ...
 **예 4-계산된 멤버를 포함 하 여**  
 ...
 마지막 예제에 나와 있는 결과의 맨 아래에 표시 되는 계산된 멤버를 추가할 때 설정 된 **include_calculated_members** 플래그입니다. 플래그는 네 번째 매개 변수로 지정됩니다.  
