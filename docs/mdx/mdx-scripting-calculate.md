...
## <a name="remarks"></a>설명  
 ...
 MDX 스크립트 내의 중첩된 하위 큐브에는 CALCULATE 문을 포함할 수 없습니다. 중첩된 하위 큐브는 SCOPE 문을 사용하여 정의합니다. SCOPE 문에 대 한 자세한 내용은 [Scope 문 &#40;MDX&#41;](../mdx/mdx-scripting-scope.md)를 참조 하십시오.  
...
## <a name="see-also"></a>관련 항목  
 ...
 [MDX 스크립팅 기본 사항 & #40; Analysis Services & #41;](https://docs.microsoft.com/analysis-services/multidimensional-models/mdx/mdx-scripting-fundamentals-analysis-services)   
