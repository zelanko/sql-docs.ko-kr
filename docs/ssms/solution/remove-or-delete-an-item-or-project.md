...
프로젝트를 영구히 삭제할 수 있지만 그러기 위해서는 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 솔루션에서 프로젝트에 대한 참조를 먼저 제거한 다음 [!INCLUDE[msCoName](../../includes/msconame_md.md)] Widows 탐색기를 사용하여 연결된 파일을 저장소에서 영구히 삭제해야 합니다.  
