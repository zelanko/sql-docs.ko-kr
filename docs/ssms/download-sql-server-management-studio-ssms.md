...
ms.locfileid: "49419258"
---
# <a name="download-sql-server-management-studio-ssms"></a>SSMS(SQL Server Management Studio) 다운로드
[!INCLUDE[appliesto-ss-asdb-asdw-xxx-md](../includes/appliesto-ss-asdb-asdw-xxx-md.md)]
SSMS는 SQL Server에서 Azure SQL Database까지 모든 SQL 인프라를 관리하기 위한 통합 환경입니다. SSMS는 SQL의 인스턴스를 구성, 모니터링 및 관리하는 도구를 제공합니다. SSMS를 사용하면 응용 프로그램에 사용되는 데이터 계층 구성 요소를 배포, 모니터링 및 업그레이드하고 쿼리 및 스크립트를 작성할 수 있습니다.
...
## <a name="ssms-180-preview"></a>SSMS 18.0(미리 보기)

**현재 SSMS 18.0 공개 미리 보기 4를 사용할 수 있으며, [!INCLUDE[sql-server-2019](..\includes\sssqlv15-md.md)] 지원을 제공하는 최신 *SQL Server Management Studio* 세대입니다.**

**[![다운로드](../ssdt/media/download.png) SQL Server Management Studio 18.0(미리 보기 4) 다운로드](https://go.microsoft.com/fwlink/?linkid=2014662)**

미리 보기 4는 SSMS 18.0의 첫 번째 공개 미리 보기입니다.

**버전 정보**

- 릴리스 번호: 18.0 (미리 보기 4)<br>
...
## <a name="available-languages-ssms-180-preview"></a>사용 가능한 언어(SSMS 18.0 미리 보기)

이 SSMS 릴리스는 다음 언어로 설치할 수 있습니다.

SQL Server Management Studio 18.0(미리 보기 4):<br>
[중국어(간체)](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x804) | [중국어(번체)](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x404) | [영어(미국)](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x409) | [프랑스어](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x40c) | [독일어](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x407) | [이탈리아어](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x410) | [일본어](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x411) | [한국어](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x412) | [포르투갈어(브라질)](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x416) | [러시아어](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x419) | [스페인어](https://go.microsoft.com/fwlink/?linkid=2014662&clcid=0x40a)

SQL Server Management Studio 18.0 업그레이드 패키지 다운로드(18.0으로 업그레이드):<br>
지금은 업그레이드 옵션을 사용할 수 없습니다.
...
## <a name="new-in-this-release-ssms-180-preview"></a>이 릴리스의 새로운 기능(SSMS 18.0 미리 보기)

SSMS 18.0(미리 보기)은 최신 버전의 SQL Server Management Studio입니다. 18.X 세대의 SSMS는 SQL Server 2019 미리 보기를 통해 SQL Server 2008의 거의 모든 기능 영역을 지원합니다.

이 릴리스의 새로운 기능에 대한 자세한 내용은 [SSMS 변경 로그](sql-server-management-studio-changelog-ssms.md)를 참조하세요.


## <a name="supported-sql-offerings-ssms-180-preview"></a>지원되는 SQL 제품(SSMS 18.0 미리 보기)
...
## <a name="supported-operating-systems-ssms-180-preview"></a>지원되는 운영 체제(SSMS 18.0 미리 보기)
...
## <a name="ssms-installation-tips-and-issues-ssms-180-preview"></a>SSMS 설치 팁 및 문제(SSMS 18.0 미리 보기)
...
## <a name="release-notes-ssms-180-preview"></a>릴리스 정보(SSMS 18.0 미리 보기)
