...
[SSMS 18.0 공개 미리 보기 7은 현재 사용할 수 있으며](#ssms-180-preview-7), [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)]를 지원하는 최신 세대 *SQL Server Management Studio*입니다.
...
## <a name="ssms-180-preview-7"></a>SSMS 18.0(미리 보기 7)

**SSMS 18.0 공개 미리 보기 7은 현재 사용할 수 있으며, [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)]!** 를 지원하는 최신 세대 *SQL Server Management Studio*입니다.

**[![다운로드](../ssdt/media/download.png) SQL Server Management Studio 18.0(미리 보기 7) 다운로드](https://go.microsoft.com/fwlink/?linkid=2078638)**

*미리 보기 7*은 SSMS 18.0의 최신 공개 미리 보기입니다. 이전 SSMS 18.0 미리 보기가 설치되어 있으면 먼저 이를 제거한 후에 SSMS 18.0 미리 보기 7을 설치합니다.

**버전 정보**

- 릴리스 번호: 18.0(미리 보기 7)<br>
...
## <a name="available-languages-ssms-180-preview-7"></a>사용 가능한 언어(SSMS 18.0 미리 보기 7)

이 SSMS 릴리스는 다음 언어로 설치할 수 있습니다.

SQL Server Management Studio 18.0(미리 보기 7):<br>
[중국어(간체)](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x804) | [중국어(번체)](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x404) | [영어(미국)](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x409) | [프랑스어](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x40c) | [독일어](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x407) | [이탈리아어](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x410) | [일본어](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x411) | [한국어](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x412) | [포르투갈어(브라질)](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x416) | [러시아어](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x419) | [스페인어](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x40a)

SQL Server Management Studio 18.0 업그레이드 패키지 다운로드(18.0으로 업그레이드):<br>
지금은 업그레이드 옵션을 사용할 수 없습니다. 이전 SSMS 18.0 미리 보기가 설치되어 있으면 먼저 이를 제거한 후에 SSMS 18.0 미리 보기 7을 설치합니다.
...
## <a name="new-in-this-release-ssms-180-preview-7"></a>이 릴리스의 새로운 기능(SSMS 18.0 미리 보기 7)

SSMS 18.0(미리 보기 7)은 최신 버전의 SQL Server Management Studio입니다. 18.X 세대의 SSMS는 SQL Server 2019 미리 보기를 통해 SQL Server 2008의 거의 모든 기능 영역을 지원합니다.

이 릴리스의 새로운 기능에 대한 자세한 내용은 [SSMS 변경 로그](sql-server-management-studio-changelog-ssms.md)를 참조하세요.

## <a name="supported-sql-offerings-ssms-180-preview-7"></a>지원되는 SQL 제품(SSMS 18.0 미리 보기 7)
...
## <a name="supported-operating-systems-ssms-180-preview-7"></a>지원되는 운영 체제(SSMS 18.0 미리 보기 7)
...
## <a name="release-notes-ssms-180-preview-7"></a>릴리스 정보(SSMS 18.0 미리 보기 7)
