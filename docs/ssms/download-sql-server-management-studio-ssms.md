...
SSMS 18.x 설치는 SSMS 17.x 이전 버전을 업그레이드 또는 대체하지 않습니다. SSMS 18.x는 이전 버전과 함께 설치되므로 두 버전을 모두 사용할 수 있습니다. 그러나 SSMS 18.x의 미리 보기  버전이 설치된 경우에는 해당 버전을 제거한 후에 SSMS 18.5를 설치해야 합니다. **도움말 > 정보** 창으로 이동하여 미리 보기 버전이 있는지 확인할 수 있습니다.
