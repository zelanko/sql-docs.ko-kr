...
## <a name="download-ssms-180-ga"></a>SSMS 18.0(GA) 다운로드

**SSMS 18.0 일반 가용성 릴리스(GA)는 현재 사용할 수 있으며, [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)]!** 에 대한 지원을 제공하는 최신 세대 *SQL Server Management Studio*입니다.

**[![다운로드](../ssdt/media/download.png) SQL Server Management Studio 18.0(GA) 다운로드](https://go.microsoft.com/fwlink/?linkid=2088649)**

SSMS 18.0은 더 이상 미리 보기 상태가 아니며 SSMS 18.0의 첫 번째 GA(일반 공급) 버전입니다. SSMS 18.0의 미리 보기 버전을 설치한 경우 SSMS 18.0 GA를 설치하기 전에 제거합니다.
...
## <a name="available-languages-ssms-180-ga"></a>사용 가능한 언어(SSMS 18.0 GA)
...
지금은 업그레이드 옵션을 사용할 수 없습니다. 이전 SSMS 18.0 미리 보기가 설치되어 있으면 먼저 이를 제거한 후에 SSMS 18.0 GA를 설치합니다.
...
## <a name="supported-sql-offerings-ssms-180-ga"></a>지원되는 SQL 제품(SSMS 18.0 GA)
...
## <a name="supported-operating-systems-ssms-180-ga"></a>지원되는 운영 체제(SSMS 18.0 GA)
...
## <a name="release-notes-ssms-180-ga"></a>릴리스 정보(SSMS 18.0 GA)
