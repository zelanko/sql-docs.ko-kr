---
title: IntelliSense 구성(SQL Server Management Studio)
description: 대부분의 IntelliSense 옵션은 기본적으로 설정되어 있습니다. IntelliSense 옵션을 해제하고 대신 메뉴 명령 또는 키 입력 조합을 통해 호출하는 방법을 알아봅니다.
...
> [!NOTE]
> Azure Synapse Analytics는 IntelliSense를 지원하지 않습니다.
>
>
