---
title: T-SQL 디버거를 실행하기 전에 방화벽 규칙 구성
description: SQL Server Management Studio에서 SQL Server에 연결될 때 T-SQL(Transact-SQL) 디버거를 실행하기 전에 Windows 방화벽 규칙을 구성하는 방법에 대해 알아봅니다.
