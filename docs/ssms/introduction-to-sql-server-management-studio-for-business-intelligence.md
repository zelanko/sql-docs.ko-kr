...
[!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull_md.md)]를 사용하는 방법에 대한 자세한 내용은 [SQL Server Management Studio를 사용한 개발 및 구현](http://msdn.microsoft.com/c4f5a06b-e2e4-4660-a3a8-6fd356742c02)을 참조하세요.  
...
-   [보고서 서버 데이터베이스 관리](http://msdn.microsoft.com/97b2e1b5-3869-4766-97b9-9bf206b52262)  
  
-   [방법: RSExecRole 만들기](http://msdn.microsoft.com/7ac17341-df7e-4401-870e-652caa2859c0)  
...
[SQL Server Data Tools를 사용한 개발 및 구현](http://msdn.microsoft.com/132ed779-3ec8-4734-9698-802116d1b017)  
[SQL Server Data Tools의 Reporting Services](http://msdn.microsoft.com/0903c7b2-ac59-45f1-b7d0-922ecd9d76f8)  
