---
description: WMI를 구성하여 SQL Server 도구에 서버 상태 표시
title: WMI를 구성하여 SQL Server 도구에 서버 상태 표시
...
## <a name="to-configure-wmi-permission"></a><a name="SSMSProcedure"></a>WMI 사용 권한을 구성하려면  
