---
description: SQL Server 에이전트 보안 구현
title: SQL Server 에이전트 보안 구현
...
[보안 및 보호(데이터베이스 엔진)](../../relational-databases/security/security-center-for-sql-server-database-engine-and-azure-sql-database.md)  
