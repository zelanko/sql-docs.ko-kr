...
이 항목에서는 [!INCLUDE[ssCurrent](../../includes/sscurrent_md.md)] 또는 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull_md.md)] 을 사용하여 마스터 서버 [!INCLUDE[tsql](../../includes/tsql_md.md)]를 만드는 방법에 대해 설명합니다.  
