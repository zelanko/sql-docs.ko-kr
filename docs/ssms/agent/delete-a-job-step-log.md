...
이 항목에서는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] 에이전트 작업 단계 로그를 삭제하는 방법에 대해 설명합니다.  
...
자세한 내용은 [sp_delete_jobsteplog(Transact-SQL)](http://msdn.microsoft.com/e9ef4c99-abde-4038-b6a3-a25dcbaf0958)를 참조하세요.  
