...
MDX에 대한 자세한 내용은 [MDX 문 기본 사항(MDX)](/analysis-services/multidimensional-models/mdx/mdx-query-fundamentals-analysis-services?viewFallbackFrom=sql-server-ver15)을 참조하세요.  
