---
description: 운영자 속성 - 새 운영자(일반 페이지)
title: 새 운영자 속성(일반 페이지)
ms.prod: sql
...
이 페이지를 사용하여 [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 에이전트 운영자의 일반 속성을 확인하고 수정할 수 있습니다.  
