---
title: SQL Server Management Studio 바로 가기 키
...
|[!INCLUDE[ssSqlProfiler](../includes/sssqlprofiler-md.md)] 열기|Ctrl+Alt+P|Ctrl+Alt+P|  
