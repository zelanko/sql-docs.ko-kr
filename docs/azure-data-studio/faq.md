...
예 Azure Data Studio Azure SQL Data Warehouse에 대 한 지원은 현재 Azure SQL Database 관리 되는 인스턴스 및 SQL Server 2019 빅 데이터와 함께 미리 보기로 제공에서 됩니다.
