---
title: PostgreSQL 확장
description: Azure Data Studio PostgreSQL 확장을 설치하는 방법을 알아봅니다. 이 확장을 사용하여 Postgres 데이터베이스에 연결하고, 쿼리하고, 개발할 수 있습니다.
...
Azure Data Studio를 아직 설치하지 않았으면 [설치 지침](../download-azure-data-studio.md)을 참조하세요.

1. Azure Data Studio의 사이드바에서 확장 아이콘을 선택합니다.

    :::image type="content" source="media/postgresql-extension/extensions-icon.png" alt-text="확장 아이콘":::
