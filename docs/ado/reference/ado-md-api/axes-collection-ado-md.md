...
ms.locfileid: "88441322"
---
# <a name="axes-collection-ado-md"></a>Axes 컬렉션(ADO MD)
셀 집합을 정의 하는 [축](../../../ado/reference/ado-md-api/axis-object-ado-md.md) 개체를 포함 합니다.  
  
## <a name="remarks"></a>설명  
 [셀 집합](../../../ado/reference/ado-md-api/cellset-object-ado-md.md) 개체는 **축** 컬렉션을 포함 합니다. **셀 집합** 을 열면이 컬렉션에 하나 이상의 **축**이 포함 됩니다. **축 개체를 사용 하** 는 방법에 대 한 자세한 설명은 [axis](../../../ado/reference/ado-md-api/axis-object-ado-md.md) 개체를 참조 하세요.  
  
> [!NOTE]
>  **셀 집합** 의 필터 축은 **축** 컬렉션에 포함 되지 않습니다. 자세한 내용은 [Filteraxis](../../../ado/reference/ado-md-api/filteraxis-property-ado-md.md) 속성을 참조 하세요.  
