---
title: 계층 개체 속성, 메서드 및 이벤트 | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "35283922"
---
# <a name="hierarchy-object-properties-methods-and-events"></a>계층 개체 속성, 메서드 및 이벤트
## <a name="propertiescollections"></a>속성/컬렉션  
 [Description 속성](../../../ado/reference/ado-md-api/description-property-ado-md.md)  
  
 [컬렉션 수준](../../../ado/reference/ado-md-api/levels-collection-ado-md.md)  
