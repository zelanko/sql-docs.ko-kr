...
|[Level](./level-object-ado-md.md)|에는 계층 구조 내에서 순위가 동일한 멤버 집합이 포함 되어 있습니다.|  
|[멤버](./member-object-ado-md.md)|큐브의 수준 멤버, 수준 멤버의 자식 또는 셀 집합의 축에 있는 위치의 멤버를 나타냅니다.|  
|[위치](./position-object-ado-md.md)|축의 한 지점을 정의 하는 여러 차원의 멤버 집합을 나타냅니다.|  
