...
## <a name="remarks"></a>설명  
 **LevelName** 속성을 사용 하 여 멤버가 속한 수준의 이름을 검색 합니다. 이는 [수준](../../../ado/reference/ado-md-api/level-object-ado-md.md) 개체의 [Name](../../../ado/reference/ado-md-api/name-property-ado-md.md) 속성에 해당 합니다.  
