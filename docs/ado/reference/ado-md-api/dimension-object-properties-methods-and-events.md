---
title: 차원 개체 속성, 메서드 및 이벤트 | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "35283892"
---
# <a name="dimension-object-properties-methods-and-events"></a>차원 개체 속성, 메서드 및 이벤트
## <a name="propertiescollections"></a>속성/컬렉션  
 [Description 속성](../../../ado/reference/ado-md-api/description-property-ado-md.md)  
  
 [Hierarchies 컬렉션](../../../ado/reference/ado-md-api/hierarchies-collection-ado-md.md)  
