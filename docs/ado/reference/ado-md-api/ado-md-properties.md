...
|[캡션](../../../ado/reference/ado-md-api/caption-property-ado-md.md)|표시할 때 사용할 텍스트 캡션을 나타냅니다는 **수준** 하거나 **멤버** 개체입니다.|  
|[ChildCount](../../../ado/reference/ado-md-api/childcount-property-ado-md.md)|멤버 수를 나타내는 현재 **멤버** 개체가 계층의 부모입니다.|  
...
|[항목](../../../ado/reference/ado-md-api/item-property-ado-md-cellset.md)|좌표를 사용 하 여 셀 집합에서 셀을 검색 합니다.|  
|[항목](../../../ado/reference/ado-api/item-property-ado.md)|이름 또는 서 수로 컬렉션의 특정 멤버를 반환합니다.|  
|[FormattedValue](../../../ado/reference/ado-md-api/formattedvalue-property-ado-md.md)|셀 값의 서식이 지정 된 표시를 나타냅니다.|  
|[LevelDepth](../../../ado/reference/ado-md-api/leveldepth-property-ado-md.md)|계층의 루트 및 멤버 간 수준 수를 나타냅니다.|  
...
|[서 수 (셀)](../../../ado/reference/ado-md-api/ordinal-property-ado-md-cell.md)|셀 집합 내의 위치를 기준으로 셀을 고유 하 게 식별합니다.|  
|[서 수 (위치)](../../../ado/reference/ado-md-api/ordinal-property-ado-md-position.md)|축 따라 위치를 고유 하 게 식별합니다.|  
|[Parent](../../../ado/reference/ado-md-api/parent-property-ado-md.md)|계층의 현재 멤버의 부모 멤버를 나타냅니다.|  
|[ParentSameAsPrev](../../../ado/reference/ado-md-api/parentsameasprev-property-ado-md.md)|이 위치 멤버의 부모를 바로 앞에 있는 멤버의 부모로 같은지 여부를 나타냅니다.|  
|[원본](../../../ado/reference/ado-md-api/source-property-ado-md.md)|셀 집합에서 데이터 원본을 나타냅니다.|  
