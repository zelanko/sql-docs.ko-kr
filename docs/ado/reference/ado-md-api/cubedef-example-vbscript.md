---
description: CubeDef 예제(VBScript)
title: CubeDef 예제 (VBScript) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "88987044"
---
# <a name="cubedef-example-vbscript"></a>CubeDef 예제(VBScript)
이 예제에서는 웹 페이지에 큐브 메타 데이터를 표시 합니다.  
