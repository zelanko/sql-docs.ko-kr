 ...
 *원본*  
 (선택 사항) A **Variant** MDX (Multidimensional Expression) 쿼리 등 유효한 다차원 쿼리를 계산 합니다. 합니다 *소스* 인수에 해당 합니다 [원본](../../../ado/reference/ado-md-api/source-property-ado-md.md) 속성입니다. MDX에 대 한 자세한 내용은 참조는 [OLE DB에 대 한 분석 처리 OLAP (온라인)](https://msdn.microsoft.com/8a7673c6-3ca1-4411-9f1e-adf1e47df4f3) Microsoft Data Access Components SDK 설명서.  
