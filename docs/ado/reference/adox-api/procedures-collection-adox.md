---
title: Procedures 컬렉션 (ADOX) | Microsoft Docs
ms.prod: sql
...
-   사용 하 여 컬렉션의 프로시저에 액세스 합니다 [항목](../../../ado/reference/ado-api/item-property-ado.md) 속성입니다.  
  
-   프로시저를 사용 하 여 컬렉션에 포함 된 개수를 반환 합니다 [개수](../../../ado/reference/ado-api/count-property-ado.md) 속성입니다.  
  
-   프로시저를 사용 하 여 컬렉션에서 제거 합니다 [삭제](../../../ado/reference/adox-api/delete-method-adox-collections.md) 메서드.  
...
## <a name="see-also"></a>관련 항목  
 ...
 [Procedures 컬렉션 속성, 메서드 및 이벤트](../../../ado/reference/adox-api/procedures-collection-properties-methods-and-events.md)   
