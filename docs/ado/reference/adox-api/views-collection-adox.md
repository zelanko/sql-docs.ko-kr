...
-   사용 하 여 컬렉션에 보기 액세스는 [항목](../../../ado/reference/ado-api/item-property-ado.md) 속성입니다.  
  
-   뷰를 사용 하 여 컬렉션에 포함 된 개수를 반환 된 [Count](../../../ado/reference/ado-api/count-property-ado.md) 속성입니다.  
  
-   뷰를 사용 하 여 컬렉션에서 제거 된 [삭제](../../../ado/reference/adox-api/delete-method-adox-collections.md) 메서드.  
