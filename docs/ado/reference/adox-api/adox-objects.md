...
|[인덱스](../../../ado/reference/adox-api/index-object-adox.md)|데이터베이스 테이블에서 인덱스를 나타냅니다.|  
...
|[보기](../../../ado/reference/adox-api/view-object-adox.md)|가상 테이블 또는 레코드의 필터링 된 집합을 나타냅니다.|  
  
 이러한 개체 간의 관계는에 설명 된 [ADOX 개체 모델](../../../ado/reference/adox-api/adox-object-model.md)합니다.  
