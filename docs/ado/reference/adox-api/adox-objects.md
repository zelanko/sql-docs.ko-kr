...
|[보기](../../../ado/reference/adox-api/view-object-adox.md)|가상 테이블을 레코드의 필터링 된 집합을 나타냅니다.|  
  
 이러한 개체 간의 관계에 설명 되어 있습니다 합니다 [ADOX 개체 모델](../../../ado/reference/adox-api/adox-object-model.md)합니다.  
  
 각 개체는 해당 컬렉션에 포함할 수 있습니다. 예를 들어, 한 **테이블** 개체에 포함 될 수는 [테이블](../../../ado/reference/adox-api/tables-collection-adox.md) 컬렉션입니다. 자세한 내용은 [ADOX 컬렉션](../../../ado/reference/adox-api/adox-collections.md) 또는 특정 컬렉션 항목입니다.  
