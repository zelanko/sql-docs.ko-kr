...
|[Index](../../../ado/reference/adox-api/index-object-adox.md)|데이터베이스 테이블의 인덱스를 나타냅니다.|  
|[Key](../../../ado/reference/adox-api/key-object-adox.md)|데이터베이스 테이블의 기본 키, 외래 키 또는 고유 키 필드를 나타냅니다.|  
...
|[보기](../../../ado/reference/adox-api/view-object-adox.md)|레코드 또는 가상 테이블의 필터링 된 집합을 나타냅니다.|  
 ...
 이러한 개체 간의 관계는 [ADOX 개체 모델](../../../ado/reference/adox-api/adox-object-model.md)에 나와 있습니다.  
  
 각 개체는 해당 컬렉션에 포함 될 수 있습니다. 예를 들어 **Table** 개체는 [Tables](../../../ado/reference/adox-api/tables-collection-adox.md) 컬렉션에 포함 될 수 있습니다. 자세한 내용은 [ADOX](../../../ado/reference/adox-api/adox-collections.md) 컬렉션 또는 특정 컬렉션 항목을 참조 하세요.  
