---
description: Microsoft Visual Basic의 ADOX 코드 예제
...
ms.locfileid: "88985764"
---
# <a name="adox-code-examples-in-microsoft-visual-basic"></a>Microsoft Visual Basic의 ADOX 코드 예제
이러한 항목에서는 ADOX를 사용 하는 방법을 이해 하는 데 도움이 되는 샘플 코드를 제공 합니다. 모든 코드 예제는 Microsoft Visual Basic를 사용 하 여 작성 됩니다.  
  
> [!NOTE]
>  Sub에서 End Sub의 전체 코드 예제를 코드 편집기에 붙여 넣습니다. 부분 예제를 사용 하거나 단락 서식이 손실 된 경우 예제가 올바르게 실행 되지 않을 수 있습니다.  
...
-   [Command 속성, Parameters 컬렉션 예제 (VB)](./parameters-collection-command-property-example-vb.md)  
  
-   [CommandText 속성, Views 컬렉션 예제 (VB)](./views-collection-commandtext-property-example-vb.md)  
...
-   [Key Type, RelatedColumn, RelatedTable 및 UpdateRule 속성, Keys Append 메서드 예제 (VB)](./keys-append-method-key-type-relatedcolumn-relatedtable-example-vb.md)  
  
-   [Name 속성, Columns 및 Tables Append 메서드 예제 (VB)](./columns-and-tables-append-methods-name-property-example-vb.md)  
  
-   [NumericScale 및 Precision 속성 예제(VB)](./adox-code-example-numericscale-and-precision-properties-example-vb.md)  
...
-   [Table Type 속성, Connection Close 메서드, Example (VB)](./connection-close-method-table-type-property-example-vb.md)  
  
## <a name="collections"></a>컬렉션  
  
-   [Parameters 컬렉션, Command 속성 예제(VB)](./parameters-collection-command-property-example-vb.md)  
  
-   [보기 및 필드 컬렉션 예제(VB)](./views-and-fields-collections-example-vb.md)  
  
-   [보기 컬렉션, CommandText 속성 예제(VB)](./views-collection-commandtext-property-example-vb.md)