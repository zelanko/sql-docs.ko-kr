---
title: 그룹 개체 (ADOX) | Microsoft Docs
ms.prod: sql
...
-   사용 하 여 그룹을 식별 합니다 [이름을](../../../ado/reference/adox-api/name-property-adox.md) 속성입니다.  
  
-   확인 여부를 그룹에 읽기, 쓰기 또는 삭제 권한을 사용 하 여는 [GetPermissions](../../../ado/reference/adox-api/getpermissions-method-adox.md) 및 [SetPermissions](../../../ado/reference/adox-api/setpermissions-method-adox.md) 메서드.  
  
-   멤버 자격을 사용 하 여 그룹에 있는 사용자 계정에 액세스 합니다 [사용자](../../../ado/reference/adox-api/users-collection-adox.md) 컬렉션입니다.  
