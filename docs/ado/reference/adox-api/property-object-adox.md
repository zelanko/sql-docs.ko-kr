...
## <a name="remarks"></a>설명  
 ...
 기본 제공 속성은 MyObject 속성 구문을 사용 하 여 새 개체에 즉시 사용할 수 있는 속성입니다. 이러한 속성은 개체의 [속성 컬렉션](../../../ado/reference/ado-api/properties-collection-ado.md)에 속성 개체로 표시 되지 않으므로 해당 값을 변경할 수 있지만 특성을 수정할 수는 없습니다.  
 ...
 [Value](../../../ado/reference/ado-api/value-property-ado.md) 속성은 속성 설정을 포함 하는 변형입니다. Value는 속성 개체의 기본 속성입니다.  
