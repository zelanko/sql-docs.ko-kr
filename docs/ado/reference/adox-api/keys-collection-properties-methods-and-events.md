---
title: 컬렉션 속성, 메서드 및 이벤트 키 | Microsoft Docs
ms.prod: sql
...
---
# <a name="keys-collection-properties-methods-and-events"></a>키 컬렉션 속성, 메서드 및 이벤트
...
## <a name="methods"></a>메서드  
 [Append 메서드 (예: 키)](../../../ado/reference/adox-api/append-method-adox-keys.md)  
