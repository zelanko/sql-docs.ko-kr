---
title: 'RecordsetEvents (Visual c + + 구문 인덱스 #import) | Microsoft Docs'
ms.prod: sql
...
---
# <a name="recordsetevents-visual-c-syntax-index-with-import"></a>RecordsetEvents (Visual c + + 구문 인덱스 #import)
## <a name="events"></a>이벤트  
