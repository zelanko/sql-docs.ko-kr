---
title: 'RecordsetEvents (Visual c + + 구문 있는 인덱스 #import) | Microsoft Docs'
ms.prod: sql
...
ms.locfileid: "35281282"
---
# <a name="recordsetevents-visual-c-syntax-index-with-import"></a>RecordsetEvents (Visual c + + 구문 인덱스 #import 사용)
## <a name="events"></a>이벤트  
