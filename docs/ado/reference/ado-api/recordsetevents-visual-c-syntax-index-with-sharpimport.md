---
title: 'RecordsetEvents (Visual C++ #import 구문 인덱스) | Microsoft Docs'
ms.prod: sql
...
ms.locfileid: "66711702"
---
# <a name="recordsetevents-visual-c-syntax-index-with-import"></a>RecordsetEvents (Visual C++ #import 구문 인덱스)
## <a name="events"></a>이벤트  
