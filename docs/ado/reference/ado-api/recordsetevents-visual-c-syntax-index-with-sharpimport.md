---
description: RecordsetEvents (#import를 사용 하는 Visual C++ 구문 인덱스)
title: RecordsetEvents (#import를 사용 하는 Visual C++ 구문 인덱스) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "88989724"
---
# <a name="recordsetevents-visual-c-syntax-index-with-import"></a>RecordsetEvents (#import를 사용 하는 Visual C++ 구문 인덱스)
## <a name="events"></a>이벤트  
