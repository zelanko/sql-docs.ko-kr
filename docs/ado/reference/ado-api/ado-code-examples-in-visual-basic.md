---
title: Visual Basic의 ADO 코드 예제 | Microsoft Docs
ms.prod: sql
...
> [!NOTE]
>  End Sub를 하위에서 전체 코드 예제를에서는 코드 편집기에 붙여넣습니다. 예제에서는 예제 부분을 사용 하는 경우 또는 단락 서식이 손실 된 경우 올바르게 실행 되지 않을 수 있습니다.  
...
-   [Execute, requery, Clear 메서드 예제](../../../ado/reference/ado-api/execute-requery-and-clear-methods-example-vb.md)  
...
-   [읽기, ReadText, Write 및 WriteText 메서드 예제](../../../ado/reference/ado-api/read-readtext-write-and-writetext-methods-example-vb.md)  
...
-   [AbsolutePage, PageCount, PageSize 속성 예제](../../../ado/reference/ado-api/absolutepage-pagecount-and-pagesize-properties-example-vb.md)  
...
-   [Attributes 및 Name 속성 예제](../../../ado/reference/ado-api/attributes-and-name-properties-example-vb.md)  
...
-   [ConnectionString, ConnectionTimeout, 및 State 속성 예제](../../../ado/reference/ado-api/connectionstring-connectiontimeout-and-state-properties-example-vb.md)  
  
-   [Count 속성 예제](../../../ado/reference/ado-api/count-property-example-vb.md)  
  
-   [CursorType, LockType, EditMode 속성 예제](../../../ado/reference/ado-api/cursortype-locktype-and-editmode-properties-example-vb.md)  
  
-   [설명, HelpContext, HelpFile, NativeError, 번호, 원본 및 SQLState 속성 예제](../../../ado/reference/ado-api/description-helpcontext-helpfile-nativeerror-number-source-example-vb.md)  
...
-   [Prepared 속성 예제](../../../ado/reference/ado-api/prepared-property-example-vb.md)  
  
-   [Provider 및 DefaultDatabase 속성 예제](../../../ado/reference/ado-api/provider-and-defaultdatabase-properties-example-vb.md)  
