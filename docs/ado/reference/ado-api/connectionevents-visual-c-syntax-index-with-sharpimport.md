---
title: 'ConnectionEvents (Visual c + + 구문 인덱스 #import) | Microsoft Docs'
ms.prod: sql
...
---
# <a name="connectionevents-visual-c-syntax-index-with-import"></a>ConnectionEvents (Visual c + + 구문 인덱스 #import)
## <a name="events"></a>이벤트  
