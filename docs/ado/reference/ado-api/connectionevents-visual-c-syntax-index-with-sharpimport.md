---
title: 'ConnectionEvents (Visual C++ #import 구문 인덱스) | Microsoft Docs'
ms.prod: sql
...
ms.locfileid: "66698731"
---
# <a name="connectionevents-visual-c-syntax-index-with-import"></a>ConnectionEvents (Visual C++ #import 구문 인덱스)
## <a name="events"></a>이벤트  
