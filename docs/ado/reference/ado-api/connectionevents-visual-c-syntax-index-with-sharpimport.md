---
title: 'ConnectionEvents (Visual c + + 구문 있는 인덱스 #import) | Microsoft Docs'
ms.prod: sql
...
ms.locfileid: "35276982"
---
# <a name="connectionevents-visual-c-syntax-index-with-import"></a>ConnectionEvents (Visual c + + 구문 인덱스 #import 사용)
## <a name="events"></a>이벤트  
