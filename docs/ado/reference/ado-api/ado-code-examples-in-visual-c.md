...
-   [추가 및 CreateParameter 메서드 예제](../../../ado/reference/ado-api/append-and-createparameter-methods-example-vc.md)  
...
-   [ActiveConnection, CommandText, CommandTimeout, CommandType, 크기 및 방향 속성 예제](../../../ado/reference/ado-api/activeconnection-commandtext-commandtimeout-commandtype-size-example-vc.md)  
