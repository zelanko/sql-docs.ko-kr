---
title: '레코드 집합 (Visual c + + 구문 있는 인덱스 #import) | Microsoft Docs'
ms.prod: sql
...
ms.locfileid: "35281202"
---
# <a name="recordset-visual-c-syntax-index-with-import"></a>레코드 집합 (Visual c + + 구문 인덱스 #import 사용)
