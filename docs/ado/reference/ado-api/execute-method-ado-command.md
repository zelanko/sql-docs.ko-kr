...
> [!NOTE]
>  내부 처리를 최소화 하 여 성능을 향상 시키려면 **ExecuteadExecuteNoRecords 열거형** 값을 사용 합니다. **** **AdExecuteStream** 가 지정 된 경우 **adasyncfetch** 및 **adAsynchFetchNonBlocking** 옵션이 무시 됩니다. **Adcmdfile** 또는 **adCmdTableDirect** 의 **CommandTypeEnum** 값을 **Execute**와 함께 사용 하지 마세요. 이러한 값은 **레코드 집합**의 [Open](../../../ado/reference/ado-api/open-method-ado-recordset.md) 및 [Requery](../../../ado/reference/ado-api/requery-method.md) 메서드에서 옵션 으로만 사용할 수 있습니다.  
