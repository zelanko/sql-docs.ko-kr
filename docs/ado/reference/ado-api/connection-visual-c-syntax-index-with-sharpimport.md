---
title: '연결 (Visual c + + 구문 있는 인덱스 #import) | Microsoft Docs'
ms.prod: sql
...
ms.locfileid: "35277104"
---
# <a name="connection-visual-c-syntax-index-with-import"></a>(Visual c + + 구문 인덱스 #import와) 연결
