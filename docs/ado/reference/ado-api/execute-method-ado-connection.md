 ...
 *RecordsAffected*  
 선택 사항입니다. 공급자가 작업에서 영향을 받은 레코드 수를 반환 하는 **Long** 변수입니다.  
  
 *Options*  
 선택 사항입니다. 공급자가 CommandText 인수를 평가 하는 방법을 나타내는 **Long** 값입니다. 하나 이상의 CommandTypeEnum 또는 [Execute 열거형](../../../ado/reference/ado-api/executeoptionenum.md) 값 [CommandTypeEnum](../../../ado/reference/ado-api/commandtypeenum.md) 의 비트 마스크 일 수 있습니다.  
