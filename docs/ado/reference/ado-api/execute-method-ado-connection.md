 ...
 *옵션*  
 (선택 사항) 공급자가 CommandText 인수를 평가 하는 방법을 나타내는 **Long** 값입니다. 하나 이상의 CommandTypeEnum 또는 [Execute 열거형](../../../ado/reference/ado-api/executeoptionenum.md) 값 [](../../../ado/reference/ado-api/commandtypeenum.md) 의 비트 마스크 일 수 있습니다.  
  
 **참고** Visual Basic 6.0에서 이식 하는 응용 프로그램 및 내부 처리를 최소화 하 여 성능을 향상 시키려면 **ExecuteadExecuteNoRecords 열거형** 값을 사용 합니다. ****  
