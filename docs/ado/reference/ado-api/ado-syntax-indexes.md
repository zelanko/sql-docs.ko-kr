...
-   [Visual c + + 구문 인덱스에 대 한 COM ADO](../../../ado/reference/ado-api/ado-for-visual-c-syntax-index-for-com.md) ADO 속성과 메서드를 사용 하지 않고 설명 된 **#import** Microsoft Visual c + + 컴파일러 지시문.  
