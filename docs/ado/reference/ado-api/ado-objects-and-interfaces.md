...
|[ADORecordConstruction](../../../ado/reference/ado-api/adorecordconstruction-interface.md)|ADO 구문 **레코드** OLE DB 개체 **행** C/c + + 응용 프로그램에서 개체입니다.|  
|[ADORecordsetConstruction](../../../ado/reference/ado-api/adorecordsetconstruction-interface.md)|ADO 구문 **레코드 집합** OLE DB 개체 **행 집합** C/c + + 응용 프로그램에서 개체입니다.|  
|[ADOStreamConstruction 인터페이스](../../../ado/reference/ado-api/adostreamconstruction-interface.md)|ADO 구문 **Stream** OLE DB 개체 **IStream** C/c + + 응용 프로그램에서 개체입니다.|  
