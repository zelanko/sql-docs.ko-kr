...
> [!NOTE]
>  *NumBytes* 는 항상 바이트를 측정 합니다. 텍스트 **스트림** 개체 (adTypeText[형식](../../../ado/reference/ado-api/type-property-ado-stream.md) ) **adTypeText**의 경우 [ReadText](../../../ado/reference/ado-api/readtext-method.md)를 사용 합니다.  
