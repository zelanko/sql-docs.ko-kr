---
title: '레코드 (Visual c + + 구문 있는 인덱스 #import) | Microsoft Docs'
ms.prod: sql
...
ms.locfileid: "35280842"
---
# <a name="record-visual-c-syntax-index-with-import"></a>레코드 (Visual c + + 구문 인덱스 #import 사용)
