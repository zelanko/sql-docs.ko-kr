...
|[추가](../../../ado/reference/ado-api/append-method-ado.md)|컬렉션에 개체를 추가 합니다. 컬렉션이 **필드인**경우 컬렉션에 추가 되기 전에 새 **필드** 개체를 만들 수 있습니다.|  
...
|[원본과](../../../ado/reference/ado-api/clone-method-ado.md)|기존 **recordset** 개체에서 중복 **레코드 집합** 개체를 만듭니다. 필요에 따라 복제본을 읽기 전용으로 지정 합니다.|  
|[닫습니다](../../../ado/reference/ado-api/close-method-ado.md)|열린 개체와 모든 종속 개체를 닫습니다.|  
...
|[CopyTo](../../../ado/reference/ado-api/copyto-method-ado.md)|**스트림에** 따라 지정 된 문자 또는 바이트 수를 다른 **스트림** 개체에 복사 합니다. ****|  
...
|[Save](../../../ado/reference/ado-api/save-method.md)|파일 또는 **스트림** 개체에 **레코드 집합** 을 저장 합니다.|  
...
|[지원함](../../../ado/reference/ado-api/supports-method.md)|지정 된 **레코드 집합** 개체가 특정 유형의 기능을 지원 하는지 여부를 확인 합니다.|  
|[고침](../../../ado/reference/ado-api/update-method.md)|레코드 **집합** 개체의 현재 행 또는 **Record** 개체의 **Fields** 컬렉션에 대 한 변경 내용을 저장 합니다.|  
