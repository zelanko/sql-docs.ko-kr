---
title: AbsolutePage, PageCount, PageSize 속성 예제 (VB) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "67921852"
---
# <a name="absolutepage-pagecount-and-pagesize-properties-example-vb"></a>AbsolutePage, PageCount, PageSize 속성 예제 (VB)
```  
'BeginAbsolutePageVB  
