---
title: 언어에 따라 ADO 이벤트 인스턴스화 | Microsoft Docs
ms.prod: sql
...
---
# <a name="ado-event-instantiation-by-language"></a>언어별 ADO 이벤트 인스턴스 생성
각 프로그래밍 언어는 다르게 ADO 이벤트의 인스턴스를 만듭니다. 사용자가 만드는 모든 다음 예제는 **ConnectComplete** 이벤트 처리기입니다.  
