...
ms.locfileid: "88980694"
---
# <a name="handling-errors-in-jscript"></a>JScript로 오류 처리
Microsoft® JScript® 코드는 **연결** 개체의 **Errors** 컬렉션의 **Count** 속성을 확인 해야 합니다. 값이 0 보다 큰 경우 컬렉션을 반복 하 고 다른 언어와 동일한 방식으로 값을 인쇄 합니다.  
