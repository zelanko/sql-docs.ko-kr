...
## <a name="adlockoptimistic"></a>adLockOptimistic  
 공급자 낙관적 잠금 사용 됨을 나타냅니다-레코드를 호출 하는 경우에 잠금 합니다 **업데이트** 메서드. 레코드를 호출 하는 경우 편집이 즉, 다른 사용자가 시간 간에 데이터를 변경할 수 있습니다 수 있는지 **업데이트**, 충돌 만듭니다. 충돌 가능성이 낮은 상황에서이 잠금 유형을 사용 하거나 충돌 쉽게 해결할 수 있습니다.  
