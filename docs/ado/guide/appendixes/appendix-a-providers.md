...
|Active Directory 서비스|[Microsoft Active Directory 서비스에 대 한 Microsoft OLE DB Provider](../../../ado/guide/appendixes/microsoft-ole-db-provider-for-microsoft-active-directory-service.md)|
