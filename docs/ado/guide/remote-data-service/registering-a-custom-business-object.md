...
> [!NOTE]
>  MDAC 2.0 이상 및 Windows DAC의 경우 기본 비즈니스 개체 [RDSServer. DataFactory](../../reference/rds-api/datafactory-object-rdsserver.md)는 Mdac/Windows dac를 설치 하는 동안 기본적으로 등록 되지 않습니다. 그러나 설치 전에 **RDSServer. DataFactory** 가 컴퓨터에서 실행을 위해 안전 하 게 등록 된 경우 레지스트리 항목은 새 설치를 위해 유지 관리 됩니다.  
