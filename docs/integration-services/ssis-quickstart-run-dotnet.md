---
title: ".NET 코드 (C#)와 함께 SSIS 프로젝트를 실행 | Microsoft Docs"
ms.date: 09/25/2017
ms.topic: article
...
---
# <a name="run-an-ssis-package-with-c-code-in-a-net-app"></a>.NET 응용 프로그램에서 C# 코드가 사용 된 SSIS 패키지 실행
이 빠른 시작 자습서에는 데이터베이스 서버에 연결 하 고 SSIS 패키지를 실행 하는 C# 코드를 작성 하는 방법을 보여 줍니다.
...
3. 선택 **콘솔 응용 프로그램** 입력 *run_ssis_project* 프로젝트 이름에 대 한 합니다.
...
2. 패키지 예상 대로 실행 되었는지 확인 하 고 응용 프로그램 창을 닫습니다.
