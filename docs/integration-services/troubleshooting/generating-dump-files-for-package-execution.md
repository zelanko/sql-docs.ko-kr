---
title: SSIS 패키지 실행을 위한 덤프 파일 생성
description: "\"오류 시 덤프\" 옵션을 사용하여 SQL Server Integration Services 문제를 해결하는 방법을 알아봅니다. 이러한 옵션은 .mdmp 디버그 덤프 파일 및 텍스트 .tmp 디버그 덤프 파일을 생성합니다. 디버그 덤프 파일 형식을 알아봅니다."
ms.date: 08/24/2016
ms.prod: sql
