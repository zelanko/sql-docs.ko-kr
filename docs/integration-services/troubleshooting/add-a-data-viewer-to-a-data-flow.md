...
ms.topic: "article"
helpviewer_keywords: 
  - "데이터 뷰어 [Integration Services]"
  - "데이터 흐름 [Integration Services], 데이터 뷰어"
  - "데이터 뷰어 추가"
