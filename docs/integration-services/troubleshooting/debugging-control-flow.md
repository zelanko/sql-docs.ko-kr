...
ms.topic: "article"
helpviewer_keywords: 
  - "진행률 보고 [Integration Services]"
  - "중단점 [Integration Services]"
  - "디버깅 [Integration Services], 제어 흐름"
  - "제어 흐름 [Integration Services], 디버깅"
  - "색 구분 진행률 보고 [Integration Services]"
  - "중단점 설정 대화 상자"
...
-   [태스크 또는 컨테이너에 중단점을 설정하여 패키지 디버깅](../../integration-services/troubleshooting/debug-a-package-by-setting-breakpoints-on-a-task-or-a-container.md)  
