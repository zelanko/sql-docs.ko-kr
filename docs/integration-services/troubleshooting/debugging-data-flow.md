...
helpviewer_keywords: 
  ...
  - "데이터 흐름 [Integration Services], 디버깅"
  - "디버깅 [Integration Services], 데이터 흐름"
  - "행 계산"
...
-   [데이터 흐름에 데이터 뷰어 추가](../../integration-services/troubleshooting/add-a-data-viewer-to-a-data-flow.md)  
