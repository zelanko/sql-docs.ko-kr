...
## <a name="create-the-lesson-5-package"></a>5단원 패키지 만들기  
  
완료된 4단원을 복사하는 경우 이 프로시저를 사용하세요.  샘플 4단원을 복사하려면 다음 섹션을 참조하세요.
...
2.  **파일** 메뉴에서 **열기** > **프로젝트/솔루션**, **SSIS 자습서** 폴더, **열기**를 차례로 선택합니다.  그런 다음, **SSIS Tutorial.sln**을 두 번 클릭합니다.

3.  **솔루션 탐색기**에서 **Lesson 4.dtsx**를 마우스 오른쪽 단추로 클릭한 다음, **복사**를 선택합니다.
...
7.  **속성** 창에서 **Name** 속성을 **5단원**으로 변경합니다.

8.  **ID** 속성 상자를 선택하고 드롭다운 화살표를 선택한 다음, **\<Generate New ID>** 을 선택합니다.

## <a name="add-the-completed-lesson-4-package"></a>완성된 4단원 패키지 추가
...
4.  찾아보기 **(...)** 단추를 선택하여 머신의 **Lesson 4.dtsx**로 이동한 다음, **열기**를 선택합니다.

5.  이전 섹션의 3-8단계에서 설명한 대로 4단원 패키지를 복사하여 붙여넣습니다.
