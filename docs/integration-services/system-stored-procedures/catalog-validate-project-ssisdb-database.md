...
## <a name="arguments"></a>인수  
 ...
 [ @validate_type =] *validate_type*  
 수행할 유효성 검사의 유형을 나타냅니다. 전체 유효성 검사를 수행하려면 `F` 문자를 사용합니다. *validate_type* 은 **char(1)**합니다.  
...
## <a name="remarks"></a>주의  
 유효성 검사를 통해 프로젝트에 있는 패키지 실행을 방해하는 문제를 확인할 수 있습니다. 사용 하 여는 [catalog.validations](../../integration-services/system-views/catalog-validations-ssisdb-database.md) 또는 [catalog.operations](../../integration-services/system-views/catalog-operations-ssisdb-database.md) 뷰를 유효성 검사 상태를 모니터링 합니다.  
