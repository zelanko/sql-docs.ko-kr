...
helpviewer_keywords: 
  - "SSIS 컨테이너"
  - "컨테이너 [Integration Services]"
  - "컨테이너 [Integration Services], 컨테이너 정보"
  - "제어 흐름 [Integration Services], 컨테이너"
  - "SQL Server Integration Services 컨테이너"
...
|**Description**|컨테이너 설명입니다. 이 속성에는 문자열이 포함되지만 비워 둘 수 있습니다.<br /><br /> 자세한 내용은 <xref:Microsoft.SqlServer.Dts.Runtime.DtsContainer.Description%2A>을 참조하세요.|  
