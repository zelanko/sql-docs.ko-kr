...
**Azure SQL DW 업로드 태스크**는 SQL Server 2016에 제공되는 Azure용 SSIS(SQL Server Integration Services) 기능 팩의 구성 요소입니다. [여기](http://go.microsoft.com/fwlink/?LinkID=626967)서 기능 팩을 다운로드하세요.
...
ColumnDelimiter|각 열의 끝을 표시하는 하나 이상의 문자를 지정합니다. 예를 들어 파이프의 경우 &#124, 탭의 경우 \t, 파이프-탭 시퀀스의 경우 &#124;\t를 지정합니다.
