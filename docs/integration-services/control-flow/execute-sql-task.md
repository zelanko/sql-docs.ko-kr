...
helpviewer_keywords: 
  - "Transact-SQL 문, SSIS"
  - "문 [Integration Services]"
  - "일괄 처리 [Integration Services]"
  - "SQL 실행 태스크 [Integration Services]"
...
## SQL 문 만들기  
 ...
 [!INCLUDE[ssIS](../../includes/ssis-md.md)] 디자이너에서는 **SQL 실행 태스크 편집기** 대화 상자를 사용하여 SQL 문을 입력하거나 SQL 쿼리 작성용 그래픽 사용자 인터페이스인 **쿼리 작성기**를 사용할 수 있습니다. 자세한 내용은 [SQL 실행 태스크 편집기&#40;일반 페이지&#41;](../Topic/Execute%20SQL%20Task%20Editor%20\(General%20Page\).md) 및 [쿼리 작성기](../Topic/Query%20Builder.md)를 참조하세요.  
...
>  데이터 공급자가 지원하는 경우에만 SQL 실행 태스크에 매개 변수를 사용할 수 있습니다.  
 ...
 SQL 실행 태스크에서 매개 변수 및 반환 코드를 사용하는 방법은 [SQL 실행 태스크의 매개 변수 및 반환 코드](../Topic/Parameters%20and%20Return%20Codes%20in%20the%20Execute%20SQL%20Task.md)를 참조하세요.  
...
## 결과 집합 유형 지정  
 ...
 SQL 실행 태스크의 SQL 명령에서 결과 집합을 검색하는 방법은 [SQL 실행 태스크의 결과 집합](../Topic/Result%20Sets%20in%20the%20Execute%20SQL%20Task.md)을 참조하세요.  
...
### 사용자 지정 로그 항목  
 다음 표에서는 SQL 실행 태스크에 대한 사용자 지정 로그 항목을 설명합니다. 자세한 내용은 [Integration Services&#40;SSIS&#41; 로깅](../../integration-services/performance/integration-services-ssis-logging.md) 및 [로깅할 메시지 사용자 지정](../../integration-services/performance/custom-messages-for-logging.md)을 참조하세요.  
...
-   [SQL 실행 태스크 편집기&#40;일반 페이지&#41;](../Topic/Execute%20SQL%20Task%20Editor%20\(General%20Page\).md)  
  
-   [SQL 실행 태스크 편집기&#40;매개 변수 매핑 페이지&#41;](../Topic/Execute%20SQL%20Task%20Editor%20\(Parameter%20Mapping%20Page\).md)  
  
-   [SQL 실행 태스크 편집기&#40;결과 집합 페이지&#41;](../Topic/Execute%20SQL%20Task%20Editor%20\(Result%20Set%20Page\).md)  
...
-   [결과 집합을 SQL 실행 태스크의 변수에 매핑](../Topic/Map%20Result%20Sets%20to%20Variables%20in%20an%20Execute%20SQL%20Task.md)  
  
## 관련 내용  
  
-   [SQL 실행 태스크의 매개 변수 및 반환 코드](../Topic/Parameters%20and%20Return%20Codes%20in%20the%20Execute%20SQL%20Task.md)  
  
-   [SQL 실행 태스크의 결과 집합](../Topic/Result%20Sets%20in%20the%20Execute%20SQL%20Task.md)  
