...
helpviewer_keywords: 
  - "태스크 [Integration Services], 선행 제약 조건"
  - "제어 흐름 [Integration Services], 선행 제약 조건"
  - "선행 제약 조건 [Integration Services]"
  - "제약 조건 [Integration Services]"
  - "시퀀스 실행 옵션 [Integration Services]"
  - "컨테이너 [Integration Services], 선행 제약 조건"
...
# 선행 제약 조건
 ...
 ![패키지의 선행 제약 조��](../../integration-services/control-flow/media/mw-dts-12.gif "패키지의 선행 제약 조��")  
...
## 선행 제약 조건 구성  
 ...
 [!INCLUDE[ssIS](../../includes/ssis-md.md)] 디자이너에서 설정할 수 있는 속성에 대한 자세한 내용은 [선행 제약 조건 편집기](../Topic/Precedence%20Constraint%20Editor.md)를 참조하세요.  
  
 이러한 속성을 프로그래밍 방식으로 설정하는 방법은 <xref:Microsoft.SqlServer.Dts.Runtime.PrecedenceConstraint>를 참조하세요.  
  
## 관련 작업  
 [!INCLUDE[ssIS](../../includes/ssis-md.md)] 디자이너에서 이러한 속성을 설정하는 방법을 보려면 다음 항목 중 하나를 클릭하십시오.  
  
-   [선행 제약 조건의 속성 설정](../Topic/Set%20the%20Properties%20of%20a%20Precedence%20Constraint.md)  
  
-   [바로 가기 메뉴를 사용하여 선행 제약 조건 값 설정](../Topic/Set%20the%20Value%20of%20a%20Precedence%20Constraint%20by%20Using%20the%20Shortcut%20Menu.md)  
...
## 관련 항목:  
 [선행 제약 조건에 식 추가](../Topic/Add%20Expressions%20to%20Precedence%20Constraints.md)   
 [여러 선행 제약 조건](../Topic/Multiple%20Precedence%20Constraints.md)  
