...
**Azure HDInsight Pig 태스크** 의 구성 요소는 [Azure에 대 한 SQL Server Integration Services (SSIS) 기능 팩](../../integration-services/azure-feature-pack-for-integration-services-ssis.md)합니다.
...
5.  두 가지 방법으로 Pig 스크립트를 실행할 수를 지정할 수 있습니다.
