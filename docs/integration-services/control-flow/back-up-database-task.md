...
helpviewer_keywords: 
  - "데이터베이스 백업 [Integration Services]"
  - "데이터베이스 백업 태스크 [Integration Services]"
  - "데이터베이스 백업 [Integration Services]"
  - "트랜잭션 로그 백업 [Integration Services]"
  - "트랜잭션 로그 백업 [Integration Services]"
...
-   [데이터베이스 백업 태스크&#40;유지 관리 계획&#41;](../../relational-databases/maintenance-plans/back-up-database-task-maintenance-plan.md)  
