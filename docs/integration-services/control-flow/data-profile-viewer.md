---
title: "데이터 프로필 뷰어(Data Profile Viewer) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "데이터 프로필 뷰어 [Integration Services]"
  - "데이터 프로파일링 태스크 [Integration Services], 출력 뷰어"
...
---
# 데이터 프로필 뷰어(Data Profile Viewer)
...
-   [!INCLUDE[ssIS](../../includes/ssis-md.md)] 디자이너에서 **데이터 프로파일링** 태스크를 마우스 오른쪽 단추로 클릭하고 **편집**을 클릭합니다. **데이터 프로파일링 태스크 편집기** 의 **일반** 페이지에서 **프로필 뷰어 열기**를 클릭합니다.  
