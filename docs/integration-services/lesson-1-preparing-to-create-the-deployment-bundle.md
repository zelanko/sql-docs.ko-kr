...
-   [1단계: 작업 폴더 및 환경 변수 만들기](../integration-services/step-1-creating-working-folders-and-environment-variables.md)  
  
-   [2단계: 배포 프로젝트 만들기](../integration-services/step-2-creating-the-deployment-project.md)  
  
-   [3단계: 패키지 및 기타 파일 추가](../integration-services/step-3-adding-packages-and-other-files.md)  
