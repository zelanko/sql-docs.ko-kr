...
## [파일을 저장하고 파일 공유에 연결](lift-shift/ssis-azure-files-file-shares.md)
...
# [패키지](integration-services-ssis-packages.md)
...
#### [1-4단원 - 패키지 구성 추가](lesson-1-4-adding-package-configurations.md)
