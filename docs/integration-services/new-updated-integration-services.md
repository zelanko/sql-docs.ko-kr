...
2. [Windows 인증을 사용하여 온-프레미스 데이터 원본에 연결](lift-shift/ssis-azure-connect-with-windows-auth.md)
3. [Azure에서 SSIS 패키지 배포, 실행 및 모니터링](lift-shift/ssis-azure-deploy-run-monitor-tutorial.md)
4. [SQL Server Integration Services 워크로드를 클라우드로 리프트 앤 시프트](lift-shift/ssis-azure-lift-shift-ssis-packages-overview.md)
5. [Azure에서 SSIS 패키지 실행 예약](lift-shift/ssis-azure-schedule-packages.md)
6. [ISDeploymentWizard.exe를 사용하여 명령 프롬프트에서 SSIS 프로젝트 배포](ssis-quickstart-deploy-cmdline.md)
7. [.NET 앱에 C# 코드가 있는 SSIS 프로젝트 배포](ssis-quickstart-deploy-dotnet.md)
8. [PowerShell을 사용하여 SSIS 프로젝트 배포](ssis-quickstart-deploy-powershell.md)
9. [SSMS(SQL Server Management Studio)를 사용하여 SSIS 프로젝트 배포](ssis-quickstart-deploy-ssms.md)
10. [Transact-SQL을 사용하여 SSMS에서 SSIS 프로젝트 배포](ssis-quickstart-deploy-tsql-ssms.md)
11. [Transact-SQL을 사용하여 Visual Studio Code에서 SSIS 프로젝트 배포](ssis-quickstart-deploy-tsql-vscode.md)
12. [DTExec.exe를 사용하여 명령 프롬프트에서 SSIS 패키지 실행](ssis-quickstart-run-cmdline.md)
13. [.NET 앱에서 C# 코드가 있는 SSIS 패키지 실행](ssis-quickstart-run-dotnet.md)
14. [PowerShell을 사용하여 SSIS 패키지 실행](ssis-quickstart-run-powershell.md)
15. [SSMS(SQL Server Management Studio)를 사용하여 SSIS 패키지 실행](ssis-quickstart-run-ssms.md)
16. [Transact-SQL(SSMS)을 사용하여 SSIS 패키지 실행](ssis-quickstart-run-tsql-ssms.md)
17. [Transact-SQL을 사용하여 Visual Studio Code에서 SSIS 패키지 실행](ssis-quickstart-run-tsql-vscode.md)
