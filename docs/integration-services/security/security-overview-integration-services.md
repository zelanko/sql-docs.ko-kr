...
helpviewer_keywords: 
  - "SSIS 패키지, 보안"
  - "Integration Services, 보안"
  - "보안 [Integration Services], 보안 정보"
  - "암호 [Integration Services]"
  - "패키지 [Integration Services], 보안"
  - "SQL Server Integration Services, 보안"
  - "SSIS, 보안"
...
### 패키지 콘텐츠에 대한 액세스 제어  
 ...
 자세한 내용은 [Access Control for Sensitive Data in Packages](../../integration-services/packages/access-control-for-sensitive-data-in-packages.md)을 참조하세요.  
...
### 패키지에서 사용되는 파일에 대한 액세스 제어  
 ...
 자세한 내용은 [패키지에서 사용되는 파일 액세스](../../integration-services/security/access-to-files-used-by-packages.md)를 참조하세요.  
...
### Integration Services 서비스에 대한 액세스 제어  
 ...
 자세한 내용은 [Integration Services 서비스 액세스](../../integration-services/security/access-to-the-integration-services-service.md)를 참조하세요.  
...
-   [레지스트리 값을 설정하여 서명 정책 구현](../../integration-services/packages/implement-a-signing-policy-by-setting-a-registry-value.md)  
  
-   [디지털 인증서를 사용하여 패키지 서명](../../integration-services/packages/sign-a-package-by-using-a-digital-certificate.md)  
  
-   [패키지 보호 수준 설정 또는 변경](../../integration-services/packages/set-or-change-the-protection-level-of-packages.md)  
