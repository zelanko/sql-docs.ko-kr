---
title: "3 단원: SSIS 패키지를 설치 하 | Microsoft Docs"
ms.custom: 
ms.date: 03/14/2017
...
-   [1 단계: 배포 번들 복사](../integration-services/lesson-3-1-copying-the-deployment-bundle.md)  
  
-   [2 단계: 패키지 설치 마법사를 실행합니다.](../integration-services/lesson-3-2-running-the-package-installation-wizard.md)  
