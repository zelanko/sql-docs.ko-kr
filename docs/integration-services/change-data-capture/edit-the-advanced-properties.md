...
ms.author: douglasl
manager: craigg
ms.openlocfilehash: f3a1012f2c7015fe537e7961d5666d7d57dec7f6
...
2.  **값** 열에 속성에 대해 유효한 값을 입력합니다.  
  
    > [!NOTE]  
    >  뷰어에서 고급 속성을 볼 수 있습니다. 뷰어를 사용할 때 정보는 읽기 전용입니다. 또한 뷰어에는 테이블에서 캡처된 열 목록이 포함되어 있습니다.  
