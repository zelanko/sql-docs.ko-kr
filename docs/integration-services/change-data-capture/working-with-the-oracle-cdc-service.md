...
|유형|다음 값 중 하나가 포함됩니다.<br /><br /> ERROR<br /><br /> INFO<br /><br /> TRACE|  
 ...
 **dbo.xcdcdc_start** 프로시저를 사용하려면 사용자는 CDC 데이터베이스에 대한 **db_owner** 데이터베이스 역할의 멤버이거나 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 인스턴스에 대한 **sysadmin** 또는 **serveradmin** 역할의 멤버여야 합니다.  
 ...
 **dbo.xcdcdc_stop** 프로시저를 사용하려면 사용자는 CDC 데이터베이스에 대한 **db_owner** 데이터베이스 역할의 멤버이거나 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 인스턴스에 대한 **sysadmin** 또는 **serveradmin** 역할의 멤버여야 합니다.  
