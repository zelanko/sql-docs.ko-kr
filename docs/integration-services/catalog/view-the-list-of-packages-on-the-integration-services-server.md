---
description: Integration Services 서버의 패키지 목록 보기
...
### <a name="to-view-packages-using-ssmanstudiofull"></a>다음을 사용하여 패키지를 보려면 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]  
