...
helpviewer_keywords: 
  ...
  - "SSIS, 설치"
  - "Integration Services 설치, Integration Services 설치 정보"
  - "SQL Server Integration Services, 설치"
  - "설치 [Integration Services], Integration Services 설치 정보"
  - "Integration Services 설치"
  - "설치 [Integration Services]"
...
>     
>  사용 권한을 부여하는 방법에 대한 자세한 내용은 [Grant Permissions to Integration Services Service](../../integration-services/service/grant-permissions-to-integration-services-service.md)를 참조하십시오.    
