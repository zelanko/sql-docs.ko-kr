---
title: SQL Server Integration Services 설치 | Microsoft Docs
...
- **선택적 추가 구성 요소**. 필요에 따라 SQL Server 기능 패키지에서 추가 타사 구성 요소를 다운로드할 수 있습니다.
  ...
  - Attunity의 Oracle 및 Teradata용 Microsoft Connectors. 이러한 구성 요소를 가져오려면 [Attunity 커넥터](../attunity-connectors.md)를 참조하세요.
