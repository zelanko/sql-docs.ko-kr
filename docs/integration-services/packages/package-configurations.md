...
ms.topic: "article"
helpviewer_keywords: 
  - "패키지 구성 구문 [Integration Services]"
  - "SQL Server Integration Services 패키지, 구성"
  - "SSIS 패키지, 구성"
  - "XML [Integration Services]"
  - "Integration Services 패키지, 구성"
  - "구성 구문 [Integration Services]"
  - "간접 구성 [Integration Services]"
  - "구성 [Integration Services]"
  - "직접 구성 [Integration Services]"
...
-   **/ConfigFile** 옵션을 사용하여 디자인 타임에 지정한 구성을 대체하는 구성을 로드할 수는 없습니다.  
 ...
 이러한 옵션에 대한 자세한 내용과 이러한 옵션의 동작이 [!INCLUDE[ssISCurrent](../../includes/ssiscurrent-md.md)] 및 이전 버전 간에 어떻게 다른지에 대한 자세한 내용은 [SQL Server 2016 Integration Services 기능의 동작 변경](../Topic/Behavior%20Changes%20to%20Integration%20Services%20Features%20in%20SQL%20Server%202016.md)을 참조하세요.  
