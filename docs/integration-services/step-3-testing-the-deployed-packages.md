...
다른 [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] 자습서에서는 **디버그** 메뉴의 **디버깅 시작** 옵션을 사용하여 [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)]용 개발 환경인 [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)]에서 패키지를 실행했습니다. 여기에서는 패키지를 다르게 실행합니다.  
...
### SQL Server Management Studio에서 Integration Services에 연결하려면  
