...
-   [1단계: 2단원 패키지 복사](../integration-services/step-1-copying-the-lesson-2-package.md)  
  
-   [2단계: 로깅 추가 및 구성](../integration-services/step-2-adding-and-configuring-logging.md)  
  
-   [3단계: 3단원 자습서 패키지 테스트](../integration-services/step-3-testing-the-lesson-3-tutorial-package.md)  
