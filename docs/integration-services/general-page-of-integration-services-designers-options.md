---
title: "일반 페이지의 Integration Services 디자이너 옵션 | Microsoft Docs"
ms.custom: 
ms.date: 03/14/2017
...
## <a name="options"></a>일반  
 **패키지 로드 시 디지털 서명 확인**  
 [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] 에서 패키지 로드 시 디지털 서명을 확인하도록 하려면 선택합니다. [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)]확인 여부를 디지털 서명이 있는지, 올바른지, 신뢰할 수 있는 원본에서 제공 된 합니다. [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)]패키지가 서명 된 후 패키지가 변경 되었는지 여부를 확인 하지 않습니다.  
 ...
 **새 공급자 이름을 사용하도록 연결 문자열 업데이트**  
 열거나 업그레이드할 때 [!INCLUDE[ssISversion2005](../includes/ssisversion2005-md.md)] 패키지의 현재 릴리스에 대 한 다음 공급자 이름을 사용 하도록 연결 문자열을 업데이트 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)]:  
