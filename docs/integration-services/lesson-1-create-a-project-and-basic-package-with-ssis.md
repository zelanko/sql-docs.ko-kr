...
---
# 1단원: SSIS를 사용하여 프로젝트 및 기본 패키지 만들기
...
-   [1단계: 새 Integration Services 프로젝트 만들기](../integration-services/step-1-creating-a-new-integration-services-project.md)  
  
-   [2단계: 플랫 파일 연결 관리자 추가 및 구성](../integration-services/step-2-adding-and-configuring-a-flat-file-connection-manager.md)  
  
-   [3단계: OLE DB 연결 관리자 추가 및 구성](../integration-services/step-3-adding-and-configuring-an-ole-db-connection-manager.md)  
  
-   [4단계: 패키지에 데이터 흐름 태스크 추가](../integration-services/step-4-adding-a-data-flow-task-to-the-package.md)  
  
-   [5단계: 플랫 파일 원본 추가 및 구성](../integration-services/step-5-adding-and-configuring-the-flat-file-source.md)  
  
-   [6단계: 조회 변환 추가 및 구성](../integration-services/step-6-adding-and-configuring-the-lookup-transformations.md)  
  
-   [7단계: OLE DB 대상 추가 및 구성](../integration-services/step-7-adding-and-configuring-the-ole-db-destination.md)  
  
-   [8단계: 1단원 패키지를 쉽게 이해할 수 있도록 만들기](../integration-services/step-8-making-the-lesson-1-package-easier-to-understand.md)  
  
-   [9단계: 1단원 자습서 패키지 테스트](../integration-services/step-9-testing-the-lesson-1-tutorial-package.md)  
