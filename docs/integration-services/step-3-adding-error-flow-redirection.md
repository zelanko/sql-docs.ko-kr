...
11. **스크립트 편집**을 클릭하여 [!INCLUDE[msCoName](../includes/msconame-md.md)] VSTA([!INCLUDE[vsprvs](../includes/vsprvs-md.md)] Tools for Applications)를 엽니다. **Input0_ProcessInputRow** 메서드에 다음 코드를 입력하거나 붙여넣습니다.  
