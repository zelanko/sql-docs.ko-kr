---
title: "통합 서비스 패키지에 의해 기록된 이벤트 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## 관련 작업  
 실시간으로 로그 항목을 보는 방법에 대한 자세한 내용은 [이벤트 로그 창에서 로그 항목 보기](../../integration-services/performance/view-log-entries-in-the-log-events-window.md)를 참조하세요.  
  
## 관련 항목:  
 [Integration Services 서비스에서 기록하는 이벤트](../../integration-services/service/events-logged-by-the-integration-services-service.md)  
