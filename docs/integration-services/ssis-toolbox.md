 ...
 **제어 흐름** , **데이터 흐름** 및 **이벤트 처리기**탭을 선택하면 **즐겨찾기**및 **공용** 범주가 도구 상자에 나타납니다. **제어 흐름** 탭 또는 **이벤트 처리기** 탭을 선택하면 **기타 태스크** 범주가 도구 상자에 나타납니다. 데이터 흐름탭을 선택하면 **기타 변환**, **기타 원본** 및 **기타 대상** 범주가 도구 상자에 나타납니다.  
