...
-   SSIS Scale Out에 대한 관리 응용 프로그램을 가져오려면 [SSMS(SQL Server Management Studio)](https://docs.microsoft.com/sql/ssms/download-sql-server-management-studio-ssms) 17.1 이상을 다운로드합니다.
