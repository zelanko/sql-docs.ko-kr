...
# 용어 추출 변환 편집기(고급 탭)
 ...
 용어 추출 변환에 대한 자세한 내용은 [Term Extraction Transformation](../../../integration-services/data-flow/transformations/term-extraction-transformation.md)을 참조하십시오.  
 ...
 **오류 출력 구성**  
 [오류 출력 구성](../Topic/Configure%20Error%20Output.md) 대화 상자를 사용하여 오류 발생의 원인이 되는 행에 대한 오류 처리를 지정할 수 있습니다.  
