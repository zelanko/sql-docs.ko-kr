...
ms.topic: "article"
helpviewer_keywords: 
  - "변환 [Integration Services], 나열됨"
  - "변환 [Integration Services], 형식"
  - "변환 [Integration Services]"
  - "데이터 흐름 [Integration Services], 변환"
  - "비즈니스 인텔리전스 변환 [Integration Services]"
  - "조인 변환"
  - "분할 변환 [Integration Services]"
  - "사용자 지정 변환 [Integration Services]"
  - "행 변환 [Integration Services]"
  - "행 집합 변환 [Integration Services]"
