...
## 관련 작업  
 [!INCLUDE[ssIS](../../../includes/ssis-md.md)] 디자이너 또는 개체 모델을 사용하여 변환을 구성할 수 있습니다. [!INCLUDE[ssIS](../../../includes/ssis-md.md)] 디자이너를 사용하여 변환을 구성하는 방법은 [OLE DB 명령 변환 구성](../../../integration-services/data-flow/transformations/configure-the-ole-db-command-transformation.md)을 참조하세요. 프로그래밍 방식으로 이 변환을 구성하는 방법은 개발자 가이드를 참조하십시오.  
