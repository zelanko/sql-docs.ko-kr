...
helpviewer_keywords: 
  - "피벗 해제 변환"
  - "보다 정규화된 데이터 집합 [Integration Services]"
  - "정규화된 데이터 [Integration Services]"
  - "데이터 집합 [Integration Services], 정규화된 데이터"
...
-   [피벗 해제 변환 편집기](../../../integration-services/data-flow/transformations/unpivot-transformation-editor.md)  
