---
title: "OLE DB 연결 관리자를 사용하여 전체 캐시 모드에서 조회 변환 구현 | Microsoft Docs"
ms.custom: ""
ms.date: "12/09/2016"
...
manager: "jhubbard"
---
# OLE DB 연결 관리자를 사용하여 전체 캐시 모드에서 조회 변환 구현
...
### OLE DB 연결 관리자를 사용하여 전체 캐시 모드에서 조회 변환을 구현하려면  
