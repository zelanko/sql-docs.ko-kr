...
helpviewer_keywords: 
  ...
  - "느린 변경 차원 변환"
  - "열 가져오기 변환 [Integration Services]"
  - "정렬 변환"
  - "피벗 해제 변환"
  - "병합 조인 변환"
  - "데이터 마이닝 쿼리 변환"
  ...
  - "유사 항목 조회 변환"
  - "용어 추출 변환"
  - "행 개수 변환 사용자 지정 속성 [Integration Services]"
  - "변환 [Integration Services], 속성"
  - "피벗 변환"
  - "조회 변환"
  - "비율 샘플링 변환"
  - "열 내보내기 변환 [Integration Services]"
  - "행 샘플링 변환"
  - "조건부 분할 변환 사용자 지정 속성 [Integration Services]"
  - "사용자 지정 속성 [Integration Services]"
  - "감사 변환"
  - "용어 조회 변환"
  - "스크립트 구성 요소 변환 사용자 지정 속성 [Integration Services]"
  - "파생 열 변환"
  - "OLE DB 명령 변환"
  - "열 복사 변환 사용자 지정 속성 [Integration Services]"
  - "문자표 변환 사용자 지정 속성 [Integration Services]"
...
# 변환 사용자 지정 속성
 ...
 이 항목에서는 다양한 데이터 흐름 변환의 사용자 지정 속성을 나열하고 설명합니다. 대부분의 데이터 흐름 개체에 공통되는 속성에 대한 자세한 내용은 [Common Properties](../Topic/Common%20Properties.md)을 참조하십시오.  
  
 변환의 일부 속성은 속성 식을 사용하여 설정할 수 있습니다. 자세한 내용은 [식을 사용하여 설정할 수 있는 데이터 흐름 속성](../Topic/Data%20Flow%20Properties%20that%20Can%20Be%20Set%20by%20Using%20Expressions.md)을 참조하세요.  
...
|속성|데이터 형식|Description|  
|--------------|---------------|-----------------|  
|FastParse|Boolean|열이 [!INCLUDE[ssISnoversion](../../../includes/ssisnoversion-md.md)]에서 제공하는 더 빠르지만 로캘을 구분하지 않는 빠른 구문 분석 루틴을 사용하는지, 아니면 로캘을 구분하는 표준 구문 분석 루틴을 사용하는지를 나타내는 값입니다. 이 속성의 기본값은 **False**입니다. 자세한 내용은 [Fast Parse](../Topic/Fast%20Parse.md) 및 [Standard Parse](../Topic/Standard%20Parse.md)를 참조하세요. .<br /><br /> 참고: 이 속성은 **데이터 변환 편집기**에서는 사용할 수 없지만 **고급 편집기**를 사용하여 설정할 수는 있습니다.|  
...
## 관련 항목:  
 ...
 [경로 속성](../Topic/Path%20Properties.md)   
 [식을 사용하여 설정할 수 있는 데이터 흐름 속성](../Topic/Data%20Flow%20Properties%20that%20Can%20Be%20Set%20by%20Using%20Expressions.md)  
