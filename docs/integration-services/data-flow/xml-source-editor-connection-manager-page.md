...
# XML 원본 편집기(연결 관리자 페이지)
 ...
 XML 원본에 대한 자세한 내용은 [XML Source](../../integration-services/data-flow/xml-source.md)을 참조하십시오.  
...
|변수를 사용한 XML 파일|변수에 XML 파일 이름을 지정합니다.<br /><br /> **관련 정보**: [패키지에서 변수 사용](../Topic/Use%20Variables%20in%20Packages.md)|  
...
### 데이터 액세스 모드 = 변수를 사용한 XML 파일  
 **변수 이름**  
 XML 파일의 경로 및 파일 이름을 포함하는 변수를 선택합니다.  
  
### 데이터 액세스 모드 = 변수를 사용한 XML 데이터  
 **변수 이름**  
