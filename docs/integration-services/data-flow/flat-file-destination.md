...
helpviewer_keywords: 
  - "플랫 파일"
  - "플랫 파일 대상"
  - "텍스트 파일 기록 [Integration Services]"
  - "대상 [Integration Services], 플랫 파일"
...
-   [플랫 파일 대상 편집기&#40;연결 관리자 페이지&#41;](../../integration-services/data-flow/flat-file-destination-editor-connection-manager-page.md)  
  
-   [플랫 파일 대상 편집기&#40;매핑 페이지&#41;](../../integration-services/data-flow/flat-file-destination-editor-mappings-page.md)  
