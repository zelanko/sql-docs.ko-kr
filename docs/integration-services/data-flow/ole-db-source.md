...
helpviewer_keywords: 
  - "원본 [Integration Services], OLE DB"
  - "OLE DB 원본 [Integration Services]"
...
-   [OLE DB 원본 편집기&#40;연결 관리자 페이지&#41;](../../integration-services/data-flow/ole-db-source-editor-connection-manager-page.md)  
