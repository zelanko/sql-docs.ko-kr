...
helpviewer_keywords: 
  ...
  - "Integration Services 패키지, 성능"
  - "성능 [Integration Services]"
  - "데이터 흐름 [Integration Services], 문제해결"
  - "SQL Server Integration Services 패키지, 성능"
  - "데이터 로드"
  - "제어 흐름 [Integration Services], 문제해결"
  - "SSIS 패키지, 성능"
  - "패키지 [Integration Services], 성능"
  - "쿼리 [Integration Services], 문제해결"
  - "데이터 정렬 [Integration Services]"
  - "집계 [Integration Services]"
