---
description: Microsoft Connector for SAP BW F1 도움말
title: Microsoft Connector for SAP BW F1 도움말 | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
### <a name="sap-bw-connection-manager-f1-help"></a>SAP BW 연결 관리자 F1 도움말  
