---
title: "스크립트 태스크와 원격 개인 메시지 큐로 보내는 | Microsoft Docs"
ms.custom: 
ms.date: 03/14/2017
...
## <a name="description"></a>Description  
 다음 예제는 기존 MSMQ 연결 관리자와 System.Messaging 네임 스페이스의 개체 및 메서드를 사용 하 여 원격 개인 메시지 큐를 패키지 변수에 들어 있는 텍스트를 보냅니다. MSMQ 연결 관리자의 M:Microsoft.SqlServer.Dts.ManagedConnections.MSMQConn.AcquireConnection(System.Object) 메서드 호출에서 반환 된 **MessageQueue** 개체 **보낼** 메서드는이 작업을 수행 합니다.  
...
2.  만들기는 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] 라는 변수 **MessageText** 형식의 **문자열** 메시지 텍스트를 스크립트에 전달 합니다. 변수의 값으로 기본 메시지를 입력합니다.  
  
3.  디자인 화면에 스크립트 태스크를 추가하고 편집합니다. 에 **스크립트** 탭은 **스크립트 태스크 편집기**, 추가 된 `MessageText` 변수를 **ReadOnlyVariables** 속성 변수를 스크립트 내에서 사용할 수 있게 하려면 .  
  
4.  클릭 **스크립트 편집** 열려는 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] 응용 프로그램 (VSTA) 스크립트 편집기에 대 한 도구입니다.  
  
5.  스크립트 프로젝트에 대 한 참조 추가 **System.Messaging** 네임 스페이스입니다.  
