---
title: "패키지를 프로그래밍 방식으로 작성 | Microsoft Docs"
ms.custom: 
ms.date: 03/16/2017
...
-   새 패키지를 만들고 구성 요소를 개체별 및 속성별로 구성한 다음 새 패키지를 저장 후 실행합니다.  
 ...
 이 섹션에서는 패키지를 프로그래밍 방식으로 한 줄씩 만들고 구성하는 방법을 설명하고 예로 보여 줍니다. 덜 복잡 한 옵션을 프로그래밍 하는 패키지의 범위 끝 단순히 로드 하 고에 설명 된 대로 수정 하지 않고 기존 패키지를 실행 [실행 하 고 프로그래밍 방식으로 패키지를 관리](../../integration-services/run-manage-packages-programmatically/running-and-managing-packages-programmatically.md)합니다.  
...
## <a name="in-this-section"></a>섹션 내용  
 [패키지를 프로그래밍 방식으로 만들기](../../integration-services/building-packages-programmatically/creating-a-package-programmatically.md)  
 ...
 [이벤트를 프로그래밍 방식으로 처리](../../integration-services/building-packages-programmatically/handling-events-programmatically.md)  
 패키지 및 태스크 이벤트를 처리하는 방법에 대해 설명합니다.  
  
 [프로그래밍 방식으로 로깅 사용](../../integration-services/building-packages-programmatically/enabling-logging-programmatically.md)  
 ...
 [데이터 흐름 구성 요소를 프로그래밍 방식으로 검색](../../integration-services/building-packages-programmatically/discovering-data-flow-components-programmatically.md)  
...
## <a name="related-sections"></a>관련 단원  
 ...
 [실행 하 고 패키지를 프로그래밍 방식으로 관리](../../integration-services/run-manage-packages-programmatically/running-and-managing-packages-programmatically.md)  
