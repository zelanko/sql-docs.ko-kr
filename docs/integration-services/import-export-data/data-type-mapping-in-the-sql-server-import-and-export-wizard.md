...
##  <a name="a-namewizardmappinga-how-does-the-wizard-map-data-types-between-source-and-destination"></a><a name="wizardMapping"></a> 마법사가 원본과 대상 간에 데이터 형식을 매핑하는 방법
...
-   **C:\Program Files\Microsoft SQL Server\130\DTS\MappingFiles**(64비트)
-   **C:\Program Files (x86)\Microsoft SQL Server\130\DTS\MappingFiles**(32비트)  
