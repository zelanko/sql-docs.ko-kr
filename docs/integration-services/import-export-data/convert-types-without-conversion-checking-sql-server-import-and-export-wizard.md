---
title: "변환 검사를 수행하지 않고 형식 변환(SQL Server 가져오기 및 내보내기 마법사) | Microsoft Docs"
ms.custom: ""
ms.date: "01/11/2017"
...
---
# 변환 검사를 수행하지 않고 형식 변환(SQL Server 가져오기 및 내보내기 마법사)
 ...
 마법사에서 원본 열의 데이터 형식을 대상 열에 매핑하는 방법 및 마법사가 데이터 형식 매핑 파일을 사용하는 방법은 [마법사에서 원본과 대상 간에 데이터 형식을 대상에 매핑하는 방법](Import%20and%20Export%20Data%20with%20the%20SQL%20Server%20Import%20and%20Export%20Wizard.md\#wizardMapping)을 참조하세요.  
