...
![패키지 저장 및 실행 페이지에서 SQL Server 옵션을 선택한 경우 표시되는 가져오기 및 내보내기 마법사의 SSIS 패키지 저장 페이지 스크린샷](../../integration-services/import-export-data/media/save-package2.png "가져오기 및 내보내기 마법사의 SSIS 패키지 저장 페이지")  
...
![패키지 저장 및 실행 페이지에서 파일 시스템 옵션을 선택한 경우 표시되는 가져오기 및 내보내기 마법사의 SSIS 패키지 저장 페이지 스크린샷](../../integration-services/import-export-data/media/save-package1.png "가져오기 및 내보내기 마법사의 SSIS 패키지 저장 페이지")  
