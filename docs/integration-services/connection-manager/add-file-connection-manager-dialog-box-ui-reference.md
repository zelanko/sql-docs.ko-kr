...
---
# 파일 연결 관리자 추가 대화 상자 UI 참조
  **파일 연결 관리자 추가** 대화 상자를 사용하여 파일 또는 폴더 그룹에 대한 연결을 정의할 수 있습니다.  
  
 다중 파일 연결 관리자에 대한 자세한 내용은 [Multiple Files Connection Manager](../../integration-services/connection-manager/multiple-files-connection-manager.md)를 참조하십시오.  
