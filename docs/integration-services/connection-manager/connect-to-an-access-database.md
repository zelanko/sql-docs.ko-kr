...
helpviewer_keywords: 
  ...
  - "Access 데이터베이스 [Integration Services]"
...
## Access 2003 또는 그 이전 형식의 데이터 원본에 연결  
  
#### 연결 관리자 영역에서 Access 연결 관리자를 만들려면  
...
#### SQL Server 가져오기 및 내보내기 마법사에서 Access 연결을 만들려면  
...
#### 연결 관리자 영역에서 OLE DB 연결 관리자를 만들려면  
...
#### SQL Server 가져오기 및 내보내기 마법사에서 OLE DB 연결을 만들려면  
