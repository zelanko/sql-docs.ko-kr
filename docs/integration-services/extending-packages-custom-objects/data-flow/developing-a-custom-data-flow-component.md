...
# <a name="developing-a-custom-data-flow-component"></a>사용자 지정 데이터 흐름 구성 요소 개발
  데이터 흐름 태스크는 다양한 데이터 원본에 연결한 다음 해당 데이터를 빠른 속도로 변환하고 라우팅하는 여러 구성 요소로 구성됩니다. [!INCLUDE[msCoName](../../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] [!INCLUDE[ssISnoversion](../../../includes/ssisnoversion-md.md)] 개발자가 사용자 지정 원본, 변환 및에서 사용할 수 있는 대상을 만들 수 있도록 하는 확장 가능한 개체 모델을 [!INCLUDE[ssBIDevStudioFull](../../../includes/ssbidevstudiofull-md.md)] 와 배포 된 패키지입니다. 이 섹션에는 사용자 지정 데이터 흐름 구성 요소의 개발 과정을 설명하는 항목이 포함되어 있습니다.  
...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [유효성을 검사 하는 데이터 흐름 구성 요소](../../../integration-services/extending-packages-custom-objects/data-flow/validating-a-data-flow-component.md)  
 구성 요소의 구성 유효성을 검사하고 구성 요소 메타데이터를 다시 구성하는 데 사용하는 메서드에 대해 설명합니다.  
  
 [외부 메타 데이터 구현](../../../integration-services/extending-packages-custom-objects/data-flow/implementing-external-metadata.md)  
 데이터 유효성 검사에 외부 메타데이터 열을 사용하는 방법에 대해 설명합니다.  
  
 [이벤트 발생 및 정의 데이터에서 흐름 구성 요소](../../../integration-services/extending-packages-custom-objects/data-flow/raising-and-defining-events-in-a-data-flow-component.md)  
 미리 정의된 사용자 지정 이벤트를 발생시키는 방법에 대해 설명합니다.  
  
 [흐름 구성 요소 로깅 및 데이터에 있는 로그 항목을 정의 합니다.](../../../integration-services/extending-packages-custom-objects/data-flow/logging-and-defining-log-entries-in-a-data-flow-component.md)  
 ...
 [데이터 흐름 구성 요소에 대 한 사용자 인터페이스 개발](../../../integration-services/extending-packages-custom-objects/data-flow/developing-a-user-interface-for-a-data-flow-component.md)  
