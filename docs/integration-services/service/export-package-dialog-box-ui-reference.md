 ...
 **보호 수준**  
 찾아보기 단추**(...)**를 클릭한 다음 **패키지 보호 수준** 대화 상자에서 보호 수준을 업데이트합니다. 자세한 내용은 [패키지 및 프로젝트 보호 수준 대화 상자](../../integration-services/packages/package-and-project-protection-level-dialog-box.md)를 참조하세요.  
  
## 관련 항목:  
 [패키지 복사본 저장](../Topic/Save%20Copy%20of%20Package.md)   
 [패키지 가져오기 대화 상자 UI 참조](../../integration-services/service/import-package-dialog-box-ui-reference.md)   
