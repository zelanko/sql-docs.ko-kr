...
ms.topic: "article"
helpviewer_keywords: 
  - "서비스 [Integration Services], 원격 인스턴스"
  - "Integration Services 서비스, 연결"
  - "Integration Services 서비스, 원격 인스턴스"
  - "서비스 [Integration Services], 연결"
...
---
# 원격 Integration Services 서버에 연결(SSIS 서비스)
    
> [!IMPORTANT] 이 항목에서는 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] 패키지를 관리하는 Windows 서비스인 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] 서비스에 대해 설명합니다. [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 는 이전 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]버전과의 호환성을 위한 서비스를 지원합니다. [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]부터는 Integration Services 서버의 패키지와 같은 개체를 관리할 수 있습니다.  
...
## 원격 서버의 Integration Services에 연결  
  
#### 원격 서버의 Integration Services에 연결하려면  
...
#### Windows 2000 최신 서비스 팩에서 원격 사용자의 권한을 구성하려면  
...
## 관련 항목:  
 [SSIS 서비스 액세스에 대한 Windows 방화벽 구성](../../integration-services/service/configure-a-windows-firewall-for-access-to-the-ssis-service.md)  
