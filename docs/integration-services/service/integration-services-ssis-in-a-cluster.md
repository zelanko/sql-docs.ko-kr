...
---
# 클러스터의 Integration Services(SSIS)
...
## <a name="related-tasks"></a>관련 작업  
 클러스터에서 Integration Services 서비스를 구성하는 단계별 지침은 [Integration Services 서비스를 클러스터 리소스로 구성](../../integration-services/service/configure-the-integration-services-service-as-a-cluster-resource.md)을 참조하세요.  
