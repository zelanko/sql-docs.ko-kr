...
ms.topic: "article"
helpviewer_keywords: 
  - "서비스 [Integration Services], 이벤트"
  - "이벤트 [Integration Services], 서비스"
  - "Integration Services 서비스, 이벤트"
...
---
# Integration Services 서비스에서 기록하는 이벤트
...
## 구성 파일에 대한 메시지  
 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] 서비스에 대한 설정은 수정 가능한 XML 파일에 저장됩니다. 자세한 내용은 [Integration Services 서비스 구성&#40;SSIS 서비스&#41;](../../integration-services/service/configuring-the-integration-services-service-ssis-service.md)을 참조하세요.  
...
## 관련 작업  
 로그 항목을 보는 방법은 [이벤트 로그 창에서 로그 항목 보기](../../integration-services/performance/view-log-entries-in-the-log-events-window.md)를 참조하세요.  
