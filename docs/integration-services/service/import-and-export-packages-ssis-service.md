...
ms.topic: "article"
helpviewer_keywords: 
  - "패키지 [Integration Services], 가져오기"
  - "패키지 [Integration Services], 내보내기"
  - "패키지 가져오기"
  - "패키지 내보내기"
...
> **중요!!** 이 항목에서는 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] 의 일부인 [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)]서비스에 대해 설명합니다. [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 는 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] 와의 이전 버전 호환성을 위해 [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)]서비스를 지원합니다. [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]에서 패키지를 관리하는 방법은 [Integration Services&#40;SSIS&#41; 서버](https://msdn.microsoft.com/library/ms141134.aspx)를 참조하세요.  
...
#### SQL Server Management Studio를 사용하여 패키지 가져오려면  
...
#### SQL Server Management Studio를 사용하여 패키지 내보내려면  
