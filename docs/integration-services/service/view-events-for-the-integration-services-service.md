---
title: "Integration Services 서비스의 뷰 이벤트 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Integration Services 서비스의 뷰 이벤트
...
### SQL Server Management Studio에서 Integration Services의 서비스 이벤트를 보려면  
...
### Windows 이벤트 뷰어에서 Integration Services의 서비스 이벤트를 보려면  
...
## 관련 항목:  
 ...
 [데이터 흐름 성능 카운터에 대한 로그 추가](../../integration-services/performance/add-a-log-for-data-flow-performance-counters.md)  
