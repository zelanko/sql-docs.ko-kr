                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <p>Windows 가상 머신의 SQL Server 2017</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <p>SQL Server 2016 데이터베이스와 함께 Microsoft Azure Blob Storage 서비스 사용</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <p>SQL Server Machine Learning 서비스</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>백그라운드 프로세스인 삭제할 레코드 정리 프로세스를 대략적으로 설명합니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>인덱스 아키텍처에 대한 정보와 효율적인 인덱스를 디자인하는 데 도움이 되는 모범 사례를 제공합니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>메모리 관리 아키텍처</h3>
                                            <p>SQL Server가 페이지를 읽고 쓰는 동안 메모리와 메모리 사용량을 관리하는 방법을 설명합니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>모든 SQL Server 버전에서 페이지 및 익스텐트를 관리하는 데 사용되는 데이터 구조에 대해 설명합니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>쿼리 처리 아키텍처</h3>
                                            <p>SQL Server가 실행 계획 캐싱을 통해 쿼리를 처리하고 쿼리 재사용을 최적화하는 방법에 대해 설명합니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>이 지침에서는 트랜잭션 로그의 물리적 및 논리적 아키텍처에 대한 정보를 제공합니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>SQL Server 데이터베이스 엔진이 각 트랜잭션의 물리적 무결성을 유지하는 데 사용하는 잠금 및 행 버전 관리 메커니즘에 대해 설명합니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
