                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>데이터베이스 엔진 시작</h3>
                                                    <p>이 자습서에서는 데이터베이스 엔진의 인스턴스에 연결하는 방법에 대해 설명합니다. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>이 자습서에서는 SQL Server 인프라 관리를 위한 통합 환경을 소개합니다. SQL Server Management Studio는 SQL Server 인스턴스 구성, 모니터링 및 관리를 위한 그래픽 인터페이스를 제공합니다. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>이 자습서에서는 쿼리를 처리하는 방법을 검사한 다음 쿼리 성능 향상을 위한 권장 사항을 검토하는 방법을 소개합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>hierarchyid 데이터 형식 사용</h3>
                                                    <p>이 자습서에서는 테이블을 계층 구조로 변환한 다음 테이블에서 데이터를 관리하는 방법에 대해 설명합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Transact-SQL 쓰기</h3>
                                                    <p> 이 자습서에는 SQL Server 데이터베이스의 개체를 만들고 관리하는 Transact-SQL 문을 작성하는 기본적인 방법에 대해 설명합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>인증서로 저장 프로시저 서명</h3>
                                                    <p>이 자습서에서는 SQL Server에서 생성한 인증서를 사용하여 저장 프로시저에 서명하는 방법에 대해 설명합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>소유권 체인 및 컨텍스트 전환</h3>
                                                    <p>이 자습서에서는 시나리오를 통해 소유권 체인 및 사용자 컨텍스트 전환과 관련된 SQL Server 보안 개념을 설명합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>정책 기반 관리를 사용하여 서버 관리</h3>
                                                    <p>이 자습서에서는 사이트 관리 표준을 강화하는 정책을 만드는 방법에 대해 설명합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Microsoft Azure Blob Storage 서비스로 SQL Server 백업 및 복원</h3>
                                                    <p>이 자습서에서는 SQL Server 백업 및 Windows Azure BLOB 저장소 서비스로 복원하는 방법에 대해 설명합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQL Server 2016 데이터베이스와 함께 Microsoft Azure Blob Storage 서비스 사용 </h3>
                                                    <p>이 자습서는 Windows Azure BLOB 저장소 서비스에서 SQL Server 데이터 파일을 저장하는 방법을 이해하도록 도와 줍니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>삭제할 레코드 정리 프로세스</h3>
                                                    <p> 이 가이드에서는 삭제용으로 표시된 페이지에서 레코드를 삭제하는 백그라운드 프로세스인 삭제할 레코드 정리 프로세스를 대략적으로 설명합니다. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>인덱스 아키텍처 및 디자인</h3>
                                                    <p>이 가이드에서는 인덱스 아키텍처에 대한 정보와 응용 프로그램 요구 사항을 충족하는 효율적인 인덱스를 디자인하는 데 도움이 되는 모범 사례를 제공합니다. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>메모리 관리 아키텍처</h3>
                                                    <p> 이 가이드에서는 SQL Server가 페이지를 읽고 쓰는 동안 메모리와 메모리 사용량을 관리하는 방법을 설명합니다. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>페이지 및 익스텐트 아키텍처</h3>
                                                    <p>이 가이드에서는 모든 SQL Server 버전에서 페이지 및 익스텐트를 관리하는 데 사용되는 데이터 구조에 대해 설명합니다. 페이지 및 익스텐트의 아키텍처에 대한 이해는 효율적으로 동작하는 데이터베이스를 디자인하고 개발하는 데 있어 중요합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>마이그레이션 후 유효성 검사 및 최적화</h3>
                                                    <p>SQL Server로 마이그레션한 후 발생하는 몇 가지 일반적인 성능 시나리오와 해결 방법을 대략적으로 설명합니다. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>쿼리 처리 아키텍처</h3>
                                                    <p>SQL Server 데이터베이스 엔진은 로컬 테이블, 분할된 테이블 및 여러 서버에 분산된 테이블과 같은 다양한 데이터 저장소 아키텍처의 쿼리를 처리합니다. 이 가이드에서는 SQL Server가 실행 계획 캐싱을 통해 쿼리를 처리하고 쿼리 재사용을 최적화하는 방법에 대해 설명합니다. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>트랜잭션 로그 아키텍처 및 관리</h3>
                                                    <p> 이 지침에서는 트랜잭션 로그의 물리적 및 논리적 아키텍처에 대한 정보를 제공합니다. 아키텍처를 이해하면 트랜잭션 로그를 보다 효율적으로 관리할 수 있습니다. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>스레드 및 태스크 아키텍처</h3>
                                                    <p>스레드는 응용 프로그램 논리를 여러 동시 실행 경로로 분리할 수 있게 하는 운영 체제 기능입니다. 이 가이드에서는 SQL이 스레드 및 태스크를 조작하는 방법을 설명합니다. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>트랜잭션 잠금 및 행 버전 관리</h3>
                                                    <p> 이 가이드에서는 SQL Server 데이터베이스 엔진이 각 트랜잭션의 물리적 무결성을 유지하는 데 사용하는 잠금 및 행 버전 관리 메커니즘과 응용 프로그램에서 트랜잭션을 효율적으로 제어할 수 있는 방법에 대해 설명합니다. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<div class="container centered pageFooter">
        ...
        <ul class="links">
           ...
           <li>
                <a href="https://forms.office.com/Pages/ResponsePage.aspx?id=v4j5cvGGr0GRqy180BHbR7y_maOEfTBMj0E3nehXKj9UQjIxMzJORE1BTVk4WU9YSlNaWVVIRElPRC4u" data-linktype="external"> SQL 문서 피드백 </a>
            </li>
           <li>
