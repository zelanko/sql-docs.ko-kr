...
layout: HubPage
hide_bc: true
title: SQL Server - 데이터 로드 및 이동
description: SQL Server를 통해 데이터베이스와 데이터를 로드, 이동 및 마이그레이션하는 데 도움이 되는 기능을 살펴보세요.
ms.topic: hub-page
ms.prod: sql
author: MashaMSFT
ms.author: mathoma
...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server: 데이터 마이그레이션, 로드 및 이동</h1>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>최소 가동 중지 시간으로 여러 데이터베이스 원본에서 Azure 데이터 플랫폼으로 원활하게 마이그레이션할 수 있습니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>DMA(Data Migration Assistant)</h3>
                                                    <p>호환성 문제를 감지하고, 대상 환경에 권장되는 개선점을 제시하고, 데이터베이스 및 데이터를 이동합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>BCP</h3>
                                                    <p>데이터 파일과 SQL Database 간의 데이터를 지정된 형식으로 대량으로 복사합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>플랫 파일 가져오기 마법사</h3>
                                                    <p>이 마법사는 플랫 파일(.csv, .txt)에서 SQL Database로 데이터를 복사하는 간단한 방법입니다. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>가져오기 및 내보내기 마법사</h3>
                                                    <p>이 마법사는 다양한 원본에서 SQL Database로 데이터를 복사하는 간단한 방법입니다. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SSIS(SQL Server Integration Services)</h3>
                                                    <p>플랫 파일 및 관계형 데이터 원본과 같은 다양한 원본에서 데이터를 추출 및 변환한 다음, SQL Database로 로드합니다. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>복제</h3>
                                                    <p> 한 데이터베이스에서 다른 데이터베이스로 데이터 및 데이터베이스 개체를 복사 및 배포한 다음 데이터베이스 간에 동기화를 수행하여 일관성을 유지하는 일련의 기술입니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
