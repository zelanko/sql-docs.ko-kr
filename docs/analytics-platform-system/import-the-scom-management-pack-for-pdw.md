---
title: 분석 플랫폼 시스템-SCOM 관리 팩 가져오기 | Microsoft Docs
description: Analytics Platform System (APS)에 대 한 System Center Operations Manager (SCOM) 관리 팩을 가져오려면 다음이 단계를 수행 합니다. 관리 팩은 SCOM의 병렬 데이터 웨어하우스를 모니터링 해야 합니다.
author: mzaman1
manager: craigg
ms.prod: sql
