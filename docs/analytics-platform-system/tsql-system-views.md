...
* [sys. 어셈블리](https://msdn.microsoft.com/library/ms189790.aspx)
...
* [sys. 인증서](https://msdn.microsoft.com/library/ms189774.aspx)
* [sys. check_constraints](https://msdn.microsoft.com/library/ms187388.aspx)
* [sys. 열](https://msdn.microsoft.com/library/ms176106.aspx)
* [sys. computed_columns](https://msdn.microsoft.com/library/ms188744.aspx)
* [sys. 자격 증명](../relational-databases/system-catalog-views/sys-credentials-transact-sql.md)
...
* [sys. 데이터베이스](https://msdn.microsoft.com/library/ms178534.aspx)
...
* [sys. 파일 그룹](https://msdn.microsoft.com/library/ms187782.aspx)
...
* [sys. 인덱스](https://msdn.microsoft.com/library/ms173760.aspx)
...
* [sys. 개체](https://msdn.microsoft.com/library/ms190324.aspx)
* [sys. 매개 변수](https://msdn.microsoft.com/library/ms176074.aspx)
...
* [.sys 파티션](https://msdn.microsoft.com/library/ms175012.aspx)
* [sys. 프로시저](https://msdn.microsoft.com/library/ms188737.aspx)
...
* [sys. 동의어](../relational-databases/system-catalog-views/sys-synonyms-transact-sql.md)
...
* [sys.debug 참조](../relational-databases/system-compatibility-views/sys-sysreferences-transact-sql.md)
...
* [sys. 형식](https://msdn.microsoft.com/library/ms188021.aspx)
* [sys. 뷰](https://msdn.microsoft.com/library/ms190334.aspx)
...
* [루틴이](../relational-databases/system-information-schema-views/routines-transact-sql.md)
