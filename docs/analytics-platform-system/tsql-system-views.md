...
## <a name="parallel-data-warehouse-dynamic-management-views-dmvs"></a>병렬 데이터 웨어하우스 동적 관리 뷰 (Dmv)
...
## <a name="sql-server-catalog-views"></a>SQL Server 카탈로그 뷰
