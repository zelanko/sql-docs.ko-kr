...
4.  **적용**을 클릭합니다. 변경 내용을 다음 기기 서비스를 다시 시작할 때 SQL Server PDW에서 SQL Server 인스턴스를 통해 전파 됩니다. 어플라이언스 서비스를 지금 다시 시작 하려면 참조 [PDW 서비스 상태 &#40;분석 플랫폼 시스템&#41;](pdw-services-status.md)합니다.  
