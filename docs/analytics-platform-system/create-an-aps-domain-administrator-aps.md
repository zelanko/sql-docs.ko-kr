...
2.  
  시작 메뉴에서 **실행**을 클릭합니다. **열기** 상자에 **dsa.msc**를 입력 합니다. 
  **확인**을 클릭합니다.  
...
6.  
  **소속 그룹** 탭에서 **추가**를 클릭합니다.  
    ...
    Domain Admins를 입력 합니다 **. PdwControlNodeAccess** 를 클릭 한 다음 **이름 확인**을 클릭 합니다. 
  **확인**을 클릭합니다.  
  
    그러면 새 사용자가 **Domain Admins** 그룹 및 **Pdwcontrolnodeaccess** 그룹에 추가 됩니다. 
  **확인**을 클릭합니다.  
