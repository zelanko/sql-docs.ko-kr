...
6.  사용 하는 **장애 조치 클러스터 관리자** 에 연결 된  ***appliance_domain*-WFOHST01** 탐색 창에서을 클릭 하 고 자동으로 연결 하는 경우 클러스터 **역할**합니다. 에 **역할** 창:  
...
7.  HDInsight 지역이 인 경우  
    ...
    1.  HDInsight 클러스터에 연결 합니다. 이렇게 하려면 마우스 오른쪽 단추로 클릭 **장애 조치 클러스터 관리자**선택, **클러스터에 연결**를 지정 하 고  ***appliance_domain*-WFOHST02** 에 대 한 클러스터 이름입니다.  
...
7.  사용 하 여는 **장애 조치 클러스터 관리자** 에 연결 된  ***appliance_domain*-WFOHST01** 클러스터를 자동으로 연결 하는 경우 및 다음에  **탐색** 창에서 클릭 **역할**합니다. 에 **역할** 창:  
...
8.  어플라이언스에 HDInsight 지역이 있는 경우에 HDInsight 클러스터에 연결 합니다. (이렇게 하려면 마우스 오른쪽 단추로 클릭 **장애 조치 클러스터 관리자**선택, **클러스터에 연결**를 지정 하 고  ***appliance_domain*-WFOHST01** 클러스터 이름입니다.)에 대 한  
...
기기 시작 된 후에 열은 **관리 콘솔** 오류 상태를 나타낼 수 있는 경고에 대 한 상태 페이지를 확인 합니다. 자세한 내용은 참조 [관리 콘솔 &#40;를 사용 하 여 어플라이언스에 모니터링 분석 플랫폼 시스템 &#41; ](monitor-the-appliance-by-using-the-admin-console.md).  
