...
사용 하 여는 [백업 서버 용량 계획 워크시트](backup-capacity-planning-worksheet.md) 용량 요구 사항을 확인할 수 있습니다.  
...
4.  백업에 사용 권한을 읽기, 신뢰할 수 있는 계정 및 백업 도메인 계정에서 액세스할 수 있도록 공유 및 공유 위치에 쓰기를 추가 합니다.  
