...
더 자주 폴링은 사용할 수 있지만 너무 자주 폴링 수 복잡해 지는 [sys.dm_pdw_nodes_exec_requests](http://msdn.microsoft.com/en-us/library/ms177648(v=sql11).aspx) DMV 합니다.  너무 자주 폴링 하기가 더 어려운 쿼리 성능을 진단 하는 사용자에 대해 발급 될 때 해당 보기에서 신속 하 게 롤업 합니다.  
