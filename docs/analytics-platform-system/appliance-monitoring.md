---
title: "어플라이언스 (분석 플랫폼 시스템)를 모니터링 합니다."
author: barbkess
ms.author: barbkess
manager: jhubbard
...
---
# <a name="appliance-monitoring"></a>어플라이언스 모니터링
이 어플라이언스 모니터링 가이드 도구와 SQL Server PDW 어플라이언스에 모니터링에 대 한 작업을 설명 합니다.  
...
|모니터링 작업|Description|  
|-------------------|---------------|  
|관리 콘솔을 사용 하 여 어플라이언스에 모니터링 합니다.|[관리 콘솔 &#40;를 사용 하 여 어플라이언스에 모니터링 분석 플랫폼 시스템 &#41;](monitor-the-appliance-by-using-the-admin-console.md)|  
|시스템 뷰를 사용 하 여 어플라이언스에 모니터링 합니다.|[시스템 뷰 &#40;를 사용 하 여 어플라이언스에 모니터링 분석 플랫폼 시스템 &#41;](monitor-the-appliance-by-using-system-views.md)|  
|System Center를 사용 하 여 어플라이언스에 모니터|[System Center Operations Manager &#40;를 사용 하 여 어플라이언스에 모니터링 분석 플랫폼 시스템 &#41;](monitor-the-appliance-by-using-system-center-operations-manager.md)|  
|어플라이언스의 상태를 모니터링 합니다.|[모니터 어플라이언스 상태 &#40; 분석 플랫폼 시스템 &#41;](monitor-appliance-health-state.md)|  
|하트 비트 모니터링 합니다.|[Microsoft &#40;에 원격 분석 피드백 보내기 SQL Server PDW &#41;](send-telemetry-feedback-to-microsoft-sql-server-pdw.md)|  
|기기 경고를 추적 합니다.|[트랙 기기 경고 &#40; 분석 플랫폼 시스템 &#41;](track-appliance-alerts.md)|  
|용량 사용 중인지 확인 합니다.|[용량 사용률 &#40; 보기 분석 플랫폼 시스템 &#41;](view-capacity-utilization.md)|  
|어플라이언스에 폴링 빈도 결정 합니다.|[폴링 빈도 &#40; 결정 분석 플랫폼 시스템 &#41;](determine-polling-frequency.md)|  
|클러스터 오류가 발생할 때 결정 클러스터 노드 실패 했습니다.|[클러스터 노드 실패 한 &#40; 결정 분석 플랫폼 시스템 &#41;](determine-which-cluster-node-failed.md)|  
