...
3.  구성 마법사를 시작 합니다.  
    ...
    2.  왼쪽된 창에는 **Update Services** 창, 클릭 하 여 가상 컴퓨터 관리 노드 서버를 확장 (***appliance_domain*VMM**), 클릭하고**옵션**합니다.  
...
8.  제품을 선택 합니다.  
    ...
    선택 **SQL Server 2014**, **Windows Server 2012 R2**, 및 **System Center 2012 R2 Virtual Machine Manager**, 클릭 하 고 **다음**합니다.  
