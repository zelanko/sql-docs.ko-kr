---
title: "RDL 샌드박싱 설정 및 해제 | Microsoft Docs"
ms.custom: ""
ms.date: "03/20/2017"
...
|**AllowNew**|**Allow**의 부울 특성이며, 새 형식 인스턴스를 RDL 식에 만들 수 있는지 아니면 RDL **\<Class>** 요소에 만들 수 있는지를 제어합니다.<br /><br /> 참고: **RDLSandboxing** 을 사용하도록 설정하면 **AllowNew**설정에 관계없이 새 배열을 RDL 식에 만들 수 없습니다.|  
...
### 연산자 및 New 사용  
 기본적으로 **New**를 제외한 [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] .NET Framework 언어 연산자는 항상 허용됩니다. **New** 연산자는 **\<Allow>** 요소의 **AllowNew** 특성에서 제어합니다. 기본 컬렉션 접근자 연산자 **!**와 같은 기타 언어 연산자 및 **CInt**와 같은 [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] .NET Framework 캐스트 매크로는 항상 허용됩니다.  
