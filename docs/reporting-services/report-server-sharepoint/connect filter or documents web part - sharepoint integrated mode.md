...
ms.topic: "article"
helpviewer_keywords: 
  - "필터 웹 파트 [Reporting Services]"
  - "SharePoint 통합 [Reporting Services], 웹 파트"
  - "보고서 뷰어 웹 파트 [Reporting Services]"
  - "문서 웹 파트 [Reporting Services]"
...
manager: "erikre"
---
# 필터 또는 문서 웹 파트 연결(SharePoint 통합 모드의 Reporting Services)
...
8.   **모든 웹 파트**의 **기타** 범주에서 **SQL Server Reporting Services 보고서 뷰어.**  
