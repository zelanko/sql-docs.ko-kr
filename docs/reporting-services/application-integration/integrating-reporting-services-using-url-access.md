---
title: "URL 액세스를 사용 하 여 서비스 보고 통합 | Microsoft Docs"
ms.custom: 
ms.date: 03/14/2017
...
## <a name="in-this-section"></a>섹션 내용  
 [웹 응용 프로그램에서 URL 액세스 사용](../../reporting-services/application-integration/integrating-reporting-services-using-url-access-web-application.md)  
