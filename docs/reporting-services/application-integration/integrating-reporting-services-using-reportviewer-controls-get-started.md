...
# Reporting Services ReportViewer 컨트롤을 사용 하 여 시작-통합
...
## ReportViewer 컨트롤을 사용 하도록 기존 프로젝트를 업데이트 합니다.
...
## 새 Windows forms 프로젝트에 ReportViewer 컨트롤 추가
...
## 보고서 뷰어 2016 컨트롤에 100% 높이 설정 하는 방법
...
### Reportviewer 컨트롤의 부모에 스타일 높이 특성을 설정 하 여
