...
ms.topic: "article"
helpviewer_keywords: 
  - "보고서 처리 [Reporting Services], 상태 정보"
  - "작업 [Reporting Services]"
  - "작업 보기"
  - "작업 취소"
  - "사용자 작업 [Reporting Services]"
  - "시스템 작업 [Reporting Services]"
  - "보고서 처리 [Reporting Services], 실행 중인 프로세스 관리"
  - "프로세스 [Reporting Services]"
  - "프로세스 검색 [Reporting Services]"
  - " 상태 정보 [Reporting Services] "
  - "보고서 처리 [Reporting Services]"
  - "구독 취소"
  - "보고서 서버 [Reporting Services], 작업"
  - "데이터 기반 구독"
  - "작업 표시"
  - "구독 [Reporting Services], 실행 중인 프로세스"
...
##  <a name="bkmk_programmatically"></a> 프로그래밍 방식으로 작업 관리  
 프로그래밍 방식으로 또는 스크립트를 사용하여 작업을 관리할 수 있습니다. 자세한 내용은 <xref:ReportService2010.ReportingService2010.ListJobs%2A>, <xref:ReportService2010.ReportingService2010.CancelJob%2A>을 참조하세요.  
