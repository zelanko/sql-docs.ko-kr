...
## <a name="see-also"></a>참고 항목  
 ...
 [이메일 전송을 위한 보고서 서버 구성(SSRS 구성 관리자)](https://docs.microsoft.com/sql/reporting-services/install-windows/configure-the-report-server-service-account-ssrs-configuration-manager)  
