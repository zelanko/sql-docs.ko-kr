...
1. 선택 **사이트 설정** 드롭다운 메뉴에서.
1. **일정** 탭을 선택합니다.
1. 선택 **+ 새 일정**합니다. (기존 일정을 수정하려면 일정 이름을 선택합니다.)
