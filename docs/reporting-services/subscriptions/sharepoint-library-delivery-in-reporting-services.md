...
ms.topic: "article"
helpviewer_keywords: 
  - "SharePoint 통합 [Reporting Services], 보고서 배달"
  - "보고서 배달 [Reporting Services]"
  - "구독 [Reporting Services], SharePoint 라이브러리 배달"
...
---
# Reporting Services의 SharePoint 라이브러리 배달
...
## 배달 옵션 설정  
 ...
 경로  
 SharePoint 웹 응용 프로그램 및 사이트를 포함하는 SharePoint 라이브러리에 대한 정규화된 URL을 지정합니다. 예를 들어 http://mySharePointWeb/MySite/MyDocLib와 같이 지정할 수 있습니다. 여기서 "http://mySharePointWeb"은 웹 응용 프로그램을 나타내고 "MySite"는 SharePoint 사이트를 나타내며 "MyDocLib"는 보고서가 배달될 SharePoint 라이브러리를 나타냅니다.  
