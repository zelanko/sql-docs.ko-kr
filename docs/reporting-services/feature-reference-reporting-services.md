...
# <a name="feature-reference-reporting-services"></a>기능 참조(Reporting Services)
  [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)][!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] 여러 가지 도구와 응용 프로그램을 생성, 관리 및 보고서 보기를 사용할 수 있습니다. 이 섹션에서는 이러한 도구와 응용 프로그램의 대화 상자, 웹 페이지 및 마법사와 관련된 항목에 대해 설명합니다.  
