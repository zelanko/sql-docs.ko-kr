...
# <a name="technical-reference-ssrs"></a>기술 참조(SSRS)
  ...
  사용 하거나 SQL Server Reporting Services 관리에 대 한 도구 및 PowerShell 참조 설명서를 찾습니다.  
 ...
 ![작은 파일 폴더 아이콘](../analysis-services/media/filefolder-small.png "Small File Folder Icon") **보고서 서버 명령 프롬프트 유틸리티**  
 ...
 ![작은 파일 폴더 아이콘](../analysis-services/media/filefolder-small.png "Small File Folder Icon") **Reporting Services WMI 공급자 클래스 라이브러리**  
