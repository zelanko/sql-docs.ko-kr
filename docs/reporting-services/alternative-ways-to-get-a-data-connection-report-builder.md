...
description: SQL Server 데이터베이스와 같은 외부 데이터 원본에 연결하는 다른 방법을 자세히 알아봅니다.
ms.date: 06/15/2016
...
1.  새 테이블 또는 행렬 또는 새 차트 마법사의 **데이터 세트 선택** 페이지에서 **데이터 세트 만들기**를 선택한 후, **다음**을 클릭합니다. **데이터 원본에 대한 연결 선택** 페이지가 열립니다.  
