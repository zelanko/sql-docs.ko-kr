...
-   [자습서: 맵 보고서(보고서 작성기)](tutorial-map-report-report-builder.md)에서는 Bing 지도를 배경으로 지원하도록 보고서 서버를 구성해야 합니다. 자세한 내용은 [지도 보고서 지원 계획](./report-design/plan-a-map-report-report-builder-and-ssrs.md)을 참조하세요.   
