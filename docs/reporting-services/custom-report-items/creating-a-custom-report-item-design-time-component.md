...
description: 사용자 지정 보고서 항목 디자인 타임 구성 요소를 만드는 방법을 알아봅니다. 이 구성 요소는 끌어서 놓기 작업을 지원하는 활성화된 디자인 화면을 제공합니다.
ms.date: 03/14/2017
...
### <a name="modifying-component-properties"></a>구성 요소 속성 수정  
 ...
 다음 코드 예제에 <xref:System.ComponentModel.BrowsableAttribute> 특성이 있는 **Microsoft.ReportDesigner.CustomReportItemDesigner.CustomData** 속성이 나와 있습니다.  
