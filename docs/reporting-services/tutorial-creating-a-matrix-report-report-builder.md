...
description: 중첩 행 및 열 그룹에 샘플 판매 데이터의 행렬이 포함된 Reporting Services 페이지를 매긴 보고서를 만드는 방법을 알아봅니다.
ms.date: 06/23/2016
...
![보고서 작성기 행렬 보고서의 스크린샷](../reporting-services/media/report-builder-matrix-tutorial.png)
...
6.  **데이터 원본에 대한 연결 선택** 페이지에서 기존 데이터 원본을 선택하거나 보고서 서버를 찾아 데이터 원본을 선택합니다. 데이터 원본을 사용할 수 없거나 보고서 서버에 대한 액세스 권한이 없는 경우 포함된 데이터 원본을 대신 사용할 수 있습니다. 포함된 데이터 원본을 만드는 방법에 대한 자세한 내용은 [자습서: 기본 테이블 보고서 만들기&#40;보고서 작성기&#41;](../reporting-services/tutorial-creating-a-basic-table-report-report-builder.md).  
...
6.  Quantity를 **값** 으로 끌어옵니다.  
    ...
    ![보고서 작성기 필드 정렬 보고서 마법사를 보여 주는 스크린샷](../reporting-services/media/report-builder-arrange-fields-report-wizard.png)  
...
13. **Finish** 를 클릭합니다.  
    ...
    ![보고서 작성기 행 그룹 및 열 그룹을 보여 주는 스크린샷](../reporting-services/media/report-builder-row-and-column-groups.png)
...
![확장된 보고서 작성기 행렬 보고서를 보여 주는 스크린샷](../reporting-services/media/report-builder-expand-matrix.png)
...
3.  **홈** 탭 > **숫자** > **통화** 를 선택합니다. 셀이 변경되어 형식 지정된 통화가 표시됩니다.  
    ...
    ![보고서 작성기 샘플 값 옵션의 스크린샷](../reporting-services/media/report-builder-placeholder-value.png)
...
![보고서 작성기 행렬 보고서에 표시된 평일을 보여 주는 스크린샷](../reporting-services/media/report-builder-matrix-weekdays.png)
...
4.  행렬을 클릭하여 열 핸들과 행 핸들이 행렬 위와 옆에 표시되도록 합니다.  
    ...
    ![보고서 작성기 행렬 보고서에서 열 및 행 핸들의 스크린샷](../reporting-services/media/report-builder-column-handles.png)
...
2.  가 들어 있는 셀을 선택합니다.(!!) `[Territory].` 
    ...
    >**참고** : 텍스트가 아니라 셀을 선택합니다. WritingMode 속성은 셀에만 사용할 수 있습니다.
     ...
     ![보고서 작성기 행렬 보고서에서 Territory 셀을 보여 주는 스크린샷](../reporting-services/media/report-builder-select-territory-cell.png)
