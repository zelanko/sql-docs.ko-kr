...
##  <a name="versions-supported-by-upgrade"></a><a name="bkmk_versionsupported"></a> 업그레이드 가능한 버전  
...
##  <a name="published-reports-and-report-snapshots"></a><a name="bkmk_publishedreports_and_snapshots"></a> 게시된 보고서 및 보고서 스냅샷  
...
##  <a name="backward-compatibility-mode"></a><a name="bkmk_backcompat"></a> 이전 버전 호환 모드  
...
##  <a name="upgrading-a-report-with-subreports"></a><a name="bkmk_subreports"></a> 하위 보고서가 있는 보고서 업그레이드  
...
##  <a name="upgrading-a-report-with-custom-report-items"></a><a name="bkmk_CRIs"></a> 사용자 지정 보고서 항목이 있는 보고서 업그레이드  
