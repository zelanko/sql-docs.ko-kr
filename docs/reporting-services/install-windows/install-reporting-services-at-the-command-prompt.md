...
## 참고 항목  
 ...
 [SysPrep 매개 변수](../../database-engine/install-windows/install-sql-server-2016-from-the-command-prompt.md#SysPrep)   
 [명령 프롬프트에서 Power Pivot 설치](http://msdn.microsoft.com/ko-kr/7f1f2b28-c9f5-49ad-934b-02f2fa6b9328)  
