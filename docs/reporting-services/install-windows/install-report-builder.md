...
## 웹 포털 또는 SharePoint 라이브러리에서 [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] 설치 
...
### 다음과 통합된 SharePoint 사이트 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]
...
## System Center Configuration Manager를 사용하여 [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] 설치 
...
## 공유에서 [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] 설치  
...
## 명령줄에서 [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] 설치 
...
## [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] 를 기본값으로 설정  
