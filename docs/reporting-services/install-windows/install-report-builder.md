...
> [!NOTE]
> Power BI Report Builder의 설치 정보를 찾고 있나요? 다운로드 센터의 [Microsoft Power BI Report Builder](https://www.microsoft.com/download/details.aspx?id=58158) 페이지로 이동합니다. 
...
6.  다음 형식으로 명령을 입력합니다.  
     ...
     [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion.md)] 설치에만 해당하는 두 가지 옵션은 RBINSTALLDIR 및 RBSERVERURL을 사용할 수 있습니다. 이러한 인수는 명령줄에 포함하지 않아도 됩니다. 기본 명령은 다음과 같습니다.  
