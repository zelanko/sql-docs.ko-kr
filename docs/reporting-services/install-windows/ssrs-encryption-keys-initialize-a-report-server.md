---
title: "보고서 서버 (SSRS 구성 관리자)를 초기화 합니다. | Microsoft Docs"
ms.custom: 
ms.date: 05/31/2016
...
## <a name="how-to-confirm-a-report-server-initialization"></a>보고서 서버 초기화를 확인하는 방법  
 보고서 서버 초기화를 확인 하려면를 입력 하 여 보고서 서버 웹 서비스를 ping **http://\<서버 이름 > / reportserver** 명령 창에서. **RSReportServerNotActivated** 오류가 발생하면 초기화가 실패한 것입니다.  
