...
-   **URLReservations** 섹션의 각 요소에 대한 설명은 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 온라인 설명서에서 [RsReportServer.config 구성 파일](../../reporting-services/report-server/rsreportserver-config-configuration-file.md)을 참조하세요.  
...
-   응용 프로그램 액세스를 위한 URL을 구성하는 방법은 [URL 구성&#40;SSRS 구성 관리자&#41;](../../reporting-services/install-windows/configure-a-url-ssrs-configuration-manager.md)을 참조하세요.  
...
#### [!INCLUDE[ssRSWebPortal](../../includes/ssrswebportal.md)] 및 웹 파트를 보고서 서버 웹 서비스에 연결하는 URL  
