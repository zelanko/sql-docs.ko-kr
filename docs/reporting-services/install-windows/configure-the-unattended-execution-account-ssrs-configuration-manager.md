...
ms.topic: "article"
helpviewer_keywords: 
  - "자격 증명 옵션 없음 [Reporting Services]"
  - "보안 [Reporting Services], 무인 보고서 처리"
  - "무인 보고서 처리 [Reporting Services]"
  - "자격 증명 [Reporting Services]"
  - "외부 데이터 원본 [Reporting Services]"
  - "계정 [Reporting Services]"
  - "보고서 [Reporting Services], 처리"
...
## 참고 항목  
 [Reporting Services 구성 관리자(SSRS 기본 모드)](http://msdn.microsoft.com/ko-kr/379eab68-7f13-4997-8d64-38810240756e)  
