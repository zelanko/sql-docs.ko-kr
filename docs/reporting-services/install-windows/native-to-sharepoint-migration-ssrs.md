---
title: "기본 모드에서 SharePoint 모드로의 마이그레이션(SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
---
# 기본 모드에서 SharePoint 모드로의 마이그레이션(SSRS)
...
|구독|예|List Subscriptions 메서드 [구독 및 배달 메서드](../../reporting-services/report-server-web-service/methods/subscription-and-delivery-methods.md) 및 <xref:ReportService2010.ReportingService2010.ChangeSubscriptionOwner%2A> 메서드를 참조하세요.|  
|스냅숏|||  
