...
## <a name="see-also"></a>참고 항목  
 ...
 [일반적인 보고서 속성 구성(보고서 관리자)](https://docs.microsoft.com/sql/reporting-services/reports/configure-execution-properties-for-a-report-report-manager)  
