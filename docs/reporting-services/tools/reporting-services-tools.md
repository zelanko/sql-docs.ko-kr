...
helpviewer_keywords: 
  ...
  - "구성 요소 [Reporting Services], 구성 요소 정보"
  - "Reporting Services, 구성 요소"
  - "SSRS, 구성 요소"
  - "보고서 [Reporting Services], 도구"
  - "SQL Server Reporting Services, 구성 요소"
  - "SSRS(SQL Server Reporting Services), 도구"
  - "아키텍처 [Reporting Services]"
...
# Reporting Services 도구
 ...
 도구를 바로 찾으려면 [자습서: Reporting Services 도구 찾기 및 시작 방법&#40;SSRS&#41;](../../reporting-services/tools/tutorial-how-to-locate-and-start-reporting-services-tools-ssrs.md)을 참조하세요.  
...
|Rskeymgmt 유틸리티|이 도구를 사용하면 다음을 수행할 수 있습니다.<br /><br /> 보고서 서버 데이터를 암호화 하는 데 사용하는 대칭 키 추출, 복원, 만들기 및 삭제<br /><br /> 확장 배포에서 보고서 서버 인스턴스 조인<br /><br /> <br /><br /> 자세한 내용은 [보고서 서버 명령 프롬프트 유틸리티&#40;SSRS&#41;](../../reporting-services/tools/report-server-command-prompt-utilities-ssrs.md)를 참조하세요.|명령 프롬프트|  
