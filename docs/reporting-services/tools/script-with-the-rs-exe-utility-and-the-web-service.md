---
title: "Rs.exe 유틸리티 및 웹 서비스 스크립트 | Microsoft Docs"
ms.custom: 
ms.date: 03/14/2017
...
# <a name="script-with-the-rsexe-utility-and-the-web-service"></a>rs.exe 유틸리티 및 웹 서비스를 사용한 스크립팅
 ...
 [보고서 서버 간 콘텐츠 복사를 위한 샘플 Reporting Services rs.exe 스크립트](../../reporting-services/tools/sample-reporting-services-rs-exe-script-to-copy-content-between-report-servers.md).  
