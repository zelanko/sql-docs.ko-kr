---
title: "SharePoint 모드의 보고서 서버에 게시된 보고서 항목에 대한 URL 예(SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# SharePoint 모드의 보고서 서버에 게시된 보고서 항목에 대한 URL 예(SSRS)
...
### SharePoint 서버 사이트 또는 하위 사이트에 대한 URL  
...
|[!INCLUDE[offSPServ](../../includes/offspserv-md.md)] 또는 [!INCLUDE[SPS2010](../../includes/sps2010-md.md)] 인스턴스의 **Documents/Doc** 폴더에 있는 Company Sales 샘플 보고서|http://TestServer/TestSite/Documents/Doc/Company%20Sales.rdl|  
