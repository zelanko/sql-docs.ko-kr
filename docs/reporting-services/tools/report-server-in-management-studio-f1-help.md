...
-   [보고서 서버 작업 취소](../../reporting-services/tools/cancel-report-server-jobs-management-studio.md)  
  
-   [카탈로그 항목 삭제](../../reporting-services/tools/delete-catalog-items-management-studio.md)  
  
-   [작업 속성 페이지](../../reporting-services/tools/job-properties-management-studio.md)  
  
-   [새 공유 일정](../../reporting-services/tools/new-shared-schedule-management-studio.md)  
  
-   [새 시스템 역할](../../reporting-services/tools/new-system-role-management-studio.md)  
