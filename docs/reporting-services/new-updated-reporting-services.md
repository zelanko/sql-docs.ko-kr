...
1. [SharePoint 페이지에 보고서 뷰어 웹 파트 추가](report-server-sharepoint/add-report-viewer-web-part-to-page.md)
2. [SharePoint 사이트에서 보고서 뷰어 웹 파트를 배포 합니다.](report-server-sharepoint/deploy-report-viewer-web-part.md)
