...
---
# 모바일 보고서에 데이터 표 추가 | Reporting Services
경우에 따라 가장 적합한 시각화는 데이터 자체입니다. [!INCLUDE[SS_MobileReptPub_Long](../../includes/ss-mobilereptpub-long.md)]에 데이터를 표시하기 위해 다음 세 가지 *데이터 표* 또는 테이블에 대해 알아봅니다.
* 단순 데이터 표
* 표시기 데이터 표
* 차트 데이터 표
...
4. [모바일 보고서에 직접 추가하는 계기](../../reporting-services/mobile-reports/add-gauges-to-mobile-reports-reporting-services.md)에서와 같이 **값** 및 **비교** 필드와 **값 방향**을 설정합니다.
