...
---
# 휴대폰 또는 태블릿용 Reporting Services 모바일 보고서 레이아웃
이제 [!INCLUDE[SS_MobileReptPub_Short](../../includes/ss-mobilereptpub-long.md)]에서 [Reporting Services 모바일 보고서를 만들었으므로](../../reporting-services/mobile-reports/create-a-reporting-services-mobile-report.md) 해당 보고서의 휴대폰 또는 태블릿 버전의 레이아웃을 지정할 수 있습니다.  
