...
![운송 계기가 선택된 금융 - 운송 보고서를 보여 주는 스크린샷](../../reporting-services/mobile-reports/media/tabbed-mobile-report-web-viewer-transportation-complete.png)
...
1. 다음 5개의 계기가 포함된 판매라는 보고서를 만듭니다.
   ...
   ![5개의 계기가 포함된 판매 보고서의 스크린샷](../../reporting-services/mobile-reports/media/01-sales-mobile-report-publisher.png)
    
2. 판매 계기에 대해 **강조** 를 **켜기** 로 설정하여 보고서의 나머지 부분과 대조되도록 합니다. 이 경우 검정 바탕에 흰색입니다.

    ![빨간색 화살표가 켜기 위치의 강조 슬라이더를 가리키는 판매 계기의 스크린샷](../../reporting-services/mobile-reports/media/01a-sales-accent-mobile-report-publisher.png)
...
1. 판매 보고서에서 운송 계기를 선택합니다.
    ...
    ![빨간색 화살표가 운송 계기에서 드릴스루 대상 옵션을 가리키는 판매 보고서의 스크린샷](../../reporting-services/mobile-reports/media/02-sales-create-drillthrough-mobile-report-publisher.png)
...
4. 드릴스루 대상이 될 보고서를 탐색하고 선택합니다. 이 경우 “금융 - 운송”입니다.
    ...
    ![금융 - 운송 옵션이 설명선으로 표시된 서버에서 열기 대화 상자의 스크린샷](../../reporting-services/mobile-reports/media/03-sales-select-dashboard-mobile-report-publisher.png)

5. **대상 보고서 구성** 에서 매개 변수를 선택하여 보고서를 필터링하고, **적용** 을 선택합니다.

   ![금융 - 운송 보고서 매개 변수를 보여 주는 대상 보고서 구성 섹션의 스크린샷](../../reporting-services/mobile-reports/media/04-sales-apply-parameters-mobile-report-publisher.png)
...
2. 각 계기마다 오른쪽 위 모서리에 드릴스루 아이콘이 있습니다.
    ...
    ![연료 계기의 스크린샷](../../reporting-services/mobile-reports/media/web-viewer-drillthrough-icon-mobile-report-builder.png)

3. 계기 중 하나를 선택하여 해당 계기의 데이터를 필터링하는 보고서로 이동합니다.

   ![빨간색 화살표가 빨간색 상자 속 운송 계기를 가리키는 금융 - 운송 보고서를 보여 주는 스크린샷](../../reporting-services/mobile-reports/media/06-mobile-report-web-viewer-transportation.png)
