...
![모바일 보고서 시간 차트의 스크린샷](../../reporting-services/mobile-reports/media/mobile-report-time-chart.png)
...
![모바일 보고서 범주 차트의 스크린샷](../../reporting-services/mobile-reports/media/mobile-report-category-chart.png)   
...
![모바일 보고서 합계 차트의 스크린샷](../../reporting-services/mobile-reports/media/mobile-report-totals-chart.png)
...
![모바일 보고서 비교 시간 차트의 스크린샷](../../reporting-services/mobile-reports/media/mobile-report-comparison-time-chart.png)
...
![모바일 보고서 깔때기형 차트의 스크린샷](../../reporting-services/mobile-reports/media/mobile-report-funnel-chart.png)
...
![모바일 보고서 그룹 트리맵의 스크린샷](../../reporting-services/mobile-reports/media/mobile-report-group-treemap.png)
...
1. **레이아웃** 탭에서 **폭포 차트** 를 디자인 화면으로 끌어 놓고 크기를 조정한 다음 필요한 경우 [해당 데이터를 가져옵니다](../../reporting-services/mobile-reports/data-for-reporting-services-mobile-reports.md).
    ...
    ![모바일 보고서 폭포 차트 아이콘의 스크린샷](../../reporting-services/mobile-reports/media/mobile-report-waterfall-chart-icon.png)
    
2.  **데이터** 탭을 선택하고 **데이터 속성** 창에서 **범주 좌표** 에는 데이터의 범주 필드를, **주 계열** 에는 숫자 필드를 선택합니다. 

    ![모바일 보고서 폭포 데이터의 스크린샷](../../reporting-services/mobile-reports/media/mobile-report-waterfall-data.png)
    
3. 미리 보기로 폭포 차트를 보려면 **레이아웃** 을 탭합니다.

   ![모바일 보고서 폭포 차트의 스크린샷](../../reporting-services/mobile-reports/media/mobile-report-waterfall-chart.png)
