...
# 데이터 원본 및 보고서 게시
 ...
 보고서를 디자인하고 테스트한 후 다른 사람과 공유할 수 있습니다. 보고서를 공유하려면 보고서를 보고서 서버 또는 SharePoint 사이트에 게시 또는 *배포*해야 합니다. 보고서를 게시하면 보고서 서버나 SharePoint 사이트에 대한 사용 권한이 있는 사용자가 이 보고서를 실행할 수 있습니다. 또한 보고서 서버에 대한 관리자 권한이 있는 사람은 정기적으로 보고서가 업데이트되고 사용자에게 전송될 수 있도록 보고서에 대한 구독을 만들 수 있습니다.  
  
 공유 데이터 원본을 사용하여 보고서를 만든 경우 보고서와 같은 위치에 이 공유 데이터 원본을 게시해야 합니다. 보고서와 마찬가지로 공유 데이터 원본은 보고서 서버에서 별도로 관리될 수 있습니다.  
  
## 섹션 내용  
 [보고서 미리 보기](../../reporting-services/reports/previewing-reports.md)  
 보고서를 게시하기 전에 미리 보는 방법에 대해 설명합니다.  
