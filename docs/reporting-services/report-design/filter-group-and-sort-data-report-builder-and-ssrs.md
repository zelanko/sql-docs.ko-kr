---
title: 데이터 필터링, 그룹화 및 정렬(보고서 작성기) | Microsoft Docs
description: 보고서 작성기의 보고서 데이터 창에서 데이터 세트 필드, 매개 변수를 기반으로 식을 사용하여 보고서 데이터를 제어, 구성 및 정렬하는 방법을 알아봅니다.
ms.date: 08/17/2018
