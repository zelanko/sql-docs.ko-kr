---
title: 차트의 범례 서식 지정(보고서 작성기) | Microsoft Docs
description: 보고서 작성기에서 범례 속성 대화 상자를 사용하거나 속성 창을 사용하여 차트의 범례에 서식을 지정하는 방법을 알아봅니다.
ms.date: 03/03/2017
