---
title: 텍스트 상자 추가, 이동 또는 삭제(보고서 작성기) | Microsoft Docs
description: 보고서 작성기에서 보고서 본문에 입력란을 추가하여 제목, 매개 변수 선택 항목, 기본 제공 필드 및 날짜와 같은 정보를 표시합니다.
ms.date: 03/01/2017
