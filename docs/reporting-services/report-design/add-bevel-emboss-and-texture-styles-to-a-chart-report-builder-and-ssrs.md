...
manager: "erikre"
---
# 차트에 빗면 효과, 볼록 효과 및 질감 스타일 추가(보고서 작성기 및 SSRS)
...
### 원형 또는 도넛형 차트에 빗면 또는 볼록 스타일을 추가하려면  
...
>  3D와 빗면 또는 볼록 스타일을 동일한 차트에서 사용할 수 없습니다. 차트에 3D를 사용하도록 설정한 경우 PieDrawingStyle 속성이 표시되지 않습니다.  
 ...
 ![오목 그리기 스타일을 포함하는 원형 차트](../../reporting-services/report-design/media/rs-piedrawingeffects-concave.png "오목 그리기 스타일을 포함하는 원형 차트")  
  
### 가로 막대형 또는 세로 막대형 차트에 질감 스타일을 추가하려면  
