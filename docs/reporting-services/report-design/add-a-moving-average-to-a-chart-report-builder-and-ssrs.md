...
![Sales Chart의 스크린샷](../../reporting-services/media/report-builder-column-chart-tutorial.png)
 ...
 [자습서: 보고서에 세로 막대형 차트 추가(보고서 작성기)](../tutorial-add-a-column-chart-to-your-report-report-builder.md)는 샘플 데이터로 시도하려는 경우 차트에 이동 평균을 추가하는 것을 안내합니다.
