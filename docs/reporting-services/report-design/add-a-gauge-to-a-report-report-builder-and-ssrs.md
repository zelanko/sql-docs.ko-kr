---
title: 보고서에 계기 추가(보고서 작성기) | Microsoft Docs
description: 보고서 작성기에서 계기 데이터 영역을 만들고 보고서 데이터 집합 필드를 계기 창으로 끌어 시각적 형식으로 데이터를 요약하는 방법을 알아봅니다.
ms.date: 03/01/2017
