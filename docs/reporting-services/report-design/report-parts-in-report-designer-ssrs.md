---
title: 보고서 디자이너의 보고서 파트 | Microsoft Docs
description: 보고서 작성기에서 게시자 및 다른 사용자가 다른 보고서에 다시 사용할 수 있도록 페이지를 매긴 보고서 항목을 보고서 서버 또는 SharePoint 사이트에 별도로 게시합니다.
ms.date: 05/30/2017
