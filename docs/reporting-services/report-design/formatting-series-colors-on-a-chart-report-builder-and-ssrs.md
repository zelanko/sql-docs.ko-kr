---
title: 차트에서 계열 색 서식 지정(보고서 작성기) | Microsoft Docs
description: 보고서 작성기에서 차트에 여러 기본 제공 색상표를 사용하는 방법 또는 고유한 디자인의 사용자 지정 색상표를 정의하는 방법을 알아봅니다.
ms.date: 03/03/2017
