...
### <a name="a-use-multilookup-function"></a>A. MultiLookup 함수 사용
...
### <a name="b-use-multilookup-with-multivalue-parameter"></a>B. 다중값 매개 변수와 함께 MultiLookup 사용  
