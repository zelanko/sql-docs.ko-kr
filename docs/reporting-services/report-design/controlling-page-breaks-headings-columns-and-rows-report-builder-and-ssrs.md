---
title: 페이지 나누기, 머리글, 열 및 행 제어(보고서 작성기) | Microsoft Docs
description: 보고서 작성기에서 페이지 길이, 열, 머리글 및 행에 대한 선택 항목을 사용하여 테이블, 목록 또는 이미지의 보기 및 인쇄를 최적화합니다.
ms.date: 03/07/2017
