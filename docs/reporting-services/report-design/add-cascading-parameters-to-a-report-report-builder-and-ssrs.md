...
---
# 보고서에 연계 매개 변수 추가(보고서 작성기 및 SSRS)
...
## 관련된 여러 매개 변수가 포함된 쿼리가 있는 기본 데이터 집합을 만들려면  
...
## 독립 매개 변수에 대한 값을 제공하는 데이터 집합을 만들려면  
...
## 종속 매개 변수의 값을 제공하는 데이터 집합을 만들려면  
