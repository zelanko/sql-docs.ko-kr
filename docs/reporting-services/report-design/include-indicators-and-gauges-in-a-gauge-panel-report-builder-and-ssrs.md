---
title: 계기 패널에 표시기 및 계기 포함(보고서 작성기) | Microsoft Docs
description: 보고서 작성기에서 보고서의 계기 패널(최상위 컨테이너)에 계기 및 표시기를 사용하는 방법을 알아봅니다.
ms.date: 03/01/2017
...
7.  **값** 영역의 **(지정하지 않음)** 목록 상자에서 계기에 표시할 값이 포함된 필드를 클릭합니다. 보고서 데이터 세트에서 사용할 필드를 끌어다 놓을 수도 있습니다.  
...
12. **값** 영역의 **(지정하지 않음)** 드롭다운 상자에서 표시기로 표시할 값이 포함된 필드를 클릭합니다. 보고서 데이터 세트에서 사용할 필드를 끌어다 놓을 수도 있습니다.  
