---
title: VarP 함수(보고서 작성기) | Microsoft Docs
description: 보고서 작성기의 VarP 함수는 식으로 지정된 Null이 아닌 모든 숫자 값의 모집단 분산을 반환합니다.
ms.date: 03/07/2017
...
## <a name="example"></a>예제  
 다음 코드 예에서는 `Order` 그룹 또는 데이터 영역의 줄 항목 합계에 대한 모집단 분산을 제공합니다.  
