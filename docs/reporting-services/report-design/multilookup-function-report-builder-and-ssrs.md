...
-   배열의 각 개체에 대해 [Lookup 함수&#40;보고서 작성기 및 SSRS&#41;](../../reporting-services/report-design/lookup-function-report-builder-and-ssrs.md)를 호출하고 결과를 반환 배열에 추가합니다.  
  
-   결과 집합을 반환합니다.  
  
 일 대 일 관계의 이름-값 쌍을 포함하는 데이터 집합에서 지정된 이름에 대한 단일 값을 검색하려면 [Lookup 함수&#40;보고서 작성기 및 SSRS&#41;](../../reporting-services/report-design/lookup-function-report-builder-and-ssrs.md)를 사용하고, 일 대 다 관계의 이름 값 쌍을 포함하는 데이터 집합에서 이름에 대한 여러 값을 검색하려면 [LookupSet 함수&#40;보고서 작성기 및 SSRS&#41;](../../reporting-services/report-design/lookupset-function-report-builder-and-ssrs.md)를 사용합니다.  
