---
title: 페이지 머리글/바닥글 추가 또는 제거(보고서 작성기) | Microsoft Docs
description: 보고서 작성기에서 페이지 머리글 또는 바닥글에 정적 텍스트, 이미지, 선, 사각형 및 테두리를 추가할 수 있는 방법을 알아봅니다.
ms.date: 03/01/2017
