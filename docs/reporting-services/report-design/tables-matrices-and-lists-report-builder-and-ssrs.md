---
title: 테이블, 행렬 및 목록(보고서 작성기) | Microsoft Docs
description: 보고서 작성기에서 행과 열로 구성된 페이지를 매긴 보고서 데이터를 표시하는 테이블, 행렬, 목록, 테이블릭스 데이터 영역에 대해 알아봅니다.
ms.date: 03/14/2017
...
##  <a name="changing-between-tablix-templates"></a><a name="ChangingBetweenTablixTemplates"></a> 테이블릭스 템플릿 간 변경  
