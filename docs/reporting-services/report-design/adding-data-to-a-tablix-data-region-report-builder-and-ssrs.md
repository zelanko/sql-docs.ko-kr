---
title: 테이블릭스 데이터 영역에 데이터 추가(보고서 작성기) | Microsoft Docs
description: 테이블 또는 행렬의 보고서 데이터 세트에서 테이블릭스 데이터 영역까지 세부 데이터 또는 그룹화된 데이터를 표시하는 방법을 알아봅니다.
ms.date: 03/07/2017
