...
# 그룹 또는 테이블릭스 데이터 영역에 합계 추가(보고서 작성기 및 SSRS)
 ...
 합계를 추가한 후에는 기본 함수 Sum을 기본 제공 보고서 함수 목록의 다른 집계 함수로 변경할 수 있습니다. 자세한 내용은 [집계 함수 참조&#40;보고서 작성기 및 SSRS&#41;](../../reporting-services/report-design/aggregate-functions-reference-report-builder-and-ssrs.md)를 참조하세요.[!INCLUDE[ssRBRDDup](../../includes/ssrbrddup-md.md)]  
  
## 테이블릭스 본문 영역의 개별 값에 대한 합계를 추가하려면  
