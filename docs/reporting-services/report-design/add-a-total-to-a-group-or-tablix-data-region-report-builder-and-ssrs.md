---
title: 그룹 또는 테이블릭스에 합계 추가(보고서 작성기 및 SSRS) | Microsoft Docs
description: SQL Server Reporting Services 페이지를 매긴 보고서에서는 그룹 또는 전체 데이터 영역에 대한 테이블릭스 데이터 영역에 합계를 추가할 수 있습니다.
ms.date: 12/16/2019
