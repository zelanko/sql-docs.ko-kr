---
title: 데이터 세트 필드 컬렉션 참조(보고서 작성기) | Microsoft Docs
description: 보고서 작성기의 보고서 데이터 창에 개별 값 또는 요약 값을 표시하기 위한 데이터 세트를 만듭니다.
ms.date: 03/01/2017
...
> [!NOTE]  
>  IsMissing은 모든 유형의 데이터 원본에 대해 디자인 타임과 런타임 간의 데이터 세트 스키마 변경을 검색합니다. IsMissing은 다차원 큐브의 빈 멤버를 검색하는 데 사용할 수 없으며 **EMPTY** 및 **NON EMPTY**의 MDX 쿼리 언어 개념과 관련이 없습니다.  
...
### <a name="using-extended-field-properties"></a>확장 필드 속성 사용  
 확장 필드 속성은 데이터 세트에 대한 데이터 원본 유형에 의해 결정되는 데이터 처리 확장 프로그램에서 필드에 대해 정의하는 추가 속성입니다. 확장 필드 속성은 미리 정의되거나 데이터 원본 유형 관련 속성입니다. 자세한 내용은 [Analysis Services 데이터베이스에 대한 확장 필드 속성 &#40;SSRS&#41;](../../reporting-services/report-data/extended-field-properties-for-an-analysis-services-database-ssrs.md)을 참조하세요.  
