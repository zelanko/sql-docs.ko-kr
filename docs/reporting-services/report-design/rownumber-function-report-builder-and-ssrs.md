...
## 주의  
 **RowNumber** 는 [RunningValue](../../reporting-services/report-design/runningvalue-function-report-builder-and-ssrs.md) 가 집계 함수의 실행 값을 반환하는 것처럼 지정한 범위 내 행 개수의 실행 값을 반환합니다. 범위를 지정할 때 행 개수를 1로 다시 설정할 시점을 지정합니다.  
