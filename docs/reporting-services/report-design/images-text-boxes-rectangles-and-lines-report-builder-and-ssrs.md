---
title: 이미지, 텍스트 상자, 사각형 및 선(보고서 작성기) | Microsoft Docs
description: 보고서 작성기에서 시각적 효과를 추가하거나, 주요 정보를 강조 표시하거나, 관련 정보를 제공합니다. 이미지, 입력란, 사각형 및 선을 추가합니다.
ms.date: 03/01/2017
