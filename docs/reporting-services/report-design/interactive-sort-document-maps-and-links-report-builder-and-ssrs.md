---
title: 대화형 정렬, 문서 구조 및 링크(보고서 작성기) | Microsoft Docs
description: 보고서 작성기에서 사용자가보고서에서 값 정렬 순서를 변경하거나, 항목을 표시 또는 숨기거나, 다른 보고서 또는 웹 페이지에 대한 링크를 선택할 수 있습니다.
ms.date: 03/14/2017
