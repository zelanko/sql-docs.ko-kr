---
title: "축 간격 (보고서 작성기 및 SSRS)를 지정 합니다. | Microsoft Docs"
ms.custom: 
ms.date: 09/02/2016
...
샘플 데이터를 사용 하 여 축 간격을 설정 해 보고, 참조 [자습서: 보고서 (보고서 작성기)에 세로 막대형 차트 추가](Tutorial:%20Add%20a%20Column%20Chart%20to%20Your%20Report%20\(Report%20Builder\).md)합니다.
