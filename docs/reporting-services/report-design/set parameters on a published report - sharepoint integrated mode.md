---
title: "게시된 보고서에 매개 변수 설정(SharePoint 통합 모드의 Reporting Services) | Microsoft Docs"
ms.custom: ""
ms.date: "12/09/2016"
...
manager: "erikre"
---
# 게시된 보고서에 매개 변수 설정(SharePoint 통합 모드의 Reporting Services)
