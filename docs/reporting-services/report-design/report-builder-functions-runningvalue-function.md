...
-   *Expression* 에는 *recursive*를 지정하는 중첩 집계가 포함되지 않아야 합니다.  
 ...
 행 개수의 실행 값을 계산하려면 **RowNumber**를 사용하세요. 자세한 내용은 [RowNumber 함수&#40;보고서 작성기 및 SSRS&#41;](../../reporting-services/report-design/report-builder-functions-rownumber-function.md)를 참조하세요.  
