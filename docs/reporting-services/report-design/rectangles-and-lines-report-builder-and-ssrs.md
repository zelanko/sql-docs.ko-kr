---
title: 사각형 및 선(보고서 작성기) | Microsoft Docs
description: 보고서 작성기에서 페이지를 매긴 보고서 내에 시각적 효과를 만드는 방법을 알아봅니다. 색, 이미지, 도구 설명, 책갈피와 같은 기능을 추가할 수 있습니다.
ms.date: 03/01/2017
