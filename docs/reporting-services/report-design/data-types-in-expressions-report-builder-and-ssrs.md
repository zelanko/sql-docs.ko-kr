---
title: 식의 데이터 형식(보고서 작성기) | Microsoft Docs
description: 보고서 작성기에서 데이터를 저장하고 처리할 수 있도록 데이터 형식이 다양한 종류의 데이터를 표시하는 방식을 알아봅니다.
ms.date: 08/17/2018
...
-   입력란에서 식을 사용하여 문자열의 일부를 추출합니다. 예를 들면 다음과 같습니다.  
