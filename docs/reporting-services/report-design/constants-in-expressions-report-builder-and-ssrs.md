---
title: 식의 상수(보고서 작성기) | Microsoft Docs
description: 보고서 작성기에서 보고서에 사용되는 식의 리터럴 텍스트 또는 미리 정의된 상수 텍스트에 대해 알아봅니다.
ms.date: 03/01/2017
...
## <a name="see-also"></a>참고 항목  
 ...
 [식 대화 상자&#40;보고서 작성기&#41;](./expressions-report-builder-and-ssrs.md)  
