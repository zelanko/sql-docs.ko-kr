...
description: 보고서 작성기에서 Var 함수를 사용하여 식으로 지정된 Null이 아닌 모든 숫자 값의 분산을 반환합니다.
ms.date: 03/07/2017
 ...
 *범위*  
 (**문자열**) 선택 사항입니다. 집계 함수를 적용할 보고서 항목을 포함하는 데이터 세트, 그룹 또는 데이터 영역의 이름인 상수입니다. *scope* 를 지정하지 않은 경우 현재 범위가 사용됩니다.  
