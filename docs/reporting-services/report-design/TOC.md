...
### [Reporting Services의 트리 지도 및 선버스트 차트](tree-map-and-sunburst-charts-in-reporting-services.md)  
...
### [차트 범례 - 항목 숨기기](chart-legend-hide-items-report-builder.md)  
### [차트 범례 - 항목 텍스트 변경](chart-legend-change-item-text-report-builder.md)  
...
### [차트 효과 - 3D, 3D 가장자리 및 기타](chart-effects-3d-bevel-and-other-report-builder.md)  
### [차트 효과 - 3D 효과 추가](chart-effects-add-3d-effects-report-builder.md)  
### [차트 효과 - 3D 가장자리, 볼록 또는 질감](chart-effects-add-bevel-emboss-or-texture-report-builder.md)  
...
## [보고서에 매개 변수 창 사용자 지정](customize-the-parameters-pane-in-a-report-report-builder.md)  
...
#### [보고서 작성기 함수 - Previous 함수](report-builder-functions-previous-function.md)  
...
#### [기본 제공 컬렉션 - DataSources 및 데이터 집합 참조](built-in-collections-datasources-and-datasets-references-report-builder.md)  
