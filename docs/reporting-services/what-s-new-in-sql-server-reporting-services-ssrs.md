...
[!INCLUDE[sql-server-2019]](../includes/sssqlv15-md.md)] CTP 2.1에서는 Reporting Services를 사용할 수 없습니다. 현재 버전, [SQL Server 2017 Reporting Services](install-windows/install-reporting-services.md)를 설치하세요.
::: moniker-end
