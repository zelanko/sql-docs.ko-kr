...
# <a name="planning-for-reporting-services"></a>Reporting Services에 대한 계획
 ...
 ![작은 파일 폴더 아이콘](https://docs.microsoft.com/analysis-services/analysis-services/media/filefolder-small.png "작은 파일 폴더 아이콘") **일반적인 Reporting Services 기능 계획 및 아키텍처**  
