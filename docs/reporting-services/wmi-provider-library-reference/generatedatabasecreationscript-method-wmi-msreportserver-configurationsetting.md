...
apitype: "MOFDef"
helpviewer_keywords: 
  - "GenerateDatabaseCreationScript 메서드"
...
> [!IMPORTANT]  
>  SharePoint 모드에서는 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]가 SharePoint 공유 서비스이며 WMI 공급자를 통해 제어되지 않으므로 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]부터는 *IsSharePointMode*=**True**가 지원되지 않습니다. 항상 이 매개 변수를 **False**로 설정해야 합니다.  
