...
manager: "erikre"
---
# ReserveURL 메서드(WMI MSReportServer_ConfigurationSetting)
...
## 주의  
 *UrlString* 에는 가상 디렉터리 이름이 포함되지 않습니다. [SetVirtualDirectory](../../reporting-services/wmi-provider-library-reference/setvirtualdirectory-method-wmi-msreportserver-configurationsetting.md) 메서드를 사용하면 가상 디렉터리 이름을 포함할 수 있습니다.  
