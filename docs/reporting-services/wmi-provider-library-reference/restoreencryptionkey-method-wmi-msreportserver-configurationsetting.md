...
## 주의  
 ...
 이 메서드는 암호화 키 목록을 지우는 [DeleteEncryptionKey](../../reporting-services/wmi-provider-library-reference/deleteencryptionkey-method-wmi-msreportserver-configurationsetting.md) 메서드 다음에 호출하는 것이 가장 효과적입니다.  
