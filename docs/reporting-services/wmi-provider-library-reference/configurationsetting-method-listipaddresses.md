---
description: ListIPAddresses 메서드(WMI MSReportServer_ConfigurationSetting)
 ...
 *IsDhcpEnabled* 가 **True**이면 *IPAddress* 가 동적이므로 TLS 바인딩에 사용해서는 안 됩니다.  
