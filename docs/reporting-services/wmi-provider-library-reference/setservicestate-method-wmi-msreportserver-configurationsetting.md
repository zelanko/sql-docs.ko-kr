...
manager: "erikre"
---
# SetServiceState 메서드(WMI MSReportServer_ConfigurationSetting)
 ...
 *EnableWebService*  
 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 웹 서비스 상태를 나타내는 **Boolean** 값입니다. **true** 값은 보고서 서버 웹 서비스를 시작하고 **false** 값은 웹 서비스를 중지합니다.  
