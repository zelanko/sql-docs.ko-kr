...
ms.topic: "article"
helpviewer_keywords: 
  - "GetDatabaseVersionDisplayName 메서드"
...
manager: "erikre"
---
# GetDatabaseVersionDisplayName 메서드(WMI)
...
|핫픽스||적용 가능한 가장 가까운 버전|  
 ...
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 2000 이전 *버전*의 경우 ACT_E_BAD_VERSION의 HRESULT가 반환됩니다.  
