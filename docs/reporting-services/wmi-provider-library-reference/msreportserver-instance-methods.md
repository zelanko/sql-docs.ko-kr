...
|||  
|-|-|  
|[GetReportServerUrls 메서드&#40;WMI MSReportServer_Instance&#41;](../../reporting-services/wmi-provider-library-reference/getreportserverurls-method-wmi-msreportserver-instance.md)|사용자가 보고서 서버 및 [!INCLUDE[ssRSWebPortal](../../includes/ssrswebportal.md)]에 액세스하는 데 사용할 수 있는 URL을 나열합니다.|  
