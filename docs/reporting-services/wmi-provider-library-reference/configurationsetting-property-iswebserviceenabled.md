...
---
# <a name="configurationsetting-property---iswebserviceenabled"></a>IsWebServiceEnabled ConfigurationSetting 속성-
...
## <a name="property-values"></a>속성 값  
 읽기 전용 **부울** 값입니다. **true** 값은 보고서 서버 웹 서비스를 사용할 수 있음을 나타냅니다.  
