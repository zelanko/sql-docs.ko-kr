...
# [포함된 데이터 원본 만들기 및 수정](create-and-modify-embedded-data-sources.md)  
...
## [파워 피벗 연결 형식](power-pivot-connection-type-ssrs.md)  
...
# [보고서 데이터 집합](report-datasets-ssrs.md)  
...
## [포함된 데이터 집합 및 공유 데이터 집합](embedded-and-shared-datasets-report-builder-and-ssrs.md)  
