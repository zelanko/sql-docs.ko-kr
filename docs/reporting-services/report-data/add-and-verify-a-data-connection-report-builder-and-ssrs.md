...
# 데이터 연결 추가 및 확인(보고서 작성기 및 SSRS)
 ...
 자세한 내용은 [보고서 작성기의 데이터 연결, 데이터 원본 및 연결 문자열](../Topic/Data%20Connections,%20Data%20Sources,%20and%20Connection%20Strings%20in%20Report%20Builder.md) 및 [보고서 작성기에 자격 증명 지정](../Topic/Specify%20Credentials%20in%20Report%20Builder.md)을 참조하세요.  
  
> [!NOTE]  
>  [!INCLUDE[ssRBRDDup](../../includes/ssrbrddup-md.md)]  
  
### 보고서 작성기에서 공유 데이터 원본에 대한 연결을 만들려면  
...
5.  **자세히**를 클릭하고 표시되는 정보를 사용하여 문제를 해결합니다.  
     ...
     자세한 내용은 [보고서 작성기에 자격 증명 지정](../Topic/Specify%20Credentials%20in%20Report%20Builder.md)을 참조하세요.  
