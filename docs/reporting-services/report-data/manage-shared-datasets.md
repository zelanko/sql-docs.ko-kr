...
-   [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]/Visual Studio의 보고서 디자이너를 사용하여 솔루션 탐색기의 데이터 세트 폴더에 공유 데이터 세트를 만듭니다. 공유 데이터 세트를 게시하려면 보고서 서버 또는 SharePoint 사이트에 배포합니다.  
