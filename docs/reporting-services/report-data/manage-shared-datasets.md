...
-   보고서 디자이너 [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)] / Visual Studio 솔루션 탐색기에서 데이터 집합 폴더에 공유 데이터 집합을 만듭니다. 공유 데이터 세트를 게시하려면 보고서 서버 또는 SharePoint 사이트에 배포합니다.  
...
## <a name="viewing-or-changing-the-shared-dataset-definition"></a>공유 데이터 세트 정의 보기 또는 변경  
 ...
 XML에서 공유 데이터 세트 정의를 보는 또 다른 방법은 웹 포털에서 URL 액세스 구문을 사용하는 것입니다. 예를 들어 각 데이터 세트 매개 변수에 대한 기본값을 보려면 다음 URL 액세스 명령을 사용하여 보고서 서버에서 DataSet1이라는 공유 데이터 세트 정의를 표시할 수 있습니다.  
...
-   **보고서 보기** 공유 데이터 세트 항목 및 항목 속성을 봅니다.  
  
-   **보고서 사용** 공유 데이터 세트의 정의를 읽습니다.  
  
-   **보고서 관리** 공유 데이터 세트를 만들고 삭제하며 공유 데이터 세트의 속성을 편집합니다.  
  
-   **항목의 보안 설정** 공유 데이터 세트에 대한 보안 설정을 보고 수정합니다.  
...
|태스크      |도구      |링크      |  
|----------|----------|----------|  
|공유 데이터 세트를 추가하거나 공유 데이터 세트 정의 속성을 변경합니다.|보고서 작성기에서 저장<br /><br /> 보고서 디자이너에서 배포<br /><br /> 웹 포털에서.rsd 파일 업로드|[보고서 포함된 데이터 세트 및 공유 데이터 세트&#40;보고서 작성기 및 SSRS&#41;](../../reporting-services/report-data/report-embedded-datasets-and-shared-datasets-report-builder-and-ssrs.md)]<br /><br /> [보고서 서버에서 파일 또는 보고서 업로드r](../../reporting-services/reports/upload-a-file-or-report-report-manager.md)<br /><br /> 공유 데이터 세트를 공유 데이터 세트가 종속되어 있는 공유 데이터 원본보다 먼저 업로드하는 경우 공유 데이터 세트를 공유 데이터 원본에 수동으로 바인딩해야 합니다. 자세한 내용은 참조 하세요. [... /.. 공유 데이터 집합-웹 포털을 사용 하 여 /reporting-services/Work](../work-with-shared-datasets-web-portal.md)합니다.|  
...
|데이터 세트 매개 변수의 기본값을 확인합니다.|보고서 작성기에서 열기 또는 URL 액세스 구문 사용|예를 들어<br /><br /> `https://localhost/reportserver/?/Datasets/Dataset1&rs:command=GetShareddatasetDefinition`
...
-   보고서와 마찬가지로 공유 데이터 세트도 캐시할 수 있습니다. 데이터 원본에서 필요로 하는 자격 증명은 캐싱 제한 사항을 충족해야 하며 모든 매개 변수에 대해 기본값이 지정되어야 합니다. 자세한 내용은 msdn.microsoft.com의 [공유 데이터 세트 캐시&#40;SSRS&#41;](../../reporting-services/report-server/cache-shared-datasets-ssrs.md)을 참조하세요.  
