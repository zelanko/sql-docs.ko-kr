---
title: "Analysis Services용 MDX 쿼리 디자이너에서 매개 변수 정의(보고서 작성기 및 SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "매개 변수 [Reporting Services], MDX"
  - "다차원 식 [Reporting Services]"
  - "데이터 마이닝 예측 [Reporting Services]"
  - "MDX [Reporting Services], 매개 변수 정의"
...
manager: "erikre"
---
# Analysis Services용 MDX 쿼리 디자이너에서 매개 변수 정의(보고서 작성기 및 SSRS)
...
3.  MDX 쿼리 디자이너 도구 모음에서 **쿼리 매개 변수** \(![쿼리 매개 변수 대화 상자 아이콘](../../reporting-services/report-data/media/iconqueryparameter.png "쿼리 매개 변수 대화 상자 아이콘"))를 클릭합니다. 쿼리 매개 변수 대화 상자가 열립니다.  
