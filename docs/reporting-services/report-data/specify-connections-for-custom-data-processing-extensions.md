...
ms.topic: "article"
helpviewer_keywords: 
  - "사용자 지정 데이터 처리 확장 프로그램 [Reporting Services]"
  - "IDbConnection 인터페이스, 연결 문자열"
  - "가장 [Reporting Services]"
  - "IDbConnectionExtension 인터페이스, 연결 문자열"
  - "데이터 원본 [Reporting Services], 보안"
  - "연결 문자열 [Reporting Services]"
  - "자격 증명 [Reporting Services]"
  - "인증 [Reporting Services]"
  - "외부 데이터 원본 [Reporting Services]"
  - "데이터 처리 확장 프로그램 [Reporting Services], 연결"
...
---
# 사용자 지정 데이터 처리 확장 프로그램에 대한 연결 지정
