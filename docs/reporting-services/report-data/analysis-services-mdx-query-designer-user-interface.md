...
description: MDX(Multidimensional Expression) 쿼리를 작성하기 위한 Reporting Services 그래픽 쿼리 디자이너에 대해 알아봅니다.
ms.date: 03/07/2017
