...
-   *XML 쿼리 요소*  
 ...
 쿼리 구문에 대 한 자세한 내용은 xml [보고서 데이터 &#40;SSRS&#41;를 위한 xml 쿼리 구문](../../reporting-services/report-data/xml-query-syntax-for-xml-report-data-ssrs.md)을 참조 하세요.  
