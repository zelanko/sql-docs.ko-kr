...
-   [데이터 집합 속성 대화 상자, 매개 변수&#40;보고서 작성기&#41;](../Topic/Dataset%20Properties%20Dialog%20Box,%20Parameters%20\(Report%20Builder\).md)  
...
-   [데이터 집합 속성 대화 상자, 필터&#40;보고서 작성기&#41;](../Topic/Dataset%20Properties%20Dialog%20Box,%20Filters%20\(Report%20Builder\).md)  
 ...
 **필드 새로 고침**  
 쿼리 명령을 실행하여 [데이터 집합 속성 대화 상자, 필드](../Topic/Dataset%20Properties%20Dialog%20Box,%20Fields%20\(Report%20Builder\).md) 페이지에서 필드의 목록을 업데이트합니다.  
