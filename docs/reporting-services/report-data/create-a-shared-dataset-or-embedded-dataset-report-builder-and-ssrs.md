...
---
# 공유 데이터 집합 또는 포함된 데이터 집합 만들기(보고서 작성기 및 SSRS)
...
3.   데이터 집합을 보고서 서버 또는 SharePoint 사이트에 직접 저장합니다.  
 ...
 다음 작업에는 [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]의 **보고서 디자이너**를 사용하세요.  
...
## SQL Server 관계형 데이터베이스에서 데이터 집합을 만들려면  
...
## 관련 항목:  
 ...
 [데이터 연결, 데이터 원본 및 연결 문자열&#40;보고서 작성기 및 SSRS&#41;](../Topic/Data%20Connections,%20Data%20Sources,%20and%20Connection%20Strings%20in%20Report%20Builder.md)   
