...
1.  데이터 세트 디자인 뷰에서 공유 데이터 세트를 만듭니다. 공유 데이터 세트는 게시된 공유 데이터 원본을 사용해야 합니다.  
  
2.   보고서 디자인 뷰에서 포함된 데이터 세트를 만듭니다.  
  
3.   데이터 세트를 보고서 서버 또는 SharePoint 사이트에 직접 저장합니다.  
...
## <a name="to-create-a-shared-dataset-in-report-builder"></a>보고서 작성기에서 공유 데이터 세트를 만들려면
