...
description: Reporting Services에서 이미지 형식으로 렌더링하는 데 사용할 수 있는 다양한 디바이스 정보 설정에 대해 알아봅니다.
ms.date: 03/16/2017
...
|**OutputFormat**|[!INCLUDE[ndptecgdiexpanded](../includes/ndptecgdiexpanded-md.md)]([!INCLUDE[ndptecgdi](../includes/ndptecgdi-md.md)]) 지원 출력 형식 중 하나입니다. **BMP**, **EMF**, **GIF**, **JPEG**, **PNG** 또는 **TIFF**.|  
