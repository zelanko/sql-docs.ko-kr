...
helpviewer_keywords: 
  ...
  - "Reporting Services, 새로운 기능"
  - "SQL Server Reporting Services, 새로운 기능"
  - "SSRS, 새로운 기능"
...
SQL Server [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]의 새로운 기능에 대해 알아봅니다. 여기에서는 주요 기능 영역에 설명하고 출시된 새 항목에 맞게 업데이트되었습니다.
  
  SQL Server의 다른 영역에 도입된 새로운 기능에 대한 자세한 내용은 [SQL Server vNext의 새로운 기능](../sql-server/what-s-new-in-sql-server-vnext.md) or [SQL Server 2016의 새로운 기능](../sql-server/what-s-new-in-sql-server-2016.md)을 참조하세요.
...
-   Azure 계정이 있으세요?  계정이 있는 경우 **[여기](https://azure.microsoft.com/en-us/marketplace/partners/microsoft/sqlserver2016sp1enterprisewindowsserver2016/)** 로 이동하여 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] 이 이미 설치된 가상 컴퓨터를 실행해 보세요.  
  
 ![참고](../analysis-services/instances/install-windows/media/ssrs-fyi-note.png "참고") 현재 릴리스 정보에 대한 자세한 내용은 [SSRS의 Power BI 기술 미리 보기 보고서 - 릴리스 정보](../reporting-services/reporting-services-릴리스-정보.md) 또는 [SQL Server 2016 릴리스 정보](../sql-server/sql-server-2016-release-notes.md)를 참조하세요.  

## <a name="whats-new-in-the-january-2017-technical-preview-of-power-bi-reports-in-sql-server-reporting-services"></a>2017년 1월 SQL Server Reporting Services의 Power BI 기술 미리 보기 보고서에 포함된 새로운 기능

### <a name="reporting-services-has-a-new-setup-experience"></a>Reporting Services에서 새로운 설치 환경 제공

이제 SQL Server 설치 외부에서 Reporting Services를 설치할 수 있습니다. 설치 환경이 더 적은 단계로 구성되며 좀 더 간단합니다. 설치 프로그램은 Reporting Services용 파일을 설치합니다. 그러면 보고서 서버에 대한 데이터베이스를 구성할 수 있습니다. 사용자 환경에서 SQL Server 데이터베이스 엔진 서버에 액세스하려면 이 작업이 필요합니다.

![ssrs-standalone-setup1](../reporting-services/media/ssrs-standalone-setup1.png)

자세한 내용은 [2017년 1월 SQL Server Reporting Services의 Power BI 기술 미리 보기 보고서 설치](Install%20the%20January%202017%20Technical%20Preview%20of%20Power%20BI%20reports%20in%20SQL%20Server%20Reporting%20Services.md)를 참조하세요.

### <a name="host-power-bi-reports-within-the-web-portal"></a>웹 포털 내에 Power BI 보고서 호스트

이제 Reporting Services에 Power BI Desktop 파일을 업로드하고 웹 포털에서 직접 보고서를 볼 수 있습니다.

![ssrs-powerbi-report-config-render](../reporting-services/media/ssrs-powerbi-report-config-render.png)

Power BI Desktop 릴리스(SQL Server Reporting Services)를 다운로드해야 합니다. 현재 이 미리 보기는 이 버전의 Power BI Desktop에서 만든 보고서만 지원합니다. Power BI Desktop(SQL Server Reporting Services)은 Power BI 서비스용 Power BI Desktop과 함께 설치될 수 있습니다. Power BI Desktop(SQL Server Reporting Services)를 다운로드하려면 Microsoft 다운로드 센터로 이동하세요. 

현재 Power BI 보고서는 Analysis Services에 라이브로 연결된 상태로만 만들 수 있습니다(테이블 형식 또는 다차원 형식). 향후 미리 보기에서는 다른 데이터 원본에 대한 지원을 추가하고 파워 쿼리 기능을 사용할 예정입니다.

자세한 내용은 [Reporting Services의 Power BI 보고서](../reporting-services/power-bi-reports-in-reporting-services.md)를 참조하세요.
...
### <a name="reporting-services-includessrswebportal-non-markdowntokenssrswebportal-non-markdownmdmd"></a>Reporting Services [!INCLUDE[ssRSWebPortal-Non-Markdown](../includes/ssrswebportal-non-markdown-md.md)]  
 ...
 #### <a name="custom-branding-for-the-includessrswebportal-non-markdowntokenssrswebportal-non-markdownmdmd"></a>[!INCLUDE[ssRSWebPortal-Non-Markdown](../includes/ssrswebportal-non-markdown-md.md)]에 대한 사용자 지정 브랜딩 
  브랜딩 팩을 사용하여 조직의 로고 및 색상으로 [!INCLUDE[ssRSWebPortal-Non-Markdown](../includes/ssrswebportal-non-markdown-md.md)]을 사용자 지정할 수 있습니다.  
  
  사용자 지정 브랜딩에 대한 자세한 내용은 [웹 포털 브랜딩](http://msdn.microsoft.com/ko-kr/6dac97f7-02a6-4711-81a3-e850a6b40bf1)을 참조하세요.
 
 #### <a name="key-performance-indicators-kpi-in-the-includessrswebportal-non-markdowntokenssrswebportal-non-markdownmdmd"></a>[!INCLUDE[ssRSWebPortal-Non-Markdown](../includes/ssrswebportal-non-markdown-md.md)]의 KPI(핵심 성과 지표) 
...
현재 폴더 상황에 맞는 [!INCLUDE[ssRSWebPortal-Non-Markdown](../includes/ssrswebportal-non-markdown-md.md)]에서 직접 KPI를 만들 수 있습니다. KPI를 만들 때 데이터 집합 필드를 선택하고 이러한 값을 요약할 수 있습니다. 관련 콘텐츠를 선택하여 더 세부적으로 드릴스루할 수 있습니다.
 ...
 자세한 내용은 [웹 포털에서 KPI 사용](http://msdn.microsoft.com/ko-kr/a28cf500-6d47-4268-a248-04837e7a09eb)을 참조하세요.
...
**트리 맵과 선버스트 차트:** 계층적 데이터를 표시하는 데 유용한 방법인 트리 맵 ![ssrs_treemap_icon](../reporting-services/media/ssrs-treemap-icon.png "ssrs_treemap_icon")과 선버스트 차트 ![ssrs_sunburst_icon](../reporting-services/media/ssrs-sunburst-icon.png "ssrs_sunburst_icon")로 보고서를 개선할 수 있습니다. 자세한 내용은 [Tree Map and Sunburst Charts in Reporting Services](../reporting-services/report-design/tree-map-and-sunburst-charts-in-reporting-services.md)를 참조하세요.  
...
**높은 DPI 지원:** [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]용 [!INCLUDE[ssRBnoversion](../includes/ssrbnoversion-md.md)]는 높은 DPI(인치당 도트 수) 배율 및 장치를 지원합니다.  높은 DPI에 대한 자세한 내용은 다음을 참조하세요.  
...
## <a name="see-also"></a>관련 항목:  
 [Analysis Services의 새로운 기능](http://msdn.microsoft.com/ko-kr/aa69c299-b8f4-4969-86d8-b3292fe13f08)  
 [SSRS의 Power BI 기술 미리 보기 보고서 - 릴리스 정보](../reporting-services/reporting-services-릴리스-정보.md)  
 [SQL Server 2016 릴리스 정보](../sql-server/sql-server-2016-release-notes.md)   
 [이전 버전과의 호환성](http://msdn.microsoft.com/ko-kr/675b0e0e-cfee-4790-9675-80fc3ea6d30f)   
 [SQL Server 2016 버전에서 지원하는 Reporting Services 기능](http://msdn.microsoft.com/ko-kr/39f03d2d-6e48-4b34-a9d3-07f86313b937)   
