...
---
# 웹 포털(SSRS 기본 모드)
Reporting Services [!INCLUDE[ssRSWebPortal](../includes/ssrswebportal.md)] 은 보고서, 모바일 보고서, KPI를 보고 보고서 서버 인스턴스에 있는 요소로 이동할 수 있는 웹 기반 환경입니다. 또한 [!INCLUDE[ssRSWebPortal](../includes/ssrswebportal.md)] 을 사용하여 단일 보고서 서버 인스턴스를 관리할 수 있습니다.  
...
<a name="whatisportal"/>  
## [!INCLUDE[ssRSWebPortal](../includes/ssrswebportal.md)]이란?  
  
[!INCLUDE[ssRSWebPortal](../includes/ssrswebportal.md)] 을 사용하여 다음 작업을 수행할 수 있습니다.  
...
[!INCLUDE[ssRSWebPortal](../includes/ssrswebportal.md)] 을 사용하여 보고서 서버 폴더를 찾아보거나 특정 보고서를 검색할 수 있습니다. 보고서, 해당 일반 속성 및 보고서 기록에 캡처된 보고서의 지난 복사본을 볼 수 있습니다. 권한에 따라 보고서를 구독하여 전자 메일 받은 편지함 또는 파일 시스템의 공유 폴더로 배달되도록 할 수도 있습니다.  
  
> [!NOTE] 지원되는 브라우저와 버전에 대한 자세한 내용은 [Reporting Services 브라우저 지원 계획](../reporting-services/browser-support-for-reporting-services-and-power-view.md)을 참조하십시오.  
  
[!INCLUDE[ssRSWebPortal](../includes/ssrswebportal.md)] 은 기본 모드로 실행되는 보고서 서버에만 사용되며 SharePoint 통합 모드용으로 구성된 보고서 서버에 대해서는 지원되지 않습니다.  
  
일부 [!INCLUDE[ssRSWebPortal](../includes/ssrswebportal.md)] 기능은 지정된 버전의 [!INCLUDE[ssNoVersion](../includes/ssnoversion.md)]에서만 사용할 수 있습니다. 자세한 내용은 [SQL Server 2016 버전에서 지원하는 기능](Features%20Supported%20by%20the%20Editions%20of%20SQL%20Server%202016.xml)을 참조하십시오.  
  
새로 설치하는 경우 로컬 관리자에게만 내용 및 설정을 사용할 수 있는 권한이 부여됩니다. 다른 사용자에게 사용 권한을 부여하려면 로컬 관리자가 보고서 서버에 대한 액세스 권한을 제공하는 역할 할당을 만들어야 합니다. 사용자가 이후에 액세스할 수 있는 응용 프로그램 페이지 및 태스크는 해당 사용자에 대한 역할 할당에 따라 달라집니다. 자세한 내용은 방법: 보고서 서버에 사용자 추가를 참조하십시오.  
...
### 다음을 시작 [!INCLUDE[ssRSWebPortal](../includes/ssrswebportal.md)]  
[!INCLUDE[ssRSWebPortal](../includes/ssrswebportal.md)]을 브라우저에서 시작하려면 다음을 수행합니다.  
...
2.  웹 브라우저의 주소 표시줄에 보고서 [!INCLUDE[ssRSWebPortal](../includes/ssrswebportal.md)] URL을 입력합니다.  
  
    기본적으로 이 URL은 *http://[ComputerName]/reports*입니다.  
  
    특정 포트를 사용하도록 보고서 서버를 구성할 수 있습니다. 예: *http://[ComputerName]:80/reports* 또는 *http://[ComputerName]:8080/reports*  
  
<a name="categories">  
## 범주별 그룹화  
  
[!INCLUDE[ssRSWebPortal](../includes/ssrswebportal.md)] 이 항목을 여러 범주로 그룹화합니다. 사용 가능한 범주는 다음과 같습니다.  
...
오른쪽 상단에서 **보기** 를 선택하여 표시되는 항목을 관리할 수 있습니다. 해당 폴더에 사용 가능한 항목이 있을 경우 선택된 항목이 표시됩니다. 항목을 숨기려면 해당 항목을 선택 취소합니다.  
  
![ssRSWebPortal-view](../reporting-services/media/ssrswebportal-view.png)  
   
숨김 표시를 선택할 경우 해당 항목은 흐린 색으로 표시됩니다.  
...
[공유 데이터 집합 작업](../reporting-services/working-with-shared-datasets-web-portal.md)  
...
[SQL Server 2016 버전에서 지원하는 기능](Features%20Supported%20by%20the%20Editions%20of%20SQL%20Server%202016.xml)  
