...
ms.topic: "article"
helpviewer_keywords: 
  - "URL 액세스 [Reporting Services]"
  - "링크 [Reporting Services], URL 액세스"
  - "URL 액세스 [Reporting Services], URL 액세스 정보"
  - "매개 변수 [Reporting Services], URL 액세스"
  - "보고서 서버 [Reporting Services], URL 액세스"
  - "하이퍼링크 [Reporting Services]"
