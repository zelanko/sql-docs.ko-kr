...
![보고서 작성기 세로 막대형 차트를 보여 주는 스크린샷](../reporting-services/media/report-builder-column-chart-tutorial.png)    
> [!NOTE]  
...
6.  **Finish** 를 클릭합니다.  
    ...
    ![디자인 뷰에서 보고서 작성기 세로 막대형의 스크린샷](../reporting-services/media/report-builder-column-chart-1-design-view.png)
  
7.  차트를 클릭하여 차트 핸들을 표시합니다. 차트의 오른쪽 아래 모퉁이를 끌어 차트의 크기를 늘립니다. 보고서 디자인 화면이 차트 크기에 맞게 늘어납니다.  
  
8.  **실행** 을 클릭하여 보고서를 미리 봅니다.  

    ![보고서 작성기 세로 막대형 차트의 미리 보기를 보여 주는 스크린샷](../reporting-services/media/report-builder-column-chart-1-preview.png)
...
![날짜 형식을 표시하는 보고서 작성기 세로 막대형 차트의 스크린샷](../reporting-services/media/report-builder-column-chart-2-preview.png)
...
8.  [!INCLUDE[clickOK](../includes/clickok-md.md)]  
    ...
    ![디자인 뷰에서 X축 텍스트가 회전된 보고서 작성기 세로 막대형 차트의 스크린샷](../reporting-services/media/report-builder-column-chart-rotate-x-axis.png)
  
9. **실행** 을 클릭하여 보고서를 미리 봅니다.  
  
차트에서 레이블이 회전합니다.  

![X축 텍스트가 회전된 보고서 작성기 세로 막대형 차트의 미리 보기를 보여 주는 스크린샷](../reporting-services/media/report-builder-column-chart-rotate-x-axis-preview.png)
...
12. **실행** 을 클릭하여 보고서를 미리 봅니다.  
    ...
    ![Y축 레이블이 올바르게 지정된 보고서 작성기 세로 막대형 차트 형식의 미리 보기를 보여 주는 스크린샷](../reporting-services/media/report-builder-column-chart-format-y-axis.png)
...
3. 속성 창에서 LabelInterval을 1로 설정합니다.
    ...
    ![보고서 작성기 세로 막대형 차트의 레이블 간격을 설정하는 방법을 보여 주는 스크린샷](../reporting-services/media/report-builder-column-chart-set-label-interval.png)

    차트는 디자인 뷰에서 동일하게 보입니다. 
    
5.  **실행** 을 클릭하여 보고서를 미리 봅니다.

    ![레이블 간격이 1로 설정된 보고서 작성기 세로 막대형 차트의 미리 보기를 보여 주는 스크린샷](../reporting-services/media/report-builder-column-chart-label-interval-one-preview.png)
...
3.  **값** 영역에서 **[Sum(Sales)]** 필드를 마우스 오른쪽 단추로 클릭하고 **계산된 계열 추가** 를 클릭합니다.  
     ...
     ![보고서 작성기 세로 막대형 차트에 계산된 계열을 추가하는 방법을 보여 주는 스크린샷](../reporting-services/media/report-builder-column-chart-add-calculated-series.png)
...
![이동 평균을 보여 주는 보고서 작성기 세로 막대형 차트의 스크린샷](../reporting-services/media/report-builder-column-chart-moving-average.png)
