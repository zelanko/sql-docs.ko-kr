---
title: "Reporting Services에서 서버 및 데이터베이스 연결 문제 해결 | Microsoft Docs"
ms.custom: ""
ms.date: "02/28/2016"
...
---
# Reporting Services에서 서버 및 데이터베이스 연결 문제 해결
...
## Management Studio에서 보고서 서버에 연결할 때의 WMI 오류  
...
## 보고서 서버에서 보고서 서버 데이터베이스에 연결할 수 없습니다. 합니다(rsReportServerDatabaseUnavailable).  
...
## SharePoint 중앙 관리에서 데이터베이스 액세스 권한을 부여할 수 없습니다.  
...
## MSCS(Microsoft Cluster Services) 클러스터에서 실행되는 가상 SQL Server에 보고서 서버 데이터베이스를 생성할 경우 /reports 및 /reportsserver 디렉터리에 연결할 수 없음  
