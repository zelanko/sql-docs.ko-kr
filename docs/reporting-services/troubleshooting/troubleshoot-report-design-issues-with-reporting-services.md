...
## 두 테이블 또는 한 차트와 한 테이블을 나란히 표시하도록 디자인하는 방법  
...
### 렌더링 규칙에서 페이지 크기, 컨테이너, 피어 개체, 상대 위치 및 공백을 사용하여 레이아웃을 결정  
