...
## <a name="1c-organize-drillthrough-report-data-into-groups"></a><a name="DLayout"></a>1c. 드릴스루 보고서 데이터를 그룹으로 구성  
...
## <a name="1d-add-drillthrough-report-subtotals-and-totals"></a><a name="DTotals"></a>1d. 드릴스루 보고서 부분합 및 합계 추가  
...
## <a name="5-set-hidden-parameter-property"></a><a name="DParameter"></a>5. 숨겨진 매개 변수 속성 설정  
...
## <a name="1a-add-embedded-data-source"></a><a name="MConnection"></a>1a. 포함된 데이터 원본 추가  
...
## <a name="1b-create-embedded-dataset"></a><a name="MMDXQuery"></a>1b. 포함된 데이터 세트 만들기  
...
## <a name="1c-organize-main-report-data-into-groups"></a><a name="MLayout"></a>1c. 주 보고서 데이터를 그룹으로 구성  
데이터를 그룹화할 필드를 선택할 때 세부 데이터와 집계 데이터가 표시되는 행과 열이 포함된 행렬을 디자인합니다.  
...
## <a name="1d-add-main-report-subtotals-and-totals"></a><a name="MTotals"></a>1d. 주 보고서 부분합 및 합계 추가  
...
## <a name="5-set-internal-parameter-property"></a><a name="MParameter"></a>5. 내부 매개 변수 속성 설정  
