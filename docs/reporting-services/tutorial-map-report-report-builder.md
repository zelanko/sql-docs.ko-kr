...
![보고서 작성기 지도를 보여 주는 스크린샷](../reporting-services/media/report-builder-map-final-map-only.png)
...
이 자습서에서는 Bing 지도를 배경으로 지원하도록 보고서 서버를 구성해야 합니다. 자세한 내용은 [지도 보고서 지원 계획](./report-design/plan-a-map-report-report-builder-and-ssrs.md)을 참조하세요. 
...
6.  지도 갤러리 상자의 **USA** 에서 **States by County** 를 확장하고 **New York** 을 클릭합니다.  
    ...
    ![새 지도 마법사에서 지도 갤러리 섹션에서 뉴욕이 호출된 새 지도 마법사의 공간 데이터 원본 선택 단계를 보여 주는 스크린샷](../reporting-services/media/report-builder-map-ny-counties.png)
...
13. **데이터 필드** 드롭다운 목록에서 **#COUNTYNAME** 을 클릭합니다. 마법사의 지도 미리 보기 창에 다음 항목이 표시됩니다.  
    ...
    ![새 지도 마법사의 색 테마 및 데이터 시각화 선택 단계 스크린샷](../reporting-services/media/report-builder-map-choose-color-theme.png)
...
17. **홈** 탭 > **실행** 을 선택하여 보고서를 미리 봅니다.  
    ...
    ![새로 만든 보고서 작성기 지도의 미리 보기를 보여 주는 스크린샷](../reporting-services/media/report-builder-map-first-preview.png)
...
2.  지도를 두 번 클릭하여 **지도 계층** 창을 표시합니다. 도구 모음에서 **새 계층 마법사** 단추 ![rs_IconMapLayerWizard](../reporting-services/media/rs-iconmaplayerwizard.gif "rs_IconMapLayerWizard")를 클릭합니다. 
    ...
    ![새 계층 마법사 아이콘이 호출된 지도 계층 창을 보여 주는 스크린샷](../reporting-services/media/report-builder-map-new-layer-wizard-icon.png) 
...
9. 쿼리 디자이너 도구 모음에서 **실행** ( **!** )을 클릭합니다.  
    ...
    *   **SpatialLocation** : 경도 및 위도 위치입니다. 
    ...
    ![새 지도 계층 마법사의 쿼리 디자인 단계 스크린샷](../reporting-services/media/report-builder-map-design-query.png) 
...
21. **지도 계층 창** 에서 PointLayer1 옆의 화살표를 클릭한 다음 **점 속성** 을 클릭합니다.  
    ...
    ![점 속성 옵션을 보여 주는 지도 계층 창의 스크린샷](../reporting-services/media/report-builder-map-point-properties.png)
  
22. **글꼴** 탭에서 스타일을 **굵게** , 크기를 **10pt** 로 지정합니다.

    ![지도 점 속성 대화 상자의 글꼴, 크기 및 색 옵션 변경 섹션을 보여 주는 스크린샷](../reporting-services/media/report-builder-map-point-properties-font.png)
...
24. **실행** 을 클릭하여 보고서를 미리 봅니다.  
    ...
    ![도시 이름이 10포인트 글꼴로 굵게 표시된 보고서 작성기 지도의 미리 보기를 보여 주는 스크린샷](../reporting-services/media/report-builder-map-city-names.png)
...
14. **Finish** 를 클릭합니다.  
    ...
    ![선 계층이 있는 보고서 작성기 지도를 보여 주는 스크린샷](../reporting-services/media/report-builder-map-line.png)
...
15. **보기** 섹션을 확장한 다음 **확대/축소** 속성을 볼 수 있도록 **보기** 를 확장합니다. **125** 로 설정합니다. 
    ...
    ![보고서 작성기 지도의 확대/축소를 조정하는 방법을 보여 주는 스크린샷](../reporting-services/media/report-builder-map-zoom.png)
...
5.  **일반** 탭의 **유형** 에서 **위성** 을 선택합니다. 항공 보기에는 텍스트가 포함되지 않습니다.  
    ...
    ![보고서 작성기 지도에 추가된 Bing 지도 항공 타일 계층을 보여 주는 스크린샷](../reporting-services/media/report-builder-map-bing-aerial.png)
...
6.  [!INCLUDE[clickOK](../includes/clickok-md.md)]  
    ...
    ![보고서 작성기 지도 계층의 투명도를 설정하는 방법을 보여 주는 스크린샷](../reporting-services/media/report-builder-map-transparency.png)
...
8.  **분석 데이터 세트 필드** 에서 [County]를 클릭합니다.  
    ...
    ![지도 다각형 계층 속성 대화 상자의 분석 데이터 탭을 보여 주는 스크린샷](../reporting-services/media/report-builder-map-county-colors.png)
  
9. [!INCLUDE[clickOK](../includes/clickok-md.md)]  
  
10. 보고서를 미리 봅니다.  

    ![특정 군이 강조 표시된 보고서 작성기 지도의 미리 보기를 보여 주는 스크린샷](../reporting-services/media/report-builder-map-county-highlight.png)
...
7.  **마지막 색** 을 **녹색** 으로 변경합니다.  
    ...
    **빨강** 은 낮은 판매량 값을 나타내고, **노랑** 은 중간 판매량 값을 나타내며, **녹색** 은 높은 판매량 값을 나타냅니다. 보고서 처리기는 이러한 값과 **분포** 페이지에서 선택한 옵션에 따라 색의 범위를 계산합니다.  
    ...
    ![지도 색 규칙 속성 대화 상자의 다각형 색 규칙 변경 섹션을 보여 주는 스크린샷](../reporting-services/media/report-builder-map-county-color-rules.png)
...
15. 보고서를 미리 봅니다.
    ...
    ![특정 색 규칙이 적용된 보고서 작성기 지도 군의 미리 보기를 보여 주는 스크린샷](../reporting-services/media/report-builder-map-county-color-rule-preview.png)
...
3. TextColor 속성을 **흰색** 으로 변경합니다.  
    ...
    ![범례의 제목을 구성하는 방법을 보여 주는 스크린샷](../reporting-services/media/report-builder-map-color-scale-title.png)
...
3.  PolygonLayer1에서 아래쪽 화살표를 클릭한 다음 **다각형 속성** 을 클릭합니다. 
     ...
     ![다각형 속성 옵션 선택 방법을 보여 주는 스크린샷](../reporting-services/media/report-builder-map-polygon-layer-properties.png)
...
5.  점을 추가할 지도의 위치를 클릭합니다. 이 자습서에서는 Oneida 군의 위치를 클릭합니다. 원으로 표시된 점이 계층의 클릭한 지점에 추가됩니다. 기본적으로 점이 선택됩니다.  
    ...
    ![보고서 작성기 지도에 사용자 지정 점을 추가하는 방법을 보여 주는 스크린샷](../reporting-services/media/report-builder-map-custom-point.png)
...
7.  **이 계층의 점 옵션 무시** 를 선택합니다. 추가 페이지가 대화 상자에 나타납니다. 여기서 설정한 값은 계층 또는 색 규칙에 대한 표시 옵션보다 우선합니다.  
    ...
    ![지도 포함 점 속성 대화 상자의 포함 점 옵션 변경 섹션을 보여 주는 스크린샷](../reporting-services/media/report-builder-map-custom-point-general.png)
...
13. **글꼴** 탭에서 글꼴 크기를 **10pt** , 스타일을 **굵게** 로 지정합니다.
    ...
    ![지도 포함 점 속성 대화 상자의 글꼴, 크기 및 색 옵션 변경 섹션을 보여 주는 스크린샷](../reporting-services/media/report-builder-map-custom-point-font.png)
...
![사용자 지정 점 새 저장소가 호출된 보고서 작성기 지도의 미리 보기를 보여 주는 스크린샷](../reporting-services/media/report-builder-map-custom-point-new-store.png)
...
![포털에 표시된 완료된 보고서 작성기 지도를 보여 주는 스크린샷](../reporting-services/media/report-builder-map-in-portal.png) 
