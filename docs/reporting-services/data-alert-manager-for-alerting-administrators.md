---
title: "경고 담당자를 위한 데이터 경고 관리자입니다. | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|InventoryCount|StockStatusByQTR|Lauren Johnson|7|7/10/2011|7/2/2011|\<오류 메시지>로그 파일에 오류에 대한 자세한 내용이 포함되어 있습니다. 식별자가 포함된 로그 항목을 참조하십시오. \<GUID>|  
