...
description: HTML 형식으로 렌더링하는 데 사용할 수 있는 다양한 디바이스 정보 설정에 대해 알아봅니다.
ms.date: 03/16/2017
