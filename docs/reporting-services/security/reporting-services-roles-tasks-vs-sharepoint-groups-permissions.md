---
description: Reporting Services 역할-작업 vs. SharePoint 그룹-사용 권한
...
:::row:::
    :::column:::
        ...
        SharePoint 2010 및 SharePoint 2013  
    :::column-end:::
    :::column:::
...
|--------------------------------------|-----------------------|  
|**브라우저**<br /><br /> View|**방문자** 그룹을 사용하면 보고서를 볼 수 있는 권한을 부여할 수 있습니다. **방문자** 그룹에는 그룹 멤버가 페이지, 목록 항목 및 문서를 볼 수 있는 읽기 수준의 사용 권한이 있습니다.|  
