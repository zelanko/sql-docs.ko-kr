---
description: SharePoint 웹 애플리케이션에서 보고서 서버 작업에 대한 사용 권한 설정
...
-   애플리케이션 페이지 보기  
 ...
 "사용자 정보 찾아보기" 권한이 있는 경우 보고서 서버는 항목의 작성자 및 항목을 마지막으로 수정한 사용자에 대한 정보를 반환할 수 있습니다. 이 사용 권한이 없는 경우 보고서 서버는 다음 오류를 반환합니다. 찾아보기 작업의 경우 "보고서 서버에 SharePoint 오류가 발생했습니다. ---> System.UnauthorizedAccessException: 액세스가 거부되었습니다."라는 오류가 반환됩니다. 게시 작업의 경우 오류는 다음과 같습니다. "사용자 '\<domain>\\<user\>'에게 부여된 권한으로는 이 작업을 수행할 수 없습니다."  
