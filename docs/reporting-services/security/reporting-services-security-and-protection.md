...
# <a name="reporting-services-security-and-protection"></a>Reporting Services 보안 및 보호
  보안 기능에 대해 자세히 알아보려면이 섹션의 정보를 사용할 수 있습니다 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]합니다. [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]에서 지원되는 권한 부여 모델 및 인증 공급자에 대해서도 설명합니다.  
...
## <a name="authentication-and-authorization"></a>인증 및 권한 부여  
 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]사용자와 보고서 서버에 인증 하도록 클라이언트 응용 프로그램에 대 한 여러 인증 유형을 제공 합니다. 보고서 서버에 맞는 인증 유형을 사용하면 조직에서 요구되는 적합한 수준의 보안을 확보할 수 있습니다. 자세한 내용은 [Authentication with the Report Server](../../reporting-services/security/authentication-with-the-report-server.md)을(를) 참조하세요.  
  
 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]또한 역할 및 내용 (즉, 부분, 액세스할 수 있는 사용자 및 감사자로 액세스할 수 어떻게) 보고서 서버 카탈로그에 대 한 사용자 액세스 제어 권한을 사용 합니다. 자세한 내용은 [역할 및 사용 권한&#40;Reporting Services&#41;](../../reporting-services/security/roles-and-permissions-reporting-services.md)을 참조하세요.  
