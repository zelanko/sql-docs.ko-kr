...
ms.topic: "article"
helpviewer_keywords: 
  - "보안 [Reporting Services], 보고서"
  - "보안 [Reporting Services], 리소스"
  - "보고서 [Reporting Services], 보안"
  - "기밀 보고서 [Reporting Services]"
  - "리소스 [Reporting Services], 보안"
...
## 게시된 보고서 또는 문서의 HTML 삽입 공격 위험 완화  
...
## 게시된 보고서 또는 문서의 하이퍼링크를 이용한 스크립트 삽입 공격 위험 완화  
...
## 매개 변수가 있는 보고서의 SQL 삽입 공격 위험 완화  
