---
description: 보고서 서버 항목에 대해 Windows SharePoint Services의 기본 제공 보안 사용
...
|**SharePoint 그룹**|**권한 수준**|**요약**|**보고서 서버 액세스**|  
|---------------------------|--------------------------|-----------------|------------------------------|  
