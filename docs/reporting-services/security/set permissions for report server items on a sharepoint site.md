---
title: "SharePoint 사이트의 보고서 서버 항목에 대한 사용 권한 설정(SharePoint 통합 모드의 Reporting Services) | Microsoft Docs"
ms.custom: ""
ms.date: "12/09/2016"
...
manager: "erikre"
---
# SharePoint 사이트의 보고서 서버 항목에 대한 사용 권한 설정(SharePoint 통합 모드의 Reporting Services)
...
### 개별 보고서, 모델 또는 데이터 원본에 대한 사용 권한을 설정하려면  
