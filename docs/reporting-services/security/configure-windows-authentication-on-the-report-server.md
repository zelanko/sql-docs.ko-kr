---
title: "보고서 서버의 Windows 인증 구성 | Microsoft Docs"
ms.custom: ""
ms.date: "08/26/2016"
...
### Windows 통합 보안을 사용하도록 보고서 서버를 구성하려면  
...
-   서비스 계정이 네트워크 서비스와 같은 기본 제공 계정으로 실행되도록 변경합니다. 기본 제공 계정은 컴퓨터를 네트워크에 조인할 때 정의한 Host SPN에 HTTP SPN을 매핑합니다. 자세한 내용은 [서비스 계정 구성&#40;SSRS 구성 관리자&#41;](../Topic/Configure%20a%20Service%20Account%20\(SSRS%20Configuration%20Manager\).md)을 참조하세요.  
...
##### Reporting Services 서비스 계정에 대해 Active Directory에서 구성된 SPN  
...
#### 브라우저가 Negotiated Kerberos 또는 Negotiated NTLM을 선택하는 방법  
