---
title: "보고서 서버에서 기본 인증 구성 | Microsoft Docs"
ms.custom: 
ms.date: 08/26/2016
...
1.  텍스트 편집기에서 RSReportServer.config를 엽니다.  
     ...
     파일은  *\<드라이브 >:*files\microsoft SQL Server\MSRS13 합니다. MSSQLSERVER\Reporting Services\ReportServer입니다.  
...
5.  에 대 한 빈 값을 대체 \< **영역**> 또는 \< **DefaultDomain**> 환경에 대 한 유효한 값을 사용 합니다.  
