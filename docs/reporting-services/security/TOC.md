...
## [웹 포털에서 사용자 지정 인증 쿠키를 전달하도록 구성](configure-the-web-portal-to-pass-custom-authentication-cookies.md)  
# [역할 및 사용 권한](roles-and-permissions-reporting-services.md)  
## [보고서 서버에 사용자 액세스 권한 부여](grant-user-access-to-a-report-server.md)  
...
### [작업 및 사용 권한 - 항목 수준의 작업](tasks-and-permissions-item-level-tasks.md)  
### [작업 및 사용 권한 - 시스템 수준의 작업](tasks-and-permissions-system-level-tasks.md)  
### [역할 할당 만들기 및 관리](create-and-manage-role-assignments.md)  
### [보안 폴더](secure-folders.md)  
### [보고서 및 리소스 보안](secure-reports-and-resources.md)  
### [공유 데이터 원본 항목 보안](secure-shared-data-source-items.md)  
### [공유 데이터 집합 항목 보안](secure-shared-dataset-items.md)  
### [내 보고서 보안](secure-my-reports.md)  
...
### [역할 정의 - 미리 정의된 역할](role-definitions-predefined-roles.md)  
