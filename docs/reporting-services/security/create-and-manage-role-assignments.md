...
## 항목 수준 역할 할당 만들기  
 ...
 자세한 내용은 [사용자에게 보고서 서버에 대한 액세스 권한 부여&#40;보고서 관리자&#41;](../../reporting-services/security/grant-user-access-to-a-report-server-report-manager.md)를 참조하세요.  
...
## 시스템 수준 역할 할당 만들기  
 ...
 자세한 내용은 [사용자에게 보고서 서버에 대한 액세스 권한 부여&#40;보고서 관리자&#41;](../../reporting-services/security/grant-user-access-to-a-report-server-report-manager.md) 및 [미리 정의된 역할](../../reporting-services/security/predefined-roles.md)을 참조하세요.  
