...
description: Reporting Services의 보고서 서버 추적 로그에 대해 알아봅니다. 이 로그에는 보고서 서버 서비스 작업에 대한 세부 정보가 포함됩니다.
...
|구성 요소 범주에 대한 **추적 수준** 값|\<component category>:\<tracelevel><br /><br /> <br /><br /> 구성 요소에 추적 수준을 추가하지 않으면 **DefaultTraceSwitch** 에 대해 지정된 값이 사용됩니다. 예를 들어 "all,RunningJobs,SemanticQueryEngine,SemanticModelGenerator"를 지정하면 모든 구성 요소에서 기본 추적 수준을 사용합니다.|유효한 추적 수준 값은 다음과 같습니다.<br /><br /> <br /><br /> 0= 추적 해제<br /><br /> 1= 예외 및 다시 시작<br /><br /> 2= 예외, 다시 시작, 경고<br /><br /> 3= 예외, 다시 시작, 경고, 상태 메시지(기본값)<br /><br /> 4= 세부 정보 표시 모드<br /><br /> 보고서 서버의 기본값은 "all:3"입니다.|  
