...
helpviewer_keywords: 
  ...
  - "보고서 처리 [Reporting Services], 캐싱"
  - "캐시된 인스턴스 [Reporting Services]"
  - "캐시 새로 고침"
  - "캐시된 보고서 [Reporting Services]"
  - "캐시 사전 로드"
  - "잘못된 캐시된 보고서 [Reporting Services]"
  - "성능 [Reporting Services]"
  - "만료 [Reporting Services]"
  - "스냅숏 [Reporting Services], 캐싱"
...
## 관련 항목:  
 ...
 [캐시 새로 고침 옵션&#40;보고서 관리자&#41;](../Topic/Cache%20Refresh%20Options%20\(Report%20Manager\).md)  
