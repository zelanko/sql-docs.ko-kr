...
ms.topic: "article"
helpviewer_keywords: 
  - "문제 해결 [Reporting Services], 로그 파일"
  - "로그 [Reporting Services]"
  - "로그 [Reporting Services], 로그 파일 정보"
  - "보고서 서버 [Reporting Services], 로그 파일"
  - "보고서 서버 로그 파일"
  - "파일 [Reporting Services], 로그"
