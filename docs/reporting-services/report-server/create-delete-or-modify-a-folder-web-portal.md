---
title: 만들기, 삭제 또는 Reporting Services 폴더-수정 | Microsoft Docs
ms.date: 06/26/2019
...
---
# <a name="create-delete-or-modify-a-folder---reporting-services"></a>만들기, 삭제 또는 Reporting Services는 폴더를 수정 합니다.
...
2. 폴더 또는 하위 폴더를 새 폴더를 찾아 이동 합니다. 선택 합니다 **홈** 선택 하 여 폴더를 **찾아보기** 맨 위에 있는 도구 모음에서 폴더 계층의 맨 위에 있는 만들려면 페이지의 왼쪽.  
  
3. 선택 된 **새로 만들기** 한 다음 선택한 보고서 서버 도구 모음 오른쪽 맨 위의 단추를 **폴더** 드롭 다운 메뉴에서.  
  
4. 에 **(현재 폴더 이름)에 새 폴더를 만듭니다** 대화 상자에서 만들 새 폴더의 이름을 입력 합니다. 폴더 이름에 공백이 포함될 수 있지만 \; \?와 같은 URL 인코딩용으로 사용되는 문자는 포함될 수 없습니다. \: \@ \& \= \+ \, \$ \/ \* \< \> \|. 또한 한 번에 일련의 폴더 이름을 입력하여 여러 폴더를 만들 수는 없습니다.  
  
5. 선택 **만들기** 여 작업을 완료 합니다.  
  
## <a name="to-delete-a-folder"></a>폴더를 삭제하려면  
  
1. 웹 포털에서 폴더 계층을 탐색 하 고 삭제 하려는 폴더를 찾습니다.  
  
2. 오른쪽 클릭의 폴더를 선택한 **삭제** 드롭 다운 메뉴에서.  
  
3. 선택 합니다 **삭제할** 단추를 **삭제 <foldername>**  삭제 확인 대화 상자.  
  
## <a name="to-modify-a-folders-properties"></a>폴더의 속성을 수정 하려면  
  
1. 웹 포털에서 폴더 계층을 탐색 하 고 삭제 하려는 폴더를 찾습니다.  
  
2. 오른쪽 클릭의 폴더를 선택한 **삭제** 드롭 다운 메뉴에서.  
  
3. **속성** 탭을 선택합니다. 합니다 **속성** 페이지는 기본적으로 표시 됩니다.  
  
4. 폴더의 이름을 변경할 수 있습니다 합니다 *이름을** 텍스트 상자에 붙여넣습니다.  
  
5. 추가 하거나 폴더에 대 한 설명을 변경할 수 있습니다 합니다 *설명을** 텍스트 상자에 붙여넣습니다.  
  
6. 숨길 수 있습니다 또는 숨기기를 취소 폴더를 확인 하 여 선택 하거나 선택 취소 합니다 **이 항목을 숨기려면** 확인란을 각각.  
  
7. 선택 **적용** 속성 변경 내용을 저장 합니다.  
  
8. 이동 하거나 선택 하 여 폴더를 삭제할 수는 필요에 따라 합니다 **이동** 또는 **삭제** 맨 위에 있는 단추를 **속성** 페이지입니다. 참조를 [(웹 포털) 항목을 삭제 또는 이동](../../reporting-services/report-server/move-or-delete-an-item-report-manager.md) 자세한 문서.  
