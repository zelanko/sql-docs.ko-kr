...
1. 보고서 관리자에서 **내용** 페이지로 이동하고 기록을 보려는 항목을 마우스로 가리킨 다음 줄임표(...)를 클릭합니다.

2. 드롭다운 메뉴에서 **보고서 기록 보기**를 클릭합니다.  

3. 클릭 **새 기록 스냅숏**합니다. 새 스냅숏이 생성 되어 나열 됩니다.

    > [!NOTE]  
    > 이를 위해 관리자는 보고서 기록을 **수동으로 기록 작성 허용**상태로 구성해야 합니다. 자세한 내용은 [보고서 기록 제한&#40;보고서 관리자&#41;](../../reporting-services/reports/limit-report-history-report-manager.md)를 클릭합니다.
...
- [열기 및 닫기 보고서 &#40;보고서 관리자&#41;](../../reporting-services/reports/open-and-close-a-report-report-manager.md)- [보고서 기록을 제한 &#40;보고서 관리자&#41;](../../reporting-services/reports/limit-report-history-report-manager.md)
