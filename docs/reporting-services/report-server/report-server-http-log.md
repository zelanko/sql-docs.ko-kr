...
description: Reporting Services를 설치한 후 보고서 서버 HTTP 로그를 사용하도록 설정하는 방법을 알아봅니다. 이 기능은 보고서 서버에서 처리하는 모든 HTTP 요청 및 응답을 기록합니다.
ms.date: 06/12/2019
...
|호스트|호스트 헤더의 내용입니다.|예|  
|방법|클라이언트에서 호출된 동작 또는 SOAP 메서드입니다.|예|  
