...
# <a name="reporting-services-report-server-native-mode"></a>Reporting Services 보고서 서버(기본 모드)
 ...
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] 또는 웹 포털 중 하나를 사용하여 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 보고서를 관리할 수 있습니다. [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 구성 관리자를 사용하여 기본 모드에서 보고서 서버를 관리할 수 있습니다.  
