---
title: "보고서 및 공유 데이터 집합 처리에 대한 제한 시간 값 설정(SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "제한 시간 [Reporting Services]"
  - "쿼리 제한 시간 [Reporting Services]"
  - "보고서 처리 [Reporting Services], 제한 시간"
  - "보고서 실행 제한 시간 [Reporting Services]"
...
---
# 보고서 및 공유 데이터 집합 처리에 대한 제한 시간 값 설정(SSRS)
