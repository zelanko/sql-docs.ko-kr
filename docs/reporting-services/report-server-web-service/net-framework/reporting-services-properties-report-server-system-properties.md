...
|SnapshotCompression|스냅숏의 압축 방식을 정의합니다. 기본값은 **SQL**입니다. 유효한 값은 다음과 같습니다.<br /><br /> **SQL** = 보고서 서버 데이터베이스에 저장될 때 스냅숏이 압축됩니다. 이것은 현재 동작입니다.<br /><br /> **None =** 스냅숏이 압축되지 않습니다.<br /><br /> **All** = 보고서 서버 데이터베이스, 파일 시스템을 포함한 모든 스토리지 옵션에 대해 스냅숏이 압축됩니다.|  
