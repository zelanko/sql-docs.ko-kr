...
|[웹 서비스 메서드 인수를 제공합니다.](../../../reporting-services/report-server-web-service/net-framework/supplying-web-service-method-arguments.md)|웹 서비스 메서드를 호출하고 메서드 인수를 제공하는 방법을 설명합니다.|  
|[선택적 웹 서비스 개체에 대 한 값을 생략 하는 것입니다.](../../../reporting-services/report-server-web-service/net-framework/omitting-values-for-optional-web-service-objects.md)|선택적 웹 서비스 개체에 대한 값을 생략하는 방법을 설명합니다.|  
|[보안 웹 서비스 메서드를 사용 하 여](../../../reporting-services/report-server-web-service/net-framework/using-secure-web-service-methods.md)|설명의 **SecureConnectionLevel** 설정 및 Reporting Services SOAP API의 사용 중인 적용 하는 방법입니다.|  
