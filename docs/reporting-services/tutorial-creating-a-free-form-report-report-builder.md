...
6.  행 그룹 창에서 **세부 정보** 그룹을 마우스 오른쪽 단추로 클릭 > **그룹 삭제**를 클릭합니다.  
...
2.  사각형을 마우스 오른쪽 단추로 클릭 > **사각형 속성**을 클릭합니다.  
...
22. `[Sales]` 필드만 선택하고 필드를 마우스 오른쪽 단추로 클릭 > **식**을 클릭합니다.  
...
29. `[Sum(Sales)]` 선택한 상태로 **홈** 탭 > **숫자** 그룹 > **통화**를 클릭합니다.  
...
12. 테이블을 선택한 상태로 **행 그룹** 창에서 **세부 정보**를 마우스 오른쪽 단추로 클릭 > **합계 추가** > **다음 이후**를 클릭합니다.  
...
2.  두 차트를 모두 선택한 상태로 마우스 오른쪽 단추를 클릭 > **레이아웃** > **같은 너비로**를 클릭합니다.  
