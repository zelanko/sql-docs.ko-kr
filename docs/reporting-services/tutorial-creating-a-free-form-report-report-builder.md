...
description: 뉴스레터로 사용되고 각 페이지에 정적 텍스트, 요약 시각적 개체 및 샘플 판매 데이터가 표시되는 페이지를 매긴 보고서를 만드는 방법을 알아봅니다.
ms.date: 09/02/2016
...
![보고서 작성기 자유 형식 보고서의 스크린샷](../reporting-services/media/report-builder-free-form-report-complete.png)
...
7.  **실행** 아이콘(!)을 클릭하여 쿼리를 실행합니다.  
    ...
    ![보고서 작성기 자유 형식 보고서에 표시할 수 있는 데이터를 보여 주는 쿼리 디자이너의 스크린샷](../reporting-services/media/report-builder-free-form-tutorial-data.png) 
...
2.  목록 상자 안을 클릭하고 목록 맨 위의 막대를 마우스 오른쪽 단추로 클릭한 다음 **테이블릭스 속성** 을 클릭합니다.  
    ...
    ![보고서 작성기 자유 형식 보고서의 테이블릭스 속성 옵션을 보여 주는 스크린샷](../reporting-services/media/report-builder-free-form-tablix-properties.png) 
...
1.  행 그룹 창에서 세부 정보 그룹을 마우스 오른쪽 단추로 클릭하고 **그룹 추가** 를 가리킨 다음 **부모 그룹** 을 클릭합니다.  
    ...
    ![보고서 작성기 자유 형식 보고서에 부모 그룹을 추가하는 방법을 보여 주는 스크린샷](../reporting-services/media/report-builder-free-form-add-parent-group.png)  
...
4.  목록에서 Territory 열을 마우스 오른쪽 단추로 클릭한 다음 **열 삭제** 를 클릭합니다.  
    ...
    ![보고서 작성기 자유 형식 보고서에서 열을 삭제하는 방법을 보여 주는 스크린샷](../reporting-services/media/report-builder-free-form-delete-columns.png)
...
![연한 회색 사각형으로 구성된 세로 그래픽을 보여 주는 보고서 작성기의 스크린샷](../reporting-services/media/report-builder-free-form-gray-rectangle.png)
...
4.  보고서 데이터 창의 ListDataSet에서 `[Territory]` 필드를 입력란으로 끌어 "Newsletter for" 뒤에 놓습니다.  
    ...
    ![Territory 필드를 보고서 작성기 자유 형식 보고서로 끄는 방법을 보여 주는 스크린샷](../reporting-services/media/report-builder-free-form-territory-field.png)
...
24. [!INCLUDE[clickOK](../includes/clickok-md.md)]  
    ...
    ![보고서 작성기 자유 형식 보고서의 텍스트 상자를 보여 주는 스크린샷](../reporting-services/media/report-builder-free-form-text-box.png)
...
31. 목록 상자를 선택합니다. 두 개의 양방향 화살표를 선택하고 페이지의 맨 위로 이동합니다.  
    ...
    ![보고서 작성기 자유 형식 보고서에서 목록을 끄는 방법을 보여 주는 스크린샷](../reporting-services/media/report-builder-drag-list.png)
  
32. **실행** 을 클릭하여 보고서를 미리 봅니다.  
  
보고서에 정적 테스트가 표시되고 각 보고서 페이지에 지역과 관련된 데이터가 포함됩니다. Sales의 서식이 통화로 지정됩니다.  
  
![보고서 작성기 자유 형식 보고서에서 뉴스레터 페이지의 미리 보기를 보여 주는 스크린샷](../reporting-services/media/report-builder-newsletter-page-preview.png)
...
2.  **데이터 세트 선택** 페이지에서 **ListDataset** > **다음** 을 클릭합니다.  
...
12. 테이블을 선택한 상태로 **행 그룹** 창에서 **세부 정보** > **합계 추가** > **다음 이후** 를 마우스 오른쪽 단추로 클릭합니다.  
    ...
    ![보고서 작성기 자유 형식 보고서에 합계를 추가하는 방법을 보여 주는 스크린샷](../reporting-services/media/report-builder-free-form-table-totals.png)
  
13. Product 열의 셀을 선택하고 **Total** 을 입력합니다.

    ![합계가 입력된 Product 열의 셀 스크린샷](../reporting-services/media/report-builder-free-form-type-total.png)
...
![보고서 작성기 자유 형식 보고서에서 테이블의 미리 보기를 보여 주는 스크린샷](../reporting-services/media/report-builder-free-form-with-table.png)
...
16. 필요한 경우 마우스를 끌어 차트 영역의 높이를 늘립니다.
     ...
     ![보고서 작성기 자유 형식 보고서에 추가할 원형 차트를 보여 주는 스크린샷](../reporting-services/media/report-builder-free-form-pie.png)
...
15. 범례를 마우스 오른쪽 단추로 클릭한 다음 **범례 삭제** 를 클릭합니다.  
    ...
    ![보고서 작성기 자유 형식 보고서에 추가할 세로 막대형 차트를 보여 주는 스크린샷](../reporting-services/media/report-builder-free-form-column.png)
...
1.  이 단원의 앞부분에서 만들어 차트를 추가한 사각형을 선택합니다.  
    ...
    ![보고서 작성기 자유 형식 보고서에서 Name 속성을 보는 방법을 보여 주는 스크린샷](../reporting-services/media/report-builder-free-form-rectangle-name.png) 
  
2.  원형 차트를 클릭합니다.  
  
3.  **속성** 창에서 **Parent** 속성에 사각형의 이름이 포함되는지 확인합니다.  
  
     ![보고서 작성기 자유 형식 보고서에서 Parent 속성을 보는 방법을 보여 주는 스크린샷](../reporting-services/media/report-builder-free-form-pie-parent.png) 
...
쿼리 디자이너에 대한 자세한 내용은 [쿼리 디자인 도구(SSRS)](report-data/query-design-tools-ssrs.md) 및 [텍스트 기반 쿼리 디자이너 사용자 인터페이스&#40;보고서 작성기&#41;](../reporting-services/report-data/text-based-query-designer-user-interface-report-builder.md)를 참조하세요.  
