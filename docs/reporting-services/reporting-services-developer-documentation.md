...
## <a name="in-this-section"></a>섹션 내용  
 ...
 [ASP.net 및 기존 응용 프로그램용 보고서 서버 웹 서비스](../reporting-services/report-server-web-service/report-server-web-service.md)  
 ...
 [최신 응용 프로그램용 REST API를 사용하여 개발](developer/rest-api.md)</br>
