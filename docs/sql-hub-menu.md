        ...
        <ul class="pivots">
            <li>
                ...
                <ul id="products">
                         ...
                         <ul id="products-sql-server" class="cardsC">
                            <li class="fullSpan">
                                <div class="container intro">
                                    <p>확장 가능한 하이브리드 데이터베이스 플랫폼을 사용하여 중요 업무용 지능형 응용 프로그램을 빌드합니다. 메모리 내 성능 및 고급 보안부터 데이터베이스 내 분석에 이르기까지 모든 기능이 기본 제공됩니다.</p>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>새로운 기능</h3>
                                                <p>SQL Server 2016 이상의 새로운 기능 및 업데이트</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>관계형 데이터베이스</h3>
                                                <p>SQL의 관계형 데이터베이스 작업을 위한 기능 및 참조</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>새로운 샘플</h3>
                                                <p>Wide World Importers 데이터베이스</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>SQL Server Management Studio 자습서</h3>
                                                <p>SQL Server Management Studio 사용 방법에 대한 자세한 정보</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Transact-SQL 자습서</h3>
                                                <p>Transact-SQL 문을 작성하는 방법에 대한 자세한 정보</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <li>
                        <a href="#products-sql-server-azure">Azure VM의 SQL Server</a>
                        <ul id="products-sql-server-azure" class="cardsC">
                            <li class="fullSpan">
                                <div class="container intro">
                                    <p>SQL Server 2016 Enterprise Edition을 비롯한 SQL Server를 Azure Virtual Machines에 호스트합니다. 갤러리 이미지를 사용하거나 고유 라이선스를 가져옵니다. 온-프레미스 SQL Server 워크로드를 클라우드로 마이그레이션합니다.</p>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>자세한 정보</h3>
                                                <p>Azure VM의 SQL Server에 대한 자세한 정보</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>프로비전</h3>
                                                <p>Azure Portal에서 SQL Server 가상 컴퓨터 프로비전</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>마이그레이션</h3>
                                                <p>Azure 가상 컴퓨터의 SQL Server로 SQL Server 데이터베이스 마이그레이션</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>가용성 및 복구</h3>
                                                <p>Azure Virtual Machines의 SQL Server에 대한 고가용성 및 재해 복구</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>VM의 SQL Server에 대한 시나리오</h3>
                                                <p>SQL Server 가상 컴퓨터에서 다양한 비즈니스 문제를 해결하는 방법에 대한 자세한 정보</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>FAQ</h3>
                                                <p>Azure VM의 SQL Server에 대한 일반적인 질문 및 답변 확인</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>설명서</h3>
                                                <p>Azure VM의 SQL Server 설명서 다운로드</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <li>
                        <a href="/en-us/sql/linux?toc=/sql/docs/linux/toc.json">Linux의 SQL Server</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="/en-us/sql/microsoft-sql-documentation-table-of-contents">SQL 목차</a>
                    </li>
                </ul>
            </li>
            <li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>T-SQL</h3>
                                                <p><a href="https://msdn.microsoft.com/library/bb510741.aspx">시작</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>ADO.NET</h3>
                                                <p><a href="/sql/connect/ado-net/microsoft-ado-net-for-sql-server">시작</a></p>
                                                <p><a href="https://msdn.microsoft.com/library/system.data.sqlclient.aspx">API 참조</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>드라이버</h3>
                                                <p><a href="/sql/connect/sql-server-drivers">시작</a></p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>SSMS</h3>
                                                <p><a href="/azure/sql-database/sql-database-connect-query-ssms">시작</a></p>
                                                <p><a href="/sql/ssms/download-sql-server-management-studio-ssms">SQL Server Management Studio 다운로드</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>SSDT</h3>
                                                <p><a href="https://msdn.microsoft.com/library/hh272686(v=vs.103).aspx">시작</a></p>
                                                <p><a href="/sql/ssdt/download-sql-server-data-tools-ssdt">SQL Server Data Tools 다운로드</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>VS 코드 &amp; SQL 확장</h3>
                                                <p><a href="https://code.visualstudio.com/docs">시작</a></p>
                                                <p><a href="https://code.visualstudio.com/">Visual Studio 코드 다운로드</a></p>
                                                <p><a href="https://marketplace.visualstudio.com/items?itemName=ms-mssql.mssql">SQL 확장(mssql)</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>PowerShell</h3>
                                                <p><a href="/azure/powershell-install-configure">시작</a></p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure CLI 2.0</h3>
                                                <p><a href="/cli/azure/get-started/">시작</a></p>
                                                <p><a href="https://github.com/Azure/azure-cli">Azure CLI 2.0 다운로드</a></p>
                                                <p><a href="/cli/azure/">참조</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure CLI</h3>
                                                <p><a href="/azure/xplat-cli-install?toc=/azure/virtual-machines/linux/toc.json">시작</a></p>
                                                <p><a href="http://aka.ms/linux-azure-cli">Linux용 Azure CLI 다운로드</a></p>
                                                <p><a href="http://aka.ms/mac-azure-cli">Mac용 Azure CLI 다운로드</a></p>
                                                <p><a href="http://aka.ms/webpi-azure-cli">Windows용 Azure CLI 다운로드</a></p>
                                                <p><a href="https://azure.microsoft.com/documentation/articles/azure-cli-arm-commands/">참조</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <ul id="architecture">
                    <li>
                        ...
                        <ul id="architecture1" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p>Azure SQL Database로 시작하는 SQL에 대한 아키텍처 권장 사항 및 패턴입니다.</p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>다중 테넌트 SaaS 응용 프로그램</h3>
                                                    <p>Azure SQL Database의 다중 테넌트 SaaS 응용 프로그램에 대한 디자인 패턴</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>행 수준 보안</h3>
                                                    <p>Azure SQL Database에서 분할된 데이터베이스로 행 수준 보안 구현</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>재해 복구를 위한 응용 프로그램 디자인</h3>
                                                    <p>Azure SQL Database의 활성 지역 복제를 사용하여 클라우드 재해 복구를 위한 응용 프로그램 디자인</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>탄력적 풀을 사용한 재해 복구 전략</h3>
                                                    <p>Azure SQL Database의 탄력적 풀을 사용한 응용 프로그램에 대한 재해 복구 전략</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
