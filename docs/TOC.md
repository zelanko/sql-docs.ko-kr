# [관계형 데이터베이스 사용](relational-databases/database-features.md)
# [Linux의 SQL Server](./linux/index.md?toc=%2fsql%2fdocs%2flinux%2ftoc.json)
# [SQL Server에 대 한 고급 분석](advanced-analytics/getting-started-with-machine-learning-services.md)
...
# [샘플](sample/microsoft-sql-server-samples.md)
# [도구](tools/command-prompt-utility-reference-database-engine.md)
...
## [SQL Server 연결 및 데이터 드라이버](connect/sql-server-driver-documentation.md)
## [SSMS(SQL Server Management Studio)](ssms/download-sql-server-management-studio-ssms.md)
        
# [백서](whitepapers/microsoft-white-papers.md)
