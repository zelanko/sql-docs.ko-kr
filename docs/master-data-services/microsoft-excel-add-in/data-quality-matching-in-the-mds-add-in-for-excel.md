...
1.  MDS 관리 데이터 목록을 검색하여 MDS에서 관리되지 않는 목록과 결합합니다. 자세한 내용은 [데이터 결합&#40;Excel용 MDS 추가 기능&#41;](../../master-data-services/microsoft-excel-add-in/combine-data-mds-add-in-for-excel.md)을 참조하세요.  
  
2.  DQS 기술 자료를 사용하여 결합된 목록의 데이터를 비교합니다. 자세한 내용은 [유사한 데이터 일치&#40;Excel용 MDS 추가 기능&#41;](../../master-data-services/microsoft-excel-add-in/match-similar-data-mds-add-in-for-excel.md)를 참조하세요.  
