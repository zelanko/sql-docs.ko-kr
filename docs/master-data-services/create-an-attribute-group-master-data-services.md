...
3.  
  **엔터티 관리** 페이지의 표에서 해당 특성 그룹을 만들려는 엔터티의 행을 선택합니다.  
...
7.  
  **이름** 상자에 특성 그룹의 이름을 입력합니다. 이 이름은 **탐색기**의 탭에 표시됩니다.  
  
8.  특성을 추가하려면 **사용 가능한 특성** 상자에서 특성을 클릭하고 **추가** 화살표를 클릭합니다. 모든 특성을 추가하려면 **모두 추가** 화살표를 클릭합니다.  
  
9. 
  **위쪽** 및 **아래쪽** 화살표를 클릭하여 왼쪽에서 오른쪽으로 정렬되는 특성 순서를 변경합니다.  
  
10. 
  **사용 가능한 사용자** 상자에서 사용자를 클릭하고 **추가** 화살표를 클릭합니다. 모든 사용자를 추가하려면 **모두 추가** 화살표를 클릭합니다.  
  
11. 
  **사용 가능한 그룹** 상자에서 그룹을 클릭하고 **추가** 화살표를 클릭합니다. 모든 그룹을 추가하려면 **모두 추가** 화살표를 클릭합니다.  
  
12. **저장**을 클릭합니다.  
  
## <a name="next-steps"></a>다음 단계  
  
-   [특성 그룹을 사용자 &#40;MDS(Master Data Services)에 표시 되도록 설정&#41;](../master-data-services/make-an-attribute-group-visible-to-users-master-data-services.md)  
