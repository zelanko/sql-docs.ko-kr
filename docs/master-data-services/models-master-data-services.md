...
|태스크 설명|항목|  
|----------------------|-----------|  
|모델을 만들어 마스터 데이터를 구성합니다.|[모델 &#40;MDS(Master Data Services)를 만듭니다&#41;](../master-data-services/create-a-model-master-data-services.md)|  
|기존 모델의 이름을 변경합니다.|[모델 &#40;MDS(Master Data Services) 편집&#41;](../master-data-services/edit-model-master-data-services.md)|  
|기존 모델을 삭제합니다.|[모델 &#40;MDS(Master Data Services) 삭제&#41;](../master-data-services/delete-a-model-master-data-services.md)|  
