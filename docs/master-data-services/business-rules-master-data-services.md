...
# <a name="business-rules-master-data-services"></a>비즈니스 규칙(Master Data Services)
 ...
 비즈니스 규칙의 예를 보려면 참조 [비즈니스 규칙의 예 &#40; Master Data services&#41; ](../master-data-services/business-rule-examples-master-data-services.md).  
...
## <a name="create-and-publish-business-rules"></a>비즈니스 규칙 만들기 및 게시  
 ...
 비즈니스 규칙은 특성 값이 변경될 때(예: Color 특성 값 변경 시 동작 수행)나 특정 특성 값(예: Color=Blue일 경우 동작 수행)을 기반으로 할 수 있습니다. 관련 되지 않은 변경 내용을 추적 하는 방법에 대 한 자세한 내용은 참조 [변경 내용 추적 &#40; Master Data services&#41; ](../master-data-services/change-tracking-master-data-services.md).  
...
|태스크 설명|항목|  
|----------------------|-----------|  
|새 비즈니스 규칙을 만들어 게시합니다.|[만들기 및 비즈니스 규칙 &#40; 게시 Master Data services&#41;](../master-data-services/create-and-publish-a-business-rule-master-data-services.md)|  
|비즈니스 규칙에 여러 조건을 추가합니다.|[여러 조건을 비즈니스 규칙 &#40;에 추가 Master Data services&#41;](../master-data-services/add-multiple-conditions-to-a-business-rule-master-data-services.md)|  
|특성에 값이 필요한 비즈니스 규칙을 만듭니다.|[특성 값 &#40; 필요 합니다. Master Data services&#41;](../master-data-services/require-attribute-values-master-data-services.md)|  
...
|특정 멤버에 비즈니스 규칙을 적용합니다.|[비즈니스 규칙 &#40;에 대해 특정 멤버 유효성 검사 Master Data services&#41;](../master-data-services/validate-specific-members-against-business-rules-master-data-services.md)|  
