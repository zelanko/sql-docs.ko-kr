...
6.  
  **이름** 상자에 특성의 이름을 입력합니다. 특성 이름으로 사용하지 않아야 하는 단어의 목록을 보려면 [예약어&#40;Master Data Services&#41;](../master-data-services/reserved-words-master-data-services.md)를 참조하세요.  
...
9. 
  **특성 유형** 목록에서 **자유 형식**을 선택합니다.  
  
10. 
  **데이터 형식** 목록에서 **숫자**를 선택합니다.  
  
11. 
  **10진수** 상자에 10진수 다음에 입력할 수 있는 숫자 개수를 지정합니다.  
  
12. 
  **입력 마스크** 목록 상자에서 음수의 형식을 선택합니다.  
