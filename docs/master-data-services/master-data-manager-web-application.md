...
> [!IMPORTANT]
>  [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)][!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] 는 IE (internet Explorer) 9 이상 에서만 작동 합니다. IE 8 이하 버전, Microsoft Edge 및 Chrome은 지원되지 않습니다.  
> 
...
> [SQL Server 2016에서 낮은 권한 계정을 통해 MDS 웹 사이트를 만들 수 없습니다.](https://aka.ms/mdssupport) 
 ...
 [버전 관리 기능 영역 &#40;마스터 데이터 관리자&#41;](../master-data-services/version-management-functional-area-master-data-manager.md)  
  
 [Integration Management 기능 영역 &#40;마스터 데이터 관리자&#41;](../master-data-services/integration-management-functional-area-master-data-manager.md)  
  
 [시스템 관리 기능 영역 &#40;마스터 데이터 관리자&#41;](../master-data-services/system-administration-functional-area-master-data-manager.md)  
