...
2.  **모델 관리** 페이지의 표에서 모델을 선택하고 **엔터티**를 선택합니다.  
  
3.  **엔터티 관리** 페이지의 표에서 편집할 명시적 계층을 포함하는 엔터티에 대한 행을 선택합니다.  
  
4.  **명시적 계층**을 클릭합니다.  
  
5.  **명시적 계층 관리** 페이지에서 이름을 바꾸려는 명시적 계층을 클릭한 다음 **편집**을 선택합니다.  
