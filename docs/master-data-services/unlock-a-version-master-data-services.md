...
-   버전의 상태가 **잠금**이어야 합니다. 자세한 내용은 [버전 잠금&#40;Master Data Services&#41;](../master-data-services/lock-a-version-master-data-services.md)를 참조하세요.  
...
### <a name="to-unlock-a-version"></a>버전의 잠금을 해제하려면  
  
1.  
  [!INCLUDE[ssMDSmdm](../includes/ssmdsmdm-md.md)]에서 **버전 관리**를 클릭합니다.  
  
2.  
  **버전 관리** 페이지에서 잠금을 해제하려는 버전의 행을 선택합니다.  
