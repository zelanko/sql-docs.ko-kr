...
description: MDSModelDeploy를 사용 하 여 MDS(Master Data Services)에서 배포 패키지를 만듭니다. 패키지는 모델 개체만 또는 모델 개체와 데이터를 포함할 수 있습니다.
...
4.  MDSModelDeploy 도구를 사용하여 모델을 나열하는 데 필요한 권한은 다음과 같습니다.  
 ...
 자세한 내용은 [관리자 &#40;MDS(Master Data Services)&#41;](../master-data-services/administrators-master-data-services.md)를 참조 하세요.  
