 ...
 **Master Data Services를 설치하고, 데이터베이스 및 웹 사이트를 설정하고, 샘플 모델을 배포하려면 **MDS(Master Data Services) 개요[](../master-data-services/master-data-services-overview-mds.md "Master Data Services Overview (MDS)")를 참조하세요.  
