...
> [!IMPORTANT]  
>**동적 콘텐츠 압축**은 기본적으로 사용하도록 설정됩니다. 이로 인해 CPU 사용량이 증가하지만 xml 응답 크기가 크게 줄어들고 네트워크 I/O가 저장됩니다.  자세한 내용은 **MDS&#40;Master Data Services&#41;의 새로운 기능**에서 [[CTP 2.0] 개선된 성능](../../master-data-services/what-s-new-in-master-data-services-mds.md)을 참조하세요.  
