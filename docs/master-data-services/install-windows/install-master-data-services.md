---
title: "Master Data Services에 대 한 설치 작업 | Microsoft Docs"
ms.custom: 
ms.date: 03/24/2017
...
---
# <a name="installation-tasks-for-master-data-services"></a>Master Data Services에 대 한 설치 작업
  이 문서는 설치 작업 지침에 대 한 링크의 개요를 제공합니다. 를 설치 하 고 Master Data Services 구성 연습에 대 한 참조 [Master Data Services 설치 및 구성](../../master-data-services/master-data-services-installation-and-configuration.md) 
