...
FCI는 인스턴스 수준의 고가용성을 향상시킵니다. SQL Server 서비스 및 관련된 서비스는 WSFC에서 리소스로 등록됩니다. 또한 FCI 솔루션은 WFC 클러스터의 모든 노드에 사용할 수 있어야 하는 SAN 또는 SMB 파일 공유와 같이 대칭 공유 디스크 스토리지가 필요합니다.
