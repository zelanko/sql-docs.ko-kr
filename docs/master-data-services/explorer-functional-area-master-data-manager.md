---
description: 탐색기 기능 영역(마스터 데이터 관리자)
title: 탐색기 기능 영역
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
...
## <a name="data-management"></a>데이터 관리  
 ...
 [특성 유형 변경&#40;Excel용 MDS 추가 기능&#41;](../master-data-services/microsoft-excel-add-in/change-the-attribute-type-mds-add-in-for-excel.md)  
 ...
 [트랜잭션에 주석 추가&#40;Master Data Services&#41;](../master-data-services/annotate-a-transaction-master-data-services.md)  
...
## <a name="hierarchies-and-collections"></a>계층 및 컬렉션  
