...
3.  
  **파생 계층 유지 관리** 페이지의 **모델** 목록에서 모델을 선택합니다.  
  
4.  이름을 바꾸려는 파생 계층의 행을 선택합니다.  
  
5.  
  **편집**을 클릭합니다.  
  
6.  
  **파생 계층 편집** 페이지에서 파생 계층 이름 옆의 연필 아이콘을 클릭합니다.  
  
7.  
  **파생 계층 이름** 상자에 계층의 업데이트된 이름을 입력합니다.  
...
## <a name="see-also"></a>참고 항목  
 ...
 [파생 계층 &#40;MDS(Master Data Services)를 삭제&#41;](../master-data-services/delete-a-derived-hierarchy-master-data-services.md)  
