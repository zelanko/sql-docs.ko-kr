...
-   특성 값의 원본으로 사용할 엔터티가 있어야 합니다. 예를 들어 Color 엔터티를 기반으로 하는 도메인 기반 특성을 만들려면 먼저 Color 엔터티를 만들어야 합니다. 자세한 내용은 [&#41;MDS(Master Data Services) 엔터티 &#40;만들기 ](../master-data-services/create-an-entity-master-data-services.md)를 참조 하세요.  
...
-   날짜: 특성을 만든 날짜와 시간 **입니다.**  
  
-   **업데이트 한 사람**: 특성을 마지막으로 업데이트 한 사용자의 이름입니다.  
  
-   날짜: 특성을 마지막으로 업데이트 한 날짜와 시간 **입니다.**  
...
2.  
  **모델 관리** 페이지에서 모델을 클릭하고 **엔터티**를 클릭합니다.  
...
5.  
  **특성 관리** 페이지에서 다음 작업 중 하나를 수행하고 **추가**를 클릭합니다.  
...
6.  
  **이름** 상자에 특성의 이름을 입력합니다. 특성 이름으로 사용 하지 않아야 하는 단어의 목록을 보려면 [예약어 &#40;MDS(Master Data Services)](../master-data-services/reserved-words-master-data-services.md) 를 참조 하십시오&#41;  
...
9. 
  **특성 유형** 목록에서 **도메인 기반**을 선택합니다.  
  
10. 
  **도메인 엔터티** 목록에서 특성 값을 채우는 데 사용할 엔터티를 선택합니다. 
  
11. **리프 멤버에 대 한 도메인 기반 특성의 경우 선택 사항입니다.** 도메인 기반 특성에 허용되는 값을 제한하는 데 사용되는 필터 부모 특성을 선택합니다.  
...
## <a name="see-also"></a>참고 항목  
 ...
 [파생 계층 &#40;MDS(Master Data Services)를 만듭니다&#41;](../master-data-services/create-a-derived-hierarchy-master-data-services.md)   
