...
ms.topic: "article"
helpviewer_keywords: 
  - "변경 내용 추적 그룹 [Master Data Services]"
  - "특성 [Master Data Services], 변경 내용 추적 그룹"
  - "변경 내용 추적 그룹 [Master Data Services], 특성 추가"
...
---
# 변경 내용 추적 그룹에 특성 추가(Master Data Services)
