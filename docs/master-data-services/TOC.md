...
# [Master Data Services 설치 및 구성](master-data-services-installation-and-configuration.md)
...
# [Master Data Services 및 SQL Server 2016의 버전에서 지원 되는 데이터 품질 서비스 기능](master data services and data quality services features support.md)
# [특성 값 요구](require-attribute-values-master-data-services.md)
...
# [샘플: 모델 배포 패키지(Master Data Services)](sql-server-samples-model-deployment-packages-mds.md)
# [코드 자동 생성](automatic-code-creation-master-data-services.md)
...
# [재귀 계층 구조](recursive-hierarchies-master-data-services.md)
...
# [모델 개체 사용 권한 삭제](delete-model-object-permissions-master-data-services.md)
# [사용자의 사용 권한 테스트](test-a-user-s-permissions-master-data-services.md)
...
# [사용자 전자 메일 주소 변경](change-a-user-s-email-address-master-data-services.md)
...
# [계층 구조](hierarchies-master-data-services.md)
...
# [폴더 및 파일 사용 권한](folder-and-file-permissions-master-data-services.md)
...
# [트랜잭션](transactions-master-data-services.md)
# [비즈니스 규칙 확장](business-rules-extension-master-data-services.md)
# [모델 개체 사용 권한 할당](assign-model-object-permissions-master-data-services.md)
...
# [전자 메일 알림 구성](configure-email-notifications-master-data-services.md)
...
# [사용 권한이 결정되는 방식](how-permissions-are-determined-master-data-services.md)
