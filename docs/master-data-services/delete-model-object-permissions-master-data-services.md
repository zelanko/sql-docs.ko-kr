---
title: "모델 개체 사용 권한 (Master Data Services)를 삭제 합니다. | Microsoft Docs"
ms.custom: 
ms.date: 03/01/2017
...
### <a name="to-delete-model-object-permissions"></a>모델 개체 사용 권한을 삭제하려면  
...
7.  **모델 권한 요약** 영역에서 삭제하려는 사용 권한의 행을 선택합니다.  
  
     사용 권한의 트리 노드가 있고 강조 표시됩니다.  
