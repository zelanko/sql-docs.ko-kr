...
-   **엔터티 관리자가 "승인 필요"를 켠 경우의 변경 내용**  
    ...
    1.  변경 집합을 만듭니다. 변경 집합은 열림 상태입니다. [변경 집합 만들기&#40;Master Data Services&#41;](../master-data-services/create-a-changeset-master-data-services.md)를 참조하세요.  
