---
title: "비즈니스 규칙 (Master Data Services)의 예 | Microsoft Docs"
ms.custom: 
ms.date: 01/05/2017
...
샘플 모델을 배포 하는 방법에 지침은 [Master Data Services 설치 및 구성](../master-data-services/master-data-services-installation-and-configuration.md)합니다.  
...
다음 비즈니스 규칙 및 클래스 특성을 충족 하지 않는 경우에 `is equal` 규칙 조건는 `defaults to` [동작 규칙](../master-data-services/business-rule-actions-master-data-services.md) 이름 특성에 적용 됩니다.  
```  
If  
...
웹 사이트를 설정에 대 한 자세한 내용은 참조 하십시오. [Master Data Services 설치 및 구성](../master-data-services/master-data-services-installation-and-configuration.md)합니다.  
