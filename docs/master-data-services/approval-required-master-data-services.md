...
1.  
  [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)]에서 **시스템 관리**를 클릭합니다.  
  
2.  **모델 관리** 페이지의 표에서 모델을 선택 하 고 **엔터티**를 클릭 합니다.  
  
3.  
  **엔터티 관리** 페이지의 표에서  **승인 필요** 를 사용하도록 설정할 엔터티의 행을 선택합니다.  
  
4.  
  **편집**을 클릭하고 **승인 필요**를 선택한 후에 **저장**을 클릭합니다.  
  
## <a name="see-also"></a>참고 항목  
 [변경 집합 &#40;MDS(Master Data Services)&#41;](../master-data-services/changesets-master-data-services.md)  
