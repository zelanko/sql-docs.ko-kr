...
> -   Data Quality Services 및 MDS(Master Data Services)를 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]로 업그레이드한 후 이전 버전의 모든 Excel용 MDS(Master Data Services) 추가 기능은 더 이상 작동하지 않습니다. [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] Excel용 MDS(Master Data Services) 추가 기능은 [Microsoft 다운로드 센터](http://www.microsoft.com/en-us/download/details.aspx?id=47343)에서 다운로드할 수 있습니다.  
  
##  <a name="fileLocation"></a> 파일 위치  
  
-   기본적으로 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]의 경우 파일은 *드라이브*:\Program Files\Microsoft SQL Server\130\Master Data Services에 설치됩니다.  
...
##  <a name="noengine"></a> 데이터베이스 엔진 업그레이드 없이 업그레이드  
 이 시나리오에서는 [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]또는 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 을(를) 계속 사용하여 MDS 데이터베이스를 호스팅합니다. 그러나 MDS 데이터베이스의 스키마를 업그레이드한 다음 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 웹 응용 프로그램을 만들어 MDS 데이터베이스에 액세스해야 합니다. MDS 데이터베이스는 [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]또는 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 웹 응용 프로그램에서 더 이상 액세스할 수 없습니다.  
  
 [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] 및 이전 버전의 SQL Server([!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 또는 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)])를 동일한 컴퓨터에 설치할 수 있습니다. [파일 위치](#fileLocation)에 표시된 대로 파일은 다른 위치에 설치됩니다.  
...
2.  MDS 데이터베이스 스키마를 업그레이드합니다.  
    ...
    1.  [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] 버전의 [!INCLUDE[ssMDScfgmgr](../../includes/ssmdscfgmgr-md.md)]를 엽니다.  
    ...
    3.  오른쪽 창에서 **데이터베이스 선택** 을 클릭하고 [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]또는 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 데이터베이스 인스턴스에 대한 정보를 지정합니다.  
...
2.  데이터베이스 엔진을 [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]로 업그레이드합니다. 자세한 내용은 [Choose a Database Engine Upgrade Method](../../database-engine/install-windows/choose-a-database-engine-upgrade-method.md)을(를) 참조하세요.  
...
##  <a name="restore"></a> 백업에서 데이터베이스를 복원하여 업그레이드  
 이 시나리오에서는 [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] 이(가) [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)], 또는 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 와(과) 함께 동일한 컴퓨터 또는 서로 다른 두 컴퓨터에 설치되어 있습니다. 업그레이드하기 전에 [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] 릴리스보다 이전 버전에서 데이터베이스가 백업되었으며 이 데이터베이스가 복원되어야 합니다.  
...
## 문제 해결  
 **문제:**  [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]또는 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)][!INCLUDE[ssMDSmdm](../../includes/ssmdsmdm-md.md)] 웹 응용 프로그램을 열 때 "클라이언트 버전이 데이터베이스 버전과 호환되지 않습니다."라는 오류 메시지가 나타납니다.  
  
 **해결책:** 이 문제는 [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]또는 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 마스터 데이터 관리자 웹 응용 프로그램이 [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] MDS(Master Data Services)로 업그레이드된 데이터베이스에 액세스하려고 할 때 발생합니다. [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] 웹 응용 프로그램을 대신 사용해야 합니다.  
