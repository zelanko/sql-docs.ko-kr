...
- **Master Data Services:** MDS 데이터베이스 스키마를 업그레이드하고 SQL Server 2017 웹 응용 프로그램을 만듭니다. 자세한 내용은 [Upgrade Master Data Services](../../database-engine/install-windows/upgrade-master-data-services.md)를 참조하세요.  
