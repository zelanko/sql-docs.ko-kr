---
title: "SQL Server 2016으로 업그레이드 | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/14/2017"
...
manager: "jhubbard"
---
# SQL Server 2016으로 업그레이드
  [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)], [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]또는 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 인스턴스를 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]로 업그레이드할 수 있습니다. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 설치 프로그램을 실행하여 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]로 업그레이드하기 전에 업그레이드 프로세스 및 릴리스 정보에 대한 다음 항목을 검토하십시오.  
  
 [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]에서 업그레이드하는 방법은 [SQL Server 2005에서 업그레이드하나요?](../../database-engine/install-windows/are-you-upgrading-from-sql-server-2005.md)를 참조하세요.  
...
-   [Data Migration Assistant를 실행하여 업그레이드 준비](../../database-engine/install-windows/prepare-for-upgrade-by-running-data-migration-assistant.md)  
  
-   [SQL Server 2005에서 업그레이드하나요?](../../database-engine/install-windows/are-you-upgrading-from-sql-server-2005.md)  
...
-   [SQL Server 관리 도구 업그레이드](../../database-engine/install-windows/upgrade-sql-server-management-tools.md)  
...
-   [다른 SQL Server 2016 버전으로 업그레이드&#40;설치 프로그램&#41;](../../database-engine/install-windows/upgrade-to-a-different-edition-of-sql-server-2016-setup.md)  
