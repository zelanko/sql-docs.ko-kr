...
이 문서는 SQL Server 버전 2016 이상에서 유지 관리됩니다. 이전 버전의 SQL Server의 경우 [구성 파일을 사용하여 SQL Server 2014 설치](/../../2014/database-engine/install-windows/install-sql-server-using-a-configuration-file.md)를 참조하세요.
