...
|[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]|/PASSPHRASE<br /><br /> **SPI_AS_NewFarm의 경우 필수**|SharePoint 팜에 애플리케이션 서버 또는 웹 프런트 엔드 서버를 더 추가하는 데 사용되는 전달 구를 지정합니다.<br /><br /> 이 매개 변수는 /ROLE = SPI_AS_NEWFARM을 통해 설치된 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 인스턴스에만 사용됩니다.|  
