...
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)] 설치 컨트롤|/SUPPRESSPRIVACYSTATEMENTNOTICE<br /><br /> |개인정보취급방침을 무시합니다. 이 플래그를 사용하면 [개인정보취급방침](../../sql-server/sql-server-privacy.md)에 동의하는 것입니다.  |  
