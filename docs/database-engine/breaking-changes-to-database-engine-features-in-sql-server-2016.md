...
SQL Server 버전 2014 및 일부 이전 버전의 주요 변경 내용에 대한 정보는 [SQL Server 2014 데이터베이스 엔진 기능의 주요 변경](https://docs.microsoft.com/sql/database-engine/breaking-changes-to-database-engine-features-in-sql-server-2016?view=sql-server-2014#SQL14)을 참조하세요.
