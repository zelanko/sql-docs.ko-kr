...
### 개념  
 ...
 버퍼 풀 확장에서 커밋할 수 있는 최대 메모리는 메모리가 상당한 압박을 만드는 경우에 컴퓨터에서 실행 중인 다른 응용 프로그램에 의해 제한될 수 있습니다.  
...
## 버퍼 풀 확장 세부 정보  
 ...
 ![SSD 버퍼 풀 확장 프로그램 아키텍처](../../database-engine/configure-windows/media/ssdbufferpoolextensionarchitecture.gif "SSD 버퍼 풀 확장 프로그램 아키텍처")  
