...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server 구성 관리자, 서비스 시작 및 중지"
  - "SQL Server 에이전트 중지"
  - "매개 변수 [SQL Server], 시작 옵션"
  - "SQL Server, 시작 옵션"
  - "데이터베이스 엔진 [SQL Server], 서비스 시작 및 중지"
  - "SQL Server 일시 중지"
  - "PowerShell [SQL Server], 서비스 시작 및 중지"
  - "단일 사용자 모드 [SQL Server], 시작"
  - "SQL Server Management Studio [SQL Server], 서비스 시작 또는 중지"
  - "SQL Server Browser 서비스 중지"
  - "SQL Server 에이전트 시작"
  - "기본 인스턴스 [SQL Server], 시작 및 중지"
  - "SQL Server 에이전트, 시작 및 중지"
  - "명령 프롬프트 [SQL Server], SQL Server 서비스 시작 및 중지"
  - "SQL Server 계속 수행"
  - "SQL Server 데이터베이스 엔진 시작"
  - "net stop 명령 [SQL Server]"
  - "명령 프롬프트 [SQL Server], SQL Browser 서비스"
  - "구성 관리자, 서비스 시작 및 중지"
  - "SQL Server 재개"
  - "시작 옵션 [SQL Server]"
  - "명명된 인스턴스 [SQL Server], 시작 및 중지"
  - "net start 명령 [SQL Server]"
  - "SQL Server, 시작 및 중지"
  - "SQL Server 중지"
  - "SQL Server Browser 서비스 시작"
  - "SQL Server Database Engine 시작 옵션 설정"
  - "SQL Server 관리, 서비스 시작 및 중지"
  - "Management Studio [SQL Server], 서비스 시작 또는 중지"
...
#### [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 구성 관리자 시작  
...
#### 다음 인스턴스를 시작, 중지, 일시 중지, 재개 또는 다시 시작하기: [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]  
...
> [!NOTE]  
>  시작 옵션을 사용하여 [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)] 인스턴스를 시작하려면 [서버 시작 옵션 구성&#40;SQL Server 구성 관리자&#41;](../../database-engine/configure-windows/configure-server-startup-options-sql-server-configuration-manager.md)을 참조하세요.  
...
#### 다음을 사용하여 [!INCLUDE[ssDE](../../includes/ssde-md.md)]을 중지하기: [!INCLUDE[tsql](../../includes/tsql-md.md)]  
...
## 참고 항목  
 [SQL Server 설치 설명서 개요](../Topic/Overview%20of%20SQL%20Server%20Setup%20Documentation.md)   
