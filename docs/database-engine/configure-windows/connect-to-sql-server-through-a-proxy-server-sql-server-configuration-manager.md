...
helpviewer_keywords: 
  ...
  - "LAT"
  - "프록시 서버 [SQL Server]"
  - "연결 [SQL Server], 프록시 서버"
  - "Microsoft Proxy Server [SQL Server]"
  - "로컬 주소 테이블 [SQL Server]"
...
##  <a name="a-namessmsprocedurea-using-sql-server-configuration-manager"></a><a name="SSMSProcedure"></a> SQL Server 구성 관리자 사용  
