---
title: "데이터베이스 엔진 액세스에 대한 파일 시스템 사용 권한 구성 | Microsoft Docs"
ms.custom: ""
ms.date: "06/06/2016"
...
helpviewer_keywords: 
  - "파일 시스템 권한"
  - "서비스 계정 [SQL Server], 파일 시스템 권한"
  - "사용 권한 [SQL Server], 파일 시스템"
...
6.  **그룹 또는 사용자** 이름 상자에서 서비스별 SID 이름을 선택한 다음 \<이름>**에 대한 사용 권한** 상자에서 **모든 권한**에 대한 **허용** 확인란을 선택합니다.  
