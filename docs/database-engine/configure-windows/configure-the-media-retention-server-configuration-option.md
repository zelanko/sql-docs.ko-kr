...
description: 미디어 보존 기간 옵션에 대해 알아봅니다. 이 옵션을 사용하여 SQL Server에서 트랜잭션 로그와 데이터베이스 백업을 보존하는 기간을 지정하는 방법을 확인합니다.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
...
-   **미디어 보존 기간** 옵션은 [BACKUP](../../t-sql/statements/backup-transact-sql.md) 문의 RETAINDAYS 절을 사용하여 재정의할 수 있습니다.  
...
3.  다음 예를 복사하여 쿼리 창에 붙여 넣고 **실행**을 클릭합니다. 다음 예제에서는 [sp_configure](../../relational-databases/system-stored-procedures/sp-configure-transact-sql.md) 를 사용하여 `media retention` 옵션의 값을 `60` 일로 설정하는 방법을 보여 줍니다.  
...
##  <a name="follow-up-after-you-configure-the-media-retention-option"></a><a name="FollowUp"></a> 후속 작업: 미디어 보존 기간 옵션을 구성한 후  
