---
title: "SQL Server 인스턴스를 자동으로 시작하도록 설정(SQL Server 구성 관리자) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/14/2017"
...
manager: "jhubbard"
---
# SQL Server 인스턴스를 자동으로 시작하도록 설정(SQL Server 구성 관리자)
...
#### SQL Server 인스턴스를 자동으로 시작하도록 설정하려면  
...
## 참고 항목  
 ...
 [다른 컴퓨터에 연결&#40;SQL Server 구성 관리자&#41;](../../database-engine/configure-windows/connect-to-another-computer-sql-server-configuration-manager.md)   
