...
ms.topic: "article"
helpviewer_keywords: 
  - "시작 서비스 상태 [SQL Server]"
  - "설치 [SQL Server], 사용자 계정"
  - "Windows 사용 권한 [SQL Server]"
  - "사용자 계정 수정"
  - "기본 계정"
  - "도메인 [SQL Server], 사용자 계정"
  - "시작 계정 [SQL Server]"
  - "시스템 계정 [SQL Server]"
  - "서비스 [SQL Server], 사용 권한"
  - "ACL(액세스 제어 목록)"
  - "로컬 시스템 계정 [SQL Server]"
  - "인스턴스 인식형 서비스 [SQL Server]"
  - "사용 권한 [SQL Server], 서비스"
  - "SQL Server 에이전트 서비스, 사용자 계정"
  - "Windows NT 사용 권한 [SQL Server]"
  - "사용자 계정 [SQL Server]"
  - "인스턴스 비인식형 서비스 식별 [SQL Server]"
  - "SQL Server 설치, 사용자 계정"
  - "사용 안 함 시작 상태 [SQL Server]"
  - "사용자 계정 [SQL Server], 사용자"
  - "로컬 서비스 계정 [SQL Server]"
  - "SQL Server 설치 마법사"
  - "인스턴스 비인식형 서비스 [SQL Server]"
  - "서비스 [SQL Server], 설치 중 구성"
  - "Windows 계정 [SQL Server]"
  - "SQL Server 서비스, 사용자 계정"
  - "사용자 계정 [SQL Server], 서비스"
  - "MSSQLServer"
  - "인스턴스 인식형 서비스 식별 [SQL Server]"
  - "서비스 [SQL Server], 계정"
  - "액세스 제어 목록"
  - "선택적 계정 [SQL Server]"
  - "서비스 계정 [SQL Server]"
  - "계정 [SQL Server], 서비스 "
  - "기본 제공 시스템 계정 [SQL Server]"
  - "자동 시작 상태"
  - "도메인 [SQL Server]"
  - "수동 시작 상태 [SQL Server]"
  - "계정 [SQL Server], 사용자"
...
##  <a name="a-nameservicedetailsa-services-installed-by-includessnoversiontokenssnoversionmdmd"></a><a name="Service_Details"></a> [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]에 의해 설치되는 서비스  
...
##  <a name="a-nameservpropa-service-properties-and-configuration"></a><a name="Serv_Prop"></a> 서비스 속성 및 구성  
...
###  <a name="a-namedefaultacctsa-default-service-accounts"></a><a name="Default_Accts">기본 서비스 계정</a>  
...
####  <a name="a-namechangingaccountsa-changing-account-properties"></a><a name="Changing_Accounts"></a> 계정 속성 변경  
...
###  <a name="a-namenewaccountsa-managed-service-accounts-group-managed-service-accounts-and-virtual-accounts"></a><a name="New_Accounts"></a> 관리 서비스 계정, 그룹 관리 서비스 계정 및 가상 계정  
...
-  <a name="GMSA"></a> **그룹 관리 서비스 계정**  
    ...
    자세한 내용은 [그룹 관리 서비스 계정 개요](http://technet.microsoft.com/library/hh831782.aspx)를 참조하세요.  
...
-   <a name="VA_Desc"></a>**가상 계정**  
    ...
    |**PAYROLL**로 이름이 지정된 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 인스턴스의 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 에이전트 서비스|**NT SERVICE\SQLAGENT$PAYROLL**|  
...
###  <a name="a-nameautostarta-automatic-startup"></a><a name="Auto_Start"></a> 자동 시작  
...
###  <a name="a-nameconfigureservicesa-configuring-services-during-unattended-installation"></a><a name="Configure_services"></a> 무인 설치 중 서비스 구성  
...
###  <a name="a-namefirewalla-firewall-port"></a><a name="Firewall"></a> 방화벽 포트  
...
##  <a name="a-nameservperma-service-permissions"></a><a name="Serv_Perm"></a> 서비스 권한  
...
###  <a name="a-nameservsida-service-configuration-and-access-control"></a><a name="Serv_SID">서비스 구성 및 Access Control</a>  
...
###  <a name="a-namewindowsa-windows-privileges-and-rights"></a><a name="Windows"></a> Windows 사용 권한 및 권한  
 ...
 * [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 에이전트 서비스는 [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)]인스턴스에서 사용할 수 없습니다.  
  
###  <a name="a-namereviewingaclsa-file-system-permissions-granted-to-sql-server-per-service-sids-or-local-windows-groups"></a><a name="Reviewing_ACLs"></a> SQL Server의 서비스별 SID 또는 로컬 Windows 그룹에 부여된 파일 시스템 권한  
...
###  <a name="a-namefilesystemothera-file-system-permissions-granted-to-other-windows-user-accounts-or-groups"></a><a name="File_System_Other"></a> 다른 Windows 사용자 계정 또는 그룹에 부여된 파일 시스템 권한  
...
|[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]|\<보고서 서버 웹 서비스 계정>|*\<install>*\Reporting Services\LogFiles|DELETE<br /><br /> READ_CONTROL<br /><br /> SYNCHRONIZE<br /><br /> FILE_GENERIC_READ<br /><br /> FILE_GENERIC_WRITE<br /><br /> FILE_READ_DATA<br /><br /> FILE_WRITE_DATA<br /><br /> FILE_APPEND_DATA<br /><br /> FILE_READ_EA<br /><br /> FILE_WRITE_EA<br /><br /> FILE_READ_ATTRIBUTES<br /><br /> FILE_WRITE_ATTRIBUTES|  
||보고서 관리자 응용 프로그램 풀 ID, [!INCLUDE[vstecasp](../../includes/vstecasp-md.md)] 계정, 모든 사람|*\<install>*\Reporting Services\ReportManager, *\<install>*\Reporting Services\ReportManager\Pages\\\*.\*, *\<install>*\Reporting Services\ReportManager\Styles\\\*.\*, *\<install>*\Reporting Services\ReportManager\webctrl_client\1_0\\*.\*|읽기|  
||보고서 관리자 응용 프로그램 풀 ID|*\<install>*\Reporting Services\ReportManager\Pages\\*.\*|읽기|  
||\<보고서 서버 웹 서비스 계정>|*\<install>*\Reporting Services\ReportServer|읽기|  
||\<보고서 서버 웹 서비스 계정>|*\<install>*\Reporting Services\ReportServer\global.asax|전체|  
...
||네트워크 서비스|*\<install>*\Reporting Services\ReportServer\ReportService.asmx|전체|  
||모든 사람|*\<install>*\Reporting Services\ReportServer\ReportService.asmx|READ_CONTROL<br /><br /> SYNCHRONIZE FILE_GENERIC_READ<br /><br /> FILE_GENERIC_EXECUTE<br /><br /> FILE_READ_DATA<br /><br /> FILE_READ_EA<br /><br /> FILE_EXECUTE<br /><br /> FILE_READ_ATTRIBUTES|  
...
###  <a name="a-nameunusuallocationsa-file-system-permissions-related-to-unusual-disk-locations"></a><a name="Unusual_Locations"></a> 비정상적인 디스크 위치와 관련된 파일 시스템 권한  
...
###  <a name="a-namereviewadditionalconsiderationsa-reviewing-additional-considerations"></a><a name="Review_additional_considerations"></a> 추가 고려 사항 검토  
...
###  <a name="a-nameregistrya-registry-permissions"></a><a name="Registry"></a> 레지스트리 권한  
...
###  <a name="a-namepipesa-named-pipes"></a><a name="Pipes"></a> 명명된 파이프  
...
##  <a name="a-nameprovisioninga-provisioning"></a><a name="Provisioning"></a> 프로비전  
...
###  <a name="a-namedeprova-database-engine-provisioning"></a><a name="DE_Prov"></a> 데이터베이스 엔진 프로비전  
 다음 계정이 [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]에서 로그인으로 추가됩니다.  
  
####  <a name="a-namewinprincipalsa-windows-principals"></a><a name="Win_Principals"></a> Windows 보안 주체  
 설치 중에 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 설치 프로그램에서는 적어도 하나의 사용자 계정을 **sysadmin** 고정 서버 역할의 멤버로 명명해야 합니다.  
  
####  <a name="a-namesaa-sa-account"></a><a name="sa"></a> sa 계정  
...
####  <a name="a-nameloginsa-sql-server-per-service-sid-login-and-privileges"></a><a name="Logins"></a> SQL Server 서비스별 SID 로그인 및 권한  
...
####  <a name="a-nameagenta-sql-server-agent-login-and-privileges"></a><a name="Agent"></a> SQL Server 에이전트 로그인 및 사용 권한  
...
####  <a name="a-namehadrona-includesshadrctokensshadrcmdmd-and-sql-failover-cluster-instance-and-privileges"></a><a name="Hadron"></a> [!INCLUDE[ssHADRc](../../includes/sshadrc-md.md)] 및 SQL 장애 조치(Failover) 클러스터 인스턴스 및 사용 권한  
...
####  <a name="a-namewritera-sql-writer-and-privileges"></a><a name="Writer"></a> SQL 기록기 및 사용 권한  
...
####  <a name="a-namesqlwmia-sql-wmi-and-privileges"></a><a name="SQLWMI"></a> SQL WMI 및 사용 권한  
...
###  <a name="a-namessasa-ssas-provisioning"></a><a name="SSAS"></a> SSAS 프로비전  
...
###  <a name="a-namessrsa-ssrs-provisioning"></a><a name="SSRS"></a> SSRS 프로비전  
...
##  <a name="a-nameupgradea-upgrading-from-previous-versions"></a><a name="Upgrade"></a> 이전 버전에서 업그레이드  
...
##  <a name="a-nameappendixa-appendix"></a><a name="Appendix"></a> 부록  
...
###  <a name="a-nameservacctsa-description-of-service-accounts"></a><a name="Serv_Accts"></a> 서비스 계정에 대한 설명  
 서비스 계정은 [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]과 같은 Windows 서비스를 시작하는 데 사용되는 계정입니다.  
  
####  <a name="a-nameanyosa-accounts-available-with-any-operating-system"></a><a name="Any_OS"></a> 모든 운영 체제에서 사용할 수 있는 계정  
...
###  <a name="a-nameidentifyinstanceawareandunawarea-identifying-instance-aware-and-instance-unaware-services"></a><a name="Identify_instance_aware_and_unaware"></a> 인스턴스 인식형 및 인스턴스 비인식형 서비스 식별  
...
###  <a name="a-namelocalizedservicenamesa-localized-service-names"></a><a name="Localized_service_names"></a> 지역화된 버전의 서비스 이름  
