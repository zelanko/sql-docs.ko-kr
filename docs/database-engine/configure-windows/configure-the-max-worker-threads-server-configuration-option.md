...
-   다음 표에서는 다양한 CPU 조합과 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]버전에 대해 자동으로 구성되는 최대 작업자 스레드 수를 보여 줍니다.  
    ...
    > [!NOTE]  
    >  64개가 넘는 CPU 사용에 대한 권장 사항은 [64개를 초과하는 CPU가 있는 컴퓨터에서 SQL Server를 실행하기 위한 최선의 방법](http://technet.microsoft.com/library/ee210547\(SQL.105\).aspx)을 참조하세요.  
...
3.  **최대 작업자 스레드 수** 입력란에 128~32767 범위의 값을 입력하거나 선택합니다.  
