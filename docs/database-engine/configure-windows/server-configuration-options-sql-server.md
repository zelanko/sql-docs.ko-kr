...
description: SQL Server 리소스를 관리하고 최적화 하는 방법을 알아봅니다. 사용 가능한 구성 옵션, 가능한 설정, 기본값 및 다시 시작 요구 사항을 확인합니다.
ms.custom: ''
ms.date: 07/20/2020
ms.prod: sql
...
- A= 고급 옵션이며 숙련된 데이터베이스 관리자나 인증된 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 전문가를 위한 옵션입니다. 고급 옵션 표시를 1로 설정해야 사용할 수 있습니다.
...
| [ADR 클리너 다시 시도 시간 제한(분)](../../database-engine/configure-windows/adr-cleaner-retry-timeout-configuration-option.md)<br><br> SQL Server 2019에서 도입 | 0 | 32767 | 15 |
| [ADR 미리 할당 요소](../../database-engine/configure-windows/adr-preallocation-factor-server-configuration-option.md)<br><br> SQL Server 2019에서 도입 | 0 | 32767 | 4 |
...
| [affinity64 I/O mask](../../database-engine/configure-windows/affinity64-input-output-mask-server-configuration-option.md) (A, 64비트 버전에만 해당 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]) | -2147483648 | 2147483647 | 0 |
...
| [allow polybase export](../../database-engine/configure-windows/allow-polybase-export.md)<br/><br/> [!INCLUDE [sqlserver2016](../../includes/applies-to-version/sqlserver2016.md)]입니다.| 0 | 1 | 0 |
...
| [자동 soft-NUMA 사용 안 함](soft-numa-sql-server.md) | 0 | 1 | 0 |
...
| [clr strict security](../../database-engine/configure-windows/clr-strict-security.md) (A) <br /> [!INCLUDE [sqlserver2017](../../includes/applies-to-version/sqlserver2017.md)]입니다. | 0 | 1 | 0 |
| [열 암호화 Enclave 형식](../../database-engine/configure-windows/configure-column-encryption-enclave-type.md)(A, RR) | 0 | 1 | 0 |
...
| [external scripts enabled](../../database-engine/configure-windows/external-scripts-enabled-server-configuration-option.md)(SC)(RR)<br /><br />[!INCLUDE [sqlserver2016](../../includes/applies-to-version/sqlserver2016.md)]입니다. | 0 | 1 | 0 |
...
| [FT 크롤링 대역폭(최댓값)](../../database-engine/configure-windows/ft-crawl-bandwidth-server-configuration-option.md)(A) | 0 | 32767 | 100 |
| [FT 크롤링 대역폭(최솟값)](../../database-engine/configure-windows/ft-crawl-bandwidth-server-configuration-option.md)(A) | 0 | 32767 | 0 |
| [FT 알림 대역폭(최댓값)](../../database-engine/configure-windows/ft-notify-bandwidth-server-configuration-option.md)(A) | 0 | 32767 | 100 |
| [FT 알림 대역폭(최솟값)](../../database-engine/configure-windows/ft-notify-bandwidth-server-configuration-option.md)(A) | 0 | 32767 | 0 |
| [hadoop 연결](../../database-engine/configure-windows/polybase-connectivity-configuration-transact-sql.md)(RP)<br /><br />[!INCLUDE [sqlserver2016](../../includes/applies-to-version/sqlserver2016.md)]입니다. | 0 | 7 | 0 |
...
| [PolyBase 사용 가능](../../relational-databases/polybase/polybase-installation.md#enable)(RR) <br/><br/>[!INCLUDE [sqlserver2019](../../includes/applies-to-version/sqlserver2019.md)]| 0 | 1 | 0 |
| [Polybase 네트워크 암호화](../../relational-databases/polybase/polybase-installation.md#enable) | 0 | 1 | 1 |
...
| [복구 모델 오류 표시 안 함](../../database-engine/configure-windows/suppress-recovery-model-errors-server-configuration-option.md)(A) <br/><br/>[!INCLUDE [asdbmi](../../includes/applies-to-version/_asdbmi.md)]| 0 | 1 | 0 |
| [tempdb 메타데이터 메모리 최적화](../../relational-databases/databases/tempdb-database.md#memory-optimized-tempdb-metadata)(A) <br/><br/> [!INCLUDE [sqlserver2019](../../includes/applies-to-version/sqlserver2019.md)].| 0 | 1 | 0 |
