...
-   [등록된 서버에 연결&#40;SQL Server Management Studio&#41;](../../ssms/register-servers/connect-to-a-registered-server-sql-server-management-studio.md)  
...
-   [sqlcmd를 사용하여 데이터베이스 엔진에 연결](../../ssms/scripting/sqlcmd-connect-to-the-database-engine.md)  
...
-   [방법: ASP.NET 2.0에서 SQL 인증을 사용하여 SQL Server에 연결](/previous-versions/msp-n-p/ff648340(v=pandp.10))  
...
-   [방법: SQL Server 데이터베이스에 대한 연결 만들기](/previous-versions/visualstudio/visual-studio-2008/s4yys16a(v=vs.90))  
