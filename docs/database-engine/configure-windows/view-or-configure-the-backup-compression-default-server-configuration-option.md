...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server Management Studio [SQL Server], 백업 압축 기본값 옵션"
  - "백업 압축 [SQL Server], 백업 압축 기본값 옵션"
...
-   일부 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 버전에서는 백업 압축을 사용할 수 없습니다. 자세한 내용은 [SQL Server 2016 버전에서 지원하는 기능](../Topic/Features%20Supported%20by%20the%20Editions%20of%20SQL%20Server%202016.md)을 참조하세요.  
