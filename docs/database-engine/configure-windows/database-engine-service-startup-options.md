...
ms.topic: "article"
helpviewer_keywords: 
  - "단일 사용자 모드 [SQL Server], 시작 옵션"
  - "기본 시작 옵션 재정의"
  - "최소 구성 모드 [SQL Server], 시작 옵션"
  - "기본 시작 옵션"
  - "기본 시작 옵션 임시로 재정의 [SQL Server]"
  - "시작 옵션 [SQL Server]"
  - "SQL Server 시작, 옵션"
...
## 시작 옵션 정보  
 ...
 시작 옵션은 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 구성 관리자를 사용하여 설정할 수 있습니다. 자세한 내용은 [서버 시작 옵션 구성&#40;SQL Server 구성 관리자&#41;](../../database-engine/configure-windows/configure-server-startup-options-sql-server-configuration-manager.md)을 참조하세요.  
...
> [!NOTE]  
>  **net start**를 사용하여 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]를 시작하는 경우에는 시작 옵션에 하이픈(-) 대신 슬래시(/)를 사용합니다.  
...
## 호환성 지원  
 **-h** 매개 변수는 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]에서 지원되지 않습니다. 이 매개 변수는 이전 버전 32비트 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 인스턴스에서 AWE가 설정된 경우 Hot Add 메모리 메타데이터에 대해 가상 주소 공간을 예약하는 데 사용되었습니다. 자세한 내용은 [SQL Server 2016에서 지원되지 않는 SQL Server 기능](../Topic/Discontinued%20SQL%20Server%20Features%20in%20SQL%20Server%202016.md)을 참조하세요.  
