...
ms.topic: "article"
helpviewer_keywords: 
  - "네트워크 프로토콜 [SQL Server], 해제"
  - "원격 연결 [SQL Server], 구성 관리자 사용 설정"
  - "프로토콜 [SQL Server], 구성 관리자 사용 설정"
  - "프로토콜 [SQL Server], 구성 관리자 사용 해제"
  - "네트워크 프로토콜 해제, 구성 관리자"
  - "네트워크 프로토콜 [SQL Server], 설정"
  - "네트워크 프로토콜 설정, 구성 관리자"
  - "노출 영역 구성 [SQL Server], 연결 프로토콜"
  - "연결 [SQL Server], 구성 관리자를 사용하여 원격 설정"
...
2.  콘솔 창에서 *\<인스턴스>***에 대한 프로토콜**을 클릭합니다.  
  
3.  세부 정보 창에서 변경할 프로토콜을 마우스 오른쪽 단추로 클릭한 다음 **사용** 또는 **사용 안 함**을 클릭합니다.  
  
4.  콘솔 창에서 **SQL Server 서비스**를 클릭합니다.  
  
5.  세부 정보 창에서 **SQL Server(***\<instance name>***)**를 마우스 오른쪽 단추로 클릭한 후 **다시 시작**을 클릭하여 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 서비스를 중지한 다음 다시 시작합니다.  
  
##  <a name="PowerShellProcedure"></a> SQL Server PowerShell 사용  
  
#### PowerShell을 사용하여 서버 네트워크 프로토콜을 설정하려면  
