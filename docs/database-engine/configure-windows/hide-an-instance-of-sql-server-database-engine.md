...
#### SQL Server 데이터베이스 엔진의 인스턴스를 숨기려면  
...
## 참고 항목  
 ...
 [SQL 가상 서버 클라이언트 연결에 대한 설명](https://support.microsoft.com/kb/273673)   
 [SQL Server 명명된 인스턴스에 정적 포트를 할당하고 일반적인 문제를 방지하는 방법](http://blogs.msdn.com/b/arvindsh/archive/2012/09/08/how-to-assign-a-static-port-to-a-sql-server-named-instance-and-avoid-a-common-pitfall.aspx)  
