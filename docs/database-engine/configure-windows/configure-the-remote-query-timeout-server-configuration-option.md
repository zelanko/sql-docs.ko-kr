...
description: "\"원격 쿼리 제한 시간\" 옵션에 대해 알아봅니다. SQL Server가 시간 초과되기 전에 원격 작업을 수행할 수 있는 시간(초)이 어떻게 결정되는지 알아봅니다."
ms.custom: ''
ms.date: 03/08/2017
ms.prod: sql
...
##  <a name="follow-up-after-you-configure-the-remote-query-timeout-option"></a><a name="FollowUp"></a> 후속 작업: 원격 쿼리 제한 시간 옵션을 구성한 후  
