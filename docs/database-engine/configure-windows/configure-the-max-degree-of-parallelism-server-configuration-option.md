...
**max degree of parallelism** 서버 구성 값을 구성하는 경우 다음 지침을 사용하세요.
...
## <a name="see-also"></a>참고 항목  
 ...
 [SQL Server의 "max degree of parallelism" 구성 옵션에 대한 권장 사항 및 지침(영문)](http://support.microsoft.com/help/2806535)
