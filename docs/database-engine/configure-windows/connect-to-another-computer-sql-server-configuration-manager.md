...
#### Windows 컴퓨터 관리에서 다른 컴퓨터에 연결하려면  
...
#### 다른 컴퓨터의 SQL Server 구성 관리자에 대한 링크를 저장하려면  
...
9. **컴퓨터 관리(***\<컴퓨터 이름>***)**와 **서비스 및 응용 프로그램**을 확장합니다.  
