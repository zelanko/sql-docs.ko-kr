...
##  <a name="upgrading-the-optional-monitor-server-instance"></a><a name="UpgradeMonitor"></a> (선택 사항) 모니터 서버 인스턴스 업그레이드  
...
##  <a name="upgrading-the-secondary-server-instances"></a><a name="UpgradeSecondaries"></a> 보조 서버 인스턴스 업그레이드  
