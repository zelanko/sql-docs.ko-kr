---
title: "로그 전달 보조 데이터베이스로 장애 조치(Failover)(SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
helpviewer_keywords: 
  - "주 데이터베이스 [SQL Server]"
  - "보조 데이터 파일 [SQL Server], 수동 장애 조치(failover)"
  - "로그 전달 [SQL Server], 장애 조치(failover)"
  - "장애 조치(failover) [SQL Server], 로그 전달"
