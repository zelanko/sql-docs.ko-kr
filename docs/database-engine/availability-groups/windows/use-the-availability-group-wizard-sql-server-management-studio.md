---
title: SSMS에서 가용성 그룹 구성
description: SSMS(SQL Server Management Studio)에서 ‘새 가용성 그룹 마법사’를 사용하여 Always On 가용성 그룹을 만들고 구성합니다.
