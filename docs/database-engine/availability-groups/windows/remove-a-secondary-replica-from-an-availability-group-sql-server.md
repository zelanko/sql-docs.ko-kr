---
title: 가용성 그룹에서 보조 복제본 제거
description: 'T-SQL(Transact-SQL), PowerShell 또는 SQL Server Management Studio를 사용하여 Always On 가용성 그룹에서 보조 복제본을 제거하는 단계입니다. '
ms.custom: seodec18
ms.date: 05/17/2016
ms.prod: sql
ms.reviewer: ''
