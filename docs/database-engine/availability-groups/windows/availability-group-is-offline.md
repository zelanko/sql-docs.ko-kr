---
title: 가용성 그룹이 오프라인 상태임
description: Always On 가용성 그룹이 오프라인으로 전환되는 시기와 가능한 이유를 식별하는 방법을 알아봅니다.
ms.custom: seodec18
ms.date: 05/17/2016
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "94584739"
---
# <a name="always-on-availability-group-is-offline"></a>Always On 가용성 그룹이 오프라인 상태임
