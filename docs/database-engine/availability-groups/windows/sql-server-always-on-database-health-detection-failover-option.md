...
* [Always On 장애 조치 정책을 향상시켜 SQL Server 데이터베이스 데이터 및 로그 드라이브 테스트(영문)](/archive/blogs/alwaysonpro/enhance-alwayson-failover-policy-to-test-sql-server-database-data-and-log-drives)
