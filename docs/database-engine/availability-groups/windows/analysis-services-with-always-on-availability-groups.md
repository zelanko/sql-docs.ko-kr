...
---
# Always On 가용성 그룹이 포함된 Analysis Services
...
3.  연결 관리자의 서버 이름에 *가용성 그룹 수신기*의 이름을 입력하고 그룹에서 사용할 수 있는 데이터베이스를 선택합니다.  
     ...
     가용성 그룹 수신기의 이름을 확인하려면 데이터베이스 관리자에게 문의하거나 가용성 그룹의 인스턴스 중 하나에 연결하여 해당 Always On 가용성 구성을 확인하면 됩니다. 아래 스크린샷에서 가용성 그룹 수신기는 **AdventureWorks2**입니다.  
...
## 참고 항목  
 ...
 [차원 쓰기 저장(writeback) 설정](../../../analysis-services/multidimensional-models/enable-dimension-writeback.md)  
