...
-   **로그인**  
     ...
     애플리케이션에서 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 인증 또는 로컬 Windows 로그인을 사용하는 경우 이 항목의 뒷부분에 나오는 [SQL Server 인증 또는 로컬 Windows 로그인을 사용하는 애플리케이션의 로그인](../../../database-engine/availability-groups/windows/logins-and-jobs-for-availability-group-databases.md#SSauthentication)을 참조하십시오.  
