---
title: "Always On 가용성 그룹에 대한 서버 인스턴스 구성(SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "05/17/2016"
...
> [!IMPORTANT]  
>  WSFC(Windows Server 장애 조치(failover) 클러스터링) 노드 및 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 인스턴스의 [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)] 필수 구성 사항 및 제한 사항에 대한 자세한 내용은 [Always On 가용성 그룹에 대한 필수 구성 사항, 제한 사항 및 권장 사항&#40;SQL Server&#41;](../../../database-engine/availability-groups/windows/prereqs, restrictions, recommendations - always on availability.md)을 참조하세요.  
