...
|Task|참조|  
|-----------------|----------|  
|클러스터형 DTC 서비스에 대한 네트워크 DTC 액세스를 안전하게 사용하도록 설정합니다.|[MS DTC에 안전하게 네트워크 액세스 사용(영문)](https://technet.microsoft.com/library/cc753620(v=ws.10).aspx)|
