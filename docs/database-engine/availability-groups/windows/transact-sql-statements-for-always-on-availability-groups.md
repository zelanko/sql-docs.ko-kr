...
##  <a name="restrictions-on-the-availability-group-transact-sql-statements"></a><a name="Restrictions"></a> AVAILABILITY GROUP TRANSACT-SQL 문에 대한 제한 사항  
