...
##  <a name="supported-availability-modes"></a><a name="SupportedAvModes"></a> 지원되는 가용성 모드  
...
###  <a name="how-synchronization-works-on-a-secondary-replica"></a><a name="HowSyncWorks"></a> 보조 복제본에서 동기화가 작동하는 방법  
...
### <a name="synchronous-commit-mode-with-only-manual-failover"></a><a name="SyncCommitWithManual"></a> 수동 장애 조치만 사용하는 동기-커밋 모드  
...
###  <a name="synchronous-commit-mode-with-automatic-failover"></a><a name="SyncCommitWithAuto"></a> 자동 장애 조치를 사용하는 동기-커밋 모드  
