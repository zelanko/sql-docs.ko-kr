---
title: "로그 전달에서 Always On 가용성 그룹으로 마이그레이션하기 위한 필수 조건(SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "로그 전달 [SQL Server], AlwaysOn  가용성 그룹 "
...
manager: "jhubbard"
---
# 로그 전달에서 Always On 가용성 그룹으로 마이그레이션하기 위한 필수 조건(SQL Server)
 ...
 **자세한 내용은 다음을 참조하세요.**  
 ...
 [로그 전달 구성을 가용성 그룹으로 변환](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/01/09/converting-a-logshipping-configuration-to-availability-group.aspx)(SQL Server 블로그)  
...
-   **블로그:**  
     ...
     [로그 전달 구성을 가용성 그룹으로 변환](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/01/09/converting-a-logshipping-configuration-to-availability-group.aspx)  
  
     [기존 가용성 그룹에 로그 전달 주 데이터베이스 및 보조 데이터베이스 추가](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/02/01/use-log-shipping-to-prepare-secondary-databases-for-an-existing-availability-group.aspx)  
