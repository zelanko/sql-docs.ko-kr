...
###  <a name="DbmConnectionString"></a> 가용성 그룹에서 데이터베이스 미러링 연결 문자열 사용  
...
-   [가용성 그룹 수신기 소개](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/01/16/introduction-to-the-availability-group-listener.aspx)(SQL Server Always On 팀 블로그)  
