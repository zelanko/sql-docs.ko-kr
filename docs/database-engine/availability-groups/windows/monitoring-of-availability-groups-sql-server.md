...
-   **블로그:**  
     ...
     [Always On 상태 모델 파트 1 -- 상태 모델 아키텍처](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/02/09/overview-of-the-Always%20On-manageability-health-model.aspx)  
  
     [Always On 상태 모델 파트 2 -- 상태 모델 확장](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/02/13/extending-the-Always%20On-health-model.aspx)  
  
     [PowerShell을 사용하여 Always On 상태 모니터링 - 1부: 기본 cmdlet 개요](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/02/13/monitoring-Always%20On-health-with-powershell-part-1.aspx)  
  
     [PowerShell을 사용하여 Always On 상태 모니터링 - 2부: 고급 cmdlet 사용](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/02/13/monitoring-Always%20On-health-with-powershell-part-2.aspx)  
  
     [PowerShell을 사용하여 Always On 상태 모니터링 - 3부: 간단한 응용 프로그램 모니터링](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/02/15/monitoring-Always%20On-health-with-powershell-part-3.aspx)  
  
     [PowerShell을 사용하여 Always On 상태 모니터링 - 4부: SQL Server 에이전트와의 통합](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/02/15/the-always-on-health-model-part-4.aspx)  
...
## 참고 항목  
 ...
 [AlwaysOn 가용성 그룹 동적 관리 뷰 및 함수&#40;Transact-SQL&#41;](../../../relational-databases/system-dynamic-management-views/always-on-availability-groups-dynamic-management-views-functions.md)   
