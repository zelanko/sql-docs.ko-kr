---
title: "개체 탐색기 정보를 사용하여 가용성 그룹 모니터링(SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
manager: "jhubbard"
---
# 개체 탐색기 정보를 사용하여 가용성 그룹 모니터링(SQL Server Management Studio)
  이 항목에서는 [!INCLUDE[ssManStudioFull](../../../includes/ssmanstudiofull-md.md)]의 **개체 탐색기 정보** 창을 사용하여 기존 Always On 가용성 그룹, 가용성 복제본 및 가용성 데이터베이스를 모니터링하고 관리하는 방법에 대해 설명합니다.  
