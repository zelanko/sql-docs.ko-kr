---
title: 가용성 그룹 관리에 대한 참조
description: 속성 변경, 복제본 추가 또는 제거, 데이터베이스 추가 또는 제거, 장애 조치, 수신기 구성 등과 같은 Always On 가용성 그룹 관리의 기본 사항으로 연결되는 참조 페이지입니다.
ms.custom: seodec18
ms.date: 05/17/2016
ms.prod: sql
ms.reviewer: ''
