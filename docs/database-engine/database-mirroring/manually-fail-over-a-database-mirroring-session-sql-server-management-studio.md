...
|서버|장애 조치(failover) 전|장애 조치(failover) 후|  
|------------|---------------------|--------------------|  
...
## <a name="see-also"></a>참고 항목  
 ...
 [데이터베이스 미러링 세션 수동 장애 조치&#40;Transact-SQL&#41;](../../database-engine/database-mirroring/manually-fail-over-a-database-mirroring-session-transact-sql.md)   
