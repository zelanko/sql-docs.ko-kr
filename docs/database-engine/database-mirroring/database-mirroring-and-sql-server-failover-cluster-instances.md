...
description: SQL Server 장애 조치(failover) 클러스터 인스턴스와 데이터베이스 미러링을 결합할 수 있습니다. 장애 조치(failover)를 사용하거나 사용하지 않는 성능 우선 모드 및 보호 우선 모드에 대해 알아봅니다.
