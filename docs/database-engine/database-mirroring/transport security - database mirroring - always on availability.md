---
title: "데이터베이스 미러링 및 Always On 가용성 그룹에 대한 전송 보안(SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
### 인증서  
 ...
 암호화 방법은 인증서를 만들 때 결정됩니다. 자세한 내용은 [데이터베이스 미러링 끝점의 아웃바운드 연결에 대한 인증서 사용 허용&#40;Transact-SQL&#41;](../../database-engine/database-mirroring/database mirroring - use certificates for outbound connections.md)을 참조하세요. 인증서는 신중하게 관리해야 합니다.  
...
> [!NOTE]  
>  [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 에서는 암호화를 필요로 하거나 암호화가 해제된 상태로 미러링 끝점을 만듭니다. 암호화 설정을 SUPPORTED로 변경하려면 ALTER ENDPOINT [!INCLUDE[tsql](../../includes/tsql-md.md)] 문을 사용합니다. 자세한 내용은 [ALTER ENDPOINT&#40;Transact-SQL&#41;](../../t-sql/statements/alter-endpoint-transact-sql.md)를 참조하세요.  
