...
## 자동 장애 조치 중 서비스 중단 예측  
 ...
 ![오류 감지 및 장애 조치(Failover) 시간](../../database-engine/database-mirroring/media/dbm-failovauto-time.gif "오류 감지 및 장애 조치(Failover) 시간")  
