---
title: 데이터베이스 미러링 준비
description: SQL Server에서 SQL Server Management Studio 또는 Transact-SQL을 사용하여 SQL Server 데이터베이스의 데이터베이스 미러링을 준비하는 방법을 알아봅니다.
...
##  <a name="to-prepare-a-new-mirror-database"></a><a name="CombinedProcedure"></a> 새 미러 데이터베이스를 준비하려면  
 **미러 데이터베이스를 준비하려면**  
