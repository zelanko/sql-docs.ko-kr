...
description: SQL Server에서 SQL Server Management Studio 또는 Transact-SQL을 사용하여 데이터베이스에서 데이터베이스 미러링을 제거하는 방법을 알아봅니다.
ms.custom: ''
ms.date: 05/17/2016
ms.prod: sql
...
##  <a name="follow-up-removing-database-mirroring"></a><a name="FollowUp"></a> 후속 작업: 데이터베이스 미러링 제거  
