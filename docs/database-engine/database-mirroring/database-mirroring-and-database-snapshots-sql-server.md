...
helpviewer_keywords: 
  ...
  - "스냅숏 [SQL Server 데이터베이스 스냅숏], 데이터베이스 미러링"
  - "데이터베이스 스냅숏 [SQL Server], 데이터베이스 미러링"
...
---
# 데이터베이스 미러링 및 데이터베이스 스냅숏(SQL Server)
...
> [!NOTE]  
>  데이터베이스 스냅숏에 대한 자세한 내용은 [데이터베이스 미러링 및 데이터베이스 스냅숏&#40;SQL Server&#41;](../../relational-databases/databases/database-snapshots-sql-server.md)을 참조하세요.  
