---
title: "Windows 인증을 사용하여 데이터베이스 미러링 끝점에 대한 네트워크 액세스 허용(SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## 예제  
 다음 [!INCLUDE[tsql](../../includes/tsql-md.md)] 예에서는 `Otheruser` 도메인에 속하는 `Adomain` 사용자 계정에 대해 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 로그인을 만듭니다. 그런 다음 `Mirroring_Endpoint`라는 미리 작성된 데이터베이스 미러링 끝점에 연결할 수 있는 권한을 이 사용자에게 부여합니다.  
