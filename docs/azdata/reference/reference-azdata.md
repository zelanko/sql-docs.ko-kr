...
|[azdata arc](reference-azdata-arc.md) | Azure 데이터 서비스에 대하여 Azure Arc를 사용하기 위한 명령입니다. |
...
|[azdata postgres](reference-azdata-postgres.md) | Postgres 쿼리 실행기 및 대화형 셸입니다. |
