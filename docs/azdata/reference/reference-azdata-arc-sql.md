---
title: azdata arc sql 참조
titleSuffix: SQL Server big data clusters
description: azdata arc sql 명령에 대한 참조 문서입니다.
author: MikeRayMSFT
ms.author: mikeray
ms.reviewer: seanw
ms.date: 09/22/2020
...
|명령|설명|
| --- | --- |
[azdata arc sql mi](reference-azdata-arc-sql-mi.md) | SQL 관리형 인스턴스를 만들고, 삭제하고, 관리합니다.
