...
| 명령 | 설명 |
| --- | --- |
[azdata sql shell](#azdata-sql-shell) | SQL Database CLI를 사용하여 사용자가 T-SQL을 통해 SQL Server를 조작할 수 있습니다.
[azdata sql query](#azdata-sql-query) | query 명령을 사용하여 T-SQL 쿼리를 실행할 수 있습니다.
## <a name="azdata-sql-shell"></a>azdata sql shell
SQL Database CLI를 사용하여 사용자가 T-SQL을 통해 SQL Server를 조작할 수 있습니다.
```bash
azdata sql shell 
```
