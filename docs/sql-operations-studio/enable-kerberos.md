---
title: SQL Operations Studio (미리 보기)를 사용 하 여 연결할 때 Active Directory 인증 (Kerberos)을 사용 하 여 | Microsoft Docs
description: SQL Operations Studio (미리 보기)에 대 한 Active Directory 인증을 사용 하는 Kerberos를 사용 하는 방법 알아보기
ms.custom: tools|sos
ms.date: 11/17/2017
ms.prod: sql
...
편집 된 `/etc/krb5.conf` 원하는 편집기에서. 다음 키를 구성 합니다.
