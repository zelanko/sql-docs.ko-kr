---
title: SQL Operations Studio (미리 보기) SQL Server Profiler 확장 | Microsoft Docs
description: SQL Operations Studio (미리 보기)에 대 한 SQL Server Profiler 확장
ms.custom: tools|sos
ms.date: 07/19/2018
...
ms.locfileid: "39147024"
---
# <a name="sql-server-profiler-extension"></a>SQL Server Profiler 확장

확장 제외 하 고 SQL Server Management Studio (SSMS) Profiler 비슷합니다는 간단한 SQL Server 추적 솔루션을 제공 하는 SQL Server Profiler Xevent를 사용 하 여 작성 합니다. SQL Server Profiler는 매우 쉽게 사용할 수 있으며 가장 일반적인 추적 구성에 대 한 좋은 기본값. UX는 이벤트를 통해 검색 및 연관 된 TRANSACT-SQL (T-SQL) 텍스트를 보기 위해 최적화 됩니다. SQL Operations Studio 대 한 SQL Server Profiler를 사용 하기 쉬운 사용자 환경을 사용 하 여 T-SQL 실행 작업을 수집 하기 위한 좋은 기본값 가정
