...
저장 프로시저를 사용하여 프로덕션에 R 코드를 배포하는 보다 포괄적인 예제는 [자습서: SQL 개발자를 위한 R 데이터 분석](../../machine-learning/tutorials/sqldev-in-database-r-for-sql-developers.md)에서 확인할 수 있습니다.
...
+ [SQL Server R Services 성능 조정](../../machine-learning/r/sql-server-r-services-performance-tuning.md)
