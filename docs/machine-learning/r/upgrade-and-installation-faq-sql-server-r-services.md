---
title: 설치 및 업그레이드 FAQ
description: SQL Server의 기계 학습 기능 설치 및 업그레이드에 대한 일반적인 질문에 대한 답변입니다.
ms.prod: sql
...
ms.locfileid: "86300225"
---
# <a name="installation-and-upgrade-faq-for-sql-server-machine-learning-or-r-server"></a>SQL Server 기계 학습 또는 R Server 설치 및 업그레이드 FAQ
 [!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

이 문서에서는 SQL Server의 기계 학습 기능 설치에 대한 일반적인 질문에 대한 답변을 제공합니다. 또한 업그레이드에 대한 일반적인 질문을 다룹니다.
