...
+ 다시 시작 일치 솔루션을 위해 SQL 최적화에 사용되는 스크립트: [GitHub 리포지토리](https://github.com/Microsoft/SQL-Server-R-Services-Samples/tree/master/SQLOptimizationTips)
...
+ [R에 대한 리소스 풀을 만드는 방법](how-to-create-a-resource-pool-for-r.md)
