...
Microsoft R Open     |변경 없음 CTP 2.0을 사용 하 여|
Microsoft R Server     |변경 없음 CTP 2.0을 사용 하 여|
Microsoft Python 열기     |변경 없음 CTP 2.0을 사용 하 여|
Microsoft Python 서버    |변경 없음 CTP 2.0을 사용 하 여|
