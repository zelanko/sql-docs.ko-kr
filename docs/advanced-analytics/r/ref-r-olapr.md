...
Product | 위치 |
--------|----------|
SQL Server 2017 Machine Learning Services (R 통합) | C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\R_SERVICES\library | 
...
(Azure)에서 SQL Server Virtual Machine <sup>1</sup> | C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\R_SERVICES\library |
