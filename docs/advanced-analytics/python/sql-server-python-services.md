---
title: SQL Server 컴퓨터 학습 python 서비스 | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "31201995"
---
# <a name="sql-server-machine-learning-services-with-python"></a>Python 사용 하 여 서비스를 학습 하는 SQL Server 컴퓨터
