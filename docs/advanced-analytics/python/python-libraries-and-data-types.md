...
Python은 SQL Server에 비해 데이터 형식의 제한 된 수를 지원합니다.

결과적으로, 데이터를 사용할 때마다 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Python 스크립트에서 데이터 변환 될 수 있습니다 암시적으로 호환 되는 데이터 형식입니다. 그러나는 정확한 변환을 자동으로 수행할 수 없는 경우가 많습니다 하 고 오류가 반환 됩니다.
