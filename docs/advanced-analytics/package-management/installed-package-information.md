...
MicrosoftML 및 olapR SQL Server 2017의 Machine Learning 서비스에서 기본적으로 제공 됩니다. SQL Server 2016 R Services 인스턴스를 통해 이러한 패키지를 추가할 수 있습니다는 [구성 요소 업그레이드](../install/upgrade-r-and-python.md)합니다. 구성 요소 업그레이드도에서는 최신 버전의 패키지 (예를 들어: RevoScaleR의 최신 버전 SQL Server에서 패키지 관리에 대 한 함수 포함).
...
| Python 사용 하 여 SQL Server 2017 |C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\PYTHON_SERVICES\Lib\site-packages |
