...
이번 섹션에서 원격 계산 컨텍스트를 [!INCLUDE[rsql_productname](../../includes/rsql-productname-md.md)]의 몇 가지 함수를 시도해 보겠습니다. 데이터 소스에 R 함수를 적용하면 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 데이터를 탐색, 요약, 차트로 작성할 수 있습니다.
