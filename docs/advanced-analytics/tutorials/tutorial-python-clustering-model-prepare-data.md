---
title: '자습서: Python에서 클러스터링을 수행 하기 위해 데이터 준비'
...
ms.locfileid: "70238672"
---
# <a name="tutorial-prepare-data-to-perform-clustering-in-python-with-sql-server-machine-learning-services"></a>자습서: SQL Server Machine Learning Services를 사용 하 여 Python에서 클러스터링을 수행 하기 위해 데이터 준비

네 부분으로 구성 된 자습서 시리즈의 2 부에서는 Python을 사용 하 여 SQL database에서 데이터를 가져오고 준비 합니다. 이 시리즈의 뒷부분에서이 데이터를 사용 하 여 SQL Server Machine Learning Services으로 Python에서 클러스터링 모델을 학습 하 고 배포 합니다.
...
* 이 자습서의 2 부에서는 [**1 부**](tutorial-python-clustering-model.md)의 전제 조건을 충족 했다고 가정 합니다.
...
> [자습서: SQL Server Machine Learning Services를 사용 하 여 Python에서 예측 모델 만들기](tutorial-python-clustering-model-build.md)
