...
description: RevoScaleR 함수를 사용하여 SQL Server에서 사용자 지정 R 스크립트를 실행하는 방법에 대 한 자습서 연습입니다.
ms.prod: sql
...
ms.locfileid: "73726549"
---
# <a name="run-custom-r-functions-on-sql-server-using-rxexec"></a>rxExec를 사용하여 SQL Server에서 사용자 지정 R 함수 실행
...
+ 모든 종속 항목을 포함하여 함수에 사용되는 오픈 소스 또는 타사 라이브러리를 SQL Server에 설치해야 합니다. 자세한 내용은 [새 R 패키지 설치](../r/install-additional-r-packages-on-sql-server.md)를 참조하세요.
