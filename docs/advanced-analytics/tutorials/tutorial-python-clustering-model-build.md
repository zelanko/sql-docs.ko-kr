---
title: '자습서: Python에서 클러스터링 모델 빌드'
...
ms.locfileid: "70238712"
---
# <a name="tutorial-build-a-clustering-model-in-python-with-sql-server-machine-learning-services"></a>자습서: SQL Server Machine Learning Services를 사용 하 여 Python에서 클러스터링 모델 빌드
...
* 이 자습서의 3 부에서는 [**1**](tutorial-python-clustering-model.md)부의 전제 조건을 충족 했으며 [**2 부**](tutorial-python-clustering-model-prepare-data.md)의 단계를 완료 했다고 가정 합니다.
...
4 개의 클러스터는 [1 부](tutorial-python-clustering-model-prepare-data.md#separate-customers)에 정의 된 변수를 사용 하 여 제공 됩니다.
...
> [자습서: SQL Server Machine Learning Services를 사용 하 여 Python에 클러스터링 모델 배포](tutorial-python-clustering-model-deploy.md)