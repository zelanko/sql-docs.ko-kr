---
title: SQL Server Machine Learning 및 R Services에서 R 스크립팅 오류 | Microsoft Docs
ms.prod: sql
...
* [Sqlrutils 패키지를 사용 하 여 R 코드에 대 한 저장된 프로시저 생성](r/generating-an-r-stored-procedure-for-r-code-using-the-sqlrutils-package.md)
