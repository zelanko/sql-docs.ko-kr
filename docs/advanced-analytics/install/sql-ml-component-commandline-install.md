---
title: R 및 Python 구성 요소-SQL Server Machine Learning의 명령 프롬프트 설치
...
SQL Server\140 \Program files\Microsoft (또는 130)로 이동 \R_SERVER\bin\x64 R 콘솔 창을 열고를 두 번 클릭 **RGui.exe**합니다. R을 처음 사용하세요? 이 자습서를 시도해 보세요. [기본 R 명령 및 RevoScaleR 함수: 일반적인 예로 25](https://docs.microsoft.com/machine-learning-server/r/tutorial-r-to-revoscaler)합니다.
