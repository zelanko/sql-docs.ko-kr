---
title: R 및 Python 구성 요소용 명령 프롬프트 설치
...
설치 또는 업그레이드에 도움이 필요하세요? 일반적인 질문과 알려진 문제에 대한 답변은 다음 문서를 참조하세요.

* [업그레이드 및 설치 FAQ - Machine Learning Services](../r/upgrade-and-installation-faq-sql-server-r-services.md)

인스턴스의 설치 상태를 확인하고 일반적인 문제를 해결하려면 이러한 사용자 지정 보고서를 시도합니다.

* [SQL Server용 사용자 지정 보고서](../r/monitor-r-services-using-custom-reports-in-management-studio.md)
