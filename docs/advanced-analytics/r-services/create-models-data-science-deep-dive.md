---
title: "모델 만들기(데이터 과학 심층 분석) | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
## 로지스틱 회귀 모델 만들기  
이제 특정 고객이 사기 위험인지 여부를 나타내는 로지스틱 회귀 모델을 만듭니다.  
  
원격 계산 컨텍스트에서 로지스틱 회귀 분석 모델의 맞춤을 지원하는 *rxLogit* 함수(**RevoScaleR** 패키지에 포함되어 있음)를 사용합니다.  
...
## 다음 단계  
[새 데이터 점수 매기기&#40;데이터 과학 심층 분석&#41;](../../advanced-analytics/r-services/score-new-data-data-science-deep-dive.md)  
