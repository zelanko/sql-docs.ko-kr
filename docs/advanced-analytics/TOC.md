...
### [데이터베이스 내 분석](r/sql-server-r-services.md)
### [독립 실행형 서버](r/r-server-standalone.md)
...
# [아키텍처](architecture-overview-machine-learning.md)
...
### [Machine Learning Services의 Python](python/sql-server-python-services.md)
...
## R
### [R 및 SQL의 Hello World](tutorials/rtsql-using-r-code-in-transact-sql-quickstart.md)
### [입력 및 출력 처리](tutorials/rtsql-working-with-inputs-and-outputs.md)
### [데이터 형식 및 개체 처리](tutorials/rtsql-r-and-sql-data-types-and-data-objects.md)
### [예측 모델 만들기](tutorials/rtsql-create-a-predictive-model-r.md)
### [모델에서 예측 및 그리기](tutorials/rtsql-predict-and-plot-from-model.md)

# [자습서](tutorials/machine-learning-services-tutorials.md)
## [R](tutorials/sql-server-r-tutorials.md)
### [데이터베이스 내 분석 알아보기](tutorials/sqldev-in-database-r-for-sql-developers.md)
...
#### [3 - 데이터 시각화](tutorials/sqldev-explore-and-visualize-the-data.md)
#### [4 - 데이터 기능 만들기](tutorials/sqldev-create-data-features-using-t-sql.md)
...
#### [그래프 및 플롯 만들기](tutorials/walkthrough-create-graphs-and-plots-using-r.md)
#### [데이터 기능 만들기](tutorials/walkthrough-create-data-features.md)
#### [모델 작성 및 저장](tutorials/walkthrough-build-and-save-the-model.md)
#### [모델 배포 및 사용](tutorials/walkthrough-deploy-and-use-the-model.md)

### [RevoScaleR 심층 분석](tutorials/deepdive-data-science-deep-dive-using-the-revoscaler-packages.md)
#### [데이터베이스 및 사용 권한 만들기](tutorials/deepdive-work-with-sql-server-data-using-r.md)
#### [RxSqlServerData를 사용하여 데이터 개체 만들기](tutorials/deepdive-create-sql-server-data-objects-using-rxsqlserverdata.md)
#### [데이터 쿼리 및 수정](tutorials/deepdive-query-and-modify-the-sql-server-data.md)
#### [계산 컨텍스트 정의](tutorials/deepdive-define-and-use-compute-contexts.md)
#### [R 스크립트 만들기 및 실행](tutorials/deepdive-create-and-run-r-scripts.md)
#### [데이터 시각화](tutorials/deepdive-visualize-sql-server-data-using-r.md)
#### [모델 만들기](tutorials/deepdive-create-models.md)
#### [새 데이터 점수 매기기](tutorials/deepdive-score-new-data.md)
#### [데이터 변환](tutorials/deepdive-transform-data-using-r.md)
#### [rxImport를 사용하여 메모리에 데이터 로드](tutorials/deepdive-load-data-into-memory-using-rximport.md)
#### [rxDataStep을 사용하여 테이블 만들기](tutorials/deepdive-create-new-sql-server-table-using-rxdatastep.md)
...
### [데이터베이스 내 분석 알아보기](tutorials/sqldev-in-database-python-for-sql-developers.md)
#### [데이터 및 스크립트 가져오기](tutorials/sqldev-py1-download-the-sample-data.md)
#### [데이터 가져오기](tutorials/sqldev-py2-import-data-to-sql-server-using-powershell.md)
#### [데이터 탐색 및 시각화](tutorials/sqldev-py3-explore-and-visualize-the-data.md)
#### [데이터 기능 만들기](tutorials/sqldev-py4-create-data-features-using-t-sql.md)
...
# [샘플](https://github.com/Microsoft/sql-server-samples)

# [솔루션](tutorials/data-science-scenarios-and-solution-templates.md)
...
# [패키지 참조](r/machine-learning-services-r-reference.md)

## [SQL의 MicrosoftML](using-the-microsoftml-package.md)
## [SQL의 RevoScaleR](r/revoscaler-overview.md)
## [SQL Server 데이터에 대한 RevoScaleR 함수 목록](r/scaler-functions-for-working-with-sql-server-data.md)
## [SQL의 sqlrutils](r/generating-an-r-stored-procedure-for-r-code-using-the-sqlrutils-package.md)
## [SQL의 olapR](r/how-to-create-mdx-queries-using-olapr.md)
## [SQL의 revoscalepy](python/what-is-revoscalepy.md)
