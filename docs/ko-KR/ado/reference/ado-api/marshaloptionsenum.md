...
ms.author: genemi
manager: craigg
ms.openlocfilehash: c7b6e43caea913105f2f1bf89268f3ee16f52409
...
서버에 반환 해야 하는 레코드를 지정 합니다.  
  
|상수|Value|Description|  
|--------------|-----------|-----------------|  
|**adMarshalAll**|0|기본. 서버에 모든 행을 반환합니다.|  
|**adMarshalModifiedOnly**|1.|반환 서버에는 행만 수정 됩니다.|  
