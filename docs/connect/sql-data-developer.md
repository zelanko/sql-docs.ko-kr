...
* [Entity Framework](https://msdn.microsoft.com/library/gg696172.aspx): Entity Framework를 사용하여 SQL Server에 대한 직접 액세스와 EDM(엔터티 데이터 모델)과 원시 관계형 구조 간 매핑을 제어하는 옵션과 함께 LINQ를 사용하여 데이터베이스에 쉽게 액세스할 수 있습니다. 
* [WCF(Windows Communication Foundation)](https://msdn.microsoft.com/library/dd456779.aspx): 거의 턴키에 가까운 솔루션을 위한 Data Services를 사용하여 웹과 인트라넷 모두에서 OData 서비스를 쉽게 만들고 사용할 수 있습니다.
* [Sync Framework](https://msdn.microsoft.com/library/jj839436.aspx) Sync Framework를 사용하여 모든 데이터 형식, 데이터 저장소, 전송 프로토콜 및 네트워크 토폴로지에 대한 오프라인 액세스를 설정할 수 있습니다.
* [사후 확장](https://msdn.microsoft.com/library/hh242985.aspx) Rx(사후 확장)를 사용하여 이벤트 스트림 프로그래밍을 수행하고 관찰 가능한 시퀀스 및 LINQ 스타일 쿼리 연산자를 사용하여 비동기 프로그래밍을 단순화할 수 있습니다.  RxJS(JavaScript용 사후 확장)를 통해 관찰 가능한 시퀀스를 사용하여 웹에서 비동기 콜백 기반 프로그래밍 및 이벤트 구동 프로그래밍을 단순화할 수 있습니다.
