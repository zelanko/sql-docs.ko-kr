...
1. [Microsoft SQL Server를 프로그래밍 하는 클라이언트에 대 한 홈 페이지](homepage-sql-connection-programming.md)
2. [Azure Active Directory 인증을 사용 하 여 연결](php/azure-active-directory.md)
3. [유휴 연결 복원 력](php/connection-resiliency.md)
4. [PHP Linux 및 Mac 드라이버 설치 자습서](php/installation-tutorial-linux-mac.md)
5. [Microsoft SQL 데이터베이스에 대 한 연결 모듈](sql-connection-libraries.md)
