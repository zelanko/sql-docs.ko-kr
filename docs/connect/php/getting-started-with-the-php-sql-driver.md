---
title: Microsoft Drivers for PHP 시작
description: Microsoft Drivers for PHP for SQL Server를 사용하고 드라이버를 PHP 프로세스 공간으로 로드하기 위한 시스템 요구 사항에 대해 알아봅니다.
ms.custom: ''
ms.date: 03/26/2018
ms.prod: sql
...
[예제 애플리케이션&#40;SQLSRV 드라이버&#41;](example-application-sqlsrv-driver.md)
