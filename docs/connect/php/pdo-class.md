...
ms.author: genemi
manager: craigg
ms.openlocfilehash: 0632ab16741efa041a518f50656858a507218f65
...
PDO 클래스는 PHP 응용 프로그램을 [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] 인스턴스에 연결할 수 있는 메서드를 포함합니다.  
