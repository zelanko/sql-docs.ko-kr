...
## <a name="remarks"></a>주의  
Pdo:: query를 사용 하 여 실행 하는 쿼리는 준비 된 문을 실행할 수 있습니다 또는 SQLSRV_ATTR_DIRECT_QUERY의 설정에 따라 직접 참조 [직접 문 실행 및 준비 된 문 실행 PDO_SQLSRV 드라이버에서](../../connect/php/direct-statement-execution-prepared-statement-execution-pdo-sqlsrv-driver.md) 자세한 정보에 대 한 합니다.  
  
Pdo:: SQLSRV_ATTR_QUERY_TIMEOUT; exec의 동작을도 영향을 줍니다. 참조 [pdo:: setattribute](../../connect/php/pdo-setattribute.md) 자세한 정보에 대 한 합니다.  
