---
title: '방법: PDO_SQLSRV 드라이버를 사용하여 날짜 및 시간 형식을 PHP 날짜/시간 개체로 검색'
description: 이 항목에서는 Microsoft PDO_SQLSRV Driver for PHP를 사용할 때 날짜 및 시간 형식을 PHP 날짜/시간 개체로 검색하는 방법을 설명합니다.
ms.custom: ''
ms.date: 08/10/2020
ms.prod: sql
