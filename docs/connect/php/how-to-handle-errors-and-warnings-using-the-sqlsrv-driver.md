...
## <a name="example"></a>예제  
다음 코드 예제는 오류 및 경고를 처리하는 데 두 개의 사용자 정의 함수, 즉 **DisplayErrors** 및 **DisplayWarnings**를 사용합니다. 해당 예제에서 다음을 수행하여 경고와 오류를 별도로 처리하는 방법을 보여 줍니다.  
