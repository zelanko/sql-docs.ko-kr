---
title: Microsoft Drivers for PHP for SQL Server 개요
description: Microsoft SQLSRV 및 PDO_SQSRV Drivers for PHP for SQL Server의 개요 및 PHP 애플리케이션에서 데이터베이스 액세스를 위해 이러한 드라이버를 사용하는 방법을 알아봅니다.
ms.custom: ''
ms.date: 03/27/2018
ms.prod: sql
