...
ms.locfileid: "42785653"
---
# <a name="connecting-to-the-server"></a>서버에 연결
[!INCLUDE[Driver_PHP_Download](../../includes/driver_php_download.md)]

이 섹션의 항목에서는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 를 [!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)]에 연결하기 위한 옵션 및 절차를 설명합니다.  
