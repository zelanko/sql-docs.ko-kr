---
title: SQL Server용 PHP 드라이버와 함께 Always Encrypted 사용
description: SQL Server용 PHP 드라이버와 함께 Always Encrypted를 사용하여 애플리케이션의 중요한 데이터를 보호하는 방법을 알아봅니다.
ms.date: 12/12/2019
ms.prod: sql
