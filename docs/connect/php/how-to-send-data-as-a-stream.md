---
title: '방법: 데이터를 스트림으로 보내기 | Microsoft Docs'
ms.custom: ''
ms.date: 02/28/2019
ms.prod: sql
...
## <a name="example-sending-stream-data-at-execution"></a>예제: 실행 시 스트림 데이터 보내기
...
## <a name="example-sending-stream-data-using-sqlsrvsendstreamdata"></a>예: sqlsrv_send_stream_data를 사용 하 여 스트림 데이터 보내기
...
## <a name="example-sending-an-image-as-a-stream"></a>예제: 이미지를 스트림으로 보내기 
