---
title: "PHP Linux 및 Mac 드라이버 설치 자습서 | Microsoft Docs"
ms.date: 07/13/2017
...
## <a name="installing-the-drivers-on-ubuntu-1510-for-php-70"></a>PHP 7.0에 대 한 Ubuntu 15.10에 드라이버 설치
패키지는 없습니다 PHP 7.1 Ubuntu 15.10에 사용할 수 있습니다.
...
```
설치를 테스트 하려면 참조 **설치 테스트에** 이 문서의 끝입니다.
 
## <a name="installing-the-drivers-on-ubuntu-1604-for-php-70"></a>PHP 7.0에 대 한 Ubuntu 16.04에 드라이버 설치
### <a name="step-1-install-php"></a>1단계. PHP 설치 
```
sudo su
apt-get update
...
설치를 테스트 하려면 참조 **설치 테스트에** 이 문서의 끝입니다.
 
## <a name="installing-the-drivers-on-ubuntu-1604-for-php-71"></a>Ubuntu 16.04 PHP 7.1 용 드라이버 설치
### <a name="step-1-install-php"></a>1단계. PHP 설치 
```
sudo su
...
설치를 테스트 하려면 참조 **설치 테스트에** 이 문서의 끝입니다.
 
## <a name="installing-the-drivers-on-red-hat-7-for-php-70-and-71"></a>Red Hat 7에서 PHP 7.0 및 7.1 용 드라이버를 설치
### <a name="step-1-install-php"></a>1단계. PHP 설치 
PHP 7.1을 설치 하려면 다음 명령에 remi php71 remi php70 바꿉니다. 
```
sudo su
...
설치를 테스트 하려면 참조 **설치 테스트에** 이 문서의 끝입니다.
 
## <a name="installing-the-drivers-on-debian-8-for-php-70"></a>PHP 7.0에 대 한 Debian 8에 드라이버 설치
### <a name="step-1-install-php"></a>1단계. PHP 설치 
```
sudo su
...
설치를 테스트 하려면 참조 **설치 테스트에** 이 문서의 끝입니다.
 
## <a name="installing-the-drivers-on-debian-8-for-php-71"></a>PHP 7.1 용 Debian 8에서 드라이버를 설치
### <a name="step-1-install-php"></a>1단계. PHP 설치 
```
sudo su
apt-get install curl apt-transport-https 
...
설치를 테스트 하려면 참조 **설치 테스트에** 이 문서의 끝입니다.
 
## <a name="installing-the-drivers-on-macos-el-capitan-and-sierra"></a>El Capitan MacOS 및 시에라에 드라이버 설치
### <a name="step-1-install-php"></a>1단계. PHP 설치 
PHP 7.1을 설치 하려면 다음 명령에 php71 php70을 바꿉니다.
```
...
이 샘플 스크립트를 테스트 하려면 in/var/www/html / (/ usr/local/var/www/htdocs MacOS에서) testsql.php 라는 파일 만들고 서버, 데이터베이스, 사용자 이름 및 암호를 적절 하 게 교체, 다음 스크립트를 복사 합니다. 
```
<?php
