...
---
# <a name="download-the-microsoft-drivers-for-php-for-sql-server"></a>SQL Server 용 Microsoft Drivers for PHP 다운로드

[!INCLUDE[Driver_PHP_Download](../../includes/driver_php_download.md)]

## <a name="windows"></a>Windows

다음 버전의 Windows에서 PHP에 대 한 드라이버 다운로드에 사용할 수 있습니다.
...
PHP에 대 한 드라이버 쉽게 다운로드 되 고 PECL Linux와 macOS에서 사용 하 여 설치 합니다. 참조는 [Linux와 macOS 설치 자습서](installation-tutorial-linux-mac.md) 대 한 자세한 내용은 합니다. Linux와 macOS에서 PHP에 대 한 드라이버를 수동으로 설치 해야 할 경우에 다음 버전은 다운로드할 수 있습니다.
...
[시스템 요구 사항을 Microsoft Drivers for PHP for SQL Server](system-requirements-for-the-php-sql-driver.md)
