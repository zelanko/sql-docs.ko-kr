...
|[Microsoft Drivers for PHP for SQL Server와 함께 Always Encrypted 사용](../../connect/php/using-always-encrypted-php-drivers.md)|PHP 드라이버와 함께 Always Encrypted 기능 사용에 대한 정보를 제공합니다.|  
|[Microsoft Drivers for PHP for SQL Server에 대한 보안 고려 사항](../../connect/php/security-considerations-for-php-sql-driver.md)|애플리케이션을 개발, 배포 및 실행하기 위한 보안 고려 사항을 설명합니다.|  
