---
title: "PHP SQL 드라이버 프로그래밍 가이드 | Microsoft Docs"
ms.custom: 
ms.date: 01/19/2017
...
---
# <a name="programming-guide-for-php-sql-driver"></a>PHP SQL 드라이버 프로그래밍 가이드
...
|[PHP SQL 드라이버 보안 고려 사항](../../connect/php/security-considerations-for-php-sql-driver.md)|응용 프로그램을 개발, 배포 및 실행하기 위한 보안 고려 사항을 설명합니다.|  
