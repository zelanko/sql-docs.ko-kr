---
title: 직접 문 - 준비된 문 실행 PDO_SQLSRV 드라이버
description: Microsoft PDO_SQLSRV Driver for PHP for SQL Server를 사용할 때 직접 문 실행에 PDO::SQLSRV_ATTR_DIRECT_QUERY 특성을 사용하는 방법을 알아봅니다.
ms.custom: ''
ms.date: 08/10/2020
ms.prod: sql
