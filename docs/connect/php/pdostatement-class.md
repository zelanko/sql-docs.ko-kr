---
title: PDOStatement 클래스
description: Microsoft PDO_SQLSRV Driver for PHP for SQL Server의 PDOStatement 클래스에 대한 API 참조입니다.
ms.custom: ''
ms.date: 08/10/2020
ms.prod: sql
