---
title: 커서 유형(PDO_SQLSRV 드라이버)
description: Microsoft PDO_SQLSRV Driver for PHP for SQL Server를 사용할 때 다양한 서버 쪽 및 클라이언트 쪽 커서와 사용자가 커서 유형을 지정하는 방법을 알아봅니다.
ms.custom: ''
ms.date: 08/10/2020
ms.prod: sql
...
ms.locfileid: "88680588"
---
# <a name="cursor-types-pdo_sqlsrv-driver"></a>커서 형식(PDO_SQLSRV 드라이버)
...
## <a name="pdo_sqlsrv-and-server-side-cursors"></a>PDO_SQLSRV 및 서버 쪽 커서
...
## <a name="pdo_sqlsrv-and-client-side-cursors"></a>PDO_SQLSRV 및 클라이언트 쪽 커서
