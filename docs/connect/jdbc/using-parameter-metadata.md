...
또한 SQL Server 2008 또는 2008 R2를 사용하는 경우 SQLServerParameterMetaData 클래스에 대해 MERGE 쿼리가 지원되지 않습니다. SQL Server 2012 이상 버전의 경우 복잡한 쿼리에서 매개 변수 메타데이터가 지원됩니다.  
