...
> [!NOTE]  
>  JDBC 드라이버에서는 OUT 매개 변수로 CURSOR, SQLVARIANT, TABLE 및 TIMESTAMP와 같은 [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] 데이터 형식을 사용할 수 없습니다.  
