---
title: MSSQL JDBC 드라이버에 샘플에 대 한 공간 데이터 형식 | Microsoft Docs
ms.custom: ''
ms.date: 07/30/2018
ms.prod: sql
...
이 샘플 응용 프로그램을 실행하려면 mssql-jdbc jar 파일을 포함하도록 클래스 경로를 설정해야 합니다. 클래스 경로 설정 하는 방법에 대 한 자세한 내용은 참조 하세요. [JDBC 드라이버를 사용 하 여](../../connect/jdbc/using-the-jdbc-driver.md)입니다.  
...
[JDBC 데이터 형식 사용](../../connect/jdbc/working-with-data-types-jdbc.md)  
