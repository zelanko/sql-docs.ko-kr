---
title: 샘플 JDBC 드라이버 응용 프로그램 | Microsoft Docs
ms.custom: ''
ms.date: 07/31/2018
ms.prod: sql
...
| [SQL 데이터 검색 및 분류](../../connect/jdbc/data-discovery-classification-sample.md) | 이 샘플 응용 프로그램 방법을 검색 하려면 데이터 검색 및 분류 정보에 포함 하는 방법을 보여 줍니다는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] JDBC 드라이버를 사용 하 여 결과 집합 개체의 데이터베이스입니다.                                      |
