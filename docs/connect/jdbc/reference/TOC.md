# [JDBC 드라이버 API 참조](jdbc-driver-api-reference.md)
...
### [setDisableStatementPooling 메서드(SQLServerConnection)](setdisablestatementpooling-method-sqlserverconnection.md)
