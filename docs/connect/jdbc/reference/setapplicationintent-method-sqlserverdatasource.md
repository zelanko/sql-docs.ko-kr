 ...
 **applicationIntent** 연결 속성의 새 값입니다.  
  
## <a name="remarks"></a>설명  
 **applicationIntent** 연결 속성에 대한 자세한 내용은 [연결 속성 설정](../../../connect/jdbc/setting-the-connection-properties.md)을 참조하세요.  
