---
description: SQLServerConnection 멤버
...
|[closeUnreferencedPreparedStatementHandles](../../../connect/jdbc/reference/closeunreferencedpreparedstatementhandles-method-sqlserverconnection.md)|해결되지 않아 삭제된 준비 문에 대해 준비 취소 요청을 강제로 실행합니다.| 
...
|[createBlob](../../../connect/jdbc/reference/createblob-method-sqlserverconnection.md)|데이터가 없는 **java.sql.Blob** 개체를 만듭니다.|  
|[createClob](../../../connect/jdbc/reference/createclob-method-sqlserverconnection.md)|데이터가 없는 **java.sql.Clob** 개체를 만듭니다.|  
|[createNClob](../../../connect/jdbc/reference/createnclob-method-sqlserverconnection.md)|데이터가 없는 **java.sql.NClob** 개체를 만듭니다.|  
...
|[createSQLXML](../../../connect/jdbc/reference/createsqlxml-method-sqlserverconnection.md)|데이터가 없는 **java.sql.SQLXML** 개체를 만듭니다.|  
...
|[isStatementPoolingEnabled](../../../connect/jdbc/reference/isstatementpoolingenabled-method-sqlserverconnection.md)|이 연결에 대한 문 풀링의 사용 설정 여부를 반환합니다.|  
...
|[setStatementPoolingCacheSize](../../../connect/jdbc/reference/setstatementpoolingcachesize-method-sqlserverconnection.md)|준비된 문 캐시의 크기를 이 연결에 설정합니다.|  
