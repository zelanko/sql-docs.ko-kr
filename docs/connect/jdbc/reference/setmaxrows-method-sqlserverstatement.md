...
## <a name="remarks"></a>설명  
 ...
 SET ROWCOUNT SQL 문에 대한 자세한 내용은 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 온라인 설명서의 “[SET ROWCOUNT(Transact-SQL)](../../../t-sql/statements/set-rowcount-transact-sql.md)” 항목을 참조하십시오.  
