---
title: setInt 메서드 (SQLServerPreparedStatement) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.openlocfilehash: 3221c44e1d7417e5daf71ba18e3e7ebdced039a3
...
## <a name="remarks"></a>주의  
 이 setInt 메서드는 java.sql.PreparedStatement 인터페이스의 setInt 메서드에 의해 지정 됩니다.  
