...
|[position](../../../connect/jdbc/reference/position-method-sqlservernclob.md)|지정 된 문자 위치를 검색 **java.sql.NClob** 부분 문자열 또는 개체를 **java.sql.NClob** 지정 된 시작 위치를 기준으로 합니다.|  
