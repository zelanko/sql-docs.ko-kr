---
description: updateAsciiStream 메서드(java.lang.String, java.io.InputStream, int)
title: updateAsciiStream 메서드(java.lang.String, java.io.InputStream, int)
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
