...
|[getBinaryStream &#40;java. lang&#41;](../../../connect/jdbc/reference/getbinarystream-java-lang-string.md)|매개 변수 이름이 지정된 경우 지정된 매개 변수의 값을 검색하여 중단되지 않는 바이트의 이진 스트림으로 반환합니다.|  
