---
title: setDouble 메서드 (SQLServerPreparedStatement) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.openlocfilehash: 78f0f657b841564c15575e20cd65b7b1ef19db59
...
## <a name="remarks"></a>주의  
 이 setDouble 메서드는 java.sql.PreparedStatement 인터페이스의 setDouble 메서드에 의해 지정 됩니다.  
