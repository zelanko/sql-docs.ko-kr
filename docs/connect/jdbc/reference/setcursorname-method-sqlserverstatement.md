---
description: setCursorName 메서드(SQLServerStatement)
...
> [!NOTE]  
>  [!INCLUDE[jdbcNoVersion](../../../includes/jdbcnoversion_md.md)]에서는 현재 이 메서드가 지원되지 않습니다. 이 메서드를 호출해도 아무런 효과가 나타나지 않습니다.  
