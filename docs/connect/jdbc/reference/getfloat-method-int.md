...
## <a name="remarks"></a>Remarks  
 이 getInt 메서드는 java.sql.CallableStatement 인터페이스의 getInt 메서드에 의해 지정됩니다.  
  
 이 메서드는 Java정확성이 유지되는 모든 숫자 기반 형식을 반환합니다.  
  
## <a name="see-also"></a>참고 항목  
 [getInt 메서드&#40;SQLServerCallableStatement&#41;](../../../connect/jdbc/reference/getfloat-method-sqlservercallablestatement.md)   
