...
|속성|설명|  
|----------|-----------------|  
|[getApplicationIntent](../../../connect/jdbc/reference/getapplicationintent-method-sqlserverdatasource.md)|값을 반환 합니다 **applicationIntent** 연결 속성입니다.|  
...
|[getDisableStatementPooling](../../../connect/jdbc/reference/getdisablestatementpooling-method-sqlserverdatasource.md)|값을 반환 **disableStatementPooling** 연결 속성입니다. 이 설정은 문 풀링을 사용 하도록 설정할지 여부이 연결용 제어 합니다.|  
...
|[getMultiSubnetFailover](../../../connect/jdbc/reference/getmultisubnetfailover-method-sqlserverdatasource.md)|값을 반환 합니다 **multiSubnetFailover** 연결 속성입니다.|  
...
|[getSendTimeAsDatetime](../../../connect/jdbc/reference/getsendtimeasdatetime-method-sqlserverdatasource.md)|설정을 반환 합니다 **SendTimeAsDatetime** 연결 속성입니다.|  
...
|[getStatementPoolingCacheSize](../../../connect/jdbc/reference/getstatementpoolingcachesize-method-sqlserverdatasource.md)|이 연결에 대 한 준비 된 문 캐시의 크기를 반환합니다.|  
...
|[setApplicationIntent](../../../connect/jdbc/reference/setapplicationintent-method-sqlserverdatasource.md)|값을 설정 합니다 **applicationIntent** 연결 속성입니다.|  
...
|[setEnablePrepareOnFirstPreparedStatementCall](../../../connect/jdbc/reference/setenableprepareonfirstpreparedstatementcall-method-sqlserverdatasource.md)|새 값을 지정 합니다 **enablePrepareOnFirstPreparedStatementCall** 연결 속성입니다.|  
...
|[setMultiSubnetFailover](../../../connect/jdbc/reference/setmultisubnetfailover-method-sqlserverdatasource.md)|값을 설정 합니다 **multiSubnetFailover** 연결 속성입니다.|  
...
|[setServerPreparedStatementDiscardThreshold](../../../connect/jdbc/reference/setserverpreparedstatementdiscardthreshold-method-sqlserverdatasource.md)|새 값을 설정 합니다 **serverPreparedStatementDiscardThreshold** 연결 속성입니다.|  
