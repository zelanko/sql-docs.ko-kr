---
description: nullsAreSortedLow 메서드(SQLServerDatabaseMetaData)
...
## <a name="return-value"></a>Return Value  
 값이 하위에 정렬되면 **true**이고, 그렇지 않으면 **false**입니다.  
  
## <a name="exceptions"></a>예외  
 [SQLServerException](../../../connect/jdbc/reference/sqlserverexception-class.md)  
  
## <a name="remarks"></a>설명  
 이 nullsAreSortedLow 메서드는 java.sql.DatabaseMetaData 인터페이스의 nullsAreSortedLow 메서드에 의해 지정됩니다.  
