...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  다음 표에는 [SQLServerXADataSource](../../../connect/jdbc/reference/sqlserverxadatasource-class.md) 클래스에 의해 노출되는 멤버가 나와 있습니다.  
...
|[getApplicationName](../../../connect/jdbc/reference/getapplicationname-method-sqlserverdatasource.md)|[SQLServerDataSource](../../../connect/jdbc/reference/sqlserverdatasource-class.md)에서 상속되며, 응용 프로그램 이름을 반환합니다.|  
...
|[getMultiSubnetFailover](../../../connect/jdbc/reference/getmultisubnetfailover-method-sqlserverdatasource.md)|[SQLServerDataSource](../../../connect/jdbc/reference/sqlserverdatasource-class.md)에서 상속되며 **multiSubnetFailover** 연결 속성의 값을 검색합니다.|  
|[getPooledConnection](../../../connect/jdbc/reference/getpooledconnection-method-sqlserverconnectionpooldatasource.md)|[SQLServerConnectionPoolDataSource](../../../connect/jdbc/reference/sqlserverconnectionpooldatasource-class.md)에서 상속되며, 풀링된 연결로 사용할 수 있는 실제 데이터베이스 연결을 설정합니다.|  
...
|[getReference](../../../connect/jdbc/reference/getreference-method-sqlserverxadatasource.md)|이 [SQLServerXADataSource](../../../connect/jdbc/reference/sqlserverxadatasource-class.md) 개체에 대한 참조를 반환합니다.|  
...
|[setApplicationName](../../../connect/jdbc/reference/setapplicationname-method-sqlserverdatasource.md)|[SQLServerDataSource](../../../connect/jdbc/reference/sqlserverdatasource-class.md)에서 상속되며, 응용 프로그램 이름을 설정합니다.|  
|[setAuthenticationSceme](../../../connect/jdbc/reference/setauthenticationscheme-sqlserverdatasource.md)|[SQLServerDataSource](../../../connect/jdbc/reference/sqlserverdatasource-class.md)에서 상속되며 응용 프로그램에서 사용하려는 통합 보안의 종류를 나타냅니다.|  
...
|[setMultiSubnetFailover](../../../connect/jdbc/reference/setmultisubnetfailover-method-sqlserverdatasource.md)|(에서 상속 [SQLServerDataSource](../../../connect/jdbc/reference/sqlserverdatasource-class.md))의 값을 설정 합니다 **multiSubnetFailover** 연결 속성입니다.|  
...
|[unwrap](../../../connect/jdbc/reference/unwrap-method-sqlserverxadatasource.md)|[!INCLUDE[jdbcNoVersion](../../../includes/jdbcnoversion_md.md)] 관련 메서드에 액세스할 수 있도록 지정된 인터페이스를 구현하는 개체를 반환합니다.|  
