---
description: CONCUR_SS_SCROLL_LOCKS 필드(SQLServerResultSet)
title: CONCUR_SS_SCROLL_LOCKS 필드(SQLServerResultSet) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "88438015"
---
# <a name="concur_ss_scroll_locks-field-sqlserverresultset"></a>CONCUR_SS_SCROLL_LOCKS 필드(SQLServerResultSet)
