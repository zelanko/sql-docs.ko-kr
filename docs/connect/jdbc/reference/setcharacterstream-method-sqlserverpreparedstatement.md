...
|[setCharacterStream 메서드(int, java.io.Reader, long)](../../../connect/jdbc/reference/setcharacterstream-method-int-java-io-reader-long.md)|지정된 매개 변수를 지정된 문자 길이의 지정된 java.io.Reader 개체로 설정합니다.|  
