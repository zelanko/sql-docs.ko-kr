---
description: SQLServerSavepoint 멤버
title: SQLServerSavepoint 멤버 | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|[getSavepointName](../../../connect/jdbc/reference/getsavepointname-method-sqlserversavepoint.md)|저장점의 이름을 가져옵니다.|  
|[isNamed](../../../connect/jdbc/reference/isnamed-method-sqlserversavepoint.md)|저장점의 이름이 지정되었는지 확인합니다.|  
