---
description: getTimestamp 메서드(int, java.util.Calendar)(SQLServerResultSet)
title: getTimestamp 메서드(int, java.util.Calendar)(SQLServerResultSet) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
