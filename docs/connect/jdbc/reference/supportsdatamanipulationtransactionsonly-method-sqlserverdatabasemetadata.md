...
## <a name="remarks"></a>주의  
 이 supportsDataManipulationTransactionsOnly 메서드는 java.sql.DatabaseMetaData 인터페이스의 supportsDataManipulationTransactionsOnly 메서드에 의해 지정 됩니다.  
