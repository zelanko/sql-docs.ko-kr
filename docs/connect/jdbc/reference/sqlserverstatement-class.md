...
## <a name="remarks"></a>Remarks  
 ...
 이 클래스는 래핑 해제 클래스, ISQLServerStatement 인터페이스 및 SQLServerStatement 인터페이스를 지원 합니다. 자세한 내용은 [래퍼 및 인터페이스](../../../connect/jdbc/wrappers-and-interfaces.md)를 참조 하세요.  
