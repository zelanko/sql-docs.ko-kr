---
description: setBigDecimal 메서드(SQLServerPreparedStatement)
...
## <a name="remarks"></a>설명  
 이 setBigDecimal 메서드는 java.sql.PreparedStatement 인터페이스의 setBigDecimal 메서드에 의해 지정됩니다.  
