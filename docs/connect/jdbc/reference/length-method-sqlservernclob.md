---
title: "length 메서드 (SQLServerNClob) | Microsoft Docs"
ms.custom: 
ms.date: 01/19/2017
...
ms.openlocfilehash: e38dc24645a8ba230fa1b3d09c0cb7613c43ff9c
...
## <a name="remarks"></a>주의  
 이 길이 메서드 java.sql.NClob 인터페이스의 길이 메서드에 의해 지정 됩니다.  
