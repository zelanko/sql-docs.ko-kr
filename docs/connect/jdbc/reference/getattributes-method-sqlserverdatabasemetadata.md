---
description: getAttributes 메서드(SQLServerDatabaseMetaData)
...
## <a name="remarks"></a>설명  
 이 getAttributes 메서드는 java.sql.DatabaseMetaData 인터페이스의 getAttributes 메서드에 의해 지정됩니다.  
