---
title: free 메서드 (SQLServerBlob) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32828388"
---
# <a name="free-method-sqlserverblob"></a>free 메서드(SQLServerBlob)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  이 메서드는 BLOB 개체 및 이 개체가 보유한 리소스를 해제합니다.  
...
## <a name="remarks"></a>주의  
 이 무료 메서드는 java.sql.Blob 인터페이스의 사용 가능한 메서드에 의해 지정 됩니다.  
