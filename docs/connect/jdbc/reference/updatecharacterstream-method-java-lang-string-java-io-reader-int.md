---
description: updateCharacterStream 메서드(java.lang.String, java.io.Reader, int)
title: updateCharacterStream 메서드(java.lang.String, java.io.Reader, int)
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
