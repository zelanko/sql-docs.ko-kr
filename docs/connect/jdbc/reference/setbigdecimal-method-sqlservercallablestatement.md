---
description: setBigDecimal 메서드(SQLServerCallableStatement)
...
## <a name="remarks"></a>설명  
 이 setBigDecimal 메서드는 java.sql.CallableStatement 인터페이스의 setBigDecimal 메서드에 의해 지정됩니다.  
