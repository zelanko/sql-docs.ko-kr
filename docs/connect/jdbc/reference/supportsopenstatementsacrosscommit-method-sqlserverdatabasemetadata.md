---
description: supportsOpenStatementsAcrossCommit 메서드(SQLServerDatabaseMetaData)
title: supportsOpenStatementsAcrossCommit 메서드 | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>설명  
 이 supportsOpenStatementsAcrossCommit 메서드는 java.sql.DatabaseMetaData 인터페이스의 supportsOpenStatementsAcrossCommit 메서드에 의해 지정됩니다.  
