---
title: supportsOuterJoins 메서드(SQLServerDatabaseMetaData) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Remarks  
 이 supportsLimitedOuterJoins 메서드는 java.sql.DatabaseMetaData 인터페이스의 supportsLimitedOuterJoins 메서드에 의해 지정 됩니다.  
