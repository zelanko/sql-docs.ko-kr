---
description: getObject 메서드(int, java.util.Map)(SQLServerResultSet)
title: getObject 메서드(int, java.util.Map)(SQLServerResultSet) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  이 [SQLServerResultSet](../../../connect/jdbc/reference/sqlserverresultset-class.md) 개체의 현재 행에서 지정된 열 인덱스의 값을 지정된 Map 개체를 사용하여 Java 프로그래밍 언어의 개체로 가져옵니다.  
