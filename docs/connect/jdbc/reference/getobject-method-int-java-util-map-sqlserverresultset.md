...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  이 현재 행에서 지정 된 열 인덱스의 값을 가져옵니다 [SQLServerResultSet](../../../connect/jdbc/reference/sqlserverresultset-class.md) 프로그래밍 언어를 지정된 하는 맵 개체를 사용 하 여 Java의 개체로 개체입니다.  
