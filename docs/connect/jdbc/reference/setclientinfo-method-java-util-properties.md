...
## <a name="remarks"></a>Remarks  
 ...
 [!INCLUDE[jdbcNoVersion](../../../includes/jdbcnoversion_md.md)]에서는 클라이언트 정보 속성을 지원하지 않습니다. 이 메서드는 *properties* 입력 매개 변수가 빈 속성 집합을 참조하지 않을 경우 경고를 생성합니다. 즉, 이 메서드는 응용 프로그램에서 설정하려고 하는 속성에 대한 경고를 생성합니다. 응용 프로그램에서는 [SQLServerConnection](../../../connect/jdbc/reference/sqlserverconnection-class.md) 클래스의 [getWarnings](../../../connect/jdbc/reference/getwarnings-method-sqlserverconnection.md) 메서드를 사용하여 각 경고를 검색해야 합니다.  
