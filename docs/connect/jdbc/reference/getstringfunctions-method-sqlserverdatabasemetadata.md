...
ms.openlocfilehash: 62c6f91c9847ad3f775a5a3121f6b020a2d0eb3f
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  쉼표로 구분 된 목록을 검색 **문자열** 이 데이터베이스와 함께 사용할 수 있는 함수입니다.  
...
## <a name="return-value"></a>반환 값  
 A **문자열** 를 포함 하는 **문자열** 함수입니다.  
  
## <a name="exceptions"></a>예외  
 [SQLServerException](../../../connect/jdbc/reference/sqlserverexception-class.md)  
  
## <a name="remarks"></a>주의  
 이 getStringFunctions 메서드는 java.sql.DatabaseMetaData 인터페이스의 getStringFunctions 메서드에 의해 지정 됩니다.  
