---
title: 결과 집합 데이터 수정 샘플 | Microsoft Docs
ms.custom: ''
ms.date: 08/12/2019
ms.prod: sql
...
ms.locfileid: "69028328"
---
# <a name="modifying-result-set-data-sample"></a>결과 집합 데이터 수정 샘플

[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

이 [!INCLUDE[jdbcNoVersion](../../../includes/jdbcnoversion_md.md)] 애플리케이션 예제에서는 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 데이터베이스에서 업데이트 가능한 데이터 집합을 검색하는 방법을 보여 줍니다. 그런 다음, [SQLServerResultSet](../../../connect/jdbc/reference/sqlserverresultset-class.md) 개체의 메서드를 사용하여 데이터 행을 데이터 집합에 삽입하고 수정한 후, 마지막에는 데이터 집합에서 삭제합니다.
