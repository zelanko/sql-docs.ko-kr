...
|[JDBC 드라이버 사용](../../connect/jdbc/using-the-jdbc-driver.md)|Microsoft JDBC driver를 사용 하도록 환경을 구성 하는 방법 및 단순한 연결을 확인 하는 방법에 설명 된 [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] 데이터베이스입니다.|  
