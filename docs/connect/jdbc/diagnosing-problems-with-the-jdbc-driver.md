...
ms.locfileid: "47841501"
---
# <a name="diagnosing-problems-with-the-jdbc-driver"></a>JDBC 드라이버 관련 문제 진단
[!INCLUDE[Driver_JDBC_Download](../../includes/driver_jdbc_download.md)]

  응용 프로그램의 디자인 및 개발 정도에 관계없이 문제는 발생합니다. 문제가 발생하면 이러한 문제를 진단하는 기술을 보유하는 것이 중요합니다. [!INCLUDE[jdbcNoVersion](../../includes/jdbcnoversion_md.md)]를 사용할 때 자주 발생할 수 있는 문제에는 올바른 드라이버 버전이 없거나 데이터베이스에 연결할 수 없는 문제 등이 있습니다.  
