...
SQLServerDatabaseMetaData 개체를 만들려면 [SQLServerConnection](../../connect/jdbc/reference/getmetadata-method-sqlserverconnection.md) 클래스의 [getMetaData](../../connect/jdbc/reference/sqlserverconnection-class.md) 메서드를 사용하여 연결된 데이터베이스에 관한 정보를 가져옵니다.
