---
title: 데이터 형식 변환 이해
description: SQL Server용 JDBC Driver에서 JDBC와 데이터베이스 데이터 형식 간의 데이터 형식 변환을 처리하는 방법을 자세히 알아봅니다.
ms.custom: ''
ms.date: 08/12/2019
ms.prod: sql
...
[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 열 데이터 형식이 **XML**인 경우 데이터 값은 올바른 **XML**이어야 합니다. updateBytes, updateBinaryStream 또는 updateBlob 메서드를 호출하는 경우 데이터 값이 XML 문자의 16진수 문자열 표현이어야 합니다. 예를 들어:
