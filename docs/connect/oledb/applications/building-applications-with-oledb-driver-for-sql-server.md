---
title: SQL Server용 OLE DB 드라이버로 애플리케이션 빌드
description: OLE DB Driver for SQL Server를 사용하여 애플리케이션을 빌드할 때 발생하는 일반적인 문제 및 이전 OLE DB 드라이버에서 업그레이드할 때 발생할 수 있는 문제에 대해 알아봅니다.
ms.custom: ''
ms.date: 02/12/2019
ms.prod: sql
...
[!INCLUDE[Driver_OLEDB_Download](../../../includes/driver_oledb_download.md)]
  ...
  OLE DB Driver for SQL Server 라이브러리를 사용하는 애플리케이션을 개발할 때 많은 문제가 있습니다. 이 섹션의 항목에서는 MDAC에서 OLE DB Driver for SQL Server로 업그레이드, OLE DB Driver for SQL Server 헤더 및 라이브러리 파일 사용, OLE DB Driver for SQL Server에서 사용할 수 있는 다양한 연결 문자열의 개요 등 이러한 문제에 대해 설명합니다.  

## <a name="in-this-section"></a>섹션 내용  
 [SQL Server용 OLE DB 드라이버 설치](../../oledb/applications/installing-oledb-driver-for-sql-server.md)  
 OLE DB Driver for SQL Server 설치 방법, 다양한 구성 요소가 설치되는 위치, OLE DB Driver for SQL Server를 제거하는 방법을 설명합니다.  

 [SQL Server용 OLE DB 드라이버 구성 요소](../../oledb/applications/components-of-oledb-driver-for-sql-server.md)  
 라이브러리, 리소스, 도움말 및 헤더 파일을 포함하여 OLE DB Driver for SQL Server를 구성하는 구성 요소에 대해 설명합니다.  
 ...
 애플리케이션에서 OLE DB Driver for SQL Server 헤더 및 라이브러리 파일을 사용하는 방법을 설명합니다.  
 ...
 OLE DB Driver for SQL Server와 MDAC 간 차이, 그리고 MDAC에서 OLE DB Driver for SQL Server로 업그레이드할 때 고려할 문제에 대해 설명합니다.  
 ...
 [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] Native Client에서 OLE DB Driver for SQL Server로 업그레이드할 때 고려할 문제에 대해 설명합니다.  

 [SQL Server용 OLE DB 드라이버에서 ADO 사용](../../oledb/applications/using-ado-with-oledb-driver-for-sql-server.md)  
 ADO가 OLE DB Driver for SQL Server를 사용하여 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 기능에 액세스하고 사용하는 방법을 설명합니다.  

 [SQL Server용 OLE DB 드라이버 지원 정책](../../oledb/applications/support-policies-for-oledb-driver-for-sql-server.md)  
 다양한 데이터 액세스 구성 요소를 다양한 버전의 OLE DB Driver for SQL Server와 함께 사용하는 방법을 설명합니다.  
