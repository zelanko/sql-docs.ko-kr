---
title: OLE DB 드라이버에서 ADO 사용
description: 여러 활성 결과 집합, 쿼리 알림, 사용자 정의 형식 또는 xml 데이터 형식과 같은 새 기능을 포함하여 OLE DB 드라이버에서 ADO를 사용하는 방법에 대해 알아봅니다.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
...
-   `DataTypeCompatibility=80`  
 ...
 SQL Server용 OLE DB Driver에서 지원되는 ADO 연결 문자열 키워드에 대한 내용은 [SQL Server용 OLE DB 드라이버에서 연결 문자열 키워드 사용](using-connection-string-keywords-with-oledb-driver-for-sql-server.md)을 참조하세요.  
