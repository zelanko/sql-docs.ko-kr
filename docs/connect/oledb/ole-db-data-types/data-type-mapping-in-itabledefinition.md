---
title: ITableDefinition의 데이터 형식 매핑(OLE DB 드라이버) | Microsoft Docs
description: ITableDefinition::CreateTable 메서드를 사용하여 테이블을 만들 때 OLE DB Driver for SQL Server 소비자가 SQL Server 데이터 형식을 지정할 수 있는 방법을 알아봅니다.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
