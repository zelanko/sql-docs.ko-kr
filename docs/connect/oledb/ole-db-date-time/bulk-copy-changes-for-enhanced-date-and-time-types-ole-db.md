...
## <a name="character-data-files"></a>문자 데이터 파일  
 문자 데이터 파일의 날짜 및 시간 값의 "데이터 형식:: 문자열 및 리터럴" 섹션에 설명 된 대로 표시 됩니다 [OLE DB 날짜 및 시간 기능 향상에 대 한 데이터 형식 지원](../../oledb/ole-db-date-time/data-type-support-for-ole-db-date-and-time-improvements.md) OLE DB에 대 한 합니다.  
