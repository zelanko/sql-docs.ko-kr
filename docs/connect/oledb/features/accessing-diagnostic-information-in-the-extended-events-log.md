...
## <a name="control-file"></a>제어 파일  
 OLE DB driver for SQL Server 제어 파일 (ctrl.guid) 내용이 되었습니다.  
...
## <a name="mof-file"></a>MOF 파일  
 다음은 OLE DB 드라이버에서 SQL Server mof 파일의 내용입니다.  
