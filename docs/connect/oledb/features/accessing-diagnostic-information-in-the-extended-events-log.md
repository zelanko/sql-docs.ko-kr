...
description: SQL Server에 대 한 OLE DB 드라이버 추적 및 확장 이벤트 로그의 진단 정보 액세스
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
...
## <a name="control-file"></a>제어 파일  
 SQL Server 제어 파일 (ctrl. guid)의 OLE DB 드라이버 내용은 다음과 같습니다.  
...
## <a name="mof-file"></a>MOF 파일  
 SQL Server mof 파일에 대 한 OLE DB 드라이버의 내용은 다음과 같습니다.  
