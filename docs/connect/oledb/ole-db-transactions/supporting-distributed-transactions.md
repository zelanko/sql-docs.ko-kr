---
title: 분산 트랜잭션 지원(OLE DB 드라이버)
description: OLE DB Driver for SQL Server 소비자가 ITransactionJoin::JoinTransaction 메서드를 사용하여 분산 트랜잭션에 참여하는 방법을 알아봅니다.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
