---
title: 트랜잭션(OLE DB 드라이버)
description: OLE DB Driver for SQL Server가 로컬 트랜잭션을 지원하는 방법을 알아봅니다. 분산 트랜잭션에 Microsoft Distributed Transaction Coordinator를 사용합니다.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
