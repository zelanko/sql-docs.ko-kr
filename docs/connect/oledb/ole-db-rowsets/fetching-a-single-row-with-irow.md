...
description: SQL Server에 대 한 OLE DB 드라이버의 IRow 인터페이스를 사용 하 여 단일 행 페치
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
[!INCLUDE[Driver_OLEDB_Download](../../../includes/driver_oledb_download.md)]
  ...
  SQL Server에 대 한 OLE DB 드라이버의 **IRow** 인터페이스 구현은 성능을 향상 시키기 위해 간소화 되었습니다. **IRow**를 사용하여 단일 행 개체의 열에 직접 액세스할 수 있습니다. 명령 실행의 결과로 정확히 하나의 행이 생성된다는 것을 미리 알고 있는 경우 **IRow**는 해당 행의 열을 검색합니다. 결과 집합에 여러 행이 포함되는 경우 **IRow**는 첫 번째 행만 노출합니다.  
