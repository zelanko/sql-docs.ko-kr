---
title: ISequentialStream을 사용하여 FILESTREAM 열에서 데이터 검색(OLE DB) | Microsoft Docs
description: OLE DB Driver for SQL Server의 ICommandText 인터페이스에서 ISequentialStream 인터페이스를 사용하여 Filestream 열에서 레코드를 검색하는 방법을 알아봅니다.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
