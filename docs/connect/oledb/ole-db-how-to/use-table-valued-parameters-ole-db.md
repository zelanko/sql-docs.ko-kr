---
title: 테이블 반환 매개 변수 사용(OLE DB 드라이버)
description: 이 예제에서는 OLE DB Driver for SQL Server에서 테이블 반환 매개 변수를 만드는 방법과 해당 매개 변수를 사용하는 방법을 알아봅니다.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
