...
> [!NOTE]  
>  [ibcpsession:: Bcpcolumns](../../oledb/ole-db-interfaces/ibcpsession-bcpcolumns-ole-db.md) 메서드를 호출 하기 전에 호출 해야 **BCPColFmt**합니다. 사용자 파일에 있는 각 열에 대해 **BCPColFmt** 를 한 번씩 호출해야 합니다. 사용자 파일의 열에 대해 **BCPColFmt** 를 두 번 이상 호출하면 오류가 발생합니다.  
 ...
 **참고** 는 [ibcpsession:: Bcpwritefmt](../../oledb/ole-db-interfaces/ibcpsession-bcpwritefmt-ole-db.md) 함수를 통해 제공 된 형식 지정에 사용할 수 있습니다 **BCPColFmt**합니다.  
