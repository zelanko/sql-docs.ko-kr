---
title: IBCPSession::BCPColumns(OLE DB 드라이버) | Microsoft Docs
description: OLE DB Driver for SQL Server에서 IBCPSession::BCPColumns 메서드가 SQL Server 테이블 열에 바인딩할 필드 수를 설정하는 방법을 알아봅니다.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
