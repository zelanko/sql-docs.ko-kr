---
title: 명령 매개 변수(OLE DB 드라이버) | Microsoft Docs
description: OLE DB Driver for SQL Server가 SQL 문과 프로시저 호출 명령에 지원하는 형식을 포함하여 명령 매개 변수에 대해 알아봅니다.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
