...
다음 콘솔 애플리케이션에서는 MARS가 설정된 상태에서 두 개의 <xref:Microsoft.Data.SqlClient.SqlDataReader> 개체와 단일 <xref:Microsoft.Data.SqlClient.SqlCommand> 개체와 함께 두 개의 <xref:Microsoft.Data.SqlClient.SqlConnection> 개체를 사용하는 방법을 보여 줍니다.  
