...
|||
| :-- | :-- |
| [Ruby 사용 하 여 SQL에 연결 하는 개념 증명](./ruby/step-3-proof-of-concept-connecting-to-sql-using-ruby.md) | 작은 코드 예제는 연결 및 SQL Server 쿼리를 중점적으로 수행 합니다. |
