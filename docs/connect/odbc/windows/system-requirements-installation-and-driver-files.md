...
| Windows 기반 ODBC Driver [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 11 for | 는 하나 이상의 버전의 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client가 있는 컴퓨터에 설치할 수 있습니다. |
| ODBC Driver 13 for[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] | SQL Server 2016, SQL Server 2014, SQL Server 2012, [!INCLUDE[ssKilimanjaro](../../../includes/sskilimanjaro-md.md)]및 [!INCLUDE[ssKatmai](../../../includes/sskatmai_md.md)]에 대 한 연결을 지원 합니다. |
| ODBC Driver 13.1 for [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)], <br/> 위의 13 개 외에도 | SQL Server 2017를 지원 합니다. |
