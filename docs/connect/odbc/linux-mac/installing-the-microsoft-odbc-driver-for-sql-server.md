...
### <a name="ubuntu-1404-1604-1710-and-1804"></a>Ubuntu 14.04, 16.04, 17.10을 및 18.04
```
sudo su 
curl https://packages.microsoft.com/keys/microsoft.asc | apt-key add -
...
> - 드라이버 버전 17.3 이상은 Ubuntu 18.10 지원에 필요 합니다.   

### <a name="os-x-1011-el-capitan-macos-1012-sierra-macos-1013-high-sierra-and-macos-1014-mojave"></a>OS X 10.11 (El Capitan), macOS 10.12(sierra), macOS 10.13(high (High Sierra) 및 macOS 10.14 (Mojave)
...
#### <a name="redhat-linux-enterprise-server-7"></a>Redhat Linux Enterprise Server 7
  - 최신 다운로드 `msodbcsql` `.rpm` 여기에서: https://packages.microsoft.com/rhel/7/prod/
  - 종속성 및 드라이버 설치
...
#### <a name="ubuntu-1604"></a>Ubuntu 16.04
- 최신 다운로드 `msodbcsql` `.deb` 여기에서: https://packages.microsoft.com/ubuntu/16.04/prod/pool/main/m/msodbcsql/ 
- 종속성 및 드라이버 설치 
...
#### <a name="suse-linux-enterprise-server-12"></a>SUSE Linux Enterprise Server 12
- 최신 다운로드 `msodbcsql` `.rpm` 여기에서: https://packages.microsoft.com/sles/12/prod/
- 종속성 및 드라이버 설치
