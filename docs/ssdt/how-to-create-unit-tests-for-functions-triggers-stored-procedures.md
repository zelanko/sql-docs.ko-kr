...
1.  저장 프로시저에 대한 단위 테스트를 추가하는 예는 [연습: SQL Server 단위 테스트 만들기 및 실행](../ssdt/walkthrough-creating-and-running-a-sql-server-unit-test.md)의 "저장 프로시저에 대한 SQL Server 단위 테스트를 만들려면" 섹션을 참조하세요.  
