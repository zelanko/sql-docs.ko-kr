...
Visual Studio 2017용 SSDT(15.5.1)는 미리 보기를 종료하고 처음으로 GA(일반 공급) 릴리스됩니다. 이 릴리스는 Visual Studio 2017 15.5 이상의 SQL Server Database, Analysis Services, Reporting Services 및 Integration Services 프로젝트에 대한 독립 실행형 웹 설치 환경입니다.

| Visual Studio 2017용 SSDT | Visual Studio 2015용 SSDT | 
|:--|:--|
|[![다운로드](../ssdt/media/download.png)Visual Studio 2017용 SSDT(15.5.1) 다운로드](https://go.microsoft.com/fwlink/?LinkId=865748) | [![다운로드](../ssdt/media/download.png)Visual Studio 2015용 SSDT(17.4) 다운로드](https://go.microsoft.com/fwlink/?linkid=863440)|
|||

> [!IMPORTANT]
> Visual Studio 2017(15.5.1)은 설치 관리자에 대한 몇 가지 버그 수정을 제외하고 15.5.0 버전과 동일한 릴리스입니다. 기본적으로 동일한 릴리스이니, 15.5.0에서 15.5.1로 업그레이드하지 마세요. 이미 Visual Studio 2017(15.5.0)을 설치한 경우 설치 관리자 문제가 이미 해결된 것이므로 15.5.1로 업그레이드할 필요가 없습니다. 
> 
> Visual Studio 2017용 SSDT(15.5.1)를 설치하기 전에, VS 2017에 "Microsoft Analysis Services Projects" 및 "Microsoft Reporting Services Projects" 확장이 이미 설치되어 있는 경우 모두 제거하고 VS 인스턴스를 전부 닫습니다. 
> 
> 영어가 아닌 버전의 Visual Studio 2017 15.5.1용 SSDT는 영어 15.4.0 미리 보기에서 업그레이드하는 것을 지원하지 않으며, 15.5.1을 다른 언어로 설치하려면 영어 15.4.0 미리 보기를 제거해야 합니다. 
...
[중국어(중국)]( https://go.microsoft.com/fwlink/?linkid=865748&clcid=0x804) | 
[중국어(대만)]( https://go.microsoft.com/fwlink/?linkid=865748&clcid=0x404) | 
[영어(미국)]( https://go.microsoft.com/fwlink/?linkid=865748&clcid=0x409) | 
[프랑스어]( https://go.microsoft.com/fwlink/?linkid=865748&clcid=0x40c)  
[독일어]( https://go.microsoft.com/fwlink/?linkid=865748&clcid=0x407) | 
[이탈리아어]( https://go.microsoft.com/fwlink/?linkid=865748&clcid=0x410) | 
[일본어]( https://go.microsoft.com/fwlink/?linkid=865748&clcid=0x411) | 
[한국어]( https://go.microsoft.com/fwlink/?linkid=865748&clcid=0x412) | 
[포르투갈어(브라질)]( https://go.microsoft.com/fwlink/?linkid=865748&clcid=0x416) | 
[러시아어]( https://go.microsoft.com/fwlink/?linkid=865748&clcid=0x419) | 
[스페인어]( https://go.microsoft.com/fwlink/?linkid=865748&clcid=0x40a)  
