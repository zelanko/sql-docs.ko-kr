...
|-------------|-----------|---------------|  
|**Profile**:{ *string*}|해당 없음|DAC 게시 프로필에 대한 파일 경로를 지정합니다. 프로필은 결과 dacpac를 생성할 때 사용할 속성 및 변수 컬렉션을 정의합니다. 게시 프로필은 대상에 전달되고 **Publish**, **Script** 또는 **DeployReport** 작업 중 하나를 수행할 때 기본 옵션으로 사용됩니다.|  
