---
title: "SQL Server 도구 | Microsoft 문서"
ms.custom: 
ms.date: 01/19/2017
...
---
# <a name="sql-server-tools"></a>SQL Server 도구
...
## <a name="learn"></a>배우기
#### <a name="sql-server-management-tools-including-ssmshttpsmsdnmicrosoftcomlibraryhh213248aspx"></a>[SQL Server 관리 도구(SSMS 포함)](https://msdn.microsoft.com/library/hh213248.aspx)
#### <a name="use-sql-server-management-studiohttpsmsdnmicrosoftcomlibraryms174173aspx"></a>[SQL Server Management Studio 사용](https://msdn.microsoft.com/library/ms174173.aspx)
## <a name="see-also"></a>관련 항목:  
[SQL Server 드라이버](../connect/sql-server-drivers.md)  
