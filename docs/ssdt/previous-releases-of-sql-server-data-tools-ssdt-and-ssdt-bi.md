---
title: "SQL Server Data Tools(SSDT 및 SSDT-BI)의 이전 릴리스 | Microsoft 문서"
ms.custom: 
ms.date: 01/30/2017
...
SSDT는 이전 버전과 호환되므로 항상 [최신 SSDT](https://msdn.microsoft.com/library/mt204009.aspx) 를 사용하여 이전 버전의 SQL Server에서 실행되는 데이터베이스, 모델, 보고서 및 패키지를 설계하고 배포할 수 있습니다. 또한 아래에 나열된 이전에 출시된 버전도 사용할 수 있습니다.  
...
|16.3|[VS2015 16.3용 SSDT](https://go.microsoft.com/fwlink/?LinkID=824659)|[VS2013 16.3용 SSDT](https://go.microsoft.com/fwlink/?LinkID=824656)|
...
BI 템플릿은 SSAS 모델, SSRS 보고서 및 SSIS 패키지를 만드는 데 사용됩니다. BI Designer는 특정 버전의 SQL Server에 연결되어 있습니다. 최신 BI 기능을 사용하려면 최신 버전이 있는 BI DesigneR을 설치하세요.  
  
**BI Designers**  
  
[Visual Studio 2013용 SSDT-BI](https://www.microsoft.com/download/details.aspx?id=42313): SQL Server 2014, SQL Server 2012, SQL Server 2008, 2008 R2  
  
[Visual Studio 2012용 SSDT-BI](https://www.microsoft.com/download/details.aspx?id=36843): SQL Server 2014, SQL Server 2012, SQL Server 2008, 2008 R2  
  
BIDS(Business Intelligence Development Studio) -BIDS는 SQL Server 설치 프로그램을 통해 설치됩니다. 웹 다운로드(SQL Server 2008, 2008 R2)가 없습니다.  
