...
|-------------------------------------------|----------------------------------------------|  
|프로젝트 파일<br /><br />.dbproj(Visual Studio 2010 데이터베이스 및 서버 프로젝트, 데이터 계층 애플리케이션 프로젝트) 프로젝트 파일<br /><br />.csproj 및 .vbproj CLR 프로젝트 파일은 변환할 수는 있지만 데이터가 손실될 수 있습니다.|데이터베이스 단위 테스트 프로젝트<br /><br />부분 프로젝트(예: .files 항목)|  
