---
description: Sybase ASE 스키마를 SQL Server 스키마에 매핑(SybaseToSQL)
...
2.  오른쪽 창에서 **스키마 매핑** 탭을 클릭 합니다.  
    ...
    스키마가 있는 모든 ASE 데이터베이스 목록과 대상 값이 차례로 표시 됩니다. 이 대상은에서 두 부분으로 구성 된 표기법 (*데이터베이스 스키마*) [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 또는 개체와 데이터가 마이그레이션되는 SQL Azure 표시 됩니다.  
