...
품질 및 변환 메트릭을 개선 하기 위한 대상된 수정 사항을 제공 하려면 SSMA for Access v8.0 릴리스의 향상 되었습니다. 또한이 릴리스에 다음과 같은 새로운 기능을 제공합니다.
...
- 인기 있는 필요에 따라 SAP ASE 용 SSMA의 32 비트 버전은 다시 합니다. (이전 v7.4) 이전 구현에 비해, 두 개의 설치 관리자 패키지 있지만 나란히 설치할 수 없습니다. 결과적으로, 해야 연결 구성 요소에 따라 가장 적합 한 버전을 선택 해야 합니다. 항상 가능한 경우 64 비트 버전을 사용 하는 것이 좋습니다.
...
SAP ASE에 대 한 v7.5 릴리스의 SSMA 같은 변경 내용이 포함 됩니다.
-   장애가 있는 사용자에 큰 액세스 가능성을 보장 하기 위해 여러 향상 된 기능을 사용 하 여 향상 되었습니다.
-   CREATE 또는 REPLACE 구문에 대 한 지원을 제공 하도록 업데이트 합니다.
...
Sybase 용 SSMA의 2016 년 3 월 미리 보기 릴리스는 다음 변경 내용을 포함 되어 있습니다.  
...
Sybase 용 SSMA의 2011 년 7 월 릴리스는 다음 변경 내용이 포함 되어 있습니다.  
