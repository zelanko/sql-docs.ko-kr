...
SAP ASE 용 SSMA의 v8.2 릴리스에서 품질 및 변환 메트릭 뿐만 아니라 수정에 대 한 개선 하기 위한 수정의 대상된 집합을 통해 향상 되었습니다.
...
추가 하는 Sybase 용 SSMA의 2010 년 7 월 릴리스:
...
* Sybase ASE 15.0.3 및 15.5에서에서 마이그레이션에 대 한 지원.  
...
추가 하는 Sybase 용 SSMA의 2007 년 5 월 릴리스:  
  
* 프로젝트를 저장할 때 데이터베이스 콘텐츠를 더 빠르게 로드 하는 기능.  
* SQL Server에서 사용자가 입력 한 주석에 대 한 지원은 SQL 모드 서식이 지정 됩니다.  
* 개체 변환의 향상 된 기능입니다.  
