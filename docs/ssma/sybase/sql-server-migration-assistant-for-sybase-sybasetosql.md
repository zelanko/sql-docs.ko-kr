...
[!INCLUDE[msCoName](../../includes/msconame_md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Sybase ase (Sybase Server Enterprise) 용 ssma (Migration Assistant)는 ase 데이터베이스 [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 를 2012, [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 2014, [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 2016, [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 2017 (windows 및 linux의 경우) [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] , windows 및 linux의 2019 또는 [!INCLUDE[msCoName](../../includes/msconame_md.md)] Azure SQL Database 마이그레이션하기 위한 도구입니다. Sybase 용 SSMA는 ASE 데이터베이스 개체를 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 데이터베이스 개체로 변환 하 고, 이러한 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 개체를 또는 Azure SQL Database 만든 다음 ASE에서 또는 Azure SQL Database [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 로 데이터를 마이그레이션합니다.
  
이 설명서에서는 Sybase 용 SSMA를 소개 하 고 ASE 데이터베이스 Azure SQL Database를로 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 마이그레이션하는 방법에 대 한 단계별 지침 및 마이그레이션 후 발생할 수 있는 문제에 대 한 정보를 제공 합니다. 자세히 알아보려면 다음 문서를 참조 하세요.  
