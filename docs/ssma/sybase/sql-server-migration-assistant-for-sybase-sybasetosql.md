...
SSMA for Sybase 소개 하 고 ASE 데이터베이스 마이그레이션에 대 한 단계별 지침을 제공 하는이 설명서 [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] 또는 SQL Azure와 마이그레이션 후 발생할 수 있는 문제에 대 한 정보입니다. 자세한 내용을 보려면 다음 항목을 참조 합니다.  
  
## <a name="contents"></a>내용  
  
|섹션|Description|  
|-----------|---------------|  
|[SSMA for Sybase의에서 새로운 기능 &#40;SybaseToSQL&#41;](../../ssma/sybase/what-s-new-in-ssma-for-sybase-sybasetosql.md)|SSMA 릴리스에 변경 내용을 나열합니다.|  
...
|[SQL Server-Azure SQL DB Sybase ASE 데이터베이스 마이그레이션 &#40;SybaseToSQL&#41;](../../ssma/sybase/migrating-sybase-ase-databases-to-sql-server-azure-sql-db-sybasetosql.md)|프로세스의 각 단계에 대 한 자세한 정보 및 변환 프로세스의 개요를 제공합니다.|  
