...
-   에 모든 SSMA 프로젝트에 대 한 설정을 지정 하려면는 **도구** 메뉴 선택 **기본 프로젝트 설정**, 설정 된 볼 /에서 변경 하는 데 필요한 마이그레이션 프로젝트 형식을 선택 **마이그레이션 대상 버전** 클릭 드롭다운 **일반** 클릭 한 다음 확인 하 고 왼쪽된 창 맨 아래에 **마이그레이션**합니다.  
...
|**ID 유지**|SQL Server로 데이터를 추가할 때 SSMA Sybase id 값을 유지할지 여부를 지정 합니다. False 값에는 id 값을 대상에 의해 할당 하면 됩니다.<br /><br />**기본 모드**: True<br /><br />**최적 모드**: True<br /><br />**전체 모드**: True|  
...
|**숫자의 소수 부분 라운드**|정수 형식으로 마이그레이션하는 동안 decimal 및 numeric 데이터의 소수 부분을 자르기 또는 소수 부분이 trivial이 아닌 경우 오류 메시지가 표시 여부를 지정합니다<br /><br />**기본 모드**: 아니요<br /><br />**최적 모드**: 아니요<br /><br />**전체 모드**: 아니요|  
|**Sybase 유니코드 Endian**|Sybase 유니코드 문자열에 대 한 endian 형식을 지정합니다. 이 특정 설정에 대해 다음 옵션을 설정할 수 있습니다.<br /><br />Little endian<br /><br />Big endian<br /><br />**기본 모드**: little-endian<br /><br />**최적 모드**: little-endian<br /><br />**전체 모드**: little-endian|  
...
|**커서 사용**|이 옵션을 설정 하는 경우에 커서를 사용 하 여 원본 데이터베이스에서 데이터 검색 됩니다.<br /><br />**기본 모드**: False<br /><br />**최적 모드**: False<br /><br />**전체 모드**: False|  
