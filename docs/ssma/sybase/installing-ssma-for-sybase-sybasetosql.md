...
SAP ASE 용 SSMA의 이후 버전으로 업그레이드 하려는 경우 클라이언트와 서버 확장 팩 먼저 제거 해야 합니다. 그런 다음 최신 버전을 설치 합니다.  
  
SAP ASE에 대 한 이전 버전의 SSMA 프로젝트를 열면 프로젝트를 최신 버전으로 변환 하려면 SSMA 묻습니다. 클릭 **예** SSMA의 최신 버전의 프로젝트와 함께 작동 하도록 합니다.  
