...
> - 스크립트 파일 만들기 '에 대 한 자세한 내용은 참조 하십시오. [스크립트 파일 만들기 &#40;SybaseToSQL&#41;](../../ssma/sybase/creating-script-files-sybasetosql.md)합니다.  
...
샘플 콘솔 스크립트 파일에 대 한 자세한 내용은 참조 [샘플 콘솔 스크립트 파일을 작업할 &#40;SybaseToSQL&#41;](../../ssma/sybase/working-with-the-sample-console-script-files-sybasetosql.md)  
