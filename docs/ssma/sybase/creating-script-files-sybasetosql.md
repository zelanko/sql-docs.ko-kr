...
7.  **중지 작업:** 사용자가 다음 작업을 중지 하려고 하는 경우 중간 작업 중 **' Ctrl + C'** 바로 가기 키를 사용할 수 있습니다. SSMA Sybase 콘솔에 대 한 대기 작업을 완료 하 고 콘솔 실행을 종료 합니다.  
...
예를 들어 Sybase 데이터베이스에 있는 특정 테이블의 일반적인 데이터 마이그레이션의 계층 구조를 따릅니다: 데이터베이스-&gt;스키마-&gt;테이블입니다.  
  
스크립트 파일에 있는 모든 명령을 올바르게 실행 되는지, SSMA 콘솔 응용 프로그램 종료 되 고 사용자에 게 컨트롤을 반환 합니다. 스크립트 파일의 내용이 자세한 또는 작은 정적 변수 정보를 포함 한 [변수 값 파일](http://msdn.microsoft.com/en-us/395be464-4b19-44f7-91e5-b8876d6743dc) 또는 변수 값에 대 한 스크립트 파일 내 별도 섹션입니다.  
