---
description: SSMA 콘솔의 명령줄 옵션(SybaseToSQL)
title: SSMA 콘솔의 명령줄 옵션 (SybaseToSQL) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
ms.reviewer: ''
...
SSMA 콘솔 명령줄 옵션이 표 형식으로 표시 되는 경우 [부록-1 &#40;SybaseToSQL&#41;](../../ssma/sybase/appendix-1-sybasetosql.md)를 참조 하세요.  
...
SSMA 콘솔 명령줄 옵션이 표 형식으로 표시 되는 경우 [부록-1 &#40;SybaseToSQL](../../ssma/sybase/appendix-1-sybasetosql.md) 을 참조 하세요&#41;  
