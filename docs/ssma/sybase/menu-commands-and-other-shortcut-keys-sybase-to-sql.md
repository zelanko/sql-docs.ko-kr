...
|연결을 표시 하거나 Sybase 대화 상자에 다시 연결 합니다.|ALT + F + T|  
...
|표시는 Sybase 대화에 대 한 백업에 테이블을 추가 합니다.|ALT + S + B + B|  
|Sybase 대화에 대 한 백업에서 복원 테이블을 표시 합니다.|ALT + S + B + R|  
|Sybase 대화에 대 한 백업 콘텐츠를 관리 하는 표시 합니다.|ALT + S + B + C|  
...
|이렇게 하려면|키를 누릅니다|  
|--------------|---------|  
|Sybase 대화 상자에 대 한 SSMA에 대 한 표시 합니다.|ALT + H + A|  
