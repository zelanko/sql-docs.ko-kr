...
테스터 메뉴에 액세스 하려면 사용 되는 바로 가기 키가 ALT + S. 다음 표에서 설명 키보드 바로 가기 키 테스터 메뉴에서 메뉴 항목에 액세스 하는 데 사용 합니다.  
  
|이렇게 하려면|키를 누릅니다|  
|--------------|---------|  
|테스트 사례 마법사 대화 상자를 표시 합니다.|ALT + S + N|  
|저장소 테스트 사례 대화 상자를 표시 합니다.|Alt+S+C|  
|테스트 결과 대화 상자의 리포지토리를 표시 합니다.|ALT + S + R|  
|Sybase 백업 관리 하위 메뉴에 액세스 합니다.|ALT + S + B|  
|디스플레이는 Sybase 대화에 대 한 백업에 테이블을 추가 합니다.|ALT + S + B + B|  
|Sybase 대화에 대 한 백업에서 복원 테이블을 표시 합니다.|ALT + S + B + R|  
|디스플레이는 Sybase 대화에 대 한 백업 콘텐츠를 관리 합니다.|ALT + S + B + C|  
...
|SQL Server 대화에 대 한 백업 내용을 관리 하는 표시 합니다.|ALT + S + M + C|  
...
[바로 가기 키 &#40; Sybase SQL &#41;](../../ssma/sybase/shortcut-keys-sybase-to-sql.md)  
