...
**기본/Optimistic 모드:** 변환 하 고 경고로 표시 합니다.  
...
-   **ISNULL 함수를 사용 하 여 래핑할:** 경우이 옵션을 설정, 모든 상수가 아닌 연결에 사용 되는 ' string_expression' ISNULL(string_expression) 래핑 및 빈 문자열이 Null 바뀝니다.  
