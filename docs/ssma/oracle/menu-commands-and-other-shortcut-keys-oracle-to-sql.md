...
파일 메뉴에 액세스 하려면 사용는 바로 가기 키는 ALT + 6입니다. 다음 표에 키보드 바로 가기 파일 메뉴에서 메뉴 항목에 액세스 하는 데 있습니다.  
...
|연결을 표시 하거나 Oracle 대화 상자에 다시 연결 합니다.|ALT + F + T|  
|연결을 표시 또는 SQL Server 또는 SQL Azure 대화 상자에 다시 연결 합니다.|ALT + F + Q|  
|최근 프로젝트에 액세스 합니다.|ALT + F + P|  
|SSMA 응용 프로그램을 종료 합니다.|ALT + F + X|  
  
## <a name="edit-menu-commands"></a>편집 메뉴 명령  
편집 메뉴에 액세스 하려면 사용는 바로 가기 키는 ALT + 5입니다. 다음 표에서 편집 메뉴에서 메뉴 항목에 액세스 하는 데 사용 하는 바로 가기 키를 설명 합니다.  
...
|문 완료 변경 내용을 저장 합니다.|ALT + E + S 또는 CTRL + S|  
...
보기 메뉴에 액세스 하려면 사용 되는 바로 가기 키가 ALT + V입니다. 다음 표에 키보드 바로 가기 뷰 메뉴에서 메뉴 항목에 액세스 하는 데 있습니다.  
  
|이렇게 하려면|키를 누릅니다|  
|--------------|---------|  
|메타 데이터 탐색기를 동기화 합니다.|ALT + V + Z|  
|트리를 표시 합니다.|ALT + V + H 또는 CTRL + T|  
|소스 파트를 보여 줍니다.|ALT + V + S|  
|대상 파트를 보여 줍니다.|ALT + V + T|  
...
## <a name="tools-menu-commands"></a>도구 메뉴 명령  
도구 메뉴에 액세스 하려면 사용는 바로 가기 키는 ALT + T. 다음 표에 키보드 바로 가기를 도구 메뉴에서 메뉴 항목에 액세스 하는 데 있습니다.  
...
테스터 메뉴에 액세스 하려면 사용는 바로 가기 키는 ALT + S. 다음 표에서 키보드 바로 가기는 테스터 메뉴에서 메뉴 항목에 액세스 하는 데 사용 합니다.  
  
|이렇게 하려면|키를 누릅니다|  
|--------------|---------|  
|테스트 사례 마법사 대화 상자를 표시 합니다.|ALT + S + N|  
|저장소 테스트 사례 대화 상자를 표시 합니다.|Alt+S+C|  
|저장소 테스트 결과 대화 상자를 표시 합니다.|ALT + S + R|  
|Oracle 백업 관리 하위 메뉴에 액세스 합니다.|ALT + S + B|  
|Oracle 대화에 대 한 백업에 테이블을 추가 하는 표시 합니다.|ALT + S + B + B|  
|Oracle 대화에 대 한 백업에서 복원 테이블을 표시 합니다.|ALT + S + B + R|  
|Oracle 대화에 대 한 백업 콘텐츠를 관리 하는 표시 합니다.|ALT + S + B + C|  
|SQL Server 백업 관리 하위 메뉴에 액세스 합니다.|Alt+S+M|  
|SQL Server 대화에 대 한 백업에 테이블을 추가 하는 표시 합니다.|ALT + S + M + B|  
|SQL Server 대화에 대 한 백업에서 복원 테이블을 표시 합니다.|ALT + S + M + R|  
|SQL Server 대화에 대 한 백업 콘텐츠를 관리 하는 표시 합니다.|ALT + S + M + C|  
  
## <a name="help-menu-commands"></a>도움말 메뉴 명령  
도움말 메뉴에 액세스 하려면 사용는 바로 가기 키는 ALT + 8입니다. 다음 표에서 도움말 메뉴에서 메뉴 항목에 액세스 하는 데 사용 하는 바로 가기 키를 설명 합니다.  
  
|이렇게 하려면|키를 누릅니다|  
|--------------|---------|  
|SSMA에 대 한 Oracle 대화 상자를 표시 합니다.|ALT + H + A|  
|고객 의견 옵션 대화 상자를 표시 합니다.|ALT + H + C|  
|도움말 창을 표시 합니다.|ALT + H + H 또는 F1|  
  
## <a name="context-menu-commands"></a>상황에 맞는 메뉴 명령  
개체 탐색기에서 선택한 개체에 대 한 상황에 맞는 메뉴에 액세스 하려면 사용 되는 바로 가기 키에는 SHIFT + f10 키 또는 앱 키입니다.  
...
|이렇게 하려면|키를 누릅니다|  
|--------------|---------|  
|하나의 검색 결과를 위나 아래로 이동 합니다.|위쪽 및 아래쪽 화살표 키|  
|표에서 시작으로 이동 하거나 끝 표시 검색 됩니다.|Page up 또는 page down 키|  
|선택한 검색 결과 확인 합니다.|키 입력|  
...
|시작으로 이동 하거나 요약 정보 창이 끝날 합니다.|Page up 또는 page down 키|  
|대화 상자를 닫습니다.|ESC 키|  
...
|클립보드의 가장 최근에 추가 된 텍스트를 붙여 넣습니다.|CTRL + V|  
|빠른 찾기 시작|CTRL + F|  
|요약 정보를 시작 합니다.|CTRL + SHIFT + 스페이스바|  
|선언으로 이동 합니다.|F12|  
