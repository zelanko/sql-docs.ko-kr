...
7.  **작업 중지:** 중간 작업 중에 사용자가 작업을 중지 하려는 경우에는 **' Ctrl + C '** 바로 가기 키를 사용할 수 있습니다. Oracle 용 SSMA 콘솔은 작업이 완료 될 때까지 기다리거나 콘솔 실행을 종료 합니다.  
...
예를 들어 Oracle 데이터베이스의 특정 테이블에 대 한 일반적인 데이터 마이그레이션은 Schema 테이블의 계층 구조를 따릅니다 &gt; .  
...
스크립트 전체 목록- [SSMA 콘솔 &#40;OracleToSQL를 실행](../../ssma/oracle/executing-the-ssma-console-oracletosql.md) 하 여 찾을 수 있습니다&#41;  
