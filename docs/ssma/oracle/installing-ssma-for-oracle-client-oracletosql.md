...
-   데이터베이스 개체와 데이터를 마이그레이션할 대상 인스턴스 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 또는 AZURE SQL DB를 호스트 하는 컴퓨터에 대 한 액세스 권한이 있어야 합니다. 자세한 내용은 [SQL Server &#40;OracleToSQL&#41;에 연결 ](../../ssma/oracle/connecting-to-sql-server-oracletosql.md)을 참조 하세요.  
...
1.  Oracle *n*용 ssma를 두 번 클릭 합니다. Setup.exe를 설치 합니다. 여기서 *n* 은 빌드 번호입니다.  
