---
description: Oracle 용 SSMA의 새로운 GUI 기능 (OracleToSQL)
title: Oracle 용 SSMA의 새로운 GUI 기능 (OracleToSQL) | Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "88320339"
---
# <a name="new-gui-features-in-ssma-for-oracle-oracletosql"></a>Oracle 용 SSMA의 새로운 GUI 기능 (OracleToSQL)
