---
description: SSMA 콘솔 실행(OracleToSQL)
title: SSMA 콘솔 실행 (OracleToSQL) | Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "88497708"
---
# <a name="executing-the-ssma-console-oracletosql"></a>SSMA 콘솔 실행(OracleToSQL)
Microsoft는 SSMA 활동을 실행 하 고 제어할 수 있는 강력한 스크립트 파일 명령 집합을 제공 합니다. 콘솔 응용 프로그램은이 섹션에 열거 된 특정 표준 스크립트 파일 명령을 사용 합니다.  
...
/>  
```  
Oracle 용 SSMA 콘솔 응용 프로그램은 이전 버전과의 호환성을 지원 합니다. 이전 버전의 SSMA에서 만든 프로젝트를 열 수 있습니다.  
...
관리 효율성 명령은 대상 데이터베이스 개체를 원본 데이터베이스와 동기화 하는 데 도움이 됩니다. 마이그레이션 명령의 기본 콘솔 출력 설정은 자세한 오류 보고가 없는 ' 전체 ' 출력 보고서입니다. 원본 개체 트리 루트 노드의 요약만 포함 됩니다.  
...
-   `metabase:` 원본 또는 대상 메타 베이스를 포함할지 여부를 지정 합니다.  
...
-   `sql` 변환할 Oracle sql 문을 지정 합니다. 하나 이상의 문은 ";"을 사용 하 여 구분할 수 있습니다.  
...
-   `write-summary-report-to` 보고서가 생성 될 경로를 지정 합니다. 폴더 경로만 설명 된 경우 이름으로 파일 **ConvertSQLReport.XML** 생성 됩니다. (선택적 특성)  
    ...
    보고서를 만들 때 두 개의 하위 범주인 시각화이 추가 됩니다.  
...
명령줄 옵션에 대 한 자세한 내용은 [SSMA 콘솔의 명령줄 옵션 &#40;OracleToSQL&#41;](../../ssma/oracle/command-line-options-in-ssma-console-oracletosql.md) 을 참조 하세요.  
  
샘플 콘솔 스크립트 파일에 대 한 자세한 내용은 [샘플 콘솔 스크립트 파일 작업 &#40;OracleToSQL](../../ssma/oracle/working-with-the-sample-console-script-files-oracletosql.md) 를 참조 하세요&#41;  
  
다음 단계는 프로젝트 요구 사항에 따라 달라 집니다.  
  
-   암호 또는 내보내기/가져오기 암호를 지정 하려면 [OracleToSQL&#41;&#40;암호 관리 ](../../ssma/oracle/managing-passwords-oracletosql.md)를 참조 하세요.  
  
-   보고서를 생성 하려면 [OracleToSQL&#41;&#40;보고서 생성 ](../../ssma/oracle/generating-reports-oracletosql.md)을 참조 하세요.  
  
-   콘솔의 문제 해결에 대해서는 [문제 해결 &#40;OracleToSQL&#41;](../../ssma/oracle/troubleshooting-oracletosql.md)을 참조 하세요.  
