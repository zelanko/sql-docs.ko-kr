...
description: Oracle 용 SSMA에 대해 알아보고 Oracle 데이터베이스를 SQL Server로 마이그레이션하는 방법에 대 한 단계별 지침을 따르세요.
ms.prod: sql
ms.custom: ''
ms.date: 10/10/2019
ms.reviewer: ''
...
이 설명서에서는 Oracle 용 SSMA를 소개 하 고 Oracle 데이터베이스를로 마이그레이션하는 방법에 대 한 단계별 지침을 제공 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 합니다. 다음 표에서는 자세한 정보를 확인할 수 있는 문서를 보여 줍니다.  
