---
description: SSMA 콘솔의 명령줄 옵션(OracleToSQL)
title: SSMA 콘솔의 명령줄 옵션 (OracleToSQL) | Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
SSMA 콘솔 명령줄 옵션이 표 형식으로 표시 되는 경우 [부록-1 &#40;OracleToSQL&#41;](../../ssma/oracle/appendix-1-oracletosql.md)를 참조 하세요.  
