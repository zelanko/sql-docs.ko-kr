...
SSMA for Access v8.1 릴리스의 품질 및 변환 메트릭을 향상 하도록 설계 된 대상된 수정 사항을 향상 되었습니다.
...
SSMA for Access v8.0 릴리스의 품질 및 변환 메트릭을 개선 하기 위한 대상된 수정 사항을 사용 하 여 향상 되었습니다. 이 릴리스에 또한 다음과 같은 새로운 기능을 제공합니다.
...
SSMA for Access v7.10 릴리스의 추가 보안 및 글로벌 요구 사항 변화에에서 맞게 개인 정보 보호를 제공 하도록 설계 하는 대상된 수정 사항을 향상 되었습니다.
...
- 품질 및 변환 메트릭을 개선 하는 대상된 수정 되었습니다.
- Access 용 SSMA의 32 비트 버전 다시은 인기 있는 필요에 따라입니다. (이전 v7.4) 이전 구현에 비해, 두 개의 설치 관리자 패키지 있지만 설치-병렬 일 수 없습니다. 결과적으로, 해야 연결 구성 요소에 따라 가장 적합 한 버전을 선택 해야 합니다. 항상 가능한 경우 64 비트 버전을 사용 하는 것이 좋습니다.

## <a name="ssma-v76"></a>SSMA v7.6
SSMA for Access v7.6 릴리스의 품질 및 변환 메트릭을 개선 하는 대상된 수정 사항을 SQL Server 2017 (공개 미리 보기)에 대 한 지원이 향상 되었습니다. Windows 및 Linux에서 SQL Server 2017에 대 한 지원을 공개 미리 보기로 제공 않으며 프로덕션 마이그레이션에 사용할 수 없습니다.
...
> [!IMPORTANT]
> .NET 4.5.2 v7.4 SSMA를 설치 하기 위한 필수 조건입니다. 또한 v7.4 부터는 32 비트 버전의 SSMA는 중단 되었습니다.
...
SSMA for Access 2016 년 3 월 미리 보기 릴리스의 SQL Server 2016으로 마이그레이션에 대 한 지원을 추가합니다.  
...
SSMA for Access 2011 년 7 월 릴리스의 향상 된 오류 데이터 마이그레이션 중에 보고 기능을 추가 합니다.  
...
Access 용 SSMA 2008 년 6 월 릴리스의 Access 2007 데이터베이스에 대 한 지원을 추가합니다.  
