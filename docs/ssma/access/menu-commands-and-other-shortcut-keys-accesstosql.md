...
|찾기 데이터베이스 마법사 대화 상자를 표시 합니다.|ALT + F + F|  
...
|찾기 데이터베이스 마법사 대화 상자를 표시 합니다.|ALT + T + F|  
|표시 된 변환, 로드 및 마이그레이션 마법사 대화 상자|ALT + T + V|  
|테이블 또는 테이블을 연결 합니다.|ALT + T + L|  
|테이블의 연결을 해제 하거나 테이블을 연결 해제 합니다.|ALT + T + U|  
|스키마를 내보냅니다.|ALT + T + E|  
|로컬에서 삭제 합니다.|ALT + T + D|  
...
|이렇게 하려면|키를 누릅니다|  
|--------------|---------|  
|SSMA에 대 한 액세스 대화 상자를 표시 합니다.|ALT + H + A|  
