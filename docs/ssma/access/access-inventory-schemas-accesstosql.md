...
|**FileSize**|**bigint**|Kb에서 Access 데이터베이스의 크기입니다.|  
...
|**QueryTimeout**|**int**|구성 된 ODBC 쿼리 제한 시간 값 (초)에서 데이터베이스에 대 한 합니다. 기본값은 60초입니다.|  
...
|**ValidationRule**|**nvarchar(4000)**|추가 하거나 업데이트할 열에서 데이터 유효성을 검사 하는 데 사용 되는 규칙입니다.|  
