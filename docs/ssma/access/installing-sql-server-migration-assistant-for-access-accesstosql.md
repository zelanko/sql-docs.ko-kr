...
-   [!INCLUDE[msCoName](../../includes/msconame_md.md)] .NET Framework 버전 4.0 또는 이후 버전입니다. .NET Framework 버전 4.0에서 사용할 수는 [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] 제품 디스크에서 정보를 사용 하 여는 [Microsoft.NET 가이드](https://docs.microsoft.com/dotnet/framework/)합니다.
