...
4.  **공급자를 다시 연결:** 이 연결 오류 시 다시 연결 설정을 지정할 수 있습니다. 이 소스와 대상 서버에 대해 설정할 수 있습니다.  
...
7.  **작업 중지** 사용자가 다음 작업을 중지 하려는 경우 중간 작업 중 **' Ctrl + C'** 바로 가기 키를 사용할 수 있습니다. SSMA 콘솔 액세스에 대 한 작업이 완료 되기를 대기 하 고 콘솔 실행을 종료 합니다.  
