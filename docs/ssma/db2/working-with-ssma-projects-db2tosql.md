...
프로젝트를 열면 DB2 및에서 연결이 끊어집니다 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] . 이를 통해 오프 라인으로 작업할 수 있습니다. 에 다시 연결 하는 방법에 대 한 자세한 내용은 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [SQL Server &#40;DB2ToSQL&#41;에 연결 ](../../ssma/db2/connecting-to-sql-server-db2tosql.md)을 참조 하세요.  
...
마이그레이션 프로세스의 다음 단계는 [DB2 데이터베이스에 연결](./connecting-to-db2-database-db2tosql.md)하는 것입니다.  
