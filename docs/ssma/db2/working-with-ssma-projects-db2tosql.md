...
ms.locfileid: "68086186"
---
# <a name="working-with-ssma-projects-db2tosql"></a>SSMA 프로젝트 작업 (DB2ToSQL)
DB2 데이터베이스를로 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]마이그레이션하려면 먼저 ssma 프로젝트를 만듭니다. 프로젝트는 다음 정보를 포함 하는 파일입니다.  
...
프로젝트를 열면 DB2 및 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]에서 연결이 끊어집니다. 이를 통해 오프 라인으로 작업할 수 있습니다. 에 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]다시 연결 하는 방법에 대 한 자세한 내용은 [SQL Server &#40;DB2eToSQL&#41;에 연결 ](../../ssma/db2/connecting-to-sql-server-db2etosql.md)을 참조 하세요.  
  
## <a name="reviewing-default-project-settings"></a>기본 프로젝트 설정 검토  
SSMA에는 데이터베이스 개체를 변환 및 로드 하 고, 데이터를 마이그레이션하고, SSMA를 DB2 및 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]와 동기화 하기 위한 여러 설정이 포함 되어 있습니다. 기본 설정은 대부분의 사용자에 게 적합 합니다. 그러나 새 SSMA 프로젝트를 만들기 전에 설정을 검토 해야 합니다. 원하는 경우 모든 새 프로젝트에 사용 되는 기본 설정을 변경할 수 있습니다.  
...
5.  마이그레이션, 동기화, 시스템 개체, GUI 및 유형 매핑 페이지에 대해 1-3 단계를 반복 합니다.  
    ...
    -   로 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]의 동기화 설정에 대 한 자세한 내용은 [프로젝트 설정&#40;동기화&#41; &#40;DB2ToSQL&#41;](../../ssma/db2/project-settings-synchronization-db2tosql.md)를 참조 하세요.  
...
DB2 데이터베이스에서로 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]데이터를 마이그레이션하려면 먼저 프로젝트를 만들어야 합니다.  
...
프로젝트를 열 때 DB2와의 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]연결이 끊어집니다. 이를 통해 오프 라인으로 작업할 수 있습니다. 메타 데이터를 업데이트 하려면 데이터베이스 개체를 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]에 로드 합니다. 데이터를 마이그레이션하려면 DB2 및 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]에 다시 연결 해야 합니다.  
