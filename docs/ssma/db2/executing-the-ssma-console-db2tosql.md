...
명령줄 옵션에 대 한 자세한 내용은 참조 하십시오. [SSMA 콘솔에서 명령줄 옵션 &#40;DB2ToSQL&#41; ](../../ssma/db2/command-line-options-in-ssma-console-db2tosql.md) 합니다.  
  
샘플 콘솔 스크립트 파일에 대 한 자세한 내용은 참조 하십시오. [샘플 콘솔 스크립트 파일을 작업할 &#40;DB2ToSQL&#41;](../../ssma/db2/working-with-the-sample-console-script-files-db2tosql.md)  
