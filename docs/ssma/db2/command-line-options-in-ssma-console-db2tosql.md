...
SSMA 콘솔 명령줄 옵션의 테이블 형식으로 출력을 참조 하세요 [부록-1 &#40;DB2ToSQL&#41;](../../ssma/db2/appendix-1-db2tosql.md)합니다.  
...
SSMA 콘솔 명령줄 옵션의 테이블 형식으로 출력을 참조 하세요 [부록-1 &#40;DB2ToSQL&#41;](../../ssma/db2/appendix-1-db2tosql.md)  
  
### <a name="next-step"></a>다음 단계  
다음 단계는 프로젝트 요구 사항에 따라 달라 집니다.  
  
1.  암호 또는 내보내기 지정 하기 위한 암호 가져오기 /를 참조 하십시오 [관리 암호 &#40;DB2ToSQL&#41;](../../ssma/db2/managing-passwords-db2tosql.md)합니다.  
  
2.  보고서 생성을 참조 하세요 [보고서 생성 &#40;DB2ToSQL&#41;](../../ssma/db2/generating-reports-db2tosql.md)합니다.  
  
3.  콘솔에서 문제 해결을 참조 하세요 [문제 해결 &#40;DB2ToSQL&#41;](../../ssma/db2/troubleshooting-db2tosql.md)합니다.  
