...
1.  **ServersConnectionFileSample.xml:**  
    ...
    -   원본 및 대상 서버에 연결 하는 방법에 대 한 자세한 내용은 참조 하십시오. [서버 연결 파일 &#40; DB2ToSQL &#41; 만드는](../../ssma/db2/creating-the-server-connection-files-db2tosql.md) 합니다.  
...
[만드는 변수 값 파일 &#40; DB2ToSQL &#41;](../../ssma/db2/creating-variable-value-files-db2tosql.md)  
