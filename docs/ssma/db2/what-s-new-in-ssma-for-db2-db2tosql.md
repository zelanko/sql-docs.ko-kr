...
DB2 용 SSMA의 v8.2 릴리스에서 변환 하는 동안 뷰 선언에서 누락 된 COUNT_BIG 열의 고 SSMA 콘솔 도구에서 Azure SQL Database에 대 한 연결을 사용 하 여 문제를 해결 하려면 사용 하 여 향상 되었습니다. 또한이 버전의 품질 및 변환 메트릭 뿐만 아니라 수정에 대 한 개선 하기 위한 수정 대상된 집합을 포함:
...
DB2 용 SSMA의 v8.1 릴리스에서 품질 및 변환 메트릭을 향상 하도록 설계 된 대상된 수정 사항을 제공 하도록 향상 되었습니다.
...
DB2 용 SSMA의 v7.1 릴리스에서 다음 변경 내용을 포함 되어 있습니다.
...
DB2 용 SSMA의 2016 년 3 월 미리 보기 릴리스의 SQL Server 2016으로 마이그레이션에 대 한 지원을 추가합니다.
