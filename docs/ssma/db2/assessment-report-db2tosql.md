...
|**원본**|선택한 개체에 대 한 DB2 코드를 표시 하 고로 [!INCLUDE[tsql](../../includes/tsql-md.md)]변환 되지 않은 코드를 강조 표시 합니다. 이 창은 왼쪽 창에서 코드가 있는 개별 개체를 선택한 경우에만 표시 됩니다.<br /><br />줄 번호를 클릭 하 여 책갈피를 설정 하거나 선택 취소 합니다. 창 맨 위에 있는 단추를 사용 하 여 코드를 탐색 합니다.|  
