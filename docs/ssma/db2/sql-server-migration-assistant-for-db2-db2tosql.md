...
|[SSMA DB2 클라이언트에 대 한 설치 &#40;DB2ToSQL&#41;](../../ssma/db2/installing-ssma-for-db2-client-db2tosql.md)|필수 구성 요소 및 DB2 클라이언트 및 필수 구성 요소에 대 한 SSMA를 실행 하는 컴퓨터에 설치 하기 위한 지침을 제공 하는 항목이 들어 [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)]합니다.|  
|[D b 2 용 SSMA 시작 &#40;DB2ToSQL&#41;](../../ssma/db2/getting-started-with-ssma-for-db2-db2tosql.md)|사용자 인터페이스, 프로젝트 및 구성 옵션을 소개합니다.|  
...
|[사용자 인터페이스 참조 &#40;DB2ToSQL&#41;](../../ssma/db2/user-interface-reference-db2tosql.md)|SSMA에 대 한 DB2 대화 상자에 대 한 설명서를 포함합니다.|  
|[SSMA 콘솔 d b 2에 대 한 작업](http://msdn.microsoft.com/en-us/29d8787c-632e-4ff7-9ccc-3f7ad40480ec)|SSMA 콘솔 응용 프로그램에 대 한 설명서를 포함합니다.|  
|[SSMA DB2 지원에 대 한 가져오기](http://go.microsoft.com/fwlink/?LinkID=708538&clcid=0x409)|추가 도움말에 대 한 정보를 제공 합니다.|  
