...
7.  **중지 작업:** 사용자가 다음 작업을 중지 하려고 하는 경우 중간 작업 중 **' Ctrl + C'** 바로 가기 키를 사용할 수 있습니다. SSMA 콘솔 d b 2에 대 한 작업이 끝나기를 대기 하 고 콘솔 실행을 종료 합니다.  
...
스크립트 명령의 전체 목록은에 있습니다 [SSMA 콘솔 실행 &#40;DB2ToSQL&#41;](../../ssma/db2/executing-the-ssma-console-db2tosql.md)  
...
운영 콘솔에 다음 단계는 [변수 값 파일 만들기 &#40;DB2ToSQL&#41;](../../ssma/db2/creating-variable-value-files-db2tosql.md)합니다.  
