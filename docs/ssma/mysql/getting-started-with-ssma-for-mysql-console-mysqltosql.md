---
description: MySQL용 SSMA 콘솔 시작(MySQLToSQL)
...
![SSMA 콘솔 MySQL 출력의 예를 보여 주는 스크린샷](../../ssma/mysql/media/ssmaconsoleoutput_mysql.jpg "SSMA 콘솔 출력_MySQL")  
