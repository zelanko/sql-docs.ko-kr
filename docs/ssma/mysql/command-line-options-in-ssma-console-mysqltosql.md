...
명령줄 매개 변수로 옵션 또는 암호를 입력할 수 없습니다. 그렇지 않으면 오류가 발생합니다. 자세한 내용은 참조는 [관리 암호](http://msdn.microsoft.com/4ffbc587-ea3f-49ad-bc42-a654f672325e) 섹션입니다.  
