...
|**Converter**|해당 테이블 및 저장된 프로시저와 같은 원본 데이터베이스 개체의 구조 변환 [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] 구조입니다.|  
...
|**파서**|소스 스키마를 구문 분석합니다.|  
|**Synchronizer**|로드 원본 데이터베이스 개체에 [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)]합니다.|  
