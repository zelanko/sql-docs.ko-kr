...
1.  MySQL 확장 팩 SSMA를 복사 합니다. *n*. Install.exe 여기서  *n*  실행 중인 컴퓨터에 있는 빌드 번호 [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)]합니다.  
  
2.  MySQL 확장 팩 SSMA를 두 번 클릭 합니다. *n*. Install.exe 합니다.  
