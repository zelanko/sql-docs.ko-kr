...
1.  MySQL 용 SSMA 확장 팩을 복사 합니다. *n*.Install.exe입니다. 여기서 *n* 은를 실행 하는 컴퓨터에 대 한 빌드 번호입니다 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
  
2.  MySQL 용 SSMA 확장 팩을 두 번 클릭 합니다. *n*.Install.exe.  
...
11. 다른 인스턴스에 유틸리티를 설치 하려면 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **예**를 선택 하 고 **다음**을 클릭 합니다. 또는 마법사를 종료 하려면 **아니요**를 클릭 합니다.  
