---
description: 사용자 인터페이스 참조(MySQLToSQL)
...
|[프로젝트 설정 &#40;Azure SQL Database&#41; &#40;MySQLToSQL&#41;](../../ssma/mysql/project-settings-azure-sql-db-mysqltosql.md)|**프로젝트 설정** 대화 상자의 SQL Azure 페이지를 사용 하 여 MySQL에서 SQL Azure로 데이터를 마이그레이션하는 연결 설정을 사용자 지정할 수 있습니다.|  
