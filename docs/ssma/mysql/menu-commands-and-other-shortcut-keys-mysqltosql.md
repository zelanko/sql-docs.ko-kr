...
description: MySQL 용 SSMA 응용 프로그램의 다양 한 대화 상자에서 사용 되는 메뉴 명령 및 기타 바로 가기 키에 액세스 하기 위한 바로 가기 키에 대해 알아봅니다.
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
|MySQL에 연결 또는 다시 연결 대화 상자를 표시 합니다.|ALT + F + T|  
...
|이렇게 하려면|누르면|  
|--------------|---------|  
|MySQL 용 SSMA 대화 상자를 표시 합니다.|ALT + H + A|  
...
[MySQLToSQL&#41;&#40;바로 가기 키](../../ssma/mysql/shortcut-keys-mysqltosql.md)  
