...
|-|-|  
|**섹션**|**설명**|  
|[MySQL 용 SSMA의 새로운 기능](http://msdn.microsoft.com/1451a0b0-6713-4d0c-954f-ea3d8fce1d31)|이 버전의 MySQL 용 SSMA의 새로운 기능|  
...
|[SSMA MySQL 지원에 대 한 가져오기](http://go.microsoft.com/fwlink/?LinkID=708538&clcid=0x409)|추가 도움말을 제공 하는 방법에 대 한 정보를 제공 합니다.|  
