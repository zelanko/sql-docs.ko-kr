...
3.  스크립트 파일 만들기 '에 대 한 자세한 내용은 참조 하십시오. [스크립트 파일 만들기 &#40; MySQLToSQL &#41; ](../../ssma/mysql/creating-script-files-mysqltosql.md).  
...
명령줄 옵션에 대 한 자세한 내용은 참조 하십시오. [SSMA 콘솔 &#40;에서 명령줄 옵션 MySQLToSQL &#41; ](../../ssma/mysql/command-line-options-in-ssma-console-mysqltosql.md) .  
  
샘플 콘솔 스크립트 파일에 대 한 자세한 내용은 참조 하세요. [샘플 콘솔 스크립트 파일 &#40; 사용 MySQLToSQL &#41;](../../ssma/mysql/working-with-the-sample-console-script-files-mysqltosql.md)  
  
다음 단계에서는 프로젝트 요구 사항에 따라 달라 집니다.  
  
1.  암호 또는 내보내기 지정 하기 위한 암호 가져오기 /를 참조 하십시오 [암호 관리 &#40; MySQLToSQL &#41; ](../../ssma/mysql/managing-passwords-mysqltosql.md).  
  
2.  보고서를 생성 하는 것에 대 한 참조 [보고서 생성 &#40; MySQLToSQL &#41; ](../../ssma/mysql/generating-reports-mysqltosql.md).  
  
3.  콘솔에서 문제를 해결 하는 것에 대 한 참조 [문제 해결 &#40; MySQLToSQL &#41; ](../../ssma/mysql/troubleshooting-mysqltosql.md).  
