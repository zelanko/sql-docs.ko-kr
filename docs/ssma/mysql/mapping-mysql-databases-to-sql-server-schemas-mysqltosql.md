...
description: Mysql 스키마와 SQL Server 또는 Azure SQL Database 간 MySQL 매핑을 사용자 지정 하는 방법에 대해 알아보고 기본값을 적용 합니다.
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
2.  오른쪽 창에서 **스키마 매핑** 탭을 클릭 합니다.  
    ...
    모든 MySQL 스키마 목록에 대상 값이 표시 됩니다. 이 대상은에서 두 부분으로 구성 된 표기법 (*데이터베이스 스키마*) [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 또는 개체와 데이터가 마이그레이션되는 SQL Azure 표시 됩니다.  
