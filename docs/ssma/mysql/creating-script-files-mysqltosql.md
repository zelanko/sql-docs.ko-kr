...
스크립트 파일 또는 서버 연결 파일에 서버 연결 매개 변수를 정의할 수 있습니다. 참조 하십시오는 [서버 연결 파일을 만드는 &#40;MySQLToSQL&#41; ](../../ssma/mysql/creating-the-server-connection-files-mysqltosql.md) 자세한 내용은 섹션.  
