...
7.  **작업을 중지 합니다.** 사용자가 다음 작업을 중지 하려는 경우 중간 작업 중 **' Ctrl + C'** 바로 가기 키를 사용할 수 있습니다. SSMA MySQL 콘솔에 대 한 작업이 완료 되기를 대기 하 고 콘솔 실행을 종료 합니다.  
...
서버 연결 파일 또는 스크립트 파일에서 서버 연결 매개 변수를 정의할 수 있습니다. 참조 하십시오 합니다 [서버 연결 파일 만들기 &#40;MySQLToSQL&#41; ](../../ssma/mysql/creating-the-server-connection-files-mysqltosql.md) 대 한 자세한 내용은 섹션입니다.  
...
스크립트 명령의 전체 목록을 찾을 수 있습니다 [SSMA 콘솔 실행 &#40;MySQLToSQL&#41;](../../ssma/mysql/executing-the-ssma-console-mysqltosql.md)  
  
## <a name="script-file-validation"></a>스크립트 파일 유효성 검사  
사용자 스키마 정의 파일에 대해 자신의 스크립트 파일을 쉽게 확인할 수 있습니다 **'M2SSConsoleScriptSchema.xsd'** 'Schemas' 폴더에서 사용할 수 있습니다.  
  
## <a name="next-step"></a>다음 단계  
운영 콘솔에서 다음 단계 [변수 값 파일 만들기 &#40;MySQLToSQL&#41;](../../ssma/mysql/creating-variable-value-files-mysqltosql.md)합니다.  
