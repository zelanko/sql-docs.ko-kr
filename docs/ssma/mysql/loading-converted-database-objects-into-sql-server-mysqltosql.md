...
마이그레이션 프로세스의 다음 단계는 [SQL Server-Azure SQL DB에 MySQL 데이터 마이그레이션 &#40;MySQLToSQL&#41;](../../ssma/mysql/migrating-mysql-data-into-sql-server-azure-sql-db-mysqltosql.md)  
