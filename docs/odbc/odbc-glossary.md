...
## <a name="b"></a>b  
 **동작 변경**  
 ODBC *3.x 동작에서 odbc 2.x 동작으로* 특정 기능을 변경 하거나 ** 그 반대의 경우도 마찬가지입니다. SQL_ATTR_ODBC_VERSION 환경 특성을 변경 하 여 발생 합니다.  
 ...
 **매개 변수 설명자**  
 응용 프로그램에서 지정 하는 변환 (응용 프로그램 매개 변수 설명자 또는 APD) 또는 응용 프로그램에서 지정 된 변환 (구현) 전에 SQL 문에 사용 되는 런타임 매개 변수를 설명 하는 설명자입니다. 매개 변수 설명자 또는 IPD).  
