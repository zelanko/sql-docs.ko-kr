---
title: SQLSpecialColumns (데스크톱 데이터베이스 드라이버) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
고유 인덱스를 반환 됩니다 (있는 경우)에서 SQL_BEST_ROWID 플래그 *fColType*합니다. SQL_ROWVER 플래그에 대 한 결과 집합이 반환 됩니다.  
 ...
 모든 행 Id는 범위가 SQL_SCOPE_CURROW입니다.  
  
 패턴 일치에 대 한 지원 되지 않습니다 합니다 *szTableQualifier* 하거나 *szTableName* 인수입니다.
