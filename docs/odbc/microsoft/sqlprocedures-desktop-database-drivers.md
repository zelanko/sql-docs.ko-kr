---
title: SQLProcedures (데스크톱 데이터베이스 드라이버) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
**SQLProcedures** 적어도 하나 이상의 인수가 있는 해당 절차에는 행만 반환 됩니다. 인수가 있는 프로시저 뷰도 처리 됩니다.  
  
|Column|주석|  
|------------|--------------|  
|PROCEDURE_QUALIFIER|데이터베이스 파일의 경로입니다.|  
|PROCEDURE_OWNER|NULL|  
|PROCEDURE_NAME|구분 되지 않은 프로시저 이름|  
