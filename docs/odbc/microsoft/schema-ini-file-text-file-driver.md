...
|*type*|데이터 형식은 다음과 같습니다.<br /><br /> **Microsoft Jet 데이터 형식**<br /><br /> bit<br /><br /> Byte<br /><br /> 짧음<br /><br /> long<br /><br /> 통화<br /><br /> Single<br /><br /> Double<br /><br /> DateTime<br /><br /> 텍스트<br /><br /> Memo<br /><br /> **ODBC 데이터 형식** Char (텍스트와 동일)<br /><br /> Float (Double과 같음)<br /><br /> Integer (Short와 동일)<br /><br /> 이상 문자 (메모와 동일)<br /><br /> 날짜 *날짜 형식*|  
...
|**CurrencyNegFormat**|다음 값 중 하나입니다.<br /><br /> -($1)<br />--$1<br />-$-1<br />-$1-<br />-($1)<br />--$1<br />-1-$<br />-$1-<br />--$1<br />--$1<br />-$1-<br />-$1-<br />-$-1<br />-1-$<br />-($1)<br />-($1)<br /><br /> 이 예제는 달러 기호를 보여 주지만 실제 프로그램에서 적절 한 **CurrencySymbol** 값으로 바꾸어야 합니다.|  
