---
title: "DBASE에 대 한 반환 값 SQLGetInfo | Microsoft Docs"
ms.custom: 
ms.date: 01/19/2017
...
---
# <a name="sqlgetinfo-returned-values-for-dbase"></a>SQLGetInfo dBASE에 대 한 반환 값
...
|SQL_IDENTIFIER_CASE|SQL_IC_UPPER (한정자 값이 반환 혼합에서 Windows NT 디렉터리를 찾을 수 있도록 합니다.)|  
