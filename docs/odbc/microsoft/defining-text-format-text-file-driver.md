...
|**Width**|CHAR 또는 LONGCHAR 열에 대 한 열의 너비를 변경할 수 있습니다. 선택한 항목의 형식은 1가 기본적으로 너비를 **테이블** 목록이 대화 상자에서 이전에 정의 되지 않았습니다.<br /><br /> 다른 데이터 형식에 대 한 너비 제어를 사용 하지 않도록 설정 하 고 값이 없는 표시 됩니다.|
