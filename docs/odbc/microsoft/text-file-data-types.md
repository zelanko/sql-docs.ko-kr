...
|정수|정수 열에 유효한 값은 32767 ~ 32766입니다.<br /><br /> Schema.ini에서 너비는 다음과 같이 표시 됩니다.<br /><br /> 14083은 정수 너비 5입니다.<br /><br /> 0은 정수 너비 1입니다.<br /><br /> ODBC는 항상 정수 열에 대해 4를 반환 합니다.<br /><br /> 최대 너비는 부호를 포함 합니다. 정수 열의 최대 너비는 11 이지만 고정 형식 테이블에서 허용 되는 공백으로 인해 너비가 더 클 수 있습니다.|  
