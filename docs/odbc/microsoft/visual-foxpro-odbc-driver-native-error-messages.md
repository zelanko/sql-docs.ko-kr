...
|526|연결 오류: *값입니다.*|  
|527|ODBC 라이브러리 위한 ODBC32.DLL을 로드할 수 없습니다. GDIPLUS.DLL.|  
...
|545|별칭 \\ *값*에 대 한 테이블 버퍼에 커밋되지 않은 변경 내용이 포함 되어 있습니다.|  
