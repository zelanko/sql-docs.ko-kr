---
title: 규칙 수준 API (ODBC Driver for Oracle) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32900238"
---
# <a name="api-conformance-level-odbc-driver-for-oracle"></a>규칙 수준 API (ODBC Driver for Oracle)
> [!IMPORTANT]  
>  이 기능은 나중 버전의 Windows에서 제거 됩니다. 새 개발 작업에서는 이 기능을 사용하지 않도록 하고, 현재 이 기능을 사용하는 응용 프로그램은 수정하세요. Oracle에서 제공 하는 ODBC 드라이버를 사용 하십시오.  
 ...
 Oracle 지원에 대 한 ODBC 드라이버는 [핵심 수준 API 함수](../../odbc/microsoft/core-level-api-functions-odbc-driver-for-oracle.md) 및 [수준 1 API 함수](../../odbc/microsoft/level-1-api-functions-odbc-driver-for-oracle.md)합니다. 드라이버에서는 다음 [수준 2 API 함수](../../odbc/microsoft/level-2-api-functions-odbc-driver-for-oracle.md):  
