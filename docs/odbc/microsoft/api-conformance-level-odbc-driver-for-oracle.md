---
title: API 적합성 수준 (Oracle 용 ODBC 드라이버) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
>  이 기능은 Windows의 이후 버전에서 제거 됩니다. 새 개발 작업에서는 이 기능을 사용하지 않도록 하고, 현재 이 기능을 사용하는 애플리케이션은 수정하세요. 대신, Oracle에서 제공 하는 ODBC 드라이버를 사용 합니다.  
 ...
 ODBC Driver for Oracle 지원 합니다 [핵심 수준 API 함수](../../odbc/microsoft/core-level-api-functions-odbc-driver-for-oracle.md) 하 고 [수준 1 API 함수](../../odbc/microsoft/level-1-api-functions-odbc-driver-for-oracle.md)합니다. 드라이버에서는 다음 [수준 2 API 함수](../../odbc/microsoft/level-2-api-functions-odbc-driver-for-oracle.md):  
