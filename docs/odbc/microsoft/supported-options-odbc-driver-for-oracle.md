...
>  이 기능은 Windows의 이후 버전에서 제거 됩니다. 새 개발 작업에서는 이 기능을 사용하지 않도록 하고, 현재 이 기능을 사용하는 응용 프로그램은 수정하세요. 대신, Oracle에서 제공 하는 ODBC 드라이버를 사용 합니다.  
 ...
 Oracle 용 ODBC 드라이버는 SQLGetConnectOption () 및 SQLSetConnectOption () 수준 1 함수에 대 한 다음 옵션을 지원합니다.  
...
-   [SQL_TXN_ISOLATION](../../odbc/microsoft/connect-options.md)  
 ...
 Oracle 용 ODBC 드라이버는 SQLGetStmtOption () 및 SQLSetStmtOption () 수준 1 함수에 대 한 다음 옵션을 지원합니다.  
