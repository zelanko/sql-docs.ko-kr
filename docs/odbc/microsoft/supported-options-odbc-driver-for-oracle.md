---
title: 지원 되는 옵션 (Oracle 용 ODBC 드라이버) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
>  이 기능은 이후 버전의 Windows에서 제거 될 예정입니다. 새 개발 작업에서는 이 기능을 사용하지 않도록 하고, 현재 이 기능을 사용하는 애플리케이션은 수정하세요. 대신 Oracle에서 제공 하는 ODBC 드라이버를 사용 합니다.  
 ...
 Oracle 용 ODBC 드라이버는 SQLGetConnectOption () 및 SQLSetConnectOption () 수준 1 함수에 대해 다음과 같은 옵션을 지원 합니다.  
  
-   SQL_ACCESS_MODE ([SQLGetConnectOption](../../odbc/microsoft/level-1-api-functions-odbc-driver-for-oracle.md)()에만 해당)  
...
-   [SQL_TXN_ISOLATION](../../odbc/microsoft/connect-options.md)  
 ...
 Oracle 용 ODBC 드라이버는 SQLGetStmtOption () 및 SQLSetStmtOption () 수준 1 함수에 대해 다음과 같은 옵션을 지원 합니다.  
