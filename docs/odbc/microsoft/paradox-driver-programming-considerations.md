---
description: Paradox 드라이버 프로그래밍 고려 사항
...
-   [Paradox 데이터 형식](../../odbc/microsoft/paradox-data-types.md)  
...
> [!NOTE]  
>  ODBC 데스크톱 데이터베이스 드라이버를 통해 Paradox ISAM 파일에 액세스 하려면 Borland 데이터베이스 엔진을 설치 해야 합니다.
