---
title: SQLStatistics(액세스 드라이버) | 마이크로 소프트 문서
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|열|주석|  
|------------|--------------|  
|TABLE_QUALIFIER|데이터베이스 파일에 대한 경로는 Microsoft Access에 대해 반환됩니다.<br /><br /> 패턴 일치는 *szTableQualifier* 인수에서 지원되지 않습니다.|  
...
|CARDINALITY|Microsoft 액세스용으로만 반환되었습니다.|  
