...
|SQL_GETDATA_EXTENSIONS|SQL_GD_BLOCK &#124; 드라이버에 의해 반환 되는 모든 값 **참고:**  사용 하 여 데이터를 검색 하는 경우 **SQLFetchScroll**하십시오 **SQLGetData** SQL_GD_ANY_COLUMN 및 SQL_GD_BOUND 비트 마스크를 사용 하 여 지정 된 기능을 지원 합니다.|  
