...
|01S08|파일 DSN 저장 중 오류 발생|**SQLDriverConnect**|  
|01S09|잘못 된 키워드|**SQLDriverConnect**|  
|07001|매개 변수 수가 잘못 되었습니다|**SQLExecDirect**<br /><br /> **SQLExecute**|  
|07002|COUNT 필드가 잘못 되었습니다|**SQLExecDirect**<br /><br /> **SQLExecute**<br /><br /> **SQLParamData**|  
|07005|준비 된 문이 없습니다를 *커서 사양이*|**SQLColAttribute**<br /><br /> **SQLDescribeCol**|  
|07006|제한 된 데이터 형식 특성을 위반 했습니다.|**SQLBindCol**<br /><br /> **SQLBindParameter**<br /><br /> **SQLBulkOperations**<br /><br /> **SQLExecDirect**<br /><br /> **SQLExecute**<br /><br /> **SQLExtendedFetch**<br /><br /> **SQLFetch**<br /><br /> **SQLFetchScroll**<br /><br /> **SQLGetData**<br /><br /> **SQLParamData**<br /><br /> **SQLPutData**<br /><br /> **SQLSetPos**|  
...
|08001|클라이언트를 연결할 수 없습니다.|**SQLBrowseConnect**<br /><br /> **SQLConnect**<br /><br /> **SQLDriverConnect**|  
|08002|연결 이름 사용|**SQLBrowseConnect**<br /><br /> **SQLConnect**<br /><br /> **SQLDriverConnect**<br /><br /> **SQLSetConnectAttr**|  
...
|21S02|파생된 테이블의 단계가 열 목록과 일치 하지 않습니다.|**SQLBulkOperations**<br /><br /> **SQLExecDirect**<br /><br /> **SQLExecute**<br /><br /> **SQLParamData**<br /><br /> **SQLPrepare**<br /><br /> **SQLSetPos**|  
...
|22002|지표 변수가 필요 하지만 제공 되지|**SQLExecDirect**<br /><br /> **SQLExecute**<br /><br /> **SQLExtendedFetch**<br /><br /> **SQLFetch**<br /><br /> **SQLFetchScroll**<br /><br /> **SQLGetData**<br /><br /> **SQLParamData**|  
...
|3C000|커서 이름이 중복 됩니다.|**SQLSetCursorName**|  
...
|42S12|인덱스가 없습니다.|**SQLExecDirect**<br /><br /> **SQLPrepare**|  
|42S21|열이 이미|**SQLExecDirect**<br /><br /> **SQLPrepare**|  
...
|HY001|메모리 할당 오류|제외한 모든 ODBC 함수가:<br /><br /> **SQLError**<br /><br /> **SQLGetDiagField**<br /><br /> **SQLGetDiagRec**|  
...
|HY013|메모리 관리 오류|제외한 모든 ODBC 함수가:<br /><br /> **SQLGetDiagField**<br /><br /> **SQLGetDiagRec**|  
|HY014|초과 하는 핸들의 수를 제한|**SQLAllocHandle**|  
|HY015|커서 이름이 없습니다.|**SQLGetCursorName**|  
|HY016|구현 행 설명자를 수정할 수 없습니다.|**SQLCopyDesc**<br /><br /> **SQLSetDescField**<br /><br /> **SQLSetDescRec**|  
|HY017|자동으로 할당 된 설명자 핸들을 잘못 사용|**SQLFreeHandle**<br /><br /> **SQLSetStmtAttr**|  
|HY018|취소 요청을 거부 했습니다.|**SQLCancel**|  
|HY019|문자 및 이진이 아닌 데이터를 나누어 보냈습니다|**SQLPutData**|  
|HY020|Null 값을 연결 하려고 합니다.|**SQLPutData**|  
|HY021|일관성이 없는 설명자 정보|**SQLBindParameter**<br /><br /> **SQLCopyDesc**<br /><br /> **SQLGetDescField**<br /><br /> **SQLSetDescField**<br /><br /> **SQLSetDescRec**|  
...
|HY099|Nullable 형식 범위를 벗어났습니다.|**SQLSpecialColumns**|  
...
|HYT01|연결 제한 시간 만료 됨|제외한 모든 ODBC 함수가:<br /><br /> **SQLDrivers**<br /><br /> **SQLDataSources**<br /><br /> **SQLGetEnvAttr**<br /><br /> **SQLSetEnvAttr**|  
...
|IM004|운전 **SQLAllocHandle** SQL_HANDLE_ENV 실패에서|**SQLBrowseConnect**<br /><br /> **SQLConnect**<br /><br /> **SQLDriverConnect**|  
|IM005|운전 **SQLAllocHandle** SQL_HANDLE_DBC 실패에서|**SQLBrowseConnect**<br /><br /> **SQLConnect**<br /><br /> **SQLDriverConnect**|  
|IM006|운전 **SQLSetConnectAttr** 실패|**SQLBrowseConnect**<br /><br /> **SQLConnect**<br /><br /> **SQLDriverConnect**|  
|IM007|없는 데이터 원본 또는 드라이버 지정 금지 하는 대화 상자|**SQLDriverConnect**|  
