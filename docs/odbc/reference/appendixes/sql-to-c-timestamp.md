...
Timestamp ODBC SQL 데이터 형식에 대 한 식별자가 있습니다.  
...
_C_TYPE_TIMESTAMP|초 소수 부분 타임 스탬프는 잘리지 않습니다 [a]<br /><br /> 타임 스탬프의 초 소수 부분 잘립니다 [a]|데이터 [e]<br /><br /> 잘린된 데이터 [e]|16 [f]<br /><br /> 16 [f]|n/a<br /><br /> 01S07|  
