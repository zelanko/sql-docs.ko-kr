...
|-----------------------|----------|------------------------|----------------------------|--------------|  
|SQL_C_CHAR|*Bufferlength* > 문자 바이트 길이입니다.<br /><br /> 20 <= *bufferlength* <= 문자 바이트 길이<br /><br /> *Bufferlength* < 20|data<br /><br /> 잘린 데이터 [b]<br /><br /> 정의되지 않음|데이터의 길이 (바이트)<br /><br /> 데이터의 길이 (바이트)<br /><br /> 정의되지 않음|해당 없음<br /><br /> 01004<br /><br /> 22003|  
|SQL_C_WCHAR|*Bufferlength* > 문자 길이입니다.<br /><br /> 20 <= *bufferlength* <= 문자 길이<br /><br /> *Bufferlength* < 20|data<br /><br /> 잘린 데이터 [b]<br /><br /> 정의되지 않음|데이터의 길이 (문자)<br /><br /> 데이터의 길이 (문자)<br /><br /> 정의되지 않음|해당 없음<br /><br /> 01004<br /><br /> 22003|  
...
|SQL_C_TYPE_DATE|타임 스탬프의 시간 부분이 0 [a]입니다.<br /><br /> 타임 스탬프의 시간 부분은 0이 아닙니다. [a]|data<br /><br /> 잘린 데이터 [c]|6 [f]<br /><br /> 6 [f]|해당 없음<br /><br /> 01S07|  
