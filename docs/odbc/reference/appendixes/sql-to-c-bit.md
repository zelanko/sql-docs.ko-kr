...
|-----------------------|----------|------------------------|----------------------------|--------------|  
|SQL_C_CHAR<br /><br /> SQL_C_WCHAR|*Bufferlength* > 1<br /><br /> *Bufferlength* <= 1|데이터<br /><br /> 정의되지 않음|1<br /><br /> 정의되지 않음|해당 없음<br /><br /> 22003|  
...
|SQL_C_BINARY|*Bufferlength* >= 1<br /><br /> *Bufferlength* < 1|데이터<br /><br /> 정의되지 않음|1<br /><br /> 정의되지 않음|해당 없음<br /><br /> 22003|  
