---
title: SQL에서 C 데이터 변환 예제 | 마이크로 소프트 문서
ms.custom: ''
ms.date: 01/19/2019
ms.prod: sql
...
ms.locfileid: "81296653"
---
# <a name="sql-to-c-data-conversion-examples"></a>SQL에서 C로 데이터 변환 예제

다음 표에 나와 있는 예제에서는 드라이버가 SQL 데이터를 C 데이터로 변환하는 방법을 보여 줍니다.  
  
|SQL 유형<br /><br /> identifier|SQL data<br /><br /> value|C 형식<br /><br /> identifier|Buffer<br /><br /> length|**대상 밸류프트*|SQLSTATE|  
|-----------------------------|------------------------|---------------------------|-----------------------|------------------------|--------------|  
...
|SQL_TYPE_TIMESTAMP|1992-12-31 23:45:55.12|SQL_C_CHAR|18|----|22003|  
 ...
 [a] "\0"은 null 종료 바이트를 나타냅니다. 드라이버는 항상 null-SQL_C_CHAR 데이터를 종료합니다.  
  
 [b] 이 목록의 숫자는 TIMESTAMP_STRUCT 구조의 필드에 저장된 숫자입니다.
