...
|-----------------------|----------|------------------------|----------------------------|--------------|  
|SQL_C_CHAR|*Bufferlength* > 문자 바이트 길이입니다.<br /><br /> 11 <= *bufferlength* <= 문자 바이트 길이<br /><br /> *Bufferlength* < 11|데이터<br /><br /> 잘린 데이터<br /><br /> 정의되지 않음|10<br /><br /> 데이터의 길이 (바이트)<br /><br /> 정의되지 않음|해당 없음<br /><br /> 01004<br /><br /> 22003|  
|SQL_C_WCHAR|*Bufferlength* > 문자 길이입니다.<br /><br /> 11 <= *bufferlength* <= 문자 길이<br /><br /> *Bufferlength* < 11|데이터<br /><br /> 잘린 데이터<br /><br /> 정의되지 않음|10<br /><br /> 데이터의 길이 (문자)<br /><br /> 정의되지 않음|해당 없음<br /><br /> 01004<br /><br /> 22003|  
