...
|HY109|잘못 된 커서 위치|\**StatementText* 에 커서가 있었기 및에 위치 지정 업데이트 또는 삭제 문의 포함 된 (여 **SQLSetPos** 또는 **SQLFetchScroll**)에 한 행을 삭제 하거나 가져올 수 없습니다.|  
