 ...
 **Sqlcancelhandle** 이 SQL_ERROR 또는 SQL_SUCCESS_WITH_INFO를 반환 하는 경우 연결 된 SQLSTATE 값은 HandleType SQL_HANDLE_STMT의 *HandleType* 및 문 핸들 *핸들이* 나 SQL_HANDLE_DBC *HandleType* 및 연결 핸들 *핸들*을 사용 하 여 **SQLGetDiagRec** 를 호출 하 여 가져올 수 있습니다.  
