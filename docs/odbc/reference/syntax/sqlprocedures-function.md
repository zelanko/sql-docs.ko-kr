...
|NUM_INPUT_PARAMS (ODBC 2.0)|4|해당 없음|향후 사용을 위해 예약되어 있습니다. 응용 프로그램은 이러한 결과 열에서 반환 되는 데이터에 의존해 서는 안 됩니다.|  
|NUM_OUTPUT_PARAMS (ODBC 2.0)|5|해당 없음|향후 사용을 위해 예약되어 있습니다. 응용 프로그램은 이러한 결과 열에서 반환 되는 데이터에 의존해 서는 안 됩니다.|  
|NUM_RESULT_SETS (ODBC 2.0)|6|해당 없음|향후 사용을 위해 예약되어 있습니다. 응용 프로그램은 이러한 결과 열에서 반환 되는 데이터에 의존해 서는 안 됩니다.|  
...
|프로시저의 매개 변수 및 결과 집합 열 반환|[SQLProcedureColumns 함수(SQLProcedureColumns Function)](../../../odbc/reference/syntax/sqlprocedurecolumns-function.md)|  
