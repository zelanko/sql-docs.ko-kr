---
title: SQLFreeEnv 함수 | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "53203782"
---
# <a name="sqlfreeenv-function"></a>SQLFreeEnv 함수
**규칙**  
 도입 된 버전: ODBC 1.0 표준 준수 합니다. 사용되지 않음  
  
 **요약**  
 ODBC 3에서 *.x*, ODBC 2.0 함수 **SQLFreeEnv** 바뀌었습니다 **SQLFreeHandle**합니다. 자세한 내용은 [SQLFreeHandle](../../../odbc/reference/syntax/sqlfreehandle-function.md)합니다.  
