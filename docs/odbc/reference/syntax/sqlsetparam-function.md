...
> [!NOTE]  
>  자세한 내용은 관리자에 대 한 어떤를 드라이버에 대 한 경우는 ODBC 2이이 함수를를 매핑합니다. *x* 응용 프로그램이 작동을 ODBC 3. *x* 드라이버를 참조 하세요 [사용 되지 않는 함수 매핑](../../../odbc/reference/appendixes/mapping-deprecated-functions.md)합니다.  
