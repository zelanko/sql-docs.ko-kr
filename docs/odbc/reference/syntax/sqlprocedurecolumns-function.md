...
## <a name="comments"></a>주석  
 이 함수는 프로시저 매개 변수와 프로시저에서 반환 하는 결과 집합을 구성 하는 열 (있는 경우)에 대 한 정보를 검색 하기 위해 문 실행 전에 일반적으로 사용 됩니다. 자세한 내용은 [절차](../../../odbc/reference/develop-app/procedures-odbc.md)를 참조 하세요.  
