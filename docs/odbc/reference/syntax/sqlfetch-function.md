...
|HY107|행 값이 범위를 벗어났습니다.|SQL_ATTR_CURSOR_TYPE statement 특성으로 지정 된 값이 SQL_CURSOR_KEYSET_DRIVEN 되었지만 SQL_ATTR_KEYSET_SIZE statement 특성으로 지정 된 값이 0 보다 크고 SQL_ATTR_ROW_ARRAY_SIZE statement 특성에 지정 된 값 보다 작아야 합니다.|  
