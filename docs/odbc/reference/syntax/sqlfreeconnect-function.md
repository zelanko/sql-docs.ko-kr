 ...
 **요약**  
 Odbc에서 *3.x*, ODBC 2.0 함수 **SQLFreeConnect** 바뀌었습니다 **SQLFreeHandle**합니다. 자세한 내용은 [SQLFreeHandle](../../../odbc/reference/syntax/sqlfreehandle-function.md)합니다.  
