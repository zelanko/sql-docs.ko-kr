 ...
 **요약**  
 ODBC 3에서 *.x*, ODBC 2.0 함수 **SQLFreeConnect** 로 대체 되었습니다 **SQLFreeHandle**합니다. 자세한 내용은 참조 [SQLFreeHandle](../../../odbc/reference/syntax/sqlfreehandle-function.md)합니다.  
