---
title: SQLFreeConnect 함수 | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **요약**  
 *Odbc 3.x에서 odbc 2.0*함수 **SQLFreeConnect** 는 **sqlfreehandle**으로 대체 되었습니다. 자세한 내용은 [Sqlfreehandle](../../../odbc/reference/syntax/sqlfreehandle-function.md)을 참조 하세요.  
