 ...
 **요약**  
 Odbc에서 *3.x*, ODBC *2.x* 함수 **SQLGetConnectOption** 바뀌었습니다 **SQLGetConnectAttr**합니다. 자세한 내용은 [SQLGetConnectAttr](../../../odbc/reference/syntax/sqlgetconnectattr-function.md)합니다.  
