 ...
 *옵션*  
 ...
 SQL_UNBIND: StatementHandle의 SQL_DESC_COUNT 필드를 0으로 설정 하 여 지정 된 ** 에 대해 **SQLBindCol** 에 의해 바인딩된 모든 열 버퍼를 해제 합니다. 책갈피 열의 바인딩을 해제 하지 않습니다. 이렇게 하려면 책갈피 열에 대 한 SQL_DESC_DATA_PTR 필드가 NULL로 설정 됩니다. 둘 이상의 문에서 공유 하는 명시적으로 할당 된 설명자에 대해이 작업을 수행 하면 해당 작업은 설명자를 공유 하는 모든 문의 바인딩에 영향을 줍니다. 자세한 내용은 [결과 검색 개요 (Basic)](../../../odbc/reference/develop-app/retrieving-results-basic.md)를 참조 하세요.  
