 ...
 **요약**  
 ODBC 3에서 *.x*, ODBC 2.0 함수 **SQLSetStmtOption** 로 대체 되었습니다 **SQLSetStmtAttr**합니다. 자세한 내용은 참조 [SQLSetStmtAttr](../../../odbc/reference/syntax/sqlsetstmtattr-function.md)합니다.  
