...
ms.locfileid: "47622561"
---
# <a name="standard-programming-interface"></a>표준 프로그래밍 인터페이스
프로그래밍 인터페이스는 아마도 표준화에 대 한 가장 확실 한 후보입니다. 사실, ODBC 개발 중인 경우 ANSI 및 ISO 이미 제공 표준을 포함 된 SQL 및 SQL 모듈입니다. CLI의 SQL 액세스 그룹을 데이터베이스에 대 한 없는 표준 존재 하지만-데이터베이스 공급 업체의 업계 컨소시엄-하나; 만들지 여부를 고려 했습니다 ODBC의 일부를 나중에 회사의 기반이 되었습니다.  
