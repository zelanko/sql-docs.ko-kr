...
|**SQLLevel**|드라이버에서 지 원하는 SQL-92 문법 나타내는 번호:<br /><br /> 0 = SQL-92 항목<br /><br /> 1 = 전환 FIPS127 2<br /><br /> 2 = SQL-92 중간<br /><br /> 3 = SQL-92 Full<br /><br /> 이 같아야 SQL_SQL_CONFORMANCE 옵션에 대 한 반환 값으로 **SQLGetInfo**합니다.|  
