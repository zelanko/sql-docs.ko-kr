...
-   **SQLSetPos** 에 대 한 이전 호출을 기준으로 적용 되는 행 집합 크기를 사용 하 여 **SQLFetch** 또는 **SQLFetchScroll**때문에, **SQLSetPos** 행 집합에서 작동 합니다. 이미 설정 되었습니다. **SQLSetPos** 도 선택 됩니다 새 행 집합 크기가 경우 **SQLBulkOperations** 를 호출한 후 행 집합 크기가 변경 되었습니다.  
