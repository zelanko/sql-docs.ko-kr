...
|type|DM 버전|응용 프로그램의 버전|드라이버의 버전|  
|----------|-------------------|----------------------------|-----------------------|  
...
> [!NOTE]
>  표준 호환 응용 프로그램-예를 들어는 Open Group 또는 ISO CLI 표준에 따라 작성 된 응용 프로그램은 항상 작동 ODBC를 사용 하 여 *3.x* ODBC 통해 드라이버 *3.x*드라이버 관리자입니다. 응용 프로그램을 사용 하는 기능은 드라이버에서 사용할 수 있는 것으로 간주 합니다. 표준 호환 응용 프로그램을 ODBC를 사용 하 여 컴파일된에 또한 간주 *3.x* 헤더 파일입니다.
