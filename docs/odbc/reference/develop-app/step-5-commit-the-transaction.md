...
다음 단계는 다음 그림과 같이 트랜잭션을 커밋하는 것입니다.  
 ...
 다섯 번째 단계는 **Sqlendtran** 을 호출 하 여 트랜잭션을 커밋하거나 롤백해야 합니다. 응용 프로그램은 트랜잭션 커밋 모드를 수동 커밋으로 설정한 경우에만이 단계를 수행 합니다. 트랜잭션 커밋 모드가 기본값인 자동 커밋 인 경우 문이 실행 될 때 트랜잭션이 자동으로 커밋됩니다. 자세한 내용은 [트랜잭션](../../../odbc/reference/develop-app/transactions-odbc.md)을 참조 하세요.  
