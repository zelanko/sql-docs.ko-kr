...
ms.locfileid: "88429375"
---
# <a name="data-buffer-length"></a>데이터 버퍼 길이
응용 프로그램은 데이터 버퍼의 바이트 길이를 *bufferlength* 또는 이와 유사한 이름의 인수에 있는 드라이버로 전달 합니다. 예를 들어 SQLBindCol에 대 한 다음 호출에서 응용 프로그램은 **SQLBindCol** *의 길이* (**sizeof (***valueptr***)**)를 지정 합니다.  
