...
-   [연결 핸들 할당](../../../odbc/reference/develop-app/allocating-a-connection-handle-odbc.md)  
  
-   [연결 특성](../../../odbc/reference/develop-app/connection-attributes.md)  
  
-   [연결 설정](../../../odbc/reference/develop-app/establishing-a-connection.md)  
...
-   [연결 프로세스에서 드라이버 관리자의 역할](../../../odbc/reference/develop-app/driver-manager-s-role-in-the-connection-process.md)
