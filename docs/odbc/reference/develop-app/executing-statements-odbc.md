...
ms.locfileid: "47675581"
---
# <a name="executing-statements-odbc"></a>명령문 ODBC 실행
ODBC 응용 프로그램은 SQL 문을 실행 하 여 거의 모든 데이터베이스 액세스를 수행 합니다. 이벤트의 일반적인 순서 문 핸들을 할당, 모든 문 특성을 설정, 문을 실행 하 여, 모든 결과 검색 및 문 핸들입니다.  
  
 이 섹션에서는 다음 항목을 다룹니다.  
  
-   [문 핸들 할당](../../../odbc/reference/develop-app/allocating-a-statement-handle-odbc.md)  
  
-   [문 특성](../../../odbc/reference/develop-app/statement-attributes.md)  
  
-   [문 실행](../../../odbc/reference/develop-app/executing-a-statement.md)  
