...
|초당 ODBC 소프트 연결 카운터|초당 풀에서 만족된 하는 연결 수-즉, 해당 풀에서는 연결 된 사용자에 게 전달 합니다. 이 카운터는 풀링 작동 하는지 여부를 나타냅니다. 서버의 부하에 따라 초당 40-60 소프트 연결을 표시 하려면이 옵션에 대 한 일반적이 지 않은 아닙니다.|  
