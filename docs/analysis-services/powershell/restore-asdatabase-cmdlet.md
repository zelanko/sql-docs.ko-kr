...
### -Credential \<PSCredential>  
 ...
 인증 및 자격 증명 사용에 대한 자세한 내용은 [Analysis Services의 PowerShell 스크립팅](../../analysis-services/instances/powershell-scripting-in-analysis-services.md)을 참조하세요. HTTP 액세스에 대한 자세한 내용은 [IIS&#40;인터넷 정보 서비스&#41; 8.0에서 Analysis Services에 대한 HTTP 액세스 구성](../../analysis-services/instances/configure http access to analysis services on iis 8.0.md)을 참조하세요.  
