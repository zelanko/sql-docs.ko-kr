---
title: "AMO PowerShell 예제 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# AMO PowerShell 예제
  아래는 AMO(Analysis Services Management Object) 형식을 호출하여 SQL Server 관계형 데이터베이스에 기반한 테이블 형식 데이터베이스(호환성 수준 1200)를 만드는 예제 PowerShell 스크립트입니다.  
  
 이 예제는 예시용입니다. 짧은 테이블 관계 정의를 중지하고 데이터 가져오기는 포함되지 않습니다.  이렇게 하면 스크립트는 실행 준비 코드보다 많은 코드 조각을 가집니다. 실행 가능하게 되려면 간격을 채우는 다른 도우미 함수 및 더 많은 명령이 필요합니다.  
  
## DatabaseGenerate.ps1 예제  
...
## 관련 항목:  
 ...
 [Analysis Services PowerShell 참조](../../analysis-services/powershell/analysis-services-powershell-reference.md)   
 [AMO&#40;Analysis Services Management Objects&#41;](../Topic/Analysis%20Services%20Management%20Objects%20\(AMO\).md)   
