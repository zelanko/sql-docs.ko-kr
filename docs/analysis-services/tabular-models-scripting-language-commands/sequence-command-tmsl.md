...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]사용 하 여는 **시퀀스** 연속 된 일련의 작업 일괄 처리 모드에서 Analysis Services의 인스턴스에서 실행 될 명령을 합니다.  전체 명령 및 해당 구성 요소 부분의 모든 트랜잭션이 성공 하기 위해 완료 해야 합니다.  
