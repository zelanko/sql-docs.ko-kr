...
4.  [!INCLUDE[clickOK](../includes/clickok-md.md)]  
    ...
    이제 **Sales Territory Group**은 **Sales Territory Country**에 연결되고 **Sales Territory Country**는 **Sales Territory Region**에 연결됩니다. 한 국가의 지역 그룹화와 국가의 그룹화는 나중에 달라질 수 있으므로 이러한 각 관계의 **RelationshipType** 속성은 **유동**으로 설정됩니다.  
...
14. [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)]의 **빌드** 메뉴에서 **Analysis Services Tutorial 배포**를 클릭합니다.  
...
[사용자 계층 속성](../Topic/User%20Hierarchy%20Properties.md)  
