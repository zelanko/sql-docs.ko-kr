...
그룹화 방법을 지정한 후에 **DiscretizationBucketCount** 속성을 사용하여 그룹 수를 지정해야 합니다. 자세한 내용은 [특성 멤버 그룹화&#40;불연속화&#41;](../analysis-services/multidimensional-models/group-attribute-members-discretization.md)를 참조하세요.  
...
5.  속성 창에서 **DiscretizationMethod** 속성 값을 **Automatic**으로 변경하고 **DiscretizationBucketCount** 속성 값을 **5**로 변경합니다.  
    ...
    ![연간 소득에 대한 수정된 속성](../analysis-services/media/l4-discretizationmethod-1.gif "연간 소득에 대한 수정된 속성")  
...
9. 필드 목록에서 **Employee** 차원과 **Organization**을 차례로 확장한 후 **Sick Leave Hours**를 **열 레이블**로 끌어옵니다.  
    ...
    ![직원 병가 시간별로 차원을 구분한 판매량](../analysis-services/media/l4-discretizationmethod-2.gif "직원 병가 시간별로 차원을 구분한 판매량")  
...
3.  [!INCLUDE[ssBIDevStudio](../includes/ssbidevstudio-md.md)]의 **빌드** 메뉴에서 **Analysis Services Tutorial 배포**를 클릭합니다.  
...
## 참고 항목  
[특성 멤버 그룹화&#40;불연속화&#41;](../analysis-services/multidimensional-models/group-attribute-members-discretization.md)  
