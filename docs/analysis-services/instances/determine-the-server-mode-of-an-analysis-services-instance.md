...
## 개체 탐색기의 서버 아이콘  
 ...
 ![각 서버 모드에 대한 개체 탐색기 아이콘](../../analysis-services/instances/media/ssas-ssms-servermodes.gif "각 서버 모드에 대한 개체 탐색기 아이콘")  
  
## MSMDSRV.INI 파일에서 DeploymentMode 속성 보기  
...
## 관련 항목:  
 ...
 [SharePoint 2010용 파워 피벗 설치](http://msdn.microsoft.com/ko-kr/8d47dde7-c941-4280-a934-e2fe3f9a938f)   
