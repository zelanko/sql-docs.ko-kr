...
||Continuous Column Values|DMX SELECT DISTINCT FROM 사용 하는 방법을 보여 줍니다  *\<모델 >* DMX 사용 하 여 문을 **RangeMin** 하 고 **RangeMax** 의 집합을 검색 하는 함수 지정한 마이닝 모델의 연속 열에서 지정 된 범위의 값입니다.|  
