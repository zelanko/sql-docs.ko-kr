...
ms.topic: "article"
helpviewer_keywords: 
  - "Analysis Services 개체, 스크립트"
  - "개체 [Analysis Services], 스크립트"
  - "스크립트 [Analysis Services], 개체"
...
## 관련 항목:  
 ...
 [XMLA 쿼리 편집기&#40;Analysis Services - 다차원 데이터&#41;](../Topic/XMLA%20Query%20Editor%20\(Analysis%20Services%20-%20Multidimensional%20Data\).md)  
