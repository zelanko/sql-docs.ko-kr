---
title: "Analysis Services의 로그 작업 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
4.  필요에 따라 쿼리를 다른 속도로 샘플링하거나 테이블에 다른 이름을 사용하려면 **QueryLogSampling** 또는 **QueryLogTableName** 을 변경합니다.  
 ...
 ![Management Studio의 쿼리 로그 설정](../../analysis-services/instances/media/ssas-querylogsettings.png "Management Studio의 쿼리 로그 설정")  
