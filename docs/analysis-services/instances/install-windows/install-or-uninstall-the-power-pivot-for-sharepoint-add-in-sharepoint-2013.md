---
title: "SharePoint용 파워 피벗 추가 기능 설치 또는 제거(SharePoint 2013) | Microsoft Docs"
ms.custom: ""
ms.date: "03/20/2017"
...
-   **응용 프로그램 서버:** [!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)] 기능에는 통합 문서를 데이터 원본으로 사용하는 기능, 예약된 데이터 새로 고침 및 [!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)] 관리 대시보드가 포함됩니다.  
     ...
     [!INCLUDE[ssGeminiShortvnext](../../../includes/ssgeminishortvnext-md.md)] 은 Analysis Services 클라이언트 라이브러리를 배포하고 [!INCLUDE[ssGeminiShortvnext](../../../includes/ssgeminishortvnext-md.md)] 설치 파일을 컴퓨터에 복사하는 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] Windows Installer 패키지(**spPowerpivot.msi**)입니다. 설치 관리자는 SharePoint의 [!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)] 기능을 배포 또는 구성하지 않습니다. 다음 구성 요소가 기본적으로 설치됩니다.  
...
-   [!INCLUDE[ssASCurrent](../../../includes/ssascurrent-md.md)] 모드의 [!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)] 서버. Excel Services에서는 SQL Server Analysis Services 인스턴스를 [!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)] 서버로 사용합니다. Analysis Services는 로컬 컴퓨터 또는 원격 컴퓨터에서 실행할 수 있습니다.  
