...
2.  **동작** 탭의 도구 모음에서 **새 드릴스루 동작** 단추를 클릭합니다.  
    ...
    ![표시 창의 빈 동작 템플릿](../analysis-services/media/l8-action2.gif "표시 창의 빈 동작 템플릿")  
...
7.  판매액을 마우스 오른쪽 단추로 클릭하고 **추가 동작**을 가리킨 다음 **Drillthrough to Order Details**를 클릭합니다.  
    ...
    ![Adam Powell로 운송되는 주문](../analysis-services/media/l8-action6.gif "Adam Powell로 운송되는 주문")  
...
9. [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] Tutorial 큐브에 대한 큐브 디자이너의 **동작** 탭으로 전환합니다.  
...
2.  배포가 성공적으로 완료되면 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] Tutorial 큐브에 대한 큐브 디자이너에서 **브라우저** 탭으로 전환한 다음 **다시 연결** 단추를 클릭합니다.  
...
5.  **Internet Sales-Sales Amount** 데이터 셀을 클릭하고 **추가 동작**을 가리킨 다음 **Drillthrough to Order Details**를 클릭합니다.  
    ...
    ![Adam Powell로 운송되는 주문](../analysis-services/media/l8-action8.gif "Adam Powell로 운송되는 주문")  
