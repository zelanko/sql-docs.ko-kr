...
ms.topic: "article"
helpviewer_keywords: 
  - "마이닝 모델 예측 [Analysis Services], 마이닝 모델 선택"
...
1.  이 예제 쿼리를 작성하는 데 사용할 수 있는 클러스터링 모델이 없는 경우 [기본 데이터 마이닝 자습서](../Topic/Basic%20Data%20Mining%20Tutorial.md)를 사용하여 [TM_Clustering] 모델을 만듭니다.  
