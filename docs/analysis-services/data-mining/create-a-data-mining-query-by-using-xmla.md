---
title: "XMLA를 사용하여 데이터 마이닝 쿼리 만들기 | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
## XML/A를 사용하여 데이터 마이닝 스키마 행 집합 쿼리  
...
#### MINING MODEL CONTENT 스키마 행 집합에서 열 이름을 검색하려면  
  
1.  **스키마 행 집합 검색** 템플릿이 열려 있는 상태에서 **실행**을 클릭합니다.  
  
     현재 인스턴스에서 사용할 수 있는 모든 행 집합에 대한 행 집합 이름 및 행 집합 열이 포함된 스키마 행 집합 목록이 **결과** 창에 반환됩니다.  
  
2.  **쿼리** 창에서 **\<Restriction List>** 뒤에 커서를 놓고 Enter 키를 눌러 새 줄을 추가합니다.  
  
3.  추가한 빈 줄에 커서를 놓고 **\<SchemaName>DMSCHEMA_MINING_MODEL_CONTENT\</SchemaName>**을 입력합니다.  
...
#### MINING MODEL CONTENT 스키마 행 집합을 사용하여 내용 쿼리를 만들려면  
