...
|4|Bayesian Dirichlet Equivalent (BDE) with uniform prior<br /><br /> (기본값)|  
 ...
 이러한 점수 매기기 방법에 대한 자세한 내용은 [Feature Selection](../Topic/Feature%20Selection.md)을 참조하십시오.  
