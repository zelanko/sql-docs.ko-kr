...
### <a name="discrete-and-continuous-inputs"></a>불연속 및 연속 입력  
 ...
 방법에 대 한 설명은 더 detained [!INCLUDE[msCoName](../../includes/msconame-md.md)] 의사 결정 트리 알고리즘이 예측 가능한 불연속 열을 사용 하 여 내용은 [Learning Bayesian Networks: 지식 및 통계 데이터의 조합](http://research.microsoft.com/en-us/um/people/heckerman/hgc94uai.pdf)합니다. [!INCLUDE[msCoName](../../includes/msconame-md.md)] 의사 결정 트리 알고리즘에서 예측 가능한 연속 열을 사용하는 방법에 대한 자세한 내용은 [시계열 분석을 위한 자동 회귀 트리 모델](http://go.microsoft.com/fwlink/?LinkId=45966)의 부록을 참조하세요.  
...
|모델링 플래그|Description|  
|-------------------|-----------------|  
|MODEL_EXISTENCE_ONLY|열의 상태를 가진 것으로 간주 됩니다 것을 의미 합니다. **누락** 하 고 **기존**합니다. Null은 누락 값입니다.<br /><br /> 마이닝 모델 열에 적용됩니다.|  
