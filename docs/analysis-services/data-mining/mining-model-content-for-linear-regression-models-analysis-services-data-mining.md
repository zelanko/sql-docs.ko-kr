---
title: "선형 회귀 모델에 대한 마이닝 모델 콘텐츠(Analysis Services - 데이터 마이닝) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## 선형 회귀 모델의 구조 이해  
 ...
 ![선형 회귀에 대한 모델 구조](../../analysis-services/data-mining/media/modelcontentstructure-linreg.gif "선형 회귀에 대한 모델 구조")  
...
## 주의  
 ...
 [Microsoft 트리 뷰어](../../analysis-services/data-mining/browse-a-model-using-the-microsoft-tree-viewer.md)의 **(All)** 노드를 클릭하여 **마이닝 범례**에서 전체 회귀 수식을 볼 수 있습니다.  
