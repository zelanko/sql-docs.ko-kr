...
## <a name="implementation-of-the-microsoft-naive-bayes-algorithm"></a>Microsoft Naive Bayes 알고리즘 구현  
 ...
 Bayes 정리의 수학적 속성 설명은이 설명서;의 범위를 벗어납니다. 자세한 내용은 이라는 제목의 Microsoft research 백서를 참조 하세요. [Learning Bayesian Networks: 지식 및 통계 데이터의 조합](http://go.microsoft.com/fwlink/?LinkId=207029)합니다.  
