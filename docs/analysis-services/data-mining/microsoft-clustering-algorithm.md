...
ms.topic: "article"
helpviewer_keywords: 
  - "세그먼트화 알고리즘 [Analysis Services]"
  - "가장 인접한 항목 [데이터 마이닝]"
  - "클러스터링 [데이터 마이닝]"
  - "클러스터 [Analysis Services]"
  - "관계 [Analysis Services], 클러스터"
  - "알고리즘 [데이터 마이닝]"
  - "분류 알고리즘 [Analysis Services]"
  - "데이터 집합 [Analysis Services]"
...
# Microsoft 클러스터링 알고리즘
 ...
 ![출퇴근자 경향에 대한 클러스터 패턴](../../analysis-services/data-mining/media/clustering-example.gif "출퇴근자 경향에 대한 클러스터 패턴")  
...
## 알고리즘 작동 방법  
 ...
 ![데이터 집합에 포함된 사례의 산점도](../../analysis-services/data-mining/media/clustering-plot.png "데이터 집합에 포함된 사례의 산점도")  
