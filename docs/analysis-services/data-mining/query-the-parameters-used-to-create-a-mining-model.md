---
title: "마이닝 모델을 만드는 데 사용한 매개 변수 쿼리 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
## 예제  
 다음 코드는 [Basic Data Mining Tutorial](../Topic/Basic%20Data%20Mining%20Tutorial.md)에서 생성한 마이닝 모델을 만드는 데 사용한 매개 변수 목록을 반환합니다. 이러한 매개 변수에는 서버의 공급자가 제공하는 마이닝 서비스에 사용되는 기본값에 대한 명시적 값이 포함됩니다.  
