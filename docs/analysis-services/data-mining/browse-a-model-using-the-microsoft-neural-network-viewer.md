---
title: "Microsoft 신경망 뷰어를 사용하여 모델 찾아보기 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "마이닝 모델 콘텐츠, 보기"
  - "분류 마이닝 모델 [Analysis Services]"
  - "Microsoft 신경망 뷰어"
  - "회귀 알고리즘 [Analysis Services]"
  - "신경망 뷰어 [Analysis Services]"
  - "신경망 모델 [Analysis Services]"
...
---
# Microsoft 신경망 뷰어를 사용하여 모델 찾아보기
...
-   집에 두 아이도 함께 살고 있음  
 ...
 발견된 각 패턴을 나타내는 수식과 같은 자세한 정보를 보려는 경우 뷰로 전환하고 [!INCLUDE[msCoName](../../includes/msconame-md.md)] 일반 콘텐츠 트리 뷰어를 사용할 수 있습니다. 자세한 내용은 [Microsoft 일반 콘텐츠 트리 뷰어를 사용하여 모델 찾아보기](../../analysis-services/data-mining/browse-a-model-using-the-microsoft-generic-content-tree-viewer.md) 또는 [Microsoft 일반 콘텐츠 트리 뷰어&#40;데이터 마이닝&#41;](../Topic/Microsoft%20Generic%20Content%20Tree%20Viewer%20\(Data%20Mining\).md)를 참조하세요.  
