...
ms.topic: "article"
helpviewer_keywords: 
  - "스키마 행 집합 [Analysis Services], 데이터 마이닝"
  - "데이터 마이닝 [Analysis Services], 쿼리"
  - "마이닝 모델 콘텐츠"
  - "데이터 마이닝 [Analysis Services], 스키마 행 집합"
  - "스키마 행 집합 [Analysis Services], 검색"
  - "데이터 마이닝[Analysis Services], 문제 해결"
