---
title: "Microsoft 일반 콘텐츠 트리 뷰어를 사용하여 모델 찾아보기 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# Microsoft 일반 콘텐츠 트리 뷰어를 사용하여 모델 찾아보기
...
## 마이닝 모델 콘텐츠 보기  
 ...
 마이닝 모델 콘텐츠에 사용된 용어의 일반적인 의미에 대한 자세한 내용은 [마이닝 모델 콘텐츠&#40;Analysis Services - 데이터 마이닝&#41;](../../analysis-services/data-mining/mining-model-content-analysis-services-data-mining.md)를 참조하세요. 항목에는 특정 모델 유형의 마이닝 모델 콘텐츠에 대한 정보를 볼 수 있는 링크도 포함되어 있습니다. 각 마이닝 모델 유형에 데이터에서 찾은 알고리즘 및 패턴과 관련성이 매우 높은 정보가 포함되어 있으므로 각 모델 유형을 완전히 이해하기 위해 각 모델 유형에 대해 기술 참조 항목을 검토하는 것이 좋습니다.  
