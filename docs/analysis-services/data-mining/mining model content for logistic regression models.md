---
title: "로지스틱 회귀 모델에 대한 마이닝 모델 콘텐츠(Analysis Services - 데이터 마이닝) | Microsoft Docs"
ms.custom: ""
ms.date: "12/09/2016"
...
## 로지스틱 회귀 모델의 구조 이해  
 ...
 ![로지스틱 회귀 모델에 대한 콘텐츠 구조](../../analysis-services/data-mining/media/skt-modelcontentstructure-logregc.gif "로지스틱 회귀 모델에 대한 콘텐츠 구조")  
...
|출력 노드|NODE_DESCRIPTION 열과 동일한 정보가 들어 있는 XML 조각입니다.|  
 ...
 NODE_DISTRIBUTION  
 노드에 대한 통계 정보가 들어 있는 중첩 테이블입니다. 각 노드 유형과 관련해서 이 테이블에 포함되는 내용에 대한 자세한 내용은 [신경망 모델에 대한 마이닝 모델 콘텐츠&#40;Analysis Services - 데이터 마이닝&#41;](../../analysis-services/data-mining/mining-model-content-for-neural-network-models-analysis-services-data-mining.md)에서 "NODE_DISTRIBUTION 테이블 이해" 섹션을 참조하세요.  
