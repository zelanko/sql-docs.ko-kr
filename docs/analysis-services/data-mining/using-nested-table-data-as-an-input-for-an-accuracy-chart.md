---
title: "정확도 차트에 대한 입력으로 중첩 테이블 데이터 사용 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "마이닝 정확도 차트 [Analysis Services], 중첩 테이블"
  - "마이닝 정확도 차트 [Analysis Services], 입력 테이블"
  - "중첩 테이블"
  - "중첩 테이블 추가"
