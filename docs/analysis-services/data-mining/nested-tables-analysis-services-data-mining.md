...
ms.topic: "article"
helpviewer_keywords: 
  - "데이터 마이닝 [Analysis Services], 중첩 테이블"
  - "테이블 [Analysis Services], 중첩"
  - "중첩 테이블"
...
# 중첩 테이블(Analysis Services - 데이터 마이닝)
 ...
 ![중첩 테이블을 사용하여 결합한 두 테이블](../../analysis-services/data-mining/media/nested-tables.gif "중첩 테이블을 사용하여 결합한 두 테이블")  
