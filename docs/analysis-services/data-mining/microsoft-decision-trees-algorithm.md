...
### 불연속 열 예측  
 ...
 ![의사 결정 트리 노드](../../analysis-services/data-mining/media/dt-tree.gif "의사 결정 트리 노드")  
...
### 연속 열 예측  
 ...
 ![비선형성을 보여 주는 다중 회귀선](../../analysis-services/data-mining/media/regression-tree1.png "비선형성을 보여 주는 다중 회귀선")  
 ...
 ![비선형점을 나타내는 수식](../../analysis-services/data-mining/media/regression-tree2.gif "비선형점을 나타내는 수식")  
