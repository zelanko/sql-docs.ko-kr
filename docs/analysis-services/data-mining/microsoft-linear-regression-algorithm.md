...
# Microsoft 선형 회귀 알고리즘
 ...
 ![데이터 집합을 모델링하는 선](../../analysis-services/data-mining/media/linear-regression.png "데이터 집합을 모델링하는 선")  
 ...
 **Microsoft 트리 뷰어**를 사용하여 모델을 탐색할 수 있습니다. 선형 회귀 모델에 대한 트리 구조는 매우 간단하며 회귀 수식에 대한 모든 정보는 단일 노드에 포함됩니다. 자세한 내용은 [Microsoft 트리 뷰어를 사용하여 모델 찾아보기](../../analysis-services/data-mining/browse-a-model-using-the-microsoft-tree-viewer.md)를 참조하세요.  
 ...
 선형 회귀 모델의 경우 모델 콘텐츠에는 메타데이터, 회귀 수식 및 입력 값의 분산에 대한 통계가 포함됩니다. 자세한 내용은 [선형 회귀 모델에 대한 마이닝 모델 콘텐츠&#40;Analysis Services - 데이터 마이닝&#41;](../../analysis-services/data-mining/mining-model-content-for-linear-regression-models-analysis-services-data-mining.md)를 참조하세요.  
