...
ms.topic: "article"
helpviewer_keywords: 
  - "MINIMUM_ITEMSET_SIZE 매개 변수"
  - "MAXIMUM_SUPPORT 매개 변수"
  - "연결 알고리즘 [Analysis Services]"
  - "MINIMUM_SUPPORT 매개 변수"
  - "OPTIMIZED_PREDICTION_COUNT 매개 변수"
  - "연결 [Analysis Services]"
  - "MAXIMUM_ITEMSET_COUNT 매개 변수"
  - "MAXIMUM_ITEMSET_SIZE 매개 변수"
  - "MINIMUM_PROBABILITY 매개 변수"
