...
3.  다음 옵션 중 하나를 선택합니다. **모델 열만** 나 **모델 및 구조 열**합니다. 사용 권한이 없는 경우 옵션을 사용하지 못할 수 있습니다.  
...
3.  선택 **드릴스루**, 다음 옵션 중 하나를 선택 합니다. **모델 열만** 나 **모델 및 구조 열**합니다. 사용 권한이 없는 경우 옵션을 사용하지 못할 수 있습니다.  
