...
ms.locfileid: "68162821"
---
# <a name="import-from-analysis-services"></a>Analysis Services에서 가져오기 
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]
  이 문서는 서버에서에서 가져오기 프로젝트 템플릿에서 사용 하 여 기존 테이블 형식 모델에서 메타 데이터를 가져와서 새로운 테이블 형식 모델 프로젝트를 만드는 방법에 설명 합니다 [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]합니다.  
