...
---
# 테이블 형식 모델 파티션 만들기 및 관리(SSAS 테이블 형식)
...
## 관련 항목:  
 ...
 [테이블 형식 모델 파티션 처리&#40;SSAS 테이블 형식&#41;](../../analysis-services/tabular-models/process-tabular-model-partitions-ssas-tabular.md)  
