...
ms.locfileid: "68207693"
---
# <a name="directquery-mode"></a>DirectQuery 모드
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]
  이 문서에서는 설명 *DirectQuery 모드* 1200 이상 호환성 수준의 Analysis Services 테이블 형식 모델에 대 한 합니다. SSDT에서 디자인하는 모델에 대해 DirectQuery 모드를 설정하거나 이미 배포된 테이블 형식 모델에 대해 SSMS에서 DirectQuery 모드로 변경할 수 있습니다. DirectQuery 모드를 선택하기 전에 이점과 제한 사항을 이해하는 것이 중요합니다.
...
DirectQuery 테이블 형식 모델을 호환성 수준 1200 이상에서 다음 데이터 원본 및 공급자와 호환 됩니다.
...
## <a name="additional-articles-in-this-section"></a>이 섹션의 문서를 추가
