---
title: Analysis Services 테이블 형식 모델 파티션 처리 | Microsoft Docs
ms.date: 05/07/2018
ms.prod: sql
...
ms.locfileid: "68207505"
---
# <a name="process-tabular-model-partitions"></a>테이블 형식 모델 파티션 처리 
...
3.  에 **파티션 처리** 대화 상자의 합니다 **모드** 목록 상자에서 다음 처리 모드 중 하나를 선택 합니다.  
