---
title: "파워 피벗에서 가져오기(SSAS 테이블 형식) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
## Power Pivot for Excel 파일에서 새 테이블 형식 모델 만들기  
...
#### PowerPivot for Excel 파일에서 새 테이블 형식 모델 프로젝트를 만들려면  
...
## 관련 항목:  
 ...
 [데이터 복사 및 붙여넣기&#40;SSAS 테이블 형식&#41;](../../analysis-services/tabular-models/copy-and-paste-data-ssas-tabular.md)  
