...
# [역할](roles-ssas-tabular.md)
# [계층 구조](hierarchies-ssas-tabular.md)
# [역할 만들기 및 관리](create-and-manage-roles-ssas-tabular.md)
# [계산 열](calculated-columns-ssas-tabular.md)
...
# [파워 뷰 보고서의 기본 필드 집합 구성](configure-default-field-set-for-power-view-reports-ssas-tabular.md)
...
# [계산 열 만들기](create-a-calculated-column-ssas-tabular.md)
...
# [측정값 그룹](measures-ssas-tabular.md)
# [파워 피벗에서 복원](restore-from-power-pivot.md)
...
# [파워 뷰 보고서의 테이블 동작 속성 구성](configure-table-behavior-properties-for-power-view-reports-ssas-tabular.md)
