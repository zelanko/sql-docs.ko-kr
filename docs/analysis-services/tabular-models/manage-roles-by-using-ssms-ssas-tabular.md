...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]만들기, 편집 및 배포 된 테이블 형식 모델에 대 한 역할을 사용 하 여 관리 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]합니다.  
