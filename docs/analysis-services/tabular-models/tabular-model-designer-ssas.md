 ...
 **Analysis Services 테이블 형식 프로젝트**  
 이 템플릿은 비어 있는 새 테이블 형식 모델 프로젝트를 만드는 데 사용할 수 있습니다. 호환성 수준은 프로젝트를 만들 때 지정됩니다. [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]에서 기본 제공되는 모든 기능을 사용하려면 기본값인 **SQL Server 2016 RTM(1200)**을 선택합니다.  
 ...
 **서버에서 가져오기(테이블 형식)**  
 ...
 이전 모델에서는 오래된 호환성 수준이 사용됩니다. 모델 정의를 가져온 후 호환성 수준 속성을 변경하여 수준을 1200으로 업그레이드할 수 있습니다.  
...
### 코드 창 보기  
 솔루션 탐색기에서 마우스 오른쪽 단추를 클릭하고 파일에 대해 **코드 보기**를 선택하면 Model.bim 파일의 코드를 볼 수 있습니다. 호환성 수준이 1200인 테이블 형식 모델의 경우 모델 정의는 JSON으로 표현됩니다.  
...
### 테이블 형식 모델 탐색기
  [SQL Server Data Tools](https://msdn.microsoft.com/mt186501)의 2016년 8월 릴리스(14.0.60812.0)에서 처음으로 제공되는 테이블 형식 모델 탐색기를 사용하면 테이블 형식 1200 모델의 메타데이터 개체를 이동할 수 있습니다.
