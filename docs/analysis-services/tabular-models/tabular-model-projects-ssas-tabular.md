---
title: 테이블 형식 모델 프로젝트 | Microsoft Docs
ms.date: 05/07/2018
ms.prod: sql
...
|항목|Description|  
|-----------|-----------------|  
|[새 테이블 형식 모델 프로젝트 만들기&#40;Reporting Services&#41;](../../analysis-services/tabular-models/create-a-new-tabular-model-project-analysis-services.md)|이 문서에서는 새로운 빈 테이블 형식 모델 프로젝트를 만드는 방법을 설명 합니다.|  
...
|[파워 피벗에서 가져오기](../../analysis-services/tabular-models/import-from-power-pivot-ssas-tabular.md)|이 문서에서는 메타 데이터와 데이터를 추출 하 여 새로운 테이블 형식 모델 프로젝트를 만드는 방법을 설명는 [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] for Excel 파일 (.xlsx)입니다.|  
