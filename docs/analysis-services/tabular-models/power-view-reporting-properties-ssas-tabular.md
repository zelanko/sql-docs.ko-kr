---
title: "보고 속성 (SSAS 테이블 형식)를 볼 power | Microsoft Docs"
ms.custom: 
ms.date: 03/01/2017
...
|항목|Description|  
|-----------|-----------------|  
|[파워 뷰 보고서의 기본 필드 집합 구성&#40;SSAS 테이블 형식&#41;](../../analysis-services/tabular-models/power-view-configure-default-field-set-for-reports.md)|보고서 필드 목록에서 테이블을 선택할 때 [!INCLUDE[ssCrescent](../../includes/sscrescent-md.md)] 보고서 캔버스에 자동으로 추가되는 미리 정의된 열 및 측정값 목록인 기본 필드 집합을 구성하는 방법에 대해 설명합니다.|  
