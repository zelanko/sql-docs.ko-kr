---
title: Analysis Services 테이블 형식 모델에 열 속성 | Microsoft Docs
ms.date: 05/07/2018
ms.prod: sql
...
|--------------|---------------------|-----------------|  
|**표시 폴더**||클라이언트 응용 프로그램 필드 목록에서 열을 구성 하기 위한 단일 또는 중첩 폴더입니다.|  
...
## <a name="see-also"></a>참고자료  
 [파워 뷰 보고 속성](../../analysis-services/tabular-models/power-view-reporting-properties-ssas-tabular.md)   
