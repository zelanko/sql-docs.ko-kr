...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]더 이상 데이터 원본 뷰 (DSV) OLAP 프로젝트에서를 사용할 경우의 프로젝트에서 삭제할 수 없습니다 [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]합니다.  
