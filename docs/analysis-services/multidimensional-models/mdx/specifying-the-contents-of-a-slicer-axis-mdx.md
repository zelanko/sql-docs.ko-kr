...
### 암시적 Slicer 축  
 큐브 내에 있는 계층의 멤버가 쿼리 축에 명시적으로 포함되지 않은 경우 해당 계층의 기본 멤버는 slicer 축에 암시적으로 포함됩니다. 기본 멤버에 대한 자세한 내용은 [기본 멤버 정의](../../../analysis-services/multidimensional-models/define-a-default-member.md)를 참조하세요.  
