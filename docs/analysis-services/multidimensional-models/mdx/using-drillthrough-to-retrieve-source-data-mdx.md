---
title: "DRILLTHROUGH를 사용하여 원본 데이터 검색(MDX) | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
# DRILLTHROUGH를 사용하여 원본 데이터 검색(MDX)
  MDX(Multidimensional Expressions)는 [DRILLTHROUGH](../Topic/DRILLTHROUGH%20Statement%20\(MDX\).md) 문을 사용하여 큐브 셀의 원본 데이터에서 행 집합을 검색합니다.  
