...
ms.topic: "article"
helpviewer_keywords: 
  - "MDX [Analysis Services], 튜플"
  - "멤버 키 [MDX]"
  - "MDX [Analysis Services], 집합"
  - "계산 멤버 [MDX]"
  - "멤버 [MDX]"
  - "Multidimensional Expression [Analysis Services], 멤버"
  - "명명된 집합 [MDX]"
  - "Multidimensional Expression [Analysis Services], 튜플"
  - "멤버 함수 [MDX]"
  - "집합 [MDX]"
  - "MDX [Analysis Services], 멤버"
  - "멤버 이름 [MDX]"
  - "Multidimensional Expression [Analysis Services], 집합"
  - "튜플 함수"
  - "튜플"
  - "집합 함수 [MDX]"
...
## 집합 함수  
 MDX는 집합을 반환하는 여러 함수를 제공합니다. 명시적으로 튜플을 입력하고 중괄호로 묶는 것이 집합 검색을 위한 유일한 방법은 아닙니다. 집합을 반환하는 멤버 함수에 대한 자세한 내용은 [MDX의 주요 개념&#40;Analysis Services&#41;](../../../analysis-services/multidimensional-models/mdx/key-concepts-in-mdx-analysis-services.md)을 참조하세요. 여러 가지 추가 집합 함수가 있습니다.  
