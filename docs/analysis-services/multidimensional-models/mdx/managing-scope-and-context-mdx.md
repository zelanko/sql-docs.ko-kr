...
> [!NOTE]  
>  계산 패스가 계산에 미치는 영향에 대한 자세한 내용은 [패스 순서 및 계산 순서 이해&#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/understanding-pass-order-and-solve-order-mdx.md)를 참조하세요.  
...
## CALCULATE 문 사용  
 ...
 CALCULATE 문의 구문에 대한 자세한 내용은 [CALCULATE 문&#40;MDX&#41;](../Topic/CALCULATE%20Statement%20\(MDX\).md)을 참조하세요.  
...
```  
 ...
 SCOPE 문의 구문에 대한 자세한 내용은 [SCOPE 문&#40;MDX&#41;](../Topic/SCOPE%20Statement%20\(MDX\).md)을 참조하세요.  
