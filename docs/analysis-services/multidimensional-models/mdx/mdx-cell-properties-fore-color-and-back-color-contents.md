...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]**FORE_COLOR** 및 **BACK_COLOR** 셀 속성의 텍스트와 셀의 배경에 대 한 색상 정보 각각에 저장할 Microsoft Windows 운영 체제 빨간색-녹색-파란색 (RGB) 형식 .  
