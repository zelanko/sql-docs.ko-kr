...
ms.topic: "article"
helpviewer_keywords: 
  - "큐브 [Analysis Services], 스크립트"
  - "계산 [Analysis Services], 스크립트"
  - "MDX [Analysis Services], 스크립트"
  - "스크립트 [MDX]"
  - "큐브 [Analysis Services], 계산"
  - "Multidimensional Expression [Analysis Services], 스크립트"
...
|[범위 및 컨텍스트 관리&#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/managing-scope-and-context-mdx.md)|[CALCULATE](../Topic/CALCULATE%20Statement%20\(MDX\).md) 문, [SCOPE](../Topic/SCOPE%20Statement%20\(MDX\).md) 문, 그리고 [This](../../../mdx/this-mdx.md) 함수를 사용하여 MDX 스크립트에서 컨텍스트 및 범위를 관리하는 방법을 설명합니다.|  
