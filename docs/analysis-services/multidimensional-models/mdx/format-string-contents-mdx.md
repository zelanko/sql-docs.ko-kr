...
ms.topic: "article"
helpviewer_keywords: 
  - "형식 [Analysis Services], 문자열 값"
  - "VALUE 속성"
  - "형식 [Analysis Services], 숫자 값"
  - "FORMATTED_VALUE 속성"
  - "FORMAT_STRING 내용"
...
|**hh**|시간을 앞에 오는 0을 사용하는 숫자로 표시합니다(00-23).|  
...
## 관련 항목:  
 [FORMATED_VALUE에 대한 LANGUAGE 및 FORMAT_STRING](../../../analysis-services/multidimensional-models/mdx/language-and-format-string-on-formated-value.md)   
