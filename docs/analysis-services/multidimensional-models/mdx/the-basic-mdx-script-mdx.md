...
-   [SCOPE](../Topic/SCOPE%20Statement%20\(MDX\).md)  
 ...
 CREATE MEMBER 문은 계산 멤버를 만듭니다. 계산 멤버 작성 방법에 대한 자세한 내용은 [계산 멤버를 MDX로 작성&#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/building-calculated-members-in-mdx-mdx.md)을 참조하세요.  
  
 [CREATE SET](../Topic/CREATE%20SET%20Statement%20\(MDX\).md)  
 CREATE SET 문은 명명된 집합을 만듭니다. 명명된 집합을 만드는 방법에 대한 자세한 내용은 [명명된 집합을 MDX로 작성&#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/building-named-sets-in-mdx-mdx.md)을 참조하세요.  
  
 조건문  
 조건문은 MDX 스크립트에 조건부 논리를 추가합니다. 이 범주로는 [CASE](../../../mdx/case-statement-mdx.md) 및 [IF](../Topic/IF%20Statement%20%20\(MDX\).md) 문이 포함됩니다.  
