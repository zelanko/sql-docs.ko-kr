...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server Management Studio [Analysis Services], 데이터베이스"
  - "SQL Server Analysis Services, 데이터베이스"
  - "SSAS, 데이터베이스"
  - "Analysis Services, 데이터베이스"
  - "데이터베이스 [Analysis Services], 디자인"
  - "Business Intelligence Development Studio, 데이터베이스 [Analysis Services]"
  - "데이터베이스 [Analysis Services]"
