...
> [!IMPORTANT]  
>  집합 식을 만들 때 집합의 멤버를 명시적으로 명명하는 경우에는 멤버 목록을 중괄호 한 쌍({})으로 묶습니다.  
