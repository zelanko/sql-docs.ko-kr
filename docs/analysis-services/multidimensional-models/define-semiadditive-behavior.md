---
title: "반가산적 동작 정의 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  - "반가산적"
  - "비즈니스 인텔리전스의 향상된 기능 [Analysis Services], 반가산적 동작"
  - "측정값 [Analysis Services], 반가산적"
 ...
 **마법사에서 반가산적 멤버가 포함된 '계정" 계정 차원을 검색했습니다. 서버는 각 계정 유형에 지정된 반가산적 동작에 따라 이 차원의 멤버를 집계합니다.**  
