...
ms.topic: "article"
helpviewer_keywords: 
  - "측정값 그룹 [Analysis Services]"
  - "측정값 [Analysis Services], 측정값 정보"
  - "OLAP 개체 [Analysis Services], 측정값"
  - "집계 함수 [Analysis Services]"
  - "세분성"
  - "측정값 그룹 [Analysis Services], 측정값 그룹 정보"
  - "측정값 [Analysis Services]"
