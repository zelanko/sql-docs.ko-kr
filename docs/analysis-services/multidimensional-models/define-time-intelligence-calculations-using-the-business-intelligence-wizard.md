---
title: "비즈니스 인텔리전스 마법사를 사용하여 시간 인텔리전스 계산 정의 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "기간별 누계 증가 [Analysis Services]"
  - "병렬 기간 비교 [Analysis Services]"
  - "비즈니스 인텔리전스의 향상된 기능 [Analysis Services], 시간 인텔리전스"
  - "시간 뷰 [Analysis Services]"
  - "계층 [Analysis Services], 시간"
  - "기간 [Analysis Services]"
  - "이동 평균"
  - " 시간 [Analysis Services] "
  - "월간 누계 [Analysis Services]"
  - "계산 [Analysis Services], 시간"
  - "시간 계층 [Analysis Services]"
  - "시간 인텔리전스 [Analysis Services]"
...
---
# 비즈니스 인텔리전스 마법사를 사용하여 시간 인텔리전스 계산 정의
...
-   **계정 차원의 멤버**   **계산 범위 정의** 페이지의 **사용 가능한 측정값** 목록에는 계정 차원이 포함됩니다. 계정 차원의 **Type** 속성은 **Accounts**로 설정되어 있습니다. 계정 차원이 있지만 해당 차원이 **사용 가능한 측정값** 목록에 나타나지 않으면 비즈니스 인텔리전스 마법사를 사용하여 해당 차원에 계정 인텔리전스를 적용할 수 있습니다. 자세한 내용은 [차원에 계정 인텔리전스 추가](../../analysis-services/multidimensional-models/add-account-intelligence-to-a-dimension.md)를 참조하세요.  
