...
ms.topic: "article"
helpviewer_keywords: 
  - "파티션 [Analysis Services], 데이터 조각"
  - "데이터 조각 [Analysis Services]"
...
---
# 파티션 조각 속성 설정(Analysis Services)
...
> [!NOTE]  
>  동적 MDX 함수(예: [Generate&#40;MDX&#41;](../../mdx/generate-mdx.md) 또는 [Except&#40;MDX&#41;](../Topic/Except%20\(MDX\).md))는 파티션에 대한 Slice 속성에서 지원되지 않습니다. 명시적 튜플 또는 멤버 참조를 사용하여 조각을 정의해야 합니다.  
>   
