...
ms.topic: "article"
helpviewer_keywords: 
  - "데이터베이스 [Analysis Services], 수정"
  - "데이터베이스 제거"
  - "데이터베이스 삭제"
  - "데이터베이스 삭제"
  - "데이터베이스 [Analysis Services], 삭제"
  - "데이터베이스 수정"
...
---
# Analysis Services 데이터베이스 수정 또는 삭제
...
## SQL Server Management Studio를 사용하여 데이터베이스 수정  
...
## SQL Server Data Tools를 사용하여 데이터베이스 수정  
...
#### Analysis Services 데이터베이스를 삭제하려면  
