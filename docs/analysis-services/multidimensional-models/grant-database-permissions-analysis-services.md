...
ms.topic: "article"
helpviewer_keywords: 
  - "사용 권한 [Analysis Services], 모든 권한"
  - "모든 권한 [Analysis Services]"
...
# 데이터베이스 권한 부여(Analysis Services)
 ...
 ![데이터베이스 사용 권한을 보여 주는 역할 만들기 대화 상자](../../analysis-services/multidimensional-models/media/ssas-permsdbrole.png "데이터베이스 사용 권한을 보여 주는 역할 만들기 대화 상자")  
...
## 데이터베이스 처리  
 데이터베이스 사용 권한을 부여하는 역할을 정의할 경우 **모든 권한** 은 건너뛰고 **데이터베이스 처리**만 선택할 수 있습니다. 이 사용 권한은 데이터베이스 수준에서 설정되며, 데이터베이스 내 모든 개체에 대한 처리를 허용합니다. [처리 권한 부여&#40;Analysis Services&#41;](../../analysis-services/multidimensional-models/grant-process-permissions-analysis-services.md)를 참조하세요.  
