...
ms.topic: "article"
helpviewer_keywords: 
  - "계층 [Analysis Services], 부모-자식"
  - "차원 [Analysis Services], 부모-자식"
  - "부모 특성 [Analysis Services]"
  - "데이터 멤버 [Analysis Services]"
  - "계층 [Analysis Services], 여러 수준"
  - "자체 조인"
  - "자체 참조 관계"
  - "멤버 [Analysis Services], 데이터"
  - "부모-자식 차원 [Analysis Services]"
...
## 차원 스키마  
 ...
 ![DimOrganization 테이블의 자체 참조 조인](../../analysis-services/multidimensional-models/media/dimorganization.png "DimOrganization 테이블의 자체 참조 조인")  
