...
ms.topic: "article"
helpviewer_keywords: 
  - "쓰기 가능 파티션 [Analysis Services]"
  - "파티션 [Analysis Services], 쓰기 저장"
  - "파티션 [Analysis Services], 쓰기 가능"
  - "쓰기 저장 [Analysis Services], 파티션"
...
## 관련 항목:  
 [쓰기 가능 파티션](../Topic/Write-Enabled%20Partitions.md)   
