---
title: "데이터 원본 뷰의 테이블 또는 명명된 쿼리 바꾸기(Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  ...
  - "명명된 쿼리 [Analysis Services], 테이블 바꾸기"
  - "테이블 [Analysis Services], 데이터 원본 뷰"
  - "파티션 [Analysis Services], 명명된 쿼리"
...
---
# 데이터 원본 뷰의 테이블 또는 명명된 쿼리 바꾸기(Analysis Services)
