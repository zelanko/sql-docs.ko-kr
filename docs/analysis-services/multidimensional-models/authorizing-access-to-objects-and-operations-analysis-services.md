---
title: "개체 및 작업에 대한 액세스 승인(Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "액세스 권한 [Analysis Services], 사용자"
  - "사용 권한 [Analysis Services], 사용자"
  - "보안 [Analysis Services], 사용자 액세스"
  - "사용자 액세스 권한 [Analysis Services]"
  - "권한 부여 [Analysis Services], 사용자"
...
---
# 개체 및 작업에 대한 액세스 승인(Analysis Services)
...
## Analysis Services 권한에 대한 하향식 개요  
