...
helpviewer_keywords: 
  - "OrderBy 속성"
  - "차원 [Analysis Services], 정렬"
  - "Business Intelligence의 향상된 기능 [Analysis Services], 정렬"
  - "차원 [Analysis Services], Business Intelligence의 향상된 기능"
  - "차원 정렬 [Analysis Services]"
  - "OrderByAttributeID 속성"
 ...
 **순서 특성** 열에서 순서 지정에 사용할 특성을 변경할 수 있습니다. 멤버 순서 지정에 사용할 특성이 목록에 없다면 목록을 아래로 스크롤하고 **\<새 특성...>**을 선택하여 차원 테이블의 열을 선택할 수 있는 **열 선택** 대화 상자를 엽니다. **열 선택** 대화 상자에서 열을 선택하면 특성의 멤버 순서를 지정하는 추가 특성이 생성됩니다.  
