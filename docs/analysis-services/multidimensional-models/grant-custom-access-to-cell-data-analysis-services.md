---
title: "셀 데이터에 대한 사용자 지정 액세스 부여(Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
helpviewer_keywords: 
  - "사용자 액세스 권한 [Analysis Services], 셀 데이터"
  - "권한 [Analysis Services], 셀"
  - "불확정 읽기 권한"
  - "읽기 권한"
  - "셀 [Analysis Services]"
  - "사용자 지정 셀 데이터 액세스 [Analysis Services]"
...
# 셀 데이터에 대한 사용자 지정 액세스 부여(Analysis Services)
 ...
 ![허용된 셀 및 거부된 셀을 보여 주는 피벗 테이블](../../analysis-services/multidimensional-models/media/ssas-permscellsallowed.png "허용된 셀 및 거부된 셀을 보여 주는 피벗 테이블")  
...
1.  [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]에서 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]의 인스턴스에 연결하고, 데이터베이스를 선택하고, **역할** 폴더를 연 후 데이터베이스 역할을 클릭하거나 새로운 데이터베이스 역할을 만듭니다. 멤버 자격이 이미 지정되어 있어야 하며, 해당 역할에 큐브에 대한 **Read** 권한이 있어야 합니다. 이 단계에 대한 도움이 필요하면 [큐브 또는 모델 권한 부여&#40;Analysis Services&#41;](../../analysis-services/multidimensional-models/grant-cube-or-model-permissions-analysis-services.md)를 참조하세요.  
...
```  
 ...
 ![셀을 사용할 수 없음으로 표시하는 Excel 열](../../analysis-services/multidimensional-models/media/ssas-permscellshidemeasure.png "셀을 사용할 수 없음으로 표시하는 Excel 열")  
...
```  
 ...
 ![사용 가능한 셀 및 사용 불가능한 셀이 있는 Excel 테이블](../../analysis-services/multidimensional-models/media/ssas-permscalculatedcells.png "사용 가능한 셀 및 사용 불가능한 셀이 있는 Excel 테이블")  
  
## 계산된 측정값에 대한 불확정 읽기 권한 설정  
...
## 관련 항목:  
 [MDX 작성기&#40;Analysis Services - 다차원 데이터&#41;](../Topic/MDX%20Builder%20\(Analysis%20Services%20-%20Multidimensional%20Data\).md)   
