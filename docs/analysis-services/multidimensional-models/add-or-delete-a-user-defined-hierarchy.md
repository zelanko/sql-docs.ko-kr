...
ms.topic: "article"
helpviewer_keywords: 
  - "계층 [Analysis Services], 추가"
  - "계층 제거"
  - "계층 추가"
  - "계층 삭제"
  - "계층 [Analysis Services], 제거"
...
5.  필요에 따라 사용자 정의 계층이나 해당 수준의 속성을 수정합니다.  
     ...
     예를 들어 일반적으로 사용자 정의 계층의 이름을 지정하고 해당 수준의 이름을 하나 이상 바꾸며 All 수준의 사용자 지정 이름을 정의할 수 있습니다.  자세한 내용은 [사용자 계층 속성](../Topic/User%20Hierarchy%20Properties.md) 및 [수준 속성 - 사용자 계층](../Topic/Level%20Properties%20-%20user%20hierarchies.md)을 참조하세요.  
