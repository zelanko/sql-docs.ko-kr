...
ms.topic: "article"
helpviewer_keywords: 
  - "데이터 원본 뷰 [Analysis Services]"
  - "데이터 원본 뷰 [Analysis Services], 데이터 원본 뷰 정보"
  - "SQL Server Analysis Services, 데이터 원본 뷰"
  - "데이터 원본 뷰 [Analysis Services], 여러"
  - "Analysis Services, 데이터 원본 뷰"
  - "여러 데이터 원본 뷰"
  - "SSAS, 데이터 원본 뷰"
