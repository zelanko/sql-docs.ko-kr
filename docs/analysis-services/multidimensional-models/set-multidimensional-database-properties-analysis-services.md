...
---
# 다차원 데이터베이스 속성 설정(Analysis Services)
...
|MasterDataSource ID|원격 파티션에 사용됩니다. 자세한 내용은 [Remote Partitions](../Topic/Remote%20Partitions.md)을 참조하세요.|  
  
## 관련 항목:  
 [데이터베이스 속성 대화 상자&#40;SSAS - 다차원&#41;](../Topic/Database%20Properties%20Dialog%20Box%20\(SSAS%20-%20Multidimensional\).md)   
