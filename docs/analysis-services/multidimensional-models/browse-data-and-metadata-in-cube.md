---
title: "큐브에서 데이터 및 메타데이터 찾아보기 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
##### 차원 추가 또는 제거  
 ...
 여러 차원을 사용하려면 Excel에서 분석 기능을 사용합니다. Excel에서 분석은 [!INCLUDE[ssBIDevStudio](../../includes/ssbidevstudio-md.md)]와 동일한 컴퓨터에 설치될 경우 Excel을 시작하는 바로 가기입니다. Excel은 현재 데이터베이스에 대한 기존 연결 및 측정값과 차원이 미리 채워진 피벗 테이블 필드 목록을 포함하는 통합 문서를 엽니다. 자세한 내용은 [Excel에서 분석&#40;브라우저 탭, 큐브 디자이너&#41;&#40;Analysis Services - 다차원 데이터&#41;](../Topic/Analyze%20in%20Excel%20\(Browser%20Tab,%20Cube%20Designer\)%20\(Analysis%20Services%20-%20Multidimensional%20Data\).md)을 참조하세요.  
...
-   **필터** 창의 **차원** 열에서 **\<차원 선택>**을 클릭하고 목록에서 차원을 선택한 다음 **계층 구조** 열에서 **\<계층 선택>**을 클릭하고 목록에서 계층 구조를 선택합니다.  
