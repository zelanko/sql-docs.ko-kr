...
ms.topic: "article"
helpviewer_keywords: 
  - "멤버 [Analysis Services], 사용자 지정"
  - "사용자 지정 롤업 수식 [Analysis Services]"
  - "MDX [Analysis Services], 사용자 지정 롤업 수식"
...
## 관련 항목:  
 ...
 [차원에 특성의 사용자 지정 멤버 수식 설정](../../analysis-services/multidimensional-models/set-custom-member-formulas-for-attributes-in-a-dimension.md)  
