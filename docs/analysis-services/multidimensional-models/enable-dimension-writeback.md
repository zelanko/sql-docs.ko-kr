...
helpviewer_keywords: 
  - "차원 수정"
  - "쓰기 저장 [Analysis Services], 설정"
  - "차원 [Analysis Services], Business Intelligence의 향상된 기능"
  - "비즈니스 인텔리전스의 향상된 기능 [Analysis Services], 쓰기 저장"
  - "차원 [Analysis Services], 쓰기 저장"
  - "쓰기 저장(Writeback) [Analysis Services]"
