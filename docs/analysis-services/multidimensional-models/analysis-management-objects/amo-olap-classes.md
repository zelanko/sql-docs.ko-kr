...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Analysis Management Objects (AMO) OLAP 클래스 만들기, 수정, 삭제 하 고 큐브, 차원 및 핵심 성과 지표 (Kpi), 동작 및 자동 관리 캐싱 등의 관련된 개체를 처리 하는 데 도움이 됩니다.  
