...
3.  필요한 경우 추적을 시작하고 중지합니다.  
     ...
     추적 서버에 존재 하며 추적이 AutoRestart로 정의 된 경우 다시 시작 해야 추적 중지 된 후에 =**true**합니다.  
...
1.  서버를 설정 하 여 XMLA 로그 캡처를 시작 하려면 CaptureXml 특성 **true**합니다.  
...
3.  CaptureXml을 다시 설정 하 여 XMLA 로그 캡처를 중지 **false**합니다.  
...
## <a name="see-also"></a>관련 항목:  
 ...
 [AMO 다른 클래스와 메서드](../../../analysis-services/multidimensional-models/analysis-management-objects/amo-other-classes-and-methods.md)   
