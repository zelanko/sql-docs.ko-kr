---
title: 사용자 정의 계층에서 특성 관계 4-6 지정 | Microsoft Docs
ms.date: 05/08/2018
ms.prod: sql
...
ms.locfileid: "52952183"
---
# <a name="4-6-specifying-attribute-relationships-in-user-defined-hierarchy"></a>사용자 정의 계층에서 특성 관계 4-6 지정
