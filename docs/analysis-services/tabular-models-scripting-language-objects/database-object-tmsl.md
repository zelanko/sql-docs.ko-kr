...
## <a name="usage"></a>사용법  
 **데이터베이스** 거의 모든 명령에서 개체를 사용 합니다. 참조 [테이블 형식 모델 스크립팅 언어에서 명령을 &#40;TMSL&#41; ](../../analysis-services/tabular-models-scripting-language-commands/tmsl-reference-commands.md) 목록에 대 한 합니다. A **데이터베이스** 개체의 서버 개체의 자식입니다.  
  
 를 만들 때 바꾸거나, 데이터베이스 개체는 개체 정의의 모든 읽기 / 쓰기 속성을 지정 합니다. 읽기 / 쓰기 속성을 생략 삭제 것으로 간주 됩니다.  
  
## <a name="partial-syntax"></a>부분 구문  
 이 개체 정의 너무 크기 때문에 직접 속성만 나열 됩니다. **모델** 개체 데이터베이스 정의 제공 합니다. 참조 [모델 개체 &#40;TMSL&#41; ](../../analysis-services/tabular-models-scripting-language-objects/model-object-tmsl.md) 하는 개체를 정의 하는 방법입니다.  
