...
8.  다음 그림에 표시된 것처럼 **번역 열** 목록에서 **SpanishMonthName**을 선택합니다.  
    ...
    ![특성 데이터 번역 대화 상자](../media/l9-translations-4.gif "특성 데이터 번역 대화 상자")  
...
1.  [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] Tutorial 큐브에 대한 큐브 디자이너로 전환한 후 **번역** 탭으로 전환합니다.  
    ...
    ![기본 언어 번역 탭의](../media/l9-translations-5.gif "기본 언어 번역 탭")  
...
3.  **데이터** 창에서 모든 계층 및 측정값을 제거하고 **큐브 뷰** 목록에서 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] Tutorial을 선택합니다.  
...
5.  도구 모음의 **언어** 목록에서 **스페인어(스페인)** 를 선택합니다.  
    ...
    ![메타 데이터 창 Repopulated](../media/l9-translations-6.gif "Repopulated 메타 데이터 창")  
...
9. 메타데이터 창에서 **Mes del Ano** 를 마우스 오른쪽 단추로 클릭하고 **쿼리에 추가**를 선택합니다.  
    ...
    ![데이터 창에 스페인어로 월 이름의](../media/l9-translations-7.gif "데이터 창에 스페인어로 월 이름")  
...
[큐브 번역](../multidimensional-models-olap-logical-cube-objects/cube-translations.md)  
[Analysis Services에서의 번역 지원](../translation-support-in-analysis-services.md)  
