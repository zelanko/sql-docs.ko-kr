...
4.  속성 창에서 선택한 특성에 대해 **AttributeHierarchyEnabled** 속성 값을 **False** 로 설정합니다.  
    ...
    **특성** 창에서는 각 특성에 대한 아이콘이 변경되어 해당 특성이 활성화되지 않은 상태임을 나타냅니다.  
    ...
    ![AttributeHierarchyEnabled 속성이 False로 설정](../media/l4-hierarchyenabled-1.gif "AttributeHierarchyEnabled 속성이 False로 설정")  
...
4.  속성 창에서 선택한 특성에 대해 **AttributeHierarchyVisible** 속성 값을 **False** 로 설정합니다.  
    ...
    ![AttributeHierarchyVisible 속성이 False로 설정](../media/l4-hierarchyvisible-1.gif "AttributeHierarchyVisible 속성이 False로 설정")  
