...
2.  왼쪽 창의 **구성 속성** 노드에서 **배포**를 클릭합니다.  
    ...
    > [!NOTE]  
    > 프로젝트의 명명된 된 인스턴스를 배포 하려는 경우 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 컴퓨터의 로컬 또는 원격 서버의 인스턴스에 변경 합니다 **Server** 와 같은 속성을 적절 한 인스턴스 이름 \<  **ServerName**>\\\<**InstanceName**>.  
