...
6.  에 **DimEmployee** 테이블을 만듭니다는 [계층](../tutorial-tabular-1400/as-lesson-9-create-hierarchies.md) 이라는 **조직**합니다. 다음 순서 대로 열을 추가 합니다. **Level1**, **Level2**, **Level3**, **Level4**, **Level5**.
...
[9 단원: 계층 만들기](../tutorial-tabular-1400/as-lesson-9-create-hierarchies.md)  
