...
ms.locfileid: "37979135"
---
# <a name="create-key-performance-indicators"></a>KPI(핵심 성과 지표) 만들기

[!INCLUDE[ssas-appliesto-sql2017-later-aas](../../includes/ssas-appliesto-sql2017-later-aas.md)]

이 단원에서는 핵심 성과 지표 (Kpi) 만들 수 있습니다. Kpi는 정의 되는 값의 성능을 측정 하는 데 사용 되는 *자료* 측정값을에 대해를 *대상* 측정값 또는 절대값으로 정의 된 값입니다. 비즈니스 전문가는 보고 클라이언트 응용 프로그램에서 KPI를 사용하여 비즈니스 성취도에 대한 빠르고 이해하기 쉬운 요약 정보를 얻거나 추세를 확인할 수 있습니다. 자세한 내용은를 참조 하세요. [Kpi](../tabular-models/kpis-ssas-tabular.md)
