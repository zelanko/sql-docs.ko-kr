...
이 태스크에서는 지정는 **AdventureWorksDW** 데이터베이스에 대 한 데이터 원본으로는 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 차원 및 큐브 이후 단원에서 정의 하는 합니다.  
...
이 태스크에서는 데이터 원본 뷰의 테이블 이름을 수정 되도록 후속 형태의 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 정의 하는 개체는 사용자에 게 더 친숙 합니다.  
