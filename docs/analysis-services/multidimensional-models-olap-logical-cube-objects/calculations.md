...
```  
 ...
 계산된 멤버를 만들려면 사용 합니다 **계산**큐브 디자이너의 탭 합니다. 자세한 내용은 참조 하세요. [계산 멤버 만들기](../../analysis-services/multidimensional-models/create-calculated-members.md)  
