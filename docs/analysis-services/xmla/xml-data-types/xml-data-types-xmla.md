...
|[EmptyResult](../../../analysis-services/xmla/xml-data-types/emptyresult-data-type-xmla.md)|**root** 요소의 네임스페이스입니다. XMLA 명령이 결과 반환 하지 않으면 XMLA 명령이 결과 정상적으로 반환 하지 않으므로 또는 XMLA 명령을 실행 하는 동안 Analysis Services 인스턴스에서 오류가 발생 했기 때문에이 네임 스페이스가 반환 됩니다.|  
