...
ms.locfileid: "34576885"
---
# <a name="xml-for-analysis-xmla-compliance"></a>XML for Analysis (XMLA) 호환성
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]  

  XMLA 1.1 사양에는 World Wide Web에 존재하는 데이터 원본에 대한 데이터 액세스를 지원하는 개방형 표준이 기술되어 있습니다. 이 항목에는 XML for Analysis 1.1 사양 Azure Analysis Services 및 SQL Server Analysis Services에서 지 원하는 준수 수준을 설명 합니다.  
...
## <a name="extensions"></a>확장 프로그램  
 Analysis Services에는 또한 다음과 같은 추가 기능 및 기능을 지 원하는 XML for Analysis 1.1 사양 확장 합니다.  
