...
ms.locfileid: "38061061"
---
# <a name="source-element-xmla"></a>Source 요소(XMLA)
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]
  하는 동안 병합할 원본 파티션을 나타냅니다는 [MergePartitions](../../../analysis-services/xmla/xml-elements-commands/mergepartitions-element-xmla.md) 명령입니다.  
...
## <a name="remarks"></a>Remarks  
 합니다 **소스** 요소에서 지정한 대상 파티션으로 병합할 단일 파티션에 대 한 개체 참조는 합니다 **대상** 부모 요소의 **MergePartitions** 요소입니다.  
