 ...
 **기능** 요소를 포함 하는 응용 프로그램 이진 또는 압축과 같은 특정 기능이 지원 됨을 나타냅니다는 **ProtocolCapabilities** 헤더 요소에는 포함 된 Analysis Services의 인스턴스에 의해 또는 SOAP 요청의 SOAP 헤더는 **ProtocolCapabilities** SOAP 응답의 SOAP 헤더에 헤더 요소입니다. **Capability** 요소의 값은 지원될 기능의 이름입니다.  
