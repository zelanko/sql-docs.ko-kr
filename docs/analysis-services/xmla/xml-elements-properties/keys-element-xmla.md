...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]컬렉션을 포함 [키](../../../analysis-services/xmla/xml-elements-properties/key-element-xmla.md) 부모에서 나타내는 특성 멤버의 멤버 키를 식별 하는 데 사용 되는 요소 [특성](../../../analysis-services/xmla/xml-elements-properties/attribute-element-xmla.md) 요소입니다.  
