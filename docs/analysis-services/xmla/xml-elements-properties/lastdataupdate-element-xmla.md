...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]날짜와 부모 시간을 나타내는 큐브의 데이터가 들어 [큐브](../../../analysis-services/xmla/xml-elements-properties/cube-element-olapinfo-xmla.md) 요소를 마지막으로 업데이트 합니다.  
