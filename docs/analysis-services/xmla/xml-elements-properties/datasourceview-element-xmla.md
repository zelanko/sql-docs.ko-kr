...
# <a name="datasourceview-element-xmla"></a>DataSourceView 요소(XMLA)
  부모에 대 한 바인딩 하는 아웃오브 라인 데이터 원본 뷰가 포함 [일괄 처리](../../../analysis-services/xmla/xml-elements-commands/batch-element-xmla.md) 또는 [프로세스](../../../analysis-services/xmla/xml-elements-commands/process-element-xmla.md) 요소입니다.  
