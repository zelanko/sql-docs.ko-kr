...
이 항목은 순서대로 완료해야 하는 테이블 형식 모델링 자습서의 일부입니다. 이 단원의 태스크를 수행 하기 전에 이전 단원을 완료 해야 합니다. [9 단원: 계층 구조를 만들](../analysis-services/lesson-9-create-hierarchies.md)합니다.  
