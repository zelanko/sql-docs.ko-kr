...
ms.locfileid: "62737723"
---
# <a name="lesson-4-3---automatically-grouping-attribute-members"></a>단원 3-4-자동으로 특성 멤버 그룹화
...
5.  속성 창에서 **DiscretizationMethod** 속성 값을 **Automatic** 으로 변경하고 **DiscretizationBucketCount** 속성 값을 **5**로 변경합니다.  
    ...
    ![연간 소득에 대 한 속성을 수정한](../analysis-services/media/l4-discretizationmethod-1.gif "Yearly Income에 대 한 속성을 수정 합니다.")  
...
9. 필드 목록에서 **Employee** 차원과 **Organization**을 차례로 확장한 후 **Sick Leave Hours** 를 **열 레이블**로 끌어옵니다.  
    ...
    ![판매 직원 병가 별로 차원이 구분 시간 둡니다](../analysis-services/media/l4-discretizationmethod-2.gif "판매 직원 병가 별로 차원이 구분 유지 시간")  
