...
> [!TIP]  
>  Excel, Management Studio 및 SQL Server Profiler와 같은 클라이언트 애플리케이션을 사용하여 번역된 문자열을 반환할 수 있습니다. 자세한 내용은 [Globalization Tips and Best Practices &#40;Analysis Services&#41;](../analysis-services/globalization-tips-and-best-practices-analysis-services.md) 를 참조하세요.  
