...
helpviewer_keywords: 
  - "LowMemoryLimit 속성"
  - "MinimumAllocatedMemory 속성"
  - "MidMemoryPrice 속성"
  - "MemoryHeapType 속성"
  - "메모리 [Analysis Services]"
  - "DefaultPagesCountToReuse 속성"
  - "TotalMemoryLimit 속성"
  - "SessionMemoryLimit 속성"
  - "VirtualMemoryLimit 속성"
  - "WaitCountIfHighMemory 속성"
  - "HighMemoryPrice 속성"
  - "HeapTypeForObjects 속성"
...
**2** | Windows LFH
**5** | 하이브리드 할당자. 이 할당자는 16KB 이하 할당에 Windows LFH를 사용하고, 16KB 초과 할당에 AS 힙을 사용합니다. 
