...
ms.topic: "reference"
helpviewer_keywords: 
  - "SQMSupportEnabled 속성"
  - "ComUdfEnabled 속성"
  - "LinkToOtherInstanceEnabled 속성"
  - "ManagedCodeEnabled 속성"
  - "ConnStringEncryptionEnabled 속성"
  - "LinkFromOtherInstanceEnabled 속성"
  - "LinkInsideInstanceEnabled 속성"
  - "UseCachedPageAllocators 속성"
