---
title: "외부 데이터 원본에 대한 연결을 설정하는 동안 오류가 발생했습니다. 새로 고치지 못한 연결: 파워 피벗 데이터 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
manager: "erikre"
---
# 외부 데이터 원본에 대한 연결을 설정하는 동안 오류가 발생했습니다. 새로 고치지 못한 연결: 파워 피벗 데이터
...
## 관련 항목:  
 [데이터 연결은 Windows 인증을 사용하지만 사용자 자격 증명을 위임할 수 없습니다. 파워 피벗 데이터 연결을 새로 고치지 못했습니다.](../../analysis-services/power-pivot-sharepoint/the data connection user could not be delegated.md)  
