...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]
 ...
 SharePoint 팜에서 애플리케이션 풀 ID로 실행되는 공유 웹 서비스인 [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] 서비스 애플리케이션에 대해 두 번째 계정을 지정해야 합니다. 이 계정은 [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)]구성 도구 또는 PowerShell을 사용하여 [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] 설치를 구성할 때 지정합니다.  
...
4.  기본 **서비스 애플리케이션의 애플리케이션 풀 ID를 변경하려면** 서비스 애플리케이션 풀 - SharePoint 웹 서비스 시스템 [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] 을 선택합니다. 설치 구성 방식에 따라 서비스가 SharePoint 서비스용으로 만든 기존 서비스 애플리케이션 풀로 실행될 수 있습니다. 기본적으로 [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] 구성 도구는 서비스를 **기본 [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] 서비스 애플리케이션([!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] 서비스 애플리케이션)** 으로 등록합니다.  
...
2.  [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] 서비스 응용 프로그램을 선택하되 클릭하지는 않습니다. 애플리케이션 이름을 클릭하면 [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] 관리 대시보드가 열립니다. 여기에는 애플리케이션 풀을 지정하는 속성 페이지에 대한 링크가 없습니다.  행에서 빈 공백을 클릭하거나 유형 이름을 클릭해서 [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] 서비스 애플리케이션을 선택할 수 있습니다.  
...
#### <a name="power-pivot-service-application-pool"></a>Power Pivot 서비스 애플리케이션 풀  
