---
title: 데이터 연결 사용자를 위임할 수 없습니다 | Microsoft Docs
ms.date: 05/02/2018
ms.prod: sql
...
|메시지 텍스트|데이터 연결은 Windows 인증을 사용하지만 사용자 자격 증명을 위임할 수 없습니다. PowerPivot 데이터 연결을: [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] 데이터|  
