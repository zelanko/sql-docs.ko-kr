...
10. **테이블** 창에서 **InternetSalesReason(dbo.FactInternetSalesReason)**을 마우스 오른쪽 단추로 클릭한 다음 **데이터 탐색**을 클릭합니다.  
    ...
    ![구매에 대한 판매 이유를 식별하기 위한 키 값](../analysis-services/media/l5-many-to-many-1.png "구매에 대한 판매 이유를 식별하기 위한 키 값")  
...
6.  속성 창에서 **Internet Sales Reason Count** 측정값의 **Visible** 속성을 **False**로 변경합니다.  
    ...
    ![Internet Sales Reason Count 측정값 속성](../analysis-services/media/l5-many-to-many-2.gif "Internet Sales Reason Count 측정값 속성")  
...
12. **Sales Reason** 차원에 대한 차원 디자이너의 **특성** 창에서 **Sales Reason Key**를 선택한 후 속성 창의 **Name** 속성을 **Sales Reason**으로 변경합니다.  
...
4.  **중간 측정값 그룹** 목록에서 **Internet Sales Reason**을 선택합니다.  
    ...
    ![관계 정의 대화 상자](../analysis-services/media/l5-many-to-many-3.gif "관계 정의 대화 상자")  
...
2.  배포가 성공적으로 완료되면 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] Tutorial 큐브에 대한 큐브 디자이너에서 **브라우저** 탭으로 전환한 다음 **다시 연결**을 클릭합니다.  
...
## 단원의 다음 태스크  
[측정값 그룹의 차원 세분성 정의](../analysis-services/defining-dimension-granularity-within-a-measure-group.md)  
