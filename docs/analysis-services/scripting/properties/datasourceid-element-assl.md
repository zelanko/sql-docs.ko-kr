...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]식별는 [DataSource](../../../analysis-services/scripting/objects/datasource-element-assl.md) 부모 요소와 연결 된 요소입니다.  
