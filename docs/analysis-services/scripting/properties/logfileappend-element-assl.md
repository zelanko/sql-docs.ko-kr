...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]결정 여부는 [추적](../../../analysis-services/scripting/objects/trace-element-assl.md) 요소가 해당 로깅 출력을 기존 로그 파일에 아니면 덮어쓸지가 됩니다.  
