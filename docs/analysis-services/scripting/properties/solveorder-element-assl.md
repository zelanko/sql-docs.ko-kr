...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]계산 순서를 나타냅니다는 [CalculationProperty](../../../analysis-services/scripting/objects/calculationproperty-element-assl.md) 요소는 계산된 멤버 또는 계산된 셀 정의에 적용 합니다.  
