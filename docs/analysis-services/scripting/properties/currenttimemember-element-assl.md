...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]현재 멤버와 연결 된 차원 한 번의 정의 [Kpi](../../../analysis-services/scripting/objects/kpi-element-assl.md) 요소입니다.  
