...
|*Currency*|-2에서 사이의 통화 값<sup>63</sup> (또는-922337203685, 477.5808)에서 2<sup>63</sup>정확도 통화 단위의 1/10, 000 인-1 (또는 + 922,337,203,685,477.5807). 이 데이터 형식에 매핑됩니다는 **10 진수** .NET Framework 및 OLE DB의 DBTYPE_CY 데이터 형식에 대 한 데이터 형식입니다.|  
