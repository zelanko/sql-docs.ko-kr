...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]부모 요소의 내용을 필터링 하는 MDX (Multidimensional Expressions) 식을 포함 합니다.  
...
## <a name="remarks"></a>주의  
 에 대 한 자세한 내용은 **바인딩** 의 테이블을 포함 하 여 [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] 의 ASSL (Scripting Language) 개체는 **바인딩** 유형과의 상속 계층 구조 **바인딩**  형식 참조 [바인딩 데이터 형식 &#40; ASSL &#41; ](../../../analysis-services/scripting/data-type/binding-data-type-assl.md).  
