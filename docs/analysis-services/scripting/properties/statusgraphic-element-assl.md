...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]상태에 대 한 권장된 그래픽 표현을 포함 된 [Kpi](../../../analysis-services/scripting/objects/kpi-element-assl.md) 요소입니다.  
