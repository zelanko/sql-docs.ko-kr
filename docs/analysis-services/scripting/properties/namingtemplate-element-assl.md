...
ms.locfileid: "34040497"
---
# <a name="namingtemplate-element-assl"></a>NamingTemplate 요소(ASSL)
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]
  생성 된 부모-자식 계층에서 수준의 이름이 지정 되는 방식을 정의 [DimensionAttribute](../../../analysis-services/scripting/data-type/dimensionattribute-data-type-assl.md) 부모 요소입니다.  
