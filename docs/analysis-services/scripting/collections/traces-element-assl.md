...
# <a name="traces-element-assl"></a>Traces 요소(ASSL)
  [Server](../../../analysis-services/scripting/objects/trace-element-assl.md) 요소와 연결된 [Trace](../../../analysis-services/scripting/objects/server-element-assl.md) 요소의 컬렉션을 포함합니다.  
