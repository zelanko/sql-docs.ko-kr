...
# <a name="actions-element-assl"></a>Actions 요소(ASSL)
  에 대 한 작업의 컬렉션을 포함 한 [큐브](../../../analysis-services/scripting/objects/cube-element-assl.md) 또는 [관점](../../../analysis-services/scripting/objects/perspective-element-assl.md) 요소입니다.  
