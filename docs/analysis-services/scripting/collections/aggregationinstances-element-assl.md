...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]에 정의 된 집계 인스턴스의 컬렉션을 포함 한 [파티션](../../../analysis-services/scripting/objects/partition-element-assl.md) 요소입니다.  
