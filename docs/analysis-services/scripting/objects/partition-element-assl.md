...
# <a name="partition-element-assl"></a>Partition 요소(ASSL)
  파티션을 정의 [MeasureGroup](../../../analysis-services/scripting/objects/measuregroup-element-assl.md) 요소 또는의-라인 파티션 바인딩을 [MeasureGroupBinding](../../../analysis-services/scripting/data-type/measuregroupbinding-data-type-out-of-line-assl.md) 요소입니다.  
