...
# <a name="kpi-element-assl"></a>Kpi 요소(ASSL)
  핵심 성과 지표 (KPI) 내에서 정의 된 [큐브](../../../analysis-services/scripting/objects/cube-element-assl.md) 요소 또는 [관점](../../../analysis-services/scripting/objects/perspective-element-assl.md) 요소입니다.  
