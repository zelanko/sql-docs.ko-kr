...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]이 참조 섹션에서는 Analysis Services Scripting Language (ASSL) 스키마에서 개체로 사용 되는 각 요소에 대 한 구문 및 사용법 정보입니다.  
