...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]데이터 또는 한 개체의 메타 데이터 또는 바인딩된 개체의 메타 데이터에 따라 달라 집니다 두 개체 간의 종속 관계를 나타내는 추상 기본 데이터 형식을 정의 합니다.  
