...
ms.locfileid: "34028494"
---
# <a name="aggregationdimension-data-type-assl"></a>AggregationDimension 데이터 형식(ASSL)
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]
  차원과 [Aggregation](../../../analysis-services/scripting/objects/aggregation-element-assl.md) 요소 간의 관계를 나타내는 기본 데이터 형식을 정의합니다.  
...
|파생 요소|[Dimension](../../../analysis-services/scripting/objects/dimension-element-assl.md) ([Aggregation](../../../analysis-services/scripting/collections/dimensions-element-assl.md) 의 [Dimensions](../../../analysis-services/scripting/objects/aggregation-element-assl.md)컬렉션)|  
