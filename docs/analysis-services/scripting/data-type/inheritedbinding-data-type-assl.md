...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]함을 나타내는 파생된 데이터 형식을 정의 [MeasureGroupAttribute](../../../analysis-services/scripting/data-type/measuregroupattribute-data-type-assl.md) 요소가 특성에서 해당 바인딩을 상속 합니다.  
