...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]차원과 측정값 그룹 간의 바인딩을 나타내는 파생된 데이터 형식을 정의 합니다.  
...
|자식 요소|[CubeDimensionID](../../../analysis-services/scripting/properties/cubedimensionid-element-assl.md)|  
