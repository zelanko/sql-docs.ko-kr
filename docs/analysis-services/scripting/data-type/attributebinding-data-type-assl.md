...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]에 대 한 바인딩을 나타내는 파생된 데이터 형식을 정의 [특성](../../../analysis-services/scripting/objects/attribute-element-assl.md) 요소입니다.  
