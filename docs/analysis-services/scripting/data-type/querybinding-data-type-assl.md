...
ms.locfileid: "34035114"
---
# <a name="querybinding-data-type-assl"></a>QueryBinding 데이터 형식(ASSL)
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]
  [DataSource](../../../analysis-services/scripting/objects/datasource-element-assl.md) 요소와 [QueryDefinition](../../../analysis-services/scripting/properties/querydefinition-element-assl.md) 요소의 연결을 나타내는 파생 데이터 형식을 정의합니다.  
