...
자세한 내용은 [부모-자식 차원](../analysis-services/multidimensional-models/parent-child-dimensions.md) 및 [부모-자식 계층의 특성](../analysis-services/multidimensional-models/attributes-in-parent-child-hierarchies.md)을 참조하세요.  
...
10. ![직원 계층을 보여 주는 피벗 테이블](../analysis-services/media/l4-employee-1.gif "직원 계층을 보여 주는 피벗 테이블")  
...
5.  **Employees** 계층을 행 레이블 영역으로 끌어옵니다.  
    ...
    ![수정된 직원 계층](../analysis-services/media/l4-employee-2.png "수정된 직원 계층")  
  
## 단원의 다음 태스크  
[자동으로 특성 멤버 그룹화](../analysis-services/automatically-grouping-attribute-members.md)  
  
## 관련 항목:  
[부모-자식 차원](../analysis-services/multidimensional-models/parent-child-dimensions.md)  
[부모 자식 계층의 특성](../analysis-services/multidimensional-models/attributes-in-parent-child-hierarchies.md)  
