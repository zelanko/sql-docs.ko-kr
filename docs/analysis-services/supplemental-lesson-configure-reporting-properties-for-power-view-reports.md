...
기본 필드 집합에 대한 자세한 내용은 SQL Server 온라인 설명서에서 [파워 뷰 보고서의 기본 필드 집합 구성&#40;SSAS 테이블 형식&#41;](../analysis-services/tabular-models/power-view-configure-default-field-set-for-reports.md).  
