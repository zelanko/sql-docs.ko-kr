...
자세한 내용은 [데이터베이스 미러링 엔드포인트(SQL Server)](https://docs.microsoft.com/en-us/sql/database-engine/database-mirroring/the-database-mirroring-endpoint-sql-server?view=sql-server-2017)를 참조하세요.
