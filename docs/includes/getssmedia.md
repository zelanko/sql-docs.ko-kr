...
ms.locfileid: "62747065"
---
[!INCLUDE[ssnoversion](ssnoversion-md.md)] 다운로드 위치는 버전에 따라 다릅니다.
...
- **평가판**은 [SQL Server 다운로드](https://www.microsoft.com/sql-server/sql-server-downloads)에서 사용할 수 있습니다.