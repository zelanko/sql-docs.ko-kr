...
[SQL Server Management Studio 연결 및 쿼리 (SSMS)](../ssms/tutorials/connect-query-sql-server.md)   
[Azure Data Studio 연결 및 쿼리](../ssms/tutorials/connect-query-sql-server.md)
